...
4. Create the matching launcher note:
   `doc/scripts/campaigns/track_2/run_track2g_track2_verification_refresh.md`.
...
- `scripts/paper_reimplementation/rcim_ml_compensation/reference_family_vs_feedforward/reference_family_vs_feedforward_support.py`
  ...
  patch.
- `scripts/campaigns/track_2/run_track2g_track2_verification_refresh.ps1` for
  the operator-facing launcher.
- `doc/scripts/campaigns/track_2/run_track2g_track2_verification_refresh.md` for
