# 2026-04-29-13-42-13 Track1 Forward Last Four Open Cells Campaign Closeout
...
The campaign was prepared to repair the last `4` non-green forward cells after
the previous maxi closeout reduced the residual forward inventory from `9` to
`4`.
...
2. add one new campaign profile entry for
   ...
   and the run-name pattern for `_last_four_open_cells_attempt_`;
