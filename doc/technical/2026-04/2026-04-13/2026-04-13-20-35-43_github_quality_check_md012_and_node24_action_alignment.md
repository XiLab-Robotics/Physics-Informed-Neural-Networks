...
1. one real Markdownlint error:
   ...
   `doc/reports/analysis/validation_checks/rcim_model_bank_reproduction/track1/harmonic_wise/forward/2026-04-13-15-27-41_paper_reimplementation_rcim_harmonic_wise_track1_hgbm_h0181_heavy_reference_campaign_run_harmonic_wise_comparison_report.md`;
