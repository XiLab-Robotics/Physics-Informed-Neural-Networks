# 2026-05-16 Technical Notes

- [2026-05-16-12-28-37_python_entrypoint_platform_flag_plan.md](./2026-05-16-12-28-37_python_entrypoint_platform_flag_plan.md)
  Plan the Python-entrypoint Linux portability tranche that adds a uniform
  `--linux` / `--windows` command-line contract to remaining runnable scripts.
- [2026-05-16-20-04-43_git_lfs_exact_model_bank_threshold_cleanup.md](./2026-05-16-20-04-43_git_lfs_exact_model_bank_threshold_cleanup.md)
