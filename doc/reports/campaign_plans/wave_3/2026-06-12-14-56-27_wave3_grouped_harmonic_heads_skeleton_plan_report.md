...
| Validator | `scripts/campaigns/wave_3/validate_wave3_grouped_harmonic_heads_package.py` |
| Dry-run launcher | `scripts/campaigns/wave_3/run_wave3_grouped_harmonic_heads_checks.ps1` |
| Launcher note | `doc/scripts/campaigns/wave_3/wave3_grouped_harmonic_heads_checks.md` |
