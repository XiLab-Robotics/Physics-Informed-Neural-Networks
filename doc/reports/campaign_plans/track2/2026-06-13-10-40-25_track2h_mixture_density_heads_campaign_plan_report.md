...
- `doc/scripts/campaigns/track2/run_track2h_mixture_density_heads_campaign.md`;
...
```powershell
conda run -n pinns_env python -B scripts/campaigns/track2/validate_track2h_mixture_density_heads_package.py --queue-root config/training/track2h_mixture_density_heads/campaigns/2026-06-13_track2h_mixture_density_heads_campaign/queue --require-prepared-state --run-one-batch
