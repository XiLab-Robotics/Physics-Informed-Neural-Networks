...
- `scripts/campaigns/track2/validate_track2h_quantile_probabilistic_package.py`;
- `scripts/campaigns/track2/run_track2h_quantile_probabilistic_campaign.ps1`;
- `doc/scripts/campaigns/track2/run_track2h_quantile_probabilistic_campaign.md`;
...
```powershell
conda run -n pinns_env python -B scripts/campaigns/track2/validate_track2h_quantile_probabilistic_package.py --queue-root config/training/track2h_quantile_probabilistic_modeling/campaigns/2026-06-12_track2h_quantile_probabilistic_campaign/queue --require-prepared-state --run-one-batch
