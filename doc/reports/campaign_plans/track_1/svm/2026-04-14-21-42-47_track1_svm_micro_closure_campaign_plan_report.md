# RCIM Model-Bank Reproduction SVM Micro-Closure Campaign Plan Report

## Overview

This report prepares the next `RCIM Model-Bank Reproduction` campaign as a very narrow `SVR`
