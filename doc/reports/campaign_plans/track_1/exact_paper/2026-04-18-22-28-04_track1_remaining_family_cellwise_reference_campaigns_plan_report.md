...
- one family launcher:
  `scripts/campaigns/track_1/exact_paper/run_track1_<family>_cellwise_reference_campaign.ps1`;
- one launcher note:
  `doc/scripts/campaigns/run_track1_<family>_cellwise_reference_campaign.md`.

The aggregate orchestration layer should contain:

- `scripts/campaigns/track_1/exact_paper/run_track1_remaining_family_cellwise_reference_campaigns.ps1`
