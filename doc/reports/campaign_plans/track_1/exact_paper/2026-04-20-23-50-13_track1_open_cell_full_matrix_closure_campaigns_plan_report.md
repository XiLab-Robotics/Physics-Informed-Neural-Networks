...
- one family launcher under `scripts/campaigns/track_1/exact_paper/`;
...
```powershell
.\scripts\campaigns\track_1\exact_paper\run_track1_open_cell_full_matrix_closure_campaigns.ps1
```
