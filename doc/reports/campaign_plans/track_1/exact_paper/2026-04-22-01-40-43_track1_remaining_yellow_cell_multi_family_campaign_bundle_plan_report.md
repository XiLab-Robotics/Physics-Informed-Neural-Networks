...
- six dedicated PowerShell family launchers under `scripts/campaigns/track_1/exact_paper/`;
...
```powershell
.\scripts\campaigns\track_1\exact_paper\run_track1_remaining_yellow_cell_campaigns.ps1
```
