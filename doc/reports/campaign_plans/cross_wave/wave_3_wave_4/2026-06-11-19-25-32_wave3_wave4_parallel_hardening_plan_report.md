...
| --- | --- |
| Wave 3 validator | `scripts/campaigns/wave_3/validate_wave3_training_smoke_ready.py` |
| Wave 3 launcher | `scripts/campaigns/wave_3/run_wave3_training_smoke_ready_checks.ps1` |
| Wave 3 launcher note | `doc/scripts/campaigns/wave_3/wave3_training_smoke_ready_checks.md` |
...
| --- | --- | --- |
| Wave 3 | `scripts/campaigns/wave_3/validate_wave3_training_smoke_ready.py` | implemented |
| Wave 3 | `scripts/campaigns/wave_3/run_wave3_training_smoke_ready_checks.ps1` | implemented and validated |
| Wave 3 | `doc/scripts/campaigns/wave_3/wave3_training_smoke_ready_checks.md` | implemented |
