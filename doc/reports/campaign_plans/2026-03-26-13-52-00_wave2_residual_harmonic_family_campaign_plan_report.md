# Wave 2 Residual Harmonic Family Campaign Plan Report

## Overview

This report defines the first `Wave 2` family-specific hyperparameter
...
The first `Wave 2` campaign should prioritize configuration-space coverage over
...
command needed to launch the first `Wave 2` familywise hyperparameter campaign.
