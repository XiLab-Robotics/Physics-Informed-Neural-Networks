...
| Validator | `scripts/campaigns/wave4/validate_wave4b_mmt_feature_generator_package.py` |
| Dry-run launcher | `scripts/campaigns/wave4/run_wave4b_mmt_feature_generator_checks.ps1` |
| Launcher note | `doc/scripts/campaigns/wave4/wave4b_mmt_feature_generator_checks.md` |
