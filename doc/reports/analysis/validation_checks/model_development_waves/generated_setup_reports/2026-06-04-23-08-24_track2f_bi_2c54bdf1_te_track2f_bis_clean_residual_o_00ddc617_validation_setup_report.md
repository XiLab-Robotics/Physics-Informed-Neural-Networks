...
- logical run name: `te_track2f_bis_clean_residual_offset_global`;
- output run name: `te_track2f_bis_clean_residual_offset_global_track2f_bis_clean_global_validation`;
- run instance id: `2026-06-04-23-07-55__te_track2f_bis_clean_residual_offset_global_track2f_bis_clean_global_validation`;
...
| Field | Value |
| --- | --- |
| Config Path | `config/training/track2f_bis_harmonic_offset_probe/campaigns/2026-06-04_track2f_bis_harmonic_offset_probe_campaign/queue/01_clean_sequential_residual_offset_control_global.yaml` |
| Output Directory | `output/validation_checks/track2f_bis_clean_sequential_residual_offset_global/2026-06-04-23-07-55__te_track2f_bis_clean_residual_offset_global_track2f_bis_clean_global_validation` |
| Model Family | `track2f_bis_clean_sequential_residual_offset_global` |
| Model Type | `sequential_residual_offset_probe` |
