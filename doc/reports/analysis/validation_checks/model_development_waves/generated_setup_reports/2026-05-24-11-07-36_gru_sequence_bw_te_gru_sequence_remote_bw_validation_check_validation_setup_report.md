...
- logical run name: `te_gru_sequence_remote_Bw`;
- output run name: `te_gru_sequence_remote_Bw_validation_check`;
- run instance id: `2026-05-24-11-07-19__te_gru_sequence_remote_bw_validation_check`;
...
| Field | Value |
| --- | --- |
| Config Path | `config/training/wave2_temporal_model_entry/campaigns/2026-05-24_wave2_temporal_model_entry_campaign/queue/06_gru_sequence_bw.yaml` |
| Output Directory | `output/validation_checks/gru_sequence_bw/2026-05-24-11-07-19__te_gru_sequence_remote_bw_validation_check` |
| Model Family | `gru_sequence_bw` |
| Model Type | `gru_sequence` |
