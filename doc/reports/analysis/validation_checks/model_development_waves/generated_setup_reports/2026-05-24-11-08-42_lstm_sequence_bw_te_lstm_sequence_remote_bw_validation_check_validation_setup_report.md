...
- logical run name: `te_lstm_sequence_remote_Bw`;
- output run name: `te_lstm_sequence_remote_Bw_validation_check`;
- run instance id: `2026-05-24-11-08-25__te_lstm_sequence_remote_bw_validation_check`;
...
| Field | Value |
| --- | --- |
| Config Path | `config/training/wave2_temporal_model_entry/campaigns/2026-05-24_wave2_temporal_model_entry_campaign/queue/09_lstm_sequence_bw.yaml` |
| Output Directory | `output/validation_checks/lstm_sequence_bw/2026-05-24-11-08-25__te_lstm_sequence_remote_bw_validation_check` |
| Model Family | `lstm_sequence_bw` |
| Model Type | `lstm_sequence` |
| Run Name | `te_lstm_sequence_remote_Bw` |
| Output Run Name | `te_lstm_sequence_remote_Bw_validation_check` |
| Run Instance ID | `2026-05-24-11-08-25__te_lstm_sequence_remote_bw_validation_check` |
