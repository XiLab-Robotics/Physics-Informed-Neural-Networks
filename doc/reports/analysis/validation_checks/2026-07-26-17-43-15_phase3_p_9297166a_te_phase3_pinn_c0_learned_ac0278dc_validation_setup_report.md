...
- logical run name: `te_phase3_pinn_c0_learned_mean_control_fw__polished_setpoints`;
- output run name: `te_phase3_pinn_c0_learned_mean_control_fw__polished_setpoints_validation_check`;
- run instance id: `2026-07-26-17-43-12__te_phase3_pinn_c0_learned_mean_control_fw__polished_setpoints_validation_check`;
...
| Field | Value |
| --- | --- |
| Config Path | `config/training/quasi_static_compliance_pinn/campaigns/2026-07-26_phase3_quasi_static_compliance_pinn/queue/001_c0_learned_mean_control_fw.yaml` |
| Output Directory | `output/validation_checks/phase3_pinn_c0_learned_mean_control_fw/2026-07-26-17-43-12__te_phase3_pinn_c0_learned_mean_control_fw__polished_setpoints_validation_check` |
| Model Family | `phase3_pinn_c0_learned_mean_control_fw` |
| Model Type | `quasi_static_compliance_pinn` |
