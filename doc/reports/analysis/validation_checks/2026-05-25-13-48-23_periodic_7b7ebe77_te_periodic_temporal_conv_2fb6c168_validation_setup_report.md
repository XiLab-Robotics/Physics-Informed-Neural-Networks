...
- output run name: `te_periodic_temporal_convolution_sequence_remote_Fw_wave2b_package_final_validation`;
- run instance id: `2026-05-25-13-48-02__te_periodic_temporal_convolution_sequence_remote_fw_wave2b_package_final_validation`;
...
| Field | Value |
| --- | --- |
| Config Path | `config/training/wave2b_harmonic_temporal_hybrid/campaigns/2026-05-25_wave2b_harmonic_temporal_hybrid_campaign/queue/02_periodic_temporal_convolution_fw.yaml` |
| Output Directory | `output/validation_checks/periodic_temporal_convolution_fw/2026-05-25-13-48-02__te_periodic_temporal_convolution_sequence_remote_fw_wave2b_package_final_validation` |
| Model Family | `periodic_temporal_convolution_fw` |
| Model Type | `periodic_temporal_convolution` |
