...
- logical run name: `te_stage4_h01_r2_compact__polished_setpoints_fw`;
- output run name: `te_stage4_h01_r2_compact__polished_setpoints_fw_validation_check`;
- run instance id: `2026-07-28-09-57-56__te_stage4_h01_r2_compact__polished_setpoints_fw_validation_check`;
...
| Field | Value |
| --- | --- |
| Config Path | `config/training/data_only_residual_capacity/campaigns/2026-07-28_wave52r_stage4_data_only_residual_capacity/queue/007_h01_r2_compact.yaml` |
| Output Directory | `output/validation_checks/stage4_h01_r2_compact/2026-07-28-09-57-56__te_stage4_h01_r2_compact__polished_setpoints_fw_validation_check` |
| Model Family | `stage4_h01_r2_compact` |
| Model Type | `data_only_residual_capacity` |
