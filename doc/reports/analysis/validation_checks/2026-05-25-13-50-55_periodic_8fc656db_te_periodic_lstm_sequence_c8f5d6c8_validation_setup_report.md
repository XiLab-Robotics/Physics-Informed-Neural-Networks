...
- model family: `periodic_lstm_sequence`;
- model type: `periodic_lstm_sequence`;
- logical run name: `te_periodic_lstm_sequence_remote_global`;
- output run name: `te_periodic_lstm_sequence_remote_global_wave2b_package_final_validation`;
- run instance id: `2026-05-25-13-50-31__te_periodic_lstm_sequence_remote_global_wave2b_package_final_validation`;
...
| Field | Value |
| --- | --- |
| Config Path | `config/training/wave2b_harmonic_temporal_hybrid/campaigns/2026-05-25_wave2b_harmonic_temporal_hybrid_campaign/queue/07_periodic_lstm_sequence_global.yaml` |
| Output Directory | `output/validation_checks/periodic_lstm_sequence/2026-05-25-13-50-31__te_periodic_lstm_sequence_remote_global_wave2b_package_final_validation` |
| Model Family | `periodic_lstm_sequence` |
| Model Type | `periodic_lstm_sequence` |
| Run Name | `te_periodic_lstm_sequence_remote_global` |
| Output Run Name | `te_periodic_lstm_sequence_remote_global_wave2b_package_final_validation` |
| Run Instance ID | `2026-05-25-13-50-31__te_periodic_lstm_sequence_remote_global_wave2b_package_final_validation` |
