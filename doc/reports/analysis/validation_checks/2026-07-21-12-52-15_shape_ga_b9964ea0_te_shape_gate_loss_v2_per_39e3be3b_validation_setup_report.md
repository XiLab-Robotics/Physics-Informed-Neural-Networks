...
- logical run name: `te_shape_gate_loss_v2_periodic_gru_sequence_fw__polished_setpoints`;
- output run name: `te_shape_gate_loss_v2_periodic_gru_sequence_fw__polished_setpoints_validation_check`;
- run instance id: `2026-07-21-12-52-14__te_shape_gate_loss_v2_periodic_gru_sequence_fw__polished_setpoints_validation_check`;
...
| Field | Value |
| --- | --- |
| Config Path | `config/training/shape_gate_loss_v2_pilot/campaigns/2026-07-21_shape_gate_loss_v2_checkpoint_selection_pilot/queue/001_shape_gate_loss_v2_periodic_gru_sequence_fw.yaml` |
| Output Directory | `output/validation_checks/shape_gate_loss_v2_checkpoint_selection_periodic_gru_sequence_fw/2026-07-21-12-52-14__te_shape_gate_loss_v2_periodic_gru_sequence_fw__polished_setpoints_validation_check` |
| Model Family | `shape_gate_loss_v2_checkpoint_selection_periodic_gru_sequence_fw` |
| Model Type | `periodic_gru_sequence` |
