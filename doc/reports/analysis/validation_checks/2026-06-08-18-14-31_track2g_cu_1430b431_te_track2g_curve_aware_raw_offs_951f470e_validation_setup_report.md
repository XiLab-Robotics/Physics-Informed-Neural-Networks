...
- logical run name: `te_track2g_curve_aware_raw_offset_global`;
- output run name: `te_track2g_curve_aware_raw_offset_global_track2g_raw_offset_setup_2026_06_08`;
- run instance id: `2026-06-08-18-13-58__te_track2g_curve_aware_raw_offset_global_track2g_raw_offset_setup_2026_06_08`;
...
| Field | Value |
| --- | --- |
| Config Path | `config/training/track2g_curve_aware_training/campaigns/2026-06-08_track2g_curve_aware_training_campaign/queue/07_raw_offset_global.yaml` |
| Output Directory | `output/validation_checks/track2g_curve_aware_harmonic_residual_offset_raw_offset_global/2026-06-08-18-13-58__te_track2g_curve_aware_raw_offset_global_track2g_raw_offset_setup_2026_06_08` |
| Model Family | `track2g_curve_aware_harmonic_residual_offset_raw_offset_global` |
| Model Type | `curve_aware_harmonic_residual_offset_probe` |
