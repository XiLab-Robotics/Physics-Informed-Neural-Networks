...
- logical run name: `te_shape_objective_v3_periodic_gru_sequence_fw__polished_setpoints`;
- output run name: `te_shape_objective_v3_periodic_gru_sequence_fw__polished_setpoints_validation_check`;
- run instance id: `2026-07-21-18-48-35__te_shape_objective_v3_periodic_gru_sequence_fw__polished_setpoints_validation_check`;
...
| Field | Value |
| --- | --- |
| Config Path | `config/training/shape_objective_followup/campaigns/2026-07-21_parallel_shape_objective_followup/queue/001_shape_objective_v3_periodic_gru_sequence_fw.yaml` |
| Output Directory | `output/validation_checks/shape_objective_v3_periodic_gru_sequence_fw/2026-07-21-18-48-35__te_shape_objective_v3_periodic_gru_sequence_fw__polished_setpoints_validation_check` |
| Model Family | `shape_objective_v3_periodic_gru_sequence_fw` |
| Model Type | `periodic_gru_sequence` |
