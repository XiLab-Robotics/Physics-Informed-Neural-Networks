...
- model type: `harmonic_wise_hist_gradient_boosting_track1_h162_h240_wide_repair_1`;
- run name: `track1_hgbm_h162_h240_wide_repair_1`;
- output run name: `track1_hgbm_h162_h240_wide_repair_1_campaign_run`;
- run instance id: `2026-04-13-15-28-59__track1_hgbm_h162_h240_wide_repair_1_campaign_run`;
...
| --- | ---: | ---: | ---: | ---: | ---: |
| Validation | 0.002597 | 0.002838 | 9.405 | 3.588 | 0.000163 |
| Test | 0.002619 | 0.002815 | 8.914 | 2.749 | 0.000154 |

## Paper Alignment

- Paper offline threshold for `Target A`: `4.7%` mean percentage error.
- Current repository test result: `8.914%` mean percentage error.
...
| --- | ---: | ---: | ---: | ---: |
| `h0` | 0.002389 | 0.003181 | 0.002368 | 0.000000 |
| `h1` | 0.000026 | 0.000031 | 0.000024 | 0.001652 |
| `h3` | 0.000019 | 0.000024 | 0.000019 | 0.021621 |
| `h39` | 0.000020 | 0.000027 | 0.000021 | 0.028432 |
| `h40` | 0.000031 | 0.000047 | 0.000030 | 0.071024 |
| `h78` | 0.000027 | 0.000035 | 0.000023 | 0.053872 |
| `h81` | 0.000013 | 0.000017 | 0.000012 | 0.077636 |
| `h156` | 0.000058 | 0.000160 | 0.000058 | 0.082750 |
| `h162` | 0.000037 | 0.000114 | 0.000043 | 0.074955 |
| `h240` | 0.000034 | 0.000069 | 0.000036 | 0.069322 |

Top coefficient-error contributors on the test split:

- `h0` | coefficient MAE `0.002389` | amplitude MAE `0.002368`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| `robot` | 180 | 0.041437 | 0.070592 | 288.1 | 598.2 | 31.6 |
| `cycloidal` | 180 | 0.032884 | 0.054517 | 500.0 | 351.5 | 26.7 |
