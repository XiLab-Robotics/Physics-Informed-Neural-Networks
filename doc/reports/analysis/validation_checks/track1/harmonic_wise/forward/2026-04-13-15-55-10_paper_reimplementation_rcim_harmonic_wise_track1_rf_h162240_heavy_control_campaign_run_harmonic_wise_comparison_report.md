...
- model type: `harmonic_wise_random_forest_track1_h162240_heavy_control`;
- run name: `track1_rf_h162240_heavy_control`;
- output run name: `track1_rf_h162240_heavy_control_campaign_run`;
- run instance id: `2026-04-13-15-54-02__track1_rf_h162240_heavy_control_campaign_run`;
...
| --- | ---: | ---: | ---: | ---: | ---: |
| Validation | 0.003124 | 0.003354 | 11.333 | 3.588 | 0.000195 |
| Test | 0.003317 | 0.003502 | 11.212 | 2.749 | 0.000198 |

## Paper Alignment

- Paper offline threshold for `Target A`: `4.7%` mean percentage error.
- Current repository test result: `11.212%` mean percentage error.
...
| --- | ---: | ---: | ---: | ---: |
| `h0` | 0.003149 | 0.003723 | 0.003089 | 0.000000 |
| `h1` | 0.000025 | 0.000031 | 0.000024 | 0.001584 |
...
| `h81` | 0.000013 | 0.000017 | 0.000013 | 0.076917 |
| `h156` | 0.000065 | 0.000239 | 0.000077 | 0.094774 |
| `h162` | 0.000048 | 0.000133 | 0.000049 | 0.085295 |
| `h240` | 0.000043 | 0.000103 | 0.000047 | 0.086027 |

Top coefficient-error contributors on the test split:

- `h0` | coefficient MAE `0.003149` | amplitude MAE `0.003089`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| `robot` | 180 | 0.040777 | 0.069009 | 288.1 | 598.2 | 31.6 |
| `cycloidal` | 180 | 0.033024 | 0.054534 | 500.0 | 351.5 | 26.7 |

## Test Preview Samples

- `data/simplified_dataset/Test_25degree/1000rpm/1000.0rpm1200.0Nm25.0deg.csv` | forward | mean percentage error `13.995%` | curve MAE `0.008642`
- `data/simplified_dataset/Test_25degree/1000rpm/1000.0rpm1200.0Nm25.0deg.csv` | backward | mean percentage error `19.061%` | curve MAE `0.006233`
- `data/simplified_dataset/Test_25degree/1000rpm/1000.0rpm1300.0Nm25.0deg.csv` | forward | mean percentage error `8.002%` | curve MAE `0.005361`
