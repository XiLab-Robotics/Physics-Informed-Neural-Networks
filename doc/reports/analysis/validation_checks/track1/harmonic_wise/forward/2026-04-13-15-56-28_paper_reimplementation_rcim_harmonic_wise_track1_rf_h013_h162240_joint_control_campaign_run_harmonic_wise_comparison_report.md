...
- model type: `harmonic_wise_random_forest_track1_h013_h162240_joint_control`;
- run name: `track1_rf_h013_h162240_joint_control`;
- output run name: `track1_rf_h013_h162240_joint_control_campaign_run`;
- run instance id: `2026-04-13-15-55-18__track1_rf_h013_h162240_joint_control_campaign_run`;
...
| --- | ---: | ---: | ---: | ---: | ---: |
| Validation | 0.003126 | 0.003356 | 11.337 | 3.588 | 0.000195 |
| Test | 0.003319 | 0.003504 | 11.233 | 2.749 | 0.000198 |

## Paper Alignment

- Paper offline threshold for `Target A`: `4.7%` mean percentage error.
- Current repository test result: `11.233%` mean percentage error.
...
| --- | ---: | ---: | ---: | ---: |
| `h0` | 0.003152 | 0.003724 | 0.003086 | 0.000000 |
| `h1` | 0.000025 | 0.000031 | 0.000024 | 0.001584 |
| `h3` | 0.000022 | 0.000027 | 0.000021 | 0.025617 |
...
- `h0` | coefficient MAE `0.003152` | amplitude MAE `0.003086`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| `robot` | 180 | 0.040786 | 0.068956 | 288.1 | 598.2 | 31.6 |
| `cycloidal` | 180 | 0.033016 | 0.054528 | 500.0 | 351.5 | 26.7 |

## Test Preview Samples

- `data/simplified_dataset/Test_25degree/1000rpm/1000.0rpm1200.0Nm25.0deg.csv` | forward | mean percentage error `13.957%` | curve MAE `0.008618`
- `data/simplified_dataset/Test_25degree/1000rpm/1000.0rpm1200.0Nm25.0deg.csv` | backward | mean percentage error `19.041%` | curve MAE `0.006226`
- `data/simplified_dataset/Test_25degree/1000rpm/1000.0rpm1300.0Nm25.0deg.csv` | forward | mean percentage error `7.936%` | curve MAE `0.005318`
