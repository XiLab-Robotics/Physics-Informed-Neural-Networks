...
- model type: `harmonic_wise_random_forest_track1_h01_focus`;
- run name: `track1_rf_h01_focus`;
- output run name: `track1_rf_h01_focus_campaign_run`;
- run instance id: `2026-04-13-01-54-32__track1_rf_h01_focus_campaign_run`;
...
| --- | ---: | ---: | ---: | ---: | ---: |
| Validation | 0.003123 | 0.003353 | 11.321 | 3.588 | 0.000195 |
| Test | 0.003319 | 0.003503 | 11.190 | 2.749 | 0.000199 |

## Paper Alignment

- Paper offline threshold for `Target A`: `4.7%` mean percentage error.
- Current repository test result: `11.190%` mean percentage error.
...
| --- | ---: | ---: | ---: | ---: |
| `h0` | 0.003151 | 0.003721 | 0.003095 | 0.000000 |
| `h1` | 0.000026 | 0.000031 | 0.000024 | 0.001594 |
...
| `h156` | 0.000067 | 0.000246 | 0.000078 | 0.096029 |
| `h162` | 0.000049 | 0.000134 | 0.000050 | 0.085151 |
| `h240` | 0.000043 | 0.000105 | 0.000047 | 0.086502 |

Top coefficient-error contributors on the test split:

- `h0` | coefficient MAE `0.003151` | amplitude MAE `0.003095`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| `robot` | 180 | 0.040797 | 0.068924 | 288.1 | 598.2 | 31.6 |
| `cycloidal` | 180 | 0.033056 | 0.054688 | 500.0 | 351.5 | 26.7 |

## Test Preview Samples

- `data/simplified_dataset/Test_25degree/1000rpm/1000.0rpm1200.0Nm25.0deg.csv` | forward | mean percentage error `14.232%` | curve MAE `0.008788`
- `data/simplified_dataset/Test_25degree/1000rpm/1000.0rpm1200.0Nm25.0deg.csv` | backward | mean percentage error `18.945%` | curve MAE `0.006195`
- `data/simplified_dataset/Test_25degree/1000rpm/1000.0rpm1300.0Nm25.0deg.csv` | forward | mean percentage error `8.022%` | curve MAE `0.005375`
