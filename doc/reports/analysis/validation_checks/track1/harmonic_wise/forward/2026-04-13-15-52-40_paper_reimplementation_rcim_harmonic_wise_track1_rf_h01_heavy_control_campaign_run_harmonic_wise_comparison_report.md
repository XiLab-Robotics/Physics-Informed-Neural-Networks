...
- model type: `harmonic_wise_random_forest_track1_h01_heavy_control`;
- run name: `track1_rf_h01_heavy_control`;
- output run name: `track1_rf_h01_heavy_control_campaign_run`;
- run instance id: `2026-04-13-15-51-32__track1_rf_h01_heavy_control_campaign_run`;
...
| --- | ---: | ---: | ---: | ---: | ---: |
| Validation | 0.003127 | 0.003357 | 11.342 | 3.588 | 0.000195 |
...
| `cycloidal` | 180 | 0.033025 | 0.054559 | 500.0 | 351.5 | 26.7 |

## Test Preview Samples

- `data/simplified_dataset/Test_25degree/1000rpm/1000.0rpm1200.0Nm25.0deg.csv` | forward | mean percentage error `13.960%` | curve MAE `0.008620`
- `data/simplified_dataset/Test_25degree/1000rpm/1000.0rpm1200.0Nm25.0deg.csv` | backward | mean percentage error `19.035%` | curve MAE `0.006224`
- `data/simplified_dataset/Test_25degree/1000rpm/1000.0rpm1300.0Nm25.0deg.csv` | forward | mean percentage error `7.962%` | curve MAE `0.005335`
