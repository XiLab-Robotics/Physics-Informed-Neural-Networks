...
- model type: `harmonic_wise_hist_gradient_boosting_track1_h01_h156162240_joint`;
- run name: `track1_hgbm_h01_h156162240_joint`;
- output run name: `track1_hgbm_h01_h156162240_joint_campaign_run`;
- run instance id: `2026-04-13-15-42-33__track1_hgbm_h01_h156162240_joint_campaign_run`;
...
| --- | ---: | ---: | ---: | ---: | ---: |
| Validation | 0.002621 | 0.002863 | 9.621 | 3.588 | 0.000164 |
| Test | 0.002648 | 0.002844 | 8.768 | 2.749 | 0.000155 |

## Paper Alignment

- Paper offline threshold for `Target A`: `4.7%` mean percentage error.
- Current repository test result: `8.768%` mean percentage error.
...
| `h156` | 0.000056 | 0.000184 | 0.000061 | 0.076705 |
...
| `cycloidal` | 180 | 0.032921 | 0.053260 | 500.0 | 351.5 | 26.7 |
