...
- model type: `harmonic_wise_random_forest_track1_full_reference`;
- run name: `track1_rf_full_rcim_reference`;
- output run name: `track1_rf_full_rcim_reference_campaign_run`;
- run instance id: `2026-04-13-01-53-37__track1_rf_full_rcim_reference_campaign_run`;
...
| --- | ---: | ---: | ---: | ---: | ---: |
| Validation | 0.003125 | 0.003355 | 11.339 | 3.588 | 0.000195 |
| Test | 0.003318 | 0.003502 | 11.183 | 2.749 | 0.000198 |

## Paper Alignment

- Paper offline threshold for `Target A`: `4.7%` mean percentage error.
- Current repository test result: `11.183%` mean percentage error.
...
| --- | ---: | ---: | ---: | ---: |
| `h0` | 0.003148 | 0.003721 | 0.003094 | 0.000000 |
| `h1` | 0.000026 | 0.000031 | 0.000024 | 0.001598 |
| `h3` | 0.000022 | 0.000027 | 0.000021 | 0.025733 |
| `h39` | 0.000024 | 0.000030 | 0.000026 | 0.031321 |
| `h40` | 0.000029 | 0.000042 | 0.000028 | 0.069700 |
| `h78` | 0.000038 | 0.000050 | 0.000035 | 0.060938 |
| `h81` | 0.000013 | 0.000017 | 0.000013 | 0.076775 |
| `h156` | 0.000067 | 0.000247 | 0.000078 | 0.096170 |
| `h162` | 0.000049 | 0.000134 | 0.000050 | 0.085791 |
| `h240` | 0.000043 | 0.000105 | 0.000047 | 0.086401 |

Top coefficient-error contributors on the test split:

- `h0` | coefficient MAE `0.003148` | amplitude MAE `0.003094`
- `h156` | coefficient MAE `0.000067` | amplitude MAE `0.000078`
- `h162` | coefficient MAE `0.000049` | amplitude MAE `0.000050`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| `robot` | 180 | 0.040838 | 0.069052 | 288.1 | 598.2 | 31.6 |
| `cycloidal` | 180 | 0.033058 | 0.054892 | 500.0 | 351.5 | 26.7 |

## Test Preview Samples

- `data/simplified_dataset/Test_25degree/1000rpm/1000.0rpm1200.0Nm25.0deg.csv` | forward | mean percentage error `14.365%` | curve MAE `0.008870`
- `data/simplified_dataset/Test_25degree/1000rpm/1000.0rpm1200.0Nm25.0deg.csv` | backward | mean percentage error `18.699%` | curve MAE `0.006115`
- `data/simplified_dataset/Test_25degree/1000rpm/1000.0rpm1300.0Nm25.0deg.csv` | forward | mean percentage error `7.996%` | curve MAE `0.005358`
