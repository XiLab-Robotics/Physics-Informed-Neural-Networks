...
- output run name: `te_harmonic_wise_full_rcim_no_engineering_reference_campaign_run`;
- run instance id: `2026-04-09-20-45-48__te_harmonic_wise_full_rcim_no_engineering_reference_campaign_run`;
...
- `data/simplified_dataset/Test_25degree/1000rpm/1000.0rpm1200.0Nm25.0deg.csv` | forward | mean percentage error `7.846%` | curve MAE `0.004845`
- `data/simplified_dataset/Test_25degree/1000rpm/1000.0rpm1200.0Nm25.0deg.csv` | backward | mean percentage error `9.877%` | curve MAE `0.003230`
- `data/simplified_dataset/Test_25degree/1000rpm/1000.0rpm1300.0Nm25.0deg.csv` | forward | mean percentage error `2.849%` | curve MAE `0.001909`
