...
- model type: `harmonic_wise_hist_gradient_boosting_track1_h013_deeper`;
- run name: `track1_hgbm_h013_deeper_low_order`;
- output run name: `track1_hgbm_h013_deeper_low_order_campaign_run`;
- run instance id: `2026-04-13-01-43-33__track1_hgbm_h013_deeper_low_order_campaign_run`;
...
| --- | ---: | ---: | ---: | ---: | ---: |
| Validation | 0.002629 | 0.002868 | 9.479 | 3.588 | 0.000165 |
| Test | 0.002626 | 0.002823 | 8.954 | 2.749 | 0.000154 |

## Paper Alignment

- Paper offline threshold for `Target A`: `4.7%` mean percentage error.
- Current repository test result: `8.954%` mean percentage error.
...
| --- | ---: | ---: | ---: | ---: |
| `h0` | 0.002401 | 0.003189 | 0.002366 | 0.000000 |
| `h1` | 0.000026 | 0.000032 | 0.000025 | 0.001622 |
| `h3` | 0.000019 | 0.000023 | 0.000019 | 0.021141 |
| `h39` | 0.000020 | 0.000026 | 0.000021 | 0.026234 |
| `h40` | 0.000031 | 0.000047 | 0.000031 | 0.069542 |
| `h78` | 0.000027 | 0.000033 | 0.000023 | 0.046531 |
| `h81` | 0.000014 | 0.000018 | 0.000013 | 0.076464 |
| `h156` | 0.000058 | 0.000165 | 0.000059 | 0.080160 |
| `h162` | 0.000039 | 0.000122 | 0.000045 | 0.074991 |
| `h240` | 0.000034 | 0.000068 | 0.000036 | 0.071160 |

Top coefficient-error contributors on the test split:

- `h0` | coefficient MAE `0.002401` | amplitude MAE `0.002366`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| `robot` | 180 | 0.041274 | 0.070575 | 288.1 | 598.2 | 31.6 |
| `cycloidal` | 180 | 0.032905 | 0.054101 | 500.0 | 351.5 | 26.7 |

## Test Preview Samples

- `data/simplified_dataset/Test_25degree/1000rpm/1000.0rpm1200.0Nm25.0deg.csv` | forward | mean percentage error `7.151%` | curve MAE `0.004416`
- `data/simplified_dataset/Test_25degree/1000rpm/1000.0rpm1200.0Nm25.0deg.csv` | backward | mean percentage error `8.666%` | curve MAE `0.002834`
- `data/simplified_dataset/Test_25degree/1000rpm/1000.0rpm1300.0Nm25.0deg.csv` | forward | mean percentage error `3.178%` | curve MAE `0.002129`
