...
- model type: `harmonic_wise_hist_gradient_boosting_track1_h0139_wide_anchor_1`;
- run name: `track1_hgbm_h0139_wide_anchor_1`;
- output run name: `track1_hgbm_h0139_wide_anchor_1_campaign_run`;
- run instance id: `2026-04-13-15-15-36__track1_hgbm_h0139_wide_anchor_1_campaign_run`;
...
| `h3` | 0.000018 | 0.000023 | 0.000018 | 0.021046 |
| `h39` | 0.000020 | 0.000027 | 0.000021 | 0.027896 |
| `h40` | 0.000031 | 0.000047 | 0.000031 | 0.070612 |
| `h78` | 0.000027 | 0.000037 | 0.000023 | 0.047098 |
| `h81` | 0.000013 | 0.000018 | 0.000013 | 0.074837 |
| `h156` | 0.000057 | 0.000161 | 0.000056 | 0.086961 |
| `h162` | 0.000040 | 0.000126 | 0.000045 | 0.079611 |
| `h240` | 0.000032 | 0.000064 | 0.000034 | 0.063900 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| `robot` | 180 | 0.041365 | 0.070647 | 288.1 | 598.2 | 31.6 |
| `cycloidal` | 180 | 0.032855 | 0.053524 | 500.0 | 351.5 | 26.7 |

## Test Preview Samples

- `data/simplified_dataset/Test_25degree/1000rpm/1000.0rpm1200.0Nm25.0deg.csv` | forward | mean percentage error `8.572%` | curve MAE `0.005293`
- `data/simplified_dataset/Test_25degree/1000rpm/1000.0rpm1200.0Nm25.0deg.csv` | backward | mean percentage error `9.998%` | curve MAE `0.003269`
- `data/simplified_dataset/Test_25degree/1000rpm/1000.0rpm1300.0Nm25.0deg.csv` | forward | mean percentage error `4.588%` | curve MAE `0.003074`
