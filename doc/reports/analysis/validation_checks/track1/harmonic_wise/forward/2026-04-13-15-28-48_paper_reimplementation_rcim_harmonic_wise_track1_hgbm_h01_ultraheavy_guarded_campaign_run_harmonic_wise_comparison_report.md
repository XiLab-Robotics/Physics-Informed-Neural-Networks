...
- model type: `harmonic_wise_hist_gradient_boosting_track1_h01_ultraheavy_guarded`;
- run name: `track1_hgbm_h01_ultraheavy_guarded`;
- output run name: `track1_hgbm_h01_ultraheavy_guarded_campaign_run`;
- run instance id: `2026-04-13-15-27-48__track1_hgbm_h01_ultraheavy_guarded_campaign_run`;
...
| --- | ---: | ---: | ---: | ---: | ---: |
| Validation | 0.002711 | 0.002949 | 9.780 | 3.588 | 0.000170 |
| Test | 0.002685 | 0.002881 | 8.977 | 2.749 | 0.000158 |

## Paper Alignment

- Paper offline threshold for `Target A`: `4.7%` mean percentage error.
- Current repository test result: `8.977%` mean percentage error.
...
| --- | ---: | ---: | ---: | ---: |
| `h0` | 0.002470 | 0.003225 | 0.002438 | 0.000000 |
| `h1` | 0.000026 | 0.000032 | 0.000024 | 0.001620 |
| `h3` | 0.000018 | 0.000023 | 0.000019 | 0.020523 |
| `h39` | 0.000020 | 0.000027 | 0.000022 | 0.026884 |
| `h40` | 0.000030 | 0.000046 | 0.000031 | 0.067672 |
| `h78` | 0.000028 | 0.000036 | 0.000024 | 0.049780 |
| `h81` | 0.000013 | 0.000017 | 0.000012 | 0.081104 |
| `h156` | 0.000057 | 0.000164 | 0.000059 | 0.076006 |
| `h162` | 0.000039 | 0.000118 | 0.000044 | 0.078541 |
| `h240` | 0.000033 | 0.000066 | 0.000035 | 0.067846 |

Top coefficient-error contributors on the test split:

- `h0` | coefficient MAE `0.002470` | amplitude MAE `0.002438`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| `robot` | 180 | 0.041386 | 0.070676 | 288.1 | 598.2 | 31.6 |
| `cycloidal` | 180 | 0.032930 | 0.054691 | 500.0 | 351.5 | 26.7 |

## Test Preview Samples

- `data/simplified_dataset/Test_25degree/1000rpm/1000.0rpm1200.0Nm25.0deg.csv` | forward | mean percentage error `7.723%` | curve MAE `0.004769`
- `data/simplified_dataset/Test_25degree/1000rpm/1000.0rpm1200.0Nm25.0deg.csv` | backward | mean percentage error `8.211%` | curve MAE `0.002685`
- `data/simplified_dataset/Test_25degree/1000rpm/1000.0rpm1300.0Nm25.0deg.csv` | forward | mean percentage error `4.808%` | curve MAE `0.003222`
