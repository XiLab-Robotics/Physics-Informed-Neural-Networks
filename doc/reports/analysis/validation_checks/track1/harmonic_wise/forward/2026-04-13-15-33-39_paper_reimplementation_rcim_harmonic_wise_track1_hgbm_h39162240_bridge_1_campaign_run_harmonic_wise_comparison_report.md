...
- model type: `harmonic_wise_hist_gradient_boosting_track1_h39162240_bridge_1`;
- run name: `track1_hgbm_h39162240_bridge_1`;
- output run name: `track1_hgbm_h39162240_bridge_1_campaign_run`;
- run instance id: `2026-04-13-15-32-50__track1_hgbm_h39162240_bridge_1_campaign_run`;
...
| --- | ---: | ---: | ---: | ---: | ---: |
| Validation | 0.002626 | 0.002867 | 9.545 | 3.588 | 0.000165 |
| Test | 0.002664 | 0.002860 | 9.036 | 2.749 | 0.000157 |

## Paper Alignment

- Paper offline threshold for `Target A`: `4.7%` mean percentage error.
- Current repository test result: `9.036%` mean percentage error.
...
| --- | ---: | ---: | ---: | ---: |
| `h0` | 0.002451 | 0.003226 | 0.002424 | 0.000000 |
| `h1` | 0.000026 | 0.000032 | 0.000024 | 0.001640 |
| `h3` | 0.000019 | 0.000024 | 0.000019 | 0.021285 |
| `h39` | 0.000020 | 0.000028 | 0.000021 | 0.028904 |
| `h40` | 0.000031 | 0.000047 | 0.000030 | 0.070054 |
| `h78` | 0.000028 | 0.000038 | 0.000024 | 0.050312 |
| `h81` | 0.000013 | 0.000018 | 0.000013 | 0.079008 |
| `h156` | 0.000058 | 0.000166 | 0.000060 | 0.080636 |
| `h162` | 0.000037 | 0.000116 | 0.000043 | 0.077488 |
| `h240` | 0.000035 | 0.000068 | 0.000037 | 0.071297 |

Top coefficient-error contributors on the test split:

- `h0` | coefficient MAE `0.002451` | amplitude MAE `0.002424`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| `robot` | 180 | 0.041238 | 0.070292 | 288.1 | 598.2 | 31.6 |
| `cycloidal` | 180 | 0.033073 | 0.054694 | 500.0 | 351.5 | 26.7 |

## Test Preview Samples

- `data/simplified_dataset/Test_25degree/1000rpm/1000.0rpm1200.0Nm25.0deg.csv` | forward | mean percentage error `8.155%` | curve MAE `0.005035`
- `data/simplified_dataset/Test_25degree/1000rpm/1000.0rpm1200.0Nm25.0deg.csv` | backward | mean percentage error `10.388%` | curve MAE `0.003397`
- `data/simplified_dataset/Test_25degree/1000rpm/1000.0rpm1300.0Nm25.0deg.csv` | forward | mean percentage error `3.206%` | curve MAE `0.002148`
