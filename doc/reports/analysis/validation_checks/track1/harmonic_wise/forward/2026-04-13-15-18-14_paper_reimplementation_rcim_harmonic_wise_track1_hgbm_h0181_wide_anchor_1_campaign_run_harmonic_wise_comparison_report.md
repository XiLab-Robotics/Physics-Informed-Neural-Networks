...
- model type: `harmonic_wise_hist_gradient_boosting_track1_h0181_wide_anchor_1`;
- run name: `track1_hgbm_h0181_wide_anchor_1`;
- output run name: `track1_hgbm_h0181_wide_anchor_1_campaign_run`;
- run instance id: `2026-04-13-15-17-28__track1_hgbm_h0181_wide_anchor_1_campaign_run`;
...
| --- | ---: | ---: | ---: | ---: | ---: |
| Validation | 0.002668 | 0.002908 | 9.757 | 3.588 | 0.000168 |
| Test | 0.002677 | 0.002874 | 9.009 | 2.749 | 0.000158 |

## Paper Alignment

- Paper offline threshold for `Target A`: `4.7%` mean percentage error.
- Current repository test result: `9.009%` mean percentage error.
...
| --- | ---: | ---: | ---: | ---: |
| `h0` | 0.002464 | 0.003260 | 0.002431 | 0.000000 |
| `h1` | 0.000026 | 0.000032 | 0.000024 | 0.001613 |
| `h3` | 0.000019 | 0.000024 | 0.000018 | 0.021728 |
| `h39` | 0.000020 | 0.000027 | 0.000021 | 0.028084 |
| `h40` | 0.000031 | 0.000047 | 0.000031 | 0.071118 |
| `h78` | 0.000027 | 0.000033 | 0.000023 | 0.047036 |
| `h81` | 0.000013 | 0.000018 | 0.000012 | 0.076564 |
| `h156` | 0.000056 | 0.000162 | 0.000059 | 0.080329 |
| `h162` | 0.000038 | 0.000117 | 0.000044 | 0.081980 |
| `h240` | 0.000034 | 0.000067 | 0.000036 | 0.070108 |

Top coefficient-error contributors on the test split:

- `h0` | coefficient MAE `0.002464` | amplitude MAE `0.002431`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| `robot` | 180 | 0.041380 | 0.070612 | 288.1 | 598.2 | 31.6 |
| `cycloidal` | 180 | 0.032832 | 0.053307 | 500.0 | 351.5 | 26.7 |

## Test Preview Samples

- `data/simplified_dataset/Test_25degree/1000rpm/1000.0rpm1200.0Nm25.0deg.csv` | forward | mean percentage error `7.448%` | curve MAE `0.004599`
- `data/simplified_dataset/Test_25degree/1000rpm/1000.0rpm1200.0Nm25.0deg.csv` | backward | mean percentage error `8.226%` | curve MAE `0.002690`
- `data/simplified_dataset/Test_25degree/1000rpm/1000.0rpm1300.0Nm25.0deg.csv` | forward | mean percentage error `3.523%` | curve MAE `0.002360`
