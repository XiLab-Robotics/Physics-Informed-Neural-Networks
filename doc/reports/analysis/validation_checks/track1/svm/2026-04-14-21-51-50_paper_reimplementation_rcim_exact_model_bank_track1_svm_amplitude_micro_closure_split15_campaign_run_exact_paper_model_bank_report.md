...
- run name: `track1_svm_amplitude_micro_closure_split15`;
- output run name: `track1_svm_amplitude_micro_closure_split15_campaign_run`;
- run instance id: `2026-04-14-21-51-50__track1_svm_amplitude_micro_closure_split15_campaign_run`;
...
- winning mean component MAPE: `47.952%`;
- winning mean component MAE: `0.000215`;
- winning mean component RMSE: `0.000355`;

## Family Ranking

| Rank | Family | Estimator | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | ---: | ---: | ---: |
| 1 | `SVR` | `SVR` | 47.952 | 0.000215 | 0.000355 |
...
| `Repo Best RMSE` | - | - | - | - | 9.78e-05 | - | - | - | - | 6.12e-04 |
| `Paper Best Family` | - | - | - | - | `ERT` | - | - | - | - | `ERT` |
| `Paper Target RMSE` | - | - | - | - | 3.60e-05 | - | - | - | - | 4.20e-05 |
| `Gap Vs Paper` | - | - | - | - | 6.18e-05 | - | - | - | - | 5.70e-04 |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/svm_targeted_closure/svm/2026-04-14-21-51-50__track1_svm_amplitude_micro_closure_split15_campaign_run/onnx_export`;
