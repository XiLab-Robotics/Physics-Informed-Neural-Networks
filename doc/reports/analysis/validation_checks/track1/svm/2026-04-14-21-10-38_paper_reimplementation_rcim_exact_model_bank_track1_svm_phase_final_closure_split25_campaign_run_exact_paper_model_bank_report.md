...
- run name: `track1_svm_phase_final_closure_split25`;
- output run name: `track1_svm_phase_final_closure_split25_campaign_run`;
- run instance id: `2026-04-14-21-10-37__track1_svm_phase_final_closure_split25_campaign_run`;
...
- winning mean component MAPE: `26.893%`;
- winning mean component MAE: `0.562015`;
- winning mean component RMSE: `1.225226`;

## Family Ranking

| Rank | Family | Estimator | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | ---: | ---: | ---: |
| 1 | `SVR` | `SVR` | 26.893 | 0.562015 | 1.225226 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_162` | `SVR` | `SVR` | 26.893 | 0.562015 | 1.225226 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_162` | `ERT` | `SVR` | 26.893 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/svm_targeted_closure/svm/2026-04-14-21-10-37__track1_svm_phase_final_closure_split25_campaign_run/onnx_export`;
