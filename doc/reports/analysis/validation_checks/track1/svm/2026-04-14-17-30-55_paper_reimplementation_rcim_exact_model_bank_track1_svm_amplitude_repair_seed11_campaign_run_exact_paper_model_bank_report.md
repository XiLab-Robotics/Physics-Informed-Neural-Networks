...
- run name: `track1_svm_amplitude_repair_seed11`;
- output run name: `track1_svm_amplitude_repair_seed11_campaign_run`;
- run instance id: `2026-04-14-17-30-55__track1_svm_amplitude_repair_seed11_campaign_run`;
...
- winning mean component MAPE: `66.418%`;
- winning mean component MAE: `0.000723`;
- winning mean component RMSE: `0.001158`;

## Family Ranking

| Rank | Family | Estimator | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | ---: | ---: | ---: |
| 1 | `SVR` | `SVR` | 66.418 | 0.000723 | 0.001158 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_0` | `SVR` | `SVR` | 11.287 | 0.002523 | 0.003748 |
| `fft_y_Fw_filtered_ampl_40` | `SVR` | `SVR` | 10.922 | 0.000091 | 0.000106 |
| `fft_y_Fw_filtered_ampl_81` | `SVR` | `SVR` | 29.550 | 0.000082 | 0.000094 |
| `fft_y_Fw_filtered_ampl_156` | `SVR` | `SVR` | 203.457 | 0.000557 | 0.001210 |
| `fft_y_Fw_filtered_ampl_240` | `SVR` | `SVR` | 76.873 | 0.000363 | 0.000629 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_0` | `SVR` | `SVR` | 11.287 | `matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_40` | `ERT / GBM` | `SVR` | 10.922 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_81` | `RF` | `SVR` | 29.550 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_156` | `ERT / RF` | `SVR` | 203.457 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_240` | `ERT` | `SVR` | 76.873 | `not_matched_expected_family_direction` |
...
| `Repo Best Family` | `SVR` | - | - | - | `SVR` | - | `SVR` | `SVR` | - | `SVR` |
| `Repo Best RMSE` | 0.003748 | - | - | - | 1.06e-04 | - | 9.39e-05 | 0.001210 | - | 6.29e-04 |
| `Paper Best Family` | `SVM` | - | - | - | `ERT` | - | `RF` | `ERT` | - | `ERT` |
| `Paper Target RMSE` | 0.003300 | - | - | - | 3.60e-05 | - | 1.50e-05 | 1.30e-04 | - | 4.20e-05 |
| `Gap Vs Paper` | 4.48e-04 | - | - | - | 7.02e-05 | - | 7.89e-05 | 0.001080 | - | 5.87e-04 |
| `Status` | `above_paper_target` | - | - | - | `above_paper_target` | - | `above_paper_target` | `above_paper_target` | - | `above_paper_target` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/svm_targeted_closure/svm/2026-04-14-17-30-55__track1_svm_amplitude_repair_seed11_campaign_run/onnx_export`;
...
- extra exported relative paths: `5`;
- failed exports: `0`;
- surrogate exports: `2`;
