...
- run name: `track1_svm_amplitude_repair_seed23`;
- output run name: `track1_svm_amplitude_repair_seed23_campaign_run`;
- run instance id: `2026-04-14-17-31-04__track1_svm_amplitude_repair_seed23_campaign_run`;
...
- winning mean component MAPE: `68.392%`;
- winning mean component MAE: `0.000678`;
- winning mean component RMSE: `0.000969`;

## Family Ranking

| Rank | Family | Estimator | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | ---: | ---: | ---: |
| 1 | `SVR` | `SVR` | 68.392 | 0.000678 | 0.000969 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_0` | `SVR` | `SVR` | 4.934 | 0.002503 | 0.003110 |
| `fft_y_Fw_filtered_ampl_40` | `SVR` | `SVR` | 10.484 | 0.000084 | 0.000101 |
| `fft_y_Fw_filtered_ampl_81` | `SVR` | `SVR` | 32.580 | 0.000090 | 0.000101 |
| `fft_y_Fw_filtered_ampl_156` | `SVR` | `SVR` | 237.540 | 0.000461 | 0.001048 |
| `fft_y_Fw_filtered_ampl_240` | `SVR` | `SVR` | 56.420 | 0.000252 | 0.000486 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_0` | `SVR` | `SVR` | 4.934 | `matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_40` | `ERT / GBM` | `SVR` | 10.484 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_81` | `RF` | `SVR` | 32.580 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_156` | `ERT / RF` | `SVR` | 237.540 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_240` | `ERT` | `SVR` | 56.420 | `not_matched_expected_family_direction` |
...
| `Repo Best RMSE` | 0.003110 | - | - | - | 1.01e-04 | - | 1.01e-04 | 0.001048 | - | 4.86e-04 |
| `Paper Best Family` | `SVM` | - | - | - | `ERT` | - | `RF` | `ERT` | - | `ERT` |
| `Paper Target RMSE` | 0.003300 | - | - | - | 3.60e-05 | - | 1.50e-05 | 1.30e-04 | - | 4.20e-05 |
| `Gap Vs Paper` | -1.90e-04 | - | - | - | 6.52e-05 | - | 8.61e-05 | 9.18e-04 | - | 4.44e-04 |
| `Status` | `met_paper_target` | - | - | - | `above_paper_target` | - | `above_paper_target` | `above_paper_target` | - | `above_paper_target` |
...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `0` | `SVM` | `SVR` | `met_paper_target` | `-` | `-` | `-` | `-` | `-` | `fully_matched_tables_3_6` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/svm_targeted_closure/svm/2026-04-14-17-31-04__track1_svm_amplitude_repair_seed23_campaign_run/onnx_export`;
