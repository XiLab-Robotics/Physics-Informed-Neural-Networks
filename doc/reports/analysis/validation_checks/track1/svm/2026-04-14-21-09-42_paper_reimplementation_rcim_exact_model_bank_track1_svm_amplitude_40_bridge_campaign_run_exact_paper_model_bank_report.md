...
- run name: `track1_svm_amplitude_40_bridge`;
- output run name: `track1_svm_amplitude_40_bridge_campaign_run`;
- run instance id: `2026-04-14-21-09-42__track1_svm_amplitude_40_bridge_campaign_run`;
...
| ---: | --- | --- | ---: | ---: | ---: |
| 1 | `SVR` | `SVR` | 10.484 | 0.000084 | 0.000101 |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/svm_targeted_closure/svm/2026-04-14-21-09-42__track1_svm_amplitude_40_bridge_campaign_run/onnx_export`;
