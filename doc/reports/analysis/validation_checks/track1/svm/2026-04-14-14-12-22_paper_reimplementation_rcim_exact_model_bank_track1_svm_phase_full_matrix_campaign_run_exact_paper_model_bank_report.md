...
- run name: `track1_svm_phase_full_matrix`;
- output run name: `track1_svm_phase_full_matrix_campaign_run`;
- run instance id: `2026-04-14-14-12-21__track1_svm_phase_full_matrix_campaign_run`;
...
- winning mean component MAPE: `168.411%`;
- winning mean component MAE: `0.306888`;
- winning mean component RMSE: `0.551520`;

## Family Ranking

| Rank | Family | Estimator | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | ---: | ---: | ---: |
| 1 | `SVR` | `SVR` | 168.411 | 0.306888 | 0.551520 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_1` | `RF / LGBM` | `SVR` | 30.371 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_3` | `HGBM` | `SVR` | 1.792 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_39` | `HGBM` | `SVR` | 2.180 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_40` | `ERT / GBM` | `SVR` | 71.008 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_78` | `HGBM / RF` | `SVR` | 1180.277 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_81` | `RF` | `SVR` | 14.280 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_156` | `ERT / RF` | `SVR` | 122.219 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_162` | `ERT` | `SVR` | 27.256 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_240` | `ERT` | `SVR` | 66.312 | `not_matched_expected_family_direction` |
...
| ---: | --- | --- | --- | ---: | --- |
| `1` | `RF / LGBM` | `-` | `SVR` | 0/1 | `no_family_direction_match` |
| `3` | `HGBM` | `-` | `SVR` | 0/1 | `no_family_direction_match` |
| `39` | `HGBM` | `-` | `SVR` | 0/1 | `no_family_direction_match` |
| `40` | `ERT / GBM` | `-` | `SVR` | 0/1 | `no_family_direction_match` |
| `78` | `HGBM / RF` | `-` | `SVR` | 0/1 | `no_family_direction_match` |
| `81` | `RF` | `-` | `SVR` | 0/1 | `no_family_direction_match` |
| `156` | `ERT / RF` | `-` | `SVR` | 0/1 | `no_family_direction_match` |
| `162` | `ERT` | `-` | `SVR` | 0/1 | `no_family_direction_match` |
| `240` | `ERT` | `-` | `SVR` | 0/1 | `no_family_direction_match` |
...
| `Repo Best Family` | `SVR` | `SVR` | `SVR` | `SVR` | `SVR` | `SVR` | `SVR` | `SVR` | `SVR` |
| `Repo Best MAE` | 0.002481 | 0.0323 | 0.0268 | 0.0573 | 0.1892 | 0.1230 | 1.088 | 0.5422 | 0.7006 |
...
| `Gap Vs Paper` | 6.81e-04 | 0.0123 | 0.005820 | 0.0213 | 0.1152 | 0.0700 | 0.5781 | 0.3422 | 0.4706 |
...
| `Repo Best Family` | `SVR` | `SVR` | `SVR` | `SVR` | `SVR` | `SVR` | `SVR` | `SVR` | `SVR` |
| `Repo Best RMSE` | 0.003851 | 0.0416 | 0.0512 | 0.0937 | 0.3139 | 0.1943 | 1.637 | 1.218 | 1.411 |
...
| `Gap Vs Paper` | 0.001351 | 0.0126 | 0.0242 | 0.0387 | 0.1539 | 0.1123 | 0.4366 | 0.5778 | 0.8308 |
| `Status` | `above_paper_target` | `above_paper_target` | `above_paper_target` | `above_paper_target` | `above_paper_target` | `above_paper_target` | `above_paper_target` | `above_paper_target` | `above_paper_target` |
...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `1` | `-` | `-` | `-` | `LGBM` | `SVR` | `SVR` | `above_paper_target` | `above_paper_target` | `not_yet_matched_tables_3_6` |
| `3` | `-` | `-` | `-` | `HGBM` | `SVR` | `SVR` | `above_paper_target` | `above_paper_target` | `not_yet_matched_tables_3_6` |
| `39` | `-` | `-` | `-` | `HGBM` | `SVR` | `SVR` | `above_paper_target` | `above_paper_target` | `not_yet_matched_tables_3_6` |
| `40` | `-` | `-` | `-` | `GBM` | `SVR` | `SVR` | `above_paper_target` | `above_paper_target` | `not_yet_matched_tables_3_6` |
| `78` | `-` | `-` | `-` | `RF` | `SVR` | `SVR` | `above_paper_target` | `above_paper_target` | `not_yet_matched_tables_3_6` |
| `81` | `-` | `-` | `-` | `RF` | `SVR` | `SVR` | `above_paper_target` | `above_paper_target` | `not_yet_matched_tables_3_6` |
| `156` | `-` | `-` | `-` | `RF` | `SVR` | `SVR` | `above_paper_target` | `above_paper_target` | `not_yet_matched_tables_3_6` |
| `162` | `-` | `-` | `-` | `ERT` | `SVR` | `SVR` | `above_paper_target` | `above_paper_target` | `not_yet_matched_tables_3_6` |
| `240` | `-` | `-` | `-` | `ERT` | `SVR` | `SVR` | `above_paper_target` | `above_paper_target` | `not_yet_matched_tables_3_6` |

## ONNX Export Surface

- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/full_matrix/svm/2026-04-14-14-12-21__track1_svm_phase_full_matrix_campaign_run/onnx_export`;
