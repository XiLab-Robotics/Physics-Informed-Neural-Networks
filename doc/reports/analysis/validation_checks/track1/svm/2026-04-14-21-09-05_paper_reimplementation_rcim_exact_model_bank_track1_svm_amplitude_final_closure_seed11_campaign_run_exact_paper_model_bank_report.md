...
- run name: `track1_svm_amplitude_final_closure_seed11`;
- output run name: `track1_svm_amplitude_final_closure_seed11_campaign_run`;
- run instance id: `2026-04-14-21-09-04__track1_svm_amplitude_final_closure_seed11_campaign_run`;
...
- winning mean component MAPE: `97.084%`;
- winning mean component MAE: `0.000337`;
- winning mean component RMSE: `0.000649`;

## Family Ranking

| Rank | Family | Estimator | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | ---: | ---: | ---: |
| 1 | `SVR` | `SVR` | 97.084 | 0.000337 | 0.000649 |
...
| `Repo Best RMSE` | - | - | - | - | 1.06e-04 | - | - | 0.001210 | - | 6.29e-04 |
| `Paper Best Family` | - | - | - | - | `ERT` | - | - | `ERT` | - | `ERT` |
| `Paper Target RMSE` | - | - | - | - | 3.60e-05 | - | - | 1.30e-04 | - | 4.20e-05 |
| `Gap Vs Paper` | - | - | - | - | 7.02e-05 | - | - | 0.001080 | - | 5.87e-04 |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/svm_targeted_closure/svm/2026-04-14-21-09-04__track1_svm_amplitude_final_closure_seed11_campaign_run/onnx_export`;
