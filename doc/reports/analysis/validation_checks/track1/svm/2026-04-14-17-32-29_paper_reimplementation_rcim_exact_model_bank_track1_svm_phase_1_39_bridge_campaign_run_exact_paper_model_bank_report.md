...
- run name: `track1_svm_phase_1_39_bridge`;
- output run name: `track1_svm_phase_1_39_bridge_campaign_run`;
- run instance id: `2026-04-14-17-32-28__track1_svm_phase_1_39_bridge_campaign_run`;
...
- winning mean component MAPE: `20.540%`;
- winning mean component MAE: `0.015637`;
- winning mean component RMSE: `0.025736`;

## Family Ranking

| Rank | Family | Estimator | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | ---: | ---: | ---: |
| 1 | `SVR` | `SVR` | 20.540 | 0.015637 | 0.025736 |
...
| `Repo Best MAE` | 0.002465 | - | 0.0288 | - | - | - | - | - | - |
| `Paper Best Family` | `LGBM` | - | `HGBM` | - | - | - | - | - | - |
| `Paper Target MAE` | 0.001800 | - | 0.0210 | - | - | - | - | - | - |
| `Gap Vs Paper` | 6.65e-04 | - | 0.007808 | - | - | - | - | - | - |
...
| `Repo Best Family` | `SVR` | - | `SVR` | - | - | - | - | - | - |
| `Repo Best RMSE` | 0.003433 | - | 0.0480 | - | - | - | - | - | - |
| `Paper Best Family` | `HGBM` | - | `HGBM` | - | - | - | - | - | - |
| `Paper Target RMSE` | 0.002500 | - | 0.0270 | - | - | - | - | - | - |
| `Gap Vs Paper` | 9.33e-04 | - | 0.0210 | - | - | - | - | - | - |
| `Status` | `above_paper_target` | - | `above_paper_target` | - | - | - | - | - | - |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/svm_targeted_closure/svm/2026-04-14-17-32-28__track1_svm_phase_1_39_bridge_campaign_run/onnx_export`;
- exported file count: `2`;
...
- extra exported relative paths: `2`;
- failed exports: `0`;
- surrogate exports: `0`;
