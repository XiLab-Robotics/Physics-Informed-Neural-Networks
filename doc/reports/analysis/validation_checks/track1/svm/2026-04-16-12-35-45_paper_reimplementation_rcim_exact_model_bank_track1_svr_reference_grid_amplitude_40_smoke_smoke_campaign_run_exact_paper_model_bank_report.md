...
- run name: `track1_svr_reference_grid_amplitude_40_smoke`;
- output run name: `track1_svr_reference_grid_amplitude_40_smoke_smoke_campaign_run`;
- run instance id: `2026-04-16-12-35-44__track1_svr_reference_grid_amplitude_40_smoke_smoke_campaign_run`;
...
- winning best params: `{'estimator__C': 0.001, 'estimator__epsilon': 0.0001, 'estimator__gamma': 1.1e-06, 'estimator__kernel': 'rbf'}`;
- winning mean component MAPE: `10.097%`;
...
- grid-search `pre_dispatch`: `1*n_jobs`;

### Family Search Summary

| Family | Search Mode | CV Folds | Best Score | Best Params |
| --- | --- | ---: | ---: | --- |
| `SVR` | `paper_reference_grid_search` | 5 | -0.219484 | `{'estimator__C': 0.001, 'estimator__epsilon': 0.0001, 'estimator__gamma': 1.1e-06, 'estimator__kernel': 'rbf'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `SVR` | `SVR` | `paper_reference_grid_search` | 10.097 | 0.000082 | 0.000096 |
...
| `Repo Best Family` | - | - | - | - | `SVR` | - | - | - | - | - |
| `Repo Best RMSE` | - | - | - | - | 9.63e-05 | - | - | - | - | - |
| `Paper Best Family` | - | - | - | - | `ERT` | - | - | - | - | - |
| `Paper Target RMSE` | - | - | - | - | 3.60e-05 | - | - | - | - | - |
| `Gap Vs Paper` | - | - | - | - | 6.03e-05 | - | - | - | - | - |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/svm_targeted_closure/svm/2026-04-16-12-35-44__track1_svr_reference_grid_amplitude_40_smoke_smoke_campaign_run/onnx_export`;
- exported file count: `1`;
...
- extra exported relative paths: `1`;
- failed exports: `0`;
- surrogate exports: `1`;
