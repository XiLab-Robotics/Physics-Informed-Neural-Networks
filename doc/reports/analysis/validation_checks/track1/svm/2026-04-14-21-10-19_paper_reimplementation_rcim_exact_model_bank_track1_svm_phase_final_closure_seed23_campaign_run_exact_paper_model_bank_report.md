...
- run name: `track1_svm_phase_final_closure_seed23`;
- output run name: `track1_svm_phase_final_closure_seed23_campaign_run`;
- run instance id: `2026-04-14-21-10-19__track1_svm_phase_final_closure_seed23_campaign_run`;
...
- winning mean component MAPE: `29.870%`;
- winning mean component MAE: `0.554718`;
- winning mean component RMSE: `1.274689`;

## Family Ranking

| Rank | Family | Estimator | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | ---: | ---: | ---: |
| 1 | `SVR` | `SVR` | 29.870 | 0.554718 | 1.274689 |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/svm_targeted_closure/svm/2026-04-14-21-10-19__track1_svm_phase_final_closure_seed23_campaign_run/onnx_export`;
