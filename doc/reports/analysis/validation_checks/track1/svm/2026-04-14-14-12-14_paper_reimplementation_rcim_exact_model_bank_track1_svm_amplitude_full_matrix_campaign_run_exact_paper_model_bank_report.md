...
- run name: `track1_svm_amplitude_full_matrix`;
- output run name: `track1_svm_amplitude_full_matrix_campaign_run`;
- run instance id: `2026-04-14-14-12-14__track1_svm_amplitude_full_matrix_campaign_run`;
...
- winning mean component MAPE: `54.960%`;
- winning mean component MAE: `0.000493`;
- winning mean component RMSE: `0.000872`;

## Family Ranking

| Rank | Family | Estimator | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | ---: | ---: | ---: |
| 1 | `SVR` | `SVR` | 54.960 | 0.000493 | 0.000872 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_0` | `SVR` | `SVR` | 11.855 | `matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_1` | `RF / LGBM` | `SVR` | 0.310 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_3` | `HGBM` | `SVR` | 21.840 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_39` | `HGBM` | `SVR` | 15.075 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_40` | `ERT / GBM` | `SVR` | 10.097 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_78` | `HGBM / RF` | `SVR` | 37.240 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_81` | `RF` | `SVR` | 34.124 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_156` | `ERT / RF` | `SVR` | 225.194 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_162` | `ERT` | `SVR` | 125.798 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_240` | `ERT` | `SVR` | 68.068 | `not_matched_expected_family_direction` |
...
| ---: | --- | --- | --- | ---: | --- |
| `0` | `SVR` | `SVR` | `-` | 1/1 | `full_family_direction_match` |
...
| `Repo Best Family` | `SVR` | `SVR` | `SVR` | `SVR` | `SVR` | `SVR` | `SVR` | `SVR` | `SVR` | `SVR` |
| `Repo Best RMSE` | 0.003918 | 7.01e-05 | 1.79e-04 | 1.78e-04 | 9.63e-05 | 3.15e-04 | 1.04e-04 | 0.001107 | 0.002181 | 5.72e-04 |
...
| `Gap Vs Paper` | 6.18e-04 | 3.51e-05 | 1.54e-04 | 1.46e-04 | 6.03e-05 | 2.70e-04 | 8.87e-05 | 9.77e-04 | 0.002021 | 5.30e-04 |
...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `0` | `SVM` | `SVR` | `above_paper_target` | `-` | `-` | `-` | `-` | `-` | `partially_matched_tables_3_6` |
| `1` | `RF` | `SVR` | `above_paper_target` | `-` | `-` | `-` | `-` | `-` | `not_yet_matched_tables_3_6` |
| `3` | `HGBM` | `SVR` | `above_paper_target` | `-` | `-` | `-` | `-` | `-` | `not_yet_matched_tables_3_6` |
| `39` | `HGBM` | `SVR` | `above_paper_target` | `-` | `-` | `-` | `-` | `-` | `not_yet_matched_tables_3_6` |
| `40` | `ERT` | `SVR` | `above_paper_target` | `-` | `-` | `-` | `-` | `-` | `not_yet_matched_tables_3_6` |
| `78` | `HGBM` | `SVR` | `above_paper_target` | `-` | `-` | `-` | `-` | `-` | `not_yet_matched_tables_3_6` |
| `81` | `RF` | `SVR` | `above_paper_target` | `-` | `-` | `-` | `-` | `-` | `not_yet_matched_tables_3_6` |
| `156` | `ERT` | `SVR` | `above_paper_target` | `-` | `-` | `-` | `-` | `-` | `not_yet_matched_tables_3_6` |
| `162` | `ERT` | `SVR` | `above_paper_target` | `-` | `-` | `-` | `-` | `-` | `not_yet_matched_tables_3_6` |
| `240` | `ERT` | `SVR` | `above_paper_target` | `-` | `-` | `-` | `-` | `-` | `not_yet_matched_tables_3_6` |
