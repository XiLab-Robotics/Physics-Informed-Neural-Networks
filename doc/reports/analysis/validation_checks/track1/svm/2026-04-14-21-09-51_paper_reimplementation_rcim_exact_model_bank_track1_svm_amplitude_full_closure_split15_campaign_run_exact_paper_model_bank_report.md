...
- output run name: `track1_svm_amplitude_full_closure_split15_campaign_run`;
...
- winning mean component MAPE: `91.405%`;
- winning mean component MAE: `0.000275`;
- winning mean component RMSE: `0.000505`;

## Family Ranking

| Rank | Family | Estimator | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | ---: | ---: | ---: |
| 1 | `SVR` | `SVR` | 91.405 | 0.000275 | 0.000505 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_40` | `SVR` | `SVR` | 10.245 | 0.000083 | 0.000098 |
| `fft_y_Fw_filtered_ampl_156` | `SVR` | `SVR` | 178.313 | 0.000394 | 0.000806 |
| `fft_y_Fw_filtered_ampl_240` | `SVR` | `SVR` | 85.658 | 0.000347 | 0.000612 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_40` | `ERT / GBM` | `SVR` | 10.245 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_156` | `ERT / RF` | `SVR` | 178.313 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_240` | `ERT` | `SVR` | 85.658 | `not_matched_expected_family_direction` |
...
| `Repo Best RMSE` | - | - | - | - | 9.78e-05 | - | - | 8.06e-04 | - | 6.12e-04 |
| `Paper Best Family` | - | - | - | - | `ERT` | - | - | `ERT` | - | `ERT` |
| `Paper Target RMSE` | - | - | - | - | 3.60e-05 | - | - | 1.30e-04 | - | 4.20e-05 |
| `Gap Vs Paper` | - | - | - | - | 6.18e-05 | - | - | 6.76e-04 | - | 5.70e-04 |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/svm_targeted_closure/svm/2026-04-14-21-09-51__track1_svm_amplitude_full_closure_split15_campaign_run/onnx_export`;
