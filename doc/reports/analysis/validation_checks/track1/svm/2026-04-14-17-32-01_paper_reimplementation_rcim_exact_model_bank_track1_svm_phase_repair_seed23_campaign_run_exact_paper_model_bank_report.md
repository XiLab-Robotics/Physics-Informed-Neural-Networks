...
- run name: `track1_svm_phase_repair_seed23`;
- output run name: `track1_svm_phase_repair_seed23_campaign_run`;
- run instance id: `2026-04-14-17-32-01__track1_svm_phase_repair_seed23_campaign_run`;
...
- winning mean component MAPE: `31.478%`;
- winning mean component MAE: `0.266023`;
- winning mean component RMSE: `0.604240`;

## Family Ranking

| Rank | Family | Estimator | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | ---: | ---: | ---: |
| 1 | `SVR` | `SVR` | 31.478 | 0.266023 | 0.604240 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_1` | `SVR` | `SVR` | 38.700 | 0.002465 | 0.003433 |
| `fft_y_Fw_filtered_phase_39` | `SVR` | `SVR` | 2.379 | 0.028808 | 0.048039 |
| `fft_y_Fw_filtered_phase_162` | `SVR` | `SVR` | 29.870 | 0.554718 | 1.274689 |
| `fft_y_Fw_filtered_phase_240` | `SVR` | `SVR` | 54.964 | 0.478102 | 1.090798 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_1` | `RF / LGBM` | `SVR` | 38.700 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_39` | `HGBM` | `SVR` | 2.379 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_162` | `ERT` | `SVR` | 29.870 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_240` | `ERT` | `SVR` | 54.964 | `not_matched_expected_family_direction` |
...
| `Repo Best Family` | `SVR` | - | `SVR` | - | - | - | - | `SVR` | `SVR` |
| `Repo Best MAE` | 0.002465 | - | 0.0288 | - | - | - | - | 0.5547 | 0.4781 |
| `Paper Best Family` | `LGBM` | - | `HGBM` | - | - | - | - | `DT` | `DT` |
| `Paper Target MAE` | 0.001800 | - | 0.0210 | - | - | - | - | 0.2000 | 0.2300 |
| `Gap Vs Paper` | 6.65e-04 | - | 0.007808 | - | - | - | - | 0.3547 | 0.2481 |
| `Status` | `above_paper_target` | - | `above_paper_target` | - | - | - | - | `above_paper_target` | `above_paper_target` |
...
| `Repo Best Family` | `SVR` | - | `SVR` | - | - | - | - | `SVR` | `SVR` |
| `Repo Best RMSE` | 0.003433 | - | 0.0480 | - | - | - | - | 1.275 | 1.091 |
| `Paper Best Family` | `HGBM` | - | `HGBM` | - | - | - | - | `ERT` | `ERT` |
| `Paper Target RMSE` | 0.002500 | - | 0.0270 | - | - | - | - | 0.6400 | 0.5800 |
| `Gap Vs Paper` | 9.33e-04 | - | 0.0210 | - | - | - | - | 0.6347 | 0.5108 |
| `Status` | `above_paper_target` | - | `above_paper_target` | - | - | - | - | `above_paper_target` | `above_paper_target` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/svm_targeted_closure/svm/2026-04-14-17-32-01__track1_svm_phase_repair_seed23_campaign_run/onnx_export`;
...
- extra exported relative paths: `4`;
- failed exports: `0`;
- surrogate exports: `0`;
