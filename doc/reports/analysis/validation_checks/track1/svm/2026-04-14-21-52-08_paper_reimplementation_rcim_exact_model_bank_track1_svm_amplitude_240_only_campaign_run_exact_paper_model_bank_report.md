...
- output run name: `track1_svm_amplitude_240_only_campaign_run`;
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/svm_targeted_closure/svm/2026-04-14-21-52-08__track1_svm_amplitude_240_only_campaign_run/onnx_export`;
