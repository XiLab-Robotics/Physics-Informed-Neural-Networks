...
- run name: `track1_svm_amplitude_repair_baseline`;
- output run name: `track1_svm_amplitude_repair_baseline_campaign_run`;
- run instance id: `2026-04-14-17-30-45__track1_svm_amplitude_repair_baseline_campaign_run`;
...
- winning mean component MAPE: `69.868%`;
- winning mean component MAE: `0.000727`;
- winning mean component RMSE: `0.001159`;

## Family Ranking

| Rank | Family | Estimator | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | ---: | ---: | ---: |
| 1 | `SVR` | `SVR` | 69.868 | 0.000727 | 0.001159 |
...
| `Repo Best RMSE` | 0.003918 | - | - | - | 9.63e-05 | - | 1.04e-04 | 0.001107 | - | 5.72e-04 |
| `Paper Best Family` | `SVM` | - | - | - | `ERT` | - | `RF` | `ERT` | - | `ERT` |
| `Paper Target RMSE` | 0.003300 | - | - | - | 3.60e-05 | - | 1.50e-05 | 1.30e-04 | - | 4.20e-05 |
| `Gap Vs Paper` | 6.18e-04 | - | - | - | 6.03e-05 | - | 8.87e-05 | 9.77e-04 | - | 5.30e-04 |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/svm_targeted_closure/svm/2026-04-14-17-30-45__track1_svm_amplitude_repair_baseline_campaign_run/onnx_export`;
