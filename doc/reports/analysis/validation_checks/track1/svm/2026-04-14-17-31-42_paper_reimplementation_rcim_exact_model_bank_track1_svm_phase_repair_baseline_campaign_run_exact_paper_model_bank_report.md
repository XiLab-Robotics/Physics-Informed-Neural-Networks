...
- run name: `track1_svm_phase_repair_baseline`;
- output run name: `track1_svm_phase_repair_baseline_campaign_run`;
- run instance id: `2026-04-14-17-31-42__track1_svm_phase_repair_baseline_campaign_run`;
...
- winning mean component MAPE: `31.530%`;
- winning mean component MAE: `0.318019`;
- winning mean component RMSE: `0.670905`;

## Family Ranking

| Rank | Family | Estimator | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | ---: | ---: | ---: |
| 1 | `SVR` | `SVR` | 31.530 | 0.318019 | 0.670905 |
...
| `Repo Best MAE` | 0.002481 | - | 0.0268 | - | - | - | - | 0.5422 | 0.7006 |
| `Paper Best Family` | `LGBM` | - | `HGBM` | - | - | - | - | `DT` | `DT` |
| `Paper Target MAE` | 0.001800 | - | 0.0210 | - | - | - | - | 0.2000 | 0.2300 |
| `Gap Vs Paper` | 6.81e-04 | - | 0.005820 | - | - | - | - | 0.3422 | 0.4706 |
...
| `Repo Best Family` | `SVR` | - | `SVR` | - | - | - | - | `SVR` | `SVR` |
| `Repo Best RMSE` | 0.003851 | - | 0.0512 | - | - | - | - | 1.218 | 1.411 |
| `Paper Best Family` | `HGBM` | - | `HGBM` | - | - | - | - | `ERT` | `ERT` |
| `Paper Target RMSE` | 0.002500 | - | 0.0270 | - | - | - | - | 0.6400 | 0.5800 |
| `Gap Vs Paper` | 0.001351 | - | 0.0242 | - | - | - | - | 0.5778 | 0.8308 |
| `Status` | `above_paper_target` | - | `above_paper_target` | - | - | - | - | `above_paper_target` | `above_paper_target` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/svm_targeted_closure/svm/2026-04-14-17-31-42__track1_svm_phase_repair_baseline_campaign_run/onnx_export`;
