...
- run name: `track1_svm_phase_162_240_focus`;
- output run name: `track1_svm_phase_162_240_focus_campaign_run`;
- run instance id: `2026-04-14-17-32-19__track1_svm_phase_162_240_focus_campaign_run`;
...
- winning mean component MAPE: `67.600%`;
- winning mean component MAE: `0.479707`;
- winning mean component RMSE: `1.075004`;

## Family Ranking

| Rank | Family | Estimator | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | ---: | ---: | ---: |
| 1 | `SVR` | `SVR` | 67.600 | 0.479707 | 1.075004 |
...
| `Repo Best MAE` | - | - | - | - | - | - | - | 0.5274 | 0.4320 |
| `Paper Best Family` | - | - | - | - | - | - | - | `DT` | `DT` |
| `Paper Target MAE` | - | - | - | - | - | - | - | 0.2000 | 0.2300 |
| `Gap Vs Paper` | - | - | - | - | - | - | - | 0.3274 | 0.2020 |
...
| `Repo Best Family` | - | - | - | - | - | - | - | `SVR` | `SVR` |
| `Repo Best RMSE` | - | - | - | - | - | - | - | 1.198 | 0.9522 |
| `Paper Best Family` | - | - | - | - | - | - | - | `ERT` | `ERT` |
| `Paper Target RMSE` | - | - | - | - | - | - | - | 0.6400 | 0.5800 |
| `Gap Vs Paper` | - | - | - | - | - | - | - | 0.5578 | 0.3722 |
| `Status` | - | - | - | - | - | - | - | `above_paper_target` | `above_paper_target` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/svm_targeted_closure/svm/2026-04-14-17-32-19__track1_svm_phase_162_240_focus_campaign_run/onnx_export`;
