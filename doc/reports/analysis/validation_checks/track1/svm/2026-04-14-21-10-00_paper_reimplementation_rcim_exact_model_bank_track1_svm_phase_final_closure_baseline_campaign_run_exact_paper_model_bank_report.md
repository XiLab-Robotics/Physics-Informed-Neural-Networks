...
- run name: `track1_svm_phase_final_closure_baseline`;
- output run name: `track1_svm_phase_final_closure_baseline_campaign_run`;
- run instance id: `2026-04-14-21-10-00__track1_svm_phase_final_closure_baseline_campaign_run`;
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/svm_targeted_closure/svm/2026-04-14-21-10-00__track1_svm_phase_final_closure_baseline_campaign_run/onnx_export`;
