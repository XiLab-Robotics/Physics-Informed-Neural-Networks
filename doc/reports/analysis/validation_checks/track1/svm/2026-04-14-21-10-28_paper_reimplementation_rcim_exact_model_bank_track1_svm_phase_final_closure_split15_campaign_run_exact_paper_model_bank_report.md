...
- run name: `track1_svm_phase_final_closure_split15`;
- output run name: `track1_svm_phase_final_closure_split15_campaign_run`;
- run instance id: `2026-04-14-21-10-28__track1_svm_phase_final_closure_split15_campaign_run`;
...
- winning mean component MAPE: `24.398%`;
- winning mean component MAE: `0.502968`;
- winning mean component RMSE: `1.187303`;

## Family Ranking

| Rank | Family | Estimator | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | ---: | ---: | ---: |
| 1 | `SVR` | `SVR` | 24.398 | 0.502968 | 1.187303 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_162` | `SVR` | `SVR` | 24.398 | 0.502968 | 1.187303 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_162` | `ERT` | `SVR` | 24.398 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/svm_targeted_closure/svm/2026-04-14-21-10-28__track1_svm_phase_final_closure_split15_campaign_run/onnx_export`;
