...
- output run name: `track1_svm_phase_repair_seed11_campaign_run`;
...
- winning mean component MAPE: `41.475%`;
- winning mean component MAE: `0.246005`;
- winning mean component RMSE: `0.546989`;

## Family Ranking

| Rank | Family | Estimator | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | ---: | ---: | ---: |
| 1 | `SVR` | `SVR` | 41.475 | 0.246005 | 0.546989 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_1` | `SVR` | `SVR` | 28.779 | 0.002177 | 0.002908 |
| `fft_y_Fw_filtered_phase_39` | `SVR` | `SVR` | 1.919 | 0.022427 | 0.035038 |
| `fft_y_Fw_filtered_phase_162` | `SVR` | `SVR` | 24.663 | 0.527373 | 1.197784 |
| `fft_y_Fw_filtered_phase_240` | `SVR` | `SVR` | 110.537 | 0.432041 | 0.952225 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_1` | `RF / LGBM` | `SVR` | 28.779 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_39` | `HGBM` | `SVR` | 1.919 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_162` | `ERT` | `SVR` | 24.663 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_240` | `ERT` | `SVR` | 110.537 | `not_matched_expected_family_direction` |
...
| `Repo Best MAE` | 0.002177 | - | 0.0224 | - | - | - | - | 0.5274 | 0.4320 |
| `Paper Best Family` | `LGBM` | - | `HGBM` | - | - | - | - | `DT` | `DT` |
| `Paper Target MAE` | 0.001800 | - | 0.0210 | - | - | - | - | 0.2000 | 0.2300 |
| `Gap Vs Paper` | 3.77e-04 | - | 0.001427 | - | - | - | - | 0.3274 | 0.2020 |
...
| `Repo Best Family` | `SVR` | - | `SVR` | - | - | - | - | `SVR` | `SVR` |
| `Repo Best RMSE` | 0.002908 | - | 0.0350 | - | - | - | - | 1.198 | 0.9522 |
| `Paper Best Family` | `HGBM` | - | `HGBM` | - | - | - | - | `ERT` | `ERT` |
| `Paper Target RMSE` | 0.002500 | - | 0.0270 | - | - | - | - | 0.6400 | 0.5800 |
| `Gap Vs Paper` | 4.08e-04 | - | 0.008038 | - | - | - | - | 0.5578 | 0.3722 |
| `Status` | `above_paper_target` | - | `above_paper_target` | - | - | - | - | `above_paper_target` | `above_paper_target` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/svm_targeted_closure/svm/2026-04-14-17-31-51__track1_svm_phase_repair_seed11_campaign_run/onnx_export`;
