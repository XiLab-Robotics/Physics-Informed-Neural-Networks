...
- run name: `track1_svm_amplitude_low_mid_bridge`;
- output run name: `track1_svm_amplitude_low_mid_bridge_campaign_run`;
- run instance id: `2026-04-14-17-31-33__track1_svm_amplitude_low_mid_bridge_campaign_run`;
...
- winning mean component MAPE: `15.999%`;
- winning mean component MAE: `0.000892`;
- winning mean component RMSE: `0.001104`;

## Family Ranking

| Rank | Family | Estimator | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | ---: | ---: | ---: |
| 1 | `SVR` | `SVR` | 15.999 | 0.000892 | 0.001104 |
...
| `Repo Best RMSE` | 0.003110 | - | - | - | 1.01e-04 | - | 1.01e-04 | - | - | - |
| `Paper Best Family` | `SVM` | - | - | - | `ERT` | - | `RF` | - | - | - |
| `Paper Target RMSE` | 0.003300 | - | - | - | 3.60e-05 | - | 1.50e-05 | - | - | - |
| `Gap Vs Paper` | -1.90e-04 | - | - | - | 6.52e-05 | - | 8.61e-05 | - | - | - |
| `Status` | `met_paper_target` | - | - | - | `above_paper_target` | - | `above_paper_target` | - | - | - |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/svm_targeted_closure/svm/2026-04-14-17-31-33__track1_svm_amplitude_low_mid_bridge_campaign_run/onnx_export`;
