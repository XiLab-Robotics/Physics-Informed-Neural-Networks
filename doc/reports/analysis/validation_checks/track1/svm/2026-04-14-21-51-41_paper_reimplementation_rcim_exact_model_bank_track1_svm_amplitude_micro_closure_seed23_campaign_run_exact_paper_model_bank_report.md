...
- run name: `track1_svm_amplitude_micro_closure_seed23`;
- output run name: `track1_svm_amplitude_micro_closure_seed23_campaign_run`;
- run instance id: `2026-04-14-21-51-41__track1_svm_amplitude_micro_closure_seed23_campaign_run`;
...
- winning mean component MAPE: `33.452%`;
- winning mean component MAE: `0.000168`;
- winning mean component RMSE: `0.000294`;

## Family Ranking

| Rank | Family | Estimator | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | ---: | ---: | ---: |
| 1 | `SVR` | `SVR` | 33.452 | 0.000168 | 0.000294 |
...
| `Repo Best RMSE` | - | - | - | - | 1.01e-04 | - | - | - | - | 4.86e-04 |
| `Paper Best Family` | - | - | - | - | `ERT` | - | - | - | - | `ERT` |
| `Paper Target RMSE` | - | - | - | - | 3.60e-05 | - | - | - | - | 4.20e-05 |
| `Gap Vs Paper` | - | - | - | - | 6.52e-05 | - | - | - | - | 4.44e-04 |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/svm_targeted_closure/svm/2026-04-14-21-51-41__track1_svm_amplitude_micro_closure_seed23_campaign_run/onnx_export`;
