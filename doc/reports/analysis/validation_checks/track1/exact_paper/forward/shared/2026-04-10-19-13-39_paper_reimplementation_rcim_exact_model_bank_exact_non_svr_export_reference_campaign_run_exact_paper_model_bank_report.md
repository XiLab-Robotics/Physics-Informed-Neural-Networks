...
- run name: `exact_non_svr_export_reference`;
- output run name: `exact_non_svr_export_reference_campaign_run`;
- run instance id: `2026-04-10-19-13-05__exact_non_svr_export_reference_campaign_run`;
...
- enabled families: `MLP, RF, DT, ET, ERT, GBM, HGBM, XGBM, LGBM`;
...
| 9 | `MLP` | `MLPRegressor` | 1699870741337.933 | 0.212142 | 0.299527 |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/baseline_reproduction/shared/2026-04-10-19-13-05__exact_non_svr_export_reference_campaign_run/onnx_export`;
- exported file count: `180`;
...
- extra exported relative paths: `180`;
- failed exports: `0`;
- surrogate exports: `0`;
