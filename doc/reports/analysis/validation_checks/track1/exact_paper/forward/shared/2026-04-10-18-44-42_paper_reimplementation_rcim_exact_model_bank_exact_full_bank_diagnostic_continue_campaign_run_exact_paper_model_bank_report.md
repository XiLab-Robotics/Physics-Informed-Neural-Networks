...
- output run name: `exact_full_bank_diagnostic_continue_campaign_run`;
- run instance id: `2026-04-10-18-44-08__exact_full_bank_diagnostic_continue_campaign_run`;
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/baseline_reproduction/shared/2026-04-10-18-44-08__exact_full_bank_diagnostic_continue_campaign_run/onnx_export`;
