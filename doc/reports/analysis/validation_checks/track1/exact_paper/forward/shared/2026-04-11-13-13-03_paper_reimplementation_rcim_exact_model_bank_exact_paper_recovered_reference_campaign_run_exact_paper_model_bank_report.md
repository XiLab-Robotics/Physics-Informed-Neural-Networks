...
- model type: `exact_paper_family_bank_recovered_reference`;
- run name: `exact_paper_recovered_reference`;
- output run name: `exact_paper_recovered_reference_campaign_run`;
- run instance id: `2026-04-11-13-12-29__exact_paper_recovered_reference_campaign_run`;
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/baseline_reproduction/shared/2026-04-11-13-12-29__exact_paper_recovered_reference_campaign_run/onnx_export`;
