...
- output run name: `rcim_exact_paper_model_bank_exact_paper_validation_after_fix`;
- run instance id: `2026-04-10-17-19-53__rcim_exact_paper_model_bank_exact_paper_validation_after_fix`;
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/baseline_reproduction/shared/2026-04-10-17-19-53__rcim_exact_paper_model_bank_exact_paper_validation_after_fix/onnx_export`;
