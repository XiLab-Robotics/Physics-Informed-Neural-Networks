...
- run name: `exact_open_cell_low_order_repair`;
- output run name: `exact_open_cell_low_order_repair_campaign_run`;
- run instance id: `2026-04-13-22-07-58__exact_open_cell_low_order_repair_campaign_run`;
...
- enabled families: `SVR, RF, GBM, HGBM, LGBM`;
...
| 3 | `GBM` | `GradientBoostingRegressor` | 24.343 | 0.062593 | 0.152818 |
| 4 | `LGBM` | `LGBMRegressor` | 32.598 | 0.077943 | 0.155869 |
| 5 | `SVR` | `SVR` | 103.265 | 0.138346 | 0.248620 |
...
| `fft_y_Fw_filtered_ampl_81` | `RF` | `RandomForestRegressor` | 3.501 | 0.000011 | 0.000018 |
| `fft_y_Fw_filtered_ampl_156` | `RF` | `RandomForestRegressor` | 15.712 | 0.000053 | 0.000197 |
| `fft_y_Fw_filtered_ampl_162` | `RF` | `RandomForestRegressor` | 8.503 | 0.000053 | 0.000152 |
| `fft_y_Fw_filtered_ampl_240` | `RF` | `RandomForestRegressor` | 10.910 | 0.000034 | 0.000055 |
| `fft_y_Fw_filtered_phase_0` | `GBM` | `GradientBoostingRegressor` | 0.000 | 0.000000 | 0.000000 |
...
| `fft_y_Fw_filtered_phase_40` | `LGBM` | `LGBMRegressor` | 51.386 | 0.037179 | 0.058218 |
...
| `fft_y_Fw_filtered_phase_240` | `RF` | `RandomForestRegressor` | 20.537 | 0.277042 | 0.846168 |
...
| `fft_y_Fw_filtered_phase_0` | `SVR` | `GBM` | 0.000 | `not_matched_expected_family_direction` |
...
| `fft_y_Fw_filtered_phase_40` | `ERT / GBM` | `LGBM` | 51.386 | `not_matched_expected_family_direction` |
...
| `fft_y_Fw_filtered_ampl_81` | `RF` | `RF` | 3.501 | `matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_81` | `RF` | `RF` | 4.324 | `matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_156` | `ERT / RF` | `RF` | 15.712 | `matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_156` | `ERT / RF` | `LGBM` | 56.378 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_162` | `ERT` | `RF` | 8.503 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_162` | `ERT` | `RF` | 10.098 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_240` | `ERT` | `RF` | 10.910 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_240` | `ERT` | `RF` | 20.537 | `not_matched_expected_family_direction` |
...
| ---: | --- | --- | --- | ---: | --- |
| `0` | `SVR` | `HGBM` | `GBM` | 0/2 | `no_family_direction_match` |
...
| `40` | `ERT / GBM` | `RF` | `LGBM` | 0/2 | `no_family_direction_match` |
| `78` | `HGBM / RF` | `HGBM` | `RF` | 2/2 | `full_family_direction_match` |
| `81` | `RF` | `RF` | `RF` | 2/2 | `full_family_direction_match` |
| `156` | `ERT / RF` | `RF` | `LGBM` | 1/2 | `partial_family_direction_match` |
| `162` | `ERT` | `RF` | `RF` | 0/2 | `no_family_direction_match` |
| `240` | `ERT` | `RF` | `RF` | 0/2 | `no_family_direction_match` |
...
| `Repo Best Family` | `HGBM` | `HGBM` | `HGBM` | `HGBM` | `RF` | `LGBM` | `RF` | `RF` | `RF` | `RF` |
| `Repo Best RMSE` | 0.003699 | 3.52e-05 | 2.57e-05 | 3.17e-05 | 3.28e-05 | 3.57e-05 | 1.82e-05 | 1.97e-04 | 1.52e-04 | 5.47e-05 |
...
| `Gap Vs Paper` | 3.99e-04 | 1.76e-07 | 7.42e-07 | -3.47e-07 | -3.24e-06 | -9.30e-06 | 3.22e-06 | 6.65e-05 | -8.22e-06 | 1.27e-05 |
| `Status` | `above_paper_target` | `above_paper_target` | `above_paper_target` | `met_paper_target` | `met_paper_target` | `met_paper_target` | `above_paper_target` | `above_paper_target` | `met_paper_target` | `above_paper_target` |
...
| `Repo Best Family` | `HGBM` | `GBM` | `LGBM` | `RF` | `RF` | `LGBM` | `RF` | `RF` | `RF` |
| `Repo Best MAE` | 0.001846 | 0.0238 | 0.0204 | 0.0367 | 0.0516 | 0.0475 | 0.4251 | 0.2305 | 0.2770 |
...
| `Gap Vs Paper` | 4.64e-05 | 0.003757 | -6.25e-04 | 6.99e-04 | -0.0224 | -0.005526 | -0.0849 | 0.0305 | 0.0470 |
| `Status` | `above_paper_target` | `above_paper_target` | `met_paper_target` | `above_paper_target` | `met_paper_target` | `met_paper_target` | `met_paper_target` | `above_paper_target` | `above_paper_target` |
...
| `Repo Best Family` | `GBM` | `HGBM` | `HGBM` | `RF` | `RF` | `RF` | `RF` | `RF` | `RF` |
| `Repo Best RMSE` | 0.002510 | 0.0343 | 0.0326 | 0.0551 | 0.1250 | 0.0681 | 0.9644 | 0.7472 | 0.8462 |
...
| `Gap Vs Paper` | 1.01e-05 | 0.005302 | 0.005648 | 1.30e-04 | -0.0350 | -0.0139 | -0.2356 | 0.1072 | 0.2662 |
...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `0` | `SVM` | `HGBM` | `above_paper_target` | `-` | `GBM` | `GBM` | `not_applicable` | `not_applicable` | `not_yet_matched_tables_3_6` |
...
| `40` | `ERT` | `RF` | `met_paper_target` | `GBM` | `RF` | `RF` | `above_paper_target` | `above_paper_target` | `partially_matched_tables_3_6` |
...
| `156` | `ERT` | `RF` | `above_paper_target` | `RF` | `RF` | `RF` | `met_paper_target` | `met_paper_target` | `partially_matched_tables_3_6` |
| `162` | `ERT` | `RF` | `met_paper_target` | `ERT` | `RF` | `RF` | `above_paper_target` | `above_paper_target` | `partially_matched_tables_3_6` |
| `240` | `ERT` | `RF` | `above_paper_target` | `ERT` | `RF` | `RF` | `above_paper_target` | `above_paper_target` | `not_yet_matched_tables_3_6` |

## ONNX Export Surface

- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/open_cell_repair/shared/2026-04-13-22-07-58__exact_open_cell_low_order_repair_campaign_run/onnx_export`;
