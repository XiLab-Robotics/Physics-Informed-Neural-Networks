...
- output run name: `exact_open_cell_paper_family_reference_campaign_run`;
...
- enabled families: `SVR, RF, ERT, GBM, HGBM, LGBM`;
...
| 6 | `SVR` | `SVR` | 103.265 | 0.138346 | 0.248620 |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/open_cell_repair/shared/2026-04-13-22-08-40__exact_open_cell_paper_family_reference_campaign_run/onnx_export`;
- exported file count: `120`;
...
- extra exported relative paths: `120`;
- failed exports: `0`;
- surrogate exports: `5`;
