...
- run name: `exact_open_cell_high_order_tree_repair`;
- output run name: `exact_open_cell_high_order_tree_repair_campaign_run`;
- run instance id: `2026-04-13-22-08-18__exact_open_cell_high_order_tree_repair_campaign_run`;
...
| 2 | `ERT` | `ExtraTreesRegressor` | 21.017 | 0.054424 | 0.139747 |
| 3 | `ET` | `ExtraTreeRegressor` | 35.903 | 0.075773 | 0.178675 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_0` | `ET` | `ExtraTreeRegressor` | 11.189 | 0.003385 | 0.004280 |
| `fft_y_Fw_filtered_ampl_1` | `ERT` | `ExtraTreesRegressor` | 0.153 | 0.000026 | 0.000037 |
| `fft_y_Fw_filtered_ampl_3` | `RF` | `RandomForestRegressor` | 2.327 | 0.000019 | 0.000027 |
| `fft_y_Fw_filtered_ampl_39` | `ERT` | `ExtraTreesRegressor` | 2.372 | 0.000027 | 0.000038 |
| `fft_y_Fw_filtered_ampl_40` | `RF` | `RandomForestRegressor` | 2.778 | 0.000022 | 0.000033 |
| `fft_y_Fw_filtered_ampl_78` | `ERT` | `ExtraTreesRegressor` | 10.703 | 0.000036 | 0.000052 |
...
| `fft_y_Fw_filtered_phase_1` | `RF` | `RandomForestRegressor` | 23.309 | 0.001943 | 0.002667 |
| `fft_y_Fw_filtered_phase_3` | `RF` | `RandomForestRegressor` | 1.377 | 0.024668 | 0.035052 |
| `fft_y_Fw_filtered_phase_39` | `RF` | `RandomForestRegressor` | 2.059 | 0.026849 | 0.048313 |
...
| `fft_y_Fw_filtered_phase_156` | `ET` | `ExtraTreeRegressor` | 55.218 | 0.607909 | 1.219648 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_0` | `SVR` | `ET` | 11.189 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_0` | `SVR` | `ERT` | 0.000 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_1` | `RF / LGBM` | `ERT` | 0.153 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_1` | `RF / LGBM` | `RF` | 23.309 | `matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_3` | `HGBM` | `RF` | 2.327 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_3` | `HGBM` | `RF` | 1.377 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_39` | `HGBM` | `ERT` | 2.372 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_39` | `HGBM` | `RF` | 2.059 | `not_matched_expected_family_direction` |
...
| `fft_y_Fw_filtered_ampl_78` | `HGBM / RF` | `ERT` | 10.703 | `not_matched_expected_family_direction` |
...
| `fft_y_Fw_filtered_phase_156` | `ERT / RF` | `ET` | 55.218 | `not_matched_expected_family_direction` |
...
| ---: | --- | --- | --- | ---: | --- |
| `0` | `SVR` | `ET` | `ERT` | 0/2 | `no_family_direction_match` |
| `1` | `RF / LGBM` | `ERT` | `RF` | 1/2 | `partial_family_direction_match` |
| `3` | `HGBM` | `RF` | `RF` | 0/2 | `no_family_direction_match` |
| `39` | `HGBM` | `ERT` | `RF` | 0/2 | `no_family_direction_match` |
| `40` | `ERT / GBM` | `RF` | `ERT` | 1/2 | `partial_family_direction_match` |
| `78` | `HGBM / RF` | `ERT` | `RF` | 1/2 | `partial_family_direction_match` |
| `81` | `RF` | `ERT` | `RF` | 1/2 | `partial_family_direction_match` |
| `156` | `ERT / RF` | `ERT` | `ET` | 1/2 | `partial_family_direction_match` |
...
| `Repo Best Family` | `RF` | `RF` | `RF` | `RF` | `RF` | `ERT` | `RF` | `ERT` | `ERT` | `RF` |
| `Repo Best RMSE` | 0.004114 | 3.72e-05 | 2.73e-05 | 3.74e-05 | 3.28e-05 | 5.21e-05 | 1.82e-05 | 1.05e-04 | 1.44e-04 | 5.47e-05 |
...
| `Gap Vs Paper` | 8.14e-04 | 2.16e-06 | 2.26e-06 | 5.37e-06 | -3.24e-06 | 7.09e-06 | 3.22e-06 | -2.46e-05 | -1.64e-05 | 1.27e-05 |
| `Status` | `above_paper_target` | `above_paper_target` | `above_paper_target` | `above_paper_target` | `met_paper_target` | `above_paper_target` | `above_paper_target` | `met_paper_target` | `met_paper_target` | `above_paper_target` |
...
| `Repo Best Family` | `RF` | `RF` | `RF` | `ERT` | `RF` | `RF` | `ERT` | `ERT` | `ERT` |
| `Repo Best MAE` | 0.001943 | 0.0247 | 0.0268 | 0.0345 | 0.0516 | 0.0480 | 0.3967 | 0.2125 | 0.2699 |
...
| `Gap Vs Paper` | 1.43e-04 | 0.004668 | 0.005849 | -0.001478 | -0.0224 | -0.005021 | -0.1133 | 0.0125 | 0.0399 |
...
| `Repo Best Family` | `RF` | `RF` | `RF` | `ERT` | `RF` | `RF` | `ERT` | `ERT` | `ET` |
| `Repo Best RMSE` | 0.002667 | 0.0351 | 0.0483 | 0.0541 | 0.1250 | 0.0681 | 0.9129 | 0.7186 | 0.7295 |
...
| `Gap Vs Paper` | 1.67e-04 | 0.006052 | 0.0213 | -8.81e-04 | -0.0350 | -0.0139 | -0.2871 | 0.0786 | 0.1495 |
| `Status` | `above_paper_target` | `above_paper_target` | `above_paper_target` | `met_paper_target` | `met_paper_target` | `met_paper_target` | `met_paper_target` | `above_paper_target` | `above_paper_target` |
...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `0` | `SVM` | `RF` | `above_paper_target` | `-` | `ERT` | `ERT` | `not_applicable` | `not_applicable` | `not_yet_matched_tables_3_6` |
| `1` | `RF` | `RF` | `above_paper_target` | `LGBM` | `RF` | `RF` | `above_paper_target` | `above_paper_target` | `partially_matched_tables_3_6` |
| `3` | `HGBM` | `RF` | `above_paper_target` | `HGBM` | `RF` | `RF` | `above_paper_target` | `above_paper_target` | `not_yet_matched_tables_3_6` |
| `39` | `HGBM` | `RF` | `above_paper_target` | `HGBM` | `RF` | `RF` | `above_paper_target` | `above_paper_target` | `not_yet_matched_tables_3_6` |
| `40` | `ERT` | `RF` | `met_paper_target` | `GBM` | `ERT` | `ERT` | `met_paper_target` | `met_paper_target` | `partially_matched_tables_3_6` |
| `78` | `HGBM` | `ERT` | `above_paper_target` | `RF` | `RF` | `RF` | `met_paper_target` | `met_paper_target` | `partially_matched_tables_3_6` |
...
| `240` | `ERT` | `RF` | `above_paper_target` | `ERT` | `ERT` | `ET` | `above_paper_target` | `above_paper_target` | `not_yet_matched_tables_3_6` |

## ONNX Export Surface

- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/open_cell_repair/shared/2026-04-13-22-08-18__exact_open_cell_high_order_tree_repair_campaign_run/onnx_export`;
- exported file count: `60`;
...
- extra exported relative paths: `60`;
- failed exports: `0`;
- surrogate exports: `0`;
