...
- model type: `exact_paper_family_bank_amplitude_phase_reference`;
- run name: `exact_paper_amplitude_phase_reference`;
- output run name: `exact_paper_amplitude_phase_reference_campaign_run`;
- run instance id: `2026-04-11-13-09-53__exact_paper_amplitude_phase_reference_campaign_run`;
...
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/baseline_reproduction/shared/2026-04-11-13-09-53__exact_paper_amplitude_phase_reference_campaign_run/onnx_export`;
