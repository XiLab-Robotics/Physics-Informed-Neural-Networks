...
- run name: `track1_ert_phase_162_closure_attempt_07`;
- output run name: `track1_ert_phase_162_closure_attempt_07_campaign_run`;
- run instance id: `2026-04-21-11-06-29__track1_ert_phase_162_closure_attempt_07_campaign_run`;
...
- winning best params: `{'estimator__criterion': 'absolute_error', 'estimator__max_depth': 18, 'estimator__min_samples_split': 2, 'estimator__n_estimators': 100}`;
- winning mean component MAPE: `10.224%`;
- winning mean component MAE: `0.207660`;
- winning mean component RMSE: `0.572831`;
...
| --- | --- | ---: | ---: | --- |
| `ERT` | `paper_reference_grid_search` | 5 | 0.785972 | `{'estimator__criterion': 'absolute_error', 'estimator__max_depth': 18, 'estimator__min_samples_split': 2, 'estimator__n_estimators': 100}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ERT` | `ExtraTreesRegressor` | `paper_reference_grid_search` | 10.224 | 0.207660 | 0.572831 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_162` | `ERT` | `ExtraTreesRegressor` | 10.224 | 0.207660 | 0.572831 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_162` | `ERT` | `ERT` | 10.224 | `matched_expected_family_direction` |
...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `162` | `-` | `-` | `-` | `ERT` | `ERT` | `ERT` | `above_paper_target` | `met_paper_target` | `partially_matched_tables_3_6` |

## ONNX Export Surface

- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/ert/2026-04-21-11-06-29__track1_ert_phase_162_closure_attempt_07_campaign_run/onnx_export`;
