...
- run name: `track1_rf_phase_40_closure_attempt_05`;
- output run name: `track1_rf_phase_40_closure_attempt_05_campaign_run`;
- run instance id: `2026-04-19-02-51-16__track1_rf_phase_40_closure_attempt_05_campaign_run`;
...
- winning mean component MAPE: `39.918%`;
- winning mean component MAE: `0.031124`;
- winning mean component RMSE: `0.046008`;
...
| --- | --- | ---: | ---: | --- |
| `RF` | `paper_reference_grid_search` | 5 | 0.768502 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 3, 'estimator__n_estimators': 60}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `RF` | `RandomForestRegressor` | `paper_reference_grid_search` | 39.918 | 0.031124 | 0.046008 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_40` | `RF` | `RandomForestRegressor` | 39.918 | 0.031124 | 0.046008 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_40` | `ERT / GBM` | `RF` | 39.918 | `not_matched_expected_family_direction` |
...
| `Repo Best Family` | - | - | - | `RF` | - | - | - | - | - |
| `Repo Best RMSE` | - | - | - | 0.0460 | - | - | - | - | - |
| `Paper Best Family` | - | - | - | `GBM` | - | - | - | - | - |
| `Paper Target RMSE` | - | - | - | 0.0550 | - | - | - | - | - |
| `Gap Vs Paper` | - | - | - | -0.008992 | - | - | - | - | - |
| `Status` | - | - | - | `met_paper_target` | - | - | - | - | - |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/rf/2026-04-19-02-51-16__track1_rf_phase_40_closure_attempt_05_campaign_run/onnx_export`;
