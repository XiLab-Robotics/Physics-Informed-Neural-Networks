...
- run name: `track1_rf_phase_81_closure_attempt_01`;
- output run name: `track1_rf_phase_81_closure_attempt_01_campaign_run`;
- run instance id: `2026-04-19-02-54-32__track1_rf_phase_81_closure_attempt_01_campaign_run`;
...
- winning mean component MAPE: `4.181%`;
- winning mean component MAE: `0.047220`;
- winning mean component RMSE: `0.066022`;
...
| --- | --- | ---: | ---: | --- |
| `RF` | `paper_reference_grid_search` | 5 | 0.969397 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 12, 'estimator__min_samples_split': 2, 'estimator__n_estimators': 60}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `RF` | `RandomForestRegressor` | `paper_reference_grid_search` | 4.181 | 0.047220 | 0.066022 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_81` | `RF` | `RandomForestRegressor` | 4.181 | 0.047220 | 0.066022 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_81` | `RF` | `RF` | 4.181 | `matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/rf/2026-04-19-02-54-32__track1_rf_phase_81_closure_attempt_01_campaign_run/onnx_export`;
