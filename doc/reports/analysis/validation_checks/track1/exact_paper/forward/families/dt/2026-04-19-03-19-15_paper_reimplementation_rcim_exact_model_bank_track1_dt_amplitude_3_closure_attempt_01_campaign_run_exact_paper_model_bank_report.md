...
- run name: `track1_dt_amplitude_3_closure_attempt_01`;
- output run name: `track1_dt_amplitude_3_closure_attempt_01_campaign_run`;
- run instance id: `2026-04-19-03-19-08__track1_dt_amplitude_3_closure_attempt_01_campaign_run`;
...
- winning mean component MAPE: `2.811%`;
...
| --- | --- | ---: | ---: | --- |
| `DT` | `paper_reference_grid_search` | 5 | 0.952369 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 6}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `DT` | `DecisionTreeRegressor` | `paper_reference_grid_search` | 2.811 | 0.000023 | 0.000033 |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/dt/2026-04-19-03-19-08__track1_dt_amplitude_3_closure_attempt_01_campaign_run/onnx_export`;
