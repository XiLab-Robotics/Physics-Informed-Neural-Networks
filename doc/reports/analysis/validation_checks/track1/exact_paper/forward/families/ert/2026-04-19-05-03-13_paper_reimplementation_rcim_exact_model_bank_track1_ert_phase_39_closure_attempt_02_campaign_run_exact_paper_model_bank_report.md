...
- run name: `track1_ert_phase_39_closure_attempt_02`;
- output run name: `track1_ert_phase_39_closure_attempt_02_campaign_run`;
- run instance id: `2026-04-19-05-02-56__track1_ert_phase_39_closure_attempt_02_campaign_run`;
...
- winning best params: `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 15, 'estimator__min_samples_split': 4, 'estimator__n_estimators': 80}`;
- winning mean component MAPE: `2.122%`;
- winning mean component MAE: `0.026941`;
- winning mean component RMSE: `0.050885`;
...
| --- | --- | ---: | ---: | --- |
| `ERT` | `paper_reference_grid_search` | 5 | 0.970094 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 15, 'estimator__min_samples_split': 4, 'estimator__n_estimators': 80}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ERT` | `ExtraTreesRegressor` | `paper_reference_grid_search` | 2.122 | 0.026941 | 0.050885 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_39` | `ERT` | `ExtraTreesRegressor` | 2.122 | 0.026941 | 0.050885 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_39` | `HGBM` | `ERT` | 2.122 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/ert/2026-04-19-05-02-56__track1_ert_phase_39_closure_attempt_02_campaign_run/onnx_export`;
