...
- run name: `track1_hgbm_amplitude_81_closure_attempt_01`;
- output run name: `track1_hgbm_amplitude_81_closure_attempt_01_campaign_run`;
- run instance id: `2026-04-19-06-30-39__track1_hgbm_amplitude_81_closure_attempt_01_campaign_run`;
...
- winning mean component MAPE: `3.738%`;
...
| --- | --- | ---: | ---: | --- |
| `HGBM` | `paper_reference_grid_search` | 5 | 0.934386 | `{'estimator__learning_rate': 0.22, 'estimator__max_depth': 10, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 24}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `HGBM` | `HistGradientBoostingRegressor` | `paper_reference_grid_search` | 3.738 | 0.000012 | 0.000019 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_81` | `HGBM` | `HistGradientBoostingRegressor` | 3.738 | 0.000012 | 0.000019 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_81` | `RF` | `HGBM` | 3.738 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/hgbm/2026-04-19-06-30-39__track1_hgbm_amplitude_81_closure_attempt_01_campaign_run/onnx_export`;
