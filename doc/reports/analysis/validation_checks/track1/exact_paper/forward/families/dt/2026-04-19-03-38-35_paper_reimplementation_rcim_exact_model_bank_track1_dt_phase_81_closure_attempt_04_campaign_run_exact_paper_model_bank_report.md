...
- run name: `track1_dt_phase_81_closure_attempt_04`;
- output run name: `track1_dt_phase_81_closure_attempt_04_campaign_run`;
- run instance id: `2026-04-19-03-38-27__track1_dt_phase_81_closure_attempt_04_campaign_run`;
...
- winning mean component MAE: `0.065134`;
- winning mean component RMSE: `0.081879`;
...
| --- | --- | ---: | ---: | --- |
| `DT` | `paper_reference_grid_search` | 5 | 0.947646 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 7}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `DT` | `DecisionTreeRegressor` | `paper_reference_grid_search` | 5.354 | 0.065134 | 0.081879 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_81` | `DT` | `DecisionTreeRegressor` | 5.354 | 0.065134 | 0.081879 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_81` | `RF` | `DT` | 5.354 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/dt/2026-04-19-03-38-27__track1_dt_phase_81_closure_attempt_04_campaign_run/onnx_export`;
