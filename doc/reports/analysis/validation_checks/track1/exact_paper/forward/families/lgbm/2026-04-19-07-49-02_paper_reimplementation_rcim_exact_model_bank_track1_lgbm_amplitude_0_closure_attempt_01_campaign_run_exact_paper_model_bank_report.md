...
- run name: `track1_lgbm_amplitude_0_closure_attempt_01`;
- output run name: `track1_lgbm_amplitude_0_closure_attempt_01_campaign_run`;
- run instance id: `2026-04-19-07-47-39__track1_lgbm_amplitude_0_closure_attempt_01_campaign_run`;
...
- winning mean component MAPE: `10.877%`;
- winning mean component MAE: `0.002490`;
- winning mean component RMSE: `0.003652`;
...
| --- | --- | ---: | ---: | --- |
| `LGBM` | `paper_reference_grid_search` | 5 | 0.976310 | `{'estimator__learning_rate': 0.2, 'estimator__max_depth': 10, 'estimator__num_leaves': 10, 'estimator__subsample': 0.001}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `LGBM` | `LGBMRegressor` | `paper_reference_grid_search` | 10.877 | 0.002490 | 0.003652 |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/lgbm/2026-04-19-07-47-39__track1_lgbm_amplitude_0_closure_attempt_01_campaign_run/onnx_export`;
