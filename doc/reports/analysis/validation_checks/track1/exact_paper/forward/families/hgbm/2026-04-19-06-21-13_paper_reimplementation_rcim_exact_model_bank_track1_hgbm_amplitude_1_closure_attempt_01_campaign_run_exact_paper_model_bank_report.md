...
- run name: `track1_hgbm_amplitude_1_closure_attempt_01`;
- output run name: `track1_hgbm_amplitude_1_closure_attempt_01_campaign_run`;
- run instance id: `2026-04-19-06-21-00__track1_hgbm_amplitude_1_closure_attempt_01_campaign_run`;
...
- winning mean component MAPE: `0.150%`;
...
| --- | --- | ---: | ---: | --- |
| `HGBM` | `paper_reference_grid_search` | 5 | 0.725450 | `{'estimator__learning_rate': 0.18, 'estimator__max_depth': 13, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 25}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `HGBM` | `HistGradientBoostingRegressor` | `paper_reference_grid_search` | 0.150 | 0.000026 | 0.000035 |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/hgbm/2026-04-19-06-21-00__track1_hgbm_amplitude_1_closure_attempt_01_campaign_run/onnx_export`;
