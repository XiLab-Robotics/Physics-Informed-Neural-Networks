...
- run name: `track1_dt_amplitude_40_closure_attempt_04`;
- output run name: `track1_dt_amplitude_40_closure_attempt_04_campaign_run`;
- run instance id: `2026-04-19-03-22-42__track1_dt_amplitude_40_closure_attempt_04_campaign_run`;
...
- winning mean component MAPE: `3.206%`;
...
| --- | --- | ---: | ---: | --- |
| `DT` | `paper_reference_grid_search` | 5 | 0.732902 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 7}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `DT` | `DecisionTreeRegressor` | `paper_reference_grid_search` | 3.206 | 0.000026 | 0.000037 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_40` | `DT` | `DecisionTreeRegressor` | 3.206 | 0.000026 | 0.000037 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_40` | `ERT / GBM` | `DT` | 3.206 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/dt/2026-04-19-03-22-42__track1_dt_amplitude_40_closure_attempt_04_campaign_run/onnx_export`;
