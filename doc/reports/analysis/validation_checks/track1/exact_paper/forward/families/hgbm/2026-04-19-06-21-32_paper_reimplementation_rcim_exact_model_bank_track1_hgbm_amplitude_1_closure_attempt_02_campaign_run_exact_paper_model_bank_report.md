...
- run name: `track1_hgbm_amplitude_1_closure_attempt_02`;
- output run name: `track1_hgbm_amplitude_1_closure_attempt_02_campaign_run`;
- run instance id: `2026-04-19-06-21-19__track1_hgbm_amplitude_1_closure_attempt_02_campaign_run`;
...
| --- | --- | ---: | ---: | --- |
| `HGBM` | `paper_reference_grid_search` | 5 | 0.713320 | `{'estimator__learning_rate': 0.18, 'estimator__max_depth': 9, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 24}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `HGBM` | `HistGradientBoostingRegressor` | `paper_reference_grid_search` | 0.141 | 0.000024 | 0.000032 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_1` | `HGBM` | `HistGradientBoostingRegressor` | 0.141 | 0.000024 | 0.000032 |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/hgbm/2026-04-19-06-21-19__track1_hgbm_amplitude_1_closure_attempt_02_campaign_run/onnx_export`;
