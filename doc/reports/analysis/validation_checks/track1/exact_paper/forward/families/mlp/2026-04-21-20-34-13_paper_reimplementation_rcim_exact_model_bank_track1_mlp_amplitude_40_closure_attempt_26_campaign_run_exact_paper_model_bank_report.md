...
- run name: `track1_mlp_amplitude_40_closure_attempt_26`;
- output run name: `track1_mlp_amplitude_40_closure_attempt_26_campaign_run`;
- run instance id: `2026-04-21-20-34-03__track1_mlp_amplitude_40_closure_attempt_26_campaign_run`;
...
- winning mean component MAPE: `1603.654%`;
- winning mean component MAE: `0.013303`;
- winning mean component RMSE: `0.018874`;
...
| --- | --- | ---: | ---: | --- |
| `MLP` | `paper_reference_grid_search` | 5 | -114445.842210 | `{'estimator__activation': 'tanh', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (200, 50), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `MLP` | `MLPRegressor` | `paper_reference_grid_search` | 1603.654 | 0.013303 | 0.018874 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_40` | `MLP` | `MLPRegressor` | 1603.654 | 0.013303 | 0.018874 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_40` | `ERT / GBM` | `MLP` | 1603.654 | `not_matched_expected_family_direction` |
...
| `Repo Best RMSE` | - | - | - | - | 0.0189 | - | - | - | - | - |
| `Paper Best Family` | - | - | - | - | `ERT` | - | - | - | - | - |
| `Paper Target RMSE` | - | - | - | - | 3.60e-05 | - | - | - | - | - |
| `Gap Vs Paper` | - | - | - | - | 0.0188 | - | - | - | - | - |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/mlp/2026-04-21-20-34-03__track1_mlp_amplitude_40_closure_attempt_26_campaign_run/onnx_export`;
