...
- run name: `track1_mlp_phase_162_final_closure_attempt_49`;
- output run name: `track1_mlp_phase_162_final_closure_attempt_49_campaign_run`;
- run instance id: `2026-04-22-00-38-02__track1_mlp_phase_162_final_closure_attempt_49_campaign_run`;
...
- winning mean component MAPE: `52.608%`;
- winning mean component MAE: `1.104786`;
- winning mean component RMSE: `1.569252`;
...
| --- | --- | ---: | ---: | --- |
| `MLP` | `paper_reference_grid_search` | 5 | 0.165043 | `{'estimator__activation': 'relu', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (100,), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `MLP` | `MLPRegressor` | `paper_reference_grid_search` | 52.608 | 1.104786 | 1.569252 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_162` | `MLP` | `MLPRegressor` | 52.608 | 1.104786 | 1.569252 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_162` | `ERT` | `MLP` | 52.608 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/mlp/2026-04-22-00-38-02__track1_mlp_phase_162_final_closure_attempt_49_campaign_run/onnx_export`;
