...
- run name: `track1_mlp_amplitude_1_final_closure_attempt_52`;
- output run name: `track1_mlp_amplitude_1_final_closure_attempt_52_campaign_run`;
- run instance id: `2026-04-21-23-54-48__track1_mlp_amplitude_1_final_closure_attempt_52_campaign_run`;
...
- winning mean component MAPE: `98.209%`;
- winning mean component MAE: `0.016878`;
- winning mean component RMSE: `0.026638`;
...
| --- | --- | ---: | ---: | --- |
| `MLP` | `paper_reference_grid_search` | 5 | -140204.192622 | `{'estimator__activation': 'tanh', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (200, 50), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `MLP` | `MLPRegressor` | `paper_reference_grid_search` | 98.209 | 0.016878 | 0.026638 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_1` | `MLP` | `MLPRegressor` | 98.209 | 0.016878 | 0.026638 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_1` | `RF / LGBM` | `MLP` | 98.209 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/mlp/2026-04-21-23-54-48__track1_mlp_amplitude_1_final_closure_attempt_52_campaign_run/onnx_export`;
