...
- run name: `track1_lgbm_phase_81_closure_attempt_06`;
- output run name: `track1_lgbm_phase_81_closure_attempt_06_campaign_run`;
- run instance id: `2026-04-19-10-10-17__track1_lgbm_phase_81_closure_attempt_06_campaign_run`;
...
- winning mean component MAPE: `5.216%`;
- winning mean component MAE: `0.049105`;
- winning mean component RMSE: `0.067872`;
...
| --- | --- | ---: | ---: | --- |
| `LGBM` | `paper_reference_grid_search` | 5 | 0.962089 | `{'estimator__learning_rate': 0.39, 'estimator__max_depth': 12, 'estimator__num_leaves': 31, 'estimator__subsample': 0.001}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `LGBM` | `LGBMRegressor` | `paper_reference_grid_search` | 5.216 | 0.049105 | 0.067872 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_81` | `LGBM` | `LGBMRegressor` | 5.216 | 0.049105 | 0.067872 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_81` | `RF` | `LGBM` | 5.216 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/lgbm/2026-04-19-10-10-17__track1_lgbm_phase_81_closure_attempt_06_campaign_run/onnx_export`;
