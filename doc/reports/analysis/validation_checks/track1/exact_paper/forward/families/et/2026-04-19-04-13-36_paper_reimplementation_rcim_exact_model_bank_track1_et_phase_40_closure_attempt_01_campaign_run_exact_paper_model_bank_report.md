...
- run name: `track1_et_phase_40_closure_attempt_01`;
- output run name: `track1_et_phase_40_closure_attempt_01_campaign_run`;
- run instance id: `2026-04-19-04-13-28__track1_et_phase_40_closure_attempt_01_campaign_run`;
...
- winning mean component MAPE: `87.375%`;
- winning mean component MAE: `0.051353`;
- winning mean component RMSE: `0.085967`;
...
| --- | --- | ---: | ---: | --- |
| `ET` | `paper_reference_grid_search` | 5 | 0.621141 | `{'estimator__criterion': 'absolute_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 6}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ET` | `ExtraTreeRegressor` | `paper_reference_grid_search` | 87.375 | 0.051353 | 0.085967 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_40` | `ET` | `ExtraTreeRegressor` | 87.375 | 0.051353 | 0.085967 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_40` | `ERT / GBM` | `ET` | 87.375 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/et/2026-04-19-04-13-28__track1_et_phase_40_closure_attempt_01_campaign_run/onnx_export`;
