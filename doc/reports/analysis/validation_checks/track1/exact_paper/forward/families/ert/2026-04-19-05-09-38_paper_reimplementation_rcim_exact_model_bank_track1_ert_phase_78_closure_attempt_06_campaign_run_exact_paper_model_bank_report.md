...
- run name: `track1_ert_phase_78_closure_attempt_06`;
- output run name: `track1_ert_phase_78_closure_attempt_06_campaign_run`;
- run instance id: `2026-04-19-05-09-21__track1_ert_phase_78_closure_attempt_06_campaign_run`;
...
- winning best params: `{'estimator__criterion': 'absolute_error', 'estimator__max_depth': 15, 'estimator__min_samples_split': 6, 'estimator__n_estimators': 60}`;
- winning mean component MAPE: `136.697%`;
- winning mean component MAE: `0.073675`;
- winning mean component RMSE: `0.167142`;
...
| --- | --- | ---: | ---: | --- |
| `ERT` | `paper_reference_grid_search` | 5 | 0.748779 | `{'estimator__criterion': 'absolute_error', 'estimator__max_depth': 15, 'estimator__min_samples_split': 6, 'estimator__n_estimators': 60}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ERT` | `ExtraTreesRegressor` | `paper_reference_grid_search` | 136.697 | 0.073675 | 0.167142 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_78` | `ERT` | `ExtraTreesRegressor` | 136.697 | 0.073675 | 0.167142 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_78` | `HGBM / RF` | `ERT` | 136.697 | `not_matched_expected_family_direction` |
...
| `Repo Best Family` | - | - | - | - | `ERT` | - | - | - | - |
| `Repo Best MAE` | - | - | - | - | 0.0737 | - | - | - | - |
| `Paper Best Family` | - | - | - | - | `GBM` | - | - | - | - |
| `Paper Target MAE` | - | - | - | - | 0.0740 | - | - | - | - |
| `Gap Vs Paper` | - | - | - | - | -3.25e-04 | - | - | - | - |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/ert/2026-04-19-05-09-21__track1_ert_phase_78_closure_attempt_06_campaign_run/onnx_export`;
