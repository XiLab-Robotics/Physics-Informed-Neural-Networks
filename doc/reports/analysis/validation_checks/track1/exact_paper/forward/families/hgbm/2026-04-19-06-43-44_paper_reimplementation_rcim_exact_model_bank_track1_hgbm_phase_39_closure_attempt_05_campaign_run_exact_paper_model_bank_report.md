...
- run name: `track1_hgbm_phase_39_closure_attempt_05`;
- output run name: `track1_hgbm_phase_39_closure_attempt_05_campaign_run`;
- run instance id: `2026-04-19-06-43-31__track1_hgbm_phase_39_closure_attempt_05_campaign_run`;
...
- winning mean component MAPE: `1.517%`;
- winning mean component MAE: `0.019319`;
- winning mean component RMSE: `0.030802`;
...
| --- | --- | ---: | ---: | --- |
| `HGBM` | `paper_reference_grid_search` | 5 | 0.984066 | `{'estimator__learning_rate': 0.22, 'estimator__max_depth': 13, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 26}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `HGBM` | `HistGradientBoostingRegressor` | `paper_reference_grid_search` | 1.517 | 0.019319 | 0.030802 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_39` | `HGBM` | `HistGradientBoostingRegressor` | 1.517 | 0.019319 | 0.030802 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_39` | `HGBM` | `HGBM` | 1.517 | `matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/hgbm/2026-04-19-06-43-31__track1_hgbm_phase_39_closure_attempt_05_campaign_run/onnx_export`;
