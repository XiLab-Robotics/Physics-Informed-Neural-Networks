...
- run name: `track1_et_phase_162_closure_attempt_06`;
- output run name: `track1_et_phase_162_closure_attempt_06_campaign_run`;
- run instance id: `2026-04-19-04-20-24__track1_et_phase_162_closure_attempt_06_campaign_run`;
...
- winning mean component MAPE: `12.480%`;
- winning mean component MAE: `0.275376`;
- winning mean component RMSE: `1.084189`;
...
| --- | --- | ---: | ---: | --- |
| `ET` | `paper_reference_grid_search` | 5 | 0.623912 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 2}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ET` | `ExtraTreeRegressor` | `paper_reference_grid_search` | 12.480 | 0.275376 | 1.084189 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_162` | `ET` | `ExtraTreeRegressor` | 12.480 | 0.275376 | 1.084189 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_162` | `ERT` | `ET` | 12.480 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/et/2026-04-19-04-20-24__track1_et_phase_162_closure_attempt_06_campaign_run/onnx_export`;
