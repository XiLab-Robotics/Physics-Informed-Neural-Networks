...
- run name: `track1_dt_phase_3_closure_attempt_04`;
- output run name: `track1_dt_phase_3_closure_attempt_04_campaign_run`;
- run instance id: `2026-04-19-03-32-43__track1_dt_phase_3_closure_attempt_04_campaign_run`;
...
- winning mean component MAPE: `1.692%`;
- winning mean component MAE: `0.029916`;
- winning mean component RMSE: `0.041316`;
...
| --- | --- | ---: | ---: | --- |
| `DT` | `paper_reference_grid_search` | 5 | 0.903856 | `{'estimator__criterion': 'absolute_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 6}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `DT` | `DecisionTreeRegressor` | `paper_reference_grid_search` | 1.692 | 0.029916 | 0.041316 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_3` | `DT` | `DecisionTreeRegressor` | 1.692 | 0.029916 | 0.041316 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_3` | `HGBM` | `DT` | 1.692 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/dt/2026-04-19-03-32-43__track1_dt_phase_3_closure_attempt_04_campaign_run/onnx_export`;
