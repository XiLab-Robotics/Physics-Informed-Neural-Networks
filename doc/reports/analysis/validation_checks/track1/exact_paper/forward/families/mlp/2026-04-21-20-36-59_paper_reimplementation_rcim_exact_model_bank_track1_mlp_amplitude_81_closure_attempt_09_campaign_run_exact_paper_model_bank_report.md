...
- run name: `track1_mlp_amplitude_81_closure_attempt_09`;
- output run name: `track1_mlp_amplitude_81_closure_attempt_09_campaign_run`;
- run instance id: `2026-04-21-20-36-49__track1_mlp_amplitude_81_closure_attempt_09_campaign_run`;
...
- winning mean component MAPE: `5861.783%`;
- winning mean component MAE: `0.015554`;
- winning mean component RMSE: `0.026986`;
...
| --- | --- | ---: | ---: | --- |
| `MLP` | `paper_reference_grid_search` | 5 | -141023.013190 | `{'estimator__activation': 'tanh', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (200, 50), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `MLP` | `MLPRegressor` | `paper_reference_grid_search` | 5861.783 | 0.015554 | 0.026986 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_81` | `MLP` | `MLPRegressor` | 5861.783 | 0.015554 | 0.026986 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_81` | `RF` | `MLP` | 5861.783 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/mlp/2026-04-21-20-36-49__track1_mlp_amplitude_81_closure_attempt_09_campaign_run/onnx_export`;
