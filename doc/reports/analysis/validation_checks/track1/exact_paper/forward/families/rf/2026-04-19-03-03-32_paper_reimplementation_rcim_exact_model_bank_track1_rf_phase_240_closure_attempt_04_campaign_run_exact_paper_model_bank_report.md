...
- run name: `track1_rf_phase_240_closure_attempt_04`;
- output run name: `track1_rf_phase_240_closure_attempt_04_campaign_run`;
- run instance id: `2026-04-19-03-03-15__track1_rf_phase_240_closure_attempt_04_campaign_run`;
...
- winning mean component MAPE: `10.855%`;
- winning mean component MAE: `0.190473`;
- winning mean component RMSE: `0.476228`;
...
| --- | --- | ---: | ---: | --- |
| `RF` | `paper_reference_grid_search` | 5 | 0.587536 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 12, 'estimator__min_samples_split': 2, 'estimator__n_estimators': 70}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `RF` | `RandomForestRegressor` | `paper_reference_grid_search` | 10.855 | 0.190473 | 0.476228 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_240` | `RF` | `RandomForestRegressor` | 10.855 | 0.190473 | 0.476228 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_240` | `ERT` | `RF` | 10.855 | `not_matched_expected_family_direction` |
...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `240` | `-` | `-` | `-` | `ERT` | `RF` | `RF` | `met_paper_target` | `met_paper_target` | `partially_matched_tables_3_6` |

## ONNX Export Surface

- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/rf/2026-04-19-03-03-15__track1_rf_phase_240_closure_attempt_04_campaign_run/onnx_export`;
