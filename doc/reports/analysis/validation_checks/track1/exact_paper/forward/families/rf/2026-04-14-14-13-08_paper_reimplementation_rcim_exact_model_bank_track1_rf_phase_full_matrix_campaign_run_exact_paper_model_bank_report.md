...
- winning mean component MAPE: `33.123%`;
...
| ---: | --- | --- | ---: | ---: | ---: |
| 1 | `RF` | `RandomForestRegressor` | 33.123 | 0.124699 | 0.321338 |
...
| `fft_y_Fw_filtered_phase_40` | `RF` | `RandomForestRegressor` | 65.776 | 0.036699 | 0.055130 |
...
| `fft_y_Fw_filtered_phase_156` | `RF` | `RandomForestRegressor` | 96.195 | 0.425070 | 0.964384 |
...
| `fft_y_Fw_filtered_phase_40` | `ERT / GBM` | `RF` | 65.776 | `not_matched_expected_family_direction` |
...
| `fft_y_Fw_filtered_phase_156` | `ERT / RF` | `RF` | 96.195 | `matched_expected_family_direction` |
...
| `Repo Best MAE` | 0.001943 | 0.0247 | 0.0268 | 0.0367 | 0.0516 | 0.0480 | 0.4251 | 0.2305 | 0.2770 |
...
| `Gap Vs Paper` | 1.43e-04 | 0.004668 | 0.005849 | 6.99e-04 | -0.0224 | -0.005021 | -0.0849 | 0.0305 | 0.0470 |
...
| `Repo Best Family` | `RF` | `RF` | `RF` | `RF` | `RF` | `RF` | `RF` | `RF` | `RF` |
| `Repo Best RMSE` | 0.002667 | 0.0351 | 0.0483 | 0.0551 | 0.1250 | 0.0681 | 0.9644 | 0.7472 | 0.8462 |
...
| `Gap Vs Paper` | 1.67e-04 | 0.006052 | 0.0213 | 1.30e-04 | -0.0350 | -0.0139 | -0.2356 | 0.1072 | 0.2662 |
| `Status` | `above_paper_target` | `above_paper_target` | `above_paper_target` | `above_paper_target` | `met_paper_target` | `met_paper_target` | `met_paper_target` | `above_paper_target` | `above_paper_target` |
...
| `40` | `-` | `-` | `-` | `GBM` | `RF` | `RF` | `above_paper_target` | `above_paper_target` | `not_yet_matched_tables_3_6` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/full_matrix/rf/2026-04-14-14-13-04__track1_rf_phase_full_matrix_campaign_run/onnx_export`;
