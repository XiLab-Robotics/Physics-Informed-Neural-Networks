...
- run name: `track1_dt_phase_81_closure_attempt_03`;
- output run name: `track1_dt_phase_81_closure_attempt_03_campaign_run`;
- run instance id: `2026-04-19-03-38-12__track1_dt_phase_81_closure_attempt_03_campaign_run`;
...
- winning mean component MAPE: `5.704%`;
- winning mean component MAE: `0.058548`;
- winning mean component RMSE: `0.073972`;
...
| --- | --- | ---: | ---: | --- |
| `DT` | `paper_reference_grid_search` | 5 | 0.940536 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 4}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `DT` | `DecisionTreeRegressor` | `paper_reference_grid_search` | 5.704 | 0.058548 | 0.073972 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_81` | `DT` | `DecisionTreeRegressor` | 5.704 | 0.058548 | 0.073972 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_81` | `RF` | `DT` | 5.704 | `not_matched_expected_family_direction` |
...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `81` | `-` | `-` | `-` | `RF` | `DT` | `DT` | `above_paper_target` | `met_paper_target` | `partially_matched_tables_3_6` |

## ONNX Export Surface

- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/dt/2026-04-19-03-38-12__track1_dt_phase_81_closure_attempt_03_campaign_run/onnx_export`;
