...
- run name: `track1_mlp_amplitude_162_closure_attempt_01`;
- output run name: `track1_mlp_amplitude_162_closure_attempt_01_campaign_run`;
- run instance id: `2026-04-19-01-48-38__track1_mlp_amplitude_162_closure_attempt_01_campaign_run`;
...
- winning mean component MAPE: `5132.886%`;
- winning mean component MAE: `0.007446`;
- winning mean component RMSE: `0.012974`;
...
| --- | --- | ---: | ---: | --- |
| `MLP` | `paper_reference_grid_search` | 5 | -146.064392 | `{'estimator__activation': 'tanh', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (200, 50), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `MLP` | `MLPRegressor` | `paper_reference_grid_search` | 5132.886 | 0.007446 | 0.012974 |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/mlp/2026-04-19-01-48-38__track1_mlp_amplitude_162_closure_attempt_01_campaign_run/onnx_export`;
