...
- run name: `track1_dt_phase_1_closure_attempt_10`;
- output run name: `track1_dt_phase_1_closure_attempt_10_campaign_run`;
- run instance id: `2026-04-21-10-04-17__track1_dt_phase_1_closure_attempt_10_campaign_run`;
...
- winning mean component MAPE: `23.892%`;
- winning mean component MAE: `0.002098`;
- winning mean component RMSE: `0.003191`;
...
| --- | --- | ---: | ---: | --- |
| `DT` | `paper_reference_grid_search` | 5 | 0.568501 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 8}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `DT` | `DecisionTreeRegressor` | `paper_reference_grid_search` | 23.892 | 0.002098 | 0.003191 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_1` | `DT` | `DecisionTreeRegressor` | 23.892 | 0.002098 | 0.003191 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_1` | `RF / LGBM` | `DT` | 23.892 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/dt/2026-04-21-10-04-17__track1_dt_phase_1_closure_attempt_10_campaign_run/onnx_export`;
