...
- run name: `track1_xgbm_amplitude_78_closure_attempt_06`;
- output run name: `track1_xgbm_amplitude_78_closure_attempt_06_campaign_run`;
- run instance id: `2026-04-19-07-15-53__track1_xgbm_amplitude_78_closure_attempt_06_campaign_run`;
...
- winning mean component MAPE: `42.499%`;
- winning mean component MAE: `0.000126`;
...
| --- | --- | ---: | ---: | --- |
| `XGBM` | `paper_reference_grid_search` | 5 | 0.918047 | `{'estimator__colsample_bytree': 0.3, 'estimator__learning_rate': 0.5, 'estimator__max_depth': 14}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `XGBM` | `XGBRegressor` | `paper_reference_grid_search` | 42.499 | 0.000126 | 0.000165 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_78` | `XGBM` | `XGBRegressor` | 42.499 | 0.000126 | 0.000165 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_78` | `HGBM / RF` | `XGBM` | 42.499 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/xgbm/2026-04-19-07-15-53__track1_xgbm_amplitude_78_closure_attempt_06_campaign_run/onnx_export`;
