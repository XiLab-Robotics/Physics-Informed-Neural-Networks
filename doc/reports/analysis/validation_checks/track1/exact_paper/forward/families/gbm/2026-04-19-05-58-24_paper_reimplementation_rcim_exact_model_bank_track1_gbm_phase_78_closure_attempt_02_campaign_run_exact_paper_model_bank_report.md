...
- run name: `track1_gbm_phase_78_closure_attempt_02`;
- output run name: `track1_gbm_phase_78_closure_attempt_02_campaign_run`;
- run instance id: `2026-04-19-05-58-11__track1_gbm_phase_78_closure_attempt_02_campaign_run`;
...
- winning mean component MAPE: `59.610%`;
- winning mean component MAE: `0.081968`;
- winning mean component RMSE: `0.126608`;
...
| --- | --- | ---: | ---: | --- |
| `GBM` | `paper_reference_grid_search` | 5 | 0.784095 | `{'estimator__criterion': 'squared_error', 'estimator__learning_rate': 0.1, 'estimator__max_depth': 15, 'estimator__min_samples_split': 14, 'estimator__n_estimators': 20}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `GBM` | `GradientBoostingRegressor` | `paper_reference_grid_search` | 59.610 | 0.081968 | 0.126608 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_78` | `GBM` | `GradientBoostingRegressor` | 59.610 | 0.081968 | 0.126608 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_78` | `HGBM / RF` | `GBM` | 59.610 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/gbm/2026-04-19-05-58-11__track1_gbm_phase_78_closure_attempt_02_campaign_run/onnx_export`;
