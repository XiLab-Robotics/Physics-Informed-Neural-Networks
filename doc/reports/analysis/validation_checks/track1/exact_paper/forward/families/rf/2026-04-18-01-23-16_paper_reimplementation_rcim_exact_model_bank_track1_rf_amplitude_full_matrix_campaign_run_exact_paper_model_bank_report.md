...
- run name: `track1_rf_amplitude_full_matrix`;
- output run name: `track1_rf_amplitude_full_matrix_campaign_run`;
- run instance id: `2026-04-18-01-21-49__track1_rf_amplitude_full_matrix_campaign_run`;
...
- winning best params: `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 12, 'estimator__min_samples_split': 4, 'estimator__n_estimators': 90}`;
- winning mean component MAPE: `7.268%`;
- winning mean component MAE: `0.000338`;
- winning mean component RMSE: `0.000480`;
...
| --- | --- | ---: | ---: | --- |
| `RF` | `paper_reference_grid_search` | 5 | 0.921081 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 12, 'estimator__min_samples_split': 4, 'estimator__n_estimators': 90}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `RF` | `RandomForestRegressor` | `paper_reference_grid_search` | 7.268 | 0.000338 | 0.000480 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_0` | `RF` | `RandomForestRegressor` | 12.183 | 0.003085 | 0.004143 |
| `fft_y_Fw_filtered_ampl_1` | `RF` | `RandomForestRegressor` | 0.150 | 0.000026 | 0.000036 |
| `fft_y_Fw_filtered_ampl_3` | `RF` | `RandomForestRegressor` | 2.340 | 0.000019 | 0.000028 |
| `fft_y_Fw_filtered_ampl_39` | `RF` | `RandomForestRegressor` | 2.507 | 0.000028 | 0.000038 |
| `fft_y_Fw_filtered_ampl_40` | `RF` | `RandomForestRegressor` | 2.786 | 0.000022 | 0.000033 |
| `fft_y_Fw_filtered_ampl_78` | `RF` | `RandomForestRegressor` | 11.259 | 0.000039 | 0.000059 |
| `fft_y_Fw_filtered_ampl_81` | `RF` | `RandomForestRegressor` | 3.592 | 0.000011 | 0.000019 |
| `fft_y_Fw_filtered_ampl_156` | `RF` | `RandomForestRegressor` | 17.314 | 0.000060 | 0.000221 |
| `fft_y_Fw_filtered_ampl_162` | `RF` | `RandomForestRegressor` | 8.746 | 0.000057 | 0.000165 |
| `fft_y_Fw_filtered_ampl_240` | `RF` | `RandomForestRegressor` | 11.798 | 0.000036 | 0.000056 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_0` | `SVR` | `RF` | 12.183 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_1` | `RF / LGBM` | `RF` | 0.150 | `matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_3` | `HGBM` | `RF` | 2.340 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_39` | `HGBM` | `RF` | 2.507 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_40` | `ERT / GBM` | `RF` | 2.786 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_78` | `HGBM / RF` | `RF` | 11.259 | `matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_81` | `RF` | `RF` | 3.592 | `matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_156` | `ERT / RF` | `RF` | 17.314 | `matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_162` | `ERT` | `RF` | 8.746 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_240` | `ERT` | `RF` | 11.798 | `not_matched_expected_family_direction` |
...
| ---: | --- | --- | --- | ---: | --- |
| `0` | `SVR` | `RF` | `-` | 0/1 | `no_family_direction_match` |
...
| `Repo Best Family` | `RF` | `RF` | `RF` | `RF` | `RF` | `RF` | `RF` | `RF` | `RF` | `RF` |
| `Repo Best RMSE` | 0.004143 | 3.61e-05 | 2.75e-05 | 3.84e-05 | 3.28e-05 | 5.87e-05 | 1.85e-05 | 2.21e-04 | 1.65e-04 | 5.58e-05 |
...
| `Gap Vs Paper` | 8.43e-04 | 1.14e-06 | 2.55e-06 | 6.41e-06 | -3.24e-06 | 1.37e-05 | 3.53e-06 | 9.09e-05 | 5.18e-06 | 1.38e-05 |
...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `0` | `SVM` | `RF` | `above_paper_target` | `-` | `-` | `-` | `-` | `-` | `not_yet_matched_tables_3_6` |
| `1` | `RF` | `RF` | `above_paper_target` | `-` | `-` | `-` | `-` | `-` | `partially_matched_tables_3_6` |
| `3` | `HGBM` | `RF` | `above_paper_target` | `-` | `-` | `-` | `-` | `-` | `not_yet_matched_tables_3_6` |
| `39` | `HGBM` | `RF` | `above_paper_target` | `-` | `-` | `-` | `-` | `-` | `not_yet_matched_tables_3_6` |
| `40` | `ERT` | `RF` | `met_paper_target` | `-` | `-` | `-` | `-` | `-` | `partially_matched_tables_3_6` |
| `78` | `HGBM` | `RF` | `above_paper_target` | `-` | `-` | `-` | `-` | `-` | `not_yet_matched_tables_3_6` |
| `81` | `RF` | `RF` | `above_paper_target` | `-` | `-` | `-` | `-` | `-` | `partially_matched_tables_3_6` |
| `156` | `ERT` | `RF` | `above_paper_target` | `-` | `-` | `-` | `-` | `-` | `not_yet_matched_tables_3_6` |
| `162` | `ERT` | `RF` | `above_paper_target` | `-` | `-` | `-` | `-` | `-` | `not_yet_matched_tables_3_6` |
| `240` | `ERT` | `RF` | `above_paper_target` | `-` | `-` | `-` | `-` | `-` | `not_yet_matched_tables_3_6` |

## ONNX Export Surface

- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/full_matrix/rf/2026-04-18-01-21-49__track1_rf_amplitude_full_matrix_campaign_run/onnx_export`;
