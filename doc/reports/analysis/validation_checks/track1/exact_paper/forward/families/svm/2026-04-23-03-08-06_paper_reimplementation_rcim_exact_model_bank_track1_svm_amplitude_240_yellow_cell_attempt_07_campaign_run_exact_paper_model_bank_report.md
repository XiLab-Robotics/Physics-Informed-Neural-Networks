...
- run name: `track1_svm_amplitude_240_yellow_cell_attempt_07`;
- output run name: `track1_svm_amplitude_240_yellow_cell_attempt_07_campaign_run`;
- run instance id: `2026-04-23-00-56-09__track1_svm_amplitude_240_yellow_cell_attempt_07_campaign_run`;
...
- winning mean component MAPE: `71.355%`;
- winning mean component MAE: `0.000320`;
- winning mean component RMSE: `0.000609`;
...
| --- | --- | ---: | ---: | --- |
| `SVR` | `paper_reference_grid_search` | 5 | 0.144540 | `{'estimator__C': 0.1, 'estimator__epsilon': 1e-05, 'estimator__gamma': 1.1e-06, 'estimator__kernel': 'rbf'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `SVR` | `SVR` | `paper_reference_grid_search` | 71.355 | 0.000320 | 0.000609 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_240` | `SVR` | `SVR` | 71.355 | 0.000320 | 0.000609 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_240` | `ERT` | `SVR` | 71.355 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/svm_targeted_closure/svm/2026-04-23-00-56-09__track1_svm_amplitude_240_yellow_cell_attempt_07_campaign_run/onnx_export`;
