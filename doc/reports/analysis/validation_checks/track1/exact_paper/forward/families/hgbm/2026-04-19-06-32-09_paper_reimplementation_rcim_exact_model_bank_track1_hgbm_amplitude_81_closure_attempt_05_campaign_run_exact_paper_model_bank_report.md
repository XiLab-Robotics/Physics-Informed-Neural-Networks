...
- run name: `track1_hgbm_amplitude_81_closure_attempt_05`;
- output run name: `track1_hgbm_amplitude_81_closure_attempt_05_campaign_run`;
- run instance id: `2026-04-19-06-31-56__track1_hgbm_amplitude_81_closure_attempt_05_campaign_run`;
...
- winning best params: `{'estimator__learning_rate': 0.2, 'estimator__max_depth': 12, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 24}`;
- winning mean component MAPE: `3.866%`;
...
| --- | --- | ---: | ---: | --- |
| `HGBM` | `paper_reference_grid_search` | 5 | 0.940237 | `{'estimator__learning_rate': 0.2, 'estimator__max_depth': 12, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 24}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `HGBM` | `HistGradientBoostingRegressor` | `paper_reference_grid_search` | 3.866 | 0.000012 | 0.000020 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_81` | `HGBM` | `HistGradientBoostingRegressor` | 3.866 | 0.000012 | 0.000020 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_81` | `RF` | `HGBM` | 3.866 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/hgbm/2026-04-19-06-31-56__track1_hgbm_amplitude_81_closure_attempt_05_campaign_run/onnx_export`;
