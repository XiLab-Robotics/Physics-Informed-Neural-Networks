...
- run name: `track1_et_phase_240_closure_attempt_04`;
- output run name: `track1_et_phase_240_closure_attempt_04_campaign_run`;
- run instance id: `2026-04-21-10-21-53__track1_et_phase_240_closure_attempt_04_campaign_run`;
...
- winning mean component MAPE: `15.422%`;
- winning mean component MAE: `0.314620`;
- winning mean component RMSE: `1.099423`;
...
| --- | --- | ---: | ---: | --- |
| `ET` | `paper_reference_grid_search` | 5 | 0.430087 | `{'estimator__criterion': 'absolute_error', 'estimator__max_depth': 15, 'estimator__min_samples_split': 2}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ET` | `ExtraTreeRegressor` | `paper_reference_grid_search` | 15.422 | 0.314620 | 1.099423 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_240` | `ET` | `ExtraTreeRegressor` | 15.422 | 0.314620 | 1.099423 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_240` | `ERT` | `ET` | 15.422 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/et/2026-04-21-10-21-53__track1_et_phase_240_closure_attempt_04_campaign_run/onnx_export`;
