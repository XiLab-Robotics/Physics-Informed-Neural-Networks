...
- run name: `track1_xgbm_phase_240_closure_attempt_06`;
- output run name: `track1_xgbm_phase_240_closure_attempt_06_campaign_run`;
- run instance id: `2026-04-19-07-35-07__track1_xgbm_phase_240_closure_attempt_06_campaign_run`;
...
- winning mean component MAPE: `39.304%`;
- winning mean component MAE: `0.422063`;
- winning mean component RMSE: `0.849924`;
...
| --- | --- | ---: | ---: | --- |
| `XGBM` | `paper_reference_grid_search` | 5 | 0.409935 | `{'estimator__colsample_bytree': 0.8, 'estimator__learning_rate': 0.2, 'estimator__max_depth': 16}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `XGBM` | `XGBRegressor` | `paper_reference_grid_search` | 39.304 | 0.422063 | 0.849924 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_240` | `XGBM` | `XGBRegressor` | 39.304 | 0.422063 | 0.849924 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_240` | `ERT` | `XGBM` | 39.304 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/xgbm/2026-04-19-07-35-07__track1_xgbm_phase_240_closure_attempt_06_campaign_run/onnx_export`;
