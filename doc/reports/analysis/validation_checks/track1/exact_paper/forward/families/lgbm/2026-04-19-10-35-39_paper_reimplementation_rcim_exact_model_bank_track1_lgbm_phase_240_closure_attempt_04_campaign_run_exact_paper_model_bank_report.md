...
- run name: `track1_lgbm_phase_240_closure_attempt_04`;
- output run name: `track1_lgbm_phase_240_closure_attempt_04_campaign_run`;
- run instance id: `2026-04-19-10-34-16__track1_lgbm_phase_240_closure_attempt_04_campaign_run`;
...
- winning mean component MAPE: `23.960%`;
- winning mean component MAE: `0.321726`;
- winning mean component RMSE: `0.639127`;
...
| --- | --- | ---: | ---: | --- |
| `LGBM` | `paper_reference_grid_search` | 5 | 0.466363 | `{'estimator__learning_rate': 0.58, 'estimator__max_depth': 14, 'estimator__num_leaves': 31, 'estimator__subsample': 0.001}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `LGBM` | `LGBMRegressor` | `paper_reference_grid_search` | 23.960 | 0.321726 | 0.639127 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_240` | `LGBM` | `LGBMRegressor` | 23.960 | 0.321726 | 0.639127 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_240` | `ERT` | `LGBM` | 23.960 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/lgbm/2026-04-19-10-34-16__track1_lgbm_phase_240_closure_attempt_04_campaign_run/onnx_export`;
