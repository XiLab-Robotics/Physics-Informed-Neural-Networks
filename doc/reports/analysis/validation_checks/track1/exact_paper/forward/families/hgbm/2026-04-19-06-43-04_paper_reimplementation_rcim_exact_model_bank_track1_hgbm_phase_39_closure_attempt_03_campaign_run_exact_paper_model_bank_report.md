...
- run name: `track1_hgbm_phase_39_closure_attempt_03`;
- output run name: `track1_hgbm_phase_39_closure_attempt_03_campaign_run`;
- run instance id: `2026-04-19-06-42-51__track1_hgbm_phase_39_closure_attempt_03_campaign_run`;
...
- winning mean component MAPE: `1.588%`;
- winning mean component MAE: `0.019026`;
- winning mean component RMSE: `0.026049`;
...
| --- | --- | ---: | ---: | --- |
| `HGBM` | `paper_reference_grid_search` | 5 | 0.982196 | `{'estimator__learning_rate': 0.22, 'estimator__max_depth': 13, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 27}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `HGBM` | `HistGradientBoostingRegressor` | `paper_reference_grid_search` | 1.588 | 0.019026 | 0.026049 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_39` | `HGBM` | `HistGradientBoostingRegressor` | 1.588 | 0.019026 | 0.026049 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_39` | `HGBM` | `HGBM` | 1.588 | `matched_expected_family_direction` |
...
| `Repo Best Family` | - | - | `HGBM` | - | - | - | - | - | - |
| `Repo Best RMSE` | - | - | 0.0260 | - | - | - | - | - | - |
| `Paper Best Family` | - | - | `HGBM` | - | - | - | - | - | - |
| `Paper Target RMSE` | - | - | 0.0270 | - | - | - | - | - | - |
| `Gap Vs Paper` | - | - | -9.51e-04 | - | - | - | - | - | - |
| `Status` | - | - | `met_paper_target` | - | - | - | - | - | - |
...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `39` | `-` | `-` | `-` | `HGBM` | `HGBM` | `HGBM` | `met_paper_target` | `met_paper_target` | `fully_matched_tables_3_6` |

## ONNX Export Surface

- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/hgbm/2026-04-19-06-42-51__track1_hgbm_phase_39_closure_attempt_03_campaign_run/onnx_export`;
