...
- run name: `track1_mlp_phase_162_final_closure_attempt_36`;
- output run name: `track1_mlp_phase_162_final_closure_attempt_36_campaign_run`;
- run instance id: `2026-04-22-00-34-38__track1_mlp_phase_162_final_closure_attempt_36_campaign_run`;
...
- winning mean component MAPE: `69.494%`;
- winning mean component MAE: `1.231415`;
- winning mean component RMSE: `1.603734`;
...
| --- | --- | ---: | ---: | --- |
| `MLP` | `paper_reference_grid_search` | 5 | 0.263831 | `{'estimator__activation': 'tanh', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (200, 50), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `MLP` | `MLPRegressor` | `paper_reference_grid_search` | 69.494 | 1.231415 | 1.603734 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_162` | `MLP` | `MLPRegressor` | 69.494 | 1.231415 | 1.603734 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_162` | `ERT` | `MLP` | 69.494 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/mlp/2026-04-22-00-34-38__track1_mlp_phase_162_final_closure_attempt_36_campaign_run/onnx_export`;
