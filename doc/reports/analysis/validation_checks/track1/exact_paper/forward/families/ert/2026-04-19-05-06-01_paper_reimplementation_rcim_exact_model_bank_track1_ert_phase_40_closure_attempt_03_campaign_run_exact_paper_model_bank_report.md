...
- run name: `track1_ert_phase_40_closure_attempt_03`;
- output run name: `track1_ert_phase_40_closure_attempt_03_campaign_run`;
- run instance id: `2026-04-19-05-05-44__track1_ert_phase_40_closure_attempt_03_campaign_run`;
...
- winning best params: `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 18, 'estimator__min_samples_split': 3, 'estimator__n_estimators': 40}`;
- winning mean component MAPE: `65.026%`;
- winning mean component MAE: `0.034168`;
- winning mean component RMSE: `0.050586`;
...
| --- | --- | ---: | ---: | --- |
| `ERT` | `paper_reference_grid_search` | 5 | 0.791789 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 18, 'estimator__min_samples_split': 3, 'estimator__n_estimators': 40}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ERT` | `ExtraTreesRegressor` | `paper_reference_grid_search` | 65.026 | 0.034168 | 0.050586 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_40` | `ERT` | `ExtraTreesRegressor` | 65.026 | 0.034168 | 0.050586 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_40` | `ERT / GBM` | `ERT` | 65.026 | `matched_expected_family_direction` |
...
| `Repo Best Family` | - | - | - | `ERT` | - | - | - | - | - |
| `Repo Best RMSE` | - | - | - | 0.0506 | - | - | - | - | - |
| `Paper Best Family` | - | - | - | `GBM` | - | - | - | - | - |
| `Paper Target RMSE` | - | - | - | 0.0550 | - | - | - | - | - |
| `Gap Vs Paper` | - | - | - | -0.004414 | - | - | - | - | - |
| `Status` | - | - | - | `met_paper_target` | - | - | - | - | - |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/ert/2026-04-19-05-05-44__track1_ert_phase_40_closure_attempt_03_campaign_run/onnx_export`;
