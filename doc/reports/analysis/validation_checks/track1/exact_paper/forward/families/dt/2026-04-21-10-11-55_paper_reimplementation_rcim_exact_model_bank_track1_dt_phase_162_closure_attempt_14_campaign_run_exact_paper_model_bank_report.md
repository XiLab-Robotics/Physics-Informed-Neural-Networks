...
- run name: `track1_dt_phase_162_closure_attempt_14`;
- output run name: `track1_dt_phase_162_closure_attempt_14_campaign_run`;
- run instance id: `2026-04-21-10-11-47__track1_dt_phase_162_closure_attempt_14_campaign_run`;
...
- winning mean component MAPE: `16.683%`;
- winning mean component MAE: `0.403861`;
- winning mean component RMSE: `1.314031`;
...
| --- | --- | ---: | ---: | --- |
| `DT` | `paper_reference_grid_search` | 5 | 0.662134 | `{'estimator__criterion': 'absolute_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 5}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `DT` | `DecisionTreeRegressor` | `paper_reference_grid_search` | 16.683 | 0.403861 | 1.314031 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_162` | `DT` | `DecisionTreeRegressor` | 16.683 | 0.403861 | 1.314031 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_162` | `ERT` | `DT` | 16.683 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/dt/2026-04-21-10-11-47__track1_dt_phase_162_closure_attempt_14_campaign_run/onnx_export`;
