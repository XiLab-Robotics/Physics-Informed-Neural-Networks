...
- run name: `track1_et_phase_240_closure_attempt_01`;
- output run name: `track1_et_phase_240_closure_attempt_01_campaign_run`;
- run instance id: `2026-04-19-04-20-39__track1_et_phase_240_closure_attempt_01_campaign_run`;
...
- winning mean component MAPE: `23.114%`;
- winning mean component MAE: `0.420847`;
- winning mean component RMSE: `1.239797`;
...
| --- | --- | ---: | ---: | --- |
| `ET` | `paper_reference_grid_search` | 5 | 0.405910 | `{'estimator__criterion': 'absolute_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 2}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ET` | `ExtraTreeRegressor` | `paper_reference_grid_search` | 23.114 | 0.420847 | 1.239797 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_240` | `ET` | `ExtraTreeRegressor` | 23.114 | 0.420847 | 1.239797 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_240` | `ERT` | `ET` | 23.114 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/et/2026-04-19-04-20-39__track1_et_phase_240_closure_attempt_01_campaign_run/onnx_export`;
