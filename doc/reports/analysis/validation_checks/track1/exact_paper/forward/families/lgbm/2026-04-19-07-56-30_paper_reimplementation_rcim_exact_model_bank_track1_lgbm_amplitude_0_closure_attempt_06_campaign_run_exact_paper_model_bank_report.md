...
- run name: `track1_lgbm_amplitude_0_closure_attempt_06`;
- output run name: `track1_lgbm_amplitude_0_closure_attempt_06_campaign_run`;
- run instance id: `2026-04-19-07-55-09__track1_lgbm_amplitude_0_closure_attempt_06_campaign_run`;
...
- winning mean component MAPE: `9.698%`;
- winning mean component MAE: `0.002464`;
- winning mean component RMSE: `0.003467`;
...
| --- | --- | ---: | ---: | --- |
| `LGBM` | `paper_reference_grid_search` | 5 | 0.976541 | `{'estimator__learning_rate': 0.2, 'estimator__max_depth': 10, 'estimator__num_leaves': 8, 'estimator__subsample': 0.001}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `LGBM` | `LGBMRegressor` | `paper_reference_grid_search` | 9.698 | 0.002464 | 0.003467 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_0` | `LGBM` | `LGBMRegressor` | 9.698 | 0.002464 | 0.003467 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_0` | `SVR` | `LGBM` | 9.698 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/lgbm/2026-04-19-07-55-09__track1_lgbm_amplitude_0_closure_attempt_06_campaign_run/onnx_export`;
