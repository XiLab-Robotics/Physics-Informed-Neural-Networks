...
- run name: `track1_rf_phase_156_closure_attempt_03`;
- output run name: `track1_rf_phase_156_closure_attempt_03_campaign_run`;
- run instance id: `2026-04-19-02-57-46__track1_rf_phase_156_closure_attempt_03_campaign_run`;
...
- winning mean component MAPE: `25.804%`;
- winning mean component MAE: `0.444977`;
- winning mean component RMSE: `0.963107`;
...
| --- | --- | ---: | ---: | --- |
| `RF` | `paper_reference_grid_search` | 5 | 0.757782 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 2, 'estimator__n_estimators': 80}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `RF` | `RandomForestRegressor` | `paper_reference_grid_search` | 25.804 | 0.444977 | 0.963107 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_156` | `RF` | `RandomForestRegressor` | 25.804 | 0.444977 | 0.963107 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_156` | `ERT / RF` | `RF` | 25.804 | `matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/rf/2026-04-19-02-57-46__track1_rf_phase_156_closure_attempt_03_campaign_run/onnx_export`;
