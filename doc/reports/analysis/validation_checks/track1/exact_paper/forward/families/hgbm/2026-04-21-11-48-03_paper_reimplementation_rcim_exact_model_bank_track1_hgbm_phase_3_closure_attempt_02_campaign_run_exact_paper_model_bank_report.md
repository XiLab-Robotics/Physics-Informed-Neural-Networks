...
- run name: `track1_hgbm_phase_3_closure_attempt_02`;
- output run name: `track1_hgbm_phase_3_closure_attempt_02_campaign_run`;
- run instance id: `2026-04-21-11-47-50__track1_hgbm_phase_3_closure_attempt_02_campaign_run`;
...
- winning mean component MAPE: `1.119%`;
- winning mean component MAE: `0.020316`;
- winning mean component RMSE: `0.026760`;
...
| --- | --- | ---: | ---: | --- |
| `HGBM` | `paper_reference_grid_search` | 5 | 0.937576 | `{'estimator__learning_rate': 0.2, 'estimator__max_depth': 13, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 25}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `HGBM` | `HistGradientBoostingRegressor` | `paper_reference_grid_search` | 1.119 | 0.020316 | 0.026760 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_3` | `HGBM` | `HistGradientBoostingRegressor` | 1.119 | 0.020316 | 0.026760 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_3` | `HGBM` | `HGBM` | 1.119 | `matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/hgbm/2026-04-21-11-47-50__track1_hgbm_phase_3_closure_attempt_02_campaign_run/onnx_export`;
