...
- run name: `track1_svm_amplitude_240_yellow_cell_attempt_17`;
- output run name: `track1_svm_amplitude_240_yellow_cell_attempt_17_campaign_run`;
- run instance id: `2026-04-24-00-04-50__track1_svm_amplitude_240_yellow_cell_attempt_17_campaign_run`;
...
- winning best params: `{'estimator__C': 0.3, 'estimator__epsilon': 1e-06, 'estimator__gamma': 1.1e-06, 'estimator__kernel': 'rbf'}`;
- winning mean component MAPE: `59.577%`;
- winning mean component MAE: `0.000278`;
- winning mean component RMSE: `0.000533`;
...
| --- | --- | ---: | ---: | --- |
| `SVR` | `paper_reference_grid_search` | 5 | 0.200883 | `{'estimator__C': 0.3, 'estimator__epsilon': 1e-06, 'estimator__gamma': 1.1e-06, 'estimator__kernel': 'rbf'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `SVR` | `SVR` | `paper_reference_grid_search` | 59.577 | 0.000278 | 0.000533 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_240` | `SVR` | `SVR` | 59.577 | 0.000278 | 0.000533 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_240` | `ERT` | `SVR` | 59.577 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/svm_targeted_closure/svm/2026-04-24-00-04-50__track1_svm_amplitude_240_yellow_cell_attempt_17_campaign_run/onnx_export`;
