...
- run name: `track1_rf_phase_40_closure_attempt_04`;
- output run name: `track1_rf_phase_40_closure_attempt_04_campaign_run`;
- run instance id: `2026-04-19-02-50-52__track1_rf_phase_40_closure_attempt_04_campaign_run`;
...
- winning mean component MAPE: `73.103%`;
- winning mean component MAE: `0.036959`;
- winning mean component RMSE: `0.057612`;
...
| --- | --- | ---: | ---: | --- |
| `RF` | `paper_reference_grid_search` | 5 | 0.750747 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 12, 'estimator__min_samples_split': 2, 'estimator__n_estimators': 90}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `RF` | `RandomForestRegressor` | `paper_reference_grid_search` | 73.103 | 0.036959 | 0.057612 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_40` | `RF` | `RandomForestRegressor` | 73.103 | 0.036959 | 0.057612 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_40` | `ERT / GBM` | `RF` | 73.103 | `not_matched_expected_family_direction` |
...
| `Repo Best Family` | - | - | - | `RF` | - | - | - | - | - |
| `Repo Best RMSE` | - | - | - | 0.0576 | - | - | - | - | - |
| `Paper Best Family` | - | - | - | `GBM` | - | - | - | - | - |
| `Paper Target RMSE` | - | - | - | 0.0550 | - | - | - | - | - |
| `Gap Vs Paper` | - | - | - | 0.002612 | - | - | - | - | - |
| `Status` | - | - | - | `above_paper_target` | - | - | - | - | - |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/rf/2026-04-19-02-50-52__track1_rf_phase_40_closure_attempt_04_campaign_run/onnx_export`;
