...
- run name: `track1_et_amplitude_78_closure_attempt_01`;
- output run name: `track1_et_amplitude_78_closure_attempt_01_campaign_run`;
- run instance id: `2026-04-19-04-01-59__track1_et_amplitude_78_closure_attempt_01_campaign_run`;
...
- winning mean component MAPE: `13.902%`;
...
| --- | --- | ---: | ---: | --- |
| `ET` | `paper_reference_grid_search` | 5 | 0.984081 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 16, 'estimator__min_samples_split': 2}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ET` | `ExtraTreeRegressor` | `paper_reference_grid_search` | 13.902 | 0.000052 | 0.000074 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_78` | `ET` | `ExtraTreeRegressor` | 13.902 | 0.000052 | 0.000074 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_78` | `HGBM / RF` | `ET` | 13.902 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/et/2026-04-19-04-01-59__track1_et_amplitude_78_closure_attempt_01_campaign_run/onnx_export`;
