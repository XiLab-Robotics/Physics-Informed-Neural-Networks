...
- run name: `track1_rf_phase_40_closure_attempt_01`;
- output run name: `track1_rf_phase_40_closure_attempt_01_campaign_run`;
- run instance id: `2026-04-19-02-49-39__track1_rf_phase_40_closure_attempt_01_campaign_run`;
...
- winning mean component MAPE: `67.262%`;
- winning mean component MAE: `0.036281`;
- winning mean component RMSE: `0.054987`;
...
| --- | --- | ---: | ---: | --- |
| `RF` | `paper_reference_grid_search` | 5 | 0.752566 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 12, 'estimator__min_samples_split': 2, 'estimator__n_estimators': 60}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `RF` | `RandomForestRegressor` | `paper_reference_grid_search` | 67.262 | 0.036281 | 0.054987 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_40` | `RF` | `RandomForestRegressor` | 67.262 | 0.036281 | 0.054987 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_40` | `ERT / GBM` | `RF` | 67.262 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/rf/2026-04-19-02-49-39__track1_rf_phase_40_closure_attempt_01_campaign_run/onnx_export`;
