...
- run name: `track1_gbm_phase_156_closure_attempt_02`;
- output run name: `track1_gbm_phase_156_closure_attempt_02_campaign_run`;
- run instance id: `2026-04-19-06-02-03__track1_gbm_phase_156_closure_attempt_02_campaign_run`;
...
- winning best params: `{'estimator__criterion': 'squared_error', 'estimator__learning_rate': 0.1, 'estimator__max_depth': 16, 'estimator__min_samples_split': 14, 'estimator__n_estimators': 36}`;
- winning mean component MAPE: `41.675%`;
- winning mean component MAE: `0.642665`;
- winning mean component RMSE: `1.258745`;
...
| --- | --- | ---: | ---: | --- |
| `GBM` | `paper_reference_grid_search` | 5 | 0.757024 | `{'estimator__criterion': 'squared_error', 'estimator__learning_rate': 0.1, 'estimator__max_depth': 16, 'estimator__min_samples_split': 14, 'estimator__n_estimators': 36}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `GBM` | `GradientBoostingRegressor` | `paper_reference_grid_search` | 41.675 | 0.642665 | 1.258745 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_156` | `GBM` | `GradientBoostingRegressor` | 41.675 | 0.642665 | 1.258745 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_156` | `ERT / RF` | `GBM` | 41.675 | `not_matched_expected_family_direction` |
...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `156` | `-` | `-` | `-` | `RF` | `GBM` | `GBM` | `above_paper_target` | `above_paper_target` | `not_yet_matched_tables_3_6` |

## ONNX Export Surface

- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/gbm/2026-04-19-06-02-03__track1_gbm_phase_156_closure_attempt_02_campaign_run/onnx_export`;
