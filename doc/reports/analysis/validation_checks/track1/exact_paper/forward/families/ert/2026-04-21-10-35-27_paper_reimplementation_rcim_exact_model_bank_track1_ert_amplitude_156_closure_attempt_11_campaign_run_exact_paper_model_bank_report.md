...
- run name: `track1_ert_amplitude_156_closure_attempt_11`;
- output run name: `track1_ert_amplitude_156_closure_attempt_11_campaign_run`;
- run instance id: `2026-04-21-10-35-08__track1_ert_amplitude_156_closure_attempt_11_campaign_run`;
...
- winning best params: `{'estimator__criterion': 'absolute_error', 'estimator__max_depth': 17, 'estimator__min_samples_split': 2, 'estimator__n_estimators': 100}`;
- winning mean component MAPE: `10.051%`;
- winning mean component MAE: `0.000019`;
...
| --- | --- | ---: | ---: | --- |
| `ERT` | `paper_reference_grid_search` | 5 | 0.990016 | `{'estimator__criterion': 'absolute_error', 'estimator__max_depth': 17, 'estimator__min_samples_split': 2, 'estimator__n_estimators': 100}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ERT` | `ExtraTreesRegressor` | `paper_reference_grid_search` | 10.051 | 0.000019 | 0.000045 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_156` | `ERT` | `ExtraTreesRegressor` | 10.051 | 0.000019 | 0.000045 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_156` | `ERT / RF` | `ERT` | 10.051 | `matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/ert/2026-04-21-10-35-08__track1_ert_amplitude_156_closure_attempt_11_campaign_run/onnx_export`;
