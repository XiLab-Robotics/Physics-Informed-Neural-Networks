...
- run name: `track1_lgbm_amplitude_0_closure_attempt_03`;
- output run name: `track1_lgbm_amplitude_0_closure_attempt_03_campaign_run`;
- run instance id: `2026-04-19-07-50-38__track1_lgbm_amplitude_0_closure_attempt_03_campaign_run`;
...
- winning mean component MAPE: `5.204%`;
- winning mean component MAE: `0.002273`;
- winning mean component RMSE: `0.002956`;
...
| --- | --- | ---: | ---: | --- |
| `LGBM` | `paper_reference_grid_search` | 5 | 0.973073 | `{'estimator__learning_rate': 0.2, 'estimator__max_depth': 10, 'estimator__num_leaves': 10, 'estimator__subsample': 0.001}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `LGBM` | `LGBMRegressor` | `paper_reference_grid_search` | 5.204 | 0.002273 | 0.002956 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_0` | `LGBM` | `LGBMRegressor` | 5.204 | 0.002273 | 0.002956 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_0` | `SVR` | `LGBM` | 5.204 | `not_matched_expected_family_direction` |
...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `0` | `SVM` | `LGBM` | `met_paper_target` | `-` | `-` | `-` | `-` | `-` | `partially_matched_tables_3_6` |

## ONNX Export Surface

- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/lgbm/2026-04-19-07-50-38__track1_lgbm_amplitude_0_closure_attempt_03_campaign_run/onnx_export`;
