...
- run name: `track1_dt_phase_162_closure_attempt_12`;
- output run name: `track1_dt_phase_162_closure_attempt_12_campaign_run`;
- run instance id: `2026-04-21-10-11-18__track1_dt_phase_162_closure_attempt_12_campaign_run`;
...
- winning mean component MAPE: `8.450%`;
- winning mean component MAE: `0.194083`;
- winning mean component RMSE: `0.856305`;
...
| --- | --- | ---: | ---: | --- |
| `DT` | `paper_reference_grid_search` | 5 | 0.633385 | `{'estimator__criterion': 'absolute_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 5}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `DT` | `DecisionTreeRegressor` | `paper_reference_grid_search` | 8.450 | 0.194083 | 0.856305 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_162` | `DT` | `DecisionTreeRegressor` | 8.450 | 0.194083 | 0.856305 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_162` | `ERT` | `DT` | 8.450 | `not_matched_expected_family_direction` |
...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `162` | `-` | `-` | `-` | `ERT` | `DT` | `DT` | `met_paper_target` | `above_paper_target` | `partially_matched_tables_3_6` |

## ONNX Export Surface

- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/dt/2026-04-21-10-11-18__track1_dt_phase_162_closure_attempt_12_campaign_run/onnx_export`;
