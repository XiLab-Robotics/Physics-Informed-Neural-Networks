...
- run name: `track1_lgbm_phase_78_closure_attempt_05`;
- output run name: `track1_lgbm_phase_78_closure_attempt_05_campaign_run`;
- run instance id: `2026-04-19-09-59-46__track1_lgbm_phase_78_closure_attempt_05_campaign_run`;
...
- winning best params: `{'estimator__learning_rate': 0.39, 'estimator__max_depth': 12, 'estimator__num_leaves': 31, 'estimator__subsample': 0.001}`;
- winning mean component MAPE: `406.894%`;
- winning mean component MAE: `0.073587`;
- winning mean component RMSE: `0.157629`;
...
| --- | --- | ---: | ---: | --- |
| `LGBM` | `paper_reference_grid_search` | 5 | 0.806219 | `{'estimator__learning_rate': 0.39, 'estimator__max_depth': 12, 'estimator__num_leaves': 31, 'estimator__subsample': 0.001}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `LGBM` | `LGBMRegressor` | `paper_reference_grid_search` | 406.894 | 0.073587 | 0.157629 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_78` | `LGBM` | `LGBMRegressor` | 406.894 | 0.073587 | 0.157629 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_78` | `HGBM / RF` | `LGBM` | 406.894 | `not_matched_expected_family_direction` |
...
| `Repo Best Family` | - | - | - | - | `LGBM` | - | - | - | - |
| `Repo Best MAE` | - | - | - | - | 0.0736 | - | - | - | - |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/lgbm/2026-04-19-09-59-46__track1_lgbm_phase_78_closure_attempt_05_campaign_run/onnx_export`;
