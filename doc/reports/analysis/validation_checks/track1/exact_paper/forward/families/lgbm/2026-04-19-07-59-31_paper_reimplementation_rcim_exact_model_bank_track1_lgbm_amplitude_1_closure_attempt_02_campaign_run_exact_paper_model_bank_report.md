...
- run name: `track1_lgbm_amplitude_1_closure_attempt_02`;
- output run name: `track1_lgbm_amplitude_1_closure_attempt_02_campaign_run`;
- run instance id: `2026-04-19-07-58-07__track1_lgbm_amplitude_1_closure_attempt_02_campaign_run`;
...
| --- | --- | ---: | ---: | --- |
| `LGBM` | `paper_reference_grid_search` | 5 | 0.713260 | `{'estimator__learning_rate': 0.2, 'estimator__max_depth': 10, 'estimator__num_leaves': 10, 'estimator__subsample': 0.001}` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/lgbm/2026-04-19-07-58-07__track1_lgbm_amplitude_1_closure_attempt_02_campaign_run/onnx_export`;
