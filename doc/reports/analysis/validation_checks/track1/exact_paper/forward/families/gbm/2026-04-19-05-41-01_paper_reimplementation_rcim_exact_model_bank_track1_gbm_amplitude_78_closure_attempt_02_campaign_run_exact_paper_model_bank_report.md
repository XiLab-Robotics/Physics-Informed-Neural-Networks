...
- run name: `track1_gbm_amplitude_78_closure_attempt_02`;
- output run name: `track1_gbm_amplitude_78_closure_attempt_02_campaign_run`;
- run instance id: `2026-04-19-05-40-49__track1_gbm_amplitude_78_closure_attempt_02_campaign_run`;
...
- winning mean component MAPE: `6.757%`;
...
| --- | --- | ---: | ---: | --- |
| `GBM` | `paper_reference_grid_search` | 5 | 0.994729 | `{'estimator__criterion': 'squared_error', 'estimator__learning_rate': 0.1, 'estimator__max_depth': 18, 'estimator__min_samples_split': 18, 'estimator__n_estimators': 84}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `GBM` | `GradientBoostingRegressor` | `paper_reference_grid_search` | 6.757 | 0.000029 | 0.000042 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_78` | `GBM` | `GradientBoostingRegressor` | 6.757 | 0.000029 | 0.000042 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_78` | `HGBM / RF` | `GBM` | 6.757 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/gbm/2026-04-19-05-40-49__track1_gbm_amplitude_78_closure_attempt_02_campaign_run/onnx_export`;
