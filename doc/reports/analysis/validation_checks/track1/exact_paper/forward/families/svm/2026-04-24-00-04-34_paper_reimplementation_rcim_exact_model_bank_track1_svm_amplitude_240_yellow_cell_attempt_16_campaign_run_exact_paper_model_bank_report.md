...
- run name: `track1_svm_amplitude_240_yellow_cell_attempt_16`;
- output run name: `track1_svm_amplitude_240_yellow_cell_attempt_16_campaign_run`;
- run instance id: `2026-04-23-21-34-58__track1_svm_amplitude_240_yellow_cell_attempt_16_campaign_run`;
...
- winning mean component MAPE: `66.300%`;
- winning mean component MAE: `0.000272`;
...
| --- | --- | ---: | ---: | --- |
| `SVR` | `paper_reference_grid_search` | 5 | 0.149241 | `{'estimator__C': 0.1, 'estimator__epsilon': 1e-05, 'estimator__gamma': 1.1e-06, 'estimator__kernel': 'rbf'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `SVR` | `SVR` | `paper_reference_grid_search` | 66.300 | 0.000272 | 0.000545 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_240` | `SVR` | `SVR` | 66.300 | 0.000272 | 0.000545 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_240` | `ERT` | `SVR` | 66.300 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/svm_targeted_closure/svm/2026-04-23-21-34-58__track1_svm_amplitude_240_yellow_cell_attempt_16_campaign_run/onnx_export`;
