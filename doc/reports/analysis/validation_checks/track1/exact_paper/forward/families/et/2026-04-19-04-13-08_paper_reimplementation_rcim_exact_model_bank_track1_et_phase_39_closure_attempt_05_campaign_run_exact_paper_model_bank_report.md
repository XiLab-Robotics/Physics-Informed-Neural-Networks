...
- run name: `track1_et_phase_39_closure_attempt_05`;
- output run name: `track1_et_phase_39_closure_attempt_05_campaign_run`;
- run instance id: `2026-04-19-04-13-00__track1_et_phase_39_closure_attempt_05_campaign_run`;
...
- winning mean component MAPE: `2.346%`;
- winning mean component MAE: `0.029571`;
- winning mean component RMSE: `0.050774`;
...
| --- | --- | ---: | ---: | --- |
| `ET` | `paper_reference_grid_search` | 5 | 0.960581 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 5}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ET` | `ExtraTreeRegressor` | `paper_reference_grid_search` | 2.346 | 0.029571 | 0.050774 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_39` | `ET` | `ExtraTreeRegressor` | 2.346 | 0.029571 | 0.050774 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_39` | `HGBM` | `ET` | 2.346 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/et/2026-04-19-04-13-00__track1_et_phase_39_closure_attempt_05_campaign_run/onnx_export`;
