...
- run name: `track1_dt_phase_162_closure_attempt_27`;
- output run name: `track1_dt_phase_162_closure_attempt_27_campaign_run`;
- run instance id: `2026-04-21-10-14-55__track1_dt_phase_162_closure_attempt_27_campaign_run`;
...
- winning mean component MAPE: `14.855%`;
- winning mean component MAE: `0.391122`;
- winning mean component RMSE: `1.220857`;
...
| --- | --- | ---: | ---: | --- |
| `DT` | `paper_reference_grid_search` | 5 | 0.672548 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 16, 'estimator__min_samples_split': 6}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `DT` | `DecisionTreeRegressor` | `paper_reference_grid_search` | 14.855 | 0.391122 | 1.220857 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_162` | `DT` | `DecisionTreeRegressor` | 14.855 | 0.391122 | 1.220857 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_162` | `ERT` | `DT` | 14.855 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/dt/2026-04-21-10-14-55__track1_dt_phase_162_closure_attempt_27_campaign_run/onnx_export`;
