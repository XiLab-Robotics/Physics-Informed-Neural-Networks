...
- run name: `track1_hgbm_phase_240_closure_attempt_05`;
- output run name: `track1_hgbm_phase_240_closure_attempt_05_campaign_run`;
- run instance id: `2026-04-19-06-55-11__track1_hgbm_phase_240_closure_attempt_05_campaign_run`;
...
- winning best params: `{'estimator__learning_rate': 0.19, 'estimator__max_depth': 11, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 26}`;
- winning mean component MAPE: `23.043%`;
- winning mean component MAE: `0.402638`;
- winning mean component RMSE: `0.860624`;
...
| --- | --- | ---: | ---: | --- |
| `HGBM` | `paper_reference_grid_search` | 5 | 0.413739 | `{'estimator__learning_rate': 0.19, 'estimator__max_depth': 11, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 26}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `HGBM` | `HistGradientBoostingRegressor` | `paper_reference_grid_search` | 23.043 | 0.402638 | 0.860624 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_240` | `HGBM` | `HistGradientBoostingRegressor` | 23.043 | 0.402638 | 0.860624 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_240` | `ERT` | `HGBM` | 23.043 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/hgbm/2026-04-19-06-55-11__track1_hgbm_phase_240_closure_attempt_05_campaign_run/onnx_export`;
