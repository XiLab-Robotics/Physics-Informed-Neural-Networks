...
- run name: `track1_mlp_phase_156_closure_attempt_04`;
- output run name: `track1_mlp_phase_156_closure_attempt_04_campaign_run`;
- run instance id: `2026-04-19-02-02-23__track1_mlp_phase_156_closure_attempt_04_campaign_run`;
...
- winning mean component MAPE: `104.862%`;
- winning mean component MAE: `1.462989`;
- winning mean component RMSE: `1.794533`;
...
| --- | --- | ---: | ---: | --- |
| `MLP` | `paper_reference_grid_search` | 5 | 0.181521 | `{'estimator__activation': 'relu', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (100,), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `MLP` | `MLPRegressor` | `paper_reference_grid_search` | 104.862 | 1.462989 | 1.794533 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_156` | `MLP` | `MLPRegressor` | 104.862 | 1.462989 | 1.794533 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_156` | `ERT / RF` | `MLP` | 104.862 | `not_matched_expected_family_direction` |
...
| `Repo Best Family` | - | - | - | - | - | - | `MLP` | - | - |
| `Repo Best RMSE` | - | - | - | - | - | - | 1.795 | - | - |
| `Paper Best Family` | - | - | - | - | - | - | `ERT` | - | - |
| `Paper Target RMSE` | - | - | - | - | - | - | 1.200 | - | - |
| `Gap Vs Paper` | - | - | - | - | - | - | 0.5945 | - | - |
| `Status` | - | - | - | - | - | - | `above_paper_target` | - | - |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/mlp/2026-04-19-02-02-23__track1_mlp_phase_156_closure_attempt_04_campaign_run/onnx_export`;
