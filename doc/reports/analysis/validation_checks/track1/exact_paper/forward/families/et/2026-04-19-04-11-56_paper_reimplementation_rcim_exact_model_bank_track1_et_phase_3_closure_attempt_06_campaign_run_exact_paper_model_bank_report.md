...
- run name: `track1_et_phase_3_closure_attempt_06`;
- output run name: `track1_et_phase_3_closure_attempt_06_campaign_run`;
- run instance id: `2026-04-19-04-11-48__track1_et_phase_3_closure_attempt_06_campaign_run`;
...
- winning mean component MAPE: `1.805%`;
- winning mean component MAE: `0.032461`;
- winning mean component RMSE: `0.044676`;
...
| --- | --- | ---: | ---: | --- |
| `ET` | `paper_reference_grid_search` | 5 | 0.892734 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 4}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ET` | `ExtraTreeRegressor` | `paper_reference_grid_search` | 1.805 | 0.032461 | 0.044676 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_3` | `ET` | `ExtraTreeRegressor` | 1.805 | 0.032461 | 0.044676 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_3` | `HGBM` | `ET` | 1.805 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/et/2026-04-19-04-11-48__track1_et_phase_3_closure_attempt_06_campaign_run/onnx_export`;
