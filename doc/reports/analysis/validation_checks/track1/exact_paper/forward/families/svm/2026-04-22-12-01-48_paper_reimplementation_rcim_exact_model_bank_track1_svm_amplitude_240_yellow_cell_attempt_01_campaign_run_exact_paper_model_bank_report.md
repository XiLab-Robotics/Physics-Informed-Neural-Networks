...
- run name: `track1_svm_amplitude_240_yellow_cell_attempt_01`;
- output run name: `track1_svm_amplitude_240_yellow_cell_attempt_01_campaign_run`;
- run instance id: `2026-04-22-09-28-52__track1_svm_amplitude_240_yellow_cell_attempt_01_campaign_run`;
...
- winning mean component MAPE: `65.486%`;
- winning mean component MAE: `0.000302`;
- winning mean component RMSE: `0.000622`;
...
| --- | --- | ---: | ---: | --- |
| `SVR` | `paper_reference_grid_search` | 5 | 0.154647 | `{'estimator__C': 0.1, 'estimator__epsilon': 1e-05, 'estimator__gamma': 1.1e-06, 'estimator__kernel': 'rbf'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `SVR` | `SVR` | `paper_reference_grid_search` | 65.486 | 0.000302 | 0.000622 |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/svm_targeted_closure/svm/2026-04-22-09-28-52__track1_svm_amplitude_240_yellow_cell_attempt_01_campaign_run/onnx_export`;
