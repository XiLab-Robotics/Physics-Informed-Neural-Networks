...
- run name: `track1_dt_phase_40_closure_attempt_01`;
- output run name: `track1_dt_phase_40_closure_attempt_01_campaign_run`;
- run instance id: `2026-04-19-03-34-52__track1_dt_phase_40_closure_attempt_01_campaign_run`;
...
- winning mean component MAPE: `74.369%`;
- winning mean component MAE: `0.042278`;
- winning mean component RMSE: `0.066881`;
...
| --- | --- | ---: | ---: | --- |
| `DT` | `paper_reference_grid_search` | 5 | 0.669422 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 5}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `DT` | `DecisionTreeRegressor` | `paper_reference_grid_search` | 74.369 | 0.042278 | 0.066881 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_40` | `DT` | `DecisionTreeRegressor` | 74.369 | 0.042278 | 0.066881 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_40` | `ERT / GBM` | `DT` | 74.369 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/dt/2026-04-19-03-34-52__track1_dt_phase_40_closure_attempt_01_campaign_run/onnx_export`;
