...
- run name: `track1_ert_phase_240_closure_attempt_06`;
- output run name: `track1_ert_phase_240_closure_attempt_06_campaign_run`;
- run instance id: `2026-04-19-05-19-01__track1_ert_phase_240_closure_attempt_06_campaign_run`;
...
- winning best params: `{'estimator__criterion': 'absolute_error', 'estimator__max_depth': 18, 'estimator__min_samples_split': 2, 'estimator__n_estimators': 20}`;
- winning mean component MAPE: `19.924%`;
- winning mean component MAE: `0.283668`;
- winning mean component RMSE: `0.739840`;
...
| --- | --- | ---: | ---: | --- |
| `ERT` | `paper_reference_grid_search` | 5 | 0.584956 | `{'estimator__criterion': 'absolute_error', 'estimator__max_depth': 18, 'estimator__min_samples_split': 2, 'estimator__n_estimators': 20}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ERT` | `ExtraTreesRegressor` | `paper_reference_grid_search` | 19.924 | 0.283668 | 0.739840 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_240` | `ERT` | `ExtraTreesRegressor` | 19.924 | 0.283668 | 0.739840 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_240` | `ERT` | `ERT` | 19.924 | `matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/ert/2026-04-19-05-19-01__track1_ert_phase_240_closure_attempt_06_campaign_run/onnx_export`;
