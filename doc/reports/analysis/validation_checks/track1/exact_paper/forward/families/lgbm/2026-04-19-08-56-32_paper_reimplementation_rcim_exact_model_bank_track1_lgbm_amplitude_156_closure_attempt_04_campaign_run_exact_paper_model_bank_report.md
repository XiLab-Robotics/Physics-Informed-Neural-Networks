...
- run name: `track1_lgbm_amplitude_156_closure_attempt_04`;
- output run name: `track1_lgbm_amplitude_156_closure_attempt_04_campaign_run`;
- run instance id: `2026-04-19-08-55-09__track1_lgbm_amplitude_156_closure_attempt_04_campaign_run`;
...
- winning mean component MAPE: `32.141%`;
- winning mean component MAE: `0.000078`;
- winning mean component RMSE: `0.000182`;
...
| --- | --- | ---: | ---: | --- |
| `LGBM` | `paper_reference_grid_search` | 5 | 0.966640 | `{'estimator__learning_rate': 0.77, 'estimator__max_depth': 10, 'estimator__num_leaves': 10, 'estimator__subsample': 0.001}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `LGBM` | `LGBMRegressor` | `paper_reference_grid_search` | 32.141 | 0.000078 | 0.000182 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_156` | `LGBM` | `LGBMRegressor` | 32.141 | 0.000078 | 0.000182 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_156` | `ERT / RF` | `LGBM` | 32.141 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/lgbm/2026-04-19-08-55-09__track1_lgbm_amplitude_156_closure_attempt_04_campaign_run/onnx_export`;
