...
- run name: `track1_xgbm_phase_3_closure_attempt_05`;
- output run name: `track1_xgbm_phase_3_closure_attempt_05_campaign_run`;
- run instance id: `2026-04-19-07-24-28__track1_xgbm_phase_3_closure_attempt_05_campaign_run`;
...
- winning mean component MAE: `0.023685`;
- winning mean component RMSE: `0.034006`;
...
| --- | --- | ---: | ---: | --- |
| `XGBM` | `paper_reference_grid_search` | 5 | 0.930281 | `{'estimator__colsample_bytree': 0.8, 'estimator__learning_rate': 0.2, 'estimator__max_depth': 14}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `XGBM` | `XGBRegressor` | `paper_reference_grid_search` | 1.330 | 0.023685 | 0.034006 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_3` | `XGBM` | `XGBRegressor` | 1.330 | 0.023685 | 0.034006 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_3` | `HGBM` | `XGBM` | 1.330 | `not_matched_expected_family_direction` |
...
| `Repo Best Family` | - | `XGBM` | - | - | - | - | - | - | - |
| `Repo Best RMSE` | - | 0.0340 | - | - | - | - | - | - | - |
| `Paper Best Family` | - | `HGBM` | - | - | - | - | - | - | - |
| `Paper Target RMSE` | - | 0.0290 | - | - | - | - | - | - | - |
| `Gap Vs Paper` | - | 0.005006 | - | - | - | - | - | - | - |
| `Status` | - | `above_paper_target` | - | - | - | - | - | - | - |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/xgbm/2026-04-19-07-24-28__track1_xgbm_phase_3_closure_attempt_05_campaign_run/onnx_export`;
