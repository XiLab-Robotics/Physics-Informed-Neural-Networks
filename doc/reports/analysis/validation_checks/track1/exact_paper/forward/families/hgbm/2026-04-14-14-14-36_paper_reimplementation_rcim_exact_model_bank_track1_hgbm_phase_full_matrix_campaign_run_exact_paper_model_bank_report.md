...
- run instance id: `2026-04-14-14-14-35__track1_hgbm_phase_full_matrix_campaign_run`;
...
- winning mean component MAPE: `35.717%`;
- winning mean component MAE: `0.177003`;
- winning mean component RMSE: `0.344691`;

## Family Ranking

| Rank | Family | Estimator | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | ---: | ---: | ---: |
| 1 | `HGBM` | `HistGradientBoostingRegressor` | 35.717 | 0.177003 | 0.344691 |
...
| `fft_y_Fw_filtered_phase_3` | `HGBM` | `HistGradientBoostingRegressor` | 1.398 | 0.024899 | 0.034302 |
| `fft_y_Fw_filtered_phase_39` | `HGBM` | `HistGradientBoostingRegressor` | 1.628 | 0.020390 | 0.032648 |
| `fft_y_Fw_filtered_phase_40` | `HGBM` | `HistGradientBoostingRegressor` | 51.403 | 0.038459 | 0.059256 |
| `fft_y_Fw_filtered_phase_78` | `HGBM` | `HistGradientBoostingRegressor` | 113.629 | 0.069808 | 0.137684 |
| `fft_y_Fw_filtered_phase_81` | `HGBM` | `HistGradientBoostingRegressor` | 5.029 | 0.051418 | 0.075736 |
| `fft_y_Fw_filtered_phase_156` | `HGBM` | `HistGradientBoostingRegressor` | 79.373 | 0.609963 | 1.034697 |
| `fft_y_Fw_filtered_phase_162` | `HGBM` | `HistGradientBoostingRegressor` | 16.823 | 0.362668 | 0.801399 |
| `fft_y_Fw_filtered_phase_240` | `HGBM` | `HistGradientBoostingRegressor` | 31.111 | 0.413579 | 0.923939 |
...
| `fft_y_Fw_filtered_phase_3` | `HGBM` | `HGBM` | 1.398 | `matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_39` | `HGBM` | `HGBM` | 1.628 | `matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_40` | `ERT / GBM` | `HGBM` | 51.403 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_78` | `HGBM / RF` | `HGBM` | 113.629 | `matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_81` | `RF` | `HGBM` | 5.029 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_156` | `ERT / RF` | `HGBM` | 79.373 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_162` | `ERT` | `HGBM` | 16.823 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_240` | `ERT` | `HGBM` | 31.111 | `not_matched_expected_family_direction` |
...
| `Repo Best MAE` | 0.001846 | 0.0249 | 0.0204 | 0.0385 | 0.0698 | 0.0514 | 0.6100 | 0.3627 | 0.4136 |
...
| `Gap Vs Paper` | 4.64e-05 | 0.004899 | -6.10e-04 | 0.002459 | -0.004192 | -0.001582 | 0.1000 | 0.1627 | 0.1836 |
...
| `Repo Best Family` | `HGBM` | `HGBM` | `HGBM` | `HGBM` | `HGBM` | `HGBM` | `HGBM` | `HGBM` | `HGBM` |
| `Repo Best RMSE` | 0.002563 | 0.0343 | 0.0326 | 0.0593 | 0.1377 | 0.0757 | 1.035 | 0.8014 | 0.9239 |
...
| `Gap Vs Paper` | 6.29e-05 | 0.005302 | 0.005648 | 0.004256 | -0.0223 | -0.006264 | -0.1653 | 0.1614 | 0.3439 |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/full_matrix/hgbm/2026-04-14-14-14-35__track1_hgbm_phase_full_matrix_campaign_run/onnx_export`;
