...
- run name: `track1_mlp_phase_full_matrix`;
- output run name: `track1_mlp_phase_full_matrix_campaign_run`;
- run instance id: `2026-04-18-01-20-22__track1_mlp_phase_full_matrix_campaign_run`;
...
- winning mean component MAPE: `184.720%`;
- winning mean component MAE: `0.424374`;
- winning mean component RMSE: `0.606070`;
...
| --- | --- | ---: | ---: | --- |
| `MLP` | `paper_reference_grid_search` | 5 | -1.455137 | `{'estimator__activation': 'tanh', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (200, 50), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `MLP` | `MLPRegressor` | `paper_reference_grid_search` | 184.720 | 0.424374 | 0.606070 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_1` | `MLP` | `MLPRegressor` | 146.304 | 0.009958 | 0.015508 |
| `fft_y_Fw_filtered_phase_3` | `MLP` | `MLPRegressor` | 4.517 | 0.080160 | 0.102211 |
| `fft_y_Fw_filtered_phase_39` | `MLP` | `MLPRegressor` | 5.752 | 0.069120 | 0.089884 |
| `fft_y_Fw_filtered_phase_40` | `MLP` | `MLPRegressor` | 192.949 | 0.078778 | 0.111899 |
| `fft_y_Fw_filtered_phase_78` | `MLP` | `MLPRegressor` | 1072.989 | 0.173426 | 0.257986 |
| `fft_y_Fw_filtered_phase_81` | `MLP` | `MLPRegressor` | 15.755 | 0.165498 | 0.229632 |
| `fft_y_Fw_filtered_phase_156` | `MLP` | `MLPRegressor` | 112.962 | 1.561696 | 1.911885 |
| `fft_y_Fw_filtered_phase_162` | `MLP` | `MLPRegressor` | 46.059 | 0.924807 | 1.484005 |
| `fft_y_Fw_filtered_phase_240` | `MLP` | `MLPRegressor` | 65.190 | 0.755923 | 1.251619 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_1` | `RF / LGBM` | `MLP` | 146.304 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_3` | `HGBM` | `MLP` | 4.517 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_39` | `HGBM` | `MLP` | 5.752 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_40` | `ERT / GBM` | `MLP` | 192.949 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_78` | `HGBM / RF` | `MLP` | 1072.989 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_81` | `RF` | `MLP` | 15.755 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_156` | `ERT / RF` | `MLP` | 112.962 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_162` | `ERT` | `MLP` | 46.059 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_240` | `ERT` | `MLP` | 65.190 | `not_matched_expected_family_direction` |
...
| `Repo Best Family` | `MLP` | `MLP` | `MLP` | `MLP` | `MLP` | `MLP` | `MLP` | `MLP` | `MLP` |
| `Repo Best MAE` | 0.009958 | 0.0802 | 0.0691 | 0.0788 | 0.1734 | 0.1655 | 1.562 | 0.9248 | 0.7559 |
...
| `Gap Vs Paper` | 0.008158 | 0.0602 | 0.0481 | 0.0428 | 0.0994 | 0.1125 | 1.052 | 0.7248 | 0.5259 |
...
| `Repo Best Family` | `MLP` | `MLP` | `MLP` | `MLP` | `MLP` | `MLP` | `MLP` | `MLP` | `MLP` |
| `Repo Best RMSE` | 0.0155 | 0.1022 | 0.0899 | 0.1119 | 0.2580 | 0.2296 | 1.912 | 1.484 | 1.252 |
...
| `Gap Vs Paper` | 0.0130 | 0.0732 | 0.0629 | 0.0569 | 0.0980 | 0.1476 | 0.7119 | 0.8440 | 0.6716 |
| `Status` | `above_paper_target` | `above_paper_target` | `above_paper_target` | `above_paper_target` | `above_paper_target` | `above_paper_target` | `above_paper_target` | `above_paper_target` | `above_paper_target` |
...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `1` | `-` | `-` | `-` | `LGBM` | `MLP` | `MLP` | `above_paper_target` | `above_paper_target` | `not_yet_matched_tables_3_6` |
| `3` | `-` | `-` | `-` | `HGBM` | `MLP` | `MLP` | `above_paper_target` | `above_paper_target` | `not_yet_matched_tables_3_6` |
| `39` | `-` | `-` | `-` | `HGBM` | `MLP` | `MLP` | `above_paper_target` | `above_paper_target` | `not_yet_matched_tables_3_6` |
| `40` | `-` | `-` | `-` | `GBM` | `MLP` | `MLP` | `above_paper_target` | `above_paper_target` | `not_yet_matched_tables_3_6` |
| `78` | `-` | `-` | `-` | `RF` | `MLP` | `MLP` | `above_paper_target` | `above_paper_target` | `not_yet_matched_tables_3_6` |
| `81` | `-` | `-` | `-` | `RF` | `MLP` | `MLP` | `above_paper_target` | `above_paper_target` | `not_yet_matched_tables_3_6` |
| `156` | `-` | `-` | `-` | `RF` | `MLP` | `MLP` | `above_paper_target` | `above_paper_target` | `not_yet_matched_tables_3_6` |
| `162` | `-` | `-` | `-` | `ERT` | `MLP` | `MLP` | `above_paper_target` | `above_paper_target` | `not_yet_matched_tables_3_6` |
| `240` | `-` | `-` | `-` | `ERT` | `MLP` | `MLP` | `above_paper_target` | `above_paper_target` | `not_yet_matched_tables_3_6` |

## ONNX Export Surface

- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/full_matrix/mlp/2026-04-18-01-20-22__track1_mlp_phase_full_matrix_campaign_run/onnx_export`;
