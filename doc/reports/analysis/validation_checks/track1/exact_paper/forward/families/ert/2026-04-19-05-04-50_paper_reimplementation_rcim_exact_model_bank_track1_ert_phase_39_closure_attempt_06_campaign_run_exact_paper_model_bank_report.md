...
- run name: `track1_ert_phase_39_closure_attempt_06`;
- output run name: `track1_ert_phase_39_closure_attempt_06_campaign_run`;
- run instance id: `2026-04-19-05-04-33__track1_ert_phase_39_closure_attempt_06_campaign_run`;
...
- winning mean component MAPE: `2.168%`;
- winning mean component MAE: `0.027683`;
- winning mean component RMSE: `0.051218`;
...
| --- | --- | ---: | ---: | --- |
| `ERT` | `paper_reference_grid_search` | 5 | 0.969355 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 6, 'estimator__n_estimators': 40}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ERT` | `ExtraTreesRegressor` | `paper_reference_grid_search` | 2.168 | 0.027683 | 0.051218 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_39` | `ERT` | `ExtraTreesRegressor` | 2.168 | 0.027683 | 0.051218 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_39` | `HGBM` | `ERT` | 2.168 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/ert/2026-04-19-05-04-33__track1_ert_phase_39_closure_attempt_06_campaign_run/onnx_export`;
