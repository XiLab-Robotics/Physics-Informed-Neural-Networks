...
- run name: `track1_rf_phase_40_closure_attempt_02`;
- output run name: `track1_rf_phase_40_closure_attempt_02_campaign_run`;
- run instance id: `2026-04-19-02-50-03__track1_rf_phase_40_closure_attempt_02_campaign_run`;
...
- winning mean component MAPE: `66.839%`;
- winning mean component MAE: `0.031394`;
- winning mean component RMSE: `0.047382`;
...
| --- | --- | ---: | ---: | --- |
| `RF` | `paper_reference_grid_search` | 5 | 0.764015 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 13, 'estimator__min_samples_split': 2, 'estimator__n_estimators': 50}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `RF` | `RandomForestRegressor` | `paper_reference_grid_search` | 66.839 | 0.031394 | 0.047382 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_40` | `RF` | `RandomForestRegressor` | 66.839 | 0.031394 | 0.047382 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_40` | `ERT / GBM` | `RF` | 66.839 | `not_matched_expected_family_direction` |
...
| `Repo Best Family` | - | - | - | `RF` | - | - | - | - | - |
| `Repo Best RMSE` | - | - | - | 0.0474 | - | - | - | - | - |
| `Paper Best Family` | - | - | - | `GBM` | - | - | - | - | - |
| `Paper Target RMSE` | - | - | - | 0.0550 | - | - | - | - | - |
| `Gap Vs Paper` | - | - | - | -0.007618 | - | - | - | - | - |
| `Status` | - | - | - | `met_paper_target` | - | - | - | - | - |
...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `40` | `-` | `-` | `-` | `GBM` | `RF` | `RF` | `met_paper_target` | `met_paper_target` | `partially_matched_tables_3_6` |

## ONNX Export Surface

- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/rf/2026-04-19-02-50-03__track1_rf_phase_40_closure_attempt_02_campaign_run/onnx_export`;
