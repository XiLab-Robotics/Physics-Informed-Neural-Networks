...
- run name: `track1_xgbm_amplitude_full_matrix`;
- output run name: `track1_xgbm_amplitude_full_matrix_campaign_run`;
- run instance id: `2026-04-18-15-47-59__track1_xgbm_amplitude_full_matrix_campaign_run`;
...
- winning best params: `{'estimator__colsample_bytree': 0.8, 'estimator__learning_rate': 0.3, 'estimator__max_depth': 14}`;
- winning mean component MAPE: `29.618%`;
- winning mean component MAE: `0.000359`;
- winning mean component RMSE: `0.000607`;
...
| --- | --- | ---: | ---: | --- |
| `XGBM` | `paper_reference_grid_search` | 5 | 0.564738 | `{'estimator__colsample_bytree': 0.8, 'estimator__learning_rate': 0.3, 'estimator__max_depth': 14}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `XGBM` | `XGBRegressor` | `paper_reference_grid_search` | 29.618 | 0.000359 | 0.000607 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_0` | `XGBM` | `XGBRegressor` | 11.615 | 0.002465 | 0.003714 |
| `fft_y_Fw_filtered_ampl_1` | `XGBM` | `XGBRegressor` | 0.308 | 0.000053 | 0.000068 |
| `fft_y_Fw_filtered_ampl_3` | `XGBM` | `XGBRegressor` | 9.593 | 0.000072 | 0.000091 |
| `fft_y_Fw_filtered_ampl_39` | `XGBM` | `XGBRegressor` | 8.964 | 0.000093 | 0.000124 |
| `fft_y_Fw_filtered_ampl_40` | `XGBM` | `XGBRegressor` | 8.337 | 0.000064 | 0.000083 |
| `fft_y_Fw_filtered_ampl_78` | `XGBM` | `XGBRegressor` | 42.014 | 0.000117 | 0.000159 |
| `fft_y_Fw_filtered_ampl_81` | `XGBM` | `XGBRegressor` | 15.326 | 0.000047 | 0.000060 |
| `fft_y_Fw_filtered_ampl_156` | `XGBM` | `XGBRegressor` | 83.335 | 0.000274 | 0.000782 |
| `fft_y_Fw_filtered_ampl_162` | `XGBM` | `XGBRegressor` | 34.527 | 0.000221 | 0.000677 |
| `fft_y_Fw_filtered_ampl_240` | `XGBM` | `XGBRegressor` | 82.161 | 0.000187 | 0.000314 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_0` | `SVR` | `XGBM` | 11.615 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_1` | `RF / LGBM` | `XGBM` | 0.308 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_3` | `HGBM` | `XGBM` | 9.593 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_39` | `HGBM` | `XGBM` | 8.964 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_40` | `ERT / GBM` | `XGBM` | 8.337 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_78` | `HGBM / RF` | `XGBM` | 42.014 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_81` | `RF` | `XGBM` | 15.326 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_156` | `ERT / RF` | `XGBM` | 83.335 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_162` | `ERT` | `XGBM` | 34.527 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_240` | `ERT` | `XGBM` | 82.161 | `not_matched_expected_family_direction` |
...
| ---: | --- | --- | --- | ---: | --- |
| `0` | `SVR` | `XGBM` | `-` | 0/1 | `no_family_direction_match` |
...
| `Repo Best Family` | `XGBM` | `XGBM` | `XGBM` | `XGBM` | `XGBM` | `XGBM` | `XGBM` | `XGBM` | `XGBM` | `XGBM` |
| `Repo Best RMSE` | 0.003714 | 6.81e-05 | 9.07e-05 | 1.24e-04 | 8.34e-05 | 1.59e-04 | 5.98e-05 | 7.82e-04 | 6.77e-04 | 3.14e-04 |
...
| `Gap Vs Paper` | 4.14e-04 | 3.31e-05 | 6.57e-05 | 9.20e-05 | 4.74e-05 | 1.14e-04 | 4.48e-05 | 6.52e-04 | 5.17e-04 | 2.72e-04 |
...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `0` | `SVM` | `XGBM` | `above_paper_target` | `-` | `-` | `-` | `-` | `-` | `not_yet_matched_tables_3_6` |
| `1` | `RF` | `XGBM` | `above_paper_target` | `-` | `-` | `-` | `-` | `-` | `not_yet_matched_tables_3_6` |
| `3` | `HGBM` | `XGBM` | `above_paper_target` | `-` | `-` | `-` | `-` | `-` | `not_yet_matched_tables_3_6` |
| `39` | `HGBM` | `XGBM` | `above_paper_target` | `-` | `-` | `-` | `-` | `-` | `not_yet_matched_tables_3_6` |
| `40` | `ERT` | `XGBM` | `above_paper_target` | `-` | `-` | `-` | `-` | `-` | `not_yet_matched_tables_3_6` |
| `78` | `HGBM` | `XGBM` | `above_paper_target` | `-` | `-` | `-` | `-` | `-` | `not_yet_matched_tables_3_6` |
| `81` | `RF` | `XGBM` | `above_paper_target` | `-` | `-` | `-` | `-` | `-` | `not_yet_matched_tables_3_6` |
| `156` | `ERT` | `XGBM` | `above_paper_target` | `-` | `-` | `-` | `-` | `-` | `not_yet_matched_tables_3_6` |
| `162` | `ERT` | `XGBM` | `above_paper_target` | `-` | `-` | `-` | `-` | `-` | `not_yet_matched_tables_3_6` |
| `240` | `ERT` | `XGBM` | `above_paper_target` | `-` | `-` | `-` | `-` | `-` | `not_yet_matched_tables_3_6` |

## ONNX Export Surface

- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/full_matrix/xgbm/2026-04-18-15-47-59__track1_xgbm_amplitude_full_matrix_campaign_run/onnx_export`;
