...
- run name: `track1_rf_phase_78_closure_attempt_05`;
- output run name: `track1_rf_phase_78_closure_attempt_05_campaign_run`;
- run instance id: `2026-04-19-02-53-43__track1_rf_phase_78_closure_attempt_05_campaign_run`;
...
- winning mean component MAPE: `191.121%`;
- winning mean component MAE: `0.059212`;
- winning mean component RMSE: `0.138419`;
...
| --- | --- | ---: | ---: | --- |
| `RF` | `paper_reference_grid_search` | 5 | 0.827726 | `{'estimator__criterion': 'absolute_error', 'estimator__max_depth': 12, 'estimator__min_samples_split': 4, 'estimator__n_estimators': 80}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `RF` | `RandomForestRegressor` | `paper_reference_grid_search` | 191.121 | 0.059212 | 0.138419 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_78` | `RF` | `RandomForestRegressor` | 191.121 | 0.059212 | 0.138419 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_78` | `HGBM / RF` | `RF` | 191.121 | `matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/rf/2026-04-19-02-53-43__track1_rf_phase_78_closure_attempt_05_campaign_run/onnx_export`;
