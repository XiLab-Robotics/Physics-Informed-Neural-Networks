...
- run name: `track1_gbm_amplitude_3_closure_attempt_06`;
- output run name: `track1_gbm_amplitude_3_closure_attempt_06_campaign_run`;
- run instance id: `2026-04-19-05-36-21__track1_gbm_amplitude_3_closure_attempt_06_campaign_run`;
...
- winning mean component MAPE: `2.089%`;
- winning mean component MAE: `0.000017`;
- winning mean component RMSE: `0.000024`;
...
| --- | --- | ---: | ---: | --- |
| `GBM` | `paper_reference_grid_search` | 5 | 0.964576 | `{'estimator__criterion': 'squared_error', 'estimator__learning_rate': 0.1, 'estimator__max_depth': 14, 'estimator__min_samples_split': 18, 'estimator__n_estimators': 52}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `GBM` | `GradientBoostingRegressor` | `paper_reference_grid_search` | 2.089 | 0.000017 | 0.000024 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_3` | `GBM` | `GradientBoostingRegressor` | 2.089 | 0.000017 | 0.000024 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_3` | `HGBM` | `GBM` | 2.089 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/gbm/2026-04-19-05-36-21__track1_gbm_amplitude_3_closure_attempt_06_campaign_run/onnx_export`;
