...
- run name: `track1_xgbm_phase_81_closure_attempt_01`;
- output run name: `track1_xgbm_phase_81_closure_attempt_01_campaign_run`;
- run instance id: `2026-04-19-07-29-25__track1_xgbm_phase_81_closure_attempt_01_campaign_run`;
...
- winning mean component MAPE: `7.590%`;
- winning mean component MAE: `0.082346`;
- winning mean component RMSE: `0.114812`;
...
| --- | --- | ---: | ---: | --- |
| `XGBM` | `paper_reference_grid_search` | 5 | 0.934248 | `{'estimator__colsample_bytree': 0.8, 'estimator__learning_rate': 0.2, 'estimator__max_depth': 14}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `XGBM` | `XGBRegressor` | `paper_reference_grid_search` | 7.590 | 0.082346 | 0.114812 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_81` | `XGBM` | `XGBRegressor` | 7.590 | 0.082346 | 0.114812 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_81` | `RF` | `XGBM` | 7.590 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/xgbm/2026-04-19-07-29-25__track1_xgbm_phase_81_closure_attempt_01_campaign_run/onnx_export`;
