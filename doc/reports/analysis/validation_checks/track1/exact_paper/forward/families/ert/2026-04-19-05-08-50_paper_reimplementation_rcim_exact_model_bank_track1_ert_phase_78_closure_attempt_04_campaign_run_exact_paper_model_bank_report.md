...
- run name: `track1_ert_phase_78_closure_attempt_04`;
- output run name: `track1_ert_phase_78_closure_attempt_04_campaign_run`;
- run instance id: `2026-04-19-05-08-32__track1_ert_phase_78_closure_attempt_04_campaign_run`;
...
- winning best params: `{'estimator__criterion': 'absolute_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 5, 'estimator__n_estimators': 40}`;
- winning mean component MAPE: `107.162%`;
- winning mean component MAE: `0.065156`;
- winning mean component RMSE: `0.119648`;
...
| --- | --- | ---: | ---: | --- |
| `ERT` | `paper_reference_grid_search` | 5 | 0.811295 | `{'estimator__criterion': 'absolute_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 5, 'estimator__n_estimators': 40}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ERT` | `ExtraTreesRegressor` | `paper_reference_grid_search` | 107.162 | 0.065156 | 0.119648 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_78` | `ERT` | `ExtraTreesRegressor` | 107.162 | 0.065156 | 0.119648 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_78` | `HGBM / RF` | `ERT` | 107.162 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/ert/2026-04-19-05-08-32__track1_ert_phase_78_closure_attempt_04_campaign_run/onnx_export`;
