...
- run name: `track1_mlp_phase_78_closure_attempt_02`;
- output run name: `track1_mlp_phase_78_closure_attempt_02_campaign_run`;
- run instance id: `2026-04-19-01-58-40__track1_mlp_phase_78_closure_attempt_02_campaign_run`;
...
- winning mean component MAPE: `139.761%`;
- winning mean component MAE: `0.157194`;
- winning mean component RMSE: `0.226805`;
...
| --- | --- | ---: | ---: | --- |
| `MLP` | `paper_reference_grid_search` | 5 | 0.645071 | `{'estimator__activation': 'tanh', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (100, 50), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `MLP` | `MLPRegressor` | `paper_reference_grid_search` | 139.761 | 0.157194 | 0.226805 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_78` | `MLP` | `MLPRegressor` | 139.761 | 0.157194 | 0.226805 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_78` | `HGBM / RF` | `MLP` | 139.761 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/mlp/2026-04-19-01-58-40__track1_mlp_phase_78_closure_attempt_02_campaign_run/onnx_export`;
