...
- run name: `track1_lgbm_phase_1_closure_attempt_05`;
- output run name: `track1_lgbm_phase_1_closure_attempt_05_campaign_run`;
- run instance id: `2026-04-19-09-23-40__track1_lgbm_phase_1_closure_attempt_05_campaign_run`;
...
- winning mean component MAPE: `18.735%`;
- winning mean component MAE: `0.001706`;
- winning mean component RMSE: `0.002426`;
...
| --- | --- | ---: | ---: | --- |
| `LGBM` | `paper_reference_grid_search` | 5 | 0.765328 | `{'estimator__learning_rate': 0.58, 'estimator__max_depth': 10, 'estimator__num_leaves': 8, 'estimator__subsample': 0.001}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `LGBM` | `LGBMRegressor` | `paper_reference_grid_search` | 18.735 | 0.001706 | 0.002426 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_1` | `LGBM` | `LGBMRegressor` | 18.735 | 0.001706 | 0.002426 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_1` | `RF / LGBM` | `LGBM` | 18.735 | `matched_expected_family_direction` |
...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `1` | `-` | `-` | `-` | `LGBM` | `LGBM` | `LGBM` | `met_paper_target` | `met_paper_target` | `fully_matched_tables_3_6` |

## ONNX Export Surface

- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/lgbm/2026-04-19-09-23-40__track1_lgbm_phase_1_closure_attempt_05_campaign_run/onnx_export`;
