...
- run name: `track1_xgbm_phase_240_closure_attempt_01`;
- output run name: `track1_xgbm_phase_240_closure_attempt_01_campaign_run`;
- run instance id: `2026-04-19-07-33-53__track1_xgbm_phase_240_closure_attempt_01_campaign_run`;
...
- winning mean component MAPE: `41.379%`;
- winning mean component MAE: `0.431884`;
- winning mean component RMSE: `0.910301`;
...
| --- | --- | ---: | ---: | --- |
| `XGBM` | `paper_reference_grid_search` | 5 | 0.468409 | `{'estimator__colsample_bytree': 0.8, 'estimator__learning_rate': 0.2, 'estimator__max_depth': 16}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `XGBM` | `XGBRegressor` | `paper_reference_grid_search` | 41.379 | 0.431884 | 0.910301 |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/xgbm/2026-04-19-07-33-53__track1_xgbm_phase_240_closure_attempt_01_campaign_run/onnx_export`;
