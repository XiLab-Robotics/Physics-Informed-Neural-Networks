...
- run name: `track1_hgbm_amplitude_81_closure_attempt_04`;
- output run name: `track1_hgbm_amplitude_81_closure_attempt_04_campaign_run`;
- run instance id: `2026-04-19-06-31-37__track1_hgbm_amplitude_81_closure_attempt_04_campaign_run`;
...
- winning mean component MAPE: `3.603%`;
- winning mean component MAE: `0.000010`;
- winning mean component RMSE: `0.000014`;
...
| --- | --- | ---: | ---: | --- |
| `HGBM` | `paper_reference_grid_search` | 5 | 0.928984 | `{'estimator__learning_rate': 0.22, 'estimator__max_depth': 12, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 24}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `HGBM` | `HistGradientBoostingRegressor` | `paper_reference_grid_search` | 3.603 | 0.000010 | 0.000014 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_81` | `HGBM` | `HistGradientBoostingRegressor` | 3.603 | 0.000010 | 0.000014 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_81` | `RF` | `HGBM` | 3.603 | `not_matched_expected_family_direction` |
...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `81` | `RF` | `HGBM` | `met_paper_target` | `-` | `-` | `-` | `-` | `-` | `partially_matched_tables_3_6` |

## ONNX Export Surface

- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/hgbm/2026-04-19-06-31-37__track1_hgbm_amplitude_81_closure_attempt_04_campaign_run/onnx_export`;
