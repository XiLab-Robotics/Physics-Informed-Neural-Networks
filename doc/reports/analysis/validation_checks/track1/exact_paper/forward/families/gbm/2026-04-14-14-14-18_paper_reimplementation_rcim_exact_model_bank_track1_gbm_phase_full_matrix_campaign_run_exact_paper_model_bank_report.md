...
- run instance id: `2026-04-14-14-14-17__track1_gbm_phase_full_matrix_campaign_run`;
...
- winning mean component MAPE: `44.751%`;
- winning mean component MAE: `0.138700`;
- winning mean component RMSE: `0.339044`;

## Family Ranking

| Rank | Family | Estimator | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | ---: | ---: | ---: |
| 1 | `GBM` | `GradientBoostingRegressor` | 44.751 | 0.138700 | 0.339044 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_1` | `GBM` | `GradientBoostingRegressor` | 23.569 | 0.001883 | 0.002510 |
...
| `fft_y_Fw_filtered_phase_40` | `GBM` | `GradientBoostingRegressor` | 65.877 | 0.037930 | 0.057039 |
| `fft_y_Fw_filtered_phase_78` | `GBM` | `GradientBoostingRegressor` | 120.351 | 0.060844 | 0.139884 |
| `fft_y_Fw_filtered_phase_81` | `GBM` | `GradientBoostingRegressor` | 4.937 | 0.050932 | 0.075851 |
| `fft_y_Fw_filtered_phase_156` | `GBM` | `GradientBoostingRegressor` | 147.705 | 0.467813 | 1.019027 |
| `fft_y_Fw_filtered_phase_162` | `GBM` | `GradientBoostingRegressor` | 12.657 | 0.279670 | 0.824827 |
| `fft_y_Fw_filtered_phase_240` | `GBM` | `GradientBoostingRegressor` | 24.504 | 0.302119 | 0.857828 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_1` | `RF / LGBM` | `GBM` | 23.569 | `not_matched_expected_family_direction` |
...
| `fft_y_Fw_filtered_phase_40` | `ERT / GBM` | `GBM` | 65.877 | `matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_78` | `HGBM / RF` | `GBM` | 120.351 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_81` | `RF` | `GBM` | 4.937 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_156` | `ERT / RF` | `GBM` | 147.705 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_162` | `ERT` | `GBM` | 12.657 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_240` | `ERT` | `GBM` | 24.504 | `not_matched_expected_family_direction` |
...
| `Repo Best MAE` | 0.001883 | 0.0238 | 0.0234 | 0.0379 | 0.0608 | 0.0509 | 0.4678 | 0.2797 | 0.3021 |
...
| `Gap Vs Paper` | 8.32e-05 | 0.003757 | 0.002351 | 0.001930 | -0.0132 | -0.002068 | -0.0422 | 0.0797 | 0.0721 |
...
| `Repo Best Family` | `GBM` | `GBM` | `GBM` | `GBM` | `GBM` | `GBM` | `GBM` | `GBM` | `GBM` |
| `Repo Best RMSE` | 0.002510 | 0.0343 | 0.0401 | 0.0570 | 0.1399 | 0.0759 | 1.019 | 0.8248 | 0.8578 |
...
| `Gap Vs Paper` | 1.01e-05 | 0.005316 | 0.0131 | 0.002039 | -0.0201 | -0.006149 | -0.1810 | 0.1848 | 0.2778 |
| `Status` | `above_paper_target` | `above_paper_target` | `above_paper_target` | `above_paper_target` | `met_paper_target` | `met_paper_target` | `met_paper_target` | `above_paper_target` | `above_paper_target` |
...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `1` | `-` | `-` | `-` | `LGBM` | `GBM` | `GBM` | `above_paper_target` | `above_paper_target` | `not_yet_matched_tables_3_6` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/full_matrix/gbm/2026-04-14-14-14-17__track1_gbm_phase_full_matrix_campaign_run/onnx_export`;
