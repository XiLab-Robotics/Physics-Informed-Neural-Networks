...
- run name: `track1_mlp_amplitude_156_final_closure_attempt_53`;
- output run name: `track1_mlp_amplitude_156_final_closure_attempt_53_campaign_run`;
- run instance id: `2026-04-22-00-09-59__track1_mlp_amplitude_156_final_closure_attempt_53_campaign_run`;
...
- winning mean component MAPE: `9504.399%`;
- winning mean component MAE: `0.011681`;
- winning mean component RMSE: `0.022468`;
...
| --- | --- | ---: | ---: | --- |
| `MLP` | `paper_reference_grid_search` | 5 | -522.873219 | `{'estimator__activation': 'tanh', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (200, 50), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `MLP` | `MLPRegressor` | `paper_reference_grid_search` | 9504.399 | 0.011681 | 0.022468 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_156` | `MLP` | `MLPRegressor` | 9504.399 | 0.011681 | 0.022468 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_156` | `ERT / RF` | `MLP` | 9504.399 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/mlp/2026-04-22-00-09-59__track1_mlp_amplitude_156_final_closure_attempt_53_campaign_run/onnx_export`;
