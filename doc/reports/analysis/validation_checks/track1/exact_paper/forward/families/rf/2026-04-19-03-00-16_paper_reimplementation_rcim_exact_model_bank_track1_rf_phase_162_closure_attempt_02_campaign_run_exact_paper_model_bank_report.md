...
- run name: `track1_rf_phase_162_closure_attempt_02`;
- output run name: `track1_rf_phase_162_closure_attempt_02_campaign_run`;
- run instance id: `2026-04-19-02-59-58__track1_rf_phase_162_closure_attempt_02_campaign_run`;
...
- winning mean component MAPE: `12.565%`;
- winning mean component MAE: `0.325843`;
- winning mean component RMSE: `0.967314`;
...
| --- | --- | ---: | ---: | --- |
| `RF` | `paper_reference_grid_search` | 5 | 0.727635 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 12, 'estimator__min_samples_split': 2, 'estimator__n_estimators': 60}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `RF` | `RandomForestRegressor` | `paper_reference_grid_search` | 12.565 | 0.325843 | 0.967314 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_162` | `RF` | `RandomForestRegressor` | 12.565 | 0.325843 | 0.967314 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_162` | `ERT` | `RF` | 12.565 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/rf/2026-04-19-02-59-58__track1_rf_phase_162_closure_attempt_02_campaign_run/onnx_export`;
