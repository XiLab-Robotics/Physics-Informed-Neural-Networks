...
- run name: `track1_dt_amplitude_39_closure_attempt_05`;
- output run name: `track1_dt_amplitude_39_closure_attempt_05_campaign_run`;
- run instance id: `2026-04-19-03-21-30__track1_dt_amplitude_39_closure_attempt_05_campaign_run`;
...
| --- | --- | ---: | ---: | --- |
| `DT` | `paper_reference_grid_search` | 5 | 0.972546 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 5}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `DT` | `DecisionTreeRegressor` | `paper_reference_grid_search` | 3.136 | 0.000034 | 0.000049 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_39` | `DT` | `DecisionTreeRegressor` | 3.136 | 0.000034 | 0.000049 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_39` | `HGBM` | `DT` | 3.136 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/dt/2026-04-19-03-21-30__track1_dt_amplitude_39_closure_attempt_05_campaign_run/onnx_export`;
