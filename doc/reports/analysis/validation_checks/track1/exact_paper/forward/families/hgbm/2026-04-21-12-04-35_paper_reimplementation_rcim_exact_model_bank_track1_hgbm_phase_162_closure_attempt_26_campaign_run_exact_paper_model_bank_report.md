...
- run name: `track1_hgbm_phase_162_closure_attempt_26`;
- output run name: `track1_hgbm_phase_162_closure_attempt_26_campaign_run`;
- run instance id: `2026-04-21-12-04-22__track1_hgbm_phase_162_closure_attempt_26_campaign_run`;
...
- winning mean component MAPE: `20.761%`;
- winning mean component MAE: `0.469339`;
- winning mean component RMSE: `0.944824`;
...
| --- | --- | ---: | ---: | --- |
| `HGBM` | `paper_reference_grid_search` | 5 | 0.655966 | `{'estimator__learning_rate': 0.22, 'estimator__max_depth': 10, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 24}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `HGBM` | `HistGradientBoostingRegressor` | `paper_reference_grid_search` | 20.761 | 0.469339 | 0.944824 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_162` | `HGBM` | `HistGradientBoostingRegressor` | 20.761 | 0.469339 | 0.944824 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_162` | `ERT` | `HGBM` | 20.761 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/hgbm/2026-04-21-12-04-22__track1_hgbm_phase_162_closure_attempt_26_campaign_run/onnx_export`;
