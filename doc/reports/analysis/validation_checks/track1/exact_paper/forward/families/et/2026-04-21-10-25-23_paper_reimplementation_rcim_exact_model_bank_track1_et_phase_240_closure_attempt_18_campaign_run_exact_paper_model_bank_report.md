...
- run name: `track1_et_phase_240_closure_attempt_18`;
- output run name: `track1_et_phase_240_closure_attempt_18_campaign_run`;
- run instance id: `2026-04-21-10-25-15__track1_et_phase_240_closure_attempt_18_campaign_run`;
...
- winning mean component MAE: `0.177438`;
- winning mean component RMSE: `0.486436`;
...
| --- | --- | ---: | ---: | --- |
| `ET` | `paper_reference_grid_search` | 5 | 0.211361 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 17, 'estimator__min_samples_split': 3}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ET` | `ExtraTreeRegressor` | `paper_reference_grid_search` | 15.689 | 0.177438 | 0.486436 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_240` | `ET` | `ExtraTreeRegressor` | 15.689 | 0.177438 | 0.486436 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_240` | `ERT` | `ET` | 15.689 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/et/2026-04-21-10-25-15__track1_et_phase_240_closure_attempt_18_campaign_run/onnx_export`;
