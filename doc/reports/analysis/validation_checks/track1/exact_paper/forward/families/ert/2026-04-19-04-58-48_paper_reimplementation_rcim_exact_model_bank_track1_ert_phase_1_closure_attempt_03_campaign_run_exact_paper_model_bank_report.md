...
- run name: `track1_ert_phase_1_closure_attempt_03`;
- output run name: `track1_ert_phase_1_closure_attempt_03_campaign_run`;
- run instance id: `2026-04-19-04-58-30__track1_ert_phase_1_closure_attempt_03_campaign_run`;
...
- winning mean component MAPE: `26.064%`;
- winning mean component MAE: `0.002180`;
- winning mean component RMSE: `0.003181`;
...
| --- | --- | ---: | ---: | --- |
| `ERT` | `paper_reference_grid_search` | 5 | 0.728667 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 5, 'estimator__n_estimators': 40}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ERT` | `ExtraTreesRegressor` | `paper_reference_grid_search` | 26.064 | 0.002180 | 0.003181 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_1` | `ERT` | `ExtraTreesRegressor` | 26.064 | 0.002180 | 0.003181 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_1` | `RF / LGBM` | `ERT` | 26.064 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/ert/2026-04-19-04-58-30__track1_ert_phase_1_closure_attempt_03_campaign_run/onnx_export`;
