...
- run name: `track1_hgbm_amplitude_81_closure_attempt_02`;
- output run name: `track1_hgbm_amplitude_81_closure_attempt_02_campaign_run`;
- run instance id: `2026-04-19-06-30-58__track1_hgbm_amplitude_81_closure_attempt_02_campaign_run`;
...
- winning mean component MAPE: `3.414%`;
...
| --- | --- | ---: | ---: | --- |
| `HGBM` | `paper_reference_grid_search` | 5 | 0.913265 | `{'estimator__learning_rate': 0.22, 'estimator__max_depth': 13, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 26}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `HGBM` | `HistGradientBoostingRegressor` | `paper_reference_grid_search` | 3.414 | 0.000010 | 0.000014 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_81` | `HGBM` | `HistGradientBoostingRegressor` | 3.414 | 0.000010 | 0.000014 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_81` | `RF` | `HGBM` | 3.414 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/hgbm/2026-04-19-06-30-58__track1_hgbm_amplitude_81_closure_attempt_02_campaign_run/onnx_export`;
