...
- run name: `track1_rf_phase_162_closure_attempt_23`;
- output run name: `track1_rf_phase_162_closure_attempt_23_campaign_run`;
- run instance id: `2026-04-21-09-54-02__track1_rf_phase_162_closure_attempt_23_campaign_run`;
...
- winning mean component MAPE: `14.671%`;
- winning mean component MAE: `0.352391`;
- winning mean component RMSE: `0.933621`;
...
| --- | --- | ---: | ---: | --- |
| `RF` | `paper_reference_grid_search` | 5 | 0.752520 | `{'estimator__criterion': 'absolute_error', 'estimator__max_depth': 15, 'estimator__min_samples_split': 2, 'estimator__n_estimators': 50}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `RF` | `RandomForestRegressor` | `paper_reference_grid_search` | 14.671 | 0.352391 | 0.933621 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_162` | `RF` | `RandomForestRegressor` | 14.671 | 0.352391 | 0.933621 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_162` | `ERT` | `RF` | 14.671 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/rf/2026-04-21-09-54-02__track1_rf_phase_162_closure_attempt_23_campaign_run/onnx_export`;
