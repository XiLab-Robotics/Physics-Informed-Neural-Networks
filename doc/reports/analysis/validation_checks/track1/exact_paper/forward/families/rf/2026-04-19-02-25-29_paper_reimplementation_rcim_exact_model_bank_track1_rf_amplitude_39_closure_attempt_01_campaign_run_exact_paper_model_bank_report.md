...
- run name: `track1_rf_amplitude_39_closure_attempt_01`;
- output run name: `track1_rf_amplitude_39_closure_attempt_01_campaign_run`;
- run instance id: `2026-04-19-02-25-12__track1_rf_amplitude_39_closure_attempt_01_campaign_run`;
...
- winning best params: `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 3, 'estimator__n_estimators': 90}`;
- winning mean component MAPE: `2.433%`;
...
| --- | --- | ---: | ---: | --- |
| `RF` | `paper_reference_grid_search` | 5 | 0.980377 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 3, 'estimator__n_estimators': 90}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `RF` | `RandomForestRegressor` | `paper_reference_grid_search` | 2.433 | 0.000027 | 0.000037 |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/rf/2026-04-19-02-25-12__track1_rf_amplitude_39_closure_attempt_01_campaign_run/onnx_export`;
