...
- run name: `track1_et_amplitude_full_matrix`;
- output run name: `track1_et_amplitude_full_matrix_campaign_run`;
- run instance id: `2026-04-18-01-27-07__track1_et_amplitude_full_matrix_campaign_run`;
...
- winning best params: `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 15, 'estimator__min_samples_split': 4}`;
- winning mean component MAPE: `8.043%`;
- winning mean component MAE: `0.000398`;
- winning mean component RMSE: `0.000554`;
...
| --- | --- | ---: | ---: | --- |
| `ET` | `paper_reference_grid_search` | 5 | 0.874226 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 15, 'estimator__min_samples_split': 4}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ET` | `ExtraTreeRegressor` | `paper_reference_grid_search` | 8.043 | 0.000398 | 0.000554 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_0` | `ET` | `ExtraTreeRegressor` | 11.415 | 0.003583 | 0.004656 |
| `fft_y_Fw_filtered_ampl_1` | `ET` | `ExtraTreeRegressor` | 0.186 | 0.000032 | 0.000042 |
| `fft_y_Fw_filtered_ampl_3` | `ET` | `ExtraTreeRegressor` | 2.915 | 0.000023 | 0.000036 |
| `fft_y_Fw_filtered_ampl_39` | `ET` | `ExtraTreeRegressor` | 2.941 | 0.000033 | 0.000044 |
| `fft_y_Fw_filtered_ampl_40` | `ET` | `ExtraTreeRegressor` | 3.559 | 0.000029 | 0.000042 |
| `fft_y_Fw_filtered_ampl_78` | `ET` | `ExtraTreeRegressor` | 14.583 | 0.000062 | 0.000096 |
| `fft_y_Fw_filtered_ampl_81` | `ET` | `ExtraTreeRegressor` | 4.536 | 0.000014 | 0.000023 |
| `fft_y_Fw_filtered_ampl_156` | `ET` | `ExtraTreeRegressor` | 16.193 | 0.000084 | 0.000292 |
| `fft_y_Fw_filtered_ampl_162` | `ET` | `ExtraTreeRegressor` | 9.290 | 0.000069 | 0.000233 |
| `fft_y_Fw_filtered_ampl_240` | `ET` | `ExtraTreeRegressor` | 14.817 | 0.000048 | 0.000074 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_0` | `SVR` | `ET` | 11.415 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_1` | `RF / LGBM` | `ET` | 0.186 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_3` | `HGBM` | `ET` | 2.915 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_39` | `HGBM` | `ET` | 2.941 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_40` | `ERT / GBM` | `ET` | 3.559 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_78` | `HGBM / RF` | `ET` | 14.583 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_81` | `RF` | `ET` | 4.536 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_156` | `ERT / RF` | `ET` | 16.193 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_162` | `ERT` | `ET` | 9.290 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_240` | `ERT` | `ET` | 14.817 | `not_matched_expected_family_direction` |
...
| ---: | --- | --- | --- | ---: | --- |
| `0` | `SVR` | `ET` | `-` | 0/1 | `no_family_direction_match` |
...
| `Repo Best Family` | `ET` | `ET` | `ET` | `ET` | `ET` | `ET` | `ET` | `ET` | `ET` | `ET` |
| `Repo Best RMSE` | 0.004656 | 4.23e-05 | 3.56e-05 | 4.39e-05 | 4.21e-05 | 9.59e-05 | 2.30e-05 | 2.92e-04 | 2.33e-04 | 7.39e-05 |
...
| `Gap Vs Paper` | 0.001356 | 7.27e-06 | 1.06e-05 | 1.19e-05 | 6.13e-06 | 5.09e-05 | 7.99e-06 | 1.62e-04 | 7.30e-05 | 3.19e-05 |
...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `0` | `SVM` | `ET` | `above_paper_target` | `-` | `-` | `-` | `-` | `-` | `not_yet_matched_tables_3_6` |
| `1` | `RF` | `ET` | `above_paper_target` | `-` | `-` | `-` | `-` | `-` | `not_yet_matched_tables_3_6` |
| `3` | `HGBM` | `ET` | `above_paper_target` | `-` | `-` | `-` | `-` | `-` | `not_yet_matched_tables_3_6` |
| `39` | `HGBM` | `ET` | `above_paper_target` | `-` | `-` | `-` | `-` | `-` | `not_yet_matched_tables_3_6` |
| `40` | `ERT` | `ET` | `above_paper_target` | `-` | `-` | `-` | `-` | `-` | `not_yet_matched_tables_3_6` |
| `78` | `HGBM` | `ET` | `above_paper_target` | `-` | `-` | `-` | `-` | `-` | `not_yet_matched_tables_3_6` |
| `81` | `RF` | `ET` | `above_paper_target` | `-` | `-` | `-` | `-` | `-` | `not_yet_matched_tables_3_6` |
| `156` | `ERT` | `ET` | `above_paper_target` | `-` | `-` | `-` | `-` | `-` | `not_yet_matched_tables_3_6` |
| `162` | `ERT` | `ET` | `above_paper_target` | `-` | `-` | `-` | `-` | `-` | `not_yet_matched_tables_3_6` |
| `240` | `ERT` | `ET` | `above_paper_target` | `-` | `-` | `-` | `-` | `-` | `not_yet_matched_tables_3_6` |

## ONNX Export Surface

- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/full_matrix/et/2026-04-18-01-27-07__track1_et_amplitude_full_matrix_campaign_run/onnx_export`;
