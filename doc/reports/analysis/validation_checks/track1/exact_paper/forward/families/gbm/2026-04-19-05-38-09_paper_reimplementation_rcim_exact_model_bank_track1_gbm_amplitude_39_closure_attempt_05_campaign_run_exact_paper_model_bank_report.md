...
- run name: `track1_gbm_amplitude_39_closure_attempt_05`;
- output run name: `track1_gbm_amplitude_39_closure_attempt_05_campaign_run`;
- run instance id: `2026-04-19-05-37-56__track1_gbm_amplitude_39_closure_attempt_05_campaign_run`;
...
- winning mean component MAPE: `1.960%`;
- winning mean component MAE: `0.000021`;
- winning mean component RMSE: `0.000027`;
...
| --- | --- | ---: | ---: | --- |
| `GBM` | `paper_reference_grid_search` | 5 | 0.985227 | `{'estimator__criterion': 'squared_error', 'estimator__learning_rate': 0.1, 'estimator__max_depth': 16, 'estimator__min_samples_split': 18, 'estimator__n_estimators': 84}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `GBM` | `GradientBoostingRegressor` | `paper_reference_grid_search` | 1.960 | 0.000021 | 0.000027 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_39` | `GBM` | `GradientBoostingRegressor` | 1.960 | 0.000021 | 0.000027 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_39` | `HGBM` | `GBM` | 1.960 | `not_matched_expected_family_direction` |
...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `39` | `HGBM` | `GBM` | `met_paper_target` | `-` | `-` | `-` | `-` | `-` | `partially_matched_tables_3_6` |

## ONNX Export Surface

- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/gbm/2026-04-19-05-37-56__track1_gbm_amplitude_39_closure_attempt_05_campaign_run/onnx_export`;
