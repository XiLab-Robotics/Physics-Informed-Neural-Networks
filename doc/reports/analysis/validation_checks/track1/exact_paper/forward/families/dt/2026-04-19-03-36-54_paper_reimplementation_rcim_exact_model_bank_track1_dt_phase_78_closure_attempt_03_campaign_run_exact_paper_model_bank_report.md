...
- run name: `track1_dt_phase_78_closure_attempt_03`;
- output run name: `track1_dt_phase_78_closure_attempt_03_campaign_run`;
- run instance id: `2026-04-19-03-36-47__track1_dt_phase_78_closure_attempt_03_campaign_run`;
...
- winning mean component MAPE: `54.330%`;
- winning mean component MAE: `0.099370`;
- winning mean component RMSE: `0.264839`;
...
| --- | --- | ---: | ---: | --- |
| `DT` | `paper_reference_grid_search` | 5 | 0.806317 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 8}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `DT` | `DecisionTreeRegressor` | `paper_reference_grid_search` | 54.330 | 0.099370 | 0.264839 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_78` | `DT` | `DecisionTreeRegressor` | 54.330 | 0.099370 | 0.264839 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_78` | `HGBM / RF` | `DT` | 54.330 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/dt/2026-04-19-03-36-47__track1_dt_phase_78_closure_attempt_03_campaign_run/onnx_export`;
