...
- run name: `track1_xgbm_amplitude_39_closure_attempt_06`;
- output run name: `track1_xgbm_amplitude_39_closure_attempt_06_campaign_run`;
- run instance id: `2026-04-19-07-12-57__track1_xgbm_amplitude_39_closure_attempt_06_campaign_run`;
...
| --- | --- | ---: | ---: | --- |
| `XGBM` | `paper_reference_grid_search` | 5 | 0.806979 | `{'estimator__colsample_bytree': 0.3, 'estimator__learning_rate': 0.5, 'estimator__max_depth': 14}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `XGBM` | `XGBRegressor` | `paper_reference_grid_search` | 8.747 | 0.000090 | 0.000120 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_39` | `XGBM` | `XGBRegressor` | 8.747 | 0.000090 | 0.000120 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_39` | `HGBM` | `XGBM` | 8.747 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/xgbm/2026-04-19-07-12-57__track1_xgbm_amplitude_39_closure_attempt_06_campaign_run/onnx_export`;
