...
- run name: `track1_dt_amplitude_156_closure_attempt_06`;
- output run name: `track1_dt_amplitude_156_closure_attempt_06_campaign_run`;
- run instance id: `2026-04-19-03-27-28__track1_dt_amplitude_156_closure_attempt_06_campaign_run`;
...
- winning mean component MAPE: `21.573%`;
- winning mean component MAE: `0.000075`;
- winning mean component RMSE: `0.000275`;
...
| --- | --- | ---: | ---: | --- |
| `DT` | `paper_reference_grid_search` | 5 | 0.957320 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 15, 'estimator__min_samples_split': 4}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `DT` | `DecisionTreeRegressor` | `paper_reference_grid_search` | 21.573 | 0.000075 | 0.000275 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_156` | `DT` | `DecisionTreeRegressor` | 21.573 | 0.000075 | 0.000275 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_156` | `ERT / RF` | `DT` | 21.573 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/dt/2026-04-19-03-27-28__track1_dt_amplitude_156_closure_attempt_06_campaign_run/onnx_export`;
