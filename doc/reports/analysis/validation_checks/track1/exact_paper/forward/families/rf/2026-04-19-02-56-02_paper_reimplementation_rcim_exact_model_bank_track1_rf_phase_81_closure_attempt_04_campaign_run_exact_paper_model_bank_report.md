...
- run name: `track1_rf_phase_81_closure_attempt_04`;
- output run name: `track1_rf_phase_81_closure_attempt_04_campaign_run`;
- run instance id: `2026-04-19-02-55-45__track1_rf_phase_81_closure_attempt_04_campaign_run`;
...
- winning mean component MAPE: `4.238%`;
- winning mean component MAE: `0.051541`;
- winning mean component RMSE: `0.070057`;
...
| --- | --- | ---: | ---: | --- |
| `RF` | `paper_reference_grid_search` | 5 | 0.966422 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 12, 'estimator__min_samples_split': 2, 'estimator__n_estimators': 70}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `RF` | `RandomForestRegressor` | `paper_reference_grid_search` | 4.238 | 0.051541 | 0.070057 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_81` | `RF` | `RandomForestRegressor` | 4.238 | 0.051541 | 0.070057 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_81` | `RF` | `RF` | 4.238 | `matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/rf/2026-04-19-02-55-45__track1_rf_phase_81_closure_attempt_04_campaign_run/onnx_export`;
