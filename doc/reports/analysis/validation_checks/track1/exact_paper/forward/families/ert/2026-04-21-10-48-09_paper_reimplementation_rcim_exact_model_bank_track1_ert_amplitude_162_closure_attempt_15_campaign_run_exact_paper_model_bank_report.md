...
- run name: `track1_ert_amplitude_162_closure_attempt_15`;
- output run name: `track1_ert_amplitude_162_closure_attempt_15_campaign_run`;
- run instance id: `2026-04-21-10-47-50__track1_ert_amplitude_162_closure_attempt_15_campaign_run`;
...
- winning best params: `{'estimator__criterion': 'absolute_error', 'estimator__max_depth': 17, 'estimator__min_samples_split': 3, 'estimator__n_estimators': 60}`;
- winning mean component MAPE: `9.131%`;
- winning mean component MAE: `0.000085`;
- winning mean component RMSE: `0.000307`;
...
| --- | --- | ---: | ---: | --- |
| `ERT` | `paper_reference_grid_search` | 5 | 0.978377 | `{'estimator__criterion': 'absolute_error', 'estimator__max_depth': 17, 'estimator__min_samples_split': 3, 'estimator__n_estimators': 60}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ERT` | `ExtraTreesRegressor` | `paper_reference_grid_search` | 9.131 | 0.000085 | 0.000307 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_162` | `ERT` | `ExtraTreesRegressor` | 9.131 | 0.000085 | 0.000307 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_162` | `ERT` | `ERT` | 9.131 | `matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/ert/2026-04-21-10-47-50__track1_ert_amplitude_162_closure_attempt_15_campaign_run/onnx_export`;
