...
- run name: `track1_rf_phase_240_closure_attempt_06`;
- output run name: `track1_rf_phase_240_closure_attempt_06_campaign_run`;
- run instance id: `2026-04-19-03-04-04__track1_rf_phase_240_closure_attempt_06_campaign_run`;
...
- winning mean component MAPE: `17.807%`;
- winning mean component MAE: `0.247965`;
- winning mean component RMSE: `0.728712`;
...
| --- | --- | ---: | ---: | --- |
| `RF` | `paper_reference_grid_search` | 5 | 0.539991 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 13, 'estimator__min_samples_split': 2, 'estimator__n_estimators': 70}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `RF` | `RandomForestRegressor` | `paper_reference_grid_search` | 17.807 | 0.247965 | 0.728712 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_240` | `RF` | `RandomForestRegressor` | 17.807 | 0.247965 | 0.728712 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_240` | `ERT` | `RF` | 17.807 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/rf/2026-04-19-03-04-04__track1_rf_phase_240_closure_attempt_06_campaign_run/onnx_export`;
