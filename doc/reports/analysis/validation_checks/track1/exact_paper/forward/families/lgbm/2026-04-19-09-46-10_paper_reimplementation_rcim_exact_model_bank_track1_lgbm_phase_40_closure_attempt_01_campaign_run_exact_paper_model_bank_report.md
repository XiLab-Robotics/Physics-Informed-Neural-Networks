...
- run name: `track1_lgbm_phase_40_closure_attempt_01`;
- output run name: `track1_lgbm_phase_40_closure_attempt_01_campaign_run`;
- run instance id: `2026-04-19-09-44-47__track1_lgbm_phase_40_closure_attempt_01_campaign_run`;
...
- winning best params: `{'estimator__learning_rate': 0.2, 'estimator__max_depth': 13, 'estimator__num_leaves': 31, 'estimator__subsample': 0.001}`;
- winning mean component MAPE: `51.391%`;
- winning mean component MAE: `0.038337`;
- winning mean component RMSE: `0.060092`;
...
| --- | --- | ---: | ---: | --- |
| `LGBM` | `paper_reference_grid_search` | 5 | 0.758270 | `{'estimator__learning_rate': 0.2, 'estimator__max_depth': 13, 'estimator__num_leaves': 31, 'estimator__subsample': 0.001}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `LGBM` | `LGBMRegressor` | `paper_reference_grid_search` | 51.391 | 0.038337 | 0.060092 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_40` | `LGBM` | `LGBMRegressor` | 51.391 | 0.038337 | 0.060092 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_40` | `ERT / GBM` | `LGBM` | 51.391 | `not_matched_expected_family_direction` |
...
| `Repo Best Family` | - | - | - | `LGBM` | - | - | - | - | - |
| `Repo Best RMSE` | - | - | - | 0.0601 | - | - | - | - | - |
| `Paper Best Family` | - | - | - | `GBM` | - | - | - | - | - |
| `Paper Target RMSE` | - | - | - | 0.0550 | - | - | - | - | - |
| `Gap Vs Paper` | - | - | - | 0.005092 | - | - | - | - | - |
| `Status` | - | - | - | `above_paper_target` | - | - | - | - | - |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/lgbm/2026-04-19-09-44-47__track1_lgbm_phase_40_closure_attempt_01_campaign_run/onnx_export`;
