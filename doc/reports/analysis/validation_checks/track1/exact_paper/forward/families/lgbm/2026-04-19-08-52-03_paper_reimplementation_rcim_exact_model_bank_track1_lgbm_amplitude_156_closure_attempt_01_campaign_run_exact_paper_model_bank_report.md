...
- run name: `track1_lgbm_amplitude_156_closure_attempt_01`;
- output run name: `track1_lgbm_amplitude_156_closure_attempt_01_campaign_run`;
- run instance id: `2026-04-19-08-50-40__track1_lgbm_amplitude_156_closure_attempt_01_campaign_run`;
...
- winning best params: `{'estimator__learning_rate': 0.58, 'estimator__max_depth': 10, 'estimator__num_leaves': 6, 'estimator__subsample': 0.001}`;
- winning mean component MAPE: `29.237%`;
- winning mean component MAE: `0.000114`;
- winning mean component RMSE: `0.000265`;
...
| --- | --- | ---: | ---: | --- |
| `LGBM` | `paper_reference_grid_search` | 5 | 0.953700 | `{'estimator__learning_rate': 0.58, 'estimator__max_depth': 10, 'estimator__num_leaves': 6, 'estimator__subsample': 0.001}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `LGBM` | `LGBMRegressor` | `paper_reference_grid_search` | 29.237 | 0.000114 | 0.000265 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_156` | `LGBM` | `LGBMRegressor` | 29.237 | 0.000114 | 0.000265 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_156` | `ERT / RF` | `LGBM` | 29.237 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/lgbm/2026-04-19-08-50-40__track1_lgbm_amplitude_156_closure_attempt_01_campaign_run/onnx_export`;
