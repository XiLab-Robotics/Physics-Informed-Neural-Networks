...
- run name: `track1_dt_phase_3_closure_attempt_06`;
- output run name: `track1_dt_phase_3_closure_attempt_06_campaign_run`;
- run instance id: `2026-04-19-03-33-12__track1_dt_phase_3_closure_attempt_06_campaign_run`;
...
- winning mean component MAPE: `1.616%`;
- winning mean component MAE: `0.029005`;
- winning mean component RMSE: `0.049982`;
...
| --- | --- | ---: | ---: | --- |
| `DT` | `paper_reference_grid_search` | 5 | 0.887605 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 16, 'estimator__min_samples_split': 4}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `DT` | `DecisionTreeRegressor` | `paper_reference_grid_search` | 1.616 | 0.029005 | 0.049982 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_3` | `DT` | `DecisionTreeRegressor` | 1.616 | 0.029005 | 0.049982 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_3` | `HGBM` | `DT` | 1.616 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/dt/2026-04-19-03-33-12__track1_dt_phase_3_closure_attempt_06_campaign_run/onnx_export`;
