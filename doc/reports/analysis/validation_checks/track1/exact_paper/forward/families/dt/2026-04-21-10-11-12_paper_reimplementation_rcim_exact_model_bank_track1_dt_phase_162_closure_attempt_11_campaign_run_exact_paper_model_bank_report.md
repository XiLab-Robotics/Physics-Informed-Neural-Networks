...
- run name: `track1_dt_phase_162_closure_attempt_11`;
- output run name: `track1_dt_phase_162_closure_attempt_11_campaign_run`;
- run instance id: `2026-04-21-10-11-04__track1_dt_phase_162_closure_attempt_11_campaign_run`;
...
- winning mean component MAPE: `11.389%`;
- winning mean component MAE: `0.310289`;
- winning mean component RMSE: `1.145709`;
...
| --- | --- | ---: | ---: | --- |
| `DT` | `paper_reference_grid_search` | 5 | 0.677629 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 7}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `DT` | `DecisionTreeRegressor` | `paper_reference_grid_search` | 11.389 | 0.310289 | 1.145709 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_162` | `DT` | `DecisionTreeRegressor` | 11.389 | 0.310289 | 1.145709 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_162` | `ERT` | `DT` | 11.389 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/dt/2026-04-21-10-11-04__track1_dt_phase_162_closure_attempt_11_campaign_run/onnx_export`;
