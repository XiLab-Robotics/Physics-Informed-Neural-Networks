...
- run name: `track1_xgbm_amplitude_81_closure_attempt_11`;
- output run name: `track1_xgbm_amplitude_81_closure_attempt_11_campaign_run`;
- run instance id: `2026-04-21-12-16-37__track1_xgbm_amplitude_81_closure_attempt_11_campaign_run`;
...
- winning mean component MAPE: `15.957%`;
...
| --- | --- | ---: | ---: | --- |
| `XGBM` | `paper_reference_grid_search` | 5 | -0.006713 | `{'estimator__colsample_bytree': 0.3, 'estimator__learning_rate': 0.01, 'estimator__max_depth': 14}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `XGBM` | `XGBRegressor` | `paper_reference_grid_search` | 15.957 | 0.000051 | 0.000065 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_81` | `XGBM` | `XGBRegressor` | 15.957 | 0.000051 | 0.000065 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_81` | `RF` | `XGBM` | 15.957 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/xgbm/2026-04-21-12-16-37__track1_xgbm_amplitude_81_closure_attempt_11_campaign_run/onnx_export`;
