...
- run name: `track1_et_amplitude_156_closure_attempt_03`;
- output run name: `track1_et_amplitude_156_closure_attempt_03_campaign_run`;
- run instance id: `2026-04-19-04-05-21__track1_et_amplitude_156_closure_attempt_03_campaign_run`;
...
- winning mean component MAPE: `25.071%`;
- winning mean component MAE: `0.000067`;
- winning mean component RMSE: `0.000223`;
...
| --- | --- | ---: | ---: | --- |
| `ET` | `paper_reference_grid_search` | 5 | 0.966592 | `{'estimator__criterion': 'absolute_error', 'estimator__max_depth': 18, 'estimator__min_samples_split': 4}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ET` | `ExtraTreeRegressor` | `paper_reference_grid_search` | 25.071 | 0.000067 | 0.000223 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_156` | `ET` | `ExtraTreeRegressor` | 25.071 | 0.000067 | 0.000223 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_156` | `ERT / RF` | `ET` | 25.071 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/et/2026-04-19-04-05-21__track1_et_amplitude_156_closure_attempt_03_campaign_run/onnx_export`;
