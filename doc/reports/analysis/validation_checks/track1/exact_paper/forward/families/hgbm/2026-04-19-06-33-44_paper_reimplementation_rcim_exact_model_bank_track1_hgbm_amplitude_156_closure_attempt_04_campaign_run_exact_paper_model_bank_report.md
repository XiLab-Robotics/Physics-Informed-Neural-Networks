...
- run name: `track1_hgbm_amplitude_156_closure_attempt_04`;
- output run name: `track1_hgbm_amplitude_156_closure_attempt_04_campaign_run`;
- run instance id: `2026-04-19-06-33-32__track1_hgbm_amplitude_156_closure_attempt_04_campaign_run`;
...
- winning best params: `{'estimator__learning_rate': 0.22, 'estimator__max_depth': 12, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 26}`;
- winning mean component MAPE: `31.643%`;
- winning mean component MAE: `0.000078`;
- winning mean component RMSE: `0.000192`;
...
| --- | --- | ---: | ---: | --- |
| `HGBM` | `paper_reference_grid_search` | 5 | 0.953610 | `{'estimator__learning_rate': 0.22, 'estimator__max_depth': 12, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 26}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `HGBM` | `HistGradientBoostingRegressor` | `paper_reference_grid_search` | 31.643 | 0.000078 | 0.000192 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_156` | `HGBM` | `HistGradientBoostingRegressor` | 31.643 | 0.000078 | 0.000192 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_156` | `ERT / RF` | `HGBM` | 31.643 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/hgbm/2026-04-19-06-33-32__track1_hgbm_amplitude_156_closure_attempt_04_campaign_run/onnx_export`;
