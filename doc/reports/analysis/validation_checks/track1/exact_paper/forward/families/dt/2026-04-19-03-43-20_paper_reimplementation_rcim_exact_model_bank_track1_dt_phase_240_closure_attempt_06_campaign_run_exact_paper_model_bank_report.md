...
- run name: `track1_dt_phase_240_closure_attempt_06`;
- output run name: `track1_dt_phase_240_closure_attempt_06_campaign_run`;
- run instance id: `2026-04-19-03-43-12__track1_dt_phase_240_closure_attempt_06_campaign_run`;
...
- winning mean component MAPE: `22.736%`;
- winning mean component MAE: `0.244532`;
- winning mean component RMSE: `0.790540`;
...
| --- | --- | ---: | ---: | --- |
| `DT` | `paper_reference_grid_search` | 5 | 0.461395 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 5}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `DT` | `DecisionTreeRegressor` | `paper_reference_grid_search` | 22.736 | 0.244532 | 0.790540 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_240` | `DT` | `DecisionTreeRegressor` | 22.736 | 0.244532 | 0.790540 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_240` | `ERT` | `DT` | 22.736 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/dt/2026-04-19-03-43-12__track1_dt_phase_240_closure_attempt_06_campaign_run/onnx_export`;
