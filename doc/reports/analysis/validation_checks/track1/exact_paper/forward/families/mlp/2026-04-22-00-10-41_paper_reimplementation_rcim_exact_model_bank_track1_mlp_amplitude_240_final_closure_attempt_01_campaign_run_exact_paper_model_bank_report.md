...
- run name: `track1_mlp_amplitude_240_final_closure_attempt_01`;
- output run name: `track1_mlp_amplitude_240_final_closure_attempt_01_campaign_run`;
- run instance id: `2026-04-22-00-10-31__track1_mlp_amplitude_240_final_closure_attempt_01_campaign_run`;
...
- winning mean component MAPE: `3917.757%`;
- winning mean component MAE: `0.008946`;
- winning mean component RMSE: `0.016513`;
...
| --- | --- | ---: | ---: | --- |
| `MLP` | `paper_reference_grid_search` | 5 | -2252.913853 | `{'estimator__activation': 'tanh', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (200, 50), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `MLP` | `MLPRegressor` | `paper_reference_grid_search` | 3917.757 | 0.008946 | 0.016513 |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/mlp/2026-04-22-00-10-31__track1_mlp_amplitude_240_final_closure_attempt_01_campaign_run/onnx_export`;
