...
- run name: `track1_rf_phase_78_closure_attempt_01`;
- output run name: `track1_rf_phase_78_closure_attempt_01_campaign_run`;
- run instance id: `2026-04-19-02-52-05__track1_rf_phase_78_closure_attempt_01_campaign_run`;
...
- winning best params: `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 16, 'estimator__min_samples_split': 5, 'estimator__n_estimators': 80}`;
- winning mean component MAPE: `75.758%`;
- winning mean component MAE: `0.054233`;
- winning mean component RMSE: `0.124701`;
...
| --- | --- | ---: | ---: | --- |
| `RF` | `paper_reference_grid_search` | 5 | 0.806455 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 16, 'estimator__min_samples_split': 5, 'estimator__n_estimators': 80}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `RF` | `RandomForestRegressor` | `paper_reference_grid_search` | 75.758 | 0.054233 | 0.124701 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_78` | `RF` | `RandomForestRegressor` | 75.758 | 0.054233 | 0.124701 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_78` | `HGBM / RF` | `RF` | 75.758 | `matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/rf/2026-04-19-02-52-05__track1_rf_phase_78_closure_attempt_01_campaign_run/onnx_export`;
