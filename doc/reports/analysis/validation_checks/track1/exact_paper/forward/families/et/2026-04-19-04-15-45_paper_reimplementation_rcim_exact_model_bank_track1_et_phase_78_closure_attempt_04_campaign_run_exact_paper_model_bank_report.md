...
- run name: `track1_et_phase_78_closure_attempt_04`;
- output run name: `track1_et_phase_78_closure_attempt_04_campaign_run`;
- run instance id: `2026-04-19-04-15-37__track1_et_phase_78_closure_attempt_04_campaign_run`;
...
- winning mean component MAPE: `175.368%`;
- winning mean component MAE: `0.082846`;
- winning mean component RMSE: `0.183262`;
...
| --- | --- | ---: | ---: | --- |
| `ET` | `paper_reference_grid_search` | 5 | 0.718629 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 15, 'estimator__min_samples_split': 3}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ET` | `ExtraTreeRegressor` | `paper_reference_grid_search` | 175.368 | 0.082846 | 0.183262 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_78` | `ET` | `ExtraTreeRegressor` | 175.368 | 0.082846 | 0.183262 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_78` | `HGBM / RF` | `ET` | 175.368 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/et/2026-04-19-04-15-37__track1_et_phase_78_closure_attempt_04_campaign_run/onnx_export`;
