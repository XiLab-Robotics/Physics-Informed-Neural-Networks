...
- run name: `track1_hgbm_phase_1_closure_attempt_06`;
- output run name: `track1_hgbm_phase_1_closure_attempt_06_campaign_run`;
- run instance id: `2026-04-19-06-39-59__track1_hgbm_phase_1_closure_attempt_06_campaign_run`;
...
- winning mean component MAPE: `21.443%`;
- winning mean component MAE: `0.001864`;
- winning mean component RMSE: `0.002577`;
...
| --- | --- | ---: | ---: | --- |
| `HGBM` | `paper_reference_grid_search` | 5 | 0.748639 | `{'estimator__learning_rate': 0.22, 'estimator__max_depth': 12, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 25}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `HGBM` | `HistGradientBoostingRegressor` | `paper_reference_grid_search` | 21.443 | 0.001864 | 0.002577 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_1` | `HGBM` | `HistGradientBoostingRegressor` | 21.443 | 0.001864 | 0.002577 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_1` | `RF / LGBM` | `HGBM` | 21.443 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/hgbm/2026-04-19-06-39-59__track1_hgbm_phase_1_closure_attempt_06_campaign_run/onnx_export`;
