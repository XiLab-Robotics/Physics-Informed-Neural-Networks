...
- run name: `track1_hgbm_amplitude_240_closure_attempt_04`;
- output run name: `track1_hgbm_amplitude_240_closure_attempt_04_campaign_run`;
- run instance id: `2026-04-19-06-37-24__track1_hgbm_amplitude_240_closure_attempt_04_campaign_run`;
...
- winning mean component MAPE: `13.013%`;
- winning mean component MAE: `0.000037`;
- winning mean component RMSE: `0.000076`;
...
| --- | --- | ---: | ---: | --- |
| `HGBM` | `paper_reference_grid_search` | 5 | 0.973580 | `{'estimator__learning_rate': 0.22, 'estimator__max_depth': 11, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 26}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `HGBM` | `HistGradientBoostingRegressor` | `paper_reference_grid_search` | 13.013 | 0.000037 | 0.000076 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_240` | `HGBM` | `HistGradientBoostingRegressor` | 13.013 | 0.000037 | 0.000076 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_240` | `ERT` | `HGBM` | 13.013 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/hgbm/2026-04-19-06-37-24__track1_hgbm_amplitude_240_closure_attempt_04_campaign_run/onnx_export`;
