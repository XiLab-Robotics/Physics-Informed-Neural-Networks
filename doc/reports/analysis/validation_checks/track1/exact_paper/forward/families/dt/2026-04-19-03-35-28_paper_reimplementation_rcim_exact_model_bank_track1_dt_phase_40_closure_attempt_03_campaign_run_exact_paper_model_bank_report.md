...
- run name: `track1_dt_phase_40_closure_attempt_03`;
- output run name: `track1_dt_phase_40_closure_attempt_03_campaign_run`;
- run instance id: `2026-04-19-03-35-21__track1_dt_phase_40_closure_attempt_03_campaign_run`;
...
- winning best params: `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 15, 'estimator__min_samples_split': 5}`;
- winning mean component MAPE: `86.486%`;
- winning mean component MAE: `0.041932`;
- winning mean component RMSE: `0.062164`;
...
| --- | --- | ---: | ---: | --- |
| `DT` | `paper_reference_grid_search` | 5 | 0.697607 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 15, 'estimator__min_samples_split': 5}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `DT` | `DecisionTreeRegressor` | `paper_reference_grid_search` | 86.486 | 0.041932 | 0.062164 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_40` | `DT` | `DecisionTreeRegressor` | 86.486 | 0.041932 | 0.062164 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_40` | `ERT / GBM` | `DT` | 86.486 | `not_matched_expected_family_direction` |
...
| `Repo Best Family` | - | - | - | `DT` | - | - | - | - | - |
| `Repo Best RMSE` | - | - | - | 0.0622 | - | - | - | - | - |
| `Paper Best Family` | - | - | - | `GBM` | - | - | - | - | - |
| `Paper Target RMSE` | - | - | - | 0.0550 | - | - | - | - | - |
| `Gap Vs Paper` | - | - | - | 0.007164 | - | - | - | - | - |
| `Status` | - | - | - | `above_paper_target` | - | - | - | - | - |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/dt/2026-04-19-03-35-21__track1_dt_phase_40_closure_attempt_03_campaign_run/onnx_export`;
