...
- run name: `track1_hgbm_amplitude_81_closure_attempt_06`;
- output run name: `track1_hgbm_amplitude_81_closure_attempt_06_campaign_run`;
- run instance id: `2026-04-19-06-32-15__track1_hgbm_amplitude_81_closure_attempt_06_campaign_run`;
...
- winning mean component MAPE: `3.717%`;
- winning mean component MAE: `0.000011`;
- winning mean component RMSE: `0.000018`;
...
| --- | --- | ---: | ---: | --- |
| `HGBM` | `paper_reference_grid_search` | 5 | 0.931208 | `{'estimator__learning_rate': 0.22, 'estimator__max_depth': 13, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 24}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `HGBM` | `HistGradientBoostingRegressor` | `paper_reference_grid_search` | 3.717 | 0.000011 | 0.000018 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_81` | `HGBM` | `HistGradientBoostingRegressor` | 3.717 | 0.000011 | 0.000018 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_81` | `RF` | `HGBM` | 3.717 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/hgbm/2026-04-19-06-32-15__track1_hgbm_amplitude_81_closure_attempt_06_campaign_run/onnx_export`;
