...
- run name: `track1_gbm_phase_39_closure_attempt_01`;
- output run name: `track1_gbm_phase_39_closure_attempt_01_campaign_run`;
- run instance id: `2026-04-19-05-54-00__track1_gbm_phase_39_closure_attempt_01_campaign_run`;
...
- winning mean component MAPE: `1.853%`;
- winning mean component MAE: `0.023301`;
- winning mean component RMSE: `0.039480`;
...
| --- | --- | ---: | ---: | --- |
| `GBM` | `paper_reference_grid_search` | 5 | 0.982747 | `{'estimator__criterion': 'squared_error', 'estimator__learning_rate': 0.1, 'estimator__max_depth': 14, 'estimator__min_samples_split': 18, 'estimator__n_estimators': 84}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `GBM` | `GradientBoostingRegressor` | `paper_reference_grid_search` | 1.853 | 0.023301 | 0.039480 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_39` | `GBM` | `GradientBoostingRegressor` | 1.853 | 0.023301 | 0.039480 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_39` | `HGBM` | `GBM` | 1.853 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/gbm/2026-04-19-05-54-00__track1_gbm_phase_39_closure_attempt_01_campaign_run/onnx_export`;
