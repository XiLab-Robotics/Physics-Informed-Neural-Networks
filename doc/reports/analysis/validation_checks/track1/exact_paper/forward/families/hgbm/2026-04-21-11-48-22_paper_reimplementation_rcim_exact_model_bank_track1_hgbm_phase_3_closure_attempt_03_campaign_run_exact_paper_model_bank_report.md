...
- run instance id: `2026-04-21-11-48-10__track1_hgbm_phase_3_closure_attempt_03_campaign_run`;
...
- winning mean component MAPE: `1.104%`;
- winning mean component MAE: `0.019884`;
- winning mean component RMSE: `0.027713`;
...
| --- | --- | ---: | ---: | --- |
| `HGBM` | `paper_reference_grid_search` | 5 | 0.936087 | `{'estimator__learning_rate': 0.22, 'estimator__max_depth': 12, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 24}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `HGBM` | `HistGradientBoostingRegressor` | `paper_reference_grid_search` | 1.104 | 0.019884 | 0.027713 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_3` | `HGBM` | `HistGradientBoostingRegressor` | 1.104 | 0.019884 | 0.027713 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_3` | `HGBM` | `HGBM` | 1.104 | `matched_expected_family_direction` |
...
| `Repo Best Family` | - | `HGBM` | - | - | - | - | - | - | - |
| `Repo Best RMSE` | - | 0.0277 | - | - | - | - | - | - | - |
| `Paper Best Family` | - | `HGBM` | - | - | - | - | - | - | - |
| `Paper Target RMSE` | - | 0.0290 | - | - | - | - | - | - | - |
| `Gap Vs Paper` | - | -0.001287 | - | - | - | - | - | - | - |
| `Status` | - | `met_paper_target` | - | - | - | - | - | - | - |
...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `3` | `-` | `-` | `-` | `HGBM` | `HGBM` | `HGBM` | `met_paper_target` | `met_paper_target` | `fully_matched_tables_3_6` |

## ONNX Export Surface

- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/hgbm/2026-04-21-11-48-10__track1_hgbm_phase_3_closure_attempt_03_campaign_run/onnx_export`;
