...
- run name: `track1_ert_phase_156_closure_attempt_03`;
- output run name: `track1_ert_phase_156_closure_attempt_03_campaign_run`;
- run instance id: `2026-04-19-05-12-57__track1_ert_phase_156_closure_attempt_03_campaign_run`;
...
- winning mean component MAPE: `23.759%`;
- winning mean component MAE: `0.398286`;
- winning mean component RMSE: `0.917908`;
...
| --- | --- | ---: | ---: | --- |
| `ERT` | `paper_reference_grid_search` | 5 | 0.758130 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 18, 'estimator__min_samples_split': 2, 'estimator__n_estimators': 20}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ERT` | `ExtraTreesRegressor` | `paper_reference_grid_search` | 23.759 | 0.398286 | 0.917908 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_156` | `ERT` | `ExtraTreesRegressor` | 23.759 | 0.398286 | 0.917908 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_156` | `ERT / RF` | `ERT` | 23.759 | `matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/ert/2026-04-19-05-12-57__track1_ert_phase_156_closure_attempt_03_campaign_run/onnx_export`;
