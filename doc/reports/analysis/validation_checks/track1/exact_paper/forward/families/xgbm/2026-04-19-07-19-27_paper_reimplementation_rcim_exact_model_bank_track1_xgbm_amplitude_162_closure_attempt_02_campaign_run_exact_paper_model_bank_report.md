...
- run name: `track1_xgbm_amplitude_162_closure_attempt_02`;
- output run name: `track1_xgbm_amplitude_162_closure_attempt_02_campaign_run`;
- run instance id: `2026-04-19-07-19-19__track1_xgbm_amplitude_162_closure_attempt_02_campaign_run`;
...
- winning mean component MAPE: `50.805%`;
...
| --- | --- | ---: | ---: | --- |
| `XGBM` | `paper_reference_grid_search` | 5 | 0.878276 | `{'estimator__colsample_bytree': 0.8, 'estimator__learning_rate': 0.5, 'estimator__max_depth': 14}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `XGBM` | `XGBRegressor` | `paper_reference_grid_search` | 50.805 | 0.000167 | 0.000335 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_162` | `XGBM` | `XGBRegressor` | 50.805 | 0.000167 | 0.000335 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_162` | `ERT` | `XGBM` | 50.805 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/xgbm/2026-04-19-07-19-19__track1_xgbm_amplitude_162_closure_attempt_02_campaign_run/onnx_export`;
