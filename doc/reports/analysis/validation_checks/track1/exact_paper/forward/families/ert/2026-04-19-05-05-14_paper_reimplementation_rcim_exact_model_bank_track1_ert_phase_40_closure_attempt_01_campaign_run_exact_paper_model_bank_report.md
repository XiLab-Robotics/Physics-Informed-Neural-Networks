...
- run name: `track1_ert_phase_40_closure_attempt_01`;
- output run name: `track1_ert_phase_40_closure_attempt_01_campaign_run`;
- run instance id: `2026-04-19-05-04-56__track1_ert_phase_40_closure_attempt_01_campaign_run`;
...
- winning best params: `{'estimator__criterion': 'absolute_error', 'estimator__max_depth': 18, 'estimator__min_samples_split': 3, 'estimator__n_estimators': 40}`;
- winning mean component MAPE: `54.105%`;
- winning mean component MAE: `0.036211`;
- winning mean component RMSE: `0.057315`;
...
| --- | --- | ---: | ---: | --- |
| `ERT` | `paper_reference_grid_search` | 5 | 0.760423 | `{'estimator__criterion': 'absolute_error', 'estimator__max_depth': 18, 'estimator__min_samples_split': 3, 'estimator__n_estimators': 40}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ERT` | `ExtraTreesRegressor` | `paper_reference_grid_search` | 54.105 | 0.036211 | 0.057315 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_40` | `ERT` | `ExtraTreesRegressor` | 54.105 | 0.036211 | 0.057315 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_40` | `ERT / GBM` | `ERT` | 54.105 | `matched_expected_family_direction` |
...
| `Repo Best Family` | - | - | - | `ERT` | - | - | - | - | - |
| `Repo Best RMSE` | - | - | - | 0.0573 | - | - | - | - | - |
| `Paper Best Family` | - | - | - | `GBM` | - | - | - | - | - |
| `Paper Target RMSE` | - | - | - | 0.0550 | - | - | - | - | - |
| `Gap Vs Paper` | - | - | - | 0.002315 | - | - | - | - | - |
| `Status` | - | - | - | `above_paper_target` | - | - | - | - | - |
...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `40` | `-` | `-` | `-` | `GBM` | `ERT` | `ERT` | `above_paper_target` | `above_paper_target` | `not_yet_matched_tables_3_6` |

## ONNX Export Surface

- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/ert/2026-04-19-05-04-56__track1_ert_phase_40_closure_attempt_01_campaign_run/onnx_export`;
