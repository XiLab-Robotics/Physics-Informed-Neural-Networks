...
- run name: `track1_xgbm_amplitude_81_closure_attempt_01`;
- output run name: `track1_xgbm_amplitude_81_closure_attempt_01_campaign_run`;
- run instance id: `2026-04-19-07-16-08__track1_xgbm_amplitude_81_closure_attempt_01_campaign_run`;
...
- winning mean component MAPE: `15.326%`;
...
| --- | --- | ---: | ---: | --- |
| `XGBM` | `paper_reference_grid_search` | 5 | -0.012261 | `{'estimator__colsample_bytree': 0.3, 'estimator__learning_rate': 0.01, 'estimator__max_depth': 14}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `XGBM` | `XGBRegressor` | `paper_reference_grid_search` | 15.326 | 0.000047 | 0.000060 |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/xgbm/2026-04-19-07-16-08__track1_xgbm_amplitude_81_closure_attempt_01_campaign_run/onnx_export`;
