...
- run name: `track1_mlp_amplitude_39_closure_attempt_07`;
- output run name: `track1_mlp_amplitude_39_closure_attempt_07_campaign_run`;
- run instance id: `2026-04-21-00-28-29__track1_mlp_amplitude_39_closure_attempt_07_campaign_run`;
...
- winning mean component MAPE: `521.445%`;
- winning mean component MAE: `0.005208`;
- winning mean component RMSE: `0.009191`;
...
| --- | --- | ---: | ---: | --- |
| `MLP` | `paper_reference_grid_search` | 5 | -6484.148328 | `{'estimator__activation': 'tanh', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (200, 50), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `MLP` | `MLPRegressor` | `paper_reference_grid_search` | 521.445 | 0.005208 | 0.009191 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_39` | `MLP` | `MLPRegressor` | 521.445 | 0.005208 | 0.009191 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_39` | `HGBM` | `MLP` | 521.445 | `not_matched_expected_family_direction` |
...
| `Repo Best RMSE` | - | - | - | 0.009191 | - | - | - | - | - | - |
| `Paper Best Family` | - | - | - | `HGBM` | - | - | - | - | - | - |
| `Paper Target RMSE` | - | - | - | 3.20e-05 | - | - | - | - | - | - |
| `Gap Vs Paper` | - | - | - | 0.009159 | - | - | - | - | - | - |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/mlp/2026-04-21-00-28-29__track1_mlp_amplitude_39_closure_attempt_07_campaign_run/onnx_export`;
