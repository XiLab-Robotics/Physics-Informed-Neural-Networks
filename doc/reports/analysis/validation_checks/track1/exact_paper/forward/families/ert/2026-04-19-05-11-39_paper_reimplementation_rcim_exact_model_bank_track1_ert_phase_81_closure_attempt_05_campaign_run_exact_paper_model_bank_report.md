...
- run name: `track1_ert_phase_81_closure_attempt_05`;
- output run name: `track1_ert_phase_81_closure_attempt_05_campaign_run`;
- run instance id: `2026-04-19-05-11-21__track1_ert_phase_81_closure_attempt_05_campaign_run`;
...
- winning best params: `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 17, 'estimator__min_samples_split': 4, 'estimator__n_estimators': 60}`;
- winning mean component MAPE: `4.124%`;
- winning mean component MAE: `0.046599`;
- winning mean component RMSE: `0.065176`;
...
| --- | --- | ---: | ---: | --- |
| `ERT` | `paper_reference_grid_search` | 5 | 0.958064 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 17, 'estimator__min_samples_split': 4, 'estimator__n_estimators': 60}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ERT` | `ExtraTreesRegressor` | `paper_reference_grid_search` | 4.124 | 0.046599 | 0.065176 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_81` | `ERT` | `ExtraTreesRegressor` | 4.124 | 0.046599 | 0.065176 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_81` | `RF` | `ERT` | 4.124 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/ert/2026-04-19-05-11-21__track1_ert_phase_81_closure_attempt_05_campaign_run/onnx_export`;
