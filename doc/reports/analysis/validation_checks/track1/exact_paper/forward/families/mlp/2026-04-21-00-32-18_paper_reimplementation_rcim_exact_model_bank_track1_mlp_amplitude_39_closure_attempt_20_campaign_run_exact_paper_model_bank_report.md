...
- run name: `track1_mlp_amplitude_39_closure_attempt_20`;
- output run name: `track1_mlp_amplitude_39_closure_attempt_20_campaign_run`;
- run instance id: `2026-04-21-00-32-09__track1_mlp_amplitude_39_closure_attempt_20_campaign_run`;
...
- winning mean component MAPE: `1355.898%`;
- winning mean component MAE: `0.013113`;
- winning mean component RMSE: `0.021393`;
...
| --- | --- | ---: | ---: | --- |
| `MLP` | `paper_reference_grid_search` | 5 | -4837.916395 | `{'estimator__activation': 'tanh', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (200, 50), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `MLP` | `MLPRegressor` | `paper_reference_grid_search` | 1355.898 | 0.013113 | 0.021393 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_39` | `MLP` | `MLPRegressor` | 1355.898 | 0.013113 | 0.021393 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_39` | `HGBM` | `MLP` | 1355.898 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/mlp/2026-04-21-00-32-09__track1_mlp_amplitude_39_closure_attempt_20_campaign_run/onnx_export`;
