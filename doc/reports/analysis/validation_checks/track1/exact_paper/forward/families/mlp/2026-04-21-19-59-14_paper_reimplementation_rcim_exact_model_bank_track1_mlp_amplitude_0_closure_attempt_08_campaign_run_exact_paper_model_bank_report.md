...
- run name: `track1_mlp_amplitude_0_closure_attempt_08`;
- output run name: `track1_mlp_amplitude_0_closure_attempt_08_campaign_run`;
- run instance id: `2026-04-21-19-59-04__track1_mlp_amplitude_0_closure_attempt_08_campaign_run`;
...
- winning mean component MAPE: `24.866%`;
- winning mean component MAE: `0.011464`;
- winning mean component RMSE: `0.018999`;
...
| --- | --- | ---: | ---: | --- |
| `MLP` | `paper_reference_grid_search` | 5 | -0.658509 | `{'estimator__activation': 'tanh', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (200, 50), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `MLP` | `MLPRegressor` | `paper_reference_grid_search` | 24.866 | 0.011464 | 0.018999 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_0` | `MLP` | `MLPRegressor` | 24.866 | 0.011464 | 0.018999 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_0` | `SVR` | `MLP` | 24.866 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/mlp/2026-04-21-19-59-04__track1_mlp_amplitude_0_closure_attempt_08_campaign_run/onnx_export`;
