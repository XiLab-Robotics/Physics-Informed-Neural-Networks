...
- run name: `track1_ert_phase_40_closure_attempt_05`;
- output run name: `track1_ert_phase_40_closure_attempt_05_campaign_run`;
- run instance id: `2026-04-19-05-06-32__track1_ert_phase_40_closure_attempt_05_campaign_run`;
...
- winning best params: `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 16, 'estimator__min_samples_split': 3, 'estimator__n_estimators': 60}`;
- winning mean component MAPE: `33.484%`;
- winning mean component MAE: `0.030360`;
- winning mean component RMSE: `0.047114`;
...
| --- | --- | ---: | ---: | --- |
| `ERT` | `paper_reference_grid_search` | 5 | 0.773585 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 16, 'estimator__min_samples_split': 3, 'estimator__n_estimators': 60}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ERT` | `ExtraTreesRegressor` | `paper_reference_grid_search` | 33.484 | 0.030360 | 0.047114 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_40` | `ERT` | `ExtraTreesRegressor` | 33.484 | 0.030360 | 0.047114 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_40` | `ERT / GBM` | `ERT` | 33.484 | `matched_expected_family_direction` |
...
| `Repo Best Family` | - | - | - | `ERT` | - | - | - | - | - |
| `Repo Best RMSE` | - | - | - | 0.0471 | - | - | - | - | - |
| `Paper Best Family` | - | - | - | `GBM` | - | - | - | - | - |
| `Paper Target RMSE` | - | - | - | 0.0550 | - | - | - | - | - |
| `Gap Vs Paper` | - | - | - | -0.007886 | - | - | - | - | - |
| `Status` | - | - | - | `met_paper_target` | - | - | - | - | - |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/ert/2026-04-19-05-06-32__track1_ert_phase_40_closure_attempt_05_campaign_run/onnx_export`;
