...
- run name: `track1_lgbm_amplitude_full_matrix`;
- output run name: `track1_lgbm_amplitude_full_matrix_campaign_run`;
- run instance id: `2026-04-18-15-49-49__track1_lgbm_amplitude_full_matrix_campaign_run`;
...
- winning best params: `{'estimator__learning_rate': 0.2, 'estimator__max_depth': 10, 'estimator__num_leaves': 10, 'estimator__subsample': 0.001}`;
- winning mean component MAPE: `10.619%`;
- winning mean component MAE: `0.000292`;
- winning mean component RMSE: `0.000456`;
...
| --- | --- | ---: | ---: | --- |
| `LGBM` | `paper_reference_grid_search` | 5 | 0.917055 | `{'estimator__learning_rate': 0.2, 'estimator__max_depth': 10, 'estimator__num_leaves': 10, 'estimator__subsample': 0.001}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `LGBM` | `LGBMRegressor` | `paper_reference_grid_search` | 10.619 | 0.000292 | 0.000456 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_0` | `LGBM` | `LGBMRegressor` | 10.877 | 0.002490 | 0.003652 |
| `fft_y_Fw_filtered_ampl_1` | `LGBM` | `LGBMRegressor` | 0.139 | 0.000024 | 0.000033 |
| `fft_y_Fw_filtered_ampl_3` | `LGBM` | `LGBMRegressor` | 2.188 | 0.000017 | 0.000024 |
| `fft_y_Fw_filtered_ampl_39` | `LGBM` | `LGBMRegressor` | 2.061 | 0.000023 | 0.000031 |
| `fft_y_Fw_filtered_ampl_40` | `LGBM` | `LGBMRegressor` | 3.179 | 0.000025 | 0.000035 |
| `fft_y_Fw_filtered_ampl_78` | `LGBM` | `LGBMRegressor` | 8.669 | 0.000026 | 0.000038 |
| `fft_y_Fw_filtered_ampl_81` | `LGBM` | `LGBMRegressor` | 3.882 | 0.000012 | 0.000019 |
| `fft_y_Fw_filtered_ampl_156` | `LGBM` | `LGBMRegressor` | 28.586 | 0.000107 | 0.000300 |
| `fft_y_Fw_filtered_ampl_162` | `LGBM` | `LGBMRegressor` | 25.369 | 0.000152 | 0.000333 |
| `fft_y_Fw_filtered_ampl_240` | `LGBM` | `LGBMRegressor` | 21.241 | 0.000047 | 0.000093 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_0` | `SVR` | `LGBM` | 10.877 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_1` | `RF / LGBM` | `LGBM` | 0.139 | `matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_3` | `HGBM` | `LGBM` | 2.188 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_39` | `HGBM` | `LGBM` | 2.061 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_40` | `ERT / GBM` | `LGBM` | 3.179 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_78` | `HGBM / RF` | `LGBM` | 8.669 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_81` | `RF` | `LGBM` | 3.882 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_156` | `ERT / RF` | `LGBM` | 28.586 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_162` | `ERT` | `LGBM` | 25.369 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_240` | `ERT` | `LGBM` | 21.241 | `not_matched_expected_family_direction` |
...
| ---: | --- | --- | --- | ---: | --- |
| `0` | `SVR` | `LGBM` | `-` | 0/1 | `no_family_direction_match` |
...
| `Repo Best Family` | `LGBM` | `LGBM` | `LGBM` | `LGBM` | `LGBM` | `LGBM` | `LGBM` | `LGBM` | `LGBM` | `LGBM` |
| `Repo Best RMSE` | 0.003652 | 3.30e-05 | 2.43e-05 | 3.07e-05 | 3.53e-05 | 3.77e-05 | 1.88e-05 | 3.00e-04 | 3.33e-04 | 9.27e-05 |
...
| `Gap Vs Paper` | 3.52e-04 | -1.98e-06 | -6.51e-07 | -1.34e-06 | -6.99e-07 | -7.28e-06 | 3.81e-06 | 1.70e-04 | 1.73e-04 | 5.07e-05 |
| `Status` | `above_paper_target` | `met_paper_target` | `met_paper_target` | `met_paper_target` | `met_paper_target` | `met_paper_target` | `above_paper_target` | `above_paper_target` | `above_paper_target` | `above_paper_target` |
...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `0` | `SVM` | `LGBM` | `above_paper_target` | `-` | `-` | `-` | `-` | `-` | `not_yet_matched_tables_3_6` |
| `1` | `RF` | `LGBM` | `met_paper_target` | `-` | `-` | `-` | `-` | `-` | `partially_matched_tables_3_6` |
| `3` | `HGBM` | `LGBM` | `met_paper_target` | `-` | `-` | `-` | `-` | `-` | `partially_matched_tables_3_6` |
| `39` | `HGBM` | `LGBM` | `met_paper_target` | `-` | `-` | `-` | `-` | `-` | `partially_matched_tables_3_6` |
| `40` | `ERT` | `LGBM` | `met_paper_target` | `-` | `-` | `-` | `-` | `-` | `partially_matched_tables_3_6` |
| `78` | `HGBM` | `LGBM` | `met_paper_target` | `-` | `-` | `-` | `-` | `-` | `partially_matched_tables_3_6` |
| `81` | `RF` | `LGBM` | `above_paper_target` | `-` | `-` | `-` | `-` | `-` | `not_yet_matched_tables_3_6` |
| `156` | `ERT` | `LGBM` | `above_paper_target` | `-` | `-` | `-` | `-` | `-` | `not_yet_matched_tables_3_6` |
| `162` | `ERT` | `LGBM` | `above_paper_target` | `-` | `-` | `-` | `-` | `-` | `not_yet_matched_tables_3_6` |
| `240` | `ERT` | `LGBM` | `above_paper_target` | `-` | `-` | `-` | `-` | `-` | `not_yet_matched_tables_3_6` |

## ONNX Export Surface

- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/full_matrix/lgbm/2026-04-18-15-49-49__track1_lgbm_amplitude_full_matrix_campaign_run/onnx_export`;
