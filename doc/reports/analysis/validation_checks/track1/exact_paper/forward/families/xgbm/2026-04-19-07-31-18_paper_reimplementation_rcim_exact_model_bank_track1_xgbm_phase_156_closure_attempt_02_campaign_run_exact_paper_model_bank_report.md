...
- run name: `track1_xgbm_phase_156_closure_attempt_02`;
- output run name: `track1_xgbm_phase_156_closure_attempt_02_campaign_run`;
- run instance id: `2026-04-19-07-31-10__track1_xgbm_phase_156_closure_attempt_02_campaign_run`;
...
- winning mean component MAPE: `59.798%`;
- winning mean component MAE: `0.995468`;
- winning mean component RMSE: `1.507527`;
...
| --- | --- | ---: | ---: | --- |
| `XGBM` | `paper_reference_grid_search` | 5 | 0.642329 | `{'estimator__colsample_bytree': 0.8, 'estimator__learning_rate': 0.2, 'estimator__max_depth': 14}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `XGBM` | `XGBRegressor` | `paper_reference_grid_search` | 59.798 | 0.995468 | 1.507527 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_156` | `XGBM` | `XGBRegressor` | 59.798 | 0.995468 | 1.507527 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_156` | `ERT / RF` | `XGBM` | 59.798 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/xgbm/2026-04-19-07-31-10__track1_xgbm_phase_156_closure_attempt_02_campaign_run/onnx_export`;
