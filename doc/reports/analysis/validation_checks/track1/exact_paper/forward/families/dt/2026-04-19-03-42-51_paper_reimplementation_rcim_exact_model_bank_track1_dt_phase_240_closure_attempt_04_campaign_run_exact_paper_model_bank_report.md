...
- run name: `track1_dt_phase_240_closure_attempt_04`;
- output run name: `track1_dt_phase_240_closure_attempt_04_campaign_run`;
- run instance id: `2026-04-19-03-42-44__track1_dt_phase_240_closure_attempt_04_campaign_run`;
...
- winning mean component MAPE: `12.992%`;
- winning mean component MAE: `0.191894`;
- winning mean component RMSE: `0.623446`;
...
| --- | --- | ---: | ---: | --- |
| `DT` | `paper_reference_grid_search` | 5 | 0.506867 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 7}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `DT` | `DecisionTreeRegressor` | `paper_reference_grid_search` | 12.992 | 0.191894 | 0.623446 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_240` | `DT` | `DecisionTreeRegressor` | 12.992 | 0.191894 | 0.623446 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_240` | `ERT` | `DT` | 12.992 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/dt/2026-04-19-03-42-44__track1_dt_phase_240_closure_attempt_04_campaign_run/onnx_export`;
