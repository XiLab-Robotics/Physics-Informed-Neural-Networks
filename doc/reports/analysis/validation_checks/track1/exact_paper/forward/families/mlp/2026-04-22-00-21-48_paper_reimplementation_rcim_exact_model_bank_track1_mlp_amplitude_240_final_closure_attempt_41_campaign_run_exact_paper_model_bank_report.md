...
- run name: `track1_mlp_amplitude_240_final_closure_attempt_41`;
- output run name: `track1_mlp_amplitude_240_final_closure_attempt_41_campaign_run`;
- run instance id: `2026-04-22-00-21-38__track1_mlp_amplitude_240_final_closure_attempt_41_campaign_run`;
...
- winning mean component MAPE: `3982.566%`;
- winning mean component MAE: `0.009895`;
- winning mean component RMSE: `0.016277`;
...
| --- | --- | ---: | ---: | --- |
| `MLP` | `paper_reference_grid_search` | 5 | -1497.588675 | `{'estimator__activation': 'tanh', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (200, 50), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `MLP` | `MLPRegressor` | `paper_reference_grid_search` | 3982.566 | 0.009895 | 0.016277 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_240` | `MLP` | `MLPRegressor` | 3982.566 | 0.009895 | 0.016277 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_240` | `ERT` | `MLP` | 3982.566 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/mlp/2026-04-22-00-21-38__track1_mlp_amplitude_240_final_closure_attempt_41_campaign_run/onnx_export`;
