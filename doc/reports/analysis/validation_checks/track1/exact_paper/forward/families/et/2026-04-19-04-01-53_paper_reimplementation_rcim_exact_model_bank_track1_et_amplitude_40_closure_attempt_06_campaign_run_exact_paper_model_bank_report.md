...
- run name: `track1_et_amplitude_40_closure_attempt_06`;
- output run name: `track1_et_amplitude_40_closure_attempt_06_campaign_run`;
- run instance id: `2026-04-19-04-01-45__track1_et_amplitude_40_closure_attempt_06_campaign_run`;
...
- winning mean component MAPE: `4.092%`;
...
| --- | --- | ---: | ---: | --- |
| `ET` | `paper_reference_grid_search` | 5 | 0.730792 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 5}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ET` | `ExtraTreeRegressor` | `paper_reference_grid_search` | 4.092 | 0.000034 | 0.000059 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_40` | `ET` | `ExtraTreeRegressor` | 4.092 | 0.000034 | 0.000059 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_40` | `ERT / GBM` | `ET` | 4.092 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/et/2026-04-19-04-01-45__track1_et_amplitude_40_closure_attempt_06_campaign_run/onnx_export`;
