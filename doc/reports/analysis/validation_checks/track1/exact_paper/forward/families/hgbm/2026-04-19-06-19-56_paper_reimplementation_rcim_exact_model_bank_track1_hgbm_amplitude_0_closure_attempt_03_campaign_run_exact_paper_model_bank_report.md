...
- run name: `track1_hgbm_amplitude_0_closure_attempt_03`;
- output run name: `track1_hgbm_amplitude_0_closure_attempt_03_campaign_run`;
- run instance id: `2026-04-19-06-19-43__track1_hgbm_amplitude_0_closure_attempt_03_campaign_run`;
...
- winning best params: `{'estimator__learning_rate': 0.19, 'estimator__max_depth': 10, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 26}`;
- winning mean component MAPE: `5.365%`;
- winning mean component MAE: `0.002327`;
- winning mean component RMSE: `0.003121`;
...
| --- | --- | ---: | ---: | --- |
| `HGBM` | `paper_reference_grid_search` | 5 | 0.972458 | `{'estimator__learning_rate': 0.19, 'estimator__max_depth': 10, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 26}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `HGBM` | `HistGradientBoostingRegressor` | `paper_reference_grid_search` | 5.365 | 0.002327 | 0.003121 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_0` | `HGBM` | `HistGradientBoostingRegressor` | 5.365 | 0.002327 | 0.003121 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_0` | `SVR` | `HGBM` | 5.365 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/hgbm/2026-04-19-06-19-43__track1_hgbm_amplitude_0_closure_attempt_03_campaign_run/onnx_export`;
