...
- run name: `track1_ert_phase_39_closure_attempt_01`;
- output run name: `track1_ert_phase_39_closure_attempt_01_campaign_run`;
- run instance id: `2026-04-19-05-02-31__track1_ert_phase_39_closure_attempt_01_campaign_run`;
...
- winning mean component MAE: `0.028141`;
- winning mean component RMSE: `0.053786`;
...
| --- | --- | ---: | ---: | --- |
| `ERT` | `paper_reference_grid_search` | 5 | 0.970421 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 4, 'estimator__n_estimators': 20}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ERT` | `ExtraTreesRegressor` | `paper_reference_grid_search` | 2.182 | 0.028141 | 0.053786 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_39` | `ERT` | `ExtraTreesRegressor` | 2.182 | 0.028141 | 0.053786 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_39` | `HGBM` | `ERT` | 2.182 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/ert/2026-04-19-05-02-31__track1_ert_phase_39_closure_attempt_01_campaign_run/onnx_export`;
