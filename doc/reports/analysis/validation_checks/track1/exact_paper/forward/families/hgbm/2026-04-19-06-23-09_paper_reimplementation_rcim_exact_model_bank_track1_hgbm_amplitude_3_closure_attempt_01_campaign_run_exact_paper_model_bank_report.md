...
- run name: `track1_hgbm_amplitude_3_closure_attempt_01`;
- output run name: `track1_hgbm_amplitude_3_closure_attempt_01_campaign_run`;
- run instance id: `2026-04-19-06-22-56__track1_hgbm_amplitude_3_closure_attempt_01_campaign_run`;
...
- winning best params: `{'estimator__learning_rate': 0.18, 'estimator__max_depth': 11, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 26}`;
- winning mean component MAPE: `2.310%`;
...
| --- | --- | ---: | ---: | --- |
| `HGBM` | `paper_reference_grid_search` | 5 | 0.971214 | `{'estimator__learning_rate': 0.18, 'estimator__max_depth': 11, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 26}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `HGBM` | `HistGradientBoostingRegressor` | `paper_reference_grid_search` | 2.310 | 0.000018 | 0.000025 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_3` | `HGBM` | `HistGradientBoostingRegressor` | 2.310 | 0.000018 | 0.000025 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_3` | `HGBM` | `HGBM` | 2.310 | `matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/hgbm/2026-04-19-06-22-56__track1_hgbm_amplitude_3_closure_attempt_01_campaign_run/onnx_export`;
