...
- output run name: `track1_svr_exact_faithful_amplitude_pair_repeat_campaign_run`;
- run instance id: `2026-04-17-12-01-16__track1_svr_exact_faithful_amplitude_pair_repeat_campaign_run`;
...
- winning best params: `{'estimator__C': 0.1, 'estimator__epsilon': 1e-05, 'estimator__gamma': 1.1e-06, 'estimator__kernel': 'rbf'}`;
- winning mean component MAPE: `37.792%`;
- winning mean component MAE: `0.000192`;
- winning mean component RMSE: `0.000359`;
...
| --- | --- | ---: | ---: | --- |
| `SVR` | `paper_reference_grid_search` | 5 | -0.032418 | `{'estimator__C': 0.1, 'estimator__epsilon': 1e-05, 'estimator__gamma': 1.1e-06, 'estimator__kernel': 'rbf'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `SVR` | `SVR` | `paper_reference_grid_search` | 37.792 | 0.000192 | 0.000359 |
...
| `fft_y_Fw_filtered_ampl_240` | `SVR` | `SVR` | 65.486 | 0.000302 | 0.000622 |
...
| `fft_y_Fw_filtered_ampl_240` | `ERT` | `SVR` | 65.486 | `not_matched_expected_family_direction` |
...
| `Repo Best Family` | - | - | - | - | `SVR` | - | - | - | - | `SVR` |
| `Repo Best RMSE` | - | - | - | - | 9.63e-05 | - | - | - | - | 6.22e-04 |
| `Paper Best Family` | - | - | - | - | `ERT` | - | - | - | - | `ERT` |
| `Paper Target RMSE` | - | - | - | - | 3.60e-05 | - | - | - | - | 4.20e-05 |
| `Gap Vs Paper` | - | - | - | - | 6.03e-05 | - | - | - | - | 5.80e-04 |
| `Status` | - | - | - | - | `above_paper_target` | - | - | - | - | `above_paper_target` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/svm_targeted_closure/svm/2026-04-17-12-01-16__track1_svr_exact_faithful_amplitude_pair_repeat_campaign_run/onnx_export`;
