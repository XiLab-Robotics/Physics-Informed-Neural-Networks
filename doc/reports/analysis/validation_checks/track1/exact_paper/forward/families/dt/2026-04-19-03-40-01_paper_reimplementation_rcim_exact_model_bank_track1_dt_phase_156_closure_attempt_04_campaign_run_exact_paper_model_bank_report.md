...
- run name: `track1_dt_phase_156_closure_attempt_04`;
- output run name: `track1_dt_phase_156_closure_attempt_04_campaign_run`;
- run instance id: `2026-04-19-03-39-53__track1_dt_phase_156_closure_attempt_04_campaign_run`;
...
- winning mean component MAPE: `45.491%`;
- winning mean component MAE: `0.604006`;
- winning mean component RMSE: `1.368030`;
...
| --- | --- | ---: | ---: | --- |
| `DT` | `paper_reference_grid_search` | 5 | 0.667520 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 15, 'estimator__min_samples_split': 7}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `DT` | `DecisionTreeRegressor` | `paper_reference_grid_search` | 45.491 | 0.604006 | 1.368030 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_156` | `DT` | `DecisionTreeRegressor` | 45.491 | 0.604006 | 1.368030 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_156` | `ERT / RF` | `DT` | 45.491 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/dt/2026-04-19-03-39-53__track1_dt_phase_156_closure_attempt_04_campaign_run/onnx_export`;
