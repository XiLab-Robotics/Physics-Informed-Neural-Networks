...
- run name: `track1_et_phase_81_closure_attempt_04`;
- output run name: `track1_et_phase_81_closure_attempt_04_campaign_run`;
- run instance id: `2026-04-19-04-17-03__track1_et_phase_81_closure_attempt_04_campaign_run`;
...
- winning mean component MAPE: `5.816%`;
- winning mean component MAE: `0.070670`;
- winning mean component RMSE: `0.104852`;
...
| --- | --- | ---: | ---: | --- |
| `ET` | `paper_reference_grid_search` | 5 | 0.938476 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 15, 'estimator__min_samples_split': 4}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ET` | `ExtraTreeRegressor` | `paper_reference_grid_search` | 5.816 | 0.070670 | 0.104852 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_81` | `ET` | `ExtraTreeRegressor` | 5.816 | 0.070670 | 0.104852 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_81` | `RF` | `ET` | 5.816 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/et/2026-04-19-04-17-03__track1_et_phase_81_closure_attempt_04_campaign_run/onnx_export`;
