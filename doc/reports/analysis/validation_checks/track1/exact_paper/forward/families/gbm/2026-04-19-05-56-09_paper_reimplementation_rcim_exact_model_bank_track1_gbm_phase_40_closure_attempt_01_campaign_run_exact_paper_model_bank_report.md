...
- run name: `track1_gbm_phase_40_closure_attempt_01`;
- output run name: `track1_gbm_phase_40_closure_attempt_01_campaign_run`;
- run instance id: `2026-04-19-05-55-56__track1_gbm_phase_40_closure_attempt_01_campaign_run`;
...
- winning best params: `{'estimator__criterion': 'squared_error', 'estimator__learning_rate': 0.1, 'estimator__max_depth': 14, 'estimator__min_samples_split': 18, 'estimator__n_estimators': 52}`;
- winning mean component MAPE: `61.554%`;
- winning mean component MAE: `0.037202`;
- winning mean component RMSE: `0.057428`;
...
| --- | --- | ---: | ---: | --- |
| `GBM` | `paper_reference_grid_search` | 5 | 0.729982 | `{'estimator__criterion': 'squared_error', 'estimator__learning_rate': 0.1, 'estimator__max_depth': 14, 'estimator__min_samples_split': 18, 'estimator__n_estimators': 52}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `GBM` | `GradientBoostingRegressor` | `paper_reference_grid_search` | 61.554 | 0.037202 | 0.057428 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_40` | `GBM` | `GradientBoostingRegressor` | 61.554 | 0.037202 | 0.057428 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_40` | `ERT / GBM` | `GBM` | 61.554 | `matched_expected_family_direction` |
...
| `Repo Best MAE` | - | - | - | 0.0372 | - | - | - | - | - |
| `Paper Best Family` | - | - | - | `GBM` | - | - | - | - | - |
| `Paper Target MAE` | - | - | - | 0.0360 | - | - | - | - | - |
| `Gap Vs Paper` | - | - | - | 0.001202 | - | - | - | - | - |
...
| `Repo Best Family` | - | - | - | `GBM` | - | - | - | - | - |
| `Repo Best RMSE` | - | - | - | 0.0574 | - | - | - | - | - |
| `Paper Best Family` | - | - | - | `GBM` | - | - | - | - | - |
| `Paper Target RMSE` | - | - | - | 0.0550 | - | - | - | - | - |
| `Gap Vs Paper` | - | - | - | 0.002428 | - | - | - | - | - |
| `Status` | - | - | - | `above_paper_target` | - | - | - | - | - |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/gbm/2026-04-19-05-55-56__track1_gbm_phase_40_closure_attempt_01_campaign_run/onnx_export`;
