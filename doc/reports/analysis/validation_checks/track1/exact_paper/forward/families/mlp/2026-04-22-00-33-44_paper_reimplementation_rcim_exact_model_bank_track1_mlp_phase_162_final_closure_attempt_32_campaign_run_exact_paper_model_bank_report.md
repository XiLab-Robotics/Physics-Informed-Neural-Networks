...
- run name: `track1_mlp_phase_162_final_closure_attempt_32`;
- output run name: `track1_mlp_phase_162_final_closure_attempt_32_campaign_run`;
- run instance id: `2026-04-22-00-33-34__track1_mlp_phase_162_final_closure_attempt_32_campaign_run`;
...
- winning mean component MAPE: `54.429%`;
- winning mean component MAE: `1.070389`;
- winning mean component RMSE: `1.608985`;
...
| --- | --- | ---: | ---: | --- |
| `MLP` | `paper_reference_grid_search` | 5 | 0.273644 | `{'estimator__activation': 'tanh', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (200,), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `MLP` | `MLPRegressor` | `paper_reference_grid_search` | 54.429 | 1.070389 | 1.608985 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_162` | `MLP` | `MLPRegressor` | 54.429 | 1.070389 | 1.608985 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_162` | `ERT` | `MLP` | 54.429 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/mlp/2026-04-22-00-33-34__track1_mlp_phase_162_final_closure_attempt_32_campaign_run/onnx_export`;
