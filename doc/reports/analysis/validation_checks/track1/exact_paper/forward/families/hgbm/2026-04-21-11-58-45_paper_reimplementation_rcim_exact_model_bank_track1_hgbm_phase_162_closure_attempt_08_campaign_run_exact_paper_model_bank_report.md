...
- run name: `track1_hgbm_phase_162_closure_attempt_08`;
- output run name: `track1_hgbm_phase_162_closure_attempt_08_campaign_run`;
- run instance id: `2026-04-21-11-58-32__track1_hgbm_phase_162_closure_attempt_08_campaign_run`;
...
- winning best params: `{'estimator__learning_rate': 0.21, 'estimator__max_depth': 11, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 25}`;
- winning mean component MAPE: `22.045%`;
- winning mean component MAE: `0.507647`;
- winning mean component RMSE: `1.025220`;
...
| --- | --- | ---: | ---: | --- |
| `HGBM` | `paper_reference_grid_search` | 5 | 0.677449 | `{'estimator__learning_rate': 0.21, 'estimator__max_depth': 11, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 25}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `HGBM` | `HistGradientBoostingRegressor` | `paper_reference_grid_search` | 22.045 | 0.507647 | 1.025220 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_162` | `HGBM` | `HistGradientBoostingRegressor` | 22.045 | 0.507647 | 1.025220 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_162` | `ERT` | `HGBM` | 22.045 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/hgbm/2026-04-21-11-58-32__track1_hgbm_phase_162_closure_attempt_08_campaign_run/onnx_export`;
