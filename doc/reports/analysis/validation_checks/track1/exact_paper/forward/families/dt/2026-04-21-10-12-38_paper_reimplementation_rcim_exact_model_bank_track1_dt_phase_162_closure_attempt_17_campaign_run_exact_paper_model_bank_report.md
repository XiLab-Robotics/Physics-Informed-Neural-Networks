...
- run name: `track1_dt_phase_162_closure_attempt_17`;
- output run name: `track1_dt_phase_162_closure_attempt_17_campaign_run`;
- run instance id: `2026-04-21-10-12-31__track1_dt_phase_162_closure_attempt_17_campaign_run`;
...
- winning mean component MAPE: `10.846%`;
- winning mean component MAE: `0.282932`;
- winning mean component RMSE: `0.877715`;
...
| --- | --- | ---: | ---: | --- |
| `DT` | `paper_reference_grid_search` | 5 | 0.622965 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 17, 'estimator__min_samples_split': 6}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `DT` | `DecisionTreeRegressor` | `paper_reference_grid_search` | 10.846 | 0.282932 | 0.877715 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_162` | `DT` | `DecisionTreeRegressor` | 10.846 | 0.282932 | 0.877715 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_162` | `ERT` | `DT` | 10.846 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/dt/2026-04-21-10-12-31__track1_dt_phase_162_closure_attempt_17_campaign_run/onnx_export`;
