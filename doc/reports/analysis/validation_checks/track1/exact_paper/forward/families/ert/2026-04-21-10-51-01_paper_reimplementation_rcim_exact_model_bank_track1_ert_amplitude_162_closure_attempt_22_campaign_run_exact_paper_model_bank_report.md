...
- run name: `track1_ert_amplitude_162_closure_attempt_22`;
- output run name: `track1_ert_amplitude_162_closure_attempt_22_campaign_run`;
- run instance id: `2026-04-21-10-50-43__track1_ert_amplitude_162_closure_attempt_22_campaign_run`;
...
- winning mean component MAPE: `9.986%`;
- winning mean component MAE: `0.000066`;
- winning mean component RMSE: `0.000313`;
...
| --- | --- | ---: | ---: | --- |
| `ERT` | `paper_reference_grid_search` | 5 | 0.987802 | `{'estimator__criterion': 'absolute_error', 'estimator__max_depth': 18, 'estimator__min_samples_split': 2, 'estimator__n_estimators': 100}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ERT` | `ExtraTreesRegressor` | `paper_reference_grid_search` | 9.986 | 0.000066 | 0.000313 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_162` | `ERT` | `ExtraTreesRegressor` | 9.986 | 0.000066 | 0.000313 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_162` | `ERT` | `ERT` | 9.986 | `matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/ert/2026-04-21-10-50-43__track1_ert_amplitude_162_closure_attempt_22_campaign_run/onnx_export`;
