...
- run name: `track1_mlp_amplitude_240_final_closure_attempt_19`;
- output run name: `track1_mlp_amplitude_240_final_closure_attempt_19_campaign_run`;
- run instance id: `2026-04-22-00-15-31__track1_mlp_amplitude_240_final_closure_attempt_19_campaign_run`;
...
- winning mean component MAPE: `5386.458%`;
- winning mean component MAE: `0.008682`;
- winning mean component RMSE: `0.015044`;
...
| --- | --- | ---: | ---: | --- |
| `MLP` | `paper_reference_grid_search` | 5 | -2413.904512 | `{'estimator__activation': 'tanh', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (200, 50), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `MLP` | `MLPRegressor` | `paper_reference_grid_search` | 5386.458 | 0.008682 | 0.015044 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_240` | `MLP` | `MLPRegressor` | 5386.458 | 0.008682 | 0.015044 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_240` | `ERT` | `MLP` | 5386.458 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/mlp/2026-04-22-00-15-31__track1_mlp_amplitude_240_final_closure_attempt_19_campaign_run/onnx_export`;
