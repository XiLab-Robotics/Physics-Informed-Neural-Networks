...
- run name: `track1_ert_phase_240_closure_attempt_02`;
- output run name: `track1_ert_phase_240_closure_attempt_02_campaign_run`;
- run instance id: `2026-04-19-05-17-23__track1_ert_phase_240_closure_attempt_02_campaign_run`;
...
- winning best params: `{'estimator__criterion': 'absolute_error', 'estimator__max_depth': 15, 'estimator__min_samples_split': 3, 'estimator__n_estimators': 60}`;
- winning mean component MAPE: `78.112%`;
- winning mean component MAE: `0.253187`;
- winning mean component RMSE: `0.583767`;
...
| --- | --- | ---: | ---: | --- |
| `ERT` | `paper_reference_grid_search` | 5 | 0.654557 | `{'estimator__criterion': 'absolute_error', 'estimator__max_depth': 15, 'estimator__min_samples_split': 3, 'estimator__n_estimators': 60}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ERT` | `ExtraTreesRegressor` | `paper_reference_grid_search` | 78.112 | 0.253187 | 0.583767 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_240` | `ERT` | `ExtraTreesRegressor` | 78.112 | 0.253187 | 0.583767 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_240` | `ERT` | `ERT` | 78.112 | `matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/ert/2026-04-19-05-17-23__track1_ert_phase_240_closure_attempt_02_campaign_run/onnx_export`;
