...
- run name: `track1_xgbm_phase_162_closure_attempt_23`;
- output run name: `track1_xgbm_phase_162_closure_attempt_23_campaign_run`;
- run instance id: `2026-04-21-12-32-59__track1_xgbm_phase_162_closure_attempt_23_campaign_run`;
...
- winning mean component MAPE: `30.551%`;
- winning mean component MAE: `0.651280`;
- winning mean component RMSE: `1.151822`;
...
| --- | --- | ---: | ---: | --- |
| `XGBM` | `paper_reference_grid_search` | 5 | 0.638743 | `{'estimator__colsample_bytree': 0.8, 'estimator__learning_rate': 0.2, 'estimator__max_depth': 14}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `XGBM` | `XGBRegressor` | `paper_reference_grid_search` | 30.551 | 0.651280 | 1.151822 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_162` | `XGBM` | `XGBRegressor` | 30.551 | 0.651280 | 1.151822 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_162` | `ERT` | `XGBM` | 30.551 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/xgbm/2026-04-21-12-32-59__track1_xgbm_phase_162_closure_attempt_23_campaign_run/onnx_export`;
