...
- run name: `track1_ert_phase_240_closure_attempt_05`;
- output run name: `track1_ert_phase_240_closure_attempt_05_campaign_run`;
- run instance id: `2026-04-19-05-18-36__track1_ert_phase_240_closure_attempt_05_campaign_run`;
...
- winning best params: `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 16, 'estimator__min_samples_split': 2, 'estimator__n_estimators': 20}`;
- winning mean component MAPE: `11.954%`;
- winning mean component MAE: `0.237861`;
- winning mean component RMSE: `0.743036`;
...
| --- | --- | ---: | ---: | --- |
| `ERT` | `paper_reference_grid_search` | 5 | 0.617467 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 16, 'estimator__min_samples_split': 2, 'estimator__n_estimators': 20}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ERT` | `ExtraTreesRegressor` | `paper_reference_grid_search` | 11.954 | 0.237861 | 0.743036 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_240` | `ERT` | `ExtraTreesRegressor` | 11.954 | 0.237861 | 0.743036 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_240` | `ERT` | `ERT` | 11.954 | `matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/ert/2026-04-19-05-18-36__track1_ert_phase_240_closure_attempt_05_campaign_run/onnx_export`;
