...
- run name: `track1_rf_phase_162_closure_attempt_27`;
- output run name: `track1_rf_phase_162_closure_attempt_27_campaign_run`;
- run instance id: `2026-04-21-09-55-41__track1_rf_phase_162_closure_attempt_27_campaign_run`;
...
- winning mean component MAE: `0.328510`;
- winning mean component RMSE: `0.811246`;
...
| --- | --- | ---: | ---: | --- |
| `RF` | `paper_reference_grid_search` | 5 | 0.698705 | `{'estimator__criterion': 'absolute_error', 'estimator__max_depth': 12, 'estimator__min_samples_split': 3, 'estimator__n_estimators': 90}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `RF` | `RandomForestRegressor` | `paper_reference_grid_search` | 12.918 | 0.328510 | 0.811246 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_162` | `RF` | `RandomForestRegressor` | 12.918 | 0.328510 | 0.811246 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_162` | `ERT` | `RF` | 12.918 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/rf/2026-04-21-09-55-41__track1_rf_phase_162_closure_attempt_27_campaign_run/onnx_export`;
