...
- run name: `track1_et_phase_240_closure_attempt_13`;
- output run name: `track1_et_phase_240_closure_attempt_13_campaign_run`;
- run instance id: `2026-04-21-10-24-03__track1_et_phase_240_closure_attempt_13_campaign_run`;
...
- winning mean component MAPE: `14.721%`;
- winning mean component MAE: `0.225394`;
- winning mean component RMSE: `0.607133`;
...
| --- | --- | ---: | ---: | --- |
| `ET` | `paper_reference_grid_search` | 5 | 0.430082 | `{'estimator__criterion': 'absolute_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 5}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ET` | `ExtraTreeRegressor` | `paper_reference_grid_search` | 14.721 | 0.225394 | 0.607133 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_240` | `ET` | `ExtraTreeRegressor` | 14.721 | 0.225394 | 0.607133 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_240` | `ERT` | `ET` | 14.721 | `not_matched_expected_family_direction` |
...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `240` | `-` | `-` | `-` | `ERT` | `ET` | `ET` | `met_paper_target` | `above_paper_target` | `partially_matched_tables_3_6` |

## ONNX Export Surface

- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/et/2026-04-21-10-24-03__track1_et_phase_240_closure_attempt_13_campaign_run/onnx_export`;
