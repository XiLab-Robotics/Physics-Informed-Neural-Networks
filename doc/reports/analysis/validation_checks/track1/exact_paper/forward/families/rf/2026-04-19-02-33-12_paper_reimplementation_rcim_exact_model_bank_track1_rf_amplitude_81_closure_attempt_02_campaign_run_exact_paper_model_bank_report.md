...
- run name: `track1_rf_amplitude_81_closure_attempt_02`;
- output run name: `track1_rf_amplitude_81_closure_attempt_02_campaign_run`;
- run instance id: `2026-04-19-02-32-53__track1_rf_amplitude_81_closure_attempt_02_campaign_run`;
...
- winning mean component MAPE: `3.378%`;
...
| --- | --- | ---: | ---: | --- |
| `RF` | `paper_reference_grid_search` | 5 | 0.926379 | `{'estimator__criterion': 'absolute_error', 'estimator__max_depth': 13, 'estimator__min_samples_split': 2, 'estimator__n_estimators': 60}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `RF` | `RandomForestRegressor` | `paper_reference_grid_search` | 3.378 | 0.000010 | 0.000014 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_81` | `RF` | `RandomForestRegressor` | 3.378 | 0.000010 | 0.000014 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_81` | `RF` | `RF` | 3.378 | `matched_expected_family_direction` |
...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `81` | `RF` | `RF` | `met_paper_target` | `-` | `-` | `-` | `-` | `-` | `fully_matched_tables_3_6` |

## ONNX Export Surface

- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/rf/2026-04-19-02-32-53__track1_rf_amplitude_81_closure_attempt_02_campaign_run/onnx_export`;
