...
- run name: `track1_ert_phase_3_closure_attempt_05`;
- output run name: `track1_ert_phase_3_closure_attempt_05_campaign_run`;
- run instance id: `2026-04-19-05-01-43__track1_ert_phase_3_closure_attempt_05_campaign_run`;
...
- winning mean component MAE: `0.025261`;
- winning mean component RMSE: `0.035681`;
...
| --- | --- | ---: | ---: | --- |
| `ERT` | `paper_reference_grid_search` | 5 | 0.929816 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 15, 'estimator__min_samples_split': 5, 'estimator__n_estimators': 80}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ERT` | `ExtraTreesRegressor` | `paper_reference_grid_search` | 1.412 | 0.025261 | 0.035681 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_3` | `ERT` | `ExtraTreesRegressor` | 1.412 | 0.025261 | 0.035681 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_3` | `HGBM` | `ERT` | 1.412 | `not_matched_expected_family_direction` |
...
| `Repo Best Family` | - | `ERT` | - | - | - | - | - | - | - |
| `Repo Best RMSE` | - | 0.0357 | - | - | - | - | - | - | - |
| `Paper Best Family` | - | `HGBM` | - | - | - | - | - | - | - |
| `Paper Target RMSE` | - | 0.0290 | - | - | - | - | - | - | - |
| `Gap Vs Paper` | - | 0.006681 | - | - | - | - | - | - | - |
| `Status` | - | `above_paper_target` | - | - | - | - | - | - | - |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/ert/2026-04-19-05-01-43__track1_ert_phase_3_closure_attempt_05_campaign_run/onnx_export`;
