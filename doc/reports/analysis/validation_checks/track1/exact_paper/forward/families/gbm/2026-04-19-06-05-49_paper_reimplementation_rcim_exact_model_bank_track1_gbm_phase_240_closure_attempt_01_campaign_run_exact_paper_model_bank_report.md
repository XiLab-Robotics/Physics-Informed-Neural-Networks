...
- run name: `track1_gbm_phase_240_closure_attempt_01`;
- output run name: `track1_gbm_phase_240_closure_attempt_01_campaign_run`;
- run instance id: `2026-04-19-06-05-36__track1_gbm_phase_240_closure_attempt_01_campaign_run`;
...
- winning best params: `{'estimator__criterion': 'squared_error', 'estimator__learning_rate': 0.1, 'estimator__max_depth': 18, 'estimator__min_samples_split': 10, 'estimator__n_estimators': 36}`;
- winning mean component MAPE: `21.313%`;
- winning mean component MAE: `0.290584`;
- winning mean component RMSE: `0.928148`;
...
| --- | --- | ---: | ---: | --- |
| `GBM` | `paper_reference_grid_search` | 5 | 0.639093 | `{'estimator__criterion': 'squared_error', 'estimator__learning_rate': 0.1, 'estimator__max_depth': 18, 'estimator__min_samples_split': 10, 'estimator__n_estimators': 36}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `GBM` | `GradientBoostingRegressor` | `paper_reference_grid_search` | 21.313 | 0.290584 | 0.928148 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_240` | `GBM` | `GradientBoostingRegressor` | 21.313 | 0.290584 | 0.928148 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_240` | `ERT` | `GBM` | 21.313 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/gbm/2026-04-19-06-05-36__track1_gbm_phase_240_closure_attempt_01_campaign_run/onnx_export`;
