...
- run name: `track1_mlp_amplitude_full_matrix`;
- output run name: `track1_mlp_amplitude_full_matrix_campaign_run`;
- run instance id: `2026-04-18-01-19-43__track1_mlp_amplitude_full_matrix_campaign_run`;
...
- winning best params: `{'estimator__activation': 'tanh', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (200, 50), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}`;
- winning mean component MAPE: `2493.898%`;
- winning mean component MAE: `0.008349`;
- winning mean component RMSE: `0.013902`;
...
| --- | --- | ---: | ---: | --- |
| `MLP` | `paper_reference_grid_search` | 5 | -35830.927757 | `{'estimator__activation': 'tanh', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (200, 50), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `MLP` | `MLPRegressor` | `paper_reference_grid_search` | 2493.898 | 0.008349 | 0.013902 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_0` | `MLP` | `MLPRegressor` | 29.764 | 0.010615 | 0.014081 |
| `fft_y_Fw_filtered_ampl_1` | `MLP` | `MLPRegressor` | 51.770 | 0.008904 | 0.015569 |
| `fft_y_Fw_filtered_ampl_3` | `MLP` | `MLPRegressor` | 1334.302 | 0.009453 | 0.015451 |
| `fft_y_Fw_filtered_ampl_39` | `MLP` | `MLPRegressor` | 809.159 | 0.007449 | 0.012642 |
| `fft_y_Fw_filtered_ampl_40` | `MLP` | `MLPRegressor` | 829.194 | 0.006993 | 0.012067 |
| `fft_y_Fw_filtered_ampl_78` | `MLP` | `MLPRegressor` | 2075.322 | 0.007089 | 0.012007 |
| `fft_y_Fw_filtered_ampl_81` | `MLP` | `MLPRegressor` | 3067.441 | 0.008790 | 0.015045 |
| `fft_y_Fw_filtered_ampl_156` | `MLP` | `MLPRegressor` | 7691.382 | 0.007806 | 0.012676 |
| `fft_y_Fw_filtered_ampl_162` | `MLP` | `MLPRegressor` | 5132.886 | 0.007446 | 0.012974 |
| `fft_y_Fw_filtered_ampl_240` | `MLP` | `MLPRegressor` | 3917.757 | 0.008946 | 0.016513 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_0` | `SVR` | `MLP` | 29.764 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_1` | `RF / LGBM` | `MLP` | 51.770 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_3` | `HGBM` | `MLP` | 1334.302 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_39` | `HGBM` | `MLP` | 809.159 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_40` | `ERT / GBM` | `MLP` | 829.194 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_78` | `HGBM / RF` | `MLP` | 2075.322 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_81` | `RF` | `MLP` | 3067.441 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_156` | `ERT / RF` | `MLP` | 7691.382 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_162` | `ERT` | `MLP` | 5132.886 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_240` | `ERT` | `MLP` | 3917.757 | `not_matched_expected_family_direction` |
...
| ---: | --- | --- | --- | ---: | --- |
| `0` | `SVR` | `MLP` | `-` | 0/1 | `no_family_direction_match` |
| `1` | `RF / LGBM` | `MLP` | `-` | 0/1 | `no_family_direction_match` |
| `3` | `HGBM` | `MLP` | `-` | 0/1 | `no_family_direction_match` |
| `39` | `HGBM` | `MLP` | `-` | 0/1 | `no_family_direction_match` |
| `40` | `ERT / GBM` | `MLP` | `-` | 0/1 | `no_family_direction_match` |
| `78` | `HGBM / RF` | `MLP` | `-` | 0/1 | `no_family_direction_match` |
| `81` | `RF` | `MLP` | `-` | 0/1 | `no_family_direction_match` |
| `156` | `ERT / RF` | `MLP` | `-` | 0/1 | `no_family_direction_match` |
| `162` | `ERT` | `MLP` | `-` | 0/1 | `no_family_direction_match` |
| `240` | `ERT` | `MLP` | `-` | 0/1 | `no_family_direction_match` |
...
| `Repo Best Family` | `MLP` | `MLP` | `MLP` | `MLP` | `MLP` | `MLP` | `MLP` | `MLP` | `MLP` | `MLP` |
| `Repo Best RMSE` | 0.0141 | 0.0156 | 0.0155 | 0.0126 | 0.0121 | 0.0120 | 0.0150 | 0.0127 | 0.0130 | 0.0165 |
...
| `Gap Vs Paper` | 0.0108 | 0.0155 | 0.0154 | 0.0126 | 0.0120 | 0.0120 | 0.0150 | 0.0125 | 0.0128 | 0.0165 |
| `Status` | `above_paper_target` | `above_paper_target` | `above_paper_target` | `above_paper_target` | `above_paper_target` | `above_paper_target` | `above_paper_target` | `above_paper_target` | `above_paper_target` | `above_paper_target` |
...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `0` | `SVM` | `MLP` | `above_paper_target` | `-` | `-` | `-` | `-` | `-` | `not_yet_matched_tables_3_6` |
| `1` | `RF` | `MLP` | `above_paper_target` | `-` | `-` | `-` | `-` | `-` | `not_yet_matched_tables_3_6` |
| `3` | `HGBM` | `MLP` | `above_paper_target` | `-` | `-` | `-` | `-` | `-` | `not_yet_matched_tables_3_6` |
| `39` | `HGBM` | `MLP` | `above_paper_target` | `-` | `-` | `-` | `-` | `-` | `not_yet_matched_tables_3_6` |
| `40` | `ERT` | `MLP` | `above_paper_target` | `-` | `-` | `-` | `-` | `-` | `not_yet_matched_tables_3_6` |
| `78` | `HGBM` | `MLP` | `above_paper_target` | `-` | `-` | `-` | `-` | `-` | `not_yet_matched_tables_3_6` |
| `81` | `RF` | `MLP` | `above_paper_target` | `-` | `-` | `-` | `-` | `-` | `not_yet_matched_tables_3_6` |
| `156` | `ERT` | `MLP` | `above_paper_target` | `-` | `-` | `-` | `-` | `-` | `not_yet_matched_tables_3_6` |
| `162` | `ERT` | `MLP` | `above_paper_target` | `-` | `-` | `-` | `-` | `-` | `not_yet_matched_tables_3_6` |
| `240` | `ERT` | `MLP` | `above_paper_target` | `-` | `-` | `-` | `-` | `-` | `not_yet_matched_tables_3_6` |

## ONNX Export Surface

- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/full_matrix/mlp/2026-04-18-01-19-43__track1_mlp_amplitude_full_matrix_campaign_run/onnx_export`;
