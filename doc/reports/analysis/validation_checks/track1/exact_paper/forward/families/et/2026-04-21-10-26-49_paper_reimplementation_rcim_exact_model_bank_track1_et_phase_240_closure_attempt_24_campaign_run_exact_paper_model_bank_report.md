...
- run name: `track1_et_phase_240_closure_attempt_24`;
- output run name: `track1_et_phase_240_closure_attempt_24_campaign_run`;
- run instance id: `2026-04-21-10-26-42__track1_et_phase_240_closure_attempt_24_campaign_run`;
...
- winning mean component MAPE: `9.633%`;
- winning mean component MAE: `0.182172`;
- winning mean component RMSE: `0.614524`;
...
| --- | --- | ---: | ---: | --- |
| `ET` | `paper_reference_grid_search` | 5 | 0.476601 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 15, 'estimator__min_samples_split': 2}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ET` | `ExtraTreeRegressor` | `paper_reference_grid_search` | 9.633 | 0.182172 | 0.614524 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_240` | `ET` | `ExtraTreeRegressor` | 9.633 | 0.182172 | 0.614524 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_240` | `ERT` | `ET` | 9.633 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/et/2026-04-21-10-26-42__track1_et_phase_240_closure_attempt_24_campaign_run/onnx_export`;
