...
- run name: `track1_mlp_amplitude_39_closure_attempt_23`;
- output run name: `track1_mlp_amplitude_39_closure_attempt_23_campaign_run`;
- run instance id: `2026-04-21-20-25-42__track1_mlp_amplitude_39_closure_attempt_23_campaign_run`;
...
- winning mean component MAPE: `1083.832%`;
- winning mean component MAE: `0.010660`;
- winning mean component RMSE: `0.018940`;
...
| --- | --- | ---: | ---: | --- |
| `MLP` | `paper_reference_grid_search` | 5 | -7398.877152 | `{'estimator__activation': 'tanh', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (200, 50), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `MLP` | `MLPRegressor` | `paper_reference_grid_search` | 1083.832 | 0.010660 | 0.018940 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_39` | `MLP` | `MLPRegressor` | 1083.832 | 0.010660 | 0.018940 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_39` | `HGBM` | `MLP` | 1083.832 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/mlp/2026-04-21-20-25-42__track1_mlp_amplitude_39_closure_attempt_23_campaign_run/onnx_export`;
