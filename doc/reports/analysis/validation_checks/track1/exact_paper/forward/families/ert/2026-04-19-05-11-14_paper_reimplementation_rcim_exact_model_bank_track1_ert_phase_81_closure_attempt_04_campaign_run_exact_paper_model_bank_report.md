...
- run name: `track1_ert_phase_81_closure_attempt_04`;
- output run name: `track1_ert_phase_81_closure_attempt_04_campaign_run`;
- run instance id: `2026-04-19-05-10-57__track1_ert_phase_81_closure_attempt_04_campaign_run`;
...
- winning mean component MAPE: `3.883%`;
- winning mean component MAE: `0.048739`;
- winning mean component RMSE: `0.078072`;
...
| --- | --- | ---: | ---: | --- |
| `ERT` | `paper_reference_grid_search` | 5 | 0.963893 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 2, 'estimator__n_estimators': 100}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ERT` | `ExtraTreesRegressor` | `paper_reference_grid_search` | 3.883 | 0.048739 | 0.078072 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_81` | `ERT` | `ExtraTreesRegressor` | 3.883 | 0.048739 | 0.078072 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_81` | `RF` | `ERT` | 3.883 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/ert/2026-04-19-05-10-57__track1_ert_phase_81_closure_attempt_04_campaign_run/onnx_export`;
