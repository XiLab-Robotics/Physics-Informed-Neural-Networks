...
- run name: `track1_hgbm_amplitude_156_closure_attempt_05`;
- output run name: `track1_hgbm_amplitude_156_closure_attempt_05_campaign_run`;
- run instance id: `2026-04-19-06-33-51__track1_hgbm_amplitude_156_closure_attempt_05_campaign_run`;
...
- winning best params: `{'estimator__learning_rate': 0.22, 'estimator__max_depth': 10, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 26}`;
- winning mean component MAPE: `19.865%`;
- winning mean component MAE: `0.000081`;
- winning mean component RMSE: `0.000213`;
...
| --- | --- | ---: | ---: | --- |
| `HGBM` | `paper_reference_grid_search` | 5 | 0.938297 | `{'estimator__learning_rate': 0.22, 'estimator__max_depth': 10, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 26}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `HGBM` | `HistGradientBoostingRegressor` | `paper_reference_grid_search` | 19.865 | 0.000081 | 0.000213 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_156` | `HGBM` | `HistGradientBoostingRegressor` | 19.865 | 0.000081 | 0.000213 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_156` | `ERT / RF` | `HGBM` | 19.865 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/hgbm/2026-04-19-06-33-51__track1_hgbm_amplitude_156_closure_attempt_05_campaign_run/onnx_export`;
