...
- run name: `track1_rf_phase_156_closure_attempt_02`;
- output run name: `track1_rf_phase_156_closure_attempt_02_campaign_run`;
- run instance id: `2026-04-19-02-57-22__track1_rf_phase_156_closure_attempt_02_campaign_run`;
...
- winning mean component MAPE: `27.480%`;
- winning mean component MAE: `0.521918`;
- winning mean component RMSE: `1.117685`;
...
| --- | --- | ---: | ---: | --- |
| `RF` | `paper_reference_grid_search` | 5 | 0.767636 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 16, 'estimator__min_samples_split': 2, 'estimator__n_estimators': 80}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `RF` | `RandomForestRegressor` | `paper_reference_grid_search` | 27.480 | 0.521918 | 1.117685 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_156` | `RF` | `RandomForestRegressor` | 27.480 | 0.521918 | 1.117685 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_156` | `ERT / RF` | `RF` | 27.480 | `matched_expected_family_direction` |
...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `156` | `-` | `-` | `-` | `RF` | `RF` | `RF` | `above_paper_target` | `met_paper_target` | `partially_matched_tables_3_6` |

## ONNX Export Surface

- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/rf/2026-04-19-02-57-22__track1_rf_phase_156_closure_attempt_02_campaign_run/onnx_export`;
