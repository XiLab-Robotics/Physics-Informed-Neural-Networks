...
- run name: `track1_lgbm_phase_162_closure_attempt_14`;
- output run name: `track1_lgbm_phase_162_closure_attempt_14_campaign_run`;
- run instance id: `2026-04-21-13-02-50__track1_lgbm_phase_162_closure_attempt_14_campaign_run`;
...
- winning mean component MAPE: `22.994%`;
- winning mean component MAE: `0.528682`;
- winning mean component RMSE: `1.107084`;
...
| --- | --- | ---: | ---: | --- |
| `LGBM` | `paper_reference_grid_search` | 5 | 0.706712 | `{'estimator__learning_rate': 0.2, 'estimator__max_depth': 14, 'estimator__num_leaves': 31, 'estimator__subsample': 0.001}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `LGBM` | `LGBMRegressor` | `paper_reference_grid_search` | 22.994 | 0.528682 | 1.107084 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_162` | `LGBM` | `LGBMRegressor` | 22.994 | 0.528682 | 1.107084 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_162` | `ERT` | `LGBM` | 22.994 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/lgbm/2026-04-21-13-02-50__track1_lgbm_phase_162_closure_attempt_14_campaign_run/onnx_export`;
