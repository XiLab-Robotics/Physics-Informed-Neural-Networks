...
- run name: `track1_et_amplitude_3_closure_attempt_03`;
- output run name: `track1_et_amplitude_3_closure_attempt_03_campaign_run`;
- run instance id: `2026-04-19-03-58-10__track1_et_amplitude_3_closure_attempt_03_campaign_run`;
...
- winning mean component MAPE: `3.182%`;
...
| --- | --- | ---: | ---: | --- |
| `ET` | `paper_reference_grid_search` | 5 | 0.958227 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 17, 'estimator__min_samples_split': 5}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ET` | `ExtraTreeRegressor` | `paper_reference_grid_search` | 3.182 | 0.000026 | 0.000045 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_3` | `ET` | `ExtraTreeRegressor` | 3.182 | 0.000026 | 0.000045 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_3` | `HGBM` | `ET` | 3.182 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/et/2026-04-19-03-58-10__track1_et_amplitude_3_closure_attempt_03_campaign_run/onnx_export`;
