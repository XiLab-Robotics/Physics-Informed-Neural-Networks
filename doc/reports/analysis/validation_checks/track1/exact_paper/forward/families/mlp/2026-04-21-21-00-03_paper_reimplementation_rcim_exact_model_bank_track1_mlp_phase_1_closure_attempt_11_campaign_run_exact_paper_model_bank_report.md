...
- run name: `track1_mlp_phase_1_closure_attempt_11`;
- output run name: `track1_mlp_phase_1_closure_attempt_11_campaign_run`;
- run instance id: `2026-04-21-20-59-52__track1_mlp_phase_1_closure_attempt_11_campaign_run`;
...
- winning mean component MAPE: `90.262%`;
- winning mean component MAE: `0.005825`;
- winning mean component RMSE: `0.009163`;
...
| --- | --- | ---: | ---: | --- |
| `MLP` | `paper_reference_grid_search` | 5 | -29.363800 | `{'estimator__activation': 'tanh', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (200, 50), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `MLP` | `MLPRegressor` | `paper_reference_grid_search` | 90.262 | 0.005825 | 0.009163 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_1` | `MLP` | `MLPRegressor` | 90.262 | 0.005825 | 0.009163 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_1` | `RF / LGBM` | `MLP` | 90.262 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/mlp/2026-04-21-20-59-52__track1_mlp_phase_1_closure_attempt_11_campaign_run/onnx_export`;
