...
- run name: `track1_mlp_phase_162_final_closure_attempt_31`;
- output run name: `track1_mlp_phase_162_final_closure_attempt_31_campaign_run`;
- run instance id: `2026-04-22-00-33-19__track1_mlp_phase_162_final_closure_attempt_31_campaign_run`;
...
- winning mean component MAPE: `60.498%`;
- winning mean component MAE: `1.254332`;
- winning mean component RMSE: `1.896974`;
...
| --- | --- | ---: | ---: | --- |
| `MLP` | `paper_reference_grid_search` | 5 | 0.271179 | `{'estimator__activation': 'tanh', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (200, 50), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `MLP` | `MLPRegressor` | `paper_reference_grid_search` | 60.498 | 1.254332 | 1.896974 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_162` | `MLP` | `MLPRegressor` | 60.498 | 1.254332 | 1.896974 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_162` | `ERT` | `MLP` | 60.498 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/mlp/2026-04-22-00-33-19__track1_mlp_phase_162_final_closure_attempt_31_campaign_run/onnx_export`;
