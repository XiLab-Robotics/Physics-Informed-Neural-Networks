...
- run name: `track1_xgbm_amplitude_40_closure_attempt_03`;
- output run name: `track1_xgbm_amplitude_40_closure_attempt_03_campaign_run`;
- run instance id: `2026-04-19-07-13-41__track1_xgbm_amplitude_40_closure_attempt_03_campaign_run`;
...
- winning best params: `{'estimator__colsample_bytree': 0.3, 'estimator__learning_rate': 0.01, 'estimator__max_depth': 14}`;
- winning mean component MAPE: `9.238%`;
...
| --- | --- | ---: | ---: | --- |
| `XGBM` | `paper_reference_grid_search` | 5 | -0.015740 | `{'estimator__colsample_bytree': 0.3, 'estimator__learning_rate': 0.01, 'estimator__max_depth': 14}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `XGBM` | `XGBRegressor` | `paper_reference_grid_search` | 9.238 | 0.000070 | 0.000091 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_40` | `XGBM` | `XGBRegressor` | 9.238 | 0.000070 | 0.000091 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_40` | `ERT / GBM` | `XGBM` | 9.238 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/xgbm/2026-04-19-07-13-41__track1_xgbm_amplitude_40_closure_attempt_03_campaign_run/onnx_export`;
