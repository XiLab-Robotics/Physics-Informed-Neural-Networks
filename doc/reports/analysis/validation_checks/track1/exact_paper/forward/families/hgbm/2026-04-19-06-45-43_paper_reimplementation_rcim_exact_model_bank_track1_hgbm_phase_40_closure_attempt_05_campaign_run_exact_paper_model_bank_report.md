...
- run name: `track1_hgbm_phase_40_closure_attempt_05`;
- output run name: `track1_hgbm_phase_40_closure_attempt_05_campaign_run`;
- run instance id: `2026-04-19-06-45-30__track1_hgbm_phase_40_closure_attempt_05_campaign_run`;
...
- winning best params: `{'estimator__learning_rate': 0.22, 'estimator__max_depth': 12, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 27}`;
- winning mean component MAPE: `32.646%`;
- winning mean component MAE: `0.034526`;
- winning mean component RMSE: `0.050689`;
...
| --- | --- | ---: | ---: | --- |
| `HGBM` | `paper_reference_grid_search` | 5 | 0.771499 | `{'estimator__learning_rate': 0.22, 'estimator__max_depth': 12, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 27}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `HGBM` | `HistGradientBoostingRegressor` | `paper_reference_grid_search` | 32.646 | 0.034526 | 0.050689 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_40` | `HGBM` | `HistGradientBoostingRegressor` | 32.646 | 0.034526 | 0.050689 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_40` | `ERT / GBM` | `HGBM` | 32.646 | `not_matched_expected_family_direction` |
...
| `Repo Best Family` | - | - | - | `HGBM` | - | - | - | - | - |
| `Repo Best RMSE` | - | - | - | 0.0507 | - | - | - | - | - |
| `Paper Best Family` | - | - | - | `GBM` | - | - | - | - | - |
| `Paper Target RMSE` | - | - | - | 0.0550 | - | - | - | - | - |
| `Gap Vs Paper` | - | - | - | -0.004311 | - | - | - | - | - |
| `Status` | - | - | - | `met_paper_target` | - | - | - | - | - |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/hgbm/2026-04-19-06-45-30__track1_hgbm_phase_40_closure_attempt_05_campaign_run/onnx_export`;
