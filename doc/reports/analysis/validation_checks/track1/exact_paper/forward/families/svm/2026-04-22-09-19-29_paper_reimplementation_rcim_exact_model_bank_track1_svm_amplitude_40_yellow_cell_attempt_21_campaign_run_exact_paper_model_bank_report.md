...
- run name: `track1_svm_amplitude_40_yellow_cell_attempt_21`;
- output run name: `track1_svm_amplitude_40_yellow_cell_attempt_21_campaign_run`;
- run instance id: `2026-04-22-09-19-21__track1_svm_amplitude_40_yellow_cell_attempt_21_campaign_run`;
...
- winning mean component MAPE: `10.245%`;
...
| --- | --- | ---: | ---: | --- |
| `SVR` | `paper_reference_grid_search` | 5 | -0.216454 | `{'estimator__C': 0.001, 'estimator__epsilon': 0.0001, 'estimator__gamma': 1.1e-06, 'estimator__kernel': 'rbf'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `SVR` | `SVR` | `paper_reference_grid_search` | 10.245 | 0.000083 | 0.000098 |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/svm_targeted_closure/svm/2026-04-22-09-19-21__track1_svm_amplitude_40_yellow_cell_attempt_21_campaign_run/onnx_export`;
