...
- run name: `track1_gbm_amplitude_162_closure_attempt_04`;
- output run name: `track1_gbm_amplitude_162_closure_attempt_04_campaign_run`;
- run instance id: `2026-04-19-05-47-15__track1_gbm_amplitude_162_closure_attempt_04_campaign_run`;
...
- winning mean component MAPE: `8.747%`;
- winning mean component MAE: `0.000055`;
- winning mean component RMSE: `0.000239`;
...
| --- | --- | ---: | ---: | --- |
| `GBM` | `paper_reference_grid_search` | 5 | 0.991417 | `{'estimator__criterion': 'squared_error', 'estimator__learning_rate': 0.1, 'estimator__max_depth': 14, 'estimator__min_samples_split': 14, 'estimator__n_estimators': 52}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `GBM` | `GradientBoostingRegressor` | `paper_reference_grid_search` | 8.747 | 0.000055 | 0.000239 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_162` | `GBM` | `GradientBoostingRegressor` | 8.747 | 0.000055 | 0.000239 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_162` | `ERT` | `GBM` | 8.747 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/gbm/2026-04-19-05-47-15__track1_gbm_amplitude_162_closure_attempt_04_campaign_run/onnx_export`;
