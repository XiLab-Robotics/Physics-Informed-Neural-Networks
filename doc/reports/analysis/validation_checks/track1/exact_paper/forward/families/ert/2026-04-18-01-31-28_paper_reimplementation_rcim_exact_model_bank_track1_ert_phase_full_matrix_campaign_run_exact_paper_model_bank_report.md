...
- run name: `track1_ert_phase_full_matrix`;
- output run name: `track1_ert_phase_full_matrix_campaign_run`;
- run instance id: `2026-04-18-01-30-08__track1_ert_phase_full_matrix_campaign_run`;
...
- winning best params: `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 15, 'estimator__min_samples_split': 4, 'estimator__n_estimators': 40}`;
- winning mean component MAPE: `34.882%`;
- winning mean component MAE: `0.129009`;
- winning mean component RMSE: `0.319152`;
...
| --- | --- | ---: | ---: | --- |
| `ERT` | `paper_reference_grid_search` | 5 | 0.796346 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 15, 'estimator__min_samples_split': 4, 'estimator__n_estimators': 40}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ERT` | `ExtraTreesRegressor` | `paper_reference_grid_search` | 34.882 | 0.129009 | 0.319152 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_1` | `ERT` | `ExtraTreesRegressor` | 31.100 | 0.002360 | 0.003613 |
| `fft_y_Fw_filtered_phase_3` | `ERT` | `ExtraTreesRegressor` | 1.602 | 0.028567 | 0.040508 |
| `fft_y_Fw_filtered_phase_39` | `ERT` | `ExtraTreesRegressor` | 2.192 | 0.028394 | 0.054928 |
| `fft_y_Fw_filtered_phase_40` | `ERT` | `ExtraTreesRegressor` | 57.652 | 0.035771 | 0.056876 |
| `fft_y_Fw_filtered_phase_78` | `ERT` | `ExtraTreesRegressor` | 114.099 | 0.061871 | 0.152952 |
| `fft_y_Fw_filtered_phase_81` | `ERT` | `ExtraTreesRegressor` | 4.882 | 0.052236 | 0.080560 |
| `fft_y_Fw_filtered_phase_156` | `ERT` | `ExtraTreesRegressor` | 68.732 | 0.413796 | 0.914614 |
| `fft_y_Fw_filtered_phase_162` | `ERT` | `ExtraTreesRegressor` | 11.684 | 0.244129 | 0.746667 |
| `fft_y_Fw_filtered_phase_240` | `ERT` | `ExtraTreesRegressor` | 21.994 | 0.293955 | 0.821654 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_1` | `RF / LGBM` | `ERT` | 31.100 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_3` | `HGBM` | `ERT` | 1.602 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_39` | `HGBM` | `ERT` | 2.192 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_40` | `ERT / GBM` | `ERT` | 57.652 | `matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_78` | `HGBM / RF` | `ERT` | 114.099 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_81` | `RF` | `ERT` | 4.882 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_156` | `ERT / RF` | `ERT` | 68.732 | `matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_162` | `ERT` | `ERT` | 11.684 | `matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_240` | `ERT` | `ERT` | 21.994 | `matched_expected_family_direction` |
...
| `Repo Best Family` | `ERT` | `ERT` | `ERT` | `ERT` | `ERT` | `ERT` | `ERT` | `ERT` | `ERT` |
| `Repo Best MAE` | 0.002360 | 0.0286 | 0.0284 | 0.0358 | 0.0619 | 0.0522 | 0.4138 | 0.2441 | 0.2940 |
...
| `Gap Vs Paper` | 5.60e-04 | 0.008567 | 0.007394 | -2.29e-04 | -0.0121 | -7.64e-04 | -0.0962 | 0.0441 | 0.0640 |
...
| `Repo Best Family` | `ERT` | `ERT` | `ERT` | `ERT` | `ERT` | `ERT` | `ERT` | `ERT` | `ERT` |
| `Repo Best RMSE` | 0.003613 | 0.0405 | 0.0549 | 0.0569 | 0.1530 | 0.0806 | 0.9146 | 0.7467 | 0.8217 |
...
| `Gap Vs Paper` | 0.001113 | 0.0115 | 0.0279 | 0.001876 | -0.007048 | -0.001440 | -0.2854 | 0.1067 | 0.2417 |
...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `1` | `-` | `-` | `-` | `LGBM` | `ERT` | `ERT` | `above_paper_target` | `above_paper_target` | `not_yet_matched_tables_3_6` |
| `3` | `-` | `-` | `-` | `HGBM` | `ERT` | `ERT` | `above_paper_target` | `above_paper_target` | `not_yet_matched_tables_3_6` |
| `39` | `-` | `-` | `-` | `HGBM` | `ERT` | `ERT` | `above_paper_target` | `above_paper_target` | `not_yet_matched_tables_3_6` |
| `40` | `-` | `-` | `-` | `GBM` | `ERT` | `ERT` | `met_paper_target` | `above_paper_target` | `partially_matched_tables_3_6` |
| `78` | `-` | `-` | `-` | `RF` | `ERT` | `ERT` | `met_paper_target` | `met_paper_target` | `partially_matched_tables_3_6` |
| `81` | `-` | `-` | `-` | `RF` | `ERT` | `ERT` | `met_paper_target` | `met_paper_target` | `partially_matched_tables_3_6` |
| `156` | `-` | `-` | `-` | `RF` | `ERT` | `ERT` | `met_paper_target` | `met_paper_target` | `partially_matched_tables_3_6` |
| `162` | `-` | `-` | `-` | `ERT` | `ERT` | `ERT` | `above_paper_target` | `above_paper_target` | `partially_matched_tables_3_6` |
| `240` | `-` | `-` | `-` | `ERT` | `ERT` | `ERT` | `above_paper_target` | `above_paper_target` | `partially_matched_tables_3_6` |

## ONNX Export Surface

- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/full_matrix/ert/2026-04-18-01-30-08__track1_ert_phase_full_matrix_campaign_run/onnx_export`;
