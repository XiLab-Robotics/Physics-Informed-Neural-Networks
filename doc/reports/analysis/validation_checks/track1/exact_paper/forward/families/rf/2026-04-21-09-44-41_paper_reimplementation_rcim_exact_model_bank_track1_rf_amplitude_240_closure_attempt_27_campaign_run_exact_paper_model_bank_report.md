...
- run name: `track1_rf_amplitude_240_closure_attempt_27`;
- output run name: `track1_rf_amplitude_240_closure_attempt_27_campaign_run`;
- run instance id: `2026-04-21-09-44-24__track1_rf_amplitude_240_closure_attempt_27_campaign_run`;
...
- winning mean component MAPE: `9.846%`;
...
| --- | --- | ---: | ---: | --- |
| `RF` | `paper_reference_grid_search` | 5 | 0.985927 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 15, 'estimator__min_samples_split': 2, 'estimator__n_estimators': 70}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `RF` | `RandomForestRegressor` | `paper_reference_grid_search` | 9.846 | 0.000034 | 0.000068 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_240` | `RF` | `RandomForestRegressor` | 9.846 | 0.000034 | 0.000068 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_240` | `ERT` | `RF` | 9.846 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/rf/2026-04-21-09-44-24__track1_rf_amplitude_240_closure_attempt_27_campaign_run/onnx_export`;
