...
- run name: `track1_ert_phase_156_closure_attempt_01`;
- output run name: `track1_ert_phase_156_closure_attempt_01_campaign_run`;
- run instance id: `2026-04-19-05-12-09__track1_ert_phase_156_closure_attempt_01_campaign_run`;
...
- winning mean component MAPE: `95.338%`;
- winning mean component MAE: `0.377856`;
- winning mean component RMSE: `0.887840`;
...
| --- | --- | ---: | ---: | --- |
| `ERT` | `paper_reference_grid_search` | 5 | 0.742077 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 2, 'estimator__n_estimators': 60}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ERT` | `ExtraTreesRegressor` | `paper_reference_grid_search` | 95.338 | 0.377856 | 0.887840 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_156` | `ERT` | `ExtraTreesRegressor` | 95.338 | 0.377856 | 0.887840 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_156` | `ERT / RF` | `ERT` | 95.338 | `matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/ert/2026-04-19-05-12-09__track1_ert_phase_156_closure_attempt_01_campaign_run/onnx_export`;
