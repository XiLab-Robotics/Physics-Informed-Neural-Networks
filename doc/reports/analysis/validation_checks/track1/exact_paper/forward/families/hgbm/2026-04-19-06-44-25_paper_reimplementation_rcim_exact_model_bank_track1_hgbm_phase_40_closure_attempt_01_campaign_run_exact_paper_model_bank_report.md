...
- run name: `track1_hgbm_phase_40_closure_attempt_01`;
- output run name: `track1_hgbm_phase_40_closure_attempt_01_campaign_run`;
- run instance id: `2026-04-19-06-44-12__track1_hgbm_phase_40_closure_attempt_01_campaign_run`;
...
- winning best params: `{'estimator__learning_rate': 0.22, 'estimator__max_depth': 11, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 25}`;
- winning mean component MAPE: `53.514%`;
- winning mean component MAE: `0.039049`;
- winning mean component RMSE: `0.059985`;
...
| --- | --- | ---: | ---: | --- |
| `HGBM` | `paper_reference_grid_search` | 5 | 0.764732 | `{'estimator__learning_rate': 0.22, 'estimator__max_depth': 11, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 25}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `HGBM` | `HistGradientBoostingRegressor` | `paper_reference_grid_search` | 53.514 | 0.039049 | 0.059985 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_40` | `HGBM` | `HistGradientBoostingRegressor` | 53.514 | 0.039049 | 0.059985 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_40` | `ERT / GBM` | `HGBM` | 53.514 | `not_matched_expected_family_direction` |
...
| `Repo Best Family` | - | - | - | `HGBM` | - | - | - | - | - |
| `Repo Best RMSE` | - | - | - | 0.0600 | - | - | - | - | - |
| `Paper Best Family` | - | - | - | `GBM` | - | - | - | - | - |
| `Paper Target RMSE` | - | - | - | 0.0550 | - | - | - | - | - |
| `Gap Vs Paper` | - | - | - | 0.004985 | - | - | - | - | - |
| `Status` | - | - | - | `above_paper_target` | - | - | - | - | - |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/hgbm/2026-04-19-06-44-12__track1_hgbm_phase_40_closure_attempt_01_campaign_run/onnx_export`;
