...
- run name: `track1_ert_phase_162_closure_attempt_26`;
- output run name: `track1_ert_phase_162_closure_attempt_26_campaign_run`;
- run instance id: `2026-04-21-11-14-14__track1_ert_phase_162_closure_attempt_26_campaign_run`;
...
- winning mean component MAPE: `14.330%`;
- winning mean component MAE: `0.348103`;
- winning mean component RMSE: `1.033081`;
...
| --- | --- | ---: | ---: | --- |
| `ERT` | `paper_reference_grid_search` | 5 | 0.709548 | `{'estimator__criterion': 'absolute_error', 'estimator__max_depth': 18, 'estimator__min_samples_split': 2, 'estimator__n_estimators': 20}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ERT` | `ExtraTreesRegressor` | `paper_reference_grid_search` | 14.330 | 0.348103 | 1.033081 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_162` | `ERT` | `ExtraTreesRegressor` | 14.330 | 0.348103 | 1.033081 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_162` | `ERT` | `ERT` | 14.330 | `matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/ert/2026-04-21-11-14-14__track1_ert_phase_162_closure_attempt_26_campaign_run/onnx_export`;
