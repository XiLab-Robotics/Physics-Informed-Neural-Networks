...
- run name: `track1_xgbm_amplitude_240_closure_attempt_03`;
- output run name: `track1_xgbm_amplitude_240_closure_attempt_03_campaign_run`;
- run instance id: `2026-04-19-07-21-01__track1_xgbm_amplitude_240_closure_attempt_03_campaign_run`;
...
- winning mean component MAPE: `77.480%`;
...
| --- | --- | ---: | ---: | --- |
| `XGBM` | `paper_reference_grid_search` | 5 | 0.755890 | `{'estimator__colsample_bytree': 0.8, 'estimator__learning_rate': 0.2, 'estimator__max_depth': 14}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `XGBM` | `XGBRegressor` | `paper_reference_grid_search` | 77.480 | 0.000151 | 0.000238 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_240` | `XGBM` | `XGBRegressor` | 77.480 | 0.000151 | 0.000238 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_240` | `ERT` | `XGBM` | 77.480 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/xgbm/2026-04-19-07-21-01__track1_xgbm_amplitude_240_closure_attempt_03_campaign_run/onnx_export`;
