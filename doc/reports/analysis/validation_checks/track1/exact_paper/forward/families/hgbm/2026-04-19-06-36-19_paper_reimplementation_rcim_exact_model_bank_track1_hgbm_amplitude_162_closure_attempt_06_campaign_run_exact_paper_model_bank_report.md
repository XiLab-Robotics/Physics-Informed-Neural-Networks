...
- run name: `track1_hgbm_amplitude_162_closure_attempt_06`;
- output run name: `track1_hgbm_amplitude_162_closure_attempt_06_campaign_run`;
- run instance id: `2026-04-19-06-36-07__track1_hgbm_amplitude_162_closure_attempt_06_campaign_run`;
...
- winning best params: `{'estimator__learning_rate': 0.18, 'estimator__max_depth': 12, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 24}`;
- winning mean component MAPE: `22.791%`;
- winning mean component MAE: `0.000145`;
- winning mean component RMSE: `0.000344`;
...
| --- | --- | ---: | ---: | --- |
| `HGBM` | `paper_reference_grid_search` | 5 | 0.919786 | `{'estimator__learning_rate': 0.18, 'estimator__max_depth': 12, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 24}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `HGBM` | `HistGradientBoostingRegressor` | `paper_reference_grid_search` | 22.791 | 0.000145 | 0.000344 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_162` | `HGBM` | `HistGradientBoostingRegressor` | 22.791 | 0.000145 | 0.000344 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_162` | `ERT` | `HGBM` | 22.791 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/hgbm/2026-04-19-06-36-07__track1_hgbm_amplitude_162_closure_attempt_06_campaign_run/onnx_export`;
