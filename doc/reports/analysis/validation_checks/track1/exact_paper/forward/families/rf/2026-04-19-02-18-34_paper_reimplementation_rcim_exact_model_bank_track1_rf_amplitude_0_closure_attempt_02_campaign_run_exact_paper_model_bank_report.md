...
- run name: `track1_rf_amplitude_0_closure_attempt_02`;
- output run name: `track1_rf_amplitude_0_closure_attempt_02_campaign_run`;
- run instance id: `2026-04-19-02-18-17__track1_rf_amplitude_0_closure_attempt_02_campaign_run`;
...
- winning best params: `{'estimator__criterion': 'absolute_error', 'estimator__max_depth': 12, 'estimator__min_samples_split': 4, 'estimator__n_estimators': 50}`;
- winning mean component MAPE: `6.228%`;
- winning mean component MAE: `0.003042`;
- winning mean component RMSE: `0.003593`;
...
| --- | --- | ---: | ---: | --- |
| `RF` | `paper_reference_grid_search` | 5 | 0.964098 | `{'estimator__criterion': 'absolute_error', 'estimator__max_depth': 12, 'estimator__min_samples_split': 4, 'estimator__n_estimators': 50}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `RF` | `RandomForestRegressor` | `paper_reference_grid_search` | 6.228 | 0.003042 | 0.003593 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_0` | `RF` | `RandomForestRegressor` | 6.228 | 0.003042 | 0.003593 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_0` | `SVR` | `RF` | 6.228 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/rf/2026-04-19-02-18-17__track1_rf_amplitude_0_closure_attempt_02_campaign_run/onnx_export`;
