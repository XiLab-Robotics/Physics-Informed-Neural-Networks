...
- run name: `track1_hgbm_phase_3_closure_attempt_13`;
- output run name: `track1_hgbm_phase_3_closure_attempt_13_campaign_run`;
- run instance id: `2026-04-21-11-51-24__track1_hgbm_phase_3_closure_attempt_13_campaign_run`;
...
- winning mean component MAPE: `1.066%`;
- winning mean component MAE: `0.019221`;
- winning mean component RMSE: `0.025213`;
...
| --- | --- | ---: | ---: | --- |
| `HGBM` | `paper_reference_grid_search` | 5 | 0.939256 | `{'estimator__learning_rate': 0.19, 'estimator__max_depth': 12, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 25}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `HGBM` | `HistGradientBoostingRegressor` | `paper_reference_grid_search` | 1.066 | 0.019221 | 0.025213 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_3` | `HGBM` | `HistGradientBoostingRegressor` | 1.066 | 0.019221 | 0.025213 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_3` | `HGBM` | `HGBM` | 1.066 | `matched_expected_family_direction` |
...
| `Repo Best Family` | - | `HGBM` | - | - | - | - | - | - | - |
| `Repo Best RMSE` | - | 0.0252 | - | - | - | - | - | - | - |
| `Paper Best Family` | - | `HGBM` | - | - | - | - | - | - | - |
| `Paper Target RMSE` | - | 0.0290 | - | - | - | - | - | - | - |
| `Gap Vs Paper` | - | -0.003787 | - | - | - | - | - | - | - |
| `Status` | - | `met_paper_target` | - | - | - | - | - | - | - |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/hgbm/2026-04-21-11-51-24__track1_hgbm_phase_3_closure_attempt_13_campaign_run/onnx_export`;
