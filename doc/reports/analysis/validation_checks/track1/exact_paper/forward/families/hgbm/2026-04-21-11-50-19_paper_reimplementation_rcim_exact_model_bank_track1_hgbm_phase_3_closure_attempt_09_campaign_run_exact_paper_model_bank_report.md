...
- run name: `track1_hgbm_phase_3_closure_attempt_09`;
- output run name: `track1_hgbm_phase_3_closure_attempt_09_campaign_run`;
- run instance id: `2026-04-21-11-50-07__track1_hgbm_phase_3_closure_attempt_09_campaign_run`;
...
- winning mean component MAPE: `1.259%`;
- winning mean component MAE: `0.022249`;
- winning mean component RMSE: `0.029609`;
...
| --- | --- | ---: | ---: | --- |
| `HGBM` | `paper_reference_grid_search` | 5 | 0.939635 | `{'estimator__learning_rate': 0.22, 'estimator__max_depth': 13, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 24}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `HGBM` | `HistGradientBoostingRegressor` | `paper_reference_grid_search` | 1.259 | 0.022249 | 0.029609 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_3` | `HGBM` | `HistGradientBoostingRegressor` | 1.259 | 0.022249 | 0.029609 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_3` | `HGBM` | `HGBM` | 1.259 | `matched_expected_family_direction` |
...
| `Repo Best Family` | - | `HGBM` | - | - | - | - | - | - | - |
| `Repo Best RMSE` | - | 0.0296 | - | - | - | - | - | - | - |
| `Paper Best Family` | - | `HGBM` | - | - | - | - | - | - | - |
| `Paper Target RMSE` | - | 0.0290 | - | - | - | - | - | - | - |
| `Gap Vs Paper` | - | 6.09e-04 | - | - | - | - | - | - | - |
| `Status` | - | `above_paper_target` | - | - | - | - | - | - | - |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/hgbm/2026-04-21-11-50-07__track1_hgbm_phase_3_closure_attempt_09_campaign_run/onnx_export`;
