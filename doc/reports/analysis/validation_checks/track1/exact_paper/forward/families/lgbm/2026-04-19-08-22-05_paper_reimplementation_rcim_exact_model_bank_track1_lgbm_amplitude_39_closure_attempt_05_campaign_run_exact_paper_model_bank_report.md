...
- run name: `track1_lgbm_amplitude_39_closure_attempt_05`;
- output run name: `track1_lgbm_amplitude_39_closure_attempt_05_campaign_run`;
- run instance id: `2026-04-19-08-20-40__track1_lgbm_amplitude_39_closure_attempt_05_campaign_run`;
...
- winning mean component MAPE: `2.022%`;
...
| --- | --- | ---: | ---: | --- |
| `LGBM` | `paper_reference_grid_search` | 5 | 0.986884 | `{'estimator__learning_rate': 0.39, 'estimator__max_depth': 14, 'estimator__num_leaves': 31, 'estimator__subsample': 0.001}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `LGBM` | `LGBMRegressor` | `paper_reference_grid_search` | 2.022 | 0.000022 | 0.000029 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_39` | `LGBM` | `LGBMRegressor` | 2.022 | 0.000022 | 0.000029 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_39` | `HGBM` | `LGBM` | 2.022 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/lgbm/2026-04-19-08-20-40__track1_lgbm_amplitude_39_closure_attempt_05_campaign_run/onnx_export`;
