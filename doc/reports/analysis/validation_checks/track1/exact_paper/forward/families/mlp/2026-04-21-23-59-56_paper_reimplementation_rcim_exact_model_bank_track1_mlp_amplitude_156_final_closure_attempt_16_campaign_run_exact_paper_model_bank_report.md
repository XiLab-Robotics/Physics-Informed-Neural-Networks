...
- run name: `track1_mlp_amplitude_156_final_closure_attempt_16`;
- output run name: `track1_mlp_amplitude_156_final_closure_attempt_16_campaign_run`;
- run instance id: `2026-04-21-23-59-46__track1_mlp_amplitude_156_final_closure_attempt_16_campaign_run`;
...
- winning mean component MAPE: `16756.051%`;
- winning mean component MAE: `0.012969`;
- winning mean component RMSE: `0.023361`;
...
| --- | --- | ---: | ---: | --- |
| `MLP` | `paper_reference_grid_search` | 5 | -410.477036 | `{'estimator__activation': 'tanh', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (200, 50), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `MLP` | `MLPRegressor` | `paper_reference_grid_search` | 16756.051 | 0.012969 | 0.023361 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_156` | `MLP` | `MLPRegressor` | 16756.051 | 0.012969 | 0.023361 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_156` | `ERT / RF` | `MLP` | 16756.051 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/mlp/2026-04-21-23-59-46__track1_mlp_amplitude_156_final_closure_attempt_16_campaign_run/onnx_export`;
