...
- run name: `track1_hgbm_phase_156_closure_attempt_04`;
- output run name: `track1_hgbm_phase_156_closure_attempt_04_campaign_run`;
- run instance id: `2026-04-19-06-50-59__track1_hgbm_phase_156_closure_attempt_04_campaign_run`;
...
- winning best params: `{'estimator__learning_rate': 0.21, 'estimator__max_depth': 11, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 24}`;
- winning mean component MAPE: `61.241%`;
- winning mean component MAE: `0.723842`;
- winning mean component RMSE: `1.188407`;
...
| --- | --- | ---: | ---: | --- |
| `HGBM` | `paper_reference_grid_search` | 5 | 0.737076 | `{'estimator__learning_rate': 0.21, 'estimator__max_depth': 11, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 24}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `HGBM` | `HistGradientBoostingRegressor` | `paper_reference_grid_search` | 61.241 | 0.723842 | 1.188407 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_156` | `HGBM` | `HistGradientBoostingRegressor` | 61.241 | 0.723842 | 1.188407 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_156` | `ERT / RF` | `HGBM` | 61.241 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/hgbm/2026-04-19-06-50-59__track1_hgbm_phase_156_closure_attempt_04_campaign_run/onnx_export`;
