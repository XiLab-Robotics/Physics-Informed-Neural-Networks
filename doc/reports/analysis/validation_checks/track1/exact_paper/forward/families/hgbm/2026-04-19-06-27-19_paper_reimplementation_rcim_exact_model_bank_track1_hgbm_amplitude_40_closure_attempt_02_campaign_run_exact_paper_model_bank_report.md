...
- run name: `track1_hgbm_amplitude_40_closure_attempt_02`;
- output run name: `track1_hgbm_amplitude_40_closure_attempt_02_campaign_run`;
- run instance id: `2026-04-19-06-27-07__track1_hgbm_amplitude_40_closure_attempt_02_campaign_run`;
...
- winning mean component MAPE: `2.904%`;
...
| --- | --- | ---: | ---: | --- |
| `HGBM` | `paper_reference_grid_search` | 5 | 0.795620 | `{'estimator__learning_rate': 0.22, 'estimator__max_depth': 11, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 26}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `HGBM` | `HistGradientBoostingRegressor` | `paper_reference_grid_search` | 2.904 | 0.000023 | 0.000031 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_40` | `HGBM` | `HistGradientBoostingRegressor` | 2.904 | 0.000023 | 0.000031 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_40` | `ERT / GBM` | `HGBM` | 2.904 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/hgbm/2026-04-19-06-27-07__track1_hgbm_amplitude_40_closure_attempt_02_campaign_run/onnx_export`;
