...
- run name: `track1_ert_phase_240_closure_attempt_01`;
- output run name: `track1_ert_phase_240_closure_attempt_01_campaign_run`;
- run instance id: `2026-04-19-05-16-58__track1_ert_phase_240_closure_attempt_01_campaign_run`;
...
- winning best params: `{'estimator__criterion': 'absolute_error', 'estimator__max_depth': 15, 'estimator__min_samples_split': 3, 'estimator__n_estimators': 100}`;
- winning mean component MAPE: `24.056%`;
- winning mean component MAE: `0.299932`;
- winning mean component RMSE: `0.774701`;
...
| --- | --- | ---: | ---: | --- |
| `ERT` | `paper_reference_grid_search` | 5 | 0.660420 | `{'estimator__criterion': 'absolute_error', 'estimator__max_depth': 15, 'estimator__min_samples_split': 3, 'estimator__n_estimators': 100}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ERT` | `ExtraTreesRegressor` | `paper_reference_grid_search` | 24.056 | 0.299932 | 0.774701 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_240` | `ERT` | `ExtraTreesRegressor` | 24.056 | 0.299932 | 0.774701 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_240` | `ERT` | `ERT` | 24.056 | `matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/ert/2026-04-19-05-16-58__track1_ert_phase_240_closure_attempt_01_campaign_run/onnx_export`;
