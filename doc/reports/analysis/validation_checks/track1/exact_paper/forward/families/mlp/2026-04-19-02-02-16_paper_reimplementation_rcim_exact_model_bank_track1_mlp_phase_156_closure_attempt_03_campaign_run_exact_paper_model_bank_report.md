...
- run name: `track1_mlp_phase_156_closure_attempt_03`;
- output run name: `track1_mlp_phase_156_closure_attempt_03_campaign_run`;
- run instance id: `2026-04-19-02-02-07__track1_mlp_phase_156_closure_attempt_03_campaign_run`;
...
- winning best params: `{'estimator__activation': 'tanh', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (100,), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}`;
- winning mean component MAPE: `88.964%`;
- winning mean component MAE: `1.813043`;
- winning mean component RMSE: `2.090778`;
...
| --- | --- | ---: | ---: | --- |
| `MLP` | `paper_reference_grid_search` | 5 | 0.155594 | `{'estimator__activation': 'tanh', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (100,), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `MLP` | `MLPRegressor` | `paper_reference_grid_search` | 88.964 | 1.813043 | 2.090778 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_156` | `MLP` | `MLPRegressor` | 88.964 | 1.813043 | 2.090778 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_156` | `ERT / RF` | `MLP` | 88.964 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/mlp/2026-04-19-02-02-07__track1_mlp_phase_156_closure_attempt_03_campaign_run/onnx_export`;
