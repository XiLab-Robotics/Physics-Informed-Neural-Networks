...
- run name: `track1_mlp_amplitude_1_final_closure_attempt_31`;
- output run name: `track1_mlp_amplitude_1_final_closure_attempt_31_campaign_run`;
- run instance id: `2026-04-21-23-49-03__track1_mlp_amplitude_1_final_closure_attempt_31_campaign_run`;
...
- winning mean component MAPE: `44.838%`;
- winning mean component MAE: `0.007708`;
- winning mean component RMSE: `0.015492`;
...
| --- | --- | ---: | ---: | --- |
| `MLP` | `paper_reference_grid_search` | 5 | -85863.121060 | `{'estimator__activation': 'tanh', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (200, 50), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `MLP` | `MLPRegressor` | `paper_reference_grid_search` | 44.838 | 0.007708 | 0.015492 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_1` | `MLP` | `MLPRegressor` | 44.838 | 0.007708 | 0.015492 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_1` | `RF / LGBM` | `MLP` | 44.838 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/mlp/2026-04-21-23-49-03__track1_mlp_amplitude_1_final_closure_attempt_31_campaign_run/onnx_export`;
