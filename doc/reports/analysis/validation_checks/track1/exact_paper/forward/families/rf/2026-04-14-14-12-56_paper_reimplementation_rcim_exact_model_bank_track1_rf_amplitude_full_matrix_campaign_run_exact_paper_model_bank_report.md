...
- run instance id: `2026-04-14-14-12-52__track1_rf_amplitude_full_matrix_campaign_run`;
...
- winning mean component MAPE: `6.927%`;
- winning mean component MAE: `0.000340`;
- winning mean component RMSE: `0.000473`;

## Family Ranking

| Rank | Family | Estimator | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | ---: | ---: | ---: |
| 1 | `RF` | `RandomForestRegressor` | 6.927 | 0.000340 | 0.000473 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_0` | `RF` | `RandomForestRegressor` | 11.920 | 0.003114 | 0.004114 |
| `fft_y_Fw_filtered_ampl_1` | `RF` | `RandomForestRegressor` | 0.154 | 0.000027 | 0.000037 |
| `fft_y_Fw_filtered_ampl_3` | `RF` | `RandomForestRegressor` | 2.327 | 0.000019 | 0.000027 |
| `fft_y_Fw_filtered_ampl_39` | `RF` | `RandomForestRegressor` | 2.433 | 0.000027 | 0.000037 |
| `fft_y_Fw_filtered_ampl_40` | `RF` | `RandomForestRegressor` | 2.778 | 0.000022 | 0.000033 |
| `fft_y_Fw_filtered_ampl_78` | `RF` | `RandomForestRegressor` | 11.030 | 0.000037 | 0.000057 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_0` | `SVR` | `RF` | 11.920 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_1` | `RF / LGBM` | `RF` | 0.154 | `matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_3` | `HGBM` | `RF` | 2.327 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_39` | `HGBM` | `RF` | 2.433 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_40` | `ERT / GBM` | `RF` | 2.778 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_78` | `HGBM / RF` | `RF` | 11.030 | `matched_expected_family_direction` |
...
| `Repo Best RMSE` | 0.004114 | 3.72e-05 | 2.73e-05 | 3.74e-05 | 3.28e-05 | 5.67e-05 | 1.82e-05 | 1.97e-04 | 1.52e-04 | 5.47e-05 |
...
| `Gap Vs Paper` | 8.14e-04 | 2.16e-06 | 2.26e-06 | 5.37e-06 | -3.24e-06 | 1.17e-05 | 3.22e-06 | 6.65e-05 | -8.22e-06 | 1.27e-05 |
| `Status` | `above_paper_target` | `above_paper_target` | `above_paper_target` | `above_paper_target` | `met_paper_target` | `above_paper_target` | `above_paper_target` | `above_paper_target` | `met_paper_target` | `above_paper_target` |
...
| `162` | `ERT` | `RF` | `met_paper_target` | `-` | `-` | `-` | `-` | `-` | `partially_matched_tables_3_6` |
| `240` | `ERT` | `RF` | `above_paper_target` | `-` | `-` | `-` | `-` | `-` | `not_yet_matched_tables_3_6` |

## ONNX Export Surface

- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/full_matrix/rf/2026-04-14-14-12-52__track1_rf_amplitude_full_matrix_campaign_run/onnx_export`;
