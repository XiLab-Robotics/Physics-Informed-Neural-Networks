...
- run name: `track1_hgbm_amplitude_240_closure_attempt_01`;
- output run name: `track1_hgbm_amplitude_240_closure_attempt_01_campaign_run`;
- run instance id: `2026-04-19-06-36-25__track1_hgbm_amplitude_240_closure_attempt_01_campaign_run`;
...
- winning mean component MAPE: `16.195%`;
- winning mean component MAE: `0.000039`;
- winning mean component RMSE: `0.000084`;
...
| --- | --- | ---: | ---: | --- |
| `HGBM` | `paper_reference_grid_search` | 5 | 0.928294 | `{'estimator__learning_rate': 0.22, 'estimator__max_depth': 12, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 26}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `HGBM` | `HistGradientBoostingRegressor` | `paper_reference_grid_search` | 16.195 | 0.000039 | 0.000084 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_240` | `HGBM` | `HistGradientBoostingRegressor` | 16.195 | 0.000039 | 0.000084 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_240` | `ERT` | `HGBM` | 16.195 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/hgbm/2026-04-19-06-36-25__track1_hgbm_amplitude_240_closure_attempt_01_campaign_run/onnx_export`;
