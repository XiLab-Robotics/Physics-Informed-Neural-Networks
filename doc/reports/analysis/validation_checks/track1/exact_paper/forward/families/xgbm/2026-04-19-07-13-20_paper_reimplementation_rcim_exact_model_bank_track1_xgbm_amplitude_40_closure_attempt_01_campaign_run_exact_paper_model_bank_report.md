...
- run name: `track1_xgbm_amplitude_40_closure_attempt_01`;
- output run name: `track1_xgbm_amplitude_40_closure_attempt_01_campaign_run`;
- run instance id: `2026-04-19-07-13-11__track1_xgbm_amplitude_40_closure_attempt_01_campaign_run`;
...
- winning mean component MAPE: `8.337%`;
- winning mean component MAE: `0.000064`;
- winning mean component RMSE: `0.000083`;
...
| --- | --- | ---: | ---: | --- |
| `XGBM` | `paper_reference_grid_search` | 5 | -0.017687 | `{'estimator__colsample_bytree': 0.3, 'estimator__learning_rate': 0.01, 'estimator__max_depth': 14}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `XGBM` | `XGBRegressor` | `paper_reference_grid_search` | 8.337 | 0.000064 | 0.000083 |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/xgbm/2026-04-19-07-13-11__track1_xgbm_amplitude_40_closure_attempt_01_campaign_run/onnx_export`;
