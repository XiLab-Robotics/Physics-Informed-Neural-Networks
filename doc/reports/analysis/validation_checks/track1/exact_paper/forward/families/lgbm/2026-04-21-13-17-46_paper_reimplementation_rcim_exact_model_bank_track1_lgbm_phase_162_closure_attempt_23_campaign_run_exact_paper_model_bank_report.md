...
- run name: `track1_lgbm_phase_162_closure_attempt_23`;
- output run name: `track1_lgbm_phase_162_closure_attempt_23_campaign_run`;
- run instance id: `2026-04-21-13-16-23__track1_lgbm_phase_162_closure_attempt_23_campaign_run`;
...
- winning mean component MAPE: `25.412%`;
- winning mean component MAE: `0.537979`;
- winning mean component RMSE: `1.090901`;
...
| --- | --- | ---: | ---: | --- |
| `LGBM` | `paper_reference_grid_search` | 5 | 0.673601 | `{'estimator__learning_rate': 0.39, 'estimator__max_depth': 10, 'estimator__num_leaves': 6, 'estimator__subsample': 0.001}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `LGBM` | `LGBMRegressor` | `paper_reference_grid_search` | 25.412 | 0.537979 | 1.090901 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_162` | `LGBM` | `LGBMRegressor` | 25.412 | 0.537979 | 1.090901 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_162` | `ERT` | `LGBM` | 25.412 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/lgbm/2026-04-21-13-16-23__track1_lgbm_phase_162_closure_attempt_23_campaign_run/onnx_export`;
