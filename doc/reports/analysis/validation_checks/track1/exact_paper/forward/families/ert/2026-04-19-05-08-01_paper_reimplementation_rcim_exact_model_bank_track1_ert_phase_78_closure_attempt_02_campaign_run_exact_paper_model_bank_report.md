...
- run name: `track1_ert_phase_78_closure_attempt_02`;
- output run name: `track1_ert_phase_78_closure_attempt_02_campaign_run`;
- run instance id: `2026-04-19-05-07-44__track1_ert_phase_78_closure_attempt_02_campaign_run`;
...
- winning best params: `{'estimator__criterion': 'absolute_error', 'estimator__max_depth': 15, 'estimator__min_samples_split': 5, 'estimator__n_estimators': 80}`;
- winning mean component MAPE: `48.386%`;
- winning mean component MAE: `0.074049`;
- winning mean component RMSE: `0.163835`;
...
| --- | --- | ---: | ---: | --- |
| `ERT` | `paper_reference_grid_search` | 5 | 0.801517 | `{'estimator__criterion': 'absolute_error', 'estimator__max_depth': 15, 'estimator__min_samples_split': 5, 'estimator__n_estimators': 80}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ERT` | `ExtraTreesRegressor` | `paper_reference_grid_search` | 48.386 | 0.074049 | 0.163835 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_78` | `ERT` | `ExtraTreesRegressor` | 48.386 | 0.074049 | 0.163835 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_78` | `HGBM / RF` | `ERT` | 48.386 | `not_matched_expected_family_direction` |
...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `78` | `-` | `-` | `-` | `RF` | `ERT` | `ERT` | `above_paper_target` | `above_paper_target` | `not_yet_matched_tables_3_6` |

## ONNX Export Surface

- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/ert/2026-04-19-05-07-44__track1_ert_phase_78_closure_attempt_02_campaign_run/onnx_export`;
