...
- run name: `track1_mlp_phase_240_closure_attempt_06`;
- output run name: `track1_mlp_phase_240_closure_attempt_06_campaign_run`;
- run instance id: `2026-04-19-02-06-02__track1_mlp_phase_240_closure_attempt_06_campaign_run`;
...
- winning mean component MAPE: `51.996%`;
- winning mean component MAE: `0.693810`;
- winning mean component RMSE: `1.262694`;
...
| --- | --- | ---: | ---: | --- |
| `MLP` | `paper_reference_grid_search` | 5 | -0.044377 | `{'estimator__activation': 'tanh', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (200, 50), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `MLP` | `MLPRegressor` | `paper_reference_grid_search` | 51.996 | 0.693810 | 1.262694 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_240` | `MLP` | `MLPRegressor` | 51.996 | 0.693810 | 1.262694 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_240` | `ERT` | `MLP` | 51.996 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/mlp/2026-04-19-02-06-02__track1_mlp_phase_240_closure_attempt_06_campaign_run/onnx_export`;
