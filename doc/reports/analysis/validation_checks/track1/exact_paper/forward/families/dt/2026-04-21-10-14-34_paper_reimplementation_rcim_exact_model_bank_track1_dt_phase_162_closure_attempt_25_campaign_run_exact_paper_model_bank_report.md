...
- run name: `track1_dt_phase_162_closure_attempt_25`;
- output run name: `track1_dt_phase_162_closure_attempt_25_campaign_run`;
- run instance id: `2026-04-21-10-14-26__track1_dt_phase_162_closure_attempt_25_campaign_run`;
...
- winning best params: `{'estimator__criterion': 'absolute_error', 'estimator__max_depth': 16, 'estimator__min_samples_split': 4}`;
- winning mean component MAPE: `10.422%`;
- winning mean component MAE: `0.251871`;
- winning mean component RMSE: `0.984037`;
...
| --- | --- | ---: | ---: | --- |
| `DT` | `paper_reference_grid_search` | 5 | 0.580846 | `{'estimator__criterion': 'absolute_error', 'estimator__max_depth': 16, 'estimator__min_samples_split': 4}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `DT` | `DecisionTreeRegressor` | `paper_reference_grid_search` | 10.422 | 0.251871 | 0.984037 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_162` | `DT` | `DecisionTreeRegressor` | 10.422 | 0.251871 | 0.984037 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_162` | `ERT` | `DT` | 10.422 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/dt/2026-04-21-10-14-26__track1_dt_phase_162_closure_attempt_25_campaign_run/onnx_export`;
