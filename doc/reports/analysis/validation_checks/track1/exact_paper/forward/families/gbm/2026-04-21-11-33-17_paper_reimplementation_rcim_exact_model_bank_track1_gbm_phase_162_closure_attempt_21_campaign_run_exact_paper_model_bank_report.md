...
- run name: `track1_gbm_phase_162_closure_attempt_21`;
- output run name: `track1_gbm_phase_162_closure_attempt_21_campaign_run`;
- run instance id: `2026-04-21-11-33-04__track1_gbm_phase_162_closure_attempt_21_campaign_run`;
...
- winning mean component MAPE: `10.099%`;
- winning mean component MAE: `0.258628`;
- winning mean component RMSE: `0.875696`;
...
| --- | --- | ---: | ---: | --- |
| `GBM` | `paper_reference_grid_search` | 5 | 0.671515 | `{'estimator__criterion': 'squared_error', 'estimator__learning_rate': 0.1, 'estimator__max_depth': 15, 'estimator__min_samples_split': 12, 'estimator__n_estimators': 52}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `GBM` | `GradientBoostingRegressor` | `paper_reference_grid_search` | 10.099 | 0.258628 | 0.875696 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_162` | `GBM` | `GradientBoostingRegressor` | 10.099 | 0.258628 | 0.875696 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_162` | `ERT` | `GBM` | 10.099 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/gbm/2026-04-21-11-33-04__track1_gbm_phase_162_closure_attempt_21_campaign_run/onnx_export`;
