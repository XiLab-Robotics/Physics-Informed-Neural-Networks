...
- run name: `track1_hgbm_amplitude_3_closure_attempt_03`;
- output run name: `track1_hgbm_amplitude_3_closure_attempt_03_campaign_run`;
- run instance id: `2026-04-19-06-23-35__track1_hgbm_amplitude_3_closure_attempt_03_campaign_run`;
...
- winning mean component MAPE: `2.095%`;
...
| --- | --- | ---: | ---: | --- |
| `HGBM` | `paper_reference_grid_search` | 5 | 0.980507 | `{'estimator__learning_rate': 0.21, 'estimator__max_depth': 10, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 25}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `HGBM` | `HistGradientBoostingRegressor` | `paper_reference_grid_search` | 2.095 | 0.000017 | 0.000034 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_3` | `HGBM` | `HistGradientBoostingRegressor` | 2.095 | 0.000017 | 0.000034 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_3` | `HGBM` | `HGBM` | 2.095 | `matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/hgbm/2026-04-19-06-23-35__track1_hgbm_amplitude_3_closure_attempt_03_campaign_run/onnx_export`;
