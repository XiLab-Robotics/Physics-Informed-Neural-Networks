...
- run name: `track1_et_amplitude_39_closure_attempt_01`;
- output run name: `track1_et_amplitude_39_closure_attempt_01_campaign_run`;
- run instance id: `2026-04-19-03-59-08__track1_et_amplitude_39_closure_attempt_01_campaign_run`;
...
- winning mean component MAPE: `4.244%`;
...
| --- | --- | ---: | ---: | --- |
| `ET` | `paper_reference_grid_search` | 5 | 0.969666 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 5}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ET` | `ExtraTreeRegressor` | `paper_reference_grid_search` | 4.244 | 0.000047 | 0.000076 |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/et/2026-04-19-03-59-08__track1_et_amplitude_39_closure_attempt_01_campaign_run/onnx_export`;
