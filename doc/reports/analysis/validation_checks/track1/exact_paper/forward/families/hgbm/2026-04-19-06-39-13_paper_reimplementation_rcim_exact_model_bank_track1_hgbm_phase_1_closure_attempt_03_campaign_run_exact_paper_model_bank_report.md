...
- run name: `track1_hgbm_phase_1_closure_attempt_03`;
- output run name: `track1_hgbm_phase_1_closure_attempt_03_campaign_run`;
- run instance id: `2026-04-19-06-39-01__track1_hgbm_phase_1_closure_attempt_03_campaign_run`;
...
- winning mean component MAPE: `28.521%`;
- winning mean component MAE: `0.002076`;
- winning mean component RMSE: `0.002803`;
...
| --- | --- | ---: | ---: | --- |
| `HGBM` | `paper_reference_grid_search` | 5 | 0.789919 | `{'estimator__learning_rate': 0.22, 'estimator__max_depth': 9, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 24}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `HGBM` | `HistGradientBoostingRegressor` | `paper_reference_grid_search` | 28.521 | 0.002076 | 0.002803 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_1` | `HGBM` | `HistGradientBoostingRegressor` | 28.521 | 0.002076 | 0.002803 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_1` | `RF / LGBM` | `HGBM` | 28.521 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/hgbm/2026-04-19-06-39-01__track1_hgbm_phase_1_closure_attempt_03_campaign_run/onnx_export`;
