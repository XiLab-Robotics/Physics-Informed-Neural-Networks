...
- run name: `track1_ert_phase_81_closure_attempt_01`;
- output run name: `track1_ert_phase_81_closure_attempt_01_campaign_run`;
- run instance id: `2026-04-19-05-09-44__track1_ert_phase_81_closure_attempt_01_campaign_run`;
...
- winning mean component MAPE: `4.516%`;
- winning mean component MAE: `0.048798`;
- winning mean component RMSE: `0.080115`;
...
| --- | --- | ---: | ---: | --- |
| `ERT` | `paper_reference_grid_search` | 5 | 0.966922 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 16, 'estimator__min_samples_split': 2, 'estimator__n_estimators': 100}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ERT` | `ExtraTreesRegressor` | `paper_reference_grid_search` | 4.516 | 0.048798 | 0.080115 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_81` | `ERT` | `ExtraTreesRegressor` | 4.516 | 0.048798 | 0.080115 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_81` | `RF` | `ERT` | 4.516 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/ert/2026-04-19-05-09-44__track1_ert_phase_81_closure_attempt_01_campaign_run/onnx_export`;
