...
- run name: `track1_xgbm_amplitude_156_closure_attempt_02`;
- output run name: `track1_xgbm_amplitude_156_closure_attempt_02_campaign_run`;
- run instance id: `2026-04-19-07-17-51__track1_xgbm_amplitude_156_closure_attempt_02_campaign_run`;
...
- winning mean component MAPE: `95.549%`;
- winning mean component MAE: `0.000225`;
- winning mean component RMSE: `0.000525`;
...
| --- | --- | ---: | ---: | --- |
| `XGBM` | `paper_reference_grid_search` | 5 | 0.843288 | `{'estimator__colsample_bytree': 0.8, 'estimator__learning_rate': 0.2, 'estimator__max_depth': 14}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `XGBM` | `XGBRegressor` | `paper_reference_grid_search` | 95.549 | 0.000225 | 0.000525 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_156` | `XGBM` | `XGBRegressor` | 95.549 | 0.000225 | 0.000525 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_156` | `ERT / RF` | `XGBM` | 95.549 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/xgbm/2026-04-19-07-17-51__track1_xgbm_amplitude_156_closure_attempt_02_campaign_run/onnx_export`;
