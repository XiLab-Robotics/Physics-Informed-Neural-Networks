...
- run name: `track1_mlp_amplitude_240_final_closure_attempt_53`;
- output run name: `track1_mlp_amplitude_240_final_closure_attempt_53_campaign_run`;
- run instance id: `2026-04-22-00-24-53__track1_mlp_amplitude_240_final_closure_attempt_53_campaign_run`;
...
- winning mean component MAPE: `3993.043%`;
- winning mean component MAE: `0.011402`;
- winning mean component RMSE: `0.019300`;
...
| --- | --- | ---: | ---: | --- |
| `MLP` | `paper_reference_grid_search` | 5 | -2439.760554 | `{'estimator__activation': 'tanh', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (200, 50), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `MLP` | `MLPRegressor` | `paper_reference_grid_search` | 3993.043 | 0.011402 | 0.019300 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_240` | `MLP` | `MLPRegressor` | 3993.043 | 0.011402 | 0.019300 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_240` | `ERT` | `MLP` | 3993.043 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/mlp/2026-04-22-00-24-53__track1_mlp_amplitude_240_final_closure_attempt_53_campaign_run/onnx_export`;
