...
- run name: `track1_lgbm_phase_78_closure_attempt_01`;
- output run name: `track1_lgbm_phase_78_closure_attempt_01_campaign_run`;
- run instance id: `2026-04-19-09-53-46__track1_lgbm_phase_78_closure_attempt_01_campaign_run`;
...
- winning mean component MAPE: `469.122%`;
- winning mean component MAE: `0.072443`;
- winning mean component RMSE: `0.142386`;
...
| --- | --- | ---: | ---: | --- |
| `LGBM` | `paper_reference_grid_search` | 5 | 0.789311 | `{'estimator__learning_rate': 0.39, 'estimator__max_depth': 11, 'estimator__num_leaves': 31, 'estimator__subsample': 0.001}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `LGBM` | `LGBMRegressor` | `paper_reference_grid_search` | 469.122 | 0.072443 | 0.142386 |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/lgbm/2026-04-19-09-53-46__track1_lgbm_phase_78_closure_attempt_01_campaign_run/onnx_export`;
