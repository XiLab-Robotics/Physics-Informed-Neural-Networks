...
- run name: `track1_hgbm_phase_39_closure_attempt_04`;
- output run name: `track1_hgbm_phase_39_closure_attempt_04_campaign_run`;
- run instance id: `2026-04-19-06-43-11__track1_hgbm_phase_39_closure_attempt_04_campaign_run`;
...
- winning mean component MAPE: `1.524%`;
- winning mean component MAE: `0.019710`;
- winning mean component RMSE: `0.030448`;
...
| --- | --- | ---: | ---: | --- |
| `HGBM` | `paper_reference_grid_search` | 5 | 0.983192 | `{'estimator__learning_rate': 0.22, 'estimator__max_depth': 13, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 24}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `HGBM` | `HistGradientBoostingRegressor` | `paper_reference_grid_search` | 1.524 | 0.019710 | 0.030448 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_39` | `HGBM` | `HistGradientBoostingRegressor` | 1.524 | 0.019710 | 0.030448 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_39` | `HGBM` | `HGBM` | 1.524 | `matched_expected_family_direction` |
...
| `Repo Best Family` | - | - | `HGBM` | - | - | - | - | - | - |
| `Repo Best RMSE` | - | - | 0.0304 | - | - | - | - | - | - |
| `Paper Best Family` | - | - | `HGBM` | - | - | - | - | - | - |
| `Paper Target RMSE` | - | - | 0.0270 | - | - | - | - | - | - |
| `Gap Vs Paper` | - | - | 0.003448 | - | - | - | - | - | - |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/hgbm/2026-04-19-06-43-11__track1_hgbm_phase_39_closure_attempt_04_campaign_run/onnx_export`;
