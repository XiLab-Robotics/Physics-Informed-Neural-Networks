...
- run name: `track1_et_amplitude_39_closure_attempt_06`;
- output run name: `track1_et_amplitude_39_closure_attempt_06_campaign_run`;
- run instance id: `2026-04-19-04-00-19__track1_et_amplitude_39_closure_attempt_06_campaign_run`;
...
- winning mean component MAPE: `3.327%`;
...
| --- | --- | ---: | ---: | --- |
| `ET` | `paper_reference_grid_search` | 5 | 0.969103 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 4}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ET` | `ExtraTreeRegressor` | `paper_reference_grid_search` | 3.327 | 0.000037 | 0.000050 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_39` | `ET` | `ExtraTreeRegressor` | 3.327 | 0.000037 | 0.000050 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_39` | `HGBM` | `ET` | 3.327 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/et/2026-04-19-04-00-19__track1_et_amplitude_39_closure_attempt_06_campaign_run/onnx_export`;
