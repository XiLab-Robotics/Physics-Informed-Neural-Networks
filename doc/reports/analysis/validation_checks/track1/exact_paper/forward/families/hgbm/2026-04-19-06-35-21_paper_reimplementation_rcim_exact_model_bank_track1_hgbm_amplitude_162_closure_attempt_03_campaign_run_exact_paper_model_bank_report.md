...
- run name: `track1_hgbm_amplitude_162_closure_attempt_03`;
- output run name: `track1_hgbm_amplitude_162_closure_attempt_03_campaign_run`;
- run instance id: `2026-04-19-06-35-08__track1_hgbm_amplitude_162_closure_attempt_03_campaign_run`;
...
- winning mean component MAPE: `22.732%`;
- winning mean component MAE: `0.000125`;
- winning mean component RMSE: `0.000303`;
...
| --- | --- | ---: | ---: | --- |
| `HGBM` | `paper_reference_grid_search` | 5 | 0.967685 | `{'estimator__learning_rate': 0.22, 'estimator__max_depth': 11, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 25}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `HGBM` | `HistGradientBoostingRegressor` | `paper_reference_grid_search` | 22.732 | 0.000125 | 0.000303 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_162` | `HGBM` | `HistGradientBoostingRegressor` | 22.732 | 0.000125 | 0.000303 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_162` | `ERT` | `HGBM` | 22.732 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/hgbm/2026-04-19-06-35-08__track1_hgbm_amplitude_162_closure_attempt_03_campaign_run/onnx_export`;
