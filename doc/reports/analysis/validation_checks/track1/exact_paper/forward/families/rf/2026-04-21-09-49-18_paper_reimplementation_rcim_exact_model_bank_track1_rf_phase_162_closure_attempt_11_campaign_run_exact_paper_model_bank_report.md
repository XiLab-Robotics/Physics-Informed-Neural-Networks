...
- run name: `track1_rf_phase_162_closure_attempt_11`;
- output run name: `track1_rf_phase_162_closure_attempt_11_campaign_run`;
- run instance id: `2026-04-21-09-48-59__track1_rf_phase_162_closure_attempt_11_campaign_run`;
...
- winning best params: `{'estimator__criterion': 'absolute_error', 'estimator__max_depth': 12, 'estimator__min_samples_split': 4, 'estimator__n_estimators': 60}`;
- winning mean component MAPE: `11.283%`;
- winning mean component MAE: `0.300349`;
- winning mean component RMSE: `0.906690`;
...
| --- | --- | ---: | ---: | --- |
| `RF` | `paper_reference_grid_search` | 5 | 0.743905 | `{'estimator__criterion': 'absolute_error', 'estimator__max_depth': 12, 'estimator__min_samples_split': 4, 'estimator__n_estimators': 60}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `RF` | `RandomForestRegressor` | `paper_reference_grid_search` | 11.283 | 0.300349 | 0.906690 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_162` | `RF` | `RandomForestRegressor` | 11.283 | 0.300349 | 0.906690 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_162` | `ERT` | `RF` | 11.283 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/rf/2026-04-21-09-48-59__track1_rf_phase_162_closure_attempt_11_campaign_run/onnx_export`;
