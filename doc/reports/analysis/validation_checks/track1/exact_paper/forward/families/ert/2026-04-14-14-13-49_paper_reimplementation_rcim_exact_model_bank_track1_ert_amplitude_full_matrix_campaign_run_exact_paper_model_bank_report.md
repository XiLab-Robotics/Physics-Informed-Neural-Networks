...
- run instance id: `2026-04-14-14-13-45__track1_ert_amplitude_full_matrix_campaign_run`;
...
- winning mean component MAPE: `6.518%`;
...
| ---: | --- | --- | ---: | ---: | ---: |
| 1 | `ERT` | `ExtraTreesRegressor` | 6.518 | 0.000349 | 0.000473 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_0` | `ERT` | `ExtraTreesRegressor` | 11.764 | 0.003229 | 0.004201 |
| `fft_y_Fw_filtered_ampl_1` | `ERT` | `ExtraTreesRegressor` | 0.153 | 0.000026 | 0.000037 |
| `fft_y_Fw_filtered_ampl_3` | `ERT` | `ExtraTreesRegressor` | 2.696 | 0.000021 | 0.000032 |
| `fft_y_Fw_filtered_ampl_39` | `ERT` | `ExtraTreesRegressor` | 2.372 | 0.000027 | 0.000038 |
| `fft_y_Fw_filtered_ampl_40` | `ERT` | `ExtraTreesRegressor` | 2.870 | 0.000023 | 0.000033 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_0` | `SVR` | `ERT` | 11.764 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_1` | `RF / LGBM` | `ERT` | 0.153 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_3` | `HGBM` | `ERT` | 2.696 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_39` | `HGBM` | `ERT` | 2.372 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_40` | `ERT / GBM` | `ERT` | 2.870 | `matched_expected_family_direction` |
...
| `Repo Best RMSE` | 0.004201 | 3.75e-05 | 3.17e-05 | 3.80e-05 | 3.34e-05 | 5.21e-05 | 1.85e-05 | 1.05e-04 | 1.44e-04 | 7.22e-05 |
...
| `Gap Vs Paper` | 9.01e-04 | 2.48e-06 | 6.69e-06 | 5.98e-06 | -2.58e-06 | 7.09e-06 | 3.52e-06 | -2.46e-05 | -1.64e-05 | 3.02e-05 |
...
| `1` | `RF` | `ERT` | `above_paper_target` | `-` | `-` | `-` | `-` | `-` | `not_yet_matched_tables_3_6` |
...
| `156` | `ERT` | `ERT` | `met_paper_target` | `-` | `-` | `-` | `-` | `-` | `fully_matched_tables_3_6` |
| `162` | `ERT` | `ERT` | `met_paper_target` | `-` | `-` | `-` | `-` | `-` | `fully_matched_tables_3_6` |
| `240` | `ERT` | `ERT` | `above_paper_target` | `-` | `-` | `-` | `-` | `-` | `partially_matched_tables_3_6` |

## ONNX Export Surface

- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/full_matrix/ert/2026-04-14-14-13-45__track1_ert_amplitude_full_matrix_campaign_run/onnx_export`;
