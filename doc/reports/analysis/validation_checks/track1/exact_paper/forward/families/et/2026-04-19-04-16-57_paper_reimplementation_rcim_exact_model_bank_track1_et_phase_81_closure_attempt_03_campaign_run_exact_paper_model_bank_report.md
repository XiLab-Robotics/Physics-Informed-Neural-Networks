...
- run name: `track1_et_phase_81_closure_attempt_03`;
- output run name: `track1_et_phase_81_closure_attempt_03_campaign_run`;
- run instance id: `2026-04-19-04-16-49__track1_et_phase_81_closure_attempt_03_campaign_run`;
...
- winning mean component MAPE: `7.805%`;
- winning mean component MAE: `0.076704`;
- winning mean component RMSE: `0.137462`;
...
| --- | --- | ---: | ---: | --- |
| `ET` | `paper_reference_grid_search` | 5 | 0.929523 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 15, 'estimator__min_samples_split': 2}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ET` | `ExtraTreeRegressor` | `paper_reference_grid_search` | 7.805 | 0.076704 | 0.137462 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_81` | `ET` | `ExtraTreeRegressor` | 7.805 | 0.076704 | 0.137462 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_81` | `RF` | `ET` | 7.805 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/et/2026-04-19-04-16-49__track1_et_phase_81_closure_attempt_03_campaign_run/onnx_export`;
