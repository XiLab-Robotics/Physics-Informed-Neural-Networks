...
- run name: `track1_mlp_phase_162_final_closure_attempt_50`;
- output run name: `track1_mlp_phase_162_final_closure_attempt_50_campaign_run`;
- run instance id: `2026-04-22-00-38-17__track1_mlp_phase_162_final_closure_attempt_50_campaign_run`;
...
- winning mean component MAPE: `56.813%`;
- winning mean component MAE: `1.190292`;
- winning mean component RMSE: `1.600910`;
...
| --- | --- | ---: | ---: | --- |
| `MLP` | `paper_reference_grid_search` | 5 | 0.247205 | `{'estimator__activation': 'relu', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (100, 50), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `MLP` | `MLPRegressor` | `paper_reference_grid_search` | 56.813 | 1.190292 | 1.600910 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_162` | `MLP` | `MLPRegressor` | 56.813 | 1.190292 | 1.600910 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_162` | `ERT` | `MLP` | 56.813 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/mlp/2026-04-22-00-38-17__track1_mlp_phase_162_final_closure_attempt_50_campaign_run/onnx_export`;
