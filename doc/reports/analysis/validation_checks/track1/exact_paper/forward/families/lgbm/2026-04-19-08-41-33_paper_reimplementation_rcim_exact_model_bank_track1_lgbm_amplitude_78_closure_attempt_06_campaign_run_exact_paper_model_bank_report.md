...
- run name: `track1_lgbm_amplitude_78_closure_attempt_06`;
- output run name: `track1_lgbm_amplitude_78_closure_attempt_06_campaign_run`;
- run instance id: `2026-04-19-08-40-10__track1_lgbm_amplitude_78_closure_attempt_06_campaign_run`;
...
- winning mean component MAPE: `8.033%`;
...
| --- | --- | ---: | ---: | --- |
| `LGBM` | `paper_reference_grid_search` | 5 | 0.994053 | `{'estimator__learning_rate': 0.2, 'estimator__max_depth': 11, 'estimator__num_leaves': 31, 'estimator__subsample': 0.001}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `LGBM` | `LGBMRegressor` | `paper_reference_grid_search` | 8.033 | 0.000026 | 0.000038 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_78` | `LGBM` | `LGBMRegressor` | 8.033 | 0.000026 | 0.000038 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_78` | `HGBM / RF` | `LGBM` | 8.033 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/lgbm/2026-04-19-08-40-10__track1_lgbm_amplitude_78_closure_attempt_06_campaign_run/onnx_export`;
