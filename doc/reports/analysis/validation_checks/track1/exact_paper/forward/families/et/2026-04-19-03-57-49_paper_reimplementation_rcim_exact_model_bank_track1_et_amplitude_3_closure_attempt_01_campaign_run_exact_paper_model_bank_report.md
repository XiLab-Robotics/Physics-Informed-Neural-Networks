...
- run name: `track1_et_amplitude_3_closure_attempt_01`;
- output run name: `track1_et_amplitude_3_closure_attempt_01_campaign_run`;
- run instance id: `2026-04-19-03-57-41__track1_et_amplitude_3_closure_attempt_01_campaign_run`;
...
- winning mean component MAPE: `2.789%`;
...
| --- | --- | ---: | ---: | --- |
| `ET` | `paper_reference_grid_search` | 5 | 0.951776 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 15, 'estimator__min_samples_split': 6}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ET` | `ExtraTreeRegressor` | `paper_reference_grid_search` | 2.789 | 0.000022 | 0.000032 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_3` | `ET` | `ExtraTreeRegressor` | 2.789 | 0.000022 | 0.000032 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_3` | `HGBM` | `ET` | 2.789 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/et/2026-04-19-03-57-41__track1_et_amplitude_3_closure_attempt_01_campaign_run/onnx_export`;
