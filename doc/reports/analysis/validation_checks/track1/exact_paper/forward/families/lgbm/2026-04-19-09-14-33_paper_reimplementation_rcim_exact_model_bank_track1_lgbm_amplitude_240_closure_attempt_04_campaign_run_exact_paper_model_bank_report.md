...
- run name: `track1_lgbm_amplitude_240_closure_attempt_04`;
- output run name: `track1_lgbm_amplitude_240_closure_attempt_04_campaign_run`;
- run instance id: `2026-04-19-09-13-09__track1_lgbm_amplitude_240_closure_attempt_04_campaign_run`;
...
- winning mean component MAPE: `12.665%`;
...
| --- | --- | ---: | ---: | --- |
| `LGBM` | `paper_reference_grid_search` | 5 | 0.980061 | `{'estimator__learning_rate': 0.58, 'estimator__max_depth': 12, 'estimator__num_leaves': 31, 'estimator__subsample': 0.001}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `LGBM` | `LGBMRegressor` | `paper_reference_grid_search` | 12.665 | 0.000036 | 0.000069 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_240` | `LGBM` | `LGBMRegressor` | 12.665 | 0.000036 | 0.000069 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_240` | `ERT` | `LGBM` | 12.665 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/lgbm/2026-04-19-09-13-09__track1_lgbm_amplitude_240_closure_attempt_04_campaign_run/onnx_export`;
