...
- run name: `track1_gbm_phase_162_closure_attempt_27`;
- output run name: `track1_gbm_phase_162_closure_attempt_27_campaign_run`;
- run instance id: `2026-04-21-11-35-01__track1_gbm_phase_162_closure_attempt_27_campaign_run`;
...
- winning mean component MAPE: `17.965%`;
- winning mean component MAE: `0.415740`;
- winning mean component RMSE: `1.003981`;
...
| --- | --- | ---: | ---: | --- |
| `GBM` | `paper_reference_grid_search` | 5 | 0.689330 | `{'estimator__criterion': 'squared_error', 'estimator__learning_rate': 0.1, 'estimator__max_depth': 14, 'estimator__min_samples_split': 18, 'estimator__n_estimators': 52}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `GBM` | `GradientBoostingRegressor` | `paper_reference_grid_search` | 17.965 | 0.415740 | 1.003981 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_162` | `GBM` | `GradientBoostingRegressor` | 17.965 | 0.415740 | 1.003981 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_162` | `ERT` | `GBM` | 17.965 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/gbm/2026-04-21-11-35-01__track1_gbm_phase_162_closure_attempt_27_campaign_run/onnx_export`;
