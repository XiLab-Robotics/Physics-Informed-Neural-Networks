...
- run name: `track1_mlp_amplitude_156_final_closure_attempt_32`;
- output run name: `track1_mlp_amplitude_156_final_closure_attempt_32_campaign_run`;
- run instance id: `2026-04-22-00-04-15__track1_mlp_amplitude_156_final_closure_attempt_32_campaign_run`;
...
- winning mean component MAPE: `5272.425%`;
- winning mean component MAE: `0.006444`;
- winning mean component RMSE: `0.010666`;
...
| --- | --- | ---: | ---: | --- |
| `MLP` | `paper_reference_grid_search` | 5 | -305.856143 | `{'estimator__activation': 'tanh', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (200, 50), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `MLP` | `MLPRegressor` | `paper_reference_grid_search` | 5272.425 | 0.006444 | 0.010666 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_156` | `MLP` | `MLPRegressor` | 5272.425 | 0.006444 | 0.010666 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_156` | `ERT / RF` | `MLP` | 5272.425 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/mlp/2026-04-22-00-04-15__track1_mlp_amplitude_156_final_closure_attempt_32_campaign_run/onnx_export`;
