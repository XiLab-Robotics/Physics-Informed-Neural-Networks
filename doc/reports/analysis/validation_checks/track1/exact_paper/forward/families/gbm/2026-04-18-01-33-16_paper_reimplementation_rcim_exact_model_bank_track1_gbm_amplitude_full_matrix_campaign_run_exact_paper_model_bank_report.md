...
- run name: `track1_gbm_amplitude_full_matrix`;
- output run name: `track1_gbm_amplitude_full_matrix_campaign_run`;
- run instance id: `2026-04-18-01-32-27__track1_gbm_amplitude_full_matrix_campaign_run`;
...
- winning best params: `{'estimator__criterion': 'squared_error', 'estimator__learning_rate': 0.1, 'estimator__max_depth': 14, 'estimator__min_samples_split': 14, 'estimator__n_estimators': 36}`;
- winning mean component MAPE: `8.411%`;
- winning mean component MAE: `0.000356`;
- winning mean component RMSE: `0.000497`;
...
| --- | --- | ---: | ---: | --- |
| `GBM` | `paper_reference_grid_search` | 5 | 0.915195 | `{'estimator__criterion': 'squared_error', 'estimator__learning_rate': 0.1, 'estimator__max_depth': 14, 'estimator__min_samples_split': 14, 'estimator__n_estimators': 36}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `GBM` | `GradientBoostingRegressor` | `paper_reference_grid_search` | 8.411 | 0.000356 | 0.000497 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_0` | `GBM` | `GradientBoostingRegressor` | 12.662 | 0.003237 | 0.004261 |
| `fft_y_Fw_filtered_ampl_1` | `GBM` | `GradientBoostingRegressor` | 0.158 | 0.000027 | 0.000038 |
| `fft_y_Fw_filtered_ampl_3` | `GBM` | `GradientBoostingRegressor` | 2.357 | 0.000019 | 0.000027 |
| `fft_y_Fw_filtered_ampl_39` | `GBM` | `GradientBoostingRegressor` | 2.392 | 0.000027 | 0.000038 |
| `fft_y_Fw_filtered_ampl_40` | `GBM` | `GradientBoostingRegressor` | 3.197 | 0.000026 | 0.000036 |
| `fft_y_Fw_filtered_ampl_78` | `GBM` | `GradientBoostingRegressor` | 12.394 | 0.000039 | 0.000055 |
| `fft_y_Fw_filtered_ampl_81` | `GBM` | `GradientBoostingRegressor` | 3.664 | 0.000012 | 0.000019 |
| `fft_y_Fw_filtered_ampl_156` | `GBM` | `GradientBoostingRegressor` | 21.765 | 0.000063 | 0.000223 |
| `fft_y_Fw_filtered_ampl_162` | `GBM` | `GradientBoostingRegressor` | 13.488 | 0.000072 | 0.000212 |
| `fft_y_Fw_filtered_ampl_240` | `GBM` | `GradientBoostingRegressor` | 12.035 | 0.000034 | 0.000058 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_0` | `SVR` | `GBM` | 12.662 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_1` | `RF / LGBM` | `GBM` | 0.158 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_3` | `HGBM` | `GBM` | 2.357 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_39` | `HGBM` | `GBM` | 2.392 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_40` | `ERT / GBM` | `GBM` | 3.197 | `matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_78` | `HGBM / RF` | `GBM` | 12.394 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_81` | `RF` | `GBM` | 3.664 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_156` | `ERT / RF` | `GBM` | 21.765 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_162` | `ERT` | `GBM` | 13.488 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_240` | `ERT` | `GBM` | 12.035 | `not_matched_expected_family_direction` |
...
| ---: | --- | --- | --- | ---: | --- |
| `0` | `SVR` | `GBM` | `-` | 0/1 | `no_family_direction_match` |
| `1` | `RF / LGBM` | `GBM` | `-` | 0/1 | `no_family_direction_match` |
| `3` | `HGBM` | `GBM` | `-` | 0/1 | `no_family_direction_match` |
| `39` | `HGBM` | `GBM` | `-` | 0/1 | `no_family_direction_match` |
| `40` | `ERT / GBM` | `GBM` | `-` | 1/1 | `full_family_direction_match` |
| `78` | `HGBM / RF` | `GBM` | `-` | 0/1 | `no_family_direction_match` |
| `81` | `RF` | `GBM` | `-` | 0/1 | `no_family_direction_match` |
| `156` | `ERT / RF` | `GBM` | `-` | 0/1 | `no_family_direction_match` |
| `162` | `ERT` | `GBM` | `-` | 0/1 | `no_family_direction_match` |
| `240` | `ERT` | `GBM` | `-` | 0/1 | `no_family_direction_match` |
...
| `Repo Best Family` | `GBM` | `GBM` | `GBM` | `GBM` | `GBM` | `GBM` | `GBM` | `GBM` | `GBM` | `GBM` |
| `Repo Best RMSE` | 0.004261 | 3.79e-05 | 2.66e-05 | 3.80e-05 | 3.58e-05 | 5.49e-05 | 1.88e-05 | 2.23e-04 | 2.12e-04 | 5.81e-05 |
...
| `Gap Vs Paper` | 9.61e-04 | 2.87e-06 | 1.58e-06 | 6.04e-06 | -2.11e-07 | 9.86e-06 | 3.76e-06 | 9.33e-05 | 5.20e-05 | 1.61e-05 |
| `Status` | `above_paper_target` | `above_paper_target` | `above_paper_target` | `above_paper_target` | `met_paper_target` | `above_paper_target` | `above_paper_target` | `above_paper_target` | `above_paper_target` | `above_paper_target` |
...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `0` | `SVM` | `GBM` | `above_paper_target` | `-` | `-` | `-` | `-` | `-` | `not_yet_matched_tables_3_6` |
| `1` | `RF` | `GBM` | `above_paper_target` | `-` | `-` | `-` | `-` | `-` | `not_yet_matched_tables_3_6` |
| `3` | `HGBM` | `GBM` | `above_paper_target` | `-` | `-` | `-` | `-` | `-` | `not_yet_matched_tables_3_6` |
| `39` | `HGBM` | `GBM` | `above_paper_target` | `-` | `-` | `-` | `-` | `-` | `not_yet_matched_tables_3_6` |
| `40` | `ERT` | `GBM` | `met_paper_target` | `-` | `-` | `-` | `-` | `-` | `partially_matched_tables_3_6` |
| `78` | `HGBM` | `GBM` | `above_paper_target` | `-` | `-` | `-` | `-` | `-` | `not_yet_matched_tables_3_6` |
| `81` | `RF` | `GBM` | `above_paper_target` | `-` | `-` | `-` | `-` | `-` | `not_yet_matched_tables_3_6` |
| `156` | `ERT` | `GBM` | `above_paper_target` | `-` | `-` | `-` | `-` | `-` | `not_yet_matched_tables_3_6` |
| `162` | `ERT` | `GBM` | `above_paper_target` | `-` | `-` | `-` | `-` | `-` | `not_yet_matched_tables_3_6` |
| `240` | `ERT` | `GBM` | `above_paper_target` | `-` | `-` | `-` | `-` | `-` | `not_yet_matched_tables_3_6` |

## ONNX Export Surface

- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/full_matrix/gbm/2026-04-18-01-32-27__track1_gbm_amplitude_full_matrix_campaign_run/onnx_export`;
