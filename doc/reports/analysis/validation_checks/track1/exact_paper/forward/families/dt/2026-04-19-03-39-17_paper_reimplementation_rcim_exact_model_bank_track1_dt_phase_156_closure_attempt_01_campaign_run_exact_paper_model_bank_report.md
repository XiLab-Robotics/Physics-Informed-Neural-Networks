...
- run name: `track1_dt_phase_156_closure_attempt_01`;
- output run name: `track1_dt_phase_156_closure_attempt_01_campaign_run`;
- run instance id: `2026-04-19-03-39-10__track1_dt_phase_156_closure_attempt_01_campaign_run`;
...
- winning best params: `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 15, 'estimator__min_samples_split': 7}`;
- winning mean component MAPE: `44.636%`;
- winning mean component MAE: `0.510887`;
- winning mean component RMSE: `1.259491`;
...
| --- | --- | ---: | ---: | --- |
| `DT` | `paper_reference_grid_search` | 5 | 0.593247 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 15, 'estimator__min_samples_split': 7}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `DT` | `DecisionTreeRegressor` | `paper_reference_grid_search` | 44.636 | 0.510887 | 1.259491 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_156` | `DT` | `DecisionTreeRegressor` | 44.636 | 0.510887 | 1.259491 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_156` | `ERT / RF` | `DT` | 44.636 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/dt/2026-04-19-03-39-10__track1_dt_phase_156_closure_attempt_01_campaign_run/onnx_export`;
