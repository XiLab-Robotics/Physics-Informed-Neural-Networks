...
- run name: `track1_mlp_phase_162_final_closure_attempt_06`;
- output run name: `track1_mlp_phase_162_final_closure_attempt_06_campaign_run`;
- run instance id: `2026-04-22-00-26-44__track1_mlp_phase_162_final_closure_attempt_06_campaign_run`;
...
- winning mean component MAPE: `53.572%`;
- winning mean component MAE: `1.005174`;
- winning mean component RMSE: `1.443743`;
...
| --- | --- | ---: | ---: | --- |
| `MLP` | `paper_reference_grid_search` | 5 | 0.297338 | `{'estimator__activation': 'relu', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (100, 50), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `MLP` | `MLPRegressor` | `paper_reference_grid_search` | 53.572 | 1.005174 | 1.443743 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_162` | `MLP` | `MLPRegressor` | 53.572 | 1.005174 | 1.443743 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_162` | `ERT` | `MLP` | 53.572 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/mlp/2026-04-22-00-26-44__track1_mlp_phase_162_final_closure_attempt_06_campaign_run/onnx_export`;
