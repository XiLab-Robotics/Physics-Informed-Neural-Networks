...
- run name: `track1_lgbm_amplitude_81_closure_attempt_01`;
- output run name: `track1_lgbm_amplitude_81_closure_attempt_01_campaign_run`;
- run instance id: `2026-04-19-08-41-40__track1_lgbm_amplitude_81_closure_attempt_01_campaign_run`;
...
- winning mean component MAPE: `3.742%`;
...
| --- | --- | ---: | ---: | --- |
| `LGBM` | `paper_reference_grid_search` | 5 | 0.939156 | `{'estimator__learning_rate': 0.39, 'estimator__max_depth': 10, 'estimator__num_leaves': 6, 'estimator__subsample': 0.001}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `LGBM` | `LGBMRegressor` | `paper_reference_grid_search` | 3.742 | 0.000012 | 0.000019 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_81` | `LGBM` | `LGBMRegressor` | 3.742 | 0.000012 | 0.000019 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_81` | `RF` | `LGBM` | 3.742 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/lgbm/2026-04-19-08-41-40__track1_lgbm_amplitude_81_closure_attempt_01_campaign_run/onnx_export`;
