...
- run name: `track1_mlp_phase_156_closure_attempt_02`;
- output run name: `track1_mlp_phase_156_closure_attempt_02_campaign_run`;
- run instance id: `2026-04-19-02-01-52__track1_mlp_phase_156_closure_attempt_02_campaign_run`;
...
- winning mean component MAPE: `91.266%`;
- winning mean component MAE: `1.603336`;
- winning mean component RMSE: `1.928252`;
...
| --- | --- | ---: | ---: | --- |
| `MLP` | `paper_reference_grid_search` | 5 | 0.204365 | `{'estimator__activation': 'tanh', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (200,), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `MLP` | `MLPRegressor` | `paper_reference_grid_search` | 91.266 | 1.603336 | 1.928252 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_156` | `MLP` | `MLPRegressor` | 91.266 | 1.603336 | 1.928252 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_156` | `ERT / RF` | `MLP` | 91.266 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/mlp/2026-04-19-02-01-52__track1_mlp_phase_156_closure_attempt_02_campaign_run/onnx_export`;
