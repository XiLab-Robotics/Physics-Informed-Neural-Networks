...
- run name: `track1_hgbm_phase_81_closure_attempt_01`;
- output run name: `track1_hgbm_phase_81_closure_attempt_01_campaign_run`;
- run instance id: `2026-04-19-06-48-05__track1_hgbm_phase_81_closure_attempt_01_campaign_run`;
...
- winning best params: `{'estimator__learning_rate': 0.2, 'estimator__max_depth': 10, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 25}`;
- winning mean component MAPE: `4.999%`;
- winning mean component MAE: `0.050762`;
- winning mean component RMSE: `0.074735`;
...
| --- | --- | ---: | ---: | --- |
| `HGBM` | `paper_reference_grid_search` | 5 | 0.964127 | `{'estimator__learning_rate': 0.2, 'estimator__max_depth': 10, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 25}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `HGBM` | `HistGradientBoostingRegressor` | `paper_reference_grid_search` | 4.999 | 0.050762 | 0.074735 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_81` | `HGBM` | `HistGradientBoostingRegressor` | 4.999 | 0.050762 | 0.074735 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_81` | `RF` | `HGBM` | 4.999 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/hgbm/2026-04-19-06-48-05__track1_hgbm_phase_81_closure_attempt_01_campaign_run/onnx_export`;
