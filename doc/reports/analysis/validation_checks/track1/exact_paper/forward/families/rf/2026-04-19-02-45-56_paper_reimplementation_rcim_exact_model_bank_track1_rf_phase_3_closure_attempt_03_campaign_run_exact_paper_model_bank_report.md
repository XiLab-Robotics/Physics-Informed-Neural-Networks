...
- run name: `track1_rf_phase_3_closure_attempt_03`;
- output run name: `track1_rf_phase_3_closure_attempt_03_campaign_run`;
- run instance id: `2026-04-19-02-45-38__track1_rf_phase_3_closure_attempt_03_campaign_run`;
...
- winning mean component MAPE: `1.227%`;
- winning mean component MAE: `0.021924`;
- winning mean component RMSE: `0.031559`;
...
| --- | --- | ---: | ---: | --- |
| `RF` | `paper_reference_grid_search` | 5 | 0.927702 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 12, 'estimator__min_samples_split': 2, 'estimator__n_estimators': 70}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `RF` | `RandomForestRegressor` | `paper_reference_grid_search` | 1.227 | 0.021924 | 0.031559 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_3` | `RF` | `RandomForestRegressor` | 1.227 | 0.021924 | 0.031559 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_3` | `HGBM` | `RF` | 1.227 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/rf/2026-04-19-02-45-38__track1_rf_phase_3_closure_attempt_03_campaign_run/onnx_export`;
