...
- run name: `track1_mlp_amplitude_240_final_closure_attempt_11`;
- output run name: `track1_mlp_amplitude_240_final_closure_attempt_11_campaign_run`;
- run instance id: `2026-04-22-00-13-17__track1_mlp_amplitude_240_final_closure_attempt_11_campaign_run`;
...
- winning mean component MAPE: `3422.637%`;
- winning mean component MAE: `0.008721`;
- winning mean component RMSE: `0.014053`;
...
| --- | --- | ---: | ---: | --- |
| `MLP` | `paper_reference_grid_search` | 5 | -1729.157074 | `{'estimator__activation': 'tanh', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (200, 50), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `MLP` | `MLPRegressor` | `paper_reference_grid_search` | 3422.637 | 0.008721 | 0.014053 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_240` | `MLP` | `MLPRegressor` | 3422.637 | 0.008721 | 0.014053 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_240` | `ERT` | `MLP` | 3422.637 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/mlp/2026-04-22-00-13-17__track1_mlp_amplitude_240_final_closure_attempt_11_campaign_run/onnx_export`;
