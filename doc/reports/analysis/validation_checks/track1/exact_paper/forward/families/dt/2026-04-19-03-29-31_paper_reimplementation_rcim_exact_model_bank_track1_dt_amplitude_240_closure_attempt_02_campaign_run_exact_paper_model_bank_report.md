...
- run name: `track1_dt_amplitude_240_closure_attempt_02`;
- output run name: `track1_dt_amplitude_240_closure_attempt_02_campaign_run`;
- run instance id: `2026-04-19-03-29-23__track1_dt_amplitude_240_closure_attempt_02_campaign_run`;
...
- winning mean component MAPE: `11.975%`;
...
| --- | --- | ---: | ---: | --- |
| `DT` | `paper_reference_grid_search` | 5 | 0.957182 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 4}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `DT` | `DecisionTreeRegressor` | `paper_reference_grid_search` | 11.975 | 0.000033 | 0.000051 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_240` | `DT` | `DecisionTreeRegressor` | 11.975 | 0.000033 | 0.000051 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_240` | `ERT` | `DT` | 11.975 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/dt/2026-04-19-03-29-23__track1_dt_amplitude_240_closure_attempt_02_campaign_run/onnx_export`;
