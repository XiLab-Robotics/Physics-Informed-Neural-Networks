...
- run name: `track1_dt_phase_78_closure_attempt_05`;
- output run name: `track1_dt_phase_78_closure_attempt_05_campaign_run`;
- run instance id: `2026-04-19-03-37-15__track1_dt_phase_78_closure_attempt_05_campaign_run`;
...
- winning mean component MAPE: `313.248%`;
- winning mean component MAE: `0.079062`;
- winning mean component RMSE: `0.154636`;
...
| --- | --- | ---: | ---: | --- |
| `DT` | `paper_reference_grid_search` | 5 | 0.782014 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 7}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `DT` | `DecisionTreeRegressor` | `paper_reference_grid_search` | 313.248 | 0.079062 | 0.154636 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_78` | `DT` | `DecisionTreeRegressor` | 313.248 | 0.079062 | 0.154636 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_78` | `HGBM / RF` | `DT` | 313.248 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/dt/2026-04-19-03-37-15__track1_dt_phase_78_closure_attempt_05_campaign_run/onnx_export`;
