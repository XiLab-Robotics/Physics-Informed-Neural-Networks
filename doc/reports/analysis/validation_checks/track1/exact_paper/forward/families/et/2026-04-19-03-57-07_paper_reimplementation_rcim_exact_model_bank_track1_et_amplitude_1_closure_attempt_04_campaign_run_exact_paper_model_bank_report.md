...
- run name: `track1_et_amplitude_1_closure_attempt_04`;
- output run name: `track1_et_amplitude_1_closure_attempt_04_campaign_run`;
- run instance id: `2026-04-19-03-56-59__track1_et_amplitude_1_closure_attempt_04_campaign_run`;
...
| --- | --- | ---: | ---: | --- |
| `ET` | `paper_reference_grid_search` | 5 | 0.645757 | `{'estimator__criterion': 'absolute_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 6}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ET` | `ExtraTreeRegressor` | `paper_reference_grid_search` | 0.183 | 0.000031 | 0.000042 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_1` | `ET` | `ExtraTreeRegressor` | 0.183 | 0.000031 | 0.000042 |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/et/2026-04-19-03-56-59__track1_et_amplitude_1_closure_attempt_04_campaign_run/onnx_export`;
