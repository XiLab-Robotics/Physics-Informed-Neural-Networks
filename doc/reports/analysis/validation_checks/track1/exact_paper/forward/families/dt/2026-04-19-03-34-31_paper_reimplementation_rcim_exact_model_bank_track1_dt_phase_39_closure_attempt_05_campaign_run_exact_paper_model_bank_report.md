...
- run name: `track1_dt_phase_39_closure_attempt_05`;
- output run name: `track1_dt_phase_39_closure_attempt_05_campaign_run`;
- run instance id: `2026-04-19-03-34-23__track1_dt_phase_39_closure_attempt_05_campaign_run`;
...
- winning mean component MAPE: `2.071%`;
- winning mean component MAE: `0.026463`;
- winning mean component RMSE: `0.042227`;
...
| --- | --- | ---: | ---: | --- |
| `DT` | `paper_reference_grid_search` | 5 | 0.961692 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 8}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `DT` | `DecisionTreeRegressor` | `paper_reference_grid_search` | 2.071 | 0.026463 | 0.042227 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_39` | `DT` | `DecisionTreeRegressor` | 2.071 | 0.026463 | 0.042227 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_39` | `HGBM` | `DT` | 2.071 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/dt/2026-04-19-03-34-23__track1_dt_phase_39_closure_attempt_05_campaign_run/onnx_export`;
