...
- run instance id: `2026-04-14-14-13-23__track1_dt_phase_full_matrix_campaign_run`;
...
- winning mean component MAPE: `51.522%`;
- winning mean component MAE: `0.140995`;
- winning mean component RMSE: `0.378819`;

## Family Ranking

| Rank | Family | Estimator | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | ---: | ---: | ---: |
| 1 | `DT` | `DecisionTreeRegressor` | 51.522 | 0.140995 | 0.378819 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_1` | `DT` | `DecisionTreeRegressor` | 32.776 | 0.002236 | 0.003114 |
...
| `fft_y_Fw_filtered_phase_40` | `DT` | `DecisionTreeRegressor` | 77.317 | 0.045518 | 0.070686 |
...
| `fft_y_Fw_filtered_phase_162` | `DT` | `DecisionTreeRegressor` | 11.645 | 0.246141 | 0.891624 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_1` | `RF / LGBM` | `DT` | 32.776 | `not_matched_expected_family_direction` |
...
| `fft_y_Fw_filtered_phase_40` | `ERT / GBM` | `DT` | 77.317 | `not_matched_expected_family_direction` |
...
| `fft_y_Fw_filtered_phase_156` | `ERT / RF` | `DT` | 46.772 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_162` | `ERT` | `DT` | 11.645 | `not_matched_expected_family_direction` |
...
| `Repo Best MAE` | 0.002236 | 0.0273 | 0.0323 | 0.0455 | 0.0745 | 0.0636 | 0.4900 | 0.2461 | 0.2873 |
...
| `Gap Vs Paper` | 4.36e-04 | 0.007340 | 0.0113 | 0.009518 | 4.90e-04 | 0.0106 | -0.0200 | 0.0461 | 0.0573 |
...
| `Repo Best Family` | `DT` | `DT` | `DT` | `DT` | `DT` | `DT` | `DT` | `DT` | `DT` |
| `Repo Best RMSE` | 0.003114 | 0.0391 | 0.0601 | 0.0707 | 0.1513 | 0.0957 | 1.226 | 0.8916 | 0.8720 |
...
| `Gap Vs Paper` | 6.14e-04 | 0.0101 | 0.0331 | 0.0157 | -0.008686 | 0.0137 | 0.0258 | 0.2516 | 0.2920 |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/full_matrix/dt/2026-04-14-14-13-23__track1_dt_phase_full_matrix_campaign_run/onnx_export`;
