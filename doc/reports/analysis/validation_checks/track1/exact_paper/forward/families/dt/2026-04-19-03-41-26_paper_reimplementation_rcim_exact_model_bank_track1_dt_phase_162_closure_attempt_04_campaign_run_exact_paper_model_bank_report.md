...
- run instance id: `2026-04-19-03-41-18__track1_dt_phase_162_closure_attempt_04_campaign_run`;
...
- winning mean component MAPE: `14.900%`;
- winning mean component MAE: `0.408912`;
- winning mean component RMSE: `1.218023`;
...
| --- | --- | ---: | ---: | --- |
| `DT` | `paper_reference_grid_search` | 5 | 0.664341 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 17, 'estimator__min_samples_split': 6}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `DT` | `DecisionTreeRegressor` | `paper_reference_grid_search` | 14.900 | 0.408912 | 1.218023 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_162` | `DT` | `DecisionTreeRegressor` | 14.900 | 0.408912 | 1.218023 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_162` | `ERT` | `DT` | 14.900 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/dt/2026-04-19-03-41-18__track1_dt_phase_162_closure_attempt_04_campaign_run/onnx_export`;
