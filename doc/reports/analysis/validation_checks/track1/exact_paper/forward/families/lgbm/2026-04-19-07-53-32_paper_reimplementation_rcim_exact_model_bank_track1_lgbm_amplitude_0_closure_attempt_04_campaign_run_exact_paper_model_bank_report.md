...
- run name: `track1_lgbm_amplitude_0_closure_attempt_04`;
- output run name: `track1_lgbm_amplitude_0_closure_attempt_04_campaign_run`;
- run instance id: `2026-04-19-07-52-08__track1_lgbm_amplitude_0_closure_attempt_04_campaign_run`;
...
- winning mean component MAPE: `4.918%`;
- winning mean component MAE: `0.002320`;
- winning mean component RMSE: `0.002815`;
...
| --- | --- | ---: | ---: | --- |
| `LGBM` | `paper_reference_grid_search` | 5 | 0.973459 | `{'estimator__learning_rate': 0.2, 'estimator__max_depth': 10, 'estimator__num_leaves': 8, 'estimator__subsample': 0.001}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `LGBM` | `LGBMRegressor` | `paper_reference_grid_search` | 4.918 | 0.002320 | 0.002815 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_0` | `LGBM` | `LGBMRegressor` | 4.918 | 0.002320 | 0.002815 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_0` | `SVR` | `LGBM` | 4.918 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/lgbm/2026-04-19-07-52-08__track1_lgbm_amplitude_0_closure_attempt_04_campaign_run/onnx_export`;
