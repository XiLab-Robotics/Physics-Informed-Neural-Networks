...
- run name: `track1_dt_phase_156_closure_attempt_03`;
- output run name: `track1_dt_phase_156_closure_attempt_03_campaign_run`;
- run instance id: `2026-04-19-03-39-38__track1_dt_phase_156_closure_attempt_03_campaign_run`;
...
- winning mean component MAPE: `32.257%`;
- winning mean component MAE: `0.507961`;
- winning mean component RMSE: `1.139110`;
...
| --- | --- | ---: | ---: | --- |
| `DT` | `paper_reference_grid_search` | 5 | 0.654614 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 7}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `DT` | `DecisionTreeRegressor` | `paper_reference_grid_search` | 32.257 | 0.507961 | 1.139110 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_156` | `DT` | `DecisionTreeRegressor` | 32.257 | 0.507961 | 1.139110 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_156` | `ERT / RF` | `DT` | 32.257 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/dt/2026-04-19-03-39-38__track1_dt_phase_156_closure_attempt_03_campaign_run/onnx_export`;
