...
- run name: `track1_xgbm_amplitude_39_closure_attempt_05`;
- output run name: `track1_xgbm_amplitude_39_closure_attempt_05_campaign_run`;
- run instance id: `2026-04-19-07-12-42__track1_xgbm_amplitude_39_closure_attempt_05_campaign_run`;
...
- winning mean component MAPE: `8.519%`;
...
| --- | --- | ---: | ---: | --- |
| `XGBM` | `paper_reference_grid_search` | 5 | 0.813432 | `{'estimator__colsample_bytree': 0.8, 'estimator__learning_rate': 0.5, 'estimator__max_depth': 14}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `XGBM` | `XGBRegressor` | `paper_reference_grid_search` | 8.519 | 0.000088 | 0.000119 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_39` | `XGBM` | `XGBRegressor` | 8.519 | 0.000088 | 0.000119 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_39` | `HGBM` | `XGBM` | 8.519 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/xgbm/2026-04-19-07-12-42__track1_xgbm_amplitude_39_closure_attempt_05_campaign_run/onnx_export`;
