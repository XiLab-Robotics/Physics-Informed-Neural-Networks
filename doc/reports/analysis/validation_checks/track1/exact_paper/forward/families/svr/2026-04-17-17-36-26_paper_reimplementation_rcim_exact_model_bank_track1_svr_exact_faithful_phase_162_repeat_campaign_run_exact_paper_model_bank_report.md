...
- output run name: `track1_svr_exact_faithful_phase_162_repeat_campaign_run`;
- run instance id: `2026-04-17-17-03-43__track1_svr_exact_faithful_phase_162_repeat_campaign_run`;
...
- winning best params: `{'estimator__C': 1.0, 'estimator__epsilon': 1e-06, 'estimator__gamma': 1.1e-06, 'estimator__kernel': 'rbf'}`;
- winning mean component MAPE: `27.259%`;
- winning mean component MAE: `0.542246`;
- winning mean component RMSE: `1.217833`;
...
| --- | --- | ---: | ---: | --- |
| `SVR` | `paper_reference_grid_search` | 5 | 0.429734 | `{'estimator__C': 1.0, 'estimator__epsilon': 1e-06, 'estimator__gamma': 1.1e-06, 'estimator__kernel': 'rbf'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `SVR` | `SVR` | `paper_reference_grid_search` | 27.259 | 0.542246 | 1.217833 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_162` | `SVR` | `SVR` | 27.259 | 0.542246 | 1.217833 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_162` | `ERT` | `SVR` | 27.259 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/svm_targeted_closure/svm/2026-04-17-17-03-43__track1_svr_exact_faithful_phase_162_repeat_campaign_run/onnx_export`;
