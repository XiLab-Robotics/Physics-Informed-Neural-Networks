...
- run name: `track1_lgbm_phase_240_closure_attempt_02`;
- output run name: `track1_lgbm_phase_240_closure_attempt_02_campaign_run`;
- run instance id: `2026-04-19-10-31-16__track1_lgbm_phase_240_closure_attempt_02_campaign_run`;
...
- winning best params: `{'estimator__learning_rate': 0.39, 'estimator__max_depth': 10, 'estimator__num_leaves': 31, 'estimator__subsample': 0.001}`;
- winning mean component MAPE: `82.678%`;
- winning mean component MAE: `0.330344`;
- winning mean component RMSE: `0.648184`;
...
| --- | --- | ---: | ---: | --- |
| `LGBM` | `paper_reference_grid_search` | 5 | 0.515670 | `{'estimator__learning_rate': 0.39, 'estimator__max_depth': 10, 'estimator__num_leaves': 31, 'estimator__subsample': 0.001}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `LGBM` | `LGBMRegressor` | `paper_reference_grid_search` | 82.678 | 0.330344 | 0.648184 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_240` | `LGBM` | `LGBMRegressor` | 82.678 | 0.330344 | 0.648184 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_240` | `ERT` | `LGBM` | 82.678 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/lgbm/2026-04-19-10-31-16__track1_lgbm_phase_240_closure_attempt_02_campaign_run/onnx_export`;
