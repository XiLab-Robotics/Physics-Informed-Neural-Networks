...
- run name: `track1_hgbm_phase_3_closure_attempt_19`;
- output run name: `track1_hgbm_phase_3_closure_attempt_19_campaign_run`;
- run instance id: `2026-04-21-11-53-21__track1_hgbm_phase_3_closure_attempt_19_campaign_run`;
...
- winning mean component MAPE: `1.318%`;
- winning mean component MAE: `0.023485`;
- winning mean component RMSE: `0.031974`;
...
| --- | --- | ---: | ---: | --- |
| `HGBM` | `paper_reference_grid_search` | 5 | 0.938335 | `{'estimator__learning_rate': 0.2, 'estimator__max_depth': 12, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 25}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `HGBM` | `HistGradientBoostingRegressor` | `paper_reference_grid_search` | 1.318 | 0.023485 | 0.031974 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_3` | `HGBM` | `HistGradientBoostingRegressor` | 1.318 | 0.023485 | 0.031974 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_3` | `HGBM` | `HGBM` | 1.318 | `matched_expected_family_direction` |
...
| `Repo Best Family` | - | `HGBM` | - | - | - | - | - | - | - |
| `Repo Best RMSE` | - | 0.0320 | - | - | - | - | - | - | - |
| `Paper Best Family` | - | `HGBM` | - | - | - | - | - | - | - |
| `Paper Target RMSE` | - | 0.0290 | - | - | - | - | - | - | - |
| `Gap Vs Paper` | - | 0.002974 | - | - | - | - | - | - | - |
| `Status` | - | `above_paper_target` | - | - | - | - | - | - | - |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/hgbm/2026-04-21-11-53-21__track1_hgbm_phase_3_closure_attempt_19_campaign_run/onnx_export`;
