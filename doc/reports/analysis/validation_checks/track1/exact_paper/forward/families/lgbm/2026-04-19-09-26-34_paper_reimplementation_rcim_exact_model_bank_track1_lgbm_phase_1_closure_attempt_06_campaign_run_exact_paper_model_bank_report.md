...
- run name: `track1_lgbm_phase_1_closure_attempt_06`;
- output run name: `track1_lgbm_phase_1_closure_attempt_06_campaign_run`;
- run instance id: `2026-04-19-09-25-12__track1_lgbm_phase_1_closure_attempt_06_campaign_run`;
...
- winning mean component MAE: `0.001974`;
- winning mean component RMSE: `0.002703`;
...
| --- | --- | ---: | ---: | --- |
| `LGBM` | `paper_reference_grid_search` | 5 | 0.747203 | `{'estimator__learning_rate': 0.39, 'estimator__max_depth': 14, 'estimator__num_leaves': 31, 'estimator__subsample': 0.001}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `LGBM` | `LGBMRegressor` | `paper_reference_grid_search` | 21.935 | 0.001974 | 0.002703 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_1` | `LGBM` | `LGBMRegressor` | 21.935 | 0.001974 | 0.002703 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_1` | `RF / LGBM` | `LGBM` | 21.935 | `matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/lgbm/2026-04-19-09-25-12__track1_lgbm_phase_1_closure_attempt_06_campaign_run/onnx_export`;
