...
- run name: `track1_mlp_amplitude_156_final_closure_attempt_54`;
- output run name: `track1_mlp_amplitude_156_final_closure_attempt_54_campaign_run`;
- run instance id: `2026-04-22-00-10-15__track1_mlp_amplitude_156_final_closure_attempt_54_campaign_run`;
...
- winning mean component MAPE: `11901.528%`;
- winning mean component MAE: `0.011951`;
- winning mean component RMSE: `0.019924`;
...
| --- | --- | ---: | ---: | --- |
| `MLP` | `paper_reference_grid_search` | 5 | -474.470165 | `{'estimator__activation': 'tanh', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (200, 50), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `MLP` | `MLPRegressor` | `paper_reference_grid_search` | 11901.528 | 0.011951 | 0.019924 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_156` | `MLP` | `MLPRegressor` | 11901.528 | 0.011951 | 0.019924 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_156` | `ERT / RF` | `MLP` | 11901.528 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/mlp/2026-04-22-00-10-15__track1_mlp_amplitude_156_final_closure_attempt_54_campaign_run/onnx_export`;
