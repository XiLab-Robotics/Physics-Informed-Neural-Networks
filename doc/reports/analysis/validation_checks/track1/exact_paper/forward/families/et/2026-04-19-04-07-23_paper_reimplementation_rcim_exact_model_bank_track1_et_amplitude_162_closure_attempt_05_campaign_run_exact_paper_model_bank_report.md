...
- run name: `track1_et_amplitude_162_closure_attempt_05`;
- output run name: `track1_et_amplitude_162_closure_attempt_05_campaign_run`;
- run instance id: `2026-04-19-04-07-15__track1_et_amplitude_162_closure_attempt_05_campaign_run`;
...
- winning mean component MAPE: `12.163%`;
...
| --- | --- | ---: | ---: | --- |
| `ET` | `paper_reference_grid_search` | 5 | 0.978919 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 15, 'estimator__min_samples_split': 2}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ET` | `ExtraTreeRegressor` | `paper_reference_grid_search` | 12.163 | 0.000079 | 0.000294 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_162` | `ET` | `ExtraTreeRegressor` | 12.163 | 0.000079 | 0.000294 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_162` | `ERT` | `ET` | 12.163 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/et/2026-04-19-04-07-15__track1_et_amplitude_162_closure_attempt_05_campaign_run/onnx_export`;
