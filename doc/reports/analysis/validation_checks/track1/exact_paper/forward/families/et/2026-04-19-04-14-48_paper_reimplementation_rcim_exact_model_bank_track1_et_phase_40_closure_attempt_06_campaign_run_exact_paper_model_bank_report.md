...
- run name: `track1_et_phase_40_closure_attempt_06`;
- output run name: `track1_et_phase_40_closure_attempt_06_campaign_run`;
- run instance id: `2026-04-19-04-14-40__track1_et_phase_40_closure_attempt_06_campaign_run`;
...
- winning mean component MAPE: `83.313%`;
- winning mean component MAE: `0.047910`;
- winning mean component RMSE: `0.072368`;
...
| --- | --- | ---: | ---: | --- |
| `ET` | `paper_reference_grid_search` | 5 | 0.605697 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 15, 'estimator__min_samples_split': 5}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ET` | `ExtraTreeRegressor` | `paper_reference_grid_search` | 83.313 | 0.047910 | 0.072368 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_40` | `ET` | `ExtraTreeRegressor` | 83.313 | 0.047910 | 0.072368 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_40` | `ERT / GBM` | `ET` | 83.313 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/et/2026-04-19-04-14-40__track1_et_phase_40_closure_attempt_06_campaign_run/onnx_export`;
