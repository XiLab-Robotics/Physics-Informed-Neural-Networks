...
- run name: `track1_dt_phase_156_closure_attempt_02`;
- output run name: `track1_dt_phase_156_closure_attempt_02_campaign_run`;
- run instance id: `2026-04-19-03-39-24__track1_dt_phase_156_closure_attempt_02_campaign_run`;
...
- winning best params: `{'estimator__criterion': 'absolute_error', 'estimator__max_depth': 15, 'estimator__min_samples_split': 7}`;
- winning mean component MAPE: `39.001%`;
- winning mean component MAE: `0.518283`;
- winning mean component RMSE: `1.346288`;
...
| --- | --- | ---: | ---: | --- |
| `DT` | `paper_reference_grid_search` | 5 | 0.650595 | `{'estimator__criterion': 'absolute_error', 'estimator__max_depth': 15, 'estimator__min_samples_split': 7}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `DT` | `DecisionTreeRegressor` | `paper_reference_grid_search` | 39.001 | 0.518283 | 1.346288 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_156` | `DT` | `DecisionTreeRegressor` | 39.001 | 0.518283 | 1.346288 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_156` | `ERT / RF` | `DT` | 39.001 | `not_matched_expected_family_direction` |
...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `156` | `-` | `-` | `-` | `RF` | `DT` | `DT` | `above_paper_target` | `above_paper_target` | `not_yet_matched_tables_3_6` |

## ONNX Export Surface

- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/dt/2026-04-19-03-39-24__track1_dt_phase_156_closure_attempt_02_campaign_run/onnx_export`;
