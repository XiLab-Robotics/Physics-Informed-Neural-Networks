...
- run name: `track1_dt_phase_1_closure_attempt_15`;
- output run name: `track1_dt_phase_1_closure_attempt_15_campaign_run`;
- run instance id: `2026-04-21-10-05-30__track1_dt_phase_1_closure_attempt_15_campaign_run`;
...
- winning mean component MAPE: `41.650%`;
- winning mean component MAE: `0.002198`;
- winning mean component RMSE: `0.003511`;
...
| --- | --- | ---: | ---: | --- |
| `DT` | `paper_reference_grid_search` | 5 | 0.728878 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 8}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `DT` | `DecisionTreeRegressor` | `paper_reference_grid_search` | 41.650 | 0.002198 | 0.003511 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_1` | `DT` | `DecisionTreeRegressor` | 41.650 | 0.002198 | 0.003511 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_1` | `RF / LGBM` | `DT` | 41.650 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/dt/2026-04-21-10-05-30__track1_dt_phase_1_closure_attempt_15_campaign_run/onnx_export`;
