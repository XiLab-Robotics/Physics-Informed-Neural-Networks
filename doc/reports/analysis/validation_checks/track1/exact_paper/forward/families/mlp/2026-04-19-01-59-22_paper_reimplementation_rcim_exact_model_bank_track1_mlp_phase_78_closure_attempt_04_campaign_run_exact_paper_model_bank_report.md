...
- run name: `track1_mlp_phase_78_closure_attempt_04`;
- output run name: `track1_mlp_phase_78_closure_attempt_04_campaign_run`;
- run instance id: `2026-04-19-01-59-12__track1_mlp_phase_78_closure_attempt_04_campaign_run`;
...
- winning mean component MAPE: `844.078%`;
- winning mean component MAE: `0.200309`;
- winning mean component RMSE: `0.276731`;
...
| --- | --- | ---: | ---: | --- |
| `MLP` | `paper_reference_grid_search` | 5 | 0.684573 | `{'estimator__activation': 'tanh', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (200, 50), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `MLP` | `MLPRegressor` | `paper_reference_grid_search` | 844.078 | 0.200309 | 0.276731 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_78` | `MLP` | `MLPRegressor` | 844.078 | 0.200309 | 0.276731 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_78` | `HGBM / RF` | `MLP` | 844.078 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/mlp/2026-04-19-01-59-12__track1_mlp_phase_78_closure_attempt_04_campaign_run/onnx_export`;
