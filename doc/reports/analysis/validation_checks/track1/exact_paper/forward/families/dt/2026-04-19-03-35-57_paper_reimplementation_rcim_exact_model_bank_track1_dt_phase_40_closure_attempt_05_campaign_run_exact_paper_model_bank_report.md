...
- run name: `track1_dt_phase_40_closure_attempt_05`;
- output run name: `track1_dt_phase_40_closure_attempt_05_campaign_run`;
- run instance id: `2026-04-19-03-35-49__track1_dt_phase_40_closure_attempt_05_campaign_run`;
...
- winning mean component MAPE: `50.833%`;
- winning mean component MAE: `0.040093`;
- winning mean component RMSE: `0.052024`;
...
| --- | --- | ---: | ---: | --- |
| `DT` | `paper_reference_grid_search` | 5 | 0.674765 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 6}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `DT` | `DecisionTreeRegressor` | `paper_reference_grid_search` | 50.833 | 0.040093 | 0.052024 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_40` | `DT` | `DecisionTreeRegressor` | 50.833 | 0.040093 | 0.052024 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_40` | `ERT / GBM` | `DT` | 50.833 | `not_matched_expected_family_direction` |
...
| `Repo Best Family` | - | - | - | `DT` | - | - | - | - | - |
| `Repo Best RMSE` | - | - | - | 0.0520 | - | - | - | - | - |
| `Paper Best Family` | - | - | - | `GBM` | - | - | - | - | - |
| `Paper Target RMSE` | - | - | - | 0.0550 | - | - | - | - | - |
| `Gap Vs Paper` | - | - | - | -0.002976 | - | - | - | - | - |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/dt/2026-04-19-03-35-49__track1_dt_phase_40_closure_attempt_05_campaign_run/onnx_export`;
