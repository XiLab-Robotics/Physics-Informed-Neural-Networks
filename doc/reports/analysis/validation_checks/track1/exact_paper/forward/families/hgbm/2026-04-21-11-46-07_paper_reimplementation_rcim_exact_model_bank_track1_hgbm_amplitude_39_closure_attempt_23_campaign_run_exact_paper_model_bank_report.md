...
- run name: `track1_hgbm_amplitude_39_closure_attempt_23`;
- output run name: `track1_hgbm_amplitude_39_closure_attempt_23_campaign_run`;
- run instance id: `2026-04-21-11-45-54__track1_hgbm_amplitude_39_closure_attempt_23_campaign_run`;
...
- winning mean component MAPE: `2.243%`;
...
| --- | --- | ---: | ---: | --- |
| `HGBM` | `paper_reference_grid_search` | 5 | 0.986663 | `{'estimator__learning_rate': 0.2, 'estimator__max_depth': 12, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 24}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `HGBM` | `HistGradientBoostingRegressor` | `paper_reference_grid_search` | 2.243 | 0.000024 | 0.000034 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_39` | `HGBM` | `HistGradientBoostingRegressor` | 2.243 | 0.000024 | 0.000034 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_39` | `HGBM` | `HGBM` | 2.243 | `matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/hgbm/2026-04-21-11-45-54__track1_hgbm_amplitude_39_closure_attempt_23_campaign_run/onnx_export`;
