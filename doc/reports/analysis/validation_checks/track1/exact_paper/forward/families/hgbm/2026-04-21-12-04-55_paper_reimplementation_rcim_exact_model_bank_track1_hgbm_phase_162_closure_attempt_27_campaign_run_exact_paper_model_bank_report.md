...
- run name: `track1_hgbm_phase_162_closure_attempt_27`;
- output run name: `track1_hgbm_phase_162_closure_attempt_27_campaign_run`;
- run instance id: `2026-04-21-12-04-42__track1_hgbm_phase_162_closure_attempt_27_campaign_run`;
...
- winning mean component MAPE: `19.543%`;
- winning mean component MAE: `0.464507`;
- winning mean component RMSE: `0.976603`;
...
| --- | --- | ---: | ---: | --- |
| `HGBM` | `paper_reference_grid_search` | 5 | 0.660770 | `{'estimator__learning_rate': 0.22, 'estimator__max_depth': 12, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 24}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `HGBM` | `HistGradientBoostingRegressor` | `paper_reference_grid_search` | 19.543 | 0.464507 | 0.976603 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_162` | `HGBM` | `HistGradientBoostingRegressor` | 19.543 | 0.464507 | 0.976603 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_162` | `ERT` | `HGBM` | 19.543 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/hgbm/2026-04-21-12-04-42__track1_hgbm_phase_162_closure_attempt_27_campaign_run/onnx_export`;
