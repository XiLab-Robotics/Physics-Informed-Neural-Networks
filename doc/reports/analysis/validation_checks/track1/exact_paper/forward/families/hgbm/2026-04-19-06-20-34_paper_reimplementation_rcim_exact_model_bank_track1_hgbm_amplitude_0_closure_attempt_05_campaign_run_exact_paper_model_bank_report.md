...
- run name: `track1_hgbm_amplitude_0_closure_attempt_05`;
- output run name: `track1_hgbm_amplitude_0_closure_attempt_05_campaign_run`;
- run instance id: `2026-04-19-06-20-22__track1_hgbm_amplitude_0_closure_attempt_05_campaign_run`;
...
- winning mean component MAPE: `5.559%`;
- winning mean component MAE: `0.002453`;
- winning mean component RMSE: `0.003263`;
...
| --- | --- | ---: | ---: | --- |
| `HGBM` | `paper_reference_grid_search` | 5 | 0.974791 | `{'estimator__learning_rate': 0.21, 'estimator__max_depth': 13, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 25}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `HGBM` | `HistGradientBoostingRegressor` | `paper_reference_grid_search` | 5.559 | 0.002453 | 0.003263 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_0` | `HGBM` | `HistGradientBoostingRegressor` | 5.559 | 0.002453 | 0.003263 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_0` | `SVR` | `HGBM` | 5.559 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/hgbm/2026-04-19-06-20-22__track1_hgbm_amplitude_0_closure_attempt_05_campaign_run/onnx_export`;
