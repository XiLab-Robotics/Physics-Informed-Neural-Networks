...
- run name: `track1_dt_phase_1_closure_attempt_23`;
- output run name: `track1_dt_phase_1_closure_attempt_23_campaign_run`;
- run instance id: `2026-04-21-10-07-26__track1_dt_phase_1_closure_attempt_23_campaign_run`;
...
- winning mean component MAPE: `2054.193%`;
- winning mean component MAE: `0.002515`;
- winning mean component RMSE: `0.003497`;
...
| --- | --- | ---: | ---: | --- |
| `DT` | `paper_reference_grid_search` | 5 | 0.638692 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 7}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `DT` | `DecisionTreeRegressor` | `paper_reference_grid_search` | 2054.193 | 0.002515 | 0.003497 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_1` | `DT` | `DecisionTreeRegressor` | 2054.193 | 0.002515 | 0.003497 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_1` | `RF / LGBM` | `DT` | 2054.193 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/dt/2026-04-21-10-07-26__track1_dt_phase_1_closure_attempt_23_campaign_run/onnx_export`;
