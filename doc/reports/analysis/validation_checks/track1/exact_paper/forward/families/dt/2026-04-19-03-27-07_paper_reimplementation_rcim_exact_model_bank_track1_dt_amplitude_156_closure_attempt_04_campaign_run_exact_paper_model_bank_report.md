...
- run name: `track1_dt_amplitude_156_closure_attempt_04`;
- output run name: `track1_dt_amplitude_156_closure_attempt_04_campaign_run`;
- run instance id: `2026-04-19-03-27-00__track1_dt_amplitude_156_closure_attempt_04_campaign_run`;
...
- winning best params: `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 16, 'estimator__min_samples_split': 4}`;
- winning mean component MAPE: `22.785%`;
...
| --- | --- | ---: | ---: | --- |
| `DT` | `paper_reference_grid_search` | 5 | 0.973946 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 16, 'estimator__min_samples_split': 4}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `DT` | `DecisionTreeRegressor` | `paper_reference_grid_search` | 22.785 | 0.000074 | 0.000271 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_156` | `DT` | `DecisionTreeRegressor` | 22.785 | 0.000074 | 0.000271 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_156` | `ERT / RF` | `DT` | 22.785 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/dt/2026-04-19-03-27-00__track1_dt_amplitude_156_closure_attempt_04_campaign_run/onnx_export`;
