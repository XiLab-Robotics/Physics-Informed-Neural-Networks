...
- run name: `track1_hgbm_amplitude_162_closure_attempt_04`;
- output run name: `track1_hgbm_amplitude_162_closure_attempt_04_campaign_run`;
- run instance id: `2026-04-19-06-35-28__track1_hgbm_amplitude_162_closure_attempt_04_campaign_run`;
...
- winning best params: `{'estimator__learning_rate': 0.21, 'estimator__max_depth': 12, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 26}`;
- winning mean component MAPE: `20.454%`;
- winning mean component MAE: `0.000112`;
- winning mean component RMSE: `0.000342`;
...
| --- | --- | ---: | ---: | --- |
| `HGBM` | `paper_reference_grid_search` | 5 | 0.932078 | `{'estimator__learning_rate': 0.21, 'estimator__max_depth': 12, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 26}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `HGBM` | `HistGradientBoostingRegressor` | `paper_reference_grid_search` | 20.454 | 0.000112 | 0.000342 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_162` | `HGBM` | `HistGradientBoostingRegressor` | 20.454 | 0.000112 | 0.000342 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_162` | `ERT` | `HGBM` | 20.454 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/hgbm/2026-04-19-06-35-28__track1_hgbm_amplitude_162_closure_attempt_04_campaign_run/onnx_export`;
