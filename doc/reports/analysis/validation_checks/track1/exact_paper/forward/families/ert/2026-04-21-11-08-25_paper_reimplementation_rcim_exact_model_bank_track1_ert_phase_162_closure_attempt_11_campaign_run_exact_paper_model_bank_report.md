...
- run name: `track1_ert_phase_162_closure_attempt_11`;
- output run name: `track1_ert_phase_162_closure_attempt_11_campaign_run`;
- run instance id: `2026-04-21-11-08-07__track1_ert_phase_162_closure_attempt_11_campaign_run`;
...
- winning mean component MAPE: `9.615%`;
- winning mean component MAE: `0.261882`;
- winning mean component RMSE: `0.911115`;
...
| --- | --- | ---: | ---: | --- |
| `ERT` | `paper_reference_grid_search` | 5 | 0.780903 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 18, 'estimator__min_samples_split': 2, 'estimator__n_estimators': 20}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ERT` | `ExtraTreesRegressor` | `paper_reference_grid_search` | 9.615 | 0.261882 | 0.911115 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_162` | `ERT` | `ExtraTreesRegressor` | 9.615 | 0.261882 | 0.911115 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_162` | `ERT` | `ERT` | 9.615 | `matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/ert/2026-04-21-11-08-07__track1_ert_phase_162_closure_attempt_11_campaign_run/onnx_export`;
