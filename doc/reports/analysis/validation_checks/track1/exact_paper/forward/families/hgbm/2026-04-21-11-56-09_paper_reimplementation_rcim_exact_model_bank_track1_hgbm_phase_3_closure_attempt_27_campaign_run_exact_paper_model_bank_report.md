...
- run name: `track1_hgbm_phase_3_closure_attempt_27`;
- output run name: `track1_hgbm_phase_3_closure_attempt_27_campaign_run`;
- run instance id: `2026-04-21-11-55-56__track1_hgbm_phase_3_closure_attempt_27_campaign_run`;
...
- winning best params: `{'estimator__learning_rate': 0.19, 'estimator__max_depth': 9, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 24}`;
- winning mean component MAPE: `1.280%`;
- winning mean component MAE: `0.022815`;
- winning mean component RMSE: `0.029145`;
...
| --- | --- | ---: | ---: | --- |
| `HGBM` | `paper_reference_grid_search` | 5 | 0.935946 | `{'estimator__learning_rate': 0.19, 'estimator__max_depth': 9, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 24}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `HGBM` | `HistGradientBoostingRegressor` | `paper_reference_grid_search` | 1.280 | 0.022815 | 0.029145 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_3` | `HGBM` | `HistGradientBoostingRegressor` | 1.280 | 0.022815 | 0.029145 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_3` | `HGBM` | `HGBM` | 1.280 | `matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/hgbm/2026-04-21-11-55-56__track1_hgbm_phase_3_closure_attempt_27_campaign_run/onnx_export`;
