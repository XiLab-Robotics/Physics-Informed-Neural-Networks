...
- run name: `track1_hgbm_amplitude_78_closure_attempt_04`;
- output run name: `track1_hgbm_amplitude_78_closure_attempt_04_campaign_run`;
- run instance id: `2026-04-19-06-29-41__track1_hgbm_amplitude_78_closure_attempt_04_campaign_run`;
...
- winning mean component MAPE: `8.013%`;
...
| --- | --- | ---: | ---: | --- |
| `HGBM` | `paper_reference_grid_search` | 5 | 0.995478 | `{'estimator__learning_rate': 0.19, 'estimator__max_depth': 12, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 25}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `HGBM` | `HistGradientBoostingRegressor` | `paper_reference_grid_search` | 8.013 | 0.000028 | 0.000041 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_78` | `HGBM` | `HistGradientBoostingRegressor` | 8.013 | 0.000028 | 0.000041 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_78` | `HGBM / RF` | `HGBM` | 8.013 | `matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/hgbm/2026-04-19-06-29-41__track1_hgbm_amplitude_78_closure_attempt_04_campaign_run/onnx_export`;
