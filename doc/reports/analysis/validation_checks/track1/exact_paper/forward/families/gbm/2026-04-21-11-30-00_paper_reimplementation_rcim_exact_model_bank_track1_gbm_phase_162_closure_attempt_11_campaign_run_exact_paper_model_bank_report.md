...
- run name: `track1_gbm_phase_162_closure_attempt_11`;
- output run name: `track1_gbm_phase_162_closure_attempt_11_campaign_run`;
- run instance id: `2026-04-21-11-29-46__track1_gbm_phase_162_closure_attempt_11_campaign_run`;
...
- winning mean component MAPE: `14.802%`;
- winning mean component MAE: `0.374779`;
- winning mean component RMSE: `1.190390`;
...
| --- | --- | ---: | ---: | --- |
| `GBM` | `paper_reference_grid_search` | 5 | 0.696783 | `{'estimator__criterion': 'squared_error', 'estimator__learning_rate': 0.1, 'estimator__max_depth': 14, 'estimator__min_samples_split': 18, 'estimator__n_estimators': 84}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `GBM` | `GradientBoostingRegressor` | `paper_reference_grid_search` | 14.802 | 0.374779 | 1.190390 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_162` | `GBM` | `GradientBoostingRegressor` | 14.802 | 0.374779 | 1.190390 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_162` | `ERT` | `GBM` | 14.802 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/gbm/2026-04-21-11-29-46__track1_gbm_phase_162_closure_attempt_11_campaign_run/onnx_export`;
