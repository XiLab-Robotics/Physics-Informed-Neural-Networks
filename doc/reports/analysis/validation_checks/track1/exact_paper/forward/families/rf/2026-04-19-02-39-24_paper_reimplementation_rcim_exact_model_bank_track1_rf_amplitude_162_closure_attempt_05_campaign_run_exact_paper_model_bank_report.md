...
- run name: `track1_rf_amplitude_162_closure_attempt_05`;
- output run name: `track1_rf_amplitude_162_closure_attempt_05_campaign_run`;
- run instance id: `2026-04-19-02-39-06__track1_rf_amplitude_162_closure_attempt_05_campaign_run`;
...
- winning mean component MAPE: `7.915%`;
- winning mean component MAE: `0.000047`;
- winning mean component RMSE: `0.000151`;
...
| --- | --- | ---: | ---: | --- |
| `RF` | `paper_reference_grid_search` | 5 | 0.983245 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 2, 'estimator__n_estimators': 80}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `RF` | `RandomForestRegressor` | `paper_reference_grid_search` | 7.915 | 0.000047 | 0.000151 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_162` | `RF` | `RandomForestRegressor` | 7.915 | 0.000047 | 0.000151 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_162` | `ERT` | `RF` | 7.915 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/rf/2026-04-19-02-39-06__track1_rf_amplitude_162_closure_attempt_05_campaign_run/onnx_export`;
