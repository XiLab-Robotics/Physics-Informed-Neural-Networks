...
- run name: `track1_mlp_phase_78_closure_attempt_06`;
- output run name: `track1_mlp_phase_78_closure_attempt_06_campaign_run`;
- run instance id: `2026-04-19-01-59-45__track1_mlp_phase_78_closure_attempt_06_campaign_run`;
...
- winning mean component MAPE: `970.775%`;
- winning mean component MAE: `0.168938`;
- winning mean component RMSE: `0.259806`;
...
| --- | --- | ---: | ---: | --- |
| `MLP` | `paper_reference_grid_search` | 5 | 0.610676 | `{'estimator__activation': 'tanh', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (200, 50), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `MLP` | `MLPRegressor` | `paper_reference_grid_search` | 970.775 | 0.168938 | 0.259806 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_78` | `MLP` | `MLPRegressor` | 970.775 | 0.168938 | 0.259806 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_78` | `HGBM / RF` | `MLP` | 970.775 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/mlp/2026-04-19-01-59-45__track1_mlp_phase_78_closure_attempt_06_campaign_run/onnx_export`;
