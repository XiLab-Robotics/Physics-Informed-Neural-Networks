...
- run name: `track1_xgbm_amplitude_39_closure_attempt_01`;
- output run name: `track1_xgbm_amplitude_39_closure_attempt_01_campaign_run`;
- run instance id: `2026-04-19-07-11-43__track1_xgbm_amplitude_39_closure_attempt_01_campaign_run`;
...
- winning mean component MAPE: `8.947%`;
- winning mean component MAE: `0.000094`;
...
| --- | --- | ---: | ---: | --- |
| `XGBM` | `paper_reference_grid_search` | 5 | 0.803834 | `{'estimator__colsample_bytree': 0.3, 'estimator__learning_rate': 0.5, 'estimator__max_depth': 14}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `XGBM` | `XGBRegressor` | `paper_reference_grid_search` | 8.947 | 0.000094 | 0.000124 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_39` | `XGBM` | `XGBRegressor` | 8.947 | 0.000094 | 0.000124 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_39` | `HGBM` | `XGBM` | 8.947 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/xgbm/2026-04-19-07-11-43__track1_xgbm_amplitude_39_closure_attempt_01_campaign_run/onnx_export`;
