...
- run name: `track1_lgbm_phase_81_closure_attempt_04`;
- output run name: `track1_lgbm_phase_81_closure_attempt_04_campaign_run`;
- run instance id: `2026-04-19-10-07-15__track1_lgbm_phase_81_closure_attempt_04_campaign_run`;
...
- winning mean component MAPE: `4.609%`;
- winning mean component MAE: `0.053924`;
- winning mean component RMSE: `0.071916`;
...
| --- | --- | ---: | ---: | --- |
| `LGBM` | `paper_reference_grid_search` | 5 | 0.968951 | `{'estimator__learning_rate': 0.39, 'estimator__max_depth': 10, 'estimator__num_leaves': 31, 'estimator__subsample': 0.001}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `LGBM` | `LGBMRegressor` | `paper_reference_grid_search` | 4.609 | 0.053924 | 0.071916 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_81` | `LGBM` | `LGBMRegressor` | 4.609 | 0.053924 | 0.071916 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_81` | `RF` | `LGBM` | 4.609 | `not_matched_expected_family_direction` |
...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `81` | `-` | `-` | `-` | `RF` | `LGBM` | `LGBM` | `above_paper_target` | `met_paper_target` | `partially_matched_tables_3_6` |

## ONNX Export Surface

- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/lgbm/2026-04-19-10-07-15__track1_lgbm_phase_81_closure_attempt_04_campaign_run/onnx_export`;
