...
- run instance id: `2026-04-21-12-46-11__track1_lgbm_phase_162_closure_attempt_03_campaign_run`;
...
- winning mean component MAPE: `15.054%`;
- winning mean component MAE: `0.334514`;
- winning mean component RMSE: `0.780181`;
...
| --- | --- | ---: | ---: | --- |
| `LGBM` | `paper_reference_grid_search` | 5 | 0.698323 | `{'estimator__learning_rate': 0.77, 'estimator__max_depth': 12, 'estimator__num_leaves': 31, 'estimator__subsample': 0.001}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `LGBM` | `LGBMRegressor` | `paper_reference_grid_search` | 15.054 | 0.334514 | 0.780181 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_162` | `LGBM` | `LGBMRegressor` | 15.054 | 0.334514 | 0.780181 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_162` | `ERT` | `LGBM` | 15.054 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/lgbm/2026-04-21-12-46-11__track1_lgbm_phase_162_closure_attempt_03_campaign_run/onnx_export`;
