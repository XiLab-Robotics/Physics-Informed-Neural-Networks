...
- run name: `track1_mlp_amplitude_156_final_closure_attempt_07`;
- output run name: `track1_mlp_amplitude_156_final_closure_attempt_07_campaign_run`;
- run instance id: `2026-04-21-23-57-15__track1_mlp_amplitude_156_final_closure_attempt_07_campaign_run`;
...
- winning mean component MAPE: `9700.681%`;
- winning mean component MAE: `0.011348`;
- winning mean component RMSE: `0.017834`;
...
| --- | --- | ---: | ---: | --- |
| `MLP` | `paper_reference_grid_search` | 5 | -178.642977 | `{'estimator__activation': 'tanh', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (200, 50), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `MLP` | `MLPRegressor` | `paper_reference_grid_search` | 9700.681 | 0.011348 | 0.017834 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_156` | `MLP` | `MLPRegressor` | 9700.681 | 0.011348 | 0.017834 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_156` | `ERT / RF` | `MLP` | 9700.681 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/mlp/2026-04-21-23-57-15__track1_mlp_amplitude_156_final_closure_attempt_07_campaign_run/onnx_export`;
