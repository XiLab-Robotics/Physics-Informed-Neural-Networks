...
- run name: `track1_mlp_phase_162_final_closure_attempt_53`;
- output run name: `track1_mlp_phase_162_final_closure_attempt_53_campaign_run`;
- run instance id: `2026-04-22-00-39-04__track1_mlp_phase_162_final_closure_attempt_53_campaign_run`;
...
- winning mean component MAPE: `62.248%`;
- winning mean component MAE: `1.227466`;
- winning mean component RMSE: `1.528735`;
...
| --- | --- | ---: | ---: | --- |
| `MLP` | `paper_reference_grid_search` | 5 | 0.148890 | `{'estimator__activation': 'tanh', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (200, 50), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `MLP` | `MLPRegressor` | `paper_reference_grid_search` | 62.248 | 1.227466 | 1.528735 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_162` | `MLP` | `MLPRegressor` | 62.248 | 1.227466 | 1.528735 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_162` | `ERT` | `MLP` | 62.248 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/mlp/2026-04-22-00-39-04__track1_mlp_phase_162_final_closure_attempt_53_campaign_run/onnx_export`;
