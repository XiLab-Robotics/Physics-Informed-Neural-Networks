...
- run name: `track1_dt_amplitude_0_closure_attempt_06`;
- output run name: `track1_dt_amplitude_0_closure_attempt_06_campaign_run`;
- run instance id: `2026-04-19-03-17-27__track1_dt_amplitude_0_closure_attempt_06_campaign_run`;
...
- winning mean component MAPE: `13.190%`;
- winning mean component MAE: `0.003433`;
- winning mean component RMSE: `0.004666`;
...
| --- | --- | ---: | ---: | --- |
| `DT` | `paper_reference_grid_search` | 5 | 0.960972 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 8}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `DT` | `DecisionTreeRegressor` | `paper_reference_grid_search` | 13.190 | 0.003433 | 0.004666 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_0` | `DT` | `DecisionTreeRegressor` | 13.190 | 0.003433 | 0.004666 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_0` | `SVR` | `DT` | 13.190 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/dt/2026-04-19-03-17-27__track1_dt_amplitude_0_closure_attempt_06_campaign_run/onnx_export`;
