...
- run name: `track1_xgbm_amplitude_78_closure_attempt_05`;
- output run name: `track1_xgbm_amplitude_78_closure_attempt_05_campaign_run`;
- run instance id: `2026-04-19-07-15-38__track1_xgbm_amplitude_78_closure_attempt_05_campaign_run`;
...
- winning mean component MAPE: `46.550%`;
...
| --- | --- | ---: | ---: | --- |
| `XGBM` | `paper_reference_grid_search` | 5 | 0.927663 | `{'estimator__colsample_bytree': 0.8, 'estimator__learning_rate': 0.3, 'estimator__max_depth': 14}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `XGBM` | `XGBRegressor` | `paper_reference_grid_search` | 46.550 | 0.000104 | 0.000139 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_78` | `XGBM` | `XGBRegressor` | 46.550 | 0.000104 | 0.000139 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_78` | `HGBM / RF` | `XGBM` | 46.550 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/xgbm/2026-04-19-07-15-38__track1_xgbm_amplitude_78_closure_attempt_05_campaign_run/onnx_export`;
