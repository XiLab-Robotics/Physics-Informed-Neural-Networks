...
- run name: `track1_et_phase_78_closure_attempt_03`;
- output run name: `track1_et_phase_78_closure_attempt_03_campaign_run`;
- run instance id: `2026-04-19-04-15-23__track1_et_phase_78_closure_attempt_03_campaign_run`;
...
- winning mean component MAPE: `79.417%`;
- winning mean component MAE: `0.143447`;
- winning mean component RMSE: `0.411230`;
...
| --- | --- | ---: | ---: | --- |
| `ET` | `paper_reference_grid_search` | 5 | 0.693676 | `{'estimator__criterion': 'absolute_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 5}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ET` | `ExtraTreeRegressor` | `paper_reference_grid_search` | 79.417 | 0.143447 | 0.411230 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_78` | `ET` | `ExtraTreeRegressor` | 79.417 | 0.143447 | 0.411230 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_78` | `HGBM / RF` | `ET` | 79.417 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/et/2026-04-19-04-15-23__track1_et_phase_78_closure_attempt_03_campaign_run/onnx_export`;
