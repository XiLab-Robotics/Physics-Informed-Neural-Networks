...
- run name: `track1_dt_phase_1_closure_attempt_06`;
- output run name: `track1_dt_phase_1_closure_attempt_06_campaign_run`;
- run instance id: `2026-04-19-03-31-46__track1_dt_phase_1_closure_attempt_06_campaign_run`;
...
- winning mean component MAPE: `31.490%`;
- winning mean component MAE: `0.002182`;
- winning mean component RMSE: `0.002994`;
...
| --- | --- | ---: | ---: | --- |
| `DT` | `paper_reference_grid_search` | 5 | 0.597862 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 8}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `DT` | `DecisionTreeRegressor` | `paper_reference_grid_search` | 31.490 | 0.002182 | 0.002994 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_1` | `DT` | `DecisionTreeRegressor` | 31.490 | 0.002182 | 0.002994 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_1` | `RF / LGBM` | `DT` | 31.490 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/dt/2026-04-19-03-31-46__track1_dt_phase_1_closure_attempt_06_campaign_run/onnx_export`;
