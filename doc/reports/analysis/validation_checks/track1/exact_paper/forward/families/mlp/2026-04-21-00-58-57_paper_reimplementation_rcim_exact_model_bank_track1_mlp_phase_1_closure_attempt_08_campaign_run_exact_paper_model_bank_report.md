...
- run name: `track1_mlp_phase_1_closure_attempt_08`;
- output run name: `track1_mlp_phase_1_closure_attempt_08_campaign_run`;
- run instance id: `2026-04-21-00-58-48__track1_mlp_phase_1_closure_attempt_08_campaign_run`;
...
- winning mean component MAPE: `271.562%`;
- winning mean component MAE: `0.011611`;
- winning mean component RMSE: `0.018935`;
...
| --- | --- | ---: | ---: | --- |
| `MLP` | `paper_reference_grid_search` | 5 | -17.770529 | `{'estimator__activation': 'tanh', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (200, 50), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `MLP` | `MLPRegressor` | `paper_reference_grid_search` | 271.562 | 0.011611 | 0.018935 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_1` | `MLP` | `MLPRegressor` | 271.562 | 0.011611 | 0.018935 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_1` | `RF / LGBM` | `MLP` | 271.562 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/mlp/2026-04-21-00-58-48__track1_mlp_phase_1_closure_attempt_08_campaign_run/onnx_export`;
