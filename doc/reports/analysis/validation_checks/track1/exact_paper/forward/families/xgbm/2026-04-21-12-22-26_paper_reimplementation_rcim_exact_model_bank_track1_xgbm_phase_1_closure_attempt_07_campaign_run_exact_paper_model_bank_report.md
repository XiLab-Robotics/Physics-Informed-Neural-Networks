...
- run name: `track1_xgbm_phase_1_closure_attempt_07`;
- output run name: `track1_xgbm_phase_1_closure_attempt_07_campaign_run`;
- run instance id: `2026-04-21-12-22-17__track1_xgbm_phase_1_closure_attempt_07_campaign_run`;
...
- winning mean component MAPE: `28.814%`;
- winning mean component MAE: `0.002132`;
- winning mean component RMSE: `0.002998`;
...
| --- | --- | ---: | ---: | --- |
| `XGBM` | `paper_reference_grid_search` | 5 | 0.718712 | `{'estimator__colsample_bytree': 0.8, 'estimator__learning_rate': 0.2, 'estimator__max_depth': 14}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `XGBM` | `XGBRegressor` | `paper_reference_grid_search` | 28.814 | 0.002132 | 0.002998 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_1` | `XGBM` | `XGBRegressor` | 28.814 | 0.002132 | 0.002998 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_1` | `RF / LGBM` | `XGBM` | 28.814 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/xgbm/2026-04-21-12-22-17__track1_xgbm_phase_1_closure_attempt_07_campaign_run/onnx_export`;
