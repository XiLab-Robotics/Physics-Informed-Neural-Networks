...
- run name: `track1_mlp_amplitude_3_closure_attempt_17`;
- output run name: `track1_mlp_amplitude_3_closure_attempt_17_campaign_run`;
- run instance id: `2026-04-21-20-16-33__track1_mlp_amplitude_3_closure_attempt_17_campaign_run`;
...
- winning mean component MAPE: `1063.660%`;
- winning mean component MAE: `0.007764`;
- winning mean component RMSE: `0.015550`;
...
| --- | --- | ---: | ---: | --- |
| `MLP` | `paper_reference_grid_search` | 5 | -13015.307732 | `{'estimator__activation': 'tanh', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (200, 50), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `MLP` | `MLPRegressor` | `paper_reference_grid_search` | 1063.660 | 0.007764 | 0.015550 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_3` | `MLP` | `MLPRegressor` | 1063.660 | 0.007764 | 0.015550 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_3` | `HGBM` | `MLP` | 1063.660 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/mlp/2026-04-21-20-16-33__track1_mlp_amplitude_3_closure_attempt_17_campaign_run/onnx_export`;
