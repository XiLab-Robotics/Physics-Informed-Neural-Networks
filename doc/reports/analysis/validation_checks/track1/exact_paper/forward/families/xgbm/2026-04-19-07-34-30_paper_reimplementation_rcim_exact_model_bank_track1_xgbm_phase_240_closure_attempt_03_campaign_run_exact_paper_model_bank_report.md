...
- run name: `track1_xgbm_phase_240_closure_attempt_03`;
- output run name: `track1_xgbm_phase_240_closure_attempt_03_campaign_run`;
- run instance id: `2026-04-19-07-34-22__track1_xgbm_phase_240_closure_attempt_03_campaign_run`;
...
- winning mean component MAPE: `27.246%`;
- winning mean component MAE: `0.341097`;
- winning mean component RMSE: `0.673430`;
...
| --- | --- | ---: | ---: | --- |
| `XGBM` | `paper_reference_grid_search` | 5 | 0.580982 | `{'estimator__colsample_bytree': 0.8, 'estimator__learning_rate': 0.2, 'estimator__max_depth': 16}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `XGBM` | `XGBRegressor` | `paper_reference_grid_search` | 27.246 | 0.341097 | 0.673430 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_240` | `XGBM` | `XGBRegressor` | 27.246 | 0.341097 | 0.673430 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_240` | `ERT` | `XGBM` | 27.246 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/xgbm/2026-04-19-07-34-22__track1_xgbm_phase_240_closure_attempt_03_campaign_run/onnx_export`;
