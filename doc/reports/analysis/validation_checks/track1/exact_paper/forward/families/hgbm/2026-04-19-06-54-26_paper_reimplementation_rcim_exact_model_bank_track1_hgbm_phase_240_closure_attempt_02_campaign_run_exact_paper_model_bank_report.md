...
- run name: `track1_hgbm_phase_240_closure_attempt_02`;
- output run name: `track1_hgbm_phase_240_closure_attempt_02_campaign_run`;
- run instance id: `2026-04-19-06-54-13__track1_hgbm_phase_240_closure_attempt_02_campaign_run`;
...
- winning mean component MAPE: `85.378%`;
- winning mean component MAE: `0.368595`;
- winning mean component RMSE: `0.742093`;
...
| --- | --- | ---: | ---: | --- |
| `HGBM` | `paper_reference_grid_search` | 5 | 0.518053 | `{'estimator__learning_rate': 0.18, 'estimator__max_depth': 12, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 25}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `HGBM` | `HistGradientBoostingRegressor` | `paper_reference_grid_search` | 85.378 | 0.368595 | 0.742093 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_240` | `HGBM` | `HistGradientBoostingRegressor` | 85.378 | 0.368595 | 0.742093 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_240` | `ERT` | `HGBM` | 85.378 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/hgbm/2026-04-19-06-54-13__track1_hgbm_phase_240_closure_attempt_02_campaign_run/onnx_export`;
