...
- run name: `track1_dt_amplitude_0_closure_attempt_01`;
- output run name: `track1_dt_amplitude_0_closure_attempt_01_campaign_run`;
- run instance id: `2026-04-19-03-16-16__track1_dt_amplitude_0_closure_attempt_01_campaign_run`;
...
- winning mean component MAPE: `14.748%`;
- winning mean component MAE: `0.003478`;
- winning mean component RMSE: `0.004807`;
...
| --- | --- | ---: | ---: | --- |
| `DT` | `paper_reference_grid_search` | 5 | 0.959193 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 8}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `DT` | `DecisionTreeRegressor` | `paper_reference_grid_search` | 14.748 | 0.003478 | 0.004807 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_0` | `DT` | `DecisionTreeRegressor` | 14.748 | 0.003478 | 0.004807 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_0` | `SVR` | `DT` | 14.748 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/dt/2026-04-19-03-16-16__track1_dt_amplitude_0_closure_attempt_01_campaign_run/onnx_export`;
