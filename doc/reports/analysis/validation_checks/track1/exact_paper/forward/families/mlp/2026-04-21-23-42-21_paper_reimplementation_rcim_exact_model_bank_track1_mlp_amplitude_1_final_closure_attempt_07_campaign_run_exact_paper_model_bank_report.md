...
- run name: `track1_mlp_amplitude_1_final_closure_attempt_07`;
- output run name: `track1_mlp_amplitude_1_final_closure_attempt_07_campaign_run`;
- run instance id: `2026-04-21-23-42-10__track1_mlp_amplitude_1_final_closure_attempt_07_campaign_run`;
...
- winning mean component MAPE: `30.489%`;
- winning mean component MAE: `0.005240`;
- winning mean component RMSE: `0.009274`;
...
| --- | --- | ---: | ---: | --- |
| `MLP` | `paper_reference_grid_search` | 5 | -160110.577323 | `{'estimator__activation': 'tanh', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (200, 50), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `MLP` | `MLPRegressor` | `paper_reference_grid_search` | 30.489 | 0.005240 | 0.009274 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_1` | `MLP` | `MLPRegressor` | 30.489 | 0.005240 | 0.009274 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_1` | `RF / LGBM` | `MLP` | 30.489 | `not_matched_expected_family_direction` |
...
| `Repo Best RMSE` | - | 0.009274 | - | - | - | - | - | - | - | - |
| `Paper Best Family` | - | `RF` | - | - | - | - | - | - | - | - |
| `Paper Target RMSE` | - | 3.50e-05 | - | - | - | - | - | - | - | - |
| `Gap Vs Paper` | - | 0.009239 | - | - | - | - | - | - | - | - |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/mlp/2026-04-21-23-42-10__track1_mlp_amplitude_1_final_closure_attempt_07_campaign_run/onnx_export`;
