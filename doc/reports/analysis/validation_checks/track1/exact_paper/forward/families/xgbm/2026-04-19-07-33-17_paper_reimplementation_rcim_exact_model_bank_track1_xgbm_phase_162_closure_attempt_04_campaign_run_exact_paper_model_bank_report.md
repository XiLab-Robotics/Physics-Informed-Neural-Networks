...
- run instance id: `2026-04-19-07-33-08__track1_xgbm_phase_162_closure_attempt_04_campaign_run`;
...
- winning mean component MAPE: `24.142%`;
- winning mean component MAE: `0.553569`;
- winning mean component RMSE: `1.044222`;
...
| --- | --- | ---: | ---: | --- |
| `XGBM` | `paper_reference_grid_search` | 5 | 0.640057 | `{'estimator__colsample_bytree': 0.8, 'estimator__learning_rate': 0.2, 'estimator__max_depth': 18}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `XGBM` | `XGBRegressor` | `paper_reference_grid_search` | 24.142 | 0.553569 | 1.044222 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_162` | `XGBM` | `XGBRegressor` | 24.142 | 0.553569 | 1.044222 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_162` | `ERT` | `XGBM` | 24.142 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/xgbm/2026-04-19-07-33-08__track1_xgbm_phase_162_closure_attempt_04_campaign_run/onnx_export`;
