...
- run name: `track1_hgbm_amplitude_3_closure_attempt_04`;
- output run name: `track1_hgbm_amplitude_3_closure_attempt_04_campaign_run`;
- run instance id: `2026-04-19-06-23-54__track1_hgbm_amplitude_3_closure_attempt_04_campaign_run`;
...
- winning mean component MAPE: `2.059%`;
- winning mean component MAE: `0.000016`;
- winning mean component RMSE: `0.000021`;
...
| --- | --- | ---: | ---: | --- |
| `HGBM` | `paper_reference_grid_search` | 5 | 0.971361 | `{'estimator__learning_rate': 0.22, 'estimator__max_depth': 12, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 25}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `HGBM` | `HistGradientBoostingRegressor` | `paper_reference_grid_search` | 2.059 | 0.000016 | 0.000021 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_3` | `HGBM` | `HistGradientBoostingRegressor` | 2.059 | 0.000016 | 0.000021 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_3` | `HGBM` | `HGBM` | 2.059 | `matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/hgbm/2026-04-19-06-23-54__track1_hgbm_amplitude_3_closure_attempt_04_campaign_run/onnx_export`;
