...
- run name: `track1_hgbm_amplitude_40_closure_attempt_06`;
- output run name: `track1_hgbm_amplitude_40_closure_attempt_06_campaign_run`;
- run instance id: `2026-04-19-06-28-24__track1_hgbm_amplitude_40_closure_attempt_06_campaign_run`;
...
- winning best params: `{'estimator__learning_rate': 0.18, 'estimator__max_depth': 12, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 25}`;
- winning mean component MAPE: `3.174%`;
- winning mean component MAE: `0.000026`;
- winning mean component RMSE: `0.000038`;
...
| --- | --- | ---: | ---: | --- |
| `HGBM` | `paper_reference_grid_search` | 5 | 0.789499 | `{'estimator__learning_rate': 0.18, 'estimator__max_depth': 12, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 25}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `HGBM` | `HistGradientBoostingRegressor` | `paper_reference_grid_search` | 3.174 | 0.000026 | 0.000038 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_40` | `HGBM` | `HistGradientBoostingRegressor` | 3.174 | 0.000026 | 0.000038 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_40` | `ERT / GBM` | `HGBM` | 3.174 | `not_matched_expected_family_direction` |
...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `40` | `ERT` | `HGBM` | `above_paper_target` | `-` | `-` | `-` | `-` | `-` | `not_yet_matched_tables_3_6` |

## ONNX Export Surface

- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/hgbm/2026-04-19-06-28-24__track1_hgbm_amplitude_40_closure_attempt_06_campaign_run/onnx_export`;
