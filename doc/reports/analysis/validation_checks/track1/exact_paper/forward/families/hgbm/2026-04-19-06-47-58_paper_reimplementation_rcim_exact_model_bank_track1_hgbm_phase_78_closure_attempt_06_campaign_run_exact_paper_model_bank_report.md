...
- run name: `track1_hgbm_phase_78_closure_attempt_06`;
- output run name: `track1_hgbm_phase_78_closure_attempt_06_campaign_run`;
- run instance id: `2026-04-19-06-47-45__track1_hgbm_phase_78_closure_attempt_06_campaign_run`;
...
- winning best params: `{'estimator__learning_rate': 0.19, 'estimator__max_depth': 13, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 24}`;
- winning mean component MAPE: `301.324%`;
- winning mean component MAE: `0.081611`;
- winning mean component RMSE: `0.160581`;
...
| --- | --- | ---: | ---: | --- |
| `HGBM` | `paper_reference_grid_search` | 5 | 0.719021 | `{'estimator__learning_rate': 0.19, 'estimator__max_depth': 13, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 24}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `HGBM` | `HistGradientBoostingRegressor` | `paper_reference_grid_search` | 301.324 | 0.081611 | 0.160581 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_78` | `HGBM` | `HistGradientBoostingRegressor` | 301.324 | 0.081611 | 0.160581 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_78` | `HGBM / RF` | `HGBM` | 301.324 | `matched_expected_family_direction` |
...
| `Repo Best Family` | - | - | - | - | `HGBM` | - | - | - | - |
| `Repo Best MAE` | - | - | - | - | 0.0816 | - | - | - | - |
| `Paper Best Family` | - | - | - | - | `GBM` | - | - | - | - |
| `Paper Target MAE` | - | - | - | - | 0.0740 | - | - | - | - |
| `Gap Vs Paper` | - | - | - | - | 0.007611 | - | - | - | - |
...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `78` | `-` | `-` | `-` | `RF` | `HGBM` | `HGBM` | `above_paper_target` | `above_paper_target` | `not_yet_matched_tables_3_6` |

## ONNX Export Surface

- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/hgbm/2026-04-19-06-47-45__track1_hgbm_phase_78_closure_attempt_06_campaign_run/onnx_export`;
