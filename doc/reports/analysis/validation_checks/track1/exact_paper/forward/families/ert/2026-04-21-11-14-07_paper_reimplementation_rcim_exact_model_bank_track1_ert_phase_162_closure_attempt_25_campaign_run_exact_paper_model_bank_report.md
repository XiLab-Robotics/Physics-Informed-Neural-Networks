...
- run name: `track1_ert_phase_162_closure_attempt_25`;
- output run name: `track1_ert_phase_162_closure_attempt_25_campaign_run`;
- run instance id: `2026-04-21-11-13-50__track1_ert_phase_162_closure_attempt_25_campaign_run`;
...
- winning mean component MAPE: `10.057%`;
- winning mean component MAE: `0.207757`;
- winning mean component RMSE: `0.585586`;
...
| --- | --- | ---: | ---: | --- |
| `ERT` | `paper_reference_grid_search` | 5 | 0.775612 | `{'estimator__criterion': 'absolute_error', 'estimator__max_depth': 16, 'estimator__min_samples_split': 2, 'estimator__n_estimators': 20}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ERT` | `ExtraTreesRegressor` | `paper_reference_grid_search` | 10.057 | 0.207757 | 0.585586 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_162` | `ERT` | `ExtraTreesRegressor` | 10.057 | 0.207757 | 0.585586 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_162` | `ERT` | `ERT` | 10.057 | `matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/ert/2026-04-21-11-13-50__track1_ert_phase_162_closure_attempt_25_campaign_run/onnx_export`;
