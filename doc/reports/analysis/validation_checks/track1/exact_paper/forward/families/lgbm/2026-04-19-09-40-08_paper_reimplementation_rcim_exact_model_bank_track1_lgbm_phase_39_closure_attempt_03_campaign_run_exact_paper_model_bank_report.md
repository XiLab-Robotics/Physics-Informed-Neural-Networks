...
- run name: `track1_lgbm_phase_39_closure_attempt_03`;
- output run name: `track1_lgbm_phase_39_closure_attempt_03_campaign_run`;
- run instance id: `2026-04-19-09-38-44__track1_lgbm_phase_39_closure_attempt_03_campaign_run`;
...
- winning mean component MAPE: `1.611%`;
- winning mean component MAE: `0.019292`;
- winning mean component RMSE: `0.025804`;
...
| --- | --- | ---: | ---: | --- |
| `LGBM` | `paper_reference_grid_search` | 5 | 0.981784 | `{'estimator__learning_rate': 0.39, 'estimator__max_depth': 10, 'estimator__num_leaves': 31, 'estimator__subsample': 0.001}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `LGBM` | `LGBMRegressor` | `paper_reference_grid_search` | 1.611 | 0.019292 | 0.025804 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_39` | `LGBM` | `LGBMRegressor` | 1.611 | 0.019292 | 0.025804 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_39` | `HGBM` | `LGBM` | 1.611 | `not_matched_expected_family_direction` |
...
| `Repo Best Family` | - | - | `LGBM` | - | - | - | - | - | - |
| `Repo Best RMSE` | - | - | 0.0258 | - | - | - | - | - | - |
| `Paper Best Family` | - | - | `HGBM` | - | - | - | - | - | - |
| `Paper Target RMSE` | - | - | 0.0270 | - | - | - | - | - | - |
| `Gap Vs Paper` | - | - | -0.001196 | - | - | - | - | - | - |
| `Status` | - | - | `met_paper_target` | - | - | - | - | - | - |
...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `39` | `-` | `-` | `-` | `HGBM` | `LGBM` | `LGBM` | `met_paper_target` | `met_paper_target` | `partially_matched_tables_3_6` |

## ONNX Export Surface

- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/lgbm/2026-04-19-09-38-44__track1_lgbm_phase_39_closure_attempt_03_campaign_run/onnx_export`;
