...
- run name: `track1_mlp_amplitude_39_closure_attempt_10`;
- output run name: `track1_mlp_amplitude_39_closure_attempt_10_campaign_run`;
- run instance id: `2026-04-21-20-22-06__track1_mlp_amplitude_39_closure_attempt_10_campaign_run`;
...
- winning mean component MAPE: `705.804%`;
- winning mean component MAE: `0.006748`;
- winning mean component RMSE: `0.012992`;
...
| --- | --- | ---: | ---: | --- |
| `MLP` | `paper_reference_grid_search` | 5 | -8070.261011 | `{'estimator__activation': 'tanh', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (200, 50), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `MLP` | `MLPRegressor` | `paper_reference_grid_search` | 705.804 | 0.006748 | 0.012992 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_39` | `MLP` | `MLPRegressor` | 705.804 | 0.006748 | 0.012992 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_39` | `HGBM` | `MLP` | 705.804 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/mlp/2026-04-21-20-22-06__track1_mlp_amplitude_39_closure_attempt_10_campaign_run/onnx_export`;
