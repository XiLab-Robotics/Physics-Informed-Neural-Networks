...
- run name: `track1_dt_phase_162_closure_attempt_01`;
- output run name: `track1_dt_phase_162_closure_attempt_01_campaign_run`;
- run instance id: `2026-04-21-10-08-38__track1_dt_phase_162_closure_attempt_01_campaign_run`;
...
- winning mean component MAPE: `11.606%`;
- winning mean component MAE: `0.245312`;
- winning mean component RMSE: `0.891606`;
...
| --- | --- | ---: | ---: | --- |
| `DT` | `paper_reference_grid_search` | 5 | 0.679894 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 6}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `DT` | `DecisionTreeRegressor` | `paper_reference_grid_search` | 11.606 | 0.245312 | 0.891606 |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/dt/2026-04-21-10-08-38__track1_dt_phase_162_closure_attempt_01_campaign_run/onnx_export`;
