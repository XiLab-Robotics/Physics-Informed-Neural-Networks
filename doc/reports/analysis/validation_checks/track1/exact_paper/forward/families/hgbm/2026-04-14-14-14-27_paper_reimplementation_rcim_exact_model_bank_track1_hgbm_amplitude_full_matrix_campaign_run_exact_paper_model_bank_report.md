...
- run instance id: `2026-04-14-14-14-26__track1_hgbm_amplitude_full_matrix_campaign_run`;
...
- winning mean component MAPE: `9.027%`;
- winning mean component MAE: `0.000291`;
- winning mean component RMSE: `0.000457`;

## Family Ranking

| Rank | Family | Estimator | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | ---: | ---: | ---: |
| 1 | `HGBM` | `HistGradientBoostingRegressor` | 9.027 | 0.000291 | 0.000457 |
...
| `fft_y_Fw_filtered_ampl_40` | `HGBM` | `HistGradientBoostingRegressor` | 3.112 | 0.000025 | 0.000035 |
| `fft_y_Fw_filtered_ampl_78` | `HGBM` | `HistGradientBoostingRegressor` | 8.314 | 0.000025 | 0.000038 |
| `fft_y_Fw_filtered_ampl_81` | `HGBM` | `HistGradientBoostingRegressor` | 3.721 | 0.000012 | 0.000019 |
| `fft_y_Fw_filtered_ampl_156` | `HGBM` | `HistGradientBoostingRegressor` | 21.195 | 0.000101 | 0.000297 |
| `fft_y_Fw_filtered_ampl_162` | `HGBM` | `HistGradientBoostingRegressor` | 22.783 | 0.000138 | 0.000308 |
| `fft_y_Fw_filtered_ampl_240` | `HGBM` | `HistGradientBoostingRegressor` | 15.751 | 0.000038 | 0.000084 |
...
| `fft_y_Fw_filtered_ampl_40` | `ERT / GBM` | `HGBM` | 3.112 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_78` | `HGBM / RF` | `HGBM` | 8.314 | `matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_81` | `RF` | `HGBM` | 3.721 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_156` | `ERT / RF` | `HGBM` | 21.195 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_162` | `ERT` | `HGBM` | 22.783 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_240` | `ERT` | `HGBM` | 15.751 | `not_matched_expected_family_direction` |
...
| `Repo Best RMSE` | 0.003699 | 3.52e-05 | 2.57e-05 | 3.17e-05 | 3.47e-05 | 3.75e-05 | 1.86e-05 | 2.97e-04 | 3.08e-04 | 8.41e-05 |
...
| `Gap Vs Paper` | 3.99e-04 | 1.76e-07 | 7.42e-07 | -3.47e-07 | -1.30e-06 | -7.45e-06 | 3.57e-06 | 1.67e-04 | 1.48e-04 | 4.21e-05 |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/full_matrix/hgbm/2026-04-14-14-14-26__track1_hgbm_amplitude_full_matrix_campaign_run/onnx_export`;
