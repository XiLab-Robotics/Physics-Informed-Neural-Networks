...
- run instance id: `2026-04-19-10-28-17__track1_lgbm_phase_162_closure_attempt_06_campaign_run`;
...
- winning mean component MAPE: `19.295%`;
- winning mean component MAE: `0.411757`;
- winning mean component RMSE: `0.919616`;
...
| --- | --- | ---: | ---: | --- |
| `LGBM` | `paper_reference_grid_search` | 5 | 0.668998 | `{'estimator__learning_rate': 0.58, 'estimator__max_depth': 12, 'estimator__num_leaves': 31, 'estimator__subsample': 0.001}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `LGBM` | `LGBMRegressor` | `paper_reference_grid_search` | 19.295 | 0.411757 | 0.919616 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_162` | `LGBM` | `LGBMRegressor` | 19.295 | 0.411757 | 0.919616 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_162` | `ERT` | `LGBM` | 19.295 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/lgbm/2026-04-19-10-28-17__track1_lgbm_phase_162_closure_attempt_06_campaign_run/onnx_export`;
