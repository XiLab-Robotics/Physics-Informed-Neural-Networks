...
- run name: `track1_gbm_amplitude_40_closure_attempt_05`;
- output run name: `track1_gbm_amplitude_40_closure_attempt_05_campaign_run`;
- run instance id: `2026-04-19-05-39-51__track1_gbm_amplitude_40_closure_attempt_05_campaign_run`;
...
- winning best params: `{'estimator__criterion': 'squared_error', 'estimator__learning_rate': 0.1, 'estimator__max_depth': 15, 'estimator__min_samples_split': 18, 'estimator__n_estimators': 36}`;
- winning mean component MAPE: `2.889%`;
- winning mean component MAE: `0.000023`;
- winning mean component RMSE: `0.000032`;
...
| --- | --- | ---: | ---: | --- |
| `GBM` | `paper_reference_grid_search` | 5 | 0.774099 | `{'estimator__criterion': 'squared_error', 'estimator__learning_rate': 0.1, 'estimator__max_depth': 15, 'estimator__min_samples_split': 18, 'estimator__n_estimators': 36}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `GBM` | `GradientBoostingRegressor` | `paper_reference_grid_search` | 2.889 | 0.000023 | 0.000032 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_40` | `GBM` | `GradientBoostingRegressor` | 2.889 | 0.000023 | 0.000032 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_40` | `ERT / GBM` | `GBM` | 2.889 | `matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/gbm/2026-04-19-05-39-51__track1_gbm_amplitude_40_closure_attempt_05_campaign_run/onnx_export`;
