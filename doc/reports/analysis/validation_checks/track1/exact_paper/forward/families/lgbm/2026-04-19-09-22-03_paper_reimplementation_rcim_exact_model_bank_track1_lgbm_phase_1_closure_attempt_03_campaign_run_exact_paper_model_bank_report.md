...
- run name: `track1_lgbm_phase_1_closure_attempt_03`;
- output run name: `track1_lgbm_phase_1_closure_attempt_03_campaign_run`;
- run instance id: `2026-04-19-09-20-41__track1_lgbm_phase_1_closure_attempt_03_campaign_run`;
...
- winning mean component MAPE: `32.119%`;
- winning mean component MAE: `0.002073`;
- winning mean component RMSE: `0.002766`;
...
| --- | --- | ---: | ---: | --- |
| `LGBM` | `paper_reference_grid_search` | 5 | 0.793477 | `{'estimator__learning_rate': 0.39, 'estimator__max_depth': 10, 'estimator__num_leaves': 10, 'estimator__subsample': 0.001}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `LGBM` | `LGBMRegressor` | `paper_reference_grid_search` | 32.119 | 0.002073 | 0.002766 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_1` | `LGBM` | `LGBMRegressor` | 32.119 | 0.002073 | 0.002766 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_1` | `RF / LGBM` | `LGBM` | 32.119 | `matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/lgbm/2026-04-19-09-20-41__track1_lgbm_phase_1_closure_attempt_03_campaign_run/onnx_export`;
