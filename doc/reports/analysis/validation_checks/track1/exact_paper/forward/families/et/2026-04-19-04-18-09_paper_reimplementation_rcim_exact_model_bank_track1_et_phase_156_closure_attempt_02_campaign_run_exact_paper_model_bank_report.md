...
- run name: `track1_et_phase_156_closure_attempt_02`;
- output run name: `track1_et_phase_156_closure_attempt_02_campaign_run`;
- run instance id: `2026-04-19-04-18-01__track1_et_phase_156_closure_attempt_02_campaign_run`;
...
- winning mean component MAPE: `53.292%`;
- winning mean component MAE: `0.799991`;
- winning mean component RMSE: `1.615292`;
...
| --- | --- | ---: | ---: | --- |
| `ET` | `paper_reference_grid_search` | 5 | 0.596433 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 15, 'estimator__min_samples_split': 5}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ET` | `ExtraTreeRegressor` | `paper_reference_grid_search` | 53.292 | 0.799991 | 1.615292 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_156` | `ET` | `ExtraTreeRegressor` | 53.292 | 0.799991 | 1.615292 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_156` | `ERT / RF` | `ET` | 53.292 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/et/2026-04-19-04-18-01__track1_et_phase_156_closure_attempt_02_campaign_run/onnx_export`;
