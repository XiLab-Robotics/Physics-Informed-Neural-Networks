...
- run name: `track1_mlp_phase_156_closure_attempt_05`;
- output run name: `track1_mlp_phase_156_closure_attempt_05_campaign_run`;
- run instance id: `2026-04-19-02-02-38__track1_mlp_phase_156_closure_attempt_05_campaign_run`;
...
- winning mean component MAPE: `83.276%`;
- winning mean component MAE: `1.473328`;
- winning mean component RMSE: `1.861723`;
...
| --- | --- | ---: | ---: | --- |
| `MLP` | `paper_reference_grid_search` | 5 | 0.177236 | `{'estimator__activation': 'tanh', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (200,), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `MLP` | `MLPRegressor` | `paper_reference_grid_search` | 83.276 | 1.473328 | 1.861723 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_156` | `MLP` | `MLPRegressor` | 83.276 | 1.473328 | 1.861723 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_156` | `ERT / RF` | `MLP` | 83.276 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/mlp/2026-04-19-02-02-38__track1_mlp_phase_156_closure_attempt_05_campaign_run/onnx_export`;
