...
- run name: `track1_ert_amplitude_156_closure_attempt_13`;
- output run name: `track1_ert_amplitude_156_closure_attempt_13_campaign_run`;
- run instance id: `2026-04-21-10-35-58__track1_ert_amplitude_156_closure_attempt_13_campaign_run`;
...
- winning mean component MAPE: `12.141%`;
- winning mean component MAE: `0.000024`;
- winning mean component RMSE: `0.000052`;
...
| --- | --- | ---: | ---: | --- |
| `ERT` | `paper_reference_grid_search` | 5 | 0.990370 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 2, 'estimator__n_estimators': 100}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ERT` | `ExtraTreesRegressor` | `paper_reference_grid_search` | 12.141 | 0.000024 | 0.000052 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_156` | `ERT` | `ExtraTreesRegressor` | 12.141 | 0.000024 | 0.000052 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_156` | `ERT / RF` | `ERT` | 12.141 | `matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/ert/2026-04-21-10-35-58__track1_ert_amplitude_156_closure_attempt_13_campaign_run/onnx_export`;
