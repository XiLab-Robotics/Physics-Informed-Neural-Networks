...
- run name: `track1_lgbm_phase_40_closure_attempt_02`;
- output run name: `track1_lgbm_phase_40_closure_attempt_02_campaign_run`;
- run instance id: `2026-04-19-09-46-17__track1_lgbm_phase_40_closure_attempt_02_campaign_run`;
...
- winning best params: `{'estimator__learning_rate': 0.58, 'estimator__max_depth': 12, 'estimator__num_leaves': 31, 'estimator__subsample': 0.001}`;
- winning mean component MAPE: `115.239%`;
- winning mean component MAE: `0.034629`;
- winning mean component RMSE: `0.049680`;
...
| --- | --- | ---: | ---: | --- |
| `LGBM` | `paper_reference_grid_search` | 5 | 0.753239 | `{'estimator__learning_rate': 0.58, 'estimator__max_depth': 12, 'estimator__num_leaves': 31, 'estimator__subsample': 0.001}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `LGBM` | `LGBMRegressor` | `paper_reference_grid_search` | 115.239 | 0.034629 | 0.049680 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_40` | `LGBM` | `LGBMRegressor` | 115.239 | 0.034629 | 0.049680 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_40` | `ERT / GBM` | `LGBM` | 115.239 | `not_matched_expected_family_direction` |
...
| `Repo Best Family` | - | - | - | `LGBM` | - | - | - | - | - |
| `Repo Best RMSE` | - | - | - | 0.0497 | - | - | - | - | - |
| `Paper Best Family` | - | - | - | `GBM` | - | - | - | - | - |
| `Paper Target RMSE` | - | - | - | 0.0550 | - | - | - | - | - |
| `Gap Vs Paper` | - | - | - | -0.005320 | - | - | - | - | - |
| `Status` | - | - | - | `met_paper_target` | - | - | - | - | - |
...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `40` | `-` | `-` | `-` | `GBM` | `LGBM` | `LGBM` | `met_paper_target` | `met_paper_target` | `partially_matched_tables_3_6` |

## ONNX Export Surface

- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/lgbm/2026-04-19-09-46-17__track1_lgbm_phase_40_closure_attempt_02_campaign_run/onnx_export`;
