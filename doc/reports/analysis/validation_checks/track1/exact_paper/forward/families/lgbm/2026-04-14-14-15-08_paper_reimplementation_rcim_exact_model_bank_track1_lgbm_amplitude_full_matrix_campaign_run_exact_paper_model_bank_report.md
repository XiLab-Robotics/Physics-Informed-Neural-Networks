...
- run instance id: `2026-04-14-14-15-07__track1_lgbm_amplitude_full_matrix_campaign_run`;
...
- winning mean component MAPE: `8.950%`;
- winning mean component MAE: `0.000300`;
- winning mean component RMSE: `0.000462`;

## Family Ranking

| Rank | Family | Estimator | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | ---: | ---: | ---: |
| 1 | `LGBM` | `LGBMRegressor` | 8.950 | 0.000300 | 0.000462 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_0` | `LGBM` | `LGBMRegressor` | 10.856 | 0.002613 | 0.003829 |
| `fft_y_Fw_filtered_ampl_1` | `LGBM` | `LGBMRegressor` | 0.155 | 0.000027 | 0.000037 |
| `fft_y_Fw_filtered_ampl_3` | `LGBM` | `LGBMRegressor` | 2.419 | 0.000019 | 0.000027 |
| `fft_y_Fw_filtered_ampl_39` | `LGBM` | `LGBMRegressor` | 2.175 | 0.000024 | 0.000033 |
| `fft_y_Fw_filtered_ampl_40` | `LGBM` | `LGBMRegressor` | 3.158 | 0.000025 | 0.000035 |
| `fft_y_Fw_filtered_ampl_78` | `LGBM` | `LGBMRegressor` | 8.391 | 0.000025 | 0.000036 |
| `fft_y_Fw_filtered_ampl_81` | `LGBM` | `LGBMRegressor` | 4.076 | 0.000013 | 0.000020 |
| `fft_y_Fw_filtered_ampl_156` | `LGBM` | `LGBMRegressor` | 22.323 | 0.000105 | 0.000262 |
| `fft_y_Fw_filtered_ampl_162` | `LGBM` | `LGBMRegressor` | 21.754 | 0.000121 | 0.000276 |
| `fft_y_Fw_filtered_ampl_240` | `LGBM` | `LGBMRegressor` | 14.190 | 0.000034 | 0.000068 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_0` | `SVR` | `LGBM` | 10.856 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_1` | `RF / LGBM` | `LGBM` | 0.155 | `matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_3` | `HGBM` | `LGBM` | 2.419 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_39` | `HGBM` | `LGBM` | 2.175 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_40` | `ERT / GBM` | `LGBM` | 3.158 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_78` | `HGBM / RF` | `LGBM` | 8.391 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_81` | `RF` | `LGBM` | 4.076 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_156` | `ERT / RF` | `LGBM` | 22.323 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_162` | `ERT` | `LGBM` | 21.754 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_240` | `ERT` | `LGBM` | 14.190 | `not_matched_expected_family_direction` |
...
| `Repo Best RMSE` | 0.003829 | 3.69e-05 | 2.66e-05 | 3.26e-05 | 3.54e-05 | 3.57e-05 | 1.98e-05 | 2.62e-04 | 2.76e-04 | 6.78e-05 |
...
| `Gap Vs Paper` | 5.29e-04 | 1.89e-06 | 1.60e-06 | 5.88e-07 | -6.30e-07 | -9.30e-06 | 4.76e-06 | 1.32e-04 | 1.16e-04 | 2.58e-05 |
| `Status` | `above_paper_target` | `above_paper_target` | `above_paper_target` | `above_paper_target` | `met_paper_target` | `met_paper_target` | `above_paper_target` | `above_paper_target` | `above_paper_target` | `above_paper_target` |
...
| `1` | `RF` | `LGBM` | `above_paper_target` | `-` | `-` | `-` | `-` | `-` | `not_yet_matched_tables_3_6` |
| `3` | `HGBM` | `LGBM` | `above_paper_target` | `-` | `-` | `-` | `-` | `-` | `not_yet_matched_tables_3_6` |
| `39` | `HGBM` | `LGBM` | `above_paper_target` | `-` | `-` | `-` | `-` | `-` | `not_yet_matched_tables_3_6` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/full_matrix/lgbm/2026-04-14-14-15-07__track1_lgbm_amplitude_full_matrix_campaign_run/onnx_export`;
