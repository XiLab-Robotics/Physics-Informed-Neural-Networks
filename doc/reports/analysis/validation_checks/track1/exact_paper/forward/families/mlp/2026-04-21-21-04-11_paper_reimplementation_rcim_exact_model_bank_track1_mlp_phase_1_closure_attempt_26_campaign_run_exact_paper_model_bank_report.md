...
- run name: `track1_mlp_phase_1_closure_attempt_26`;
- output run name: `track1_mlp_phase_1_closure_attempt_26_campaign_run`;
- run instance id: `2026-04-21-21-04-02__track1_mlp_phase_1_closure_attempt_26_campaign_run`;
...
- winning mean component MAPE: `273.507%`;
- winning mean component MAE: `0.013960`;
- winning mean component RMSE: `0.021467`;
...
| --- | --- | ---: | ---: | --- |
| `MLP` | `paper_reference_grid_search` | 5 | -27.752403 | `{'estimator__activation': 'tanh', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (200, 50), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `MLP` | `MLPRegressor` | `paper_reference_grid_search` | 273.507 | 0.013960 | 0.021467 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_1` | `MLP` | `MLPRegressor` | 273.507 | 0.013960 | 0.021467 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_1` | `RF / LGBM` | `MLP` | 273.507 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/mlp/2026-04-21-21-04-02__track1_mlp_phase_1_closure_attempt_26_campaign_run/onnx_export`;
