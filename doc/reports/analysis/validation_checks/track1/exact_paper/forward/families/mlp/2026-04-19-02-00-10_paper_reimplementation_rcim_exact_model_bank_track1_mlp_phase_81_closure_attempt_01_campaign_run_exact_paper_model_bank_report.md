...
- run name: `track1_mlp_phase_81_closure_attempt_01`;
- output run name: `track1_mlp_phase_81_closure_attempt_01_campaign_run`;
- run instance id: `2026-04-19-02-00-01__track1_mlp_phase_81_closure_attempt_01_campaign_run`;
...
- winning mean component MAPE: `15.755%`;
- winning mean component MAE: `0.165498`;
- winning mean component RMSE: `0.229632`;
...
| --- | --- | ---: | ---: | --- |
| `MLP` | `paper_reference_grid_search` | 5 | 0.784301 | `{'estimator__activation': 'tanh', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (200, 50), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `MLP` | `MLPRegressor` | `paper_reference_grid_search` | 15.755 | 0.165498 | 0.229632 |
...
| `Repo Best MAE` | - | - | - | - | - | 0.1655 | - | - | - |
| `Paper Best Family` | - | - | - | - | - | `GBM` | - | - | - |
| `Paper Target MAE` | - | - | - | - | - | 0.0530 | - | - | - |
| `Gap Vs Paper` | - | - | - | - | - | 0.1125 | - | - | - |
...
| `Repo Best Family` | - | - | - | - | - | `MLP` | - | - | - |
| `Repo Best RMSE` | - | - | - | - | - | 0.2296 | - | - | - |
| `Paper Best Family` | - | - | - | - | - | `LGBM` | - | - | - |
| `Paper Target RMSE` | - | - | - | - | - | 0.0820 | - | - | - |
| `Gap Vs Paper` | - | - | - | - | - | 0.1476 | - | - | - |
| `Status` | - | - | - | - | - | `above_paper_target` | - | - | - |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/mlp/2026-04-19-02-00-01__track1_mlp_phase_81_closure_attempt_01_campaign_run/onnx_export`;
