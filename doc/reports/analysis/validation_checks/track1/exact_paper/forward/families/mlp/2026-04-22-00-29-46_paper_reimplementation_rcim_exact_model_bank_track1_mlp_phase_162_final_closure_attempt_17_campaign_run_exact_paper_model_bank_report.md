...
- run name: `track1_mlp_phase_162_final_closure_attempt_17`;
- output run name: `track1_mlp_phase_162_final_closure_attempt_17_campaign_run`;
- run instance id: `2026-04-22-00-29-37__track1_mlp_phase_162_final_closure_attempt_17_campaign_run`;
...
- winning best params: `{'estimator__activation': 'tanh', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (200,), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}`;
- winning mean component MAPE: `50.259%`;
- winning mean component MAE: `0.925465`;
- winning mean component RMSE: `1.325638`;
...
| --- | --- | ---: | ---: | --- |
| `MLP` | `paper_reference_grid_search` | 5 | 0.214294 | `{'estimator__activation': 'tanh', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (200,), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `MLP` | `MLPRegressor` | `paper_reference_grid_search` | 50.259 | 0.925465 | 1.325638 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_162` | `MLP` | `MLPRegressor` | 50.259 | 0.925465 | 1.325638 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_162` | `ERT` | `MLP` | 50.259 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/mlp/2026-04-22-00-29-37__track1_mlp_phase_162_final_closure_attempt_17_campaign_run/onnx_export`;
