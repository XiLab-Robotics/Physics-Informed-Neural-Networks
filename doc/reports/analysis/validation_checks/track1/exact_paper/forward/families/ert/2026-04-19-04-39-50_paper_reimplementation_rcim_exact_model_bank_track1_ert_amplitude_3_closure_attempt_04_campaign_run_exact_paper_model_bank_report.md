...
- run name: `track1_ert_amplitude_3_closure_attempt_04`;
- output run name: `track1_ert_amplitude_3_closure_attempt_04_campaign_run`;
- run instance id: `2026-04-19-04-39-33__track1_ert_amplitude_3_closure_attempt_04_campaign_run`;
...
- winning mean component MAPE: `2.305%`;
...
| --- | --- | ---: | ---: | --- |
| `ERT` | `paper_reference_grid_search` | 5 | 0.958934 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 3, 'estimator__n_estimators': 20}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ERT` | `ExtraTreesRegressor` | `paper_reference_grid_search` | 2.305 | 0.000017 | 0.000023 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_3` | `ERT` | `ExtraTreesRegressor` | 2.305 | 0.000017 | 0.000023 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_3` | `HGBM` | `ERT` | 2.305 | `not_matched_expected_family_direction` |
...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `3` | `HGBM` | `ERT` | `met_paper_target` | `-` | `-` | `-` | `-` | `-` | `partially_matched_tables_3_6` |

## ONNX Export Surface

- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/ert/2026-04-19-04-39-33__track1_ert_amplitude_3_closure_attempt_04_campaign_run/onnx_export`;
