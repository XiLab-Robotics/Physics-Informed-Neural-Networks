...
- run name: `track1_dt_phase_162_closure_attempt_22`;
- output run name: `track1_dt_phase_162_closure_attempt_22_campaign_run`;
- run instance id: `2026-04-21-10-13-43__track1_dt_phase_162_closure_attempt_22_campaign_run`;
...
- winning mean component MAE: `0.226008`;
- winning mean component RMSE: `0.733319`;
...
| --- | --- | ---: | ---: | --- |
| `DT` | `paper_reference_grid_search` | 5 | 0.687153 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 17, 'estimator__min_samples_split': 8}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `DT` | `DecisionTreeRegressor` | `paper_reference_grid_search` | 9.746 | 0.226008 | 0.733319 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_162` | `DT` | `DecisionTreeRegressor` | 9.746 | 0.226008 | 0.733319 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_162` | `ERT` | `DT` | 9.746 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/dt/2026-04-21-10-13-43__track1_dt_phase_162_closure_attempt_22_campaign_run/onnx_export`;
