...
- run name: `track1_hgbm_phase_full_matrix`;
- output run name: `track1_hgbm_phase_full_matrix_campaign_run`;
- run instance id: `2026-04-18-01-35-49__track1_hgbm_phase_full_matrix_campaign_run`;
...
- winning best params: `{'estimator__learning_rate': 0.21, 'estimator__max_depth': 13, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 25}`;
- winning mean component MAPE: `47.207%`;
- winning mean component MAE: `0.179495`;
- winning mean component RMSE: `0.347021`;
...
| --- | --- | ---: | ---: | --- |
| `HGBM` | `paper_reference_grid_search` | 5 | 0.782079 | `{'estimator__learning_rate': 0.21, 'estimator__max_depth': 13, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 25}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `HGBM` | `HistGradientBoostingRegressor` | `paper_reference_grid_search` | 47.207 | 0.179495 | 0.347021 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_1` | `HGBM` | `HistGradientBoostingRegressor` | 20.964 | 0.001832 | 0.002556 |
| `fft_y_Fw_filtered_phase_3` | `HGBM` | `HistGradientBoostingRegressor` | 1.395 | 0.024833 | 0.033872 |
| `fft_y_Fw_filtered_phase_39` | `HGBM` | `HistGradientBoostingRegressor` | 1.555 | 0.019674 | 0.032421 |
| `fft_y_Fw_filtered_phase_40` | `HGBM` | `HistGradientBoostingRegressor` | 52.924 | 0.039488 | 0.060390 |
| `fft_y_Fw_filtered_phase_78` | `HGBM` | `HistGradientBoostingRegressor` | 212.288 | 0.070595 | 0.137252 |
| `fft_y_Fw_filtered_phase_81` | `HGBM` | `HistGradientBoostingRegressor` | 4.957 | 0.049391 | 0.072232 |
| `fft_y_Fw_filtered_phase_156` | `HGBM` | `HistGradientBoostingRegressor` | 81.596 | 0.604771 | 1.037570 |
| `fft_y_Fw_filtered_phase_162` | `HGBM` | `HistGradientBoostingRegressor` | 17.627 | 0.387796 | 0.819126 |
| `fft_y_Fw_filtered_phase_240` | `HGBM` | `HistGradientBoostingRegressor` | 31.563 | 0.417077 | 0.927769 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_1` | `RF / LGBM` | `HGBM` | 20.964 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_3` | `HGBM` | `HGBM` | 1.395 | `matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_39` | `HGBM` | `HGBM` | 1.555 | `matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_40` | `ERT / GBM` | `HGBM` | 52.924 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_78` | `HGBM / RF` | `HGBM` | 212.288 | `matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_81` | `RF` | `HGBM` | 4.957 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_156` | `ERT / RF` | `HGBM` | 81.596 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_162` | `ERT` | `HGBM` | 17.627 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_240` | `ERT` | `HGBM` | 31.563 | `not_matched_expected_family_direction` |
...
| ---: | --- | --- | --- | ---: | --- |
| `1` | `RF / LGBM` | `-` | `HGBM` | 0/1 | `no_family_direction_match` |
| `3` | `HGBM` | `-` | `HGBM` | 1/1 | `full_family_direction_match` |
| `39` | `HGBM` | `-` | `HGBM` | 1/1 | `full_family_direction_match` |
| `40` | `ERT / GBM` | `-` | `HGBM` | 0/1 | `no_family_direction_match` |
| `78` | `HGBM / RF` | `-` | `HGBM` | 1/1 | `full_family_direction_match` |
| `81` | `RF` | `-` | `HGBM` | 0/1 | `no_family_direction_match` |
| `156` | `ERT / RF` | `-` | `HGBM` | 0/1 | `no_family_direction_match` |
| `162` | `ERT` | `-` | `HGBM` | 0/1 | `no_family_direction_match` |
| `240` | `ERT` | `-` | `HGBM` | 0/1 | `no_family_direction_match` |
...
| `Repo Best Family` | `HGBM` | `HGBM` | `HGBM` | `HGBM` | `HGBM` | `HGBM` | `HGBM` | `HGBM` | `HGBM` |
| `Repo Best MAE` | 0.001832 | 0.0248 | 0.0197 | 0.0395 | 0.0706 | 0.0494 | 0.6048 | 0.3878 | 0.4171 |
...
| `Gap Vs Paper` | 3.22e-05 | 0.004833 | -0.001326 | 0.003488 | -0.003405 | -0.003609 | 0.0948 | 0.1878 | 0.1871 |
| `Status` | `above_paper_target` | `above_paper_target` | `met_paper_target` | `above_paper_target` | `met_paper_target` | `met_paper_target` | `above_paper_target` | `above_paper_target` | `above_paper_target` |
...
| `Repo Best Family` | `HGBM` | `HGBM` | `HGBM` | `HGBM` | `HGBM` | `HGBM` | `HGBM` | `HGBM` | `HGBM` |
| `Repo Best RMSE` | 0.002556 | 0.0339 | 0.0324 | 0.0604 | 0.1373 | 0.0722 | 1.038 | 0.8191 | 0.9278 |
...
| `Gap Vs Paper` | 5.57e-05 | 0.004872 | 0.005421 | 0.005390 | -0.0227 | -0.009768 | -0.1624 | 0.1791 | 0.3478 |
...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `1` | `-` | `-` | `-` | `LGBM` | `HGBM` | `HGBM` | `above_paper_target` | `above_paper_target` | `not_yet_matched_tables_3_6` |
| `3` | `-` | `-` | `-` | `HGBM` | `HGBM` | `HGBM` | `above_paper_target` | `above_paper_target` | `partially_matched_tables_3_6` |
| `39` | `-` | `-` | `-` | `HGBM` | `HGBM` | `HGBM` | `met_paper_target` | `above_paper_target` | `partially_matched_tables_3_6` |
| `40` | `-` | `-` | `-` | `GBM` | `HGBM` | `HGBM` | `above_paper_target` | `above_paper_target` | `not_yet_matched_tables_3_6` |
| `78` | `-` | `-` | `-` | `RF` | `HGBM` | `HGBM` | `met_paper_target` | `met_paper_target` | `partially_matched_tables_3_6` |
| `81` | `-` | `-` | `-` | `RF` | `HGBM` | `HGBM` | `met_paper_target` | `met_paper_target` | `partially_matched_tables_3_6` |
| `156` | `-` | `-` | `-` | `RF` | `HGBM` | `HGBM` | `above_paper_target` | `met_paper_target` | `partially_matched_tables_3_6` |
| `162` | `-` | `-` | `-` | `ERT` | `HGBM` | `HGBM` | `above_paper_target` | `above_paper_target` | `not_yet_matched_tables_3_6` |
| `240` | `-` | `-` | `-` | `ERT` | `HGBM` | `HGBM` | `above_paper_target` | `above_paper_target` | `not_yet_matched_tables_3_6` |

## ONNX Export Surface

- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/full_matrix/hgbm/2026-04-18-01-35-49__track1_hgbm_phase_full_matrix_campaign_run/onnx_export`;
