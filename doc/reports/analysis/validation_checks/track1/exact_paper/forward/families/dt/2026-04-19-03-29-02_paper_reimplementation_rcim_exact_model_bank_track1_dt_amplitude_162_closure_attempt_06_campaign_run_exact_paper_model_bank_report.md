...
- run name: `track1_dt_amplitude_162_closure_attempt_06`;
- output run name: `track1_dt_amplitude_162_closure_attempt_06_campaign_run`;
- run instance id: `2026-04-19-03-28-54__track1_dt_amplitude_162_closure_attempt_06_campaign_run`;
...
- winning best params: `{'estimator__criterion': 'absolute_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 5}`;
- winning mean component MAPE: `10.073%`;
...
| --- | --- | ---: | ---: | --- |
| `DT` | `paper_reference_grid_search` | 5 | 0.938745 | `{'estimator__criterion': 'absolute_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 5}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `DT` | `DecisionTreeRegressor` | `paper_reference_grid_search` | 10.073 | 0.000070 | 0.000218 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_162` | `DT` | `DecisionTreeRegressor` | 10.073 | 0.000070 | 0.000218 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_162` | `ERT` | `DT` | 10.073 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/dt/2026-04-19-03-28-54__track1_dt_amplitude_162_closure_attempt_06_campaign_run/onnx_export`;
