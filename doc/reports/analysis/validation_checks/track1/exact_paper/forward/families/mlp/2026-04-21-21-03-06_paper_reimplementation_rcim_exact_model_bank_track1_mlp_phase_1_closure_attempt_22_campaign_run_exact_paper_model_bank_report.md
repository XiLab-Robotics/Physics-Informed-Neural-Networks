...
- run name: `track1_mlp_phase_1_closure_attempt_22`;
- output run name: `track1_mlp_phase_1_closure_attempt_22_campaign_run`;
- run instance id: `2026-04-21-21-02-56__track1_mlp_phase_1_closure_attempt_22_campaign_run`;
...
- winning mean component MAPE: `200.677%`;
- winning mean component MAE: `0.013979`;
- winning mean component RMSE: `0.024094`;
...
| --- | --- | ---: | ---: | --- |
| `MLP` | `paper_reference_grid_search` | 5 | -19.500372 | `{'estimator__activation': 'tanh', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (200, 50), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `MLP` | `MLPRegressor` | `paper_reference_grid_search` | 200.677 | 0.013979 | 0.024094 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_1` | `MLP` | `MLPRegressor` | 200.677 | 0.013979 | 0.024094 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_1` | `RF / LGBM` | `MLP` | 200.677 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/mlp/2026-04-21-21-02-56__track1_mlp_phase_1_closure_attempt_22_campaign_run/onnx_export`;
