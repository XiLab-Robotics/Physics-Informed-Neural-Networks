...
- run name: `track1_rf_phase_81_closure_attempt_06`;
- output run name: `track1_rf_phase_81_closure_attempt_06_campaign_run`;
- run instance id: `2026-04-19-02-56-34__track1_rf_phase_81_closure_attempt_06_campaign_run`;
...
- winning mean component MAPE: `4.592%`;
- winning mean component MAE: `0.048110`;
- winning mean component RMSE: `0.068430`;
...
| --- | --- | ---: | ---: | --- |
| `RF` | `paper_reference_grid_search` | 5 | 0.963809 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 15, 'estimator__min_samples_split': 2, 'estimator__n_estimators': 60}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `RF` | `RandomForestRegressor` | `paper_reference_grid_search` | 4.592 | 0.048110 | 0.068430 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_81` | `RF` | `RandomForestRegressor` | 4.592 | 0.048110 | 0.068430 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_81` | `RF` | `RF` | 4.592 | `matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/rf/2026-04-19-02-56-34__track1_rf_phase_81_closure_attempt_06_campaign_run/onnx_export`;
