...
- run name: `track1_xgbm_amplitude_0_closure_attempt_04`;
- output run name: `track1_xgbm_amplitude_0_closure_attempt_04_campaign_run`;
- run instance id: `2026-04-19-07-08-03__track1_xgbm_amplitude_0_closure_attempt_04_campaign_run`;
...
- winning mean component MAPE: `5.336%`;
- winning mean component MAE: `0.002503`;
- winning mean component RMSE: `0.002935`;
...
| --- | --- | ---: | ---: | --- |
| `XGBM` | `paper_reference_grid_search` | 5 | 0.971258 | `{'estimator__colsample_bytree': 0.8, 'estimator__learning_rate': 0.2, 'estimator__max_depth': 14}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `XGBM` | `XGBRegressor` | `paper_reference_grid_search` | 5.336 | 0.002503 | 0.002935 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_0` | `XGBM` | `XGBRegressor` | 5.336 | 0.002503 | 0.002935 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_0` | `SVR` | `XGBM` | 5.336 | `not_matched_expected_family_direction` |
...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `0` | `SVM` | `XGBM` | `met_paper_target` | `-` | `-` | `-` | `-` | `-` | `partially_matched_tables_3_6` |

## ONNX Export Surface

- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/xgbm/2026-04-19-07-08-03__track1_xgbm_amplitude_0_closure_attempt_04_campaign_run/onnx_export`;
