...
- run name: `track1_mlp_phase_162_final_closure_attempt_19`;
- output run name: `track1_mlp_phase_162_final_closure_attempt_19_campaign_run`;
- run instance id: `2026-04-22-00-30-09__track1_mlp_phase_162_final_closure_attempt_19_campaign_run`;
...
- winning mean component MAPE: `48.317%`;
- winning mean component MAE: `1.039244`;
- winning mean component RMSE: `1.464897`;
...
| --- | --- | ---: | ---: | --- |
| `MLP` | `paper_reference_grid_search` | 5 | 0.297350 | `{'estimator__activation': 'relu', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (100, 50), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `MLP` | `MLPRegressor` | `paper_reference_grid_search` | 48.317 | 1.039244 | 1.464897 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_162` | `MLP` | `MLPRegressor` | 48.317 | 1.039244 | 1.464897 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_162` | `ERT` | `MLP` | 48.317 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/mlp/2026-04-22-00-30-09__track1_mlp_phase_162_final_closure_attempt_19_campaign_run/onnx_export`;
