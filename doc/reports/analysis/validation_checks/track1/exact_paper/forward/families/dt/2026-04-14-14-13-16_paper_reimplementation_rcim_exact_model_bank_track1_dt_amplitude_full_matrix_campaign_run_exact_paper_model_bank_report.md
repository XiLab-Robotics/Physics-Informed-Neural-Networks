...
- run instance id: `2026-04-14-14-13-15__track1_dt_amplitude_full_matrix_campaign_run`;
...
- winning mean component MAPE: `8.469%`;
...
| ---: | --- | --- | ---: | ---: | ---: |
| 1 | `DT` | `DecisionTreeRegressor` | 8.469 | 0.000390 | 0.000572 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_0` | `DT` | `DecisionTreeRegressor` | 14.751 | 0.003510 | 0.004879 |
| `fft_y_Fw_filtered_ampl_1` | `DT` | `DecisionTreeRegressor` | 0.181 | 0.000031 | 0.000043 |
| `fft_y_Fw_filtered_ampl_3` | `DT` | `DecisionTreeRegressor` | 2.811 | 0.000023 | 0.000033 |
| `fft_y_Fw_filtered_ampl_39` | `DT` | `DecisionTreeRegressor` | 3.311 | 0.000037 | 0.000051 |
| `fft_y_Fw_filtered_ampl_40` | `DT` | `DecisionTreeRegressor` | 3.699 | 0.000030 | 0.000045 |
| `fft_y_Fw_filtered_ampl_78` | `DT` | `DecisionTreeRegressor` | 13.884 | 0.000056 | 0.000080 |
| `fft_y_Fw_filtered_ampl_81` | `DT` | `DecisionTreeRegressor` | 4.812 | 0.000015 | 0.000024 |
| `fft_y_Fw_filtered_ampl_156` | `DT` | `DecisionTreeRegressor` | 19.010 | 0.000089 | 0.000298 |
| `fft_y_Fw_filtered_ampl_162` | `DT` | `DecisionTreeRegressor` | 9.746 | 0.000067 | 0.000197 |
| `fft_y_Fw_filtered_ampl_240` | `DT` | `DecisionTreeRegressor` | 12.489 | 0.000045 | 0.000072 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_0` | `SVR` | `DT` | 14.751 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_1` | `RF / LGBM` | `DT` | 0.181 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_3` | `HGBM` | `DT` | 2.811 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_39` | `HGBM` | `DT` | 3.311 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_40` | `ERT / GBM` | `DT` | 3.699 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_78` | `HGBM / RF` | `DT` | 13.884 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_81` | `RF` | `DT` | 4.812 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_156` | `ERT / RF` | `DT` | 19.010 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_162` | `ERT` | `DT` | 9.746 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_240` | `ERT` | `DT` | 12.489 | `not_matched_expected_family_direction` |
...
| `Repo Best RMSE` | 0.004879 | 4.31e-05 | 3.34e-05 | 5.06e-05 | 4.51e-05 | 7.97e-05 | 2.38e-05 | 2.98e-04 | 1.97e-04 | 7.18e-05 |
...
| `Gap Vs Paper` | 0.001579 | 8.06e-06 | 8.37e-06 | 1.86e-05 | 9.09e-06 | 3.47e-05 | 8.75e-06 | 1.68e-04 | 3.68e-05 | 2.98e-05 |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/full_matrix/dt/2026-04-14-14-13-15__track1_dt_amplitude_full_matrix_campaign_run/onnx_export`;
