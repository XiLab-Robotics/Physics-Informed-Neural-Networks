...
- run name: `track1_gbm_phase_39_closure_attempt_05`;
- output run name: `track1_gbm_phase_39_closure_attempt_05_campaign_run`;
- run instance id: `2026-04-19-05-55-17__track1_gbm_phase_39_closure_attempt_05_campaign_run`;
...
- winning mean component MAPE: `1.585%`;
- winning mean component MAE: `0.019915`;
- winning mean component RMSE: `0.033534`;
...
| --- | --- | ---: | ---: | --- |
| `GBM` | `paper_reference_grid_search` | 5 | 0.978763 | `{'estimator__criterion': 'squared_error', 'estimator__learning_rate': 0.1, 'estimator__max_depth': 14, 'estimator__min_samples_split': 16, 'estimator__n_estimators': 84}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `GBM` | `GradientBoostingRegressor` | `paper_reference_grid_search` | 1.585 | 0.019915 | 0.033534 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_39` | `GBM` | `GradientBoostingRegressor` | 1.585 | 0.019915 | 0.033534 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_39` | `HGBM` | `GBM` | 1.585 | `not_matched_expected_family_direction` |
...
| `Repo Best MAE` | - | - | 0.0199 | - | - | - | - | - | - |
| `Paper Best Family` | - | - | `HGBM` | - | - | - | - | - | - |
| `Paper Target MAE` | - | - | 0.0210 | - | - | - | - | - | - |
| `Gap Vs Paper` | - | - | -0.001085 | - | - | - | - | - | - |
...
| `Repo Best Family` | - | - | `GBM` | - | - | - | - | - | - |
| `Repo Best RMSE` | - | - | 0.0335 | - | - | - | - | - | - |
| `Paper Best Family` | - | - | `HGBM` | - | - | - | - | - | - |
| `Paper Target RMSE` | - | - | 0.0270 | - | - | - | - | - | - |
| `Gap Vs Paper` | - | - | 0.006534 | - | - | - | - | - | - |
...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `39` | `-` | `-` | `-` | `HGBM` | `GBM` | `GBM` | `met_paper_target` | `above_paper_target` | `partially_matched_tables_3_6` |

## ONNX Export Surface

- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/gbm/2026-04-19-05-55-17__track1_gbm_phase_39_closure_attempt_05_campaign_run/onnx_export`;
