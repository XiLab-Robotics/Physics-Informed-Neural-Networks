...
- run name: `track1_ert_phase_1_closure_attempt_01`;
- output run name: `track1_ert_phase_1_closure_attempt_01_campaign_run`;
- run instance id: `2026-04-19-04-57-42__track1_ert_phase_1_closure_attempt_01_campaign_run`;
...
- winning best params: `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 15, 'estimator__min_samples_split': 6, 'estimator__n_estimators': 100}`;
- winning mean component MAPE: `30.388%`;
- winning mean component MAE: `0.002310`;
- winning mean component RMSE: `0.003548`;
...
| --- | --- | ---: | ---: | --- |
| `ERT` | `paper_reference_grid_search` | 5 | 0.694735 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 15, 'estimator__min_samples_split': 6, 'estimator__n_estimators': 100}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ERT` | `ExtraTreesRegressor` | `paper_reference_grid_search` | 30.388 | 0.002310 | 0.003548 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_1` | `ERT` | `ExtraTreesRegressor` | 30.388 | 0.002310 | 0.003548 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_1` | `RF / LGBM` | `ERT` | 30.388 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/ert/2026-04-19-04-57-42__track1_ert_phase_1_closure_attempt_01_campaign_run/onnx_export`;
