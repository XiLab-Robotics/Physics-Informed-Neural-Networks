...
- run name: `track1_mlp_amplitude_240_final_closure_attempt_43`;
- output run name: `track1_mlp_amplitude_240_final_closure_attempt_43_campaign_run`;
- run instance id: `2026-04-22-00-22-10__track1_mlp_amplitude_240_final_closure_attempt_43_campaign_run`;
...
- winning mean component MAPE: `5068.785%`;
- winning mean component MAE: `0.013102`;
- winning mean component RMSE: `0.021628`;
...
| --- | --- | ---: | ---: | --- |
| `MLP` | `paper_reference_grid_search` | 5 | -1876.284960 | `{'estimator__activation': 'tanh', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (200, 50), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `MLP` | `MLPRegressor` | `paper_reference_grid_search` | 5068.785 | 0.013102 | 0.021628 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_240` | `MLP` | `MLPRegressor` | 5068.785 | 0.013102 | 0.021628 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_240` | `ERT` | `MLP` | 5068.785 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/mlp/2026-04-22-00-22-10__track1_mlp_amplitude_240_final_closure_attempt_43_campaign_run/onnx_export`;
