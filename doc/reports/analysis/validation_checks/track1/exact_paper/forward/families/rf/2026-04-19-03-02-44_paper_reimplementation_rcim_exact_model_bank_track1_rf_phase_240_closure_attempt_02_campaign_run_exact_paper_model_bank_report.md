...
- run name: `track1_rf_phase_240_closure_attempt_02`;
- output run name: `track1_rf_phase_240_closure_attempt_02_campaign_run`;
- run instance id: `2026-04-19-03-02-26__track1_rf_phase_240_closure_attempt_02_campaign_run`;
...
- winning best params: `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 13, 'estimator__min_samples_split': 5, 'estimator__n_estimators': 50}`;
- winning mean component MAPE: `88.769%`;
- winning mean component MAE: `0.277512`;
- winning mean component RMSE: `0.648291`;
...
| --- | --- | ---: | ---: | --- |
| `RF` | `paper_reference_grid_search` | 5 | 0.609206 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 13, 'estimator__min_samples_split': 5, 'estimator__n_estimators': 50}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `RF` | `RandomForestRegressor` | `paper_reference_grid_search` | 88.769 | 0.277512 | 0.648291 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_240` | `RF` | `RandomForestRegressor` | 88.769 | 0.277512 | 0.648291 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_240` | `ERT` | `RF` | 88.769 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/rf/2026-04-19-03-02-26__track1_rf_phase_240_closure_attempt_02_campaign_run/onnx_export`;
