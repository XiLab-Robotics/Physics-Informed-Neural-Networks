...
- run name: `track1_lgbm_phase_3_closure_attempt_05`;
- output run name: `track1_lgbm_phase_3_closure_attempt_05_campaign_run`;
- run instance id: `2026-04-19-09-32-42__track1_lgbm_phase_3_closure_attempt_05_campaign_run`;
...
- winning mean component MAPE: `1.315%`;
- winning mean component MAE: `0.023409`;
- winning mean component RMSE: `0.034880`;
...
| --- | --- | ---: | ---: | --- |
| `LGBM` | `paper_reference_grid_search` | 5 | 0.943703 | `{'estimator__learning_rate': 0.39, 'estimator__max_depth': 14, 'estimator__num_leaves': 31, 'estimator__subsample': 0.001}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `LGBM` | `LGBMRegressor` | `paper_reference_grid_search` | 1.315 | 0.023409 | 0.034880 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_3` | `LGBM` | `LGBMRegressor` | 1.315 | 0.023409 | 0.034880 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_3` | `HGBM` | `LGBM` | 1.315 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/lgbm/2026-04-19-09-32-42__track1_lgbm_phase_3_closure_attempt_05_campaign_run/onnx_export`;
