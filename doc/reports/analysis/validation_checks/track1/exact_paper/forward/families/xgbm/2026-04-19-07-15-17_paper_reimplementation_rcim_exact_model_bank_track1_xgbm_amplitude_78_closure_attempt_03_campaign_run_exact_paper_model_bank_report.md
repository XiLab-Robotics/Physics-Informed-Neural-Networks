...
- run name: `track1_xgbm_amplitude_78_closure_attempt_03`;
- output run name: `track1_xgbm_amplitude_78_closure_attempt_03_campaign_run`;
- run instance id: `2026-04-19-07-15-09__track1_xgbm_amplitude_78_closure_attempt_03_campaign_run`;
...
- winning mean component MAPE: `50.969%`;
- winning mean component MAE: `0.000119`;
...
| --- | --- | ---: | ---: | --- |
| `XGBM` | `paper_reference_grid_search` | 5 | 0.923358 | `{'estimator__colsample_bytree': 0.8, 'estimator__learning_rate': 0.3, 'estimator__max_depth': 14}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `XGBM` | `XGBRegressor` | `paper_reference_grid_search` | 50.969 | 0.000119 | 0.000158 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_78` | `XGBM` | `XGBRegressor` | 50.969 | 0.000119 | 0.000158 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_78` | `HGBM / RF` | `XGBM` | 50.969 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/xgbm/2026-04-19-07-15-09__track1_xgbm_amplitude_78_closure_attempt_03_campaign_run/onnx_export`;
