...
- run name: `track1_hgbm_amplitude_162_closure_attempt_02`;
- output run name: `track1_hgbm_amplitude_162_closure_attempt_02_campaign_run`;
- run instance id: `2026-04-19-06-34-49__track1_hgbm_amplitude_162_closure_attempt_02_campaign_run`;
...
- winning mean component MAPE: `32.974%`;
- winning mean component MAE: `0.000115`;
- winning mean component RMSE: `0.000282`;
...
| --- | --- | ---: | ---: | --- |
| `HGBM` | `paper_reference_grid_search` | 5 | 0.955184 | `{'estimator__learning_rate': 0.22, 'estimator__max_depth': 10, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 26}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `HGBM` | `HistGradientBoostingRegressor` | `paper_reference_grid_search` | 32.974 | 0.000115 | 0.000282 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_162` | `HGBM` | `HistGradientBoostingRegressor` | 32.974 | 0.000115 | 0.000282 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_162` | `ERT` | `HGBM` | 32.974 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/hgbm/2026-04-19-06-34-49__track1_hgbm_amplitude_162_closure_attempt_02_campaign_run/onnx_export`;
