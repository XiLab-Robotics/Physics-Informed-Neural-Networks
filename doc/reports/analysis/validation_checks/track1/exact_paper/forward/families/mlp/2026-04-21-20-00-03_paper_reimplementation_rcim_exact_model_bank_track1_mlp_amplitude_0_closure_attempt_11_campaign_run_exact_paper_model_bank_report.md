...
- run name: `track1_mlp_amplitude_0_closure_attempt_11`;
- output run name: `track1_mlp_amplitude_0_closure_attempt_11_campaign_run`;
- run instance id: `2026-04-21-19-59-53__track1_mlp_amplitude_0_closure_attempt_11_campaign_run`;
...
- winning mean component MAPE: `41.694%`;
- winning mean component MAE: `0.021096`;
- winning mean component RMSE: `0.037006`;
...
| --- | --- | ---: | ---: | --- |
| `MLP` | `paper_reference_grid_search` | 5 | -0.554193 | `{'estimator__activation': 'tanh', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (100, 50), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `MLP` | `MLPRegressor` | `paper_reference_grid_search` | 41.694 | 0.021096 | 0.037006 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_0` | `MLP` | `MLPRegressor` | 41.694 | 0.021096 | 0.037006 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_0` | `SVR` | `MLP` | 41.694 | `not_matched_expected_family_direction` |
...
| `Repo Best RMSE` | 0.0370 | - | - | - | - | - | - | - | - | - |
| `Paper Best Family` | `SVM` | - | - | - | - | - | - | - | - | - |
| `Paper Target RMSE` | 0.003300 | - | - | - | - | - | - | - | - | - |
| `Gap Vs Paper` | 0.0337 | - | - | - | - | - | - | - | - | - |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/mlp/2026-04-21-19-59-53__track1_mlp_amplitude_0_closure_attempt_11_campaign_run/onnx_export`;
