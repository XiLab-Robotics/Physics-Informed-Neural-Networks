...
- run name: `track1_svm_amplitude_40_yellow_cell_attempt_11`;
- output run name: `track1_svm_amplitude_40_yellow_cell_attempt_11_campaign_run`;
- run instance id: `2026-04-22-09-16-58__track1_svm_amplitude_40_yellow_cell_attempt_11_campaign_run`;
...
| --- | --- | ---: | ---: | --- |
| `SVR` | `paper_reference_grid_search` | 5 | -0.407908 | `{'estimator__C': 0.001, 'estimator__epsilon': 1e-06, 'estimator__gamma': 1.1e-06, 'estimator__kernel': 'rbf'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `SVR` | `SVR` | `paper_reference_grid_search` | 10.484 | 0.000084 | 0.000101 |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/svm_targeted_closure/svm/2026-04-22-09-16-58__track1_svm_amplitude_40_yellow_cell_attempt_11_campaign_run/onnx_export`;
