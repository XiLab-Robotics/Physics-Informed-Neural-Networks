...
- run name: `track1_lgbm_phase_3_closure_attempt_03`;
- output run name: `track1_lgbm_phase_3_closure_attempt_03_campaign_run`;
- run instance id: `2026-04-19-09-29-41__track1_lgbm_phase_3_closure_attempt_03_campaign_run`;
...
- winning mean component MAPE: `1.190%`;
- winning mean component MAE: `0.021217`;
- winning mean component RMSE: `0.029957`;
...
| --- | --- | ---: | ---: | --- |
| `LGBM` | `paper_reference_grid_search` | 5 | 0.932894 | `{'estimator__learning_rate': 0.39, 'estimator__max_depth': 13, 'estimator__num_leaves': 31, 'estimator__subsample': 0.001}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `LGBM` | `LGBMRegressor` | `paper_reference_grid_search` | 1.190 | 0.021217 | 0.029957 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_3` | `LGBM` | `LGBMRegressor` | 1.190 | 0.021217 | 0.029957 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_3` | `HGBM` | `LGBM` | 1.190 | `not_matched_expected_family_direction` |
...
| `Repo Best Family` | - | `LGBM` | - | - | - | - | - | - | - |
| `Repo Best RMSE` | - | 0.0300 | - | - | - | - | - | - | - |
| `Paper Best Family` | - | `HGBM` | - | - | - | - | - | - | - |
| `Paper Target RMSE` | - | 0.0290 | - | - | - | - | - | - | - |
| `Gap Vs Paper` | - | 9.57e-04 | - | - | - | - | - | - | - |
| `Status` | - | `above_paper_target` | - | - | - | - | - | - | - |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/lgbm/2026-04-19-09-29-41__track1_lgbm_phase_3_closure_attempt_03_campaign_run/onnx_export`;
