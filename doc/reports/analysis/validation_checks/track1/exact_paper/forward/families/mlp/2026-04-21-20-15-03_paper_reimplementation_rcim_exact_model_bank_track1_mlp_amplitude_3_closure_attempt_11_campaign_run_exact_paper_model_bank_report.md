...
- run name: `track1_mlp_amplitude_3_closure_attempt_11`;
- output run name: `track1_mlp_amplitude_3_closure_attempt_11_campaign_run`;
- run instance id: `2026-04-21-20-14-52__track1_mlp_amplitude_3_closure_attempt_11_campaign_run`;
...
- winning mean component MAPE: `1547.564%`;
- winning mean component MAE: `0.011701`;
- winning mean component RMSE: `0.023917`;
...
| --- | --- | ---: | ---: | --- |
| `MLP` | `paper_reference_grid_search` | 5 | -26073.531772 | `{'estimator__activation': 'tanh', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (100, 50), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `MLP` | `MLPRegressor` | `paper_reference_grid_search` | 1547.564 | 0.011701 | 0.023917 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_3` | `MLP` | `MLPRegressor` | 1547.564 | 0.011701 | 0.023917 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_3` | `HGBM` | `MLP` | 1547.564 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/mlp/2026-04-21-20-14-52__track1_mlp_amplitude_3_closure_attempt_11_campaign_run/onnx_export`;
