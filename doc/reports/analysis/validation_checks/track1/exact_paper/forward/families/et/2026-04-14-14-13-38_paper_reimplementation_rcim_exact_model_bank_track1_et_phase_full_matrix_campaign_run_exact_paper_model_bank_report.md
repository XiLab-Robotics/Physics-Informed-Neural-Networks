...
- run instance id: `2026-04-14-14-13-37__track1_et_phase_full_matrix_campaign_run`;
...
- winning mean component MAPE: `69.771%`;
- winning mean component MAE: `0.167959`;
- winning mean component RMSE: `0.396455`;

## Family Ranking

| Rank | Family | Estimator | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | ---: | ---: | ---: |
| 1 | `ET` | `ExtraTreeRegressor` | 69.771 | 0.167959 | 0.396455 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_1` | `ET` | `ExtraTreeRegressor` | 40.733 | 0.002964 | 0.004396 |
| `fft_y_Fw_filtered_phase_3` | `ET` | `ExtraTreeRegressor` | 1.775 | 0.031858 | 0.042943 |
| `fft_y_Fw_filtered_phase_39` | `ET` | `ExtraTreeRegressor` | 2.562 | 0.032849 | 0.057899 |
| `fft_y_Fw_filtered_phase_40` | `ET` | `ExtraTreeRegressor` | 84.820 | 0.044238 | 0.070136 |
| `fft_y_Fw_filtered_phase_78` | `ET` | `ExtraTreeRegressor` | 385.137 | 0.112514 | 0.347164 |
| `fft_y_Fw_filtered_phase_81` | `ET` | `ExtraTreeRegressor` | 8.109 | 0.091555 | 0.165762 |
| `fft_y_Fw_filtered_phase_156` | `ET` | `ExtraTreeRegressor` | 55.218 | 0.607909 | 1.219648 |
| `fft_y_Fw_filtered_phase_162` | `ET` | `ExtraTreeRegressor` | 16.183 | 0.313559 | 0.930680 |
| `fft_y_Fw_filtered_phase_240` | `ET` | `ExtraTreeRegressor` | 33.402 | 0.274189 | 0.729469 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_1` | `RF / LGBM` | `ET` | 40.733 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_3` | `HGBM` | `ET` | 1.775 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_39` | `HGBM` | `ET` | 2.562 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_40` | `ERT / GBM` | `ET` | 84.820 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_78` | `HGBM / RF` | `ET` | 385.137 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_81` | `RF` | `ET` | 8.109 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_156` | `ERT / RF` | `ET` | 55.218 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_162` | `ERT` | `ET` | 16.183 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_240` | `ERT` | `ET` | 33.402 | `not_matched_expected_family_direction` |
...
| `Repo Best MAE` | 0.002964 | 0.0319 | 0.0328 | 0.0442 | 0.1125 | 0.0916 | 0.6079 | 0.3136 | 0.2742 |
...
| `Gap Vs Paper` | 0.001164 | 0.0119 | 0.0118 | 0.008238 | 0.0385 | 0.0386 | 0.0979 | 0.1136 | 0.0442 |
...
| `Repo Best Family` | `ET` | `ET` | `ET` | `ET` | `ET` | `ET` | `ET` | `ET` | `ET` |
| `Repo Best RMSE` | 0.004396 | 0.0429 | 0.0579 | 0.0701 | 0.3472 | 0.1658 | 1.220 | 0.9307 | 0.7295 |
...
| `Gap Vs Paper` | 0.001896 | 0.0139 | 0.0309 | 0.0151 | 0.1872 | 0.0838 | 0.0196 | 0.2907 | 0.1495 |
| `Status` | `above_paper_target` | `above_paper_target` | `above_paper_target` | `above_paper_target` | `above_paper_target` | `above_paper_target` | `above_paper_target` | `above_paper_target` | `above_paper_target` |
...
| `156` | `-` | `-` | `-` | `RF` | `ET` | `ET` | `above_paper_target` | `above_paper_target` | `not_yet_matched_tables_3_6` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/full_matrix/et/2026-04-14-14-13-37__track1_et_phase_full_matrix_campaign_run/onnx_export`;
