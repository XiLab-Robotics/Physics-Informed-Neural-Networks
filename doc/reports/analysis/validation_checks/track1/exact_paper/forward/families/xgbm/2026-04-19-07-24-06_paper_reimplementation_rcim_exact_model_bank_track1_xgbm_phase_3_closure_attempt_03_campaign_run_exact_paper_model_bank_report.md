...
- run name: `track1_xgbm_phase_3_closure_attempt_03`;
- output run name: `track1_xgbm_phase_3_closure_attempt_03_campaign_run`;
- run instance id: `2026-04-19-07-23-58__track1_xgbm_phase_3_closure_attempt_03_campaign_run`;
...
- winning mean component MAPE: `1.351%`;
- winning mean component MAE: `0.024210`;
- winning mean component RMSE: `0.032144`;
...
| --- | --- | ---: | ---: | --- |
| `XGBM` | `paper_reference_grid_search` | 5 | 0.926956 | `{'estimator__colsample_bytree': 0.8, 'estimator__learning_rate': 0.2, 'estimator__max_depth': 14}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `XGBM` | `XGBRegressor` | `paper_reference_grid_search` | 1.351 | 0.024210 | 0.032144 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_3` | `XGBM` | `XGBRegressor` | 1.351 | 0.024210 | 0.032144 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_3` | `HGBM` | `XGBM` | 1.351 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/xgbm/2026-04-19-07-23-58__track1_xgbm_phase_3_closure_attempt_03_campaign_run/onnx_export`;
