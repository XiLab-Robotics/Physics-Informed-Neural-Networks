...
- run name: `track1_hgbm_phase_162_closure_attempt_20`;
- output run name: `track1_hgbm_phase_162_closure_attempt_20_campaign_run`;
- run instance id: `2026-04-21-12-02-26__track1_hgbm_phase_162_closure_attempt_20_campaign_run`;
...
- winning mean component MAPE: `20.426%`;
- winning mean component MAE: `0.442440`;
- winning mean component RMSE: `1.033092`;
...
| --- | --- | ---: | ---: | --- |
| `HGBM` | `paper_reference_grid_search` | 5 | 0.697034 | `{'estimator__learning_rate': 0.22, 'estimator__max_depth': 10, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 24}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `HGBM` | `HistGradientBoostingRegressor` | `paper_reference_grid_search` | 20.426 | 0.442440 | 1.033092 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_162` | `HGBM` | `HistGradientBoostingRegressor` | 20.426 | 0.442440 | 1.033092 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_162` | `ERT` | `HGBM` | 20.426 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/hgbm/2026-04-21-12-02-26__track1_hgbm_phase_162_closure_attempt_20_campaign_run/onnx_export`;
