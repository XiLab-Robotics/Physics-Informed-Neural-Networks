...
- run instance id: `2026-04-14-14-13-56__track1_ert_phase_full_matrix_campaign_run`;
...
- winning mean component MAPE: `39.463%`;
- winning mean component MAE: `0.120555`;
- winning mean component RMSE: `0.310022`;

## Family Ranking

| Rank | Family | Estimator | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | ---: | ---: | ---: |
| 1 | `ERT` | `ExtraTreesRegressor` | 39.463 | 0.120555 | 0.310022 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_1` | `ERT` | `ExtraTreesRegressor` | 30.896 | 0.002372 | 0.003630 |
| `fft_y_Fw_filtered_phase_3` | `ERT` | `ExtraTreesRegressor` | 1.575 | 0.028087 | 0.040897 |
| `fft_y_Fw_filtered_phase_39` | `ERT` | `ExtraTreesRegressor` | 2.155 | 0.028097 | 0.054868 |
| `fft_y_Fw_filtered_phase_40` | `ERT` | `ExtraTreesRegressor` | 48.272 | 0.034522 | 0.054119 |
| `fft_y_Fw_filtered_phase_78` | `ERT` | `ExtraTreesRegressor` | 124.812 | 0.063566 | 0.169441 |
| `fft_y_Fw_filtered_phase_81` | `ERT` | `ExtraTreesRegressor` | 4.561 | 0.049228 | 0.078444 |
| `fft_y_Fw_filtered_phase_156` | `ERT` | `ExtraTreesRegressor` | 112.705 | 0.396674 | 0.912920 |
| `fft_y_Fw_filtered_phase_162` | `ERT` | `ExtraTreesRegressor` | 10.299 | 0.212507 | 0.718591 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_1` | `RF / LGBM` | `ERT` | 30.896 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_3` | `HGBM` | `ERT` | 1.575 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_39` | `HGBM` | `ERT` | 2.155 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_40` | `ERT / GBM` | `ERT` | 48.272 | `matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_78` | `HGBM / RF` | `ERT` | 124.812 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_81` | `RF` | `ERT` | 4.561 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_156` | `ERT / RF` | `ERT` | 112.705 | `matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_162` | `ERT` | `ERT` | 10.299 | `matched_expected_family_direction` |
...
| `Repo Best MAE` | 0.002372 | 0.0281 | 0.0281 | 0.0345 | 0.0636 | 0.0492 | 0.3967 | 0.2125 | 0.2699 |
...
| `Gap Vs Paper` | 5.72e-04 | 0.008087 | 0.007097 | -0.001478 | -0.0104 | -0.003772 | -0.1133 | 0.0125 | 0.0399 |
...
| `Repo Best Family` | `ERT` | `ERT` | `ERT` | `ERT` | `ERT` | `ERT` | `ERT` | `ERT` | `ERT` |
| `Repo Best RMSE` | 0.003630 | 0.0409 | 0.0549 | 0.0541 | 0.1694 | 0.0784 | 0.9129 | 0.7186 | 0.7573 |
...
| `Gap Vs Paper` | 0.001130 | 0.0119 | 0.0279 | -8.81e-04 | 0.009441 | -0.003556 | -0.2871 | 0.0786 | 0.1773 |
| `Status` | `above_paper_target` | `above_paper_target` | `above_paper_target` | `met_paper_target` | `above_paper_target` | `met_paper_target` | `met_paper_target` | `above_paper_target` | `above_paper_target` |
...
| `40` | `-` | `-` | `-` | `GBM` | `ERT` | `ERT` | `met_paper_target` | `met_paper_target` | `partially_matched_tables_3_6` |
| `78` | `-` | `-` | `-` | `RF` | `ERT` | `ERT` | `met_paper_target` | `above_paper_target` | `partially_matched_tables_3_6` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/full_matrix/ert/2026-04-14-14-13-56__track1_ert_phase_full_matrix_campaign_run/onnx_export`;
