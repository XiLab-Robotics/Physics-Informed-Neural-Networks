...
- run name: `track1_mlp_amplitude_162_closure_attempt_05`;
- output run name: `track1_mlp_amplitude_162_closure_attempt_05_campaign_run`;
- run instance id: `2026-04-19-01-49-43__track1_mlp_amplitude_162_closure_attempt_05_campaign_run`;
...
- winning mean component MAPE: `8551.535%`;
- winning mean component MAE: `0.010781`;
- winning mean component RMSE: `0.020410`;
...
| --- | --- | ---: | ---: | --- |
| `MLP` | `paper_reference_grid_search` | 5 | -193.729568 | `{'estimator__activation': 'tanh', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (200, 50), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `MLP` | `MLPRegressor` | `paper_reference_grid_search` | 8551.535 | 0.010781 | 0.020410 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_162` | `MLP` | `MLPRegressor` | 8551.535 | 0.010781 | 0.020410 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_162` | `ERT` | `MLP` | 8551.535 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/mlp/2026-04-19-01-49-43__track1_mlp_amplitude_162_closure_attempt_05_campaign_run/onnx_export`;
