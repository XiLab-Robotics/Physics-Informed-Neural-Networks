...
- run name: `track1_mlp_amplitude_81_closure_attempt_26`;
- output run name: `track1_mlp_amplitude_81_closure_attempt_26_campaign_run`;
- run instance id: `2026-04-21-00-41-16__track1_mlp_amplitude_81_closure_attempt_26_campaign_run`;
...
- winning mean component MAPE: `3724.738%`;
- winning mean component MAE: `0.010814`;
- winning mean component RMSE: `0.017830`;
...
| --- | --- | ---: | ---: | --- |
| `MLP` | `paper_reference_grid_search` | 5 | -186967.432825 | `{'estimator__activation': 'tanh', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (200, 50), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `MLP` | `MLPRegressor` | `paper_reference_grid_search` | 3724.738 | 0.010814 | 0.017830 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_81` | `MLP` | `MLPRegressor` | 3724.738 | 0.010814 | 0.017830 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_81` | `RF` | `MLP` | 3724.738 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/mlp/2026-04-21-00-41-16__track1_mlp_amplitude_81_closure_attempt_26_campaign_run/onnx_export`;
