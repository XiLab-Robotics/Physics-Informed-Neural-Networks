...
- run name: `track1_et_phase_240_closure_attempt_25`;
- output run name: `track1_et_phase_240_closure_attempt_25_campaign_run`;
- run instance id: `2026-04-21-10-26-56__track1_et_phase_240_closure_attempt_25_campaign_run`;
...
- winning mean component MAPE: `17.728%`;
- winning mean component MAE: `0.249703`;
- winning mean component RMSE: `0.869537`;
...
| --- | --- | ---: | ---: | --- |
| `ET` | `paper_reference_grid_search` | 5 | 0.352079 | `{'estimator__criterion': 'absolute_error', 'estimator__max_depth': 17, 'estimator__min_samples_split': 2}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ET` | `ExtraTreeRegressor` | `paper_reference_grid_search` | 17.728 | 0.249703 | 0.869537 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_240` | `ET` | `ExtraTreeRegressor` | 17.728 | 0.249703 | 0.869537 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_240` | `ERT` | `ET` | 17.728 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/et/2026-04-21-10-26-56__track1_et_phase_240_closure_attempt_25_campaign_run/onnx_export`;
