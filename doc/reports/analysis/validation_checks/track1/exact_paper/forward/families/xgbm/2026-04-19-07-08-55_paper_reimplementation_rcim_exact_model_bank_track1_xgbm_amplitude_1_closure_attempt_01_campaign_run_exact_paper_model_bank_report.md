...
- run name: `track1_xgbm_amplitude_1_closure_attempt_01`;
- output run name: `track1_xgbm_amplitude_1_closure_attempt_01_campaign_run`;
- run instance id: `2026-04-19-07-08-47__track1_xgbm_amplitude_1_closure_attempt_01_campaign_run`;
...
- winning mean component MAPE: `0.308%`;
...
| --- | --- | ---: | ---: | --- |
| `XGBM` | `paper_reference_grid_search` | 5 | -0.003728 | `{'estimator__colsample_bytree': 0.3, 'estimator__learning_rate': 0.01, 'estimator__max_depth': 14}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `XGBM` | `XGBRegressor` | `paper_reference_grid_search` | 0.308 | 0.000053 | 0.000068 |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/xgbm/2026-04-19-07-08-47__track1_xgbm_amplitude_1_closure_attempt_01_campaign_run/onnx_export`;
