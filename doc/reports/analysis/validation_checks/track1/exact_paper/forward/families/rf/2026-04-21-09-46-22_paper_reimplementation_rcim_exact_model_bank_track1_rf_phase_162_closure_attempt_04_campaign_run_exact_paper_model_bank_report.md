...
- run name: `track1_rf_phase_162_closure_attempt_04`;
- output run name: `track1_rf_phase_162_closure_attempt_04_campaign_run`;
- run instance id: `2026-04-21-09-46-03__track1_rf_phase_162_closure_attempt_04_campaign_run`;
...
- winning mean component MAPE: `9.837%`;
- winning mean component MAE: `0.242082`;
- winning mean component RMSE: `0.643289`;
...
| --- | --- | ---: | ---: | --- |
| `RF` | `paper_reference_grid_search` | 5 | 0.768742 | `{'estimator__criterion': 'absolute_error', 'estimator__max_depth': 12, 'estimator__min_samples_split': 2, 'estimator__n_estimators': 90}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `RF` | `RandomForestRegressor` | `paper_reference_grid_search` | 9.837 | 0.242082 | 0.643289 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_162` | `RF` | `RandomForestRegressor` | 9.837 | 0.242082 | 0.643289 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_162` | `ERT` | `RF` | 9.837 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/rf/2026-04-21-09-46-03__track1_rf_phase_162_closure_attempt_04_campaign_run/onnx_export`;
