...
- run name: `track1_et_phase_156_closure_attempt_01`;
- output run name: `track1_et_phase_156_closure_attempt_01_campaign_run`;
- run instance id: `2026-04-19-04-17-46__track1_et_phase_156_closure_attempt_01_campaign_run`;
...
- winning mean component MAPE: `46.826%`;
- winning mean component MAE: `0.495464`;
- winning mean component RMSE: `1.138228`;
...
| --- | --- | ---: | ---: | --- |
| `ET` | `paper_reference_grid_search` | 5 | 0.582564 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 16, 'estimator__min_samples_split': 4}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ET` | `ExtraTreeRegressor` | `paper_reference_grid_search` | 46.826 | 0.495464 | 1.138228 |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/et/2026-04-19-04-17-46__track1_et_phase_156_closure_attempt_01_campaign_run/onnx_export`;
