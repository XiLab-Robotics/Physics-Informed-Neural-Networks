...
- run name: `track1_hgbm_phase_78_closure_attempt_04`;
- output run name: `track1_hgbm_phase_78_closure_attempt_04_campaign_run`;
- run instance id: `2026-04-19-06-47-06__track1_hgbm_phase_78_closure_attempt_04_campaign_run`;
...
- winning mean component MAPE: `259.850%`;
- winning mean component MAE: `0.076933`;
- winning mean component RMSE: `0.138690`;
...
| --- | --- | ---: | ---: | --- |
| `HGBM` | `paper_reference_grid_search` | 5 | 0.788855 | `{'estimator__learning_rate': 0.2, 'estimator__max_depth': 13, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 26}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `HGBM` | `HistGradientBoostingRegressor` | `paper_reference_grid_search` | 259.850 | 0.076933 | 0.138690 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_78` | `HGBM` | `HistGradientBoostingRegressor` | 259.850 | 0.076933 | 0.138690 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_78` | `HGBM / RF` | `HGBM` | 259.850 | `matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/hgbm/2026-04-19-06-47-06__track1_hgbm_phase_78_closure_attempt_04_campaign_run/onnx_export`;
