...
- run name: `track1_lgbm_phase_39_closure_attempt_06`;
- output run name: `track1_lgbm_phase_39_closure_attempt_06_campaign_run`;
- run instance id: `2026-04-19-09-43-18__track1_lgbm_phase_39_closure_attempt_06_campaign_run`;
...
- winning mean component MAPE: `1.770%`;
- winning mean component MAE: `0.021532`;
- winning mean component RMSE: `0.032655`;
...
| --- | --- | ---: | ---: | --- |
| `LGBM` | `paper_reference_grid_search` | 5 | 0.984148 | `{'estimator__learning_rate': 0.58, 'estimator__max_depth': 11, 'estimator__num_leaves': 31, 'estimator__subsample': 0.001}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `LGBM` | `LGBMRegressor` | `paper_reference_grid_search` | 1.770 | 0.021532 | 0.032655 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_39` | `LGBM` | `LGBMRegressor` | 1.770 | 0.021532 | 0.032655 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_39` | `HGBM` | `LGBM` | 1.770 | `not_matched_expected_family_direction` |
...
| `Repo Best Family` | - | - | `LGBM` | - | - | - | - | - | - |
| `Repo Best RMSE` | - | - | 0.0327 | - | - | - | - | - | - |
| `Paper Best Family` | - | - | `HGBM` | - | - | - | - | - | - |
| `Paper Target RMSE` | - | - | 0.0270 | - | - | - | - | - | - |
| `Gap Vs Paper` | - | - | 0.005655 | - | - | - | - | - | - |
| `Status` | - | - | `above_paper_target` | - | - | - | - | - | - |
...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `39` | `-` | `-` | `-` | `HGBM` | `LGBM` | `LGBM` | `above_paper_target` | `above_paper_target` | `not_yet_matched_tables_3_6` |

## ONNX Export Surface

- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/lgbm/2026-04-19-09-43-18__track1_lgbm_phase_39_closure_attempt_06_campaign_run/onnx_export`;
