...
- run name: `track1_gbm_amplitude_162_closure_attempt_03`;
- output run name: `track1_gbm_amplitude_162_closure_attempt_03_campaign_run`;
- run instance id: `2026-04-19-05-46-56__track1_gbm_amplitude_162_closure_attempt_03_campaign_run`;
...
- winning best params: `{'estimator__criterion': 'squared_error', 'estimator__learning_rate': 0.1, 'estimator__max_depth': 14, 'estimator__min_samples_split': 14, 'estimator__n_estimators': 52}`;
- winning mean component MAPE: `10.037%`;
- winning mean component MAE: `0.000069`;
- winning mean component RMSE: `0.000269`;
...
| --- | --- | ---: | ---: | --- |
| `GBM` | `paper_reference_grid_search` | 5 | 0.991515 | `{'estimator__criterion': 'squared_error', 'estimator__learning_rate': 0.1, 'estimator__max_depth': 14, 'estimator__min_samples_split': 14, 'estimator__n_estimators': 52}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `GBM` | `GradientBoostingRegressor` | `paper_reference_grid_search` | 10.037 | 0.000069 | 0.000269 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_162` | `GBM` | `GradientBoostingRegressor` | 10.037 | 0.000069 | 0.000269 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_162` | `ERT` | `GBM` | 10.037 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/gbm/2026-04-19-05-46-56__track1_gbm_amplitude_162_closure_attempt_03_campaign_run/onnx_export`;
