...
- run name: `track1_hgbm_amplitude_full_matrix`;
- output run name: `track1_hgbm_amplitude_full_matrix_campaign_run`;
- run instance id: `2026-04-18-01-35-07__track1_hgbm_amplitude_full_matrix_campaign_run`;
...
- target scope mode: `amplitudes_only`;
...
- target count: `10`;
- target schema kind: `ampl_exact_paper`;
...
- winning best params: `{'estimator__learning_rate': 0.2, 'estimator__max_depth': 11, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 25}`;
- winning mean component MAPE: `9.098%`;
- winning mean component MAE: `0.000292`;
- winning mean component RMSE: `0.000458`;
...
| --- | --- | ---: | ---: | --- |
| `HGBM` | `paper_reference_grid_search` | 5 | 0.916872 | `{'estimator__learning_rate': 0.2, 'estimator__max_depth': 11, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 25}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `HGBM` | `HistGradientBoostingRegressor` | `paper_reference_grid_search` | 9.098 | 0.000292 | 0.000458 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_0` | `HGBM` | `HistGradientBoostingRegressor` | 10.671 | 0.002512 | 0.003683 |
| `fft_y_Fw_filtered_ampl_1` | `HGBM` | `HistGradientBoostingRegressor` | 0.150 | 0.000026 | 0.000035 |
| `fft_y_Fw_filtered_ampl_3` | `HGBM` | `HistGradientBoostingRegressor` | 2.349 | 0.000018 | 0.000026 |
| `fft_y_Fw_filtered_ampl_39` | `HGBM` | `HistGradientBoostingRegressor` | 2.083 | 0.000023 | 0.000031 |
| `fft_y_Fw_filtered_ampl_40` | `HGBM` | `HistGradientBoostingRegressor` | 3.025 | 0.000024 | 0.000034 |
| `fft_y_Fw_filtered_ampl_78` | `HGBM` | `HistGradientBoostingRegressor` | 7.996 | 0.000025 | 0.000037 |
| `fft_y_Fw_filtered_ampl_81` | `HGBM` | `HistGradientBoostingRegressor` | 3.833 | 0.000012 | 0.000019 |
| `fft_y_Fw_filtered_ampl_156` | `HGBM` | `HistGradientBoostingRegressor` | 21.824 | 0.000101 | 0.000301 |
| `fft_y_Fw_filtered_ampl_162` | `HGBM` | `HistGradientBoostingRegressor` | 21.888 | 0.000139 | 0.000323 |
| `fft_y_Fw_filtered_ampl_240` | `HGBM` | `HistGradientBoostingRegressor` | 17.162 | 0.000041 | 0.000089 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_0` | `SVR` | `HGBM` | 10.671 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_1` | `RF / LGBM` | `HGBM` | 0.150 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_3` | `HGBM` | `HGBM` | 2.349 | `matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_39` | `HGBM` | `HGBM` | 2.083 | `matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_40` | `ERT / GBM` | `HGBM` | 3.025 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_78` | `HGBM / RF` | `HGBM` | 7.996 | `matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_81` | `RF` | `HGBM` | 3.833 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_156` | `ERT / RF` | `HGBM` | 21.824 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_162` | `ERT` | `HGBM` | 21.888 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_240` | `ERT` | `HGBM` | 17.162 | `not_matched_expected_family_direction` |
...
| ---: | --- | --- | --- | ---: | --- |
| `0` | `SVR` | `HGBM` | `-` | 0/1 | `no_family_direction_match` |
...
| `Repo Best Family` | `HGBM` | `HGBM` | `HGBM` | `HGBM` | `HGBM` | `HGBM` | `HGBM` | `HGBM` | `HGBM` | `HGBM` |
| `Repo Best RMSE` | 0.003683 | 3.51e-05 | 2.57e-05 | 3.12e-05 | 3.35e-05 | 3.72e-05 | 1.89e-05 | 3.01e-04 | 3.23e-04 | 8.88e-05 |
...
| `Gap Vs Paper` | 3.83e-04 | 6.86e-08 | 7.32e-07 | -7.78e-07 | -2.45e-06 | -7.75e-06 | 3.92e-06 | 1.71e-04 | 1.63e-04 | 4.68e-05 |
| `Status` | `above_paper_target` | `above_paper_target` | `above_paper_target` | `met_paper_target` | `met_paper_target` | `met_paper_target` | `above_paper_target` | `above_paper_target` | `above_paper_target` | `above_paper_target` |
...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `0` | `SVM` | `HGBM` | `above_paper_target` | `-` | `-` | `-` | `-` | `-` | `not_yet_matched_tables_3_6` |
| `1` | `RF` | `HGBM` | `above_paper_target` | `-` | `-` | `-` | `-` | `-` | `not_yet_matched_tables_3_6` |
| `3` | `HGBM` | `HGBM` | `above_paper_target` | `-` | `-` | `-` | `-` | `-` | `partially_matched_tables_3_6` |
| `39` | `HGBM` | `HGBM` | `met_paper_target` | `-` | `-` | `-` | `-` | `-` | `fully_matched_tables_3_6` |
| `40` | `ERT` | `HGBM` | `met_paper_target` | `-` | `-` | `-` | `-` | `-` | `partially_matched_tables_3_6` |
| `78` | `HGBM` | `HGBM` | `met_paper_target` | `-` | `-` | `-` | `-` | `-` | `fully_matched_tables_3_6` |
| `81` | `RF` | `HGBM` | `above_paper_target` | `-` | `-` | `-` | `-` | `-` | `not_yet_matched_tables_3_6` |
| `156` | `ERT` | `HGBM` | `above_paper_target` | `-` | `-` | `-` | `-` | `-` | `not_yet_matched_tables_3_6` |
| `162` | `ERT` | `HGBM` | `above_paper_target` | `-` | `-` | `-` | `-` | `-` | `not_yet_matched_tables_3_6` |
| `240` | `ERT` | `HGBM` | `above_paper_target` | `-` | `-` | `-` | `-` | `-` | `not_yet_matched_tables_3_6` |

## ONNX Export Surface

- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/full_matrix/hgbm/2026-04-18-01-35-07__track1_hgbm_amplitude_full_matrix_campaign_run/onnx_export`;
