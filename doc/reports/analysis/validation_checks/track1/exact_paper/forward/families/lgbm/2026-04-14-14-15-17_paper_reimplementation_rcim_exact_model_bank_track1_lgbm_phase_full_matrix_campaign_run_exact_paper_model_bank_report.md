...
- run instance id: `2026-04-14-14-15-16__track1_lgbm_phase_full_matrix_campaign_run`;
...
- winning mean component MAPE: `62.496%`;
- winning mean component MAE: `0.172873`;
- winning mean component RMSE: `0.345862`;

## Family Ranking

| Rank | Family | Estimator | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | ---: | ---: | ---: |
| 1 | `LGBM` | `LGBMRegressor` | 62.496 | 0.172873 | 0.345862 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_1` | `LGBM` | `LGBMRegressor` | 22.293 | 0.001890 | 0.002605 |
| `fft_y_Fw_filtered_phase_3` | `LGBM` | `LGBMRegressor` | 1.440 | 0.025608 | 0.036527 |
| `fft_y_Fw_filtered_phase_39` | `LGBM` | `LGBMRegressor` | 1.642 | 0.020375 | 0.032922 |
| `fft_y_Fw_filtered_phase_40` | `LGBM` | `LGBMRegressor` | 51.386 | 0.037179 | 0.058218 |
| `fft_y_Fw_filtered_phase_78` | `LGBM` | `LGBMRegressor` | 379.311 | 0.074713 | 0.149228 |
| `fft_y_Fw_filtered_phase_81` | `LGBM` | `LGBMRegressor` | 4.589 | 0.047474 | 0.068638 |
| `fft_y_Fw_filtered_phase_156` | `LGBM` | `LGBMRegressor` | 56.378 | 0.609151 | 1.054014 |
| `fft_y_Fw_filtered_phase_162` | `LGBM` | `LGBMRegressor` | 16.409 | 0.349105 | 0.813894 |
| `fft_y_Fw_filtered_phase_240` | `LGBM` | `LGBMRegressor` | 29.013 | 0.390359 | 0.896709 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_1` | `RF / LGBM` | `LGBM` | 22.293 | `matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_3` | `HGBM` | `LGBM` | 1.440 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_39` | `HGBM` | `LGBM` | 1.642 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_40` | `ERT / GBM` | `LGBM` | 51.386 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_78` | `HGBM / RF` | `LGBM` | 379.311 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_81` | `RF` | `LGBM` | 4.589 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_156` | `ERT / RF` | `LGBM` | 56.378 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_162` | `ERT` | `LGBM` | 16.409 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_240` | `ERT` | `LGBM` | 29.013 | `not_matched_expected_family_direction` |
...
| `Repo Best MAE` | 0.001890 | 0.0256 | 0.0204 | 0.0372 | 0.0747 | 0.0475 | 0.6092 | 0.3491 | 0.3904 |
...
| `Gap Vs Paper` | 8.98e-05 | 0.005608 | -6.25e-04 | 0.001179 | 7.13e-04 | -0.005526 | 0.0992 | 0.1491 | 0.1604 |
| `Status` | `above_paper_target` | `above_paper_target` | `met_paper_target` | `above_paper_target` | `above_paper_target` | `met_paper_target` | `above_paper_target` | `above_paper_target` | `above_paper_target` |
...
| `Repo Best Family` | `LGBM` | `LGBM` | `LGBM` | `LGBM` | `LGBM` | `LGBM` | `LGBM` | `LGBM` | `LGBM` |
| `Repo Best RMSE` | 0.002605 | 0.0365 | 0.0329 | 0.0582 | 0.1492 | 0.0686 | 1.054 | 0.8139 | 0.8967 |
...
| `Gap Vs Paper` | 1.05e-04 | 0.007527 | 0.005922 | 0.003218 | -0.0108 | -0.0134 | -0.1460 | 0.1739 | 0.3167 |
...
| `78` | `-` | `-` | `-` | `RF` | `LGBM` | `LGBM` | `above_paper_target` | `met_paper_target` | `partially_matched_tables_3_6` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/full_matrix/lgbm/2026-04-14-14-15-16__track1_lgbm_phase_full_matrix_campaign_run/onnx_export`;
