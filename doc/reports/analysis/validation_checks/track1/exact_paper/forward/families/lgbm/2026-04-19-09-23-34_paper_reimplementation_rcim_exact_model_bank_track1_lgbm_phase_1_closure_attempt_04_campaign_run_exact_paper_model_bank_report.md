...
- run name: `track1_lgbm_phase_1_closure_attempt_04`;
- output run name: `track1_lgbm_phase_1_closure_attempt_04_campaign_run`;
- run instance id: `2026-04-19-09-22-10__track1_lgbm_phase_1_closure_attempt_04_campaign_run`;
...
- winning mean component MAPE: `39.545%`;
- winning mean component MAE: `0.001850`;
- winning mean component RMSE: `0.002433`;
...
| --- | --- | ---: | ---: | --- |
| `LGBM` | `paper_reference_grid_search` | 5 | 0.772708 | `{'estimator__learning_rate': 0.2, 'estimator__max_depth': 12, 'estimator__num_leaves': 31, 'estimator__subsample': 0.001}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `LGBM` | `LGBMRegressor` | `paper_reference_grid_search` | 39.545 | 0.001850 | 0.002433 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_1` | `LGBM` | `LGBMRegressor` | 39.545 | 0.001850 | 0.002433 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_1` | `RF / LGBM` | `LGBM` | 39.545 | `matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/lgbm/2026-04-19-09-22-10__track1_lgbm_phase_1_closure_attempt_04_campaign_run/onnx_export`;
