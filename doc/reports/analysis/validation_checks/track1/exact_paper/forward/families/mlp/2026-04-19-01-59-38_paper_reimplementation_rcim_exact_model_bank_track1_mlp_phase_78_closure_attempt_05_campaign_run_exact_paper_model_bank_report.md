...
- run name: `track1_mlp_phase_78_closure_attempt_05`;
- output run name: `track1_mlp_phase_78_closure_attempt_05_campaign_run`;
- run instance id: `2026-04-19-01-59-28__track1_mlp_phase_78_closure_attempt_05_campaign_run`;
...
- winning mean component MAPE: `880.730%`;
- winning mean component MAE: `0.162849`;
- winning mean component RMSE: `0.251243`;
...
| --- | --- | ---: | ---: | --- |
| `MLP` | `paper_reference_grid_search` | 5 | 0.689109 | `{'estimator__activation': 'tanh', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (200, 50), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `MLP` | `MLPRegressor` | `paper_reference_grid_search` | 880.730 | 0.162849 | 0.251243 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_78` | `MLP` | `MLPRegressor` | 880.730 | 0.162849 | 0.251243 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_78` | `HGBM / RF` | `MLP` | 880.730 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/mlp/2026-04-19-01-59-28__track1_mlp_phase_78_closure_attempt_05_campaign_run/onnx_export`;
