...
- run name: `track1_ert_amplitude_78_closure_attempt_02`;
- output run name: `track1_ert_amplitude_78_closure_attempt_02_campaign_run`;
- run instance id: `2026-04-19-04-45-58__track1_ert_amplitude_78_closure_attempt_02_campaign_run`;
...
- winning mean component MAPE: `8.674%`;
...
| --- | --- | ---: | ---: | --- |
| `ERT` | `paper_reference_grid_search` | 5 | 0.992395 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 17, 'estimator__min_samples_split': 2, 'estimator__n_estimators': 100}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ERT` | `ExtraTreesRegressor` | `paper_reference_grid_search` | 8.674 | 0.000033 | 0.000049 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_78` | `ERT` | `ExtraTreesRegressor` | 8.674 | 0.000033 | 0.000049 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_78` | `HGBM / RF` | `ERT` | 8.674 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/ert/2026-04-19-04-45-58__track1_ert_amplitude_78_closure_attempt_02_campaign_run/onnx_export`;
