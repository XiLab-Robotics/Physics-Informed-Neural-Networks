...
- run name: `track1_rf_amplitude_78_closure_attempt_05`;
- output run name: `track1_rf_amplitude_78_closure_attempt_05_campaign_run`;
- run instance id: `2026-04-19-02-31-40__track1_rf_amplitude_78_closure_attempt_05_campaign_run`;
...
- winning mean component MAPE: `10.725%`;
...
| --- | --- | ---: | ---: | --- |
| `RF` | `paper_reference_grid_search` | 5 | 0.992471 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 2, 'estimator__n_estimators': 60}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `RF` | `RandomForestRegressor` | `paper_reference_grid_search` | 10.725 | 0.000032 | 0.000047 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_78` | `RF` | `RandomForestRegressor` | 10.725 | 0.000032 | 0.000047 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_78` | `HGBM / RF` | `RF` | 10.725 | `matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/rf/2026-04-19-02-31-40__track1_rf_amplitude_78_closure_attempt_05_campaign_run/onnx_export`;
