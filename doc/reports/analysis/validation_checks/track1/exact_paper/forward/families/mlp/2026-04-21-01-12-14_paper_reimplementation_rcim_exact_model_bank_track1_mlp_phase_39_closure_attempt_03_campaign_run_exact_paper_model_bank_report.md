...
- run name: `track1_mlp_phase_39_closure_attempt_03`;
- output run name: `track1_mlp_phase_39_closure_attempt_03_campaign_run`;
- run instance id: `2026-04-21-01-12-04__track1_mlp_phase_39_closure_attempt_03_campaign_run`;
...
- winning mean component MAPE: `5.210%`;
- winning mean component MAE: `0.060881`;
- winning mean component RMSE: `0.074276`;
...
| --- | --- | ---: | ---: | --- |
| `MLP` | `paper_reference_grid_search` | 5 | 0.866895 | `{'estimator__activation': 'tanh', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (200, 50), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `MLP` | `MLPRegressor` | `paper_reference_grid_search` | 5.210 | 0.060881 | 0.074276 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_39` | `MLP` | `MLPRegressor` | 5.210 | 0.060881 | 0.074276 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_39` | `HGBM` | `MLP` | 5.210 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/mlp/2026-04-21-01-12-04__track1_mlp_phase_39_closure_attempt_03_campaign_run/onnx_export`;
