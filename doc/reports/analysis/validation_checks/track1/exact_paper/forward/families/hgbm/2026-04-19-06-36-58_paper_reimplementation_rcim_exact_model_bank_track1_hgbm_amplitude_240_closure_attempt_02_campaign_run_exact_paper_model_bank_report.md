...
- run name: `track1_hgbm_amplitude_240_closure_attempt_02`;
- output run name: `track1_hgbm_amplitude_240_closure_attempt_02_campaign_run`;
- run instance id: `2026-04-19-06-36-45__track1_hgbm_amplitude_240_closure_attempt_02_campaign_run`;
...
- winning mean component MAPE: `13.741%`;
- winning mean component MAE: `0.000035`;
- winning mean component RMSE: `0.000059`;
...
| --- | --- | ---: | ---: | --- |
| `HGBM` | `paper_reference_grid_search` | 5 | 0.967564 | `{'estimator__learning_rate': 0.22, 'estimator__max_depth': 10, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 24}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `HGBM` | `HistGradientBoostingRegressor` | `paper_reference_grid_search` | 13.741 | 0.000035 | 0.000059 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_240` | `HGBM` | `HistGradientBoostingRegressor` | 13.741 | 0.000035 | 0.000059 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_240` | `ERT` | `HGBM` | 13.741 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/hgbm/2026-04-19-06-36-45__track1_hgbm_amplitude_240_closure_attempt_02_campaign_run/onnx_export`;
