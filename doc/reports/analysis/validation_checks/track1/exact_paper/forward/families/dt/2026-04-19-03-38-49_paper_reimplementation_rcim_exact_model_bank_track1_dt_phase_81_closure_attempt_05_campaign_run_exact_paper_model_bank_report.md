...
- run name: `track1_dt_phase_81_closure_attempt_05`;
- output run name: `track1_dt_phase_81_closure_attempt_05_campaign_run`;
- run instance id: `2026-04-19-03-38-41__track1_dt_phase_81_closure_attempt_05_campaign_run`;
...
- winning mean component MAPE: `4.607%`;
- winning mean component MAE: `0.053351`;
- winning mean component RMSE: `0.067950`;
...
| --- | --- | ---: | ---: | --- |
| `DT` | `paper_reference_grid_search` | 5 | 0.943731 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 4}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `DT` | `DecisionTreeRegressor` | `paper_reference_grid_search` | 4.607 | 0.053351 | 0.067950 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_81` | `DT` | `DecisionTreeRegressor` | 4.607 | 0.053351 | 0.067950 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_81` | `RF` | `DT` | 4.607 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/dt/2026-04-19-03-38-41__track1_dt_phase_81_closure_attempt_05_campaign_run/onnx_export`;
