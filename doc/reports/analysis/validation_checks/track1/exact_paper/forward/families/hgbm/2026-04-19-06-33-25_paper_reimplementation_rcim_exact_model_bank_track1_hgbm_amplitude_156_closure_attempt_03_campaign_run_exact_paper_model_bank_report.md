...
- run name: `track1_hgbm_amplitude_156_closure_attempt_03`;
- output run name: `track1_hgbm_amplitude_156_closure_attempt_03_campaign_run`;
- run instance id: `2026-04-19-06-33-13__track1_hgbm_amplitude_156_closure_attempt_03_campaign_run`;
...
- winning best params: `{'estimator__learning_rate': 0.22, 'estimator__max_depth': 10, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 24}`;
- winning mean component MAPE: `31.940%`;
- winning mean component MAE: `0.000123`;
- winning mean component RMSE: `0.000309`;
...
| --- | --- | ---: | ---: | --- |
| `HGBM` | `paper_reference_grid_search` | 5 | 0.944774 | `{'estimator__learning_rate': 0.22, 'estimator__max_depth': 10, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 24}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `HGBM` | `HistGradientBoostingRegressor` | `paper_reference_grid_search` | 31.940 | 0.000123 | 0.000309 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_156` | `HGBM` | `HistGradientBoostingRegressor` | 31.940 | 0.000123 | 0.000309 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_156` | `ERT / RF` | `HGBM` | 31.940 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/hgbm/2026-04-19-06-33-13__track1_hgbm_amplitude_156_closure_attempt_03_campaign_run/onnx_export`;
