...
- run name: `track1_hgbm_phase_81_closure_attempt_05`;
- output run name: `track1_hgbm_phase_81_closure_attempt_05_campaign_run`;
- run instance id: `2026-04-19-06-49-22__track1_hgbm_phase_81_closure_attempt_05_campaign_run`;
...
- winning mean component MAPE: `4.317%`;
- winning mean component MAE: `0.047653`;
- winning mean component RMSE: `0.065273`;
...
| --- | --- | ---: | ---: | --- |
| `HGBM` | `paper_reference_grid_search` | 5 | 0.958386 | `{'estimator__learning_rate': 0.21, 'estimator__max_depth': 9, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 26}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `HGBM` | `HistGradientBoostingRegressor` | `paper_reference_grid_search` | 4.317 | 0.047653 | 0.065273 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_81` | `HGBM` | `HistGradientBoostingRegressor` | 4.317 | 0.047653 | 0.065273 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_81` | `RF` | `HGBM` | 4.317 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/hgbm/2026-04-19-06-49-22__track1_hgbm_phase_81_closure_attempt_05_campaign_run/onnx_export`;
