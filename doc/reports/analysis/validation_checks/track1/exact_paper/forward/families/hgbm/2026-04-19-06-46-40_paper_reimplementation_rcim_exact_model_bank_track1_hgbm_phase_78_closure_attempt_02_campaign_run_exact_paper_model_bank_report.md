...
- run name: `track1_hgbm_phase_78_closure_attempt_02`;
- output run name: `track1_hgbm_phase_78_closure_attempt_02_campaign_run`;
- run instance id: `2026-04-19-06-46-28__track1_hgbm_phase_78_closure_attempt_02_campaign_run`;
...
- winning mean component MAPE: `67.224%`;
- winning mean component MAE: `0.080370`;
- winning mean component RMSE: `0.130300`;
...
| --- | --- | ---: | ---: | --- |
| `HGBM` | `paper_reference_grid_search` | 5 | 0.779278 | `{'estimator__learning_rate': 0.21, 'estimator__max_depth': 12, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 26}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `HGBM` | `HistGradientBoostingRegressor` | `paper_reference_grid_search` | 67.224 | 0.080370 | 0.130300 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_78` | `HGBM` | `HistGradientBoostingRegressor` | 67.224 | 0.080370 | 0.130300 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_78` | `HGBM / RF` | `HGBM` | 67.224 | `matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/hgbm/2026-04-19-06-46-28__track1_hgbm_phase_78_closure_attempt_02_campaign_run/onnx_export`;
