...
- run name: `track1_gbm_amplitude_0_closure_attempt_04`;
- output run name: `track1_gbm_amplitude_0_closure_attempt_04_campaign_run`;
- run instance id: `2026-04-19-05-31-52__track1_gbm_amplitude_0_closure_attempt_04_campaign_run`;
...
- winning mean component MAPE: `5.893%`;
- winning mean component MAE: `0.002805`;
- winning mean component RMSE: `0.003471`;
...
| --- | --- | ---: | ---: | --- |
| `GBM` | `paper_reference_grid_search` | 5 | 0.965137 | `{'estimator__criterion': 'squared_error', 'estimator__learning_rate': 0.1, 'estimator__max_depth': 14, 'estimator__min_samples_split': 18, 'estimator__n_estimators': 68}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `GBM` | `GradientBoostingRegressor` | `paper_reference_grid_search` | 5.893 | 0.002805 | 0.003471 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_0` | `GBM` | `GradientBoostingRegressor` | 5.893 | 0.002805 | 0.003471 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_0` | `SVR` | `GBM` | 5.893 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/gbm/2026-04-19-05-31-52__track1_gbm_amplitude_0_closure_attempt_04_campaign_run/onnx_export`;
