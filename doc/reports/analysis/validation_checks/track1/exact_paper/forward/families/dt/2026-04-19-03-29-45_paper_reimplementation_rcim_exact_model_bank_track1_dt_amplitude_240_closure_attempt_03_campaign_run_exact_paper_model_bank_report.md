...
- run name: `track1_dt_amplitude_240_closure_attempt_03`;
- output run name: `track1_dt_amplitude_240_closure_attempt_03_campaign_run`;
- run instance id: `2026-04-19-03-29-37__track1_dt_amplitude_240_closure_attempt_03_campaign_run`;
...
- winning mean component MAPE: `14.535%`;
...
| --- | --- | ---: | ---: | --- |
| `DT` | `paper_reference_grid_search` | 5 | 0.985511 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 4}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `DT` | `DecisionTreeRegressor` | `paper_reference_grid_search` | 14.535 | 0.000043 | 0.000069 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_240` | `DT` | `DecisionTreeRegressor` | 14.535 | 0.000043 | 0.000069 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_240` | `ERT` | `DT` | 14.535 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/dt/2026-04-19-03-29-37__track1_dt_amplitude_240_closure_attempt_03_campaign_run/onnx_export`;
