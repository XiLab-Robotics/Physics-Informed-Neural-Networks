...
- run name: `track1_mlp_phase_156_closure_attempt_01`;
- output run name: `track1_mlp_phase_156_closure_attempt_01_campaign_run`;
- run instance id: `2026-04-19-02-01-36__track1_mlp_phase_156_closure_attempt_01_campaign_run`;
...
- winning mean component MAPE: `113.942%`;
- winning mean component MAE: `1.540067`;
- winning mean component RMSE: `1.934818`;
...
| --- | --- | ---: | ---: | --- |
| `MLP` | `paper_reference_grid_search` | 5 | 0.184887 | `{'estimator__activation': 'relu', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (100,), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `MLP` | `MLPRegressor` | `paper_reference_grid_search` | 113.942 | 1.540067 | 1.934818 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_156` | `MLP` | `MLPRegressor` | 113.942 | 1.540067 | 1.934818 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_156` | `ERT / RF` | `MLP` | 113.942 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/mlp/2026-04-19-02-01-36__track1_mlp_phase_156_closure_attempt_01_campaign_run/onnx_export`;
