...
- run instance id: `2026-04-19-01-42-34__track1_mlp_amplitude_40_closure_attempt_03_campaign_run`;
...
- winning mean component MAPE: `1602.622%`;
- winning mean component MAE: `0.013181`;
- winning mean component RMSE: `0.022405`;
...
| --- | --- | ---: | ---: | --- |
| `MLP` | `paper_reference_grid_search` | 5 | -97940.016635 | `{'estimator__activation': 'tanh', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (200, 50), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `MLP` | `MLPRegressor` | `paper_reference_grid_search` | 1602.622 | 0.013181 | 0.022405 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_40` | `MLP` | `MLPRegressor` | 1602.622 | 0.013181 | 0.022405 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_40` | `ERT / GBM` | `MLP` | 1602.622 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/mlp/2026-04-19-01-42-34__track1_mlp_amplitude_40_closure_attempt_03_campaign_run/onnx_export`;
