...
- run name: `track1_mlp_amplitude_156_final_closure_attempt_19`;
- output run name: `track1_mlp_amplitude_156_final_closure_attempt_19_campaign_run`;
- run instance id: `2026-04-22-00-00-35__track1_mlp_amplitude_156_final_closure_attempt_19_campaign_run`;
...
- winning best params: `{'estimator__activation': 'tanh', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (100, 50), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}`;
- winning mean component MAPE: `6279.353%`;
- winning mean component MAE: `0.007432`;
- winning mean component RMSE: `0.013824`;
...
| --- | --- | ---: | ---: | --- |
| `MLP` | `paper_reference_grid_search` | 5 | -407.036722 | `{'estimator__activation': 'tanh', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (100, 50), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `MLP` | `MLPRegressor` | `paper_reference_grid_search` | 6279.353 | 0.007432 | 0.013824 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_156` | `MLP` | `MLPRegressor` | 6279.353 | 0.007432 | 0.013824 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_156` | `ERT / RF` | `MLP` | 6279.353 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/mlp/2026-04-22-00-00-35__track1_mlp_amplitude_156_final_closure_attempt_19_campaign_run/onnx_export`;
