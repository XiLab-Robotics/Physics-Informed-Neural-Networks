...
- run name: `track1_lgbm_phase_81_closure_attempt_01`;
- output run name: `track1_lgbm_phase_81_closure_attempt_01_campaign_run`;
- run instance id: `2026-04-19-10-02-45__track1_lgbm_phase_81_closure_attempt_01_campaign_run`;
...
- winning mean component MAPE: `4.619%`;
- winning mean component MAE: `0.047014`;
- winning mean component RMSE: `0.066971`;
...
| --- | --- | ---: | ---: | --- |
| `LGBM` | `paper_reference_grid_search` | 5 | 0.965579 | `{'estimator__learning_rate': 0.39, 'estimator__max_depth': 11, 'estimator__num_leaves': 31, 'estimator__subsample': 0.001}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `LGBM` | `LGBMRegressor` | `paper_reference_grid_search` | 4.619 | 0.047014 | 0.066971 |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/lgbm/2026-04-19-10-02-45__track1_lgbm_phase_81_closure_attempt_01_campaign_run/onnx_export`;
