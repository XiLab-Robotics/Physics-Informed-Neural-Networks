...
- run name: `track1_et_phase_240_closure_attempt_12`;
- output run name: `track1_et_phase_240_closure_attempt_12_campaign_run`;
- run instance id: `2026-04-21-10-23-48__track1_et_phase_240_closure_attempt_12_campaign_run`;
...
- winning mean component MAPE: `114.543%`;
- winning mean component MAE: `0.308704`;
- winning mean component RMSE: `1.028121`;
...
| --- | --- | ---: | ---: | --- |
| `ET` | `paper_reference_grid_search` | 5 | 0.480745 | `{'estimator__criterion': 'absolute_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 2}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ET` | `ExtraTreeRegressor` | `paper_reference_grid_search` | 114.543 | 0.308704 | 1.028121 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_240` | `ET` | `ExtraTreeRegressor` | 114.543 | 0.308704 | 1.028121 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_240` | `ERT` | `ET` | 114.543 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/et/2026-04-21-10-23-48__track1_et_phase_240_closure_attempt_12_campaign_run/onnx_export`;
