...
- run name: `track1_xgbm_amplitude_240_closure_attempt_04`;
- output run name: `track1_xgbm_amplitude_240_closure_attempt_04_campaign_run`;
- run instance id: `2026-04-19-07-21-16__track1_xgbm_amplitude_240_closure_attempt_04_campaign_run`;
...
- winning mean component MAPE: `63.058%`;
- winning mean component MAE: `0.000167`;
- winning mean component RMSE: `0.000279`;
...
| --- | --- | ---: | ---: | --- |
| `XGBM` | `paper_reference_grid_search` | 5 | 0.706298 | `{'estimator__colsample_bytree': 0.8, 'estimator__learning_rate': 0.3, 'estimator__max_depth': 14}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `XGBM` | `XGBRegressor` | `paper_reference_grid_search` | 63.058 | 0.000167 | 0.000279 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_240` | `XGBM` | `XGBRegressor` | 63.058 | 0.000167 | 0.000279 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_240` | `ERT` | `XGBM` | 63.058 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/xgbm/2026-04-19-07-21-16__track1_xgbm_amplitude_240_closure_attempt_04_campaign_run/onnx_export`;
