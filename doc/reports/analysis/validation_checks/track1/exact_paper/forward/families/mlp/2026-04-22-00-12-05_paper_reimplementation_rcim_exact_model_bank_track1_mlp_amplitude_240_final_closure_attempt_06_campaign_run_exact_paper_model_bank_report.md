...
- run name: `track1_mlp_amplitude_240_final_closure_attempt_06`;
- output run name: `track1_mlp_amplitude_240_final_closure_attempt_06_campaign_run`;
- run instance id: `2026-04-22-00-11-55__track1_mlp_amplitude_240_final_closure_attempt_06_campaign_run`;
...
- winning mean component MAPE: `4809.904%`;
- winning mean component MAE: `0.010090`;
- winning mean component RMSE: `0.019928`;
...
| --- | --- | ---: | ---: | --- |
| `MLP` | `paper_reference_grid_search` | 5 | -1874.115726 | `{'estimator__activation': 'tanh', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (200, 50), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `MLP` | `MLPRegressor` | `paper_reference_grid_search` | 4809.904 | 0.010090 | 0.019928 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_240` | `MLP` | `MLPRegressor` | 4809.904 | 0.010090 | 0.019928 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_240` | `ERT` | `MLP` | 4809.904 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/mlp/2026-04-22-00-11-55__track1_mlp_amplitude_240_final_closure_attempt_06_campaign_run/onnx_export`;
