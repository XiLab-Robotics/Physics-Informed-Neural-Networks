...
- run name: `track1_hgbm_phase_240_closure_attempt_06`;
- output run name: `track1_hgbm_phase_240_closure_attempt_06_campaign_run`;
- run instance id: `2026-04-19-06-55-30__track1_hgbm_phase_240_closure_attempt_06_campaign_run`;
...
- winning mean component MAPE: `28.487%`;
- winning mean component MAE: `0.380073`;
- winning mean component RMSE: `0.851485`;
...
| --- | --- | ---: | ---: | --- |
| `HGBM` | `paper_reference_grid_search` | 5 | 0.424971 | `{'estimator__learning_rate': 0.18, 'estimator__max_depth': 12, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 24}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `HGBM` | `HistGradientBoostingRegressor` | `paper_reference_grid_search` | 28.487 | 0.380073 | 0.851485 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_240` | `HGBM` | `HistGradientBoostingRegressor` | 28.487 | 0.380073 | 0.851485 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_240` | `ERT` | `HGBM` | 28.487 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/hgbm/2026-04-19-06-55-30__track1_hgbm_phase_240_closure_attempt_06_campaign_run/onnx_export`;
