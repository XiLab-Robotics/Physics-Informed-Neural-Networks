...
- run instance id: `2026-04-18-15-48-17__track1_xgbm_phase_full_matrix_campaign_run`;
...
- winning best params: `{'estimator__colsample_bytree': 0.8, 'estimator__learning_rate': 0.2, 'estimator__max_depth': 16}`;
- winning mean component MAPE: `82.455%`;
- winning mean component MAE: `0.228464`;
- winning mean component RMSE: `0.390978`;
...
| --- | --- | ---: | ---: | --- |
| `XGBM` | `paper_reference_grid_search` | 5 | 0.723108 | `{'estimator__colsample_bytree': 0.8, 'estimator__learning_rate': 0.2, 'estimator__max_depth': 16}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `XGBM` | `XGBRegressor` | `paper_reference_grid_search` | 82.455 | 0.228464 | 0.390978 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_1` | `XGBM` | `XGBRegressor` | 25.147 | 0.002175 | 0.003325 |
| `fft_y_Fw_filtered_phase_3` | `XGBM` | `XGBRegressor` | 1.426 | 0.025401 | 0.035586 |
| `fft_y_Fw_filtered_phase_39` | `XGBM` | `XGBRegressor` | 2.236 | 0.027801 | 0.043762 |
| `fft_y_Fw_filtered_phase_40` | `XGBM` | `XGBRegressor` | 110.360 | 0.056293 | 0.084622 |
| `fft_y_Fw_filtered_phase_78` | `XGBM` | `XGBRegressor` | 466.964 | 0.110507 | 0.180507 |
| `fft_y_Fw_filtered_phase_81` | `XGBM` | `XGBRegressor` | 7.617 | 0.082818 | 0.115478 |
| `fft_y_Fw_filtered_phase_156` | `XGBM` | `XGBRegressor` | 62.541 | 0.815807 | 1.239972 |
| `fft_y_Fw_filtered_phase_162` | `XGBM` | `XGBRegressor` | 24.430 | 0.503488 | 0.905250 |
| `fft_y_Fw_filtered_phase_240` | `XGBM` | `XGBRegressor` | 41.379 | 0.431884 | 0.910301 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_1` | `RF / LGBM` | `XGBM` | 25.147 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_3` | `HGBM` | `XGBM` | 1.426 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_39` | `HGBM` | `XGBM` | 2.236 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_40` | `ERT / GBM` | `XGBM` | 110.360 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_78` | `HGBM / RF` | `XGBM` | 466.964 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_81` | `RF` | `XGBM` | 7.617 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_156` | `ERT / RF` | `XGBM` | 62.541 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_162` | `ERT` | `XGBM` | 24.430 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_240` | `ERT` | `XGBM` | 41.379 | `not_matched_expected_family_direction` |
...
| `Repo Best MAE` | 0.002175 | 0.0254 | 0.0278 | 0.0563 | 0.1105 | 0.0828 | 0.8158 | 0.5035 | 0.4319 |
...
| `Gap Vs Paper` | 3.75e-04 | 0.005401 | 0.006801 | 0.0203 | 0.0365 | 0.0298 | 0.3058 | 0.3035 | 0.2019 |
...
| `Repo Best Family` | `XGBM` | `XGBM` | `XGBM` | `XGBM` | `XGBM` | `XGBM` | `XGBM` | `XGBM` | `XGBM` |
| `Repo Best RMSE` | 0.003325 | 0.0356 | 0.0438 | 0.0846 | 0.1805 | 0.1155 | 1.240 | 0.9052 | 0.9103 |
...
| `Gap Vs Paper` | 8.25e-04 | 0.006586 | 0.0168 | 0.0296 | 0.0205 | 0.0335 | 0.0400 | 0.2652 | 0.3303 |
| `Status` | `above_paper_target` | `above_paper_target` | `above_paper_target` | `above_paper_target` | `above_paper_target` | `above_paper_target` | `above_paper_target` | `above_paper_target` | `above_paper_target` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/full_matrix/xgbm/2026-04-18-15-48-17__track1_xgbm_phase_full_matrix_campaign_run/onnx_export`;
