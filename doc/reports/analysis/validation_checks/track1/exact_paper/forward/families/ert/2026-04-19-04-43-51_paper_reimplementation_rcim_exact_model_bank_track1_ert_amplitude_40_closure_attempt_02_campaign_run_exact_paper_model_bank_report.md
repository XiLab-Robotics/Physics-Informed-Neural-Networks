...
- run name: `track1_ert_amplitude_40_closure_attempt_02`;
- output run name: `track1_ert_amplitude_40_closure_attempt_02_campaign_run`;
- run instance id: `2026-04-19-04-43-33__track1_ert_amplitude_40_closure_attempt_02_campaign_run`;
...
- winning best params: `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 15, 'estimator__min_samples_split': 5, 'estimator__n_estimators': 60}`;
- winning mean component MAPE: `2.776%`;
- winning mean component MAE: `0.000022`;
- winning mean component RMSE: `0.000030`;
...
| --- | --- | ---: | ---: | --- |
| `ERT` | `paper_reference_grid_search` | 5 | 0.810437 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 15, 'estimator__min_samples_split': 5, 'estimator__n_estimators': 60}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ERT` | `ExtraTreesRegressor` | `paper_reference_grid_search` | 2.776 | 0.000022 | 0.000030 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_40` | `ERT` | `ExtraTreesRegressor` | 2.776 | 0.000022 | 0.000030 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_40` | `ERT / GBM` | `ERT` | 2.776 | `matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/ert/2026-04-19-04-43-33__track1_ert_amplitude_40_closure_attempt_02_campaign_run/onnx_export`;
