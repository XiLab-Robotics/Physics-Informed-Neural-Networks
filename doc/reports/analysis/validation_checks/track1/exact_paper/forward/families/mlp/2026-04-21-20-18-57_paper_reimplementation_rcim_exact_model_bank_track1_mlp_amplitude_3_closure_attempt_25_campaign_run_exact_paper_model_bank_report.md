...
- run name: `track1_mlp_amplitude_3_closure_attempt_25`;
- output run name: `track1_mlp_amplitude_3_closure_attempt_25_campaign_run`;
- run instance id: `2026-04-21-20-18-46__track1_mlp_amplitude_3_closure_attempt_25_campaign_run`;
...
- winning mean component MAPE: `1555.234%`;
- winning mean component MAE: `0.011373`;
- winning mean component RMSE: `0.018807`;
...
| --- | --- | ---: | ---: | --- |
| `MLP` | `paper_reference_grid_search` | 5 | -33733.839161 | `{'estimator__activation': 'tanh', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (200, 50), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `MLP` | `MLPRegressor` | `paper_reference_grid_search` | 1555.234 | 0.011373 | 0.018807 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_3` | `MLP` | `MLPRegressor` | 1555.234 | 0.011373 | 0.018807 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_3` | `HGBM` | `MLP` | 1555.234 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/mlp/2026-04-21-20-18-46__track1_mlp_amplitude_3_closure_attempt_25_campaign_run/onnx_export`;
