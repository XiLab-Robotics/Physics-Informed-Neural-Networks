...
- run name: `track1_dt_phase_156_closure_attempt_06`;
- output run name: `track1_dt_phase_156_closure_attempt_06_campaign_run`;
- run instance id: `2026-04-19-03-40-21__track1_dt_phase_156_closure_attempt_06_campaign_run`;
...
- winning mean component MAPE: `42.276%`;
- winning mean component MAE: `0.532498`;
- winning mean component RMSE: `1.280549`;
...
| --- | --- | ---: | ---: | --- |
| `DT` | `paper_reference_grid_search` | 5 | 0.678815 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 15, 'estimator__min_samples_split': 7}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `DT` | `DecisionTreeRegressor` | `paper_reference_grid_search` | 42.276 | 0.532498 | 1.280549 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_156` | `DT` | `DecisionTreeRegressor` | 42.276 | 0.532498 | 1.280549 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_156` | `ERT / RF` | `DT` | 42.276 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/dt/2026-04-19-03-40-21__track1_dt_phase_156_closure_attempt_06_campaign_run/onnx_export`;
