...
- run name: `track1_ert_amplitude_162_closure_attempt_24`;
- output run name: `track1_ert_amplitude_162_closure_attempt_24_campaign_run`;
- run instance id: `2026-04-21-10-51-31__track1_ert_amplitude_162_closure_attempt_24_campaign_run`;
...
- winning mean component MAPE: `8.464%`;
- winning mean component MAE: `0.000050`;
...
| --- | --- | ---: | ---: | --- |
| `ERT` | `paper_reference_grid_search` | 5 | 0.990201 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 16, 'estimator__min_samples_split': 3, 'estimator__n_estimators': 20}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ERT` | `ExtraTreesRegressor` | `paper_reference_grid_search` | 8.464 | 0.000050 | 0.000213 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_162` | `ERT` | `ExtraTreesRegressor` | 8.464 | 0.000050 | 0.000213 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_162` | `ERT` | `ERT` | 8.464 | `matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/ert/2026-04-21-10-51-31__track1_ert_amplitude_162_closure_attempt_24_campaign_run/onnx_export`;
