...
- run name: `track1_lgbm_phase_39_closure_attempt_04`;
- output run name: `track1_lgbm_phase_39_closure_attempt_04_campaign_run`;
- run instance id: `2026-04-19-09-40-15__track1_lgbm_phase_39_closure_attempt_04_campaign_run`;
...
- winning mean component MAPE: `1.525%`;
- winning mean component MAE: `0.019243`;
- winning mean component RMSE: `0.027692`;
...
| --- | --- | ---: | ---: | --- |
| `LGBM` | `paper_reference_grid_search` | 5 | 0.983273 | `{'estimator__learning_rate': 0.58, 'estimator__max_depth': 14, 'estimator__num_leaves': 31, 'estimator__subsample': 0.001}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `LGBM` | `LGBMRegressor` | `paper_reference_grid_search` | 1.525 | 0.019243 | 0.027692 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_39` | `LGBM` | `LGBMRegressor` | 1.525 | 0.019243 | 0.027692 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_39` | `HGBM` | `LGBM` | 1.525 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/lgbm/2026-04-19-09-40-15__track1_lgbm_phase_39_closure_attempt_04_campaign_run/onnx_export`;
