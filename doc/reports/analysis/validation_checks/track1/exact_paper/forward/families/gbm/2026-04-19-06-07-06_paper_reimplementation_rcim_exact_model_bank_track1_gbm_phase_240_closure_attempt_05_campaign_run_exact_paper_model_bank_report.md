...
- run name: `track1_gbm_phase_240_closure_attempt_05`;
- output run name: `track1_gbm_phase_240_closure_attempt_05_campaign_run`;
- run instance id: `2026-04-19-06-06-53__track1_gbm_phase_240_closure_attempt_05_campaign_run`;
...
- winning mean component MAPE: `15.212%`;
- winning mean component MAE: `0.270860`;
- winning mean component RMSE: `0.742407`;
...
| --- | --- | ---: | ---: | --- |
| `GBM` | `paper_reference_grid_search` | 5 | 0.527472 | `{'estimator__criterion': 'squared_error', 'estimator__learning_rate': 0.1, 'estimator__max_depth': 16, 'estimator__min_samples_split': 16, 'estimator__n_estimators': 68}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `GBM` | `GradientBoostingRegressor` | `paper_reference_grid_search` | 15.212 | 0.270860 | 0.742407 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_240` | `GBM` | `GradientBoostingRegressor` | 15.212 | 0.270860 | 0.742407 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_240` | `ERT` | `GBM` | 15.212 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/gbm/2026-04-19-06-06-53__track1_gbm_phase_240_closure_attempt_05_campaign_run/onnx_export`;
