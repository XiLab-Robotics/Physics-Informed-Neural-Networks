...
- run name: `track1_lgbm_amplitude_162_closure_attempt_02`;
- output run name: `track1_lgbm_amplitude_162_closure_attempt_02_campaign_run`;
- run instance id: `2026-04-19-09-01-10__track1_lgbm_amplitude_162_closure_attempt_02_campaign_run`;
...
- winning mean component MAPE: `30.247%`;
- winning mean component MAE: `0.000099`;
- winning mean component RMSE: `0.000209`;
...
| --- | --- | ---: | ---: | --- |
| `LGBM` | `paper_reference_grid_search` | 5 | 0.972678 | `{'estimator__learning_rate': 0.77, 'estimator__max_depth': 11, 'estimator__num_leaves': 31, 'estimator__subsample': 0.001}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `LGBM` | `LGBMRegressor` | `paper_reference_grid_search` | 30.247 | 0.000099 | 0.000209 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_162` | `LGBM` | `LGBMRegressor` | 30.247 | 0.000099 | 0.000209 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_162` | `ERT` | `LGBM` | 30.247 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/lgbm/2026-04-19-09-01-10__track1_lgbm_amplitude_162_closure_attempt_02_campaign_run/onnx_export`;
