...
- run name: `track1_mlp_amplitude_156_final_closure_attempt_24`;
- output run name: `track1_mlp_amplitude_156_final_closure_attempt_24_campaign_run`;
- run instance id: `2026-04-22-00-01-59__track1_mlp_amplitude_156_final_closure_attempt_24_campaign_run`;
...
- winning mean component MAPE: `11593.824%`;
- winning mean component MAE: `0.009745`;
- winning mean component RMSE: `0.017009`;
...
| --- | --- | ---: | ---: | --- |
| `MLP` | `paper_reference_grid_search` | 5 | -192.674322 | `{'estimator__activation': 'tanh', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (200, 50), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `MLP` | `MLPRegressor` | `paper_reference_grid_search` | 11593.824 | 0.009745 | 0.017009 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_156` | `MLP` | `MLPRegressor` | 11593.824 | 0.009745 | 0.017009 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_156` | `ERT / RF` | `MLP` | 11593.824 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/mlp/2026-04-22-00-01-59__track1_mlp_amplitude_156_final_closure_attempt_24_campaign_run/onnx_export`;
