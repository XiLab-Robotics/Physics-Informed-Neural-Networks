...
- run name: `track1_et_phase_162_closure_attempt_04`;
- output run name: `track1_et_phase_162_closure_attempt_04_campaign_run`;
- run instance id: `2026-04-19-04-19-55__track1_et_phase_162_closure_attempt_04_campaign_run`;
...
- winning mean component MAPE: `11.903%`;
- winning mean component MAE: `0.293286`;
- winning mean component RMSE: `0.979942`;
...
| --- | --- | ---: | ---: | --- |
| `ET` | `paper_reference_grid_search` | 5 | 0.633965 | `{'estimator__criterion': 'absolute_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 5}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ET` | `ExtraTreeRegressor` | `paper_reference_grid_search` | 11.903 | 0.293286 | 0.979942 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_162` | `ET` | `ExtraTreeRegressor` | 11.903 | 0.293286 | 0.979942 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_162` | `ERT` | `ET` | 11.903 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/et/2026-04-19-04-19-55__track1_et_phase_162_closure_attempt_04_campaign_run/onnx_export`;
