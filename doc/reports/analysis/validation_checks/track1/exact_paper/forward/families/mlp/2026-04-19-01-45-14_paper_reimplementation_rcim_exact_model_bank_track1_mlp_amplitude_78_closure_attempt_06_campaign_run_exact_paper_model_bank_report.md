...
- run name: `track1_mlp_amplitude_78_closure_attempt_06`;
- output run name: `track1_mlp_amplitude_78_closure_attempt_06_campaign_run`;
- run instance id: `2026-04-19-01-45-05__track1_mlp_amplitude_78_closure_attempt_06_campaign_run`;
...
- winning mean component MAPE: `5276.532%`;
- winning mean component MAE: `0.018013`;
- winning mean component RMSE: `0.032609`;
...
| --- | --- | ---: | ---: | --- |
| `MLP` | `paper_reference_grid_search` | 5 | -1396.785740 | `{'estimator__activation': 'tanh', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (200, 50), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `MLP` | `MLPRegressor` | `paper_reference_grid_search` | 5276.532 | 0.018013 | 0.032609 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_78` | `MLP` | `MLPRegressor` | 5276.532 | 0.018013 | 0.032609 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_78` | `HGBM / RF` | `MLP` | 5276.532 | `not_matched_expected_family_direction` |
...
| `Repo Best RMSE` | - | - | - | - | - | 0.0326 | - | - | - | - |
| `Paper Best Family` | - | - | - | - | - | `HGBM` | - | - | - | - |
| `Paper Target RMSE` | - | - | - | - | - | 4.50e-05 | - | - | - | - |
| `Gap Vs Paper` | - | - | - | - | - | 0.0326 | - | - | - | - |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/mlp/2026-04-19-01-45-05__track1_mlp_amplitude_78_closure_attempt_06_campaign_run/onnx_export`;
