...
- run name: `track1_xgbm_amplitude_81_closure_attempt_26`;
- output run name: `track1_xgbm_amplitude_81_closure_attempt_26_campaign_run`;
- run instance id: `2026-04-21-12-20-19__track1_xgbm_amplitude_81_closure_attempt_26_campaign_run`;
...
- winning mean component MAPE: `14.423%`;
...
| --- | --- | ---: | ---: | --- |
| `XGBM` | `paper_reference_grid_search` | 5 | -0.006421 | `{'estimator__colsample_bytree': 0.3, 'estimator__learning_rate': 0.01, 'estimator__max_depth': 14}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `XGBM` | `XGBRegressor` | `paper_reference_grid_search` | 14.423 | 0.000044 | 0.000057 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_81` | `XGBM` | `XGBRegressor` | 14.423 | 0.000044 | 0.000057 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_81` | `RF` | `XGBM` | 14.423 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/xgbm/2026-04-21-12-20-19__track1_xgbm_amplitude_81_closure_attempt_26_campaign_run/onnx_export`;
