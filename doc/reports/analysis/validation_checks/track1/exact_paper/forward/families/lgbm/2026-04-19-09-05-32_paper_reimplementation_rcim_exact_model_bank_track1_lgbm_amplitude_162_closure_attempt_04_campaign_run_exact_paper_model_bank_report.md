...
- run name: `track1_lgbm_amplitude_162_closure_attempt_04`;
- output run name: `track1_lgbm_amplitude_162_closure_attempt_04_campaign_run`;
- run instance id: `2026-04-19-09-04-09__track1_lgbm_amplitude_162_closure_attempt_04_campaign_run`;
...
- winning best params: `{'estimator__learning_rate': 0.77, 'estimator__max_depth': 14, 'estimator__num_leaves': 31, 'estimator__subsample': 0.001}`;
- winning mean component MAPE: `27.866%`;
- winning mean component MAE: `0.000123`;
- winning mean component RMSE: `0.000411`;
...
| --- | --- | ---: | ---: | --- |
| `LGBM` | `paper_reference_grid_search` | 5 | 0.962523 | `{'estimator__learning_rate': 0.77, 'estimator__max_depth': 14, 'estimator__num_leaves': 31, 'estimator__subsample': 0.001}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `LGBM` | `LGBMRegressor` | `paper_reference_grid_search` | 27.866 | 0.000123 | 0.000411 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_162` | `LGBM` | `LGBMRegressor` | 27.866 | 0.000123 | 0.000411 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_162` | `ERT` | `LGBM` | 27.866 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/lgbm/2026-04-19-09-04-09__track1_lgbm_amplitude_162_closure_attempt_04_campaign_run/onnx_export`;
