...
- run name: `track1_hgbm_phase_240_closure_attempt_01`;
- output run name: `track1_hgbm_phase_240_closure_attempt_01_campaign_run`;
- run instance id: `2026-04-19-06-53-54__track1_hgbm_phase_240_closure_attempt_01_campaign_run`;
...
- winning best params: `{'estimator__learning_rate': 0.21, 'estimator__max_depth': 9, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 26}`;
- winning mean component MAPE: `31.616%`;
- winning mean component MAE: `0.416176`;
- winning mean component RMSE: `0.915440`;
...
| --- | --- | ---: | ---: | --- |
| `HGBM` | `paper_reference_grid_search` | 5 | 0.509576 | `{'estimator__learning_rate': 0.21, 'estimator__max_depth': 9, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 26}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `HGBM` | `HistGradientBoostingRegressor` | `paper_reference_grid_search` | 31.616 | 0.416176 | 0.915440 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_240` | `HGBM` | `HistGradientBoostingRegressor` | 31.616 | 0.416176 | 0.915440 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_240` | `ERT` | `HGBM` | 31.616 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/hgbm/2026-04-19-06-53-54__track1_hgbm_phase_240_closure_attempt_01_campaign_run/onnx_export`;
