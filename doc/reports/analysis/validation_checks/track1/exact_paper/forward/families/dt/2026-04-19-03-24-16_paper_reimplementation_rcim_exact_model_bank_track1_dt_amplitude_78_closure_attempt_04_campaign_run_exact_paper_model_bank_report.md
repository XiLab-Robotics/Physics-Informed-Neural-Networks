...
- run name: `track1_dt_amplitude_78_closure_attempt_04`;
- output run name: `track1_dt_amplitude_78_closure_attempt_04_campaign_run`;
- run instance id: `2026-04-19-03-24-09__track1_dt_amplitude_78_closure_attempt_04_campaign_run`;
...
- winning mean component MAPE: `13.137%`;
...
| --- | --- | ---: | ---: | --- |
| `DT` | `paper_reference_grid_search` | 5 | 0.985376 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 4}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `DT` | `DecisionTreeRegressor` | `paper_reference_grid_search` | 13.137 | 0.000049 | 0.000072 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_78` | `DT` | `DecisionTreeRegressor` | 13.137 | 0.000049 | 0.000072 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_78` | `HGBM / RF` | `DT` | 13.137 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/dt/2026-04-19-03-24-09__track1_dt_amplitude_78_closure_attempt_04_campaign_run/onnx_export`;
