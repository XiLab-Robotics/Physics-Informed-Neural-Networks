...
- run name: `track1_dt_amplitude_162_closure_attempt_03`;
- output run name: `track1_dt_amplitude_162_closure_attempt_03_campaign_run`;
- run instance id: `2026-04-19-03-28-11__track1_dt_amplitude_162_closure_attempt_03_campaign_run`;
...
- winning mean component MAPE: `11.733%`;
- winning mean component MAE: `0.000087`;
- winning mean component RMSE: `0.000336`;
...
| --- | --- | ---: | ---: | --- |
| `DT` | `paper_reference_grid_search` | 5 | 0.992435 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 15, 'estimator__min_samples_split': 5}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `DT` | `DecisionTreeRegressor` | `paper_reference_grid_search` | 11.733 | 0.000087 | 0.000336 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_162` | `DT` | `DecisionTreeRegressor` | 11.733 | 0.000087 | 0.000336 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_162` | `ERT` | `DT` | 11.733 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/dt/2026-04-19-03-28-11__track1_dt_amplitude_162_closure_attempt_03_campaign_run/onnx_export`;
