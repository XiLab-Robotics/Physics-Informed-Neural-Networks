...
- run name: `track1_gbm_phase_81_closure_attempt_01`;
- output run name: `track1_gbm_phase_81_closure_attempt_01_campaign_run`;
- run instance id: `2026-04-19-05-59-48__track1_gbm_phase_81_closure_attempt_01_campaign_run`;
...
- winning best params: `{'estimator__criterion': 'squared_error', 'estimator__learning_rate': 0.1, 'estimator__max_depth': 16, 'estimator__min_samples_split': 12, 'estimator__n_estimators': 84}`;
- winning mean component MAPE: `4.247%`;
- winning mean component MAE: `0.044539`;
- winning mean component RMSE: `0.064328`;
...
| --- | --- | ---: | ---: | --- |
| `GBM` | `paper_reference_grid_search` | 5 | 0.967902 | `{'estimator__criterion': 'squared_error', 'estimator__learning_rate': 0.1, 'estimator__max_depth': 16, 'estimator__min_samples_split': 12, 'estimator__n_estimators': 84}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `GBM` | `GradientBoostingRegressor` | `paper_reference_grid_search` | 4.247 | 0.044539 | 0.064328 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_81` | `GBM` | `GradientBoostingRegressor` | 4.247 | 0.044539 | 0.064328 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_81` | `RF` | `GBM` | 4.247 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/gbm/2026-04-19-05-59-48__track1_gbm_phase_81_closure_attempt_01_campaign_run/onnx_export`;
