...
- run name: `track1_hgbm_amplitude_240_closure_attempt_06`;
- output run name: `track1_hgbm_amplitude_240_closure_attempt_06_campaign_run`;
- run instance id: `2026-04-19-06-38-03__track1_hgbm_amplitude_240_closure_attempt_06_campaign_run`;
...
- winning best params: `{'estimator__learning_rate': 0.22, 'estimator__max_depth': 13, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 24}`;
- winning mean component MAPE: `15.787%`;
- winning mean component MAE: `0.000039`;
- winning mean component RMSE: `0.000082`;
...
| --- | --- | ---: | ---: | --- |
| `HGBM` | `paper_reference_grid_search` | 5 | 0.925013 | `{'estimator__learning_rate': 0.22, 'estimator__max_depth': 13, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 24}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `HGBM` | `HistGradientBoostingRegressor` | `paper_reference_grid_search` | 15.787 | 0.000039 | 0.000082 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_240` | `HGBM` | `HistGradientBoostingRegressor` | 15.787 | 0.000039 | 0.000082 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_240` | `ERT` | `HGBM` | 15.787 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/hgbm/2026-04-19-06-38-03__track1_hgbm_amplitude_240_closure_attempt_06_campaign_run/onnx_export`;
