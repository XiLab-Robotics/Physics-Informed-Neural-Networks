...
- run name: `track1_xgbm_phase_39_closure_attempt_02`;
- output run name: `track1_xgbm_phase_39_closure_attempt_02_campaign_run`;
- run instance id: `2026-04-19-07-25-12__track1_xgbm_phase_39_closure_attempt_02_campaign_run`;
...
- winning mean component MAPE: `2.364%`;
- winning mean component MAE: `0.029016`;
- winning mean component RMSE: `0.043516`;
...
| --- | --- | ---: | ---: | --- |
| `XGBM` | `paper_reference_grid_search` | 5 | 0.972788 | `{'estimator__colsample_bytree': 0.8, 'estimator__learning_rate': 0.2, 'estimator__max_depth': 14}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `XGBM` | `XGBRegressor` | `paper_reference_grid_search` | 2.364 | 0.029016 | 0.043516 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_39` | `XGBM` | `XGBRegressor` | 2.364 | 0.029016 | 0.043516 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_39` | `HGBM` | `XGBM` | 2.364 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/xgbm/2026-04-19-07-25-12__track1_xgbm_phase_39_closure_attempt_02_campaign_run/onnx_export`;
