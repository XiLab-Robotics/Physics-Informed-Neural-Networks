...
- run name: `track1_ert_phase_40_closure_attempt_06`;
- output run name: `track1_ert_phase_40_closure_attempt_06_campaign_run`;
- run instance id: `2026-04-19-05-06-56__track1_ert_phase_40_closure_attempt_06_campaign_run`;
...
- winning best params: `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 4, 'estimator__n_estimators': 40}`;
- winning mean component MAPE: `49.090%`;
- winning mean component MAE: `0.035727`;
- winning mean component RMSE: `0.056452`;
...
| --- | --- | ---: | ---: | --- |
| `ERT` | `paper_reference_grid_search` | 5 | 0.755569 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 4, 'estimator__n_estimators': 40}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ERT` | `ExtraTreesRegressor` | `paper_reference_grid_search` | 49.090 | 0.035727 | 0.056452 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_40` | `ERT` | `ExtraTreesRegressor` | 49.090 | 0.035727 | 0.056452 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_40` | `ERT / GBM` | `ERT` | 49.090 | `matched_expected_family_direction` |
...
| `Repo Best Family` | - | - | - | `ERT` | - | - | - | - | - |
| `Repo Best RMSE` | - | - | - | 0.0565 | - | - | - | - | - |
| `Paper Best Family` | - | - | - | `GBM` | - | - | - | - | - |
| `Paper Target RMSE` | - | - | - | 0.0550 | - | - | - | - | - |
| `Gap Vs Paper` | - | - | - | 0.001452 | - | - | - | - | - |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/ert/2026-04-19-05-06-56__track1_ert_phase_40_closure_attempt_06_campaign_run/onnx_export`;
