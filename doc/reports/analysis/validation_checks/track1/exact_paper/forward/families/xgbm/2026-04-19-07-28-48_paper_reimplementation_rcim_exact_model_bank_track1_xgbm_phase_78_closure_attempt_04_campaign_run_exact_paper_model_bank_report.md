...
- run name: `track1_xgbm_phase_78_closure_attempt_04`;
- output run name: `track1_xgbm_phase_78_closure_attempt_04_campaign_run`;
- run instance id: `2026-04-19-07-28-40__track1_xgbm_phase_78_closure_attempt_04_campaign_run`;
...
- winning mean component MAPE: `452.394%`;
- winning mean component MAE: `0.125214`;
- winning mean component RMSE: `0.190043`;
...
| --- | --- | ---: | ---: | --- |
| `XGBM` | `paper_reference_grid_search` | 5 | 0.766737 | `{'estimator__colsample_bytree': 0.8, 'estimator__learning_rate': 0.2, 'estimator__max_depth': 16}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `XGBM` | `XGBRegressor` | `paper_reference_grid_search` | 452.394 | 0.125214 | 0.190043 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_78` | `XGBM` | `XGBRegressor` | 452.394 | 0.125214 | 0.190043 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_78` | `HGBM / RF` | `XGBM` | 452.394 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/xgbm/2026-04-19-07-28-40__track1_xgbm_phase_78_closure_attempt_04_campaign_run/onnx_export`;
