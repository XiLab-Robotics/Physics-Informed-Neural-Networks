...
- run name: `track1_ert_phase_1_closure_attempt_06`;
- output run name: `track1_ert_phase_1_closure_attempt_06_campaign_run`;
- run instance id: `2026-04-19-04-59-43__track1_ert_phase_1_closure_attempt_06_campaign_run`;
...
- winning best params: `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 17, 'estimator__min_samples_split': 6, 'estimator__n_estimators': 60}`;
- winning mean component MAPE: `28.038%`;
- winning mean component MAE: `0.002206`;
- winning mean component RMSE: `0.003314`;
...
| --- | --- | ---: | ---: | --- |
| `ERT` | `paper_reference_grid_search` | 5 | 0.680808 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 17, 'estimator__min_samples_split': 6, 'estimator__n_estimators': 60}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ERT` | `ExtraTreesRegressor` | `paper_reference_grid_search` | 28.038 | 0.002206 | 0.003314 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_1` | `ERT` | `ExtraTreesRegressor` | 28.038 | 0.002206 | 0.003314 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_1` | `RF / LGBM` | `ERT` | 28.038 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/ert/2026-04-19-04-59-43__track1_ert_phase_1_closure_attempt_06_campaign_run/onnx_export`;
