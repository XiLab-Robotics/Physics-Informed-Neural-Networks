...
- run name: `track1_et_phase_78_closure_attempt_05`;
- output run name: `track1_et_phase_78_closure_attempt_05_campaign_run`;
- run instance id: `2026-04-19-04-15-52__track1_et_phase_78_closure_attempt_05_campaign_run`;
...
- winning best params: `{'estimator__criterion': 'absolute_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 6}`;
- winning mean component MAPE: `217.570%`;
- winning mean component MAE: `0.072627`;
- winning mean component RMSE: `0.151497`;
...
| --- | --- | ---: | ---: | --- |
| `ET` | `paper_reference_grid_search` | 5 | 0.681852 | `{'estimator__criterion': 'absolute_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 6}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ET` | `ExtraTreeRegressor` | `paper_reference_grid_search` | 217.570 | 0.072627 | 0.151497 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_78` | `ET` | `ExtraTreeRegressor` | 217.570 | 0.072627 | 0.151497 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_78` | `HGBM / RF` | `ET` | 217.570 | `not_matched_expected_family_direction` |
...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `78` | `-` | `-` | `-` | `RF` | `ET` | `ET` | `met_paper_target` | `met_paper_target` | `partially_matched_tables_3_6` |

## ONNX Export Surface

- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/et/2026-04-19-04-15-52__track1_et_phase_78_closure_attempt_05_campaign_run/onnx_export`;
