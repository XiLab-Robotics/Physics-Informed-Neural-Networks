...
- run name: `track1_gbm_phase_40_closure_attempt_04`;
- output run name: `track1_gbm_phase_40_closure_attempt_04_campaign_run`;
- run instance id: `2026-04-19-05-56-54__track1_gbm_phase_40_closure_attempt_04_campaign_run`;
...
- winning best params: `{'estimator__criterion': 'squared_error', 'estimator__learning_rate': 0.1, 'estimator__max_depth': 15, 'estimator__min_samples_split': 10, 'estimator__n_estimators': 36}`;
- winning mean component MAPE: `69.597%`;
- winning mean component MAE: `0.035801`;
- winning mean component RMSE: `0.057509`;
...
| --- | --- | ---: | ---: | --- |
| `GBM` | `paper_reference_grid_search` | 5 | 0.731965 | `{'estimator__criterion': 'squared_error', 'estimator__learning_rate': 0.1, 'estimator__max_depth': 15, 'estimator__min_samples_split': 10, 'estimator__n_estimators': 36}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `GBM` | `GradientBoostingRegressor` | `paper_reference_grid_search` | 69.597 | 0.035801 | 0.057509 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_40` | `GBM` | `GradientBoostingRegressor` | 69.597 | 0.035801 | 0.057509 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_40` | `ERT / GBM` | `GBM` | 69.597 | `matched_expected_family_direction` |
...
| `Repo Best Family` | - | - | - | `GBM` | - | - | - | - | - |
| `Repo Best RMSE` | - | - | - | 0.0575 | - | - | - | - | - |
| `Paper Best Family` | - | - | - | `GBM` | - | - | - | - | - |
| `Paper Target RMSE` | - | - | - | 0.0550 | - | - | - | - | - |
| `Gap Vs Paper` | - | - | - | 0.002509 | - | - | - | - | - |
...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `40` | `-` | `-` | `-` | `GBM` | `GBM` | `GBM` | `met_paper_target` | `above_paper_target` | `partially_matched_tables_3_6` |

## ONNX Export Surface

- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/gbm/2026-04-19-05-56-54__track1_gbm_phase_40_closure_attempt_04_campaign_run/onnx_export`;
