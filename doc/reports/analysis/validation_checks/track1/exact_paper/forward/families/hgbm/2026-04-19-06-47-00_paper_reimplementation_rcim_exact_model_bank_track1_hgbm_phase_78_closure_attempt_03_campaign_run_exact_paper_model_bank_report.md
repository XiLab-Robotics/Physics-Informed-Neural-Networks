...
- run name: `track1_hgbm_phase_78_closure_attempt_03`;
- output run name: `track1_hgbm_phase_78_closure_attempt_03_campaign_run`;
- run instance id: `2026-04-19-06-46-47__track1_hgbm_phase_78_closure_attempt_03_campaign_run`;
...
- winning mean component MAPE: `65.795%`;
- winning mean component MAE: `0.104598`;
- winning mean component RMSE: `0.278135`;
...
| --- | --- | ---: | ---: | --- |
| `HGBM` | `paper_reference_grid_search` | 5 | 0.845305 | `{'estimator__learning_rate': 0.2, 'estimator__max_depth': 13, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 26}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `HGBM` | `HistGradientBoostingRegressor` | `paper_reference_grid_search` | 65.795 | 0.104598 | 0.278135 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_78` | `HGBM` | `HistGradientBoostingRegressor` | 65.795 | 0.104598 | 0.278135 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_78` | `HGBM / RF` | `HGBM` | 65.795 | `matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/hgbm/2026-04-19-06-46-47__track1_hgbm_phase_78_closure_attempt_03_campaign_run/onnx_export`;
