...
- run name: `track1_gbm_amplitude_78_closure_attempt_03`;
- output run name: `track1_gbm_amplitude_78_closure_attempt_03_campaign_run`;
- run instance id: `2026-04-19-05-41-08__track1_gbm_amplitude_78_closure_attempt_03_campaign_run`;
...
- winning mean component MAPE: `9.748%`;
- winning mean component MAE: `0.000031`;
- winning mean component RMSE: `0.000040`;
...
| --- | --- | ---: | ---: | --- |
| `GBM` | `paper_reference_grid_search` | 5 | 0.994129 | `{'estimator__criterion': 'squared_error', 'estimator__learning_rate': 0.1, 'estimator__max_depth': 18, 'estimator__min_samples_split': 16, 'estimator__n_estimators': 84}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `GBM` | `GradientBoostingRegressor` | `paper_reference_grid_search` | 9.748 | 0.000031 | 0.000040 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_78` | `GBM` | `GradientBoostingRegressor` | 9.748 | 0.000031 | 0.000040 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_78` | `HGBM / RF` | `GBM` | 9.748 | `not_matched_expected_family_direction` |
...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `78` | `HGBM` | `GBM` | `met_paper_target` | `-` | `-` | `-` | `-` | `-` | `partially_matched_tables_3_6` |

## ONNX Export Surface

- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/gbm/2026-04-19-05-41-08__track1_gbm_amplitude_78_closure_attempt_03_campaign_run/onnx_export`;
