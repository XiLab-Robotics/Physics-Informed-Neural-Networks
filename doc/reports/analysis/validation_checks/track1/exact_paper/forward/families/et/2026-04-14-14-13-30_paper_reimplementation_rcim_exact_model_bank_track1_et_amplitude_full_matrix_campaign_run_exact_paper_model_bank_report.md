...
- run instance id: `2026-04-14-14-13-30__track1_et_amplitude_full_matrix_campaign_run`;
...
- winning mean component MAPE: `9.012%`;
- winning mean component MAE: `0.000382`;
- winning mean component RMSE: `0.000540`;

## Family Ranking

| Rank | Family | Estimator | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | ---: | ---: | ---: |
| 1 | `ET` | `ExtraTreeRegressor` | 9.012 | 0.000382 | 0.000540 |
...
| `fft_y_Fw_filtered_ampl_1` | `ET` | `ExtraTreeRegressor` | 0.176 | 0.000030 | 0.000042 |
| `fft_y_Fw_filtered_ampl_3` | `ET` | `ExtraTreeRegressor` | 3.072 | 0.000024 | 0.000035 |
| `fft_y_Fw_filtered_ampl_39` | `ET` | `ExtraTreeRegressor` | 4.244 | 0.000047 | 0.000076 |
| `fft_y_Fw_filtered_ampl_40` | `ET` | `ExtraTreeRegressor` | 3.185 | 0.000026 | 0.000038 |
| `fft_y_Fw_filtered_ampl_78` | `ET` | `ExtraTreeRegressor` | 14.028 | 0.000060 | 0.000087 |
| `fft_y_Fw_filtered_ampl_81` | `ET` | `ExtraTreeRegressor` | 4.140 | 0.000013 | 0.000020 |
| `fft_y_Fw_filtered_ampl_156` | `ET` | `ExtraTreeRegressor` | 19.102 | 0.000078 | 0.000265 |
| `fft_y_Fw_filtered_ampl_162` | `ET` | `ExtraTreeRegressor` | 10.147 | 0.000077 | 0.000286 |
| `fft_y_Fw_filtered_ampl_240` | `ET` | `ExtraTreeRegressor` | 20.836 | 0.000081 | 0.000274 |
...
| `fft_y_Fw_filtered_ampl_1` | `RF / LGBM` | `ET` | 0.176 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_3` | `HGBM` | `ET` | 3.072 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_39` | `HGBM` | `ET` | 4.244 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_40` | `ERT / GBM` | `ET` | 3.185 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_78` | `HGBM / RF` | `ET` | 14.028 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_81` | `RF` | `ET` | 4.140 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_156` | `ERT / RF` | `ET` | 19.102 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_162` | `ERT` | `ET` | 10.147 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_240` | `ERT` | `ET` | 20.836 | `not_matched_expected_family_direction` |
...
| `Repo Best RMSE` | 0.004280 | 4.15e-05 | 3.54e-05 | 7.57e-05 | 3.77e-05 | 8.65e-05 | 2.01e-05 | 2.65e-04 | 2.86e-04 | 2.74e-04 |
...
| `Gap Vs Paper` | 9.80e-04 | 6.53e-06 | 1.04e-05 | 4.37e-05 | 1.75e-06 | 4.15e-05 | 5.07e-06 | 1.35e-04 | 1.26e-04 | 2.32e-04 |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/full_matrix/et/2026-04-14-14-13-30__track1_et_amplitude_full_matrix_campaign_run/onnx_export`;
