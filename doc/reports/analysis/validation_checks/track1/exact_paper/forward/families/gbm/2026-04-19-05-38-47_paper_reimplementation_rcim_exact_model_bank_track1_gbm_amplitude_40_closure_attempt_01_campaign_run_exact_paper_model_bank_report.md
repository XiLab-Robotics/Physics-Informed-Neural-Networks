...
- run name: `track1_gbm_amplitude_40_closure_attempt_01`;
- output run name: `track1_gbm_amplitude_40_closure_attempt_01_campaign_run`;
- run instance id: `2026-04-19-05-38-35__track1_gbm_amplitude_40_closure_attempt_01_campaign_run`;
...
- winning mean component MAPE: `3.197%`;
- winning mean component MAE: `0.000026`;
- winning mean component RMSE: `0.000036`;
...
| --- | --- | ---: | ---: | --- |
| `GBM` | `paper_reference_grid_search` | 5 | 0.758539 | `{'estimator__criterion': 'squared_error', 'estimator__learning_rate': 0.1, 'estimator__max_depth': 14, 'estimator__min_samples_split': 14, 'estimator__n_estimators': 36}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `GBM` | `GradientBoostingRegressor` | `paper_reference_grid_search` | 3.197 | 0.000026 | 0.000036 |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/gbm/2026-04-19-05-38-35__track1_gbm_amplitude_40_closure_attempt_01_campaign_run/onnx_export`;
