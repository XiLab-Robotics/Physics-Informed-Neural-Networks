...
- run name: `track1_hgbm_phase_39_closure_attempt_01`;
- output run name: `track1_hgbm_phase_39_closure_attempt_01_campaign_run`;
- run instance id: `2026-04-19-06-42-13__track1_hgbm_phase_39_closure_attempt_01_campaign_run`;
...
- winning mean component MAPE: `1.568%`;
- winning mean component MAE: `0.019765`;
- winning mean component RMSE: `0.032562`;
...
| --- | --- | ---: | ---: | --- |
| `HGBM` | `paper_reference_grid_search` | 5 | 0.983783 | `{'estimator__learning_rate': 0.22, 'estimator__max_depth': 10, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 24}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `HGBM` | `HistGradientBoostingRegressor` | `paper_reference_grid_search` | 1.568 | 0.019765 | 0.032562 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_39` | `HGBM` | `HistGradientBoostingRegressor` | 1.568 | 0.019765 | 0.032562 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_39` | `HGBM` | `HGBM` | 1.568 | `matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/hgbm/2026-04-19-06-42-13__track1_hgbm_phase_39_closure_attempt_01_campaign_run/onnx_export`;
