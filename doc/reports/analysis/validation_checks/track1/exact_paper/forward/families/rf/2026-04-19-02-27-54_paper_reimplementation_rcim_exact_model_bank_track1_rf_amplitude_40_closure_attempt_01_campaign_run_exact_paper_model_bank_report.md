...
- run name: `track1_rf_amplitude_40_closure_attempt_01`;
- output run name: `track1_rf_amplitude_40_closure_attempt_01_campaign_run`;
- run instance id: `2026-04-19-02-27-36__track1_rf_amplitude_40_closure_attempt_01_campaign_run`;
...
- winning best params: `{'estimator__criterion': 'absolute_error', 'estimator__max_depth': 16, 'estimator__min_samples_split': 5, 'estimator__n_estimators': 90}`;
- winning mean component MAPE: `3.058%`;
...
| --- | --- | ---: | ---: | --- |
| `RF` | `paper_reference_grid_search` | 5 | 0.778937 | `{'estimator__criterion': 'absolute_error', 'estimator__max_depth': 16, 'estimator__min_samples_split': 5, 'estimator__n_estimators': 90}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `RF` | `RandomForestRegressor` | `paper_reference_grid_search` | 3.058 | 0.000024 | 0.000036 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_40` | `RF` | `RandomForestRegressor` | 3.058 | 0.000024 | 0.000036 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_40` | `ERT / GBM` | `RF` | 3.058 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/rf/2026-04-19-02-27-36__track1_rf_amplitude_40_closure_attempt_01_campaign_run/onnx_export`;
