...
- run name: `track1_ert_phase_240_closure_attempt_04`;
- output run name: `track1_ert_phase_240_closure_attempt_04_campaign_run`;
- run instance id: `2026-04-19-05-18-12__track1_ert_phase_240_closure_attempt_04_campaign_run`;
...
- winning mean component MAPE: `12.913%`;
- winning mean component MAE: `0.239439`;
- winning mean component RMSE: `0.548444`;
...
| --- | --- | ---: | ---: | --- |
| `ERT` | `paper_reference_grid_search` | 5 | 0.578277 | `{'estimator__criterion': 'absolute_error', 'estimator__max_depth': 15, 'estimator__min_samples_split': 2, 'estimator__n_estimators': 80}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ERT` | `ExtraTreesRegressor` | `paper_reference_grid_search` | 12.913 | 0.239439 | 0.548444 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_240` | `ERT` | `ExtraTreesRegressor` | 12.913 | 0.239439 | 0.548444 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_240` | `ERT` | `ERT` | 12.913 | `matched_expected_family_direction` |
...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `240` | `-` | `-` | `-` | `ERT` | `ERT` | `ERT` | `above_paper_target` | `met_paper_target` | `partially_matched_tables_3_6` |

## ONNX Export Surface

- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/ert/2026-04-19-05-18-12__track1_ert_phase_240_closure_attempt_04_campaign_run/onnx_export`;
