...
- run name: `track1_hgbm_phase_162_closure_attempt_21`;
- output run name: `track1_hgbm_phase_162_closure_attempt_21_campaign_run`;
- run instance id: `2026-04-21-12-02-45__track1_hgbm_phase_162_closure_attempt_21_campaign_run`;
...
- winning mean component MAPE: `17.882%`;
- winning mean component MAE: `0.416038`;
- winning mean component RMSE: `0.970897`;
...
| --- | --- | ---: | ---: | --- |
| `HGBM` | `paper_reference_grid_search` | 5 | 0.686877 | `{'estimator__learning_rate': 0.21, 'estimator__max_depth': 10, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 25}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `HGBM` | `HistGradientBoostingRegressor` | `paper_reference_grid_search` | 17.882 | 0.416038 | 0.970897 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_162` | `HGBM` | `HistGradientBoostingRegressor` | 17.882 | 0.416038 | 0.970897 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_162` | `ERT` | `HGBM` | 17.882 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/hgbm/2026-04-21-12-02-45__track1_hgbm_phase_162_closure_attempt_21_campaign_run/onnx_export`;
