...
- run name: `track1_gbm_phase_162_closure_attempt_23`;
- output run name: `track1_gbm_phase_162_closure_attempt_23_campaign_run`;
- run instance id: `2026-04-21-11-33-43__track1_gbm_phase_162_closure_attempt_23_campaign_run`;
...
- winning best params: `{'estimator__criterion': 'squared_error', 'estimator__learning_rate': 1.0, 'estimator__max_depth': 18, 'estimator__min_samples_split': 18, 'estimator__n_estimators': 20}`;
- winning mean component MAPE: `22.537%`;
- winning mean component MAE: `0.528834`;
- winning mean component RMSE: `1.358455`;
...
| --- | --- | ---: | ---: | --- |
| `GBM` | `paper_reference_grid_search` | 5 | 0.646785 | `{'estimator__criterion': 'squared_error', 'estimator__learning_rate': 1.0, 'estimator__max_depth': 18, 'estimator__min_samples_split': 18, 'estimator__n_estimators': 20}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `GBM` | `GradientBoostingRegressor` | `paper_reference_grid_search` | 22.537 | 0.528834 | 1.358455 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_162` | `GBM` | `GradientBoostingRegressor` | 22.537 | 0.528834 | 1.358455 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_162` | `ERT` | `GBM` | 22.537 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/gbm/2026-04-21-11-33-43__track1_gbm_phase_162_closure_attempt_23_campaign_run/onnx_export`;
