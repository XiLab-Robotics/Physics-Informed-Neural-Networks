...
- run name: `track1_mlp_phase_3_closure_attempt_27`;
- output run name: `track1_mlp_phase_3_closure_attempt_27_campaign_run`;
- run instance id: `2026-04-21-01-11-15__track1_mlp_phase_3_closure_attempt_27_campaign_run`;
...
- winning mean component MAPE: `3.812%`;
- winning mean component MAE: `0.067894`;
- winning mean component RMSE: `0.085115`;
...
| --- | --- | ---: | ---: | --- |
| `MLP` | `paper_reference_grid_search` | 5 | 0.495821 | `{'estimator__activation': 'tanh', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (100, 50), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `MLP` | `MLPRegressor` | `paper_reference_grid_search` | 3.812 | 0.067894 | 0.085115 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_3` | `MLP` | `MLPRegressor` | 3.812 | 0.067894 | 0.085115 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_3` | `HGBM` | `MLP` | 3.812 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/mlp/2026-04-21-01-11-15__track1_mlp_phase_3_closure_attempt_27_campaign_run/onnx_export`;
