...
- run name: `track1_ert_phase_40_closure_attempt_02`;
- output run name: `track1_ert_phase_40_closure_attempt_02_campaign_run`;
- run instance id: `2026-04-19-05-05-21__track1_ert_phase_40_closure_attempt_02_campaign_run`;
...
- winning mean component MAPE: `101.789%`;
- winning mean component MAE: `0.032499`;
- winning mean component RMSE: `0.048903`;
...
| --- | --- | ---: | ---: | --- |
| `ERT` | `paper_reference_grid_search` | 5 | 0.769602 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 15, 'estimator__min_samples_split': 4, 'estimator__n_estimators': 40}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ERT` | `ExtraTreesRegressor` | `paper_reference_grid_search` | 101.789 | 0.032499 | 0.048903 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_40` | `ERT` | `ExtraTreesRegressor` | 101.789 | 0.032499 | 0.048903 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_40` | `ERT / GBM` | `ERT` | 101.789 | `matched_expected_family_direction` |
...
| `Repo Best Family` | - | - | - | `ERT` | - | - | - | - | - |
| `Repo Best RMSE` | - | - | - | 0.0489 | - | - | - | - | - |
| `Paper Best Family` | - | - | - | `GBM` | - | - | - | - | - |
| `Paper Target RMSE` | - | - | - | 0.0550 | - | - | - | - | - |
| `Gap Vs Paper` | - | - | - | -0.006097 | - | - | - | - | - |
| `Status` | - | - | - | `met_paper_target` | - | - | - | - | - |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/ert/2026-04-19-05-05-21__track1_ert_phase_40_closure_attempt_02_campaign_run/onnx_export`;
