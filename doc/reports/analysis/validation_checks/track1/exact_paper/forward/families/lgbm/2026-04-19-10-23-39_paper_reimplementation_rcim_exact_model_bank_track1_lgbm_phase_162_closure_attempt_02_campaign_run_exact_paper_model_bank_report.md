...
- run name: `track1_lgbm_phase_162_closure_attempt_02`;
- output run name: `track1_lgbm_phase_162_closure_attempt_02_campaign_run`;
- run instance id: `2026-04-19-10-22-16__track1_lgbm_phase_162_closure_attempt_02_campaign_run`;
...
- winning mean component MAPE: `16.613%`;
- winning mean component MAE: `0.386741`;
- winning mean component RMSE: `0.914572`;
...
| --- | --- | ---: | ---: | --- |
| `LGBM` | `paper_reference_grid_search` | 5 | 0.692598 | `{'estimator__learning_rate': 0.58, 'estimator__max_depth': 12, 'estimator__num_leaves': 31, 'estimator__subsample': 0.001}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `LGBM` | `LGBMRegressor` | `paper_reference_grid_search` | 16.613 | 0.386741 | 0.914572 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_162` | `LGBM` | `LGBMRegressor` | 16.613 | 0.386741 | 0.914572 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_162` | `ERT` | `LGBM` | 16.613 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/lgbm/2026-04-19-10-22-16__track1_lgbm_phase_162_closure_attempt_02_campaign_run/onnx_export`;
