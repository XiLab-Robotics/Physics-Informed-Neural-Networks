...
- run name: `track1_lgbm_phase_162_closure_attempt_16`;
- output run name: `track1_lgbm_phase_162_closure_attempt_16_campaign_run`;
- run instance id: `2026-04-21-13-05-54__track1_lgbm_phase_162_closure_attempt_16_campaign_run`;
...
- winning mean component MAPE: `15.064%`;
- winning mean component MAE: `0.331879`;
- winning mean component RMSE: `0.658821`;
...
| --- | --- | ---: | ---: | --- |
| `LGBM` | `paper_reference_grid_search` | 5 | 0.717252 | `{'estimator__learning_rate': 0.77, 'estimator__max_depth': 11, 'estimator__num_leaves': 31, 'estimator__subsample': 0.001}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `LGBM` | `LGBMRegressor` | `paper_reference_grid_search` | 15.064 | 0.331879 | 0.658821 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_162` | `LGBM` | `LGBMRegressor` | 15.064 | 0.331879 | 0.658821 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_162` | `ERT` | `LGBM` | 15.064 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/lgbm/2026-04-21-13-05-54__track1_lgbm_phase_162_closure_attempt_16_campaign_run/onnx_export`;
