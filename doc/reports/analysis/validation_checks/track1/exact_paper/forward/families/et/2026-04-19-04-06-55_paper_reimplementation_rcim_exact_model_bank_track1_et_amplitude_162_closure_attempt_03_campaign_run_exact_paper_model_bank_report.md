...
- run name: `track1_et_amplitude_162_closure_attempt_03`;
- output run name: `track1_et_amplitude_162_closure_attempt_03_campaign_run`;
- run instance id: `2026-04-19-04-06-47__track1_et_amplitude_162_closure_attempt_03_campaign_run`;
...
- winning mean component MAPE: `12.715%`;
- winning mean component MAE: `0.000077`;
- winning mean component RMSE: `0.000281`;
...
| --- | --- | ---: | ---: | --- |
| `ET` | `paper_reference_grid_search` | 5 | 0.986024 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 16, 'estimator__min_samples_split': 4}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ET` | `ExtraTreeRegressor` | `paper_reference_grid_search` | 12.715 | 0.000077 | 0.000281 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_162` | `ET` | `ExtraTreeRegressor` | 12.715 | 0.000077 | 0.000281 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_162` | `ERT` | `ET` | 12.715 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/et/2026-04-19-04-06-47__track1_et_amplitude_162_closure_attempt_03_campaign_run/onnx_export`;
