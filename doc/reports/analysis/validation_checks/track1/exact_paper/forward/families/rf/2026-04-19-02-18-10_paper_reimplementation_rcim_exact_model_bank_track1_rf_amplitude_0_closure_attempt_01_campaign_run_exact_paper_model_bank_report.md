...
- run name: `track1_rf_amplitude_0_closure_attempt_01`;
- output run name: `track1_rf_amplitude_0_closure_attempt_01_campaign_run`;
- run instance id: `2026-04-19-02-17-53__track1_rf_amplitude_0_closure_attempt_01_campaign_run`;
...
- winning best params: `{'estimator__criterion': 'absolute_error', 'estimator__max_depth': 13, 'estimator__min_samples_split': 6, 'estimator__n_estimators': 50}`;
- winning mean component MAPE: `12.373%`;
- winning mean component MAE: `0.003017`;
- winning mean component RMSE: `0.004150`;
...
| --- | --- | ---: | ---: | --- |
| `RF` | `paper_reference_grid_search` | 5 | 0.967284 | `{'estimator__criterion': 'absolute_error', 'estimator__max_depth': 13, 'estimator__min_samples_split': 6, 'estimator__n_estimators': 50}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `RF` | `RandomForestRegressor` | `paper_reference_grid_search` | 12.373 | 0.003017 | 0.004150 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_0` | `RF` | `RandomForestRegressor` | 12.373 | 0.003017 | 0.004150 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_0` | `SVR` | `RF` | 12.373 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/rf/2026-04-19-02-17-53__track1_rf_amplitude_0_closure_attempt_01_campaign_run/onnx_export`;
