...
- run name: `track1_et_phase_40_closure_attempt_02`;
- output run name: `track1_et_phase_40_closure_attempt_02_campaign_run`;
- run instance id: `2026-04-19-04-13-43__track1_et_phase_40_closure_attempt_02_campaign_run`;
...
- winning mean component MAPE: `109.489%`;
- winning mean component MAE: `0.045399`;
- winning mean component RMSE: `0.071221`;
...
| --- | --- | ---: | ---: | --- |
| `ET` | `paper_reference_grid_search` | 5 | 0.588467 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 15, 'estimator__min_samples_split': 3}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ET` | `ExtraTreeRegressor` | `paper_reference_grid_search` | 109.489 | 0.045399 | 0.071221 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_40` | `ET` | `ExtraTreeRegressor` | 109.489 | 0.045399 | 0.071221 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_40` | `ERT / GBM` | `ET` | 109.489 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/et/2026-04-19-04-13-43__track1_et_phase_40_closure_attempt_02_campaign_run/onnx_export`;
