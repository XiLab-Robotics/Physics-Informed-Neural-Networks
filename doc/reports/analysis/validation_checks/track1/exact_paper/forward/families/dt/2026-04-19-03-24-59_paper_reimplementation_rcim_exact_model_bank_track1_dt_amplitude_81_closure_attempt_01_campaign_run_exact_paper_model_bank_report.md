...
- run name: `track1_dt_amplitude_81_closure_attempt_01`;
- output run name: `track1_dt_amplitude_81_closure_attempt_01_campaign_run`;
- run instance id: `2026-04-19-03-24-51__track1_dt_amplitude_81_closure_attempt_01_campaign_run`;
...
- winning mean component MAPE: `4.847%`;
...
| --- | --- | ---: | ---: | --- |
| `DT` | `paper_reference_grid_search` | 5 | 0.910767 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 6}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `DT` | `DecisionTreeRegressor` | `paper_reference_grid_search` | 4.847 | 0.000015 | 0.000024 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_81` | `DT` | `DecisionTreeRegressor` | 4.847 | 0.000015 | 0.000024 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_81` | `RF` | `DT` | 4.847 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/dt/2026-04-19-03-24-51__track1_dt_amplitude_81_closure_attempt_01_campaign_run/onnx_export`;
