...
- run name: `track1_gbm_amplitude_156_closure_attempt_02`;
- output run name: `track1_gbm_amplitude_156_closure_attempt_02_campaign_run`;
- run instance id: `2026-04-19-05-44-40__track1_gbm_amplitude_156_closure_attempt_02_campaign_run`;
...
- winning mean component MAPE: `12.812%`;
- winning mean component MAE: `0.000043`;
- winning mean component RMSE: `0.000115`;
...
| --- | --- | ---: | ---: | --- |
| `GBM` | `paper_reference_grid_search` | 5 | 0.976365 | `{'estimator__criterion': 'squared_error', 'estimator__learning_rate': 0.1, 'estimator__max_depth': 15, 'estimator__min_samples_split': 12, 'estimator__n_estimators': 84}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `GBM` | `GradientBoostingRegressor` | `paper_reference_grid_search` | 12.812 | 0.000043 | 0.000115 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_156` | `GBM` | `GradientBoostingRegressor` | 12.812 | 0.000043 | 0.000115 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_156` | `ERT / RF` | `GBM` | 12.812 | `not_matched_expected_family_direction` |
...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `156` | `ERT` | `GBM` | `met_paper_target` | `-` | `-` | `-` | `-` | `-` | `partially_matched_tables_3_6` |

## ONNX Export Surface

- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/gbm/2026-04-19-05-44-40__track1_gbm_amplitude_156_closure_attempt_02_campaign_run/onnx_export`;
