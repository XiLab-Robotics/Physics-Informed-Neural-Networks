...
- run name: `track1_et_phase_1_closure_attempt_03`;
- output run name: `track1_et_phase_1_closure_attempt_03_campaign_run`;
- run instance id: `2026-04-19-04-09-39__track1_et_phase_1_closure_attempt_03_campaign_run`;
...
- winning mean component MAPE: `44.070%`;
- winning mean component MAE: `0.002555`;
- winning mean component RMSE: `0.004092`;
...
| --- | --- | ---: | ---: | --- |
| `ET` | `paper_reference_grid_search` | 5 | 0.617042 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 16, 'estimator__min_samples_split': 6}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ET` | `ExtraTreeRegressor` | `paper_reference_grid_search` | 44.070 | 0.002555 | 0.004092 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_1` | `ET` | `ExtraTreeRegressor` | 44.070 | 0.002555 | 0.004092 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_1` | `RF / LGBM` | `ET` | 44.070 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/et/2026-04-19-04-09-39__track1_et_phase_1_closure_attempt_03_campaign_run/onnx_export`;
