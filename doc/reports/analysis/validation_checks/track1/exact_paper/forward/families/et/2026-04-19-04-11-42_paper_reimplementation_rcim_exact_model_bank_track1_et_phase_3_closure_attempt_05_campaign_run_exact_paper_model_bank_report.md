...
- run name: `track1_et_phase_3_closure_attempt_05`;
- output run name: `track1_et_phase_3_closure_attempt_05_campaign_run`;
- run instance id: `2026-04-19-04-11-34__track1_et_phase_3_closure_attempt_05_campaign_run`;
...
- winning mean component MAPE: `2.112%`;
- winning mean component MAE: `0.037792`;
- winning mean component RMSE: `0.065428`;
...
| --- | --- | ---: | ---: | --- |
| `ET` | `paper_reference_grid_search` | 5 | 0.896098 | `{'estimator__criterion': 'absolute_error', 'estimator__max_depth': 16, 'estimator__min_samples_split': 2}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ET` | `ExtraTreeRegressor` | `paper_reference_grid_search` | 2.112 | 0.037792 | 0.065428 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_3` | `ET` | `ExtraTreeRegressor` | 2.112 | 0.037792 | 0.065428 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_3` | `HGBM` | `ET` | 2.112 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/et/2026-04-19-04-11-34__track1_et_phase_3_closure_attempt_05_campaign_run/onnx_export`;
