...
- run name: `track1_hgbm_phase_156_closure_attempt_06`;
- output run name: `track1_hgbm_phase_156_closure_attempt_06_campaign_run`;
- run instance id: `2026-04-19-06-51-38__track1_hgbm_phase_156_closure_attempt_06_campaign_run`;
...
- winning mean component MAPE: `88.542%`;
- winning mean component MAE: `0.641493`;
- winning mean component RMSE: `1.121968`;
...
| --- | --- | ---: | ---: | --- |
| `HGBM` | `paper_reference_grid_search` | 5 | 0.722849 | `{'estimator__learning_rate': 0.2, 'estimator__max_depth': 10, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 25}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `HGBM` | `HistGradientBoostingRegressor` | `paper_reference_grid_search` | 88.542 | 0.641493 | 1.121968 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_156` | `HGBM` | `HistGradientBoostingRegressor` | 88.542 | 0.641493 | 1.121968 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_156` | `ERT / RF` | `HGBM` | 88.542 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/hgbm/2026-04-19-06-51-38__track1_hgbm_phase_156_closure_attempt_06_campaign_run/onnx_export`;
