...
- run name: `track1_xgbm_amplitude_0_closure_attempt_06`;
- output run name: `track1_xgbm_amplitude_0_closure_attempt_06_campaign_run`;
- run instance id: `2026-04-19-07-08-32__track1_xgbm_amplitude_0_closure_attempt_06_campaign_run`;
...
- winning best params: `{'estimator__colsample_bytree': 0.8, 'estimator__learning_rate': 0.2, 'estimator__max_depth': 14}`;
- winning mean component MAPE: `10.434%`;
- winning mean component MAE: `0.002514`;
- winning mean component RMSE: `0.003586`;
...
| --- | --- | ---: | ---: | --- |
| `XGBM` | `paper_reference_grid_search` | 5 | 0.975096 | `{'estimator__colsample_bytree': 0.8, 'estimator__learning_rate': 0.2, 'estimator__max_depth': 14}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `XGBM` | `XGBRegressor` | `paper_reference_grid_search` | 10.434 | 0.002514 | 0.003586 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_0` | `XGBM` | `XGBRegressor` | 10.434 | 0.002514 | 0.003586 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_0` | `SVR` | `XGBM` | 10.434 | `not_matched_expected_family_direction` |
...
| `Repo Best Family` | `XGBM` | - | - | - | - | - | - | - | - | - |
| `Repo Best RMSE` | 0.003586 | - | - | - | - | - | - | - | - | - |
| `Paper Best Family` | `SVM` | - | - | - | - | - | - | - | - | - |
| `Paper Target RMSE` | 0.003300 | - | - | - | - | - | - | - | - | - |
| `Gap Vs Paper` | 2.86e-04 | - | - | - | - | - | - | - | - | - |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/xgbm/2026-04-19-07-08-32__track1_xgbm_amplitude_0_closure_attempt_06_campaign_run/onnx_export`;
