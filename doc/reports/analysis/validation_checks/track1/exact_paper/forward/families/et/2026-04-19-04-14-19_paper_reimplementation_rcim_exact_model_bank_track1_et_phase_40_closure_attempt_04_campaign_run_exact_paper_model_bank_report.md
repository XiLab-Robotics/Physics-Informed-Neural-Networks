...
- run name: `track1_et_phase_40_closure_attempt_04`;
- output run name: `track1_et_phase_40_closure_attempt_04_campaign_run`;
- run instance id: `2026-04-19-04-14-12__track1_et_phase_40_closure_attempt_04_campaign_run`;
...
- winning mean component MAPE: `89.808%`;
- winning mean component MAE: `0.053427`;
- winning mean component RMSE: `0.087718`;
...
| --- | --- | ---: | ---: | --- |
| `ET` | `paper_reference_grid_search` | 5 | 0.619431 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 15, 'estimator__min_samples_split': 5}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ET` | `ExtraTreeRegressor` | `paper_reference_grid_search` | 89.808 | 0.053427 | 0.087718 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_40` | `ET` | `ExtraTreeRegressor` | 89.808 | 0.053427 | 0.087718 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_40` | `ERT / GBM` | `ET` | 89.808 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/et/2026-04-19-04-14-12__track1_et_phase_40_closure_attempt_04_campaign_run/onnx_export`;
