...
- run name: `track1_ert_phase_162_closure_attempt_20`;
- output run name: `track1_ert_phase_162_closure_attempt_20_campaign_run`;
- run instance id: `2026-04-21-11-11-50__track1_ert_phase_162_closure_attempt_20_campaign_run`;
...
- winning mean component MAPE: `12.488%`;
- winning mean component MAE: `0.302166`;
- winning mean component RMSE: `0.920395`;
...
| --- | --- | ---: | ---: | --- |
| `ERT` | `paper_reference_grid_search` | 5 | 0.745905 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 16, 'estimator__min_samples_split': 3, 'estimator__n_estimators': 20}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ERT` | `ExtraTreesRegressor` | `paper_reference_grid_search` | 12.488 | 0.302166 | 0.920395 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_162` | `ERT` | `ExtraTreesRegressor` | 12.488 | 0.302166 | 0.920395 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_162` | `ERT` | `ERT` | 12.488 | `matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/ert/2026-04-21-11-11-50__track1_ert_phase_162_closure_attempt_20_campaign_run/onnx_export`;
