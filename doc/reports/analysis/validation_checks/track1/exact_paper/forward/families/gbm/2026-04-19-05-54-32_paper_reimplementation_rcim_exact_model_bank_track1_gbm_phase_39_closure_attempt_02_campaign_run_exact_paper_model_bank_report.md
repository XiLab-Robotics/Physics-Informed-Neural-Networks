...
- run name: `track1_gbm_phase_39_closure_attempt_02`;
- output run name: `track1_gbm_phase_39_closure_attempt_02_campaign_run`;
- run instance id: `2026-04-19-05-54-19__track1_gbm_phase_39_closure_attempt_02_campaign_run`;
...
- winning best params: `{'estimator__criterion': 'squared_error', 'estimator__learning_rate': 0.1, 'estimator__max_depth': 15, 'estimator__min_samples_split': 18, 'estimator__n_estimators': 84}`;
- winning mean component MAPE: `1.790%`;
- winning mean component MAE: `0.022305`;
- winning mean component RMSE: `0.035478`;
...
| --- | --- | ---: | ---: | --- |
| `GBM` | `paper_reference_grid_search` | 5 | 0.978295 | `{'estimator__criterion': 'squared_error', 'estimator__learning_rate': 0.1, 'estimator__max_depth': 15, 'estimator__min_samples_split': 18, 'estimator__n_estimators': 84}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `GBM` | `GradientBoostingRegressor` | `paper_reference_grid_search` | 1.790 | 0.022305 | 0.035478 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_39` | `GBM` | `GradientBoostingRegressor` | 1.790 | 0.022305 | 0.035478 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_39` | `HGBM` | `GBM` | 1.790 | `not_matched_expected_family_direction` |
...
| `Repo Best Family` | - | - | `GBM` | - | - | - | - | - | - |
| `Repo Best RMSE` | - | - | 0.0355 | - | - | - | - | - | - |
| `Paper Best Family` | - | - | `HGBM` | - | - | - | - | - | - |
| `Paper Target RMSE` | - | - | 0.0270 | - | - | - | - | - | - |
| `Gap Vs Paper` | - | - | 0.008478 | - | - | - | - | - | - |
| `Status` | - | - | `above_paper_target` | - | - | - | - | - | - |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/gbm/2026-04-19-05-54-19__track1_gbm_phase_39_closure_attempt_02_campaign_run/onnx_export`;
