...
- run name: `track1_mlp_amplitude_240_final_closure_attempt_20`;
- output run name: `track1_mlp_amplitude_240_final_closure_attempt_20_campaign_run`;
- run instance id: `2026-04-22-00-15-47__track1_mlp_amplitude_240_final_closure_attempt_20_campaign_run`;
...
- winning mean component MAPE: `1621.911%`;
- winning mean component MAE: `0.005740`;
- winning mean component RMSE: `0.009110`;
...
| --- | --- | ---: | ---: | --- |
| `MLP` | `paper_reference_grid_search` | 5 | -942.198825 | `{'estimator__activation': 'tanh', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (200, 50), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `MLP` | `MLPRegressor` | `paper_reference_grid_search` | 1621.911 | 0.005740 | 0.009110 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_240` | `MLP` | `MLPRegressor` | 1621.911 | 0.005740 | 0.009110 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_240` | `ERT` | `MLP` | 1621.911 | `not_matched_expected_family_direction` |
...
| `Repo Best Family` | - | - | - | - | - | - | - | - | - | `MLP` |
| `Repo Best RMSE` | - | - | - | - | - | - | - | - | - | 0.009110 |
| `Paper Best Family` | - | - | - | - | - | - | - | - | - | `ERT` |
| `Paper Target RMSE` | - | - | - | - | - | - | - | - | - | 4.20e-05 |
| `Gap Vs Paper` | - | - | - | - | - | - | - | - | - | 0.009068 |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/mlp/2026-04-22-00-15-47__track1_mlp_amplitude_240_final_closure_attempt_20_campaign_run/onnx_export`;
