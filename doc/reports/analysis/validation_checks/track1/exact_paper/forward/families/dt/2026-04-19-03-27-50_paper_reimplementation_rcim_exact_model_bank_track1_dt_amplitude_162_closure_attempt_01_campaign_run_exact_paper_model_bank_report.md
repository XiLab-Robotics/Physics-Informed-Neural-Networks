...
- run name: `track1_dt_amplitude_162_closure_attempt_01`;
- output run name: `track1_dt_amplitude_162_closure_attempt_01_campaign_run`;
- run instance id: `2026-04-19-03-27-42__track1_dt_amplitude_162_closure_attempt_01_campaign_run`;
...
- winning mean component MAPE: `9.746%`;
- winning mean component MAE: `0.000067`;
- winning mean component RMSE: `0.000197`;
...
| --- | --- | ---: | ---: | --- |
| `DT` | `paper_reference_grid_search` | 5 | 0.968579 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 6}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `DT` | `DecisionTreeRegressor` | `paper_reference_grid_search` | 9.746 | 0.000067 | 0.000197 |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/dt/2026-04-19-03-27-42__track1_dt_amplitude_162_closure_attempt_01_campaign_run/onnx_export`;
