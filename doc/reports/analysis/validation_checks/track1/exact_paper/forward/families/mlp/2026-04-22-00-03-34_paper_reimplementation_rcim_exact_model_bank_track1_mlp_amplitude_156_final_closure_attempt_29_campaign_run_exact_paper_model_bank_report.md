...
- run name: `track1_mlp_amplitude_156_final_closure_attempt_29`;
- output run name: `track1_mlp_amplitude_156_final_closure_attempt_29_campaign_run`;
- run instance id: `2026-04-22-00-03-24__track1_mlp_amplitude_156_final_closure_attempt_29_campaign_run`;
...
- winning mean component MAPE: `5754.971%`;
- winning mean component MAE: `0.006829`;
- winning mean component RMSE: `0.011491`;
...
| --- | --- | ---: | ---: | --- |
| `MLP` | `paper_reference_grid_search` | 5 | -367.052711 | `{'estimator__activation': 'tanh', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (200, 50), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `MLP` | `MLPRegressor` | `paper_reference_grid_search` | 5754.971 | 0.006829 | 0.011491 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_156` | `MLP` | `MLPRegressor` | 5754.971 | 0.006829 | 0.011491 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_156` | `ERT / RF` | `MLP` | 5754.971 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/mlp/2026-04-22-00-03-24__track1_mlp_amplitude_156_final_closure_attempt_29_campaign_run/onnx_export`;
