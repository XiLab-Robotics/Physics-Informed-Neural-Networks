...
- run name: `track1_dt_phase_40_closure_attempt_02`;
- output run name: `track1_dt_phase_40_closure_attempt_02_campaign_run`;
- run instance id: `2026-04-19-03-35-06__track1_dt_phase_40_closure_attempt_02_campaign_run`;
...
- winning mean component MAPE: `104.705%`;
- winning mean component MAE: `0.037264`;
- winning mean component RMSE: `0.052814`;
...
| --- | --- | ---: | ---: | --- |
| `DT` | `paper_reference_grid_search` | 5 | 0.686952 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 6}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `DT` | `DecisionTreeRegressor` | `paper_reference_grid_search` | 104.705 | 0.037264 | 0.052814 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_40` | `DT` | `DecisionTreeRegressor` | 104.705 | 0.037264 | 0.052814 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_40` | `ERT / GBM` | `DT` | 104.705 | `not_matched_expected_family_direction` |
...
| `Repo Best Family` | - | - | - | `DT` | - | - | - | - | - |
| `Repo Best RMSE` | - | - | - | 0.0528 | - | - | - | - | - |
| `Paper Best Family` | - | - | - | `GBM` | - | - | - | - | - |
| `Paper Target RMSE` | - | - | - | 0.0550 | - | - | - | - | - |
| `Gap Vs Paper` | - | - | - | -0.002186 | - | - | - | - | - |
...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `40` | `-` | `-` | `-` | `GBM` | `DT` | `DT` | `above_paper_target` | `met_paper_target` | `partially_matched_tables_3_6` |

## ONNX Export Surface

- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/dt/2026-04-19-03-35-06__track1_dt_phase_40_closure_attempt_02_campaign_run/onnx_export`;
