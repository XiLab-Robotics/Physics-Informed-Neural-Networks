...
- run name: `track1_hgbm_phase_40_closure_attempt_04`;
- output run name: `track1_hgbm_phase_40_closure_attempt_04_campaign_run`;
- run instance id: `2026-04-19-06-45-10__track1_hgbm_phase_40_closure_attempt_04_campaign_run`;
...
- winning mean component MAPE: `73.316%`;
- winning mean component MAE: `0.036955`;
- winning mean component RMSE: `0.055409`;
...
| --- | --- | ---: | ---: | --- |
| `HGBM` | `paper_reference_grid_search` | 5 | 0.747763 | `{'estimator__learning_rate': 0.22, 'estimator__max_depth': 11, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 25}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `HGBM` | `HistGradientBoostingRegressor` | `paper_reference_grid_search` | 73.316 | 0.036955 | 0.055409 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_40` | `HGBM` | `HistGradientBoostingRegressor` | 73.316 | 0.036955 | 0.055409 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_40` | `ERT / GBM` | `HGBM` | 73.316 | `not_matched_expected_family_direction` |
...
| `Repo Best Family` | - | - | - | `HGBM` | - | - | - | - | - |
| `Repo Best RMSE` | - | - | - | 0.0554 | - | - | - | - | - |
| `Paper Best Family` | - | - | - | `GBM` | - | - | - | - | - |
| `Paper Target RMSE` | - | - | - | 0.0550 | - | - | - | - | - |
| `Gap Vs Paper` | - | - | - | 4.09e-04 | - | - | - | - | - |
| `Status` | - | - | - | `above_paper_target` | - | - | - | - | - |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/hgbm/2026-04-19-06-45-10__track1_hgbm_phase_40_closure_attempt_04_campaign_run/onnx_export`;
