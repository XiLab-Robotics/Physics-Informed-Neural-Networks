...
- run name: `track1_dt_phase_1_closure_attempt_08`;
- output run name: `track1_dt_phase_1_closure_attempt_08_campaign_run`;
- run instance id: `2026-04-21-10-03-48__track1_dt_phase_1_closure_attempt_08_campaign_run`;
...
- winning mean component MAPE: `73.752%`;
- winning mean component MAE: `0.002063`;
- winning mean component RMSE: `0.002976`;
...
| --- | --- | ---: | ---: | --- |
| `DT` | `paper_reference_grid_search` | 5 | 0.675169 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 7}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `DT` | `DecisionTreeRegressor` | `paper_reference_grid_search` | 73.752 | 0.002063 | 0.002976 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_1` | `DT` | `DecisionTreeRegressor` | 73.752 | 0.002063 | 0.002976 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_1` | `RF / LGBM` | `DT` | 73.752 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/dt/2026-04-21-10-03-48__track1_dt_phase_1_closure_attempt_08_campaign_run/onnx_export`;
