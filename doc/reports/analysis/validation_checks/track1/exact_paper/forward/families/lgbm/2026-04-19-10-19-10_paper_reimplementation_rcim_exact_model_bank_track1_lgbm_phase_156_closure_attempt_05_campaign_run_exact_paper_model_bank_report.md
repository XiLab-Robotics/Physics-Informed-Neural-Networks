...
- run name: `track1_lgbm_phase_156_closure_attempt_05`;
- output run name: `track1_lgbm_phase_156_closure_attempt_05_campaign_run`;
- run instance id: `2026-04-19-10-17-45__track1_lgbm_phase_156_closure_attempt_05_campaign_run`;
...
- winning mean component MAPE: `35.090%`;
- winning mean component MAE: `0.589673`;
- winning mean component RMSE: `1.027671`;
...
| --- | --- | ---: | ---: | --- |
| `LGBM` | `paper_reference_grid_search` | 5 | 0.703000 | `{'estimator__learning_rate': 0.2, 'estimator__max_depth': 12, 'estimator__num_leaves': 31, 'estimator__subsample': 0.001}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `LGBM` | `LGBMRegressor` | `paper_reference_grid_search` | 35.090 | 0.589673 | 1.027671 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_156` | `LGBM` | `LGBMRegressor` | 35.090 | 0.589673 | 1.027671 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_156` | `ERT / RF` | `LGBM` | 35.090 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/lgbm/2026-04-19-10-17-45__track1_lgbm_phase_156_closure_attempt_05_campaign_run/onnx_export`;
