...
- run name: `track1_mlp_phase_40_closure_attempt_03`;
- output run name: `track1_mlp_phase_40_closure_attempt_03_campaign_run`;
- run instance id: `2026-04-19-01-57-20__track1_mlp_phase_40_closure_attempt_03_campaign_run`;
...
- winning mean component MAPE: `215.375%`;
- winning mean component MAE: `0.073213`;
- winning mean component RMSE: `0.105532`;
...
| --- | --- | ---: | ---: | --- |
| `MLP` | `paper_reference_grid_search` | 5 | 0.275199 | `{'estimator__activation': 'tanh', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (200, 50), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `MLP` | `MLPRegressor` | `paper_reference_grid_search` | 215.375 | 0.073213 | 0.105532 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_40` | `MLP` | `MLPRegressor` | 215.375 | 0.073213 | 0.105532 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_40` | `ERT / GBM` | `MLP` | 215.375 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/mlp/2026-04-19-01-57-20__track1_mlp_phase_40_closure_attempt_03_campaign_run/onnx_export`;
