...
- run name: `track1_xgbm_amplitude_3_closure_attempt_02`;
- output run name: `track1_xgbm_amplitude_3_closure_attempt_02_campaign_run`;
- run instance id: `2026-04-19-07-10-30__track1_xgbm_amplitude_3_closure_attempt_02_campaign_run`;
...
- winning mean component MAPE: `10.523%`;
...
| --- | --- | ---: | ---: | --- |
| `XGBM` | `paper_reference_grid_search` | 5 | 0.595606 | `{'estimator__colsample_bytree': 0.3, 'estimator__learning_rate': 0.3, 'estimator__max_depth': 14}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `XGBM` | `XGBRegressor` | `paper_reference_grid_search` | 10.523 | 0.000081 | 0.000099 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_3` | `XGBM` | `XGBRegressor` | 10.523 | 0.000081 | 0.000099 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_3` | `HGBM` | `XGBM` | 10.523 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/xgbm/2026-04-19-07-10-30__track1_xgbm_amplitude_3_closure_attempt_02_campaign_run/onnx_export`;
