...
- run name: `track1_ert_phase_1_closure_attempt_05`;
- output run name: `track1_ert_phase_1_closure_attempt_05_campaign_run`;
- run instance id: `2026-04-19-04-59-19__track1_ert_phase_1_closure_attempt_05_campaign_run`;
...
- winning best params: `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 6, 'estimator__n_estimators': 60}`;
- winning mean component MAPE: `22.195%`;
- winning mean component MAE: `0.001983`;
...
| --- | --- | ---: | ---: | --- |
| `ERT` | `paper_reference_grid_search` | 5 | 0.686259 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 6, 'estimator__n_estimators': 60}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ERT` | `ExtraTreesRegressor` | `paper_reference_grid_search` | 22.195 | 0.001983 | 0.003078 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_1` | `ERT` | `ExtraTreesRegressor` | 22.195 | 0.001983 | 0.003078 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_1` | `RF / LGBM` | `ERT` | 22.195 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/ert/2026-04-19-04-59-19__track1_ert_phase_1_closure_attempt_05_campaign_run/onnx_export`;
