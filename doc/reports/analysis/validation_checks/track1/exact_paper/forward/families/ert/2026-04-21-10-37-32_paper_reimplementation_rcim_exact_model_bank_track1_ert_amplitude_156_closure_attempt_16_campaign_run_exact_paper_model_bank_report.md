...
- run name: `track1_ert_amplitude_156_closure_attempt_16`;
- output run name: `track1_ert_amplitude_156_closure_attempt_16_campaign_run`;
- run instance id: `2026-04-21-10-37-13__track1_ert_amplitude_156_closure_attempt_16_campaign_run`;
...
- winning mean component MAPE: `13.178%`;
...
| --- | --- | ---: | ---: | --- |
| `ERT` | `paper_reference_grid_search` | 5 | 0.988091 | `{'estimator__criterion': 'absolute_error', 'estimator__max_depth': 18, 'estimator__min_samples_split': 2, 'estimator__n_estimators': 40}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ERT` | `ExtraTreesRegressor` | `paper_reference_grid_search` | 13.178 | 0.000051 | 0.000202 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_156` | `ERT` | `ExtraTreesRegressor` | 13.178 | 0.000051 | 0.000202 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_156` | `ERT / RF` | `ERT` | 13.178 | `matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/ert/2026-04-21-10-37-13__track1_ert_amplitude_156_closure_attempt_16_campaign_run/onnx_export`;
