...
- run name: `track1_rf_amplitude_162_closure_attempt_06`;
- output run name: `track1_rf_amplitude_162_closure_attempt_06_campaign_run`;
- run instance id: `2026-04-19-02-39-31__track1_rf_amplitude_162_closure_attempt_06_campaign_run`;
...
- winning best params: `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 2, 'estimator__n_estimators': 90}`;
- winning mean component MAPE: `9.673%`;
- winning mean component MAE: `0.000061`;
- winning mean component RMSE: `0.000188`;
...
| --- | --- | ---: | ---: | --- |
| `RF` | `paper_reference_grid_search` | 5 | 0.945926 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 2, 'estimator__n_estimators': 90}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `RF` | `RandomForestRegressor` | `paper_reference_grid_search` | 9.673 | 0.000061 | 0.000188 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_162` | `RF` | `RandomForestRegressor` | 9.673 | 0.000061 | 0.000188 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_162` | `ERT` | `RF` | 9.673 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/rf/2026-04-19-02-39-31__track1_rf_amplitude_162_closure_attempt_06_campaign_run/onnx_export`;
