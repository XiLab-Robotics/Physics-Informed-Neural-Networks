...
- run name: `track1_rf_amplitude_156_closure_attempt_02`;
- output run name: `track1_rf_amplitude_156_closure_attempt_02_campaign_run`;
- run instance id: `2026-04-19-02-35-23__track1_rf_amplitude_156_closure_attempt_02_campaign_run`;
...
- winning mean component MAPE: `16.258%`;
- winning mean component MAE: `0.000044`;
- winning mean component RMSE: `0.000131`;
...
| --- | --- | ---: | ---: | --- |
| `RF` | `paper_reference_grid_search` | 5 | 0.980757 | `{'estimator__criterion': 'absolute_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 2, 'estimator__n_estimators': 50}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `RF` | `RandomForestRegressor` | `paper_reference_grid_search` | 16.258 | 0.000044 | 0.000131 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_156` | `RF` | `RandomForestRegressor` | 16.258 | 0.000044 | 0.000131 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_156` | `ERT / RF` | `RF` | 16.258 | `matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/rf/2026-04-19-02-35-23__track1_rf_amplitude_156_closure_attempt_02_campaign_run/onnx_export`;
