...
- run name: `track1_rf_phase_39_closure_attempt_05`;
- output run name: `track1_rf_phase_39_closure_attempt_05_campaign_run`;
- run instance id: `2026-04-19-02-48-51__track1_rf_phase_39_closure_attempt_05_campaign_run`;
...
- winning mean component MAPE: `1.760%`;
- winning mean component MAE: `0.022361`;
- winning mean component RMSE: `0.038215`;
...
| --- | --- | ---: | ---: | --- |
| `RF` | `paper_reference_grid_search` | 5 | 0.972805 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 12, 'estimator__min_samples_split': 3, 'estimator__n_estimators': 80}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `RF` | `RandomForestRegressor` | `paper_reference_grid_search` | 1.760 | 0.022361 | 0.038215 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_39` | `RF` | `RandomForestRegressor` | 1.760 | 0.022361 | 0.038215 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_39` | `HGBM` | `RF` | 1.760 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/rf/2026-04-19-02-48-51__track1_rf_phase_39_closure_attempt_05_campaign_run/onnx_export`;
