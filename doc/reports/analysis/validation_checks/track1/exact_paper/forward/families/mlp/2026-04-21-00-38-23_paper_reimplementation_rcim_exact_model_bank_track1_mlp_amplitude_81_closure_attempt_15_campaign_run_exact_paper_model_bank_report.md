...
- run name: `track1_mlp_amplitude_81_closure_attempt_15`;
- output run name: `track1_mlp_amplitude_81_closure_attempt_15_campaign_run`;
- run instance id: `2026-04-21-00-38-13__track1_mlp_amplitude_81_closure_attempt_15_campaign_run`;
...
- winning mean component MAPE: `5650.943%`;
- winning mean component MAE: `0.015320`;
- winning mean component RMSE: `0.026734`;
...
| --- | --- | ---: | ---: | --- |
| `MLP` | `paper_reference_grid_search` | 5 | -79569.866990 | `{'estimator__activation': 'tanh', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (200, 50), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `MLP` | `MLPRegressor` | `paper_reference_grid_search` | 5650.943 | 0.015320 | 0.026734 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_81` | `MLP` | `MLPRegressor` | 5650.943 | 0.015320 | 0.026734 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_81` | `RF` | `MLP` | 5650.943 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/mlp/2026-04-21-00-38-13__track1_mlp_amplitude_81_closure_attempt_15_campaign_run/onnx_export`;
