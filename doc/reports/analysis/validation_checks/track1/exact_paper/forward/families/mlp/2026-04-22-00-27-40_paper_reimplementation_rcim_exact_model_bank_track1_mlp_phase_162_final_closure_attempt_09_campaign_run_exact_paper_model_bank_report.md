...
- run name: `track1_mlp_phase_162_final_closure_attempt_09`;
- output run name: `track1_mlp_phase_162_final_closure_attempt_09_campaign_run`;
- run instance id: `2026-04-22-00-27-31__track1_mlp_phase_162_final_closure_attempt_09_campaign_run`;
...
- winning mean component MAPE: `56.450%`;
- winning mean component MAE: `1.148092`;
- winning mean component RMSE: `1.567435`;
...
| --- | --- | ---: | ---: | --- |
| `MLP` | `paper_reference_grid_search` | 5 | 0.279009 | `{'estimator__activation': 'relu', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (100,), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `MLP` | `MLPRegressor` | `paper_reference_grid_search` | 56.450 | 1.148092 | 1.567435 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_162` | `MLP` | `MLPRegressor` | 56.450 | 1.148092 | 1.567435 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_162` | `ERT` | `MLP` | 56.450 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/mlp/2026-04-22-00-27-31__track1_mlp_phase_162_final_closure_attempt_09_campaign_run/onnx_export`;
