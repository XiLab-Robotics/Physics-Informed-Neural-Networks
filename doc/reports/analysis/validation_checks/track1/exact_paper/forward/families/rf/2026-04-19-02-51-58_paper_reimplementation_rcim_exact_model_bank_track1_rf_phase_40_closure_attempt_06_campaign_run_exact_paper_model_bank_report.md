...
- run name: `track1_rf_phase_40_closure_attempt_06`;
- output run name: `track1_rf_phase_40_closure_attempt_06_campaign_run`;
- run instance id: `2026-04-19-02-51-41__track1_rf_phase_40_closure_attempt_06_campaign_run`;
...
- winning mean component MAPE: `56.540%`;
- winning mean component MAE: `0.036433`;
- winning mean component RMSE: `0.055011`;
...
| --- | --- | ---: | ---: | --- |
| `RF` | `paper_reference_grid_search` | 5 | 0.746848 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 12, 'estimator__min_samples_split': 2, 'estimator__n_estimators': 90}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `RF` | `RandomForestRegressor` | `paper_reference_grid_search` | 56.540 | 0.036433 | 0.055011 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_40` | `RF` | `RandomForestRegressor` | 56.540 | 0.036433 | 0.055011 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_40` | `ERT / GBM` | `RF` | 56.540 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/rf/2026-04-19-02-51-41__track1_rf_phase_40_closure_attempt_06_campaign_run/onnx_export`;
