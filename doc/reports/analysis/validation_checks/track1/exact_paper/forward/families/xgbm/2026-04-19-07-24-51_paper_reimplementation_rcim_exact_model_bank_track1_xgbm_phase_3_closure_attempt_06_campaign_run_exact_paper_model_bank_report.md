...
- run name: `track1_xgbm_phase_3_closure_attempt_06`;
- output run name: `track1_xgbm_phase_3_closure_attempt_06_campaign_run`;
- run instance id: `2026-04-19-07-24-43__track1_xgbm_phase_3_closure_attempt_06_campaign_run`;
...
- winning mean component MAE: `0.024795`;
- winning mean component RMSE: `0.034394`;
...
| --- | --- | ---: | ---: | --- |
| `XGBM` | `paper_reference_grid_search` | 5 | 0.927764 | `{'estimator__colsample_bytree': 0.8, 'estimator__learning_rate': 0.2, 'estimator__max_depth': 14}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `XGBM` | `XGBRegressor` | `paper_reference_grid_search` | 1.383 | 0.024795 | 0.034394 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_3` | `XGBM` | `XGBRegressor` | 1.383 | 0.024795 | 0.034394 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_3` | `HGBM` | `XGBM` | 1.383 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/xgbm/2026-04-19-07-24-43__track1_xgbm_phase_3_closure_attempt_06_campaign_run/onnx_export`;
