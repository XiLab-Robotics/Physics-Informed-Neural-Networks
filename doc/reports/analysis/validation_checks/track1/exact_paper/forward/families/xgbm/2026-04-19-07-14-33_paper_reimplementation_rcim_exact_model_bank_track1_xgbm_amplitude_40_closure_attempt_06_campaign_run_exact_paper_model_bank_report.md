...
- run name: `track1_xgbm_amplitude_40_closure_attempt_06`;
- output run name: `track1_xgbm_amplitude_40_closure_attempt_06_campaign_run`;
- run instance id: `2026-04-19-07-14-25__track1_xgbm_amplitude_40_closure_attempt_06_campaign_run`;
...
- winning mean component MAPE: `8.501%`;
- winning mean component MAE: `0.000066`;
- winning mean component RMSE: `0.000087`;
...
| --- | --- | ---: | ---: | --- |
| `XGBM` | `paper_reference_grid_search` | 5 | -0.005710 | `{'estimator__colsample_bytree': 0.3, 'estimator__learning_rate': 0.01, 'estimator__max_depth': 14}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `XGBM` | `XGBRegressor` | `paper_reference_grid_search` | 8.501 | 0.000066 | 0.000087 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_40` | `XGBM` | `XGBRegressor` | 8.501 | 0.000066 | 0.000087 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_40` | `ERT / GBM` | `XGBM` | 8.501 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/xgbm/2026-04-19-07-14-25__track1_xgbm_amplitude_40_closure_attempt_06_campaign_run/onnx_export`;
