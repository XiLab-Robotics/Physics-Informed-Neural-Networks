...
- run name: `track1_et_phase_40_closure_attempt_05`;
- output run name: `track1_et_phase_40_closure_attempt_05_campaign_run`;
- run instance id: `2026-04-19-04-14-26__track1_et_phase_40_closure_attempt_05_campaign_run`;
...
- winning mean component MAPE: `53.263%`;
- winning mean component MAE: `0.041306`;
- winning mean component RMSE: `0.065144`;
...
| --- | --- | ---: | ---: | --- |
| `ET` | `paper_reference_grid_search` | 5 | 0.646294 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 6}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ET` | `ExtraTreeRegressor` | `paper_reference_grid_search` | 53.263 | 0.041306 | 0.065144 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_40` | `ET` | `ExtraTreeRegressor` | 53.263 | 0.041306 | 0.065144 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_40` | `ERT / GBM` | `ET` | 53.263 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/et/2026-04-19-04-14-26__track1_et_phase_40_closure_attempt_05_campaign_run/onnx_export`;
