...
- run name: `track1_mlp_phase_40_closure_attempt_05`;
- output run name: `track1_mlp_phase_40_closure_attempt_05_campaign_run`;
- run instance id: `2026-04-19-01-57-52__track1_mlp_phase_40_closure_attempt_05_campaign_run`;
...
- winning mean component MAPE: `98.006%`;
- winning mean component MAE: `0.064060`;
- winning mean component RMSE: `0.094429`;
...
| --- | --- | ---: | ---: | --- |
| `MLP` | `paper_reference_grid_search` | 5 | 0.238108 | `{'estimator__activation': 'tanh', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (100, 50), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `MLP` | `MLPRegressor` | `paper_reference_grid_search` | 98.006 | 0.064060 | 0.094429 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_40` | `MLP` | `MLPRegressor` | 98.006 | 0.064060 | 0.094429 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_40` | `ERT / GBM` | `MLP` | 98.006 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/mlp/2026-04-19-01-57-52__track1_mlp_phase_40_closure_attempt_05_campaign_run/onnx_export`;
