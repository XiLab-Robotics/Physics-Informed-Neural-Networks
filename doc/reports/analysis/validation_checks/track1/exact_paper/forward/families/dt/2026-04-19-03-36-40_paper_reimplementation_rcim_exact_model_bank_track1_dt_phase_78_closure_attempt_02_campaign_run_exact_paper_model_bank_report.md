...
- run name: `track1_dt_phase_78_closure_attempt_02`;
- output run name: `track1_dt_phase_78_closure_attempt_02_campaign_run`;
- run instance id: `2026-04-19-03-36-32__track1_dt_phase_78_closure_attempt_02_campaign_run`;
...
- winning mean component MAPE: `73.132%`;
- winning mean component MAE: `0.085354`;
- winning mean component RMSE: `0.176873`;
...
| --- | --- | ---: | ---: | --- |
| `DT` | `paper_reference_grid_search` | 5 | 0.805441 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 6}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `DT` | `DecisionTreeRegressor` | `paper_reference_grid_search` | 73.132 | 0.085354 | 0.176873 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_78` | `DT` | `DecisionTreeRegressor` | 73.132 | 0.085354 | 0.176873 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_78` | `HGBM / RF` | `DT` | 73.132 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/dt/2026-04-19-03-36-32__track1_dt_phase_78_closure_attempt_02_campaign_run/onnx_export`;
