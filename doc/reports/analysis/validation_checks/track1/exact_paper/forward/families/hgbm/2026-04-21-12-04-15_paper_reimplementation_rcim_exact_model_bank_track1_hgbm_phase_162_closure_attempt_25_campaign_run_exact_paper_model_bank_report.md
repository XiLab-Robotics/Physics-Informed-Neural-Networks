...
- run name: `track1_hgbm_phase_162_closure_attempt_25`;
- output run name: `track1_hgbm_phase_162_closure_attempt_25_campaign_run`;
- run instance id: `2026-04-21-12-04-03__track1_hgbm_phase_162_closure_attempt_25_campaign_run`;
...
- winning mean component MAPE: `16.181%`;
- winning mean component MAE: `0.344600`;
- winning mean component RMSE: `0.682011`;
...
| --- | --- | ---: | ---: | --- |
| `HGBM` | `paper_reference_grid_search` | 5 | 0.635102 | `{'estimator__learning_rate': 0.19, 'estimator__max_depth': 12, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 24}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `HGBM` | `HistGradientBoostingRegressor` | `paper_reference_grid_search` | 16.181 | 0.344600 | 0.682011 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_162` | `HGBM` | `HistGradientBoostingRegressor` | 16.181 | 0.344600 | 0.682011 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_162` | `ERT` | `HGBM` | 16.181 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/hgbm/2026-04-21-12-04-03__track1_hgbm_phase_162_closure_attempt_25_campaign_run/onnx_export`;
