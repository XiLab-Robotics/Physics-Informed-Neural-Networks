...
- run name: `track1_ert_phase_162_closure_attempt_16`;
- output run name: `track1_ert_phase_162_closure_attempt_16_campaign_run`;
- run instance id: `2026-04-21-11-10-11__track1_ert_phase_162_closure_attempt_16_campaign_run`;
...
- winning mean component MAPE: `9.066%`;
- winning mean component MAE: `0.209406`;
- winning mean component RMSE: `0.619670`;
...
| --- | --- | ---: | ---: | --- |
| `ERT` | `paper_reference_grid_search` | 5 | 0.779989 | `{'estimator__criterion': 'absolute_error', 'estimator__max_depth': 16, 'estimator__min_samples_split': 2, 'estimator__n_estimators': 100}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ERT` | `ExtraTreesRegressor` | `paper_reference_grid_search` | 9.066 | 0.209406 | 0.619670 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_162` | `ERT` | `ExtraTreesRegressor` | 9.066 | 0.209406 | 0.619670 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_162` | `ERT` | `ERT` | 9.066 | `matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/ert/2026-04-21-11-10-11__track1_ert_phase_162_closure_attempt_16_campaign_run/onnx_export`;
