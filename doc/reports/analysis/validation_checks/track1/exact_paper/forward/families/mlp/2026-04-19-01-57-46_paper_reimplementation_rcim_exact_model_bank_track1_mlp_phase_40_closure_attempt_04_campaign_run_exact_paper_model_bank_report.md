...
- run name: `track1_mlp_phase_40_closure_attempt_04`;
- output run name: `track1_mlp_phase_40_closure_attempt_04_campaign_run`;
- run instance id: `2026-04-19-01-57-36__track1_mlp_phase_40_closure_attempt_04_campaign_run`;
...
- winning mean component MAPE: `128.997%`;
- winning mean component MAE: `0.072731`;
- winning mean component RMSE: `0.098044`;
...
| --- | --- | ---: | ---: | --- |
| `MLP` | `paper_reference_grid_search` | 5 | 0.168072 | `{'estimator__activation': 'tanh', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (200, 50), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `MLP` | `MLPRegressor` | `paper_reference_grid_search` | 128.997 | 0.072731 | 0.098044 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_40` | `MLP` | `MLPRegressor` | 128.997 | 0.072731 | 0.098044 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_40` | `ERT / GBM` | `MLP` | 128.997 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/mlp/2026-04-19-01-57-36__track1_mlp_phase_40_closure_attempt_04_campaign_run/onnx_export`;
