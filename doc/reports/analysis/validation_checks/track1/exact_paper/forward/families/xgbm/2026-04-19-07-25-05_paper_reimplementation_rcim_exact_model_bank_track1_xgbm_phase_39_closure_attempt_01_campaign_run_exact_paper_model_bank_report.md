...
- run name: `track1_xgbm_phase_39_closure_attempt_01`;
- output run name: `track1_xgbm_phase_39_closure_attempt_01_campaign_run`;
- run instance id: `2026-04-19-07-24-57__track1_xgbm_phase_39_closure_attempt_01_campaign_run`;
...
- winning mean component MAE: `0.027801`;
- winning mean component RMSE: `0.043762`;
...
| --- | --- | ---: | ---: | --- |
| `XGBM` | `paper_reference_grid_search` | 5 | 0.973482 | `{'estimator__colsample_bytree': 0.8, 'estimator__learning_rate': 0.2, 'estimator__max_depth': 16}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `XGBM` | `XGBRegressor` | `paper_reference_grid_search` | 2.236 | 0.027801 | 0.043762 |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/xgbm/2026-04-19-07-24-57__track1_xgbm_phase_39_closure_attempt_01_campaign_run/onnx_export`;
