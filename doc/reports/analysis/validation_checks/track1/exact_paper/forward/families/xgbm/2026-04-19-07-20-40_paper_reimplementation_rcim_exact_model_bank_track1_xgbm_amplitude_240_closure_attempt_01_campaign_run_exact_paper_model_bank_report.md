...
- run name: `track1_xgbm_amplitude_240_closure_attempt_01`;
- output run name: `track1_xgbm_amplitude_240_closure_attempt_01_campaign_run`;
- run instance id: `2026-04-19-07-20-32__track1_xgbm_amplitude_240_closure_attempt_01_campaign_run`;
...
- winning mean component MAPE: `82.161%`;
- winning mean component MAE: `0.000187`;
- winning mean component RMSE: `0.000314`;
...
| --- | --- | ---: | ---: | --- |
| `XGBM` | `paper_reference_grid_search` | 5 | 0.710755 | `{'estimator__colsample_bytree': 0.8, 'estimator__learning_rate': 0.3, 'estimator__max_depth': 14}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `XGBM` | `XGBRegressor` | `paper_reference_grid_search` | 82.161 | 0.000187 | 0.000314 |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/xgbm/2026-04-19-07-20-32__track1_xgbm_amplitude_240_closure_attempt_01_campaign_run/onnx_export`;
