...
- run name: `track1_svm_amplitude_240_yellow_cell_attempt_02`;
- output run name: `track1_svm_amplitude_240_yellow_cell_attempt_02_campaign_run`;
- run instance id: `2026-04-22-12-01-54__track1_svm_amplitude_240_yellow_cell_attempt_02_campaign_run`;
...
- winning mean component MAPE: `73.669%`;
- winning mean component MAE: `0.000298`;
- winning mean component RMSE: `0.000564`;
...
| --- | --- | ---: | ---: | --- |
| `SVR` | `paper_reference_grid_search` | 5 | 0.154749 | `{'estimator__C': 0.1, 'estimator__epsilon': 1e-05, 'estimator__gamma': 1.1e-06, 'estimator__kernel': 'rbf'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `SVR` | `SVR` | `paper_reference_grid_search` | 73.669 | 0.000298 | 0.000564 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_240` | `SVR` | `SVR` | 73.669 | 0.000298 | 0.000564 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_240` | `ERT` | `SVR` | 73.669 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/svm_targeted_closure/svm/2026-04-22-12-01-54__track1_svm_amplitude_240_yellow_cell_attempt_02_campaign_run/onnx_export`;
