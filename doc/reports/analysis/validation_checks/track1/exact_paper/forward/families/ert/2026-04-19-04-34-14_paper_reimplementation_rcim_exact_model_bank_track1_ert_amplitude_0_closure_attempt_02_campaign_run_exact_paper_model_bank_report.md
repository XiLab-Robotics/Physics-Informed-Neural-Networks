...
- run name: `track1_ert_amplitude_0_closure_attempt_02`;
- output run name: `track1_ert_amplitude_0_closure_attempt_02_campaign_run`;
- run instance id: `2026-04-19-04-33-57__track1_ert_amplitude_0_closure_attempt_02_campaign_run`;
...
- winning best params: `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 17, 'estimator__min_samples_split': 6, 'estimator__n_estimators': 100}`;
- winning mean component MAPE: `5.983%`;
- winning mean component MAE: `0.002915`;
- winning mean component RMSE: `0.003479`;
...
| --- | --- | ---: | ---: | --- |
| `ERT` | `paper_reference_grid_search` | 5 | 0.964266 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 17, 'estimator__min_samples_split': 6, 'estimator__n_estimators': 100}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ERT` | `ExtraTreesRegressor` | `paper_reference_grid_search` | 5.983 | 0.002915 | 0.003479 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_0` | `ERT` | `ExtraTreesRegressor` | 5.983 | 0.002915 | 0.003479 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_0` | `SVR` | `ERT` | 5.983 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/ert/2026-04-19-04-33-57__track1_ert_amplitude_0_closure_attempt_02_campaign_run/onnx_export`;
