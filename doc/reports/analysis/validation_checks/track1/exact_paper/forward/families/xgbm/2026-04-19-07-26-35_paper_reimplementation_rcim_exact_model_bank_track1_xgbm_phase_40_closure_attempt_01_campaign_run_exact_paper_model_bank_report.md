...
- run name: `track1_xgbm_phase_40_closure_attempt_01`;
- output run name: `track1_xgbm_phase_40_closure_attempt_01_campaign_run`;
- run instance id: `2026-04-19-07-26-27__track1_xgbm_phase_40_closure_attempt_01_campaign_run`;
...
- winning mean component MAPE: `110.530%`;
- winning mean component MAE: `0.056245`;
- winning mean component RMSE: `0.084596`;
...
| --- | --- | ---: | ---: | --- |
| `XGBM` | `paper_reference_grid_search` | 5 | 0.570199 | `{'estimator__colsample_bytree': 0.8, 'estimator__learning_rate': 0.2, 'estimator__max_depth': 14}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `XGBM` | `XGBRegressor` | `paper_reference_grid_search` | 110.530 | 0.056245 | 0.084596 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_40` | `XGBM` | `XGBRegressor` | 110.530 | 0.056245 | 0.084596 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_40` | `ERT / GBM` | `XGBM` | 110.530 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/xgbm/2026-04-19-07-26-27__track1_xgbm_phase_40_closure_attempt_01_campaign_run/onnx_export`;
