...
- run name: `track1_et_phase_240_closure_attempt_10`;
- output run name: `track1_et_phase_240_closure_attempt_10_campaign_run`;
- run instance id: `2026-04-21-10-23-20__track1_et_phase_240_closure_attempt_10_campaign_run`;
...
- winning mean component MAPE: `18.208%`;
- winning mean component MAE: `0.252950`;
- winning mean component RMSE: `0.787224`;
...
| --- | --- | ---: | ---: | --- |
| `ET` | `paper_reference_grid_search` | 5 | 0.353916 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 17, 'estimator__min_samples_split': 3}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ET` | `ExtraTreeRegressor` | `paper_reference_grid_search` | 18.208 | 0.252950 | 0.787224 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_240` | `ET` | `ExtraTreeRegressor` | 18.208 | 0.252950 | 0.787224 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_240` | `ERT` | `ET` | 18.208 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/et/2026-04-21-10-23-20__track1_et_phase_240_closure_attempt_10_campaign_run/onnx_export`;
