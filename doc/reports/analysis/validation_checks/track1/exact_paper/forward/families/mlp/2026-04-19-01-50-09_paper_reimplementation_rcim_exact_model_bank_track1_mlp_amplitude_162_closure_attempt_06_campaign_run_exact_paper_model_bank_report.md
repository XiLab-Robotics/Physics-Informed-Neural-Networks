...
- run name: `track1_mlp_amplitude_162_closure_attempt_06`;
- output run name: `track1_mlp_amplitude_162_closure_attempt_06_campaign_run`;
- run instance id: `2026-04-19-01-50-00__track1_mlp_amplitude_162_closure_attempt_06_campaign_run`;
...
- winning mean component MAPE: `11316.150%`;
- winning mean component MAE: `0.013425`;
- winning mean component RMSE: `0.024939`;
...
| --- | --- | ---: | ---: | --- |
| `MLP` | `paper_reference_grid_search` | 5 | -228.280018 | `{'estimator__activation': 'tanh', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (200, 50), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `MLP` | `MLPRegressor` | `paper_reference_grid_search` | 11316.150 | 0.013425 | 0.024939 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_162` | `MLP` | `MLPRegressor` | 11316.150 | 0.013425 | 0.024939 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_162` | `ERT` | `MLP` | 11316.150 | `not_matched_expected_family_direction` |
...
| `Repo Best RMSE` | - | - | - | - | - | - | - | - | 0.0249 | - |
| `Paper Best Family` | - | - | - | - | - | - | - | - | `ERT` | - |
| `Paper Target RMSE` | - | - | - | - | - | - | - | - | 1.60e-04 | - |
| `Gap Vs Paper` | - | - | - | - | - | - | - | - | 0.0248 | - |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/mlp/2026-04-19-01-50-00__track1_mlp_amplitude_162_closure_attempt_06_campaign_run/onnx_export`;
