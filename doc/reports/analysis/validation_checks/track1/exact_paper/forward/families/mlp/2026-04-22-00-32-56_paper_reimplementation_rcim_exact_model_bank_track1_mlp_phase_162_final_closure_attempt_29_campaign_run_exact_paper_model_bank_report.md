...
- run name: `track1_mlp_phase_162_final_closure_attempt_29`;
- output run name: `track1_mlp_phase_162_final_closure_attempt_29_campaign_run`;
- run instance id: `2026-04-22-00-32-47__track1_mlp_phase_162_final_closure_attempt_29_campaign_run`;
...
- winning mean component MAPE: `40.220%`;
- winning mean component MAE: `0.826864`;
- winning mean component RMSE: `1.391437`;
...
| --- | --- | ---: | ---: | --- |
| `MLP` | `paper_reference_grid_search` | 5 | 0.279120 | `{'estimator__activation': 'tanh', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (200, 50), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `MLP` | `MLPRegressor` | `paper_reference_grid_search` | 40.220 | 0.826864 | 1.391437 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_162` | `MLP` | `MLPRegressor` | 40.220 | 0.826864 | 1.391437 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_162` | `ERT` | `MLP` | 40.220 | `not_matched_expected_family_direction` |
...
| `Repo Best MAE` | - | - | - | - | - | - | - | 0.8269 | - |
| `Paper Best Family` | - | - | - | - | - | - | - | `DT` | - |
| `Paper Target MAE` | - | - | - | - | - | - | - | 0.2000 | - |
| `Gap Vs Paper` | - | - | - | - | - | - | - | 0.6269 | - |
...
| `Repo Best Family` | - | - | - | - | - | - | - | `MLP` | - |
| `Repo Best RMSE` | - | - | - | - | - | - | - | 1.391 | - |
| `Paper Best Family` | - | - | - | - | - | - | - | `ERT` | - |
| `Paper Target RMSE` | - | - | - | - | - | - | - | 0.6400 | - |
| `Gap Vs Paper` | - | - | - | - | - | - | - | 0.7514 | - |
| `Status` | - | - | - | - | - | - | - | `above_paper_target` | - |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/mlp/2026-04-22-00-32-47__track1_mlp_phase_162_final_closure_attempt_29_campaign_run/onnx_export`;
