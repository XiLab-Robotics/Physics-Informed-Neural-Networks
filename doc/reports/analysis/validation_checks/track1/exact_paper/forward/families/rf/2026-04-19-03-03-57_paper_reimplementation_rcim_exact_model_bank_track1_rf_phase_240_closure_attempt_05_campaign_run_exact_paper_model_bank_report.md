...
- run name: `track1_rf_phase_240_closure_attempt_05`;
- output run name: `track1_rf_phase_240_closure_attempt_05_campaign_run`;
- run instance id: `2026-04-19-03-03-39__track1_rf_phase_240_closure_attempt_05_campaign_run`;
...
- winning mean component MAPE: `13.922%`;
- winning mean component MAE: `0.284363`;
- winning mean component RMSE: `0.724148`;
...
| --- | --- | ---: | ---: | --- |
| `RF` | `paper_reference_grid_search` | 5 | 0.582411 | `{'estimator__criterion': 'absolute_error', 'estimator__max_depth': 13, 'estimator__min_samples_split': 2, 'estimator__n_estimators': 60}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `RF` | `RandomForestRegressor` | `paper_reference_grid_search` | 13.922 | 0.284363 | 0.724148 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_240` | `RF` | `RandomForestRegressor` | 13.922 | 0.284363 | 0.724148 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_240` | `ERT` | `RF` | 13.922 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/rf/2026-04-19-03-03-39__track1_rf_phase_240_closure_attempt_05_campaign_run/onnx_export`;
