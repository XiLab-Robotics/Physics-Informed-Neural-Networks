...
- run name: `track1_lgbm_phase_162_closure_attempt_11`;
- output run name: `track1_lgbm_phase_162_closure_attempt_11_campaign_run`;
- run instance id: `2026-04-21-12-58-16__track1_lgbm_phase_162_closure_attempt_11_campaign_run`;
...
- winning best params: `{'estimator__learning_rate': 0.58, 'estimator__max_depth': 13, 'estimator__num_leaves': 31, 'estimator__subsample': 0.001}`;
- winning mean component MAPE: `14.976%`;
- winning mean component MAE: `0.378037`;
- winning mean component RMSE: `0.975674`;
...
| --- | --- | ---: | ---: | --- |
| `LGBM` | `paper_reference_grid_search` | 5 | 0.725109 | `{'estimator__learning_rate': 0.58, 'estimator__max_depth': 13, 'estimator__num_leaves': 31, 'estimator__subsample': 0.001}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `LGBM` | `LGBMRegressor` | `paper_reference_grid_search` | 14.976 | 0.378037 | 0.975674 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_162` | `LGBM` | `LGBMRegressor` | 14.976 | 0.378037 | 0.975674 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_162` | `ERT` | `LGBM` | 14.976 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/lgbm/2026-04-21-12-58-16__track1_lgbm_phase_162_closure_attempt_11_campaign_run/onnx_export`;
