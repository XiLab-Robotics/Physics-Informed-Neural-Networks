...
- run name: `track1_xgbm_amplitude_240_closure_attempt_05`;
- output run name: `track1_xgbm_amplitude_240_closure_attempt_05_campaign_run`;
- run instance id: `2026-04-19-07-21-31__track1_xgbm_amplitude_240_closure_attempt_05_campaign_run`;
...
- winning mean component MAPE: `76.723%`;
- winning mean component MAE: `0.000171`;
- winning mean component RMSE: `0.000284`;
...
| --- | --- | ---: | ---: | --- |
| `XGBM` | `paper_reference_grid_search` | 5 | 0.727546 | `{'estimator__colsample_bytree': 0.8, 'estimator__learning_rate': 0.3, 'estimator__max_depth': 14}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `XGBM` | `XGBRegressor` | `paper_reference_grid_search` | 76.723 | 0.000171 | 0.000284 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_240` | `XGBM` | `XGBRegressor` | 76.723 | 0.000171 | 0.000284 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_240` | `ERT` | `XGBM` | 76.723 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/xgbm/2026-04-19-07-21-31__track1_xgbm_amplitude_240_closure_attempt_05_campaign_run/onnx_export`;
