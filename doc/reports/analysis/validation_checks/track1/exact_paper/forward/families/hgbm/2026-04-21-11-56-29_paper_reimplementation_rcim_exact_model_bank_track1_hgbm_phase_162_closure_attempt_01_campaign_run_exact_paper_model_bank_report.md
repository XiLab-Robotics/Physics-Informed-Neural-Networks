...
- run name: `track1_hgbm_phase_162_closure_attempt_01`;
- output run name: `track1_hgbm_phase_162_closure_attempt_01_campaign_run`;
- run instance id: `2026-04-21-11-56-16__track1_hgbm_phase_162_closure_attempt_01_campaign_run`;
...
- winning mean component MAPE: `17.627%`;
- winning mean component MAE: `0.387796`;
- winning mean component RMSE: `0.819126`;
...
| --- | --- | ---: | ---: | --- |
| `HGBM` | `paper_reference_grid_search` | 5 | 0.666331 | `{'estimator__learning_rate': 0.21, 'estimator__max_depth': 13, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 25}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `HGBM` | `HistGradientBoostingRegressor` | `paper_reference_grid_search` | 17.627 | 0.387796 | 0.819126 |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/hgbm/2026-04-21-11-56-16__track1_hgbm_phase_162_closure_attempt_01_campaign_run/onnx_export`;
