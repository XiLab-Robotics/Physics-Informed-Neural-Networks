...
- run name: `track1_ert_amplitude_162_closure_attempt_27`;
- output run name: `track1_ert_amplitude_162_closure_attempt_27_campaign_run`;
- run instance id: `2026-04-21-10-52-43__track1_ert_amplitude_162_closure_attempt_27_campaign_run`;
...
- winning best params: `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 17, 'estimator__min_samples_split': 2, 'estimator__n_estimators': 20}`;
- winning mean component MAPE: `8.757%`;
- winning mean component MAE: `0.000070`;
...
| --- | --- | ---: | ---: | --- |
| `ERT` | `paper_reference_grid_search` | 5 | 0.979184 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 17, 'estimator__min_samples_split': 2, 'estimator__n_estimators': 20}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ERT` | `ExtraTreesRegressor` | `paper_reference_grid_search` | 8.757 | 0.000070 | 0.000292 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_162` | `ERT` | `ExtraTreesRegressor` | 8.757 | 0.000070 | 0.000292 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_162` | `ERT` | `ERT` | 8.757 | `matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/ert/2026-04-21-10-52-43__track1_ert_amplitude_162_closure_attempt_27_campaign_run/onnx_export`;
