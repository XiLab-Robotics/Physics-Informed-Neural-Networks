...
- run name: `track1_hgbm_phase_1_closure_attempt_01`;
- output run name: `track1_hgbm_phase_1_closure_attempt_01_campaign_run`;
- run instance id: `2026-04-19-06-38-22__track1_hgbm_phase_1_closure_attempt_01_campaign_run`;
...
- winning mean component MAPE: `21.079%`;
- winning mean component MAE: `0.001839`;
- winning mean component RMSE: `0.002553`;
...
| --- | --- | ---: | ---: | --- |
| `HGBM` | `paper_reference_grid_search` | 5 | 0.758499 | `{'estimator__learning_rate': 0.21, 'estimator__max_depth': 12, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 26}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `HGBM` | `HistGradientBoostingRegressor` | `paper_reference_grid_search` | 21.079 | 0.001839 | 0.002553 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_1` | `HGBM` | `HistGradientBoostingRegressor` | 21.079 | 0.001839 | 0.002553 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_1` | `RF / LGBM` | `HGBM` | 21.079 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/hgbm/2026-04-19-06-38-22__track1_hgbm_phase_1_closure_attempt_01_campaign_run/onnx_export`;
