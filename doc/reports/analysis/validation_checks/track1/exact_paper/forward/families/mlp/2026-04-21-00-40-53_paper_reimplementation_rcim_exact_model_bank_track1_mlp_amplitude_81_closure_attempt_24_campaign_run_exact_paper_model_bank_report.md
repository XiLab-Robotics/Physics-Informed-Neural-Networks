...
- run name: `track1_mlp_amplitude_81_closure_attempt_24`;
- output run name: `track1_mlp_amplitude_81_closure_attempt_24_campaign_run`;
- run instance id: `2026-04-21-00-40-43__track1_mlp_amplitude_81_closure_attempt_24_campaign_run`;
...
- winning mean component MAPE: `4504.775%`;
- winning mean component MAE: `0.012559`;
- winning mean component RMSE: `0.022411`;
...
| --- | --- | ---: | ---: | --- |
| `MLP` | `paper_reference_grid_search` | 5 | -101528.948647 | `{'estimator__activation': 'tanh', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (200, 50), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `MLP` | `MLPRegressor` | `paper_reference_grid_search` | 4504.775 | 0.012559 | 0.022411 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_81` | `MLP` | `MLPRegressor` | 4504.775 | 0.012559 | 0.022411 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_81` | `RF` | `MLP` | 4504.775 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/mlp/2026-04-21-00-40-43__track1_mlp_amplitude_81_closure_attempt_24_campaign_run/onnx_export`;
