...
- run name: `track1_svm_amplitude_240_yellow_cell_attempt_10`;
- output run name: `track1_svm_amplitude_240_yellow_cell_attempt_10_campaign_run`;
- run instance id: `2026-04-23-07-21-33__track1_svm_amplitude_240_yellow_cell_attempt_10_campaign_run`;
...
- winning best params: `{'estimator__C': 0.1, 'estimator__epsilon': 0.0001, 'estimator__gamma': 1.1e-06, 'estimator__kernel': 'rbf'}`;
- winning mean component MAPE: `74.512%`;
- winning mean component MAE: `0.000265`;
- winning mean component RMSE: `0.000445`;
...
| --- | --- | ---: | ---: | --- |
| `SVR` | `paper_reference_grid_search` | 5 | 0.224339 | `{'estimator__C': 0.1, 'estimator__epsilon': 0.0001, 'estimator__gamma': 1.1e-06, 'estimator__kernel': 'rbf'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `SVR` | `SVR` | `paper_reference_grid_search` | 74.512 | 0.000265 | 0.000445 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_240` | `SVR` | `SVR` | 74.512 | 0.000265 | 0.000445 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_240` | `ERT` | `SVR` | 74.512 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/svm_targeted_closure/svm/2026-04-23-07-21-33__track1_svm_amplitude_240_yellow_cell_attempt_10_campaign_run/onnx_export`;
