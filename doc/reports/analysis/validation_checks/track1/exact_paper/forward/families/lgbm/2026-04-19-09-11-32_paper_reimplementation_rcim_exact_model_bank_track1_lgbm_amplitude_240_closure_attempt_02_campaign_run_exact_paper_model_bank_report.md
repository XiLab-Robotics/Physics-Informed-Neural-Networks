...
- run name: `track1_lgbm_amplitude_240_closure_attempt_02`;
- output run name: `track1_lgbm_amplitude_240_closure_attempt_02_campaign_run`;
- run instance id: `2026-04-19-09-10-08__track1_lgbm_amplitude_240_closure_attempt_02_campaign_run`;
...
- winning mean component MAPE: `15.779%`;
...
| --- | --- | ---: | ---: | --- |
| `LGBM` | `paper_reference_grid_search` | 5 | 0.969488 | `{'estimator__learning_rate': 0.58, 'estimator__max_depth': 12, 'estimator__num_leaves': 31, 'estimator__subsample': 0.001}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `LGBM` | `LGBMRegressor` | `paper_reference_grid_search` | 15.779 | 0.000032 | 0.000051 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_240` | `LGBM` | `LGBMRegressor` | 15.779 | 0.000032 | 0.000051 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_240` | `ERT` | `LGBM` | 15.779 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/lgbm/2026-04-19-09-10-08__track1_lgbm_amplitude_240_closure_attempt_02_campaign_run/onnx_export`;
