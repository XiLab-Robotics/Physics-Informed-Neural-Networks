...
- run name: `track1_mlp_amplitude_156_final_closure_attempt_02`;
- output run name: `track1_mlp_amplitude_156_final_closure_attempt_02_campaign_run`;
- run instance id: `2026-04-21-23-55-54__track1_mlp_amplitude_156_final_closure_attempt_02_campaign_run`;
...
- winning mean component MAPE: `14855.859%`;
- winning mean component MAE: `0.013458`;
- winning mean component RMSE: `0.020930`;
...
| --- | --- | ---: | ---: | --- |
| `MLP` | `paper_reference_grid_search` | 5 | -222.263244 | `{'estimator__activation': 'tanh', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (200, 50), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `MLP` | `MLPRegressor` | `paper_reference_grid_search` | 14855.859 | 0.013458 | 0.020930 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_156` | `MLP` | `MLPRegressor` | 14855.859 | 0.013458 | 0.020930 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_156` | `ERT / RF` | `MLP` | 14855.859 | `not_matched_expected_family_direction` |
...
| `Repo Best RMSE` | - | - | - | - | - | - | - | 0.0209 | - | - |
| `Paper Best Family` | - | - | - | - | - | - | - | `ERT` | - | - |
| `Paper Target RMSE` | - | - | - | - | - | - | - | 1.30e-04 | - | - |
| `Gap Vs Paper` | - | - | - | - | - | - | - | 0.0208 | - | - |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/mlp/2026-04-21-23-55-54__track1_mlp_amplitude_156_final_closure_attempt_02_campaign_run/onnx_export`;
