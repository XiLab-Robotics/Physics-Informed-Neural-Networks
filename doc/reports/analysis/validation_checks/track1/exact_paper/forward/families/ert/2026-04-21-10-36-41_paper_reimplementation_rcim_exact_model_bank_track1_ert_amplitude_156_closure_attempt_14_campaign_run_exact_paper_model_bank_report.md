...
- run name: `track1_ert_amplitude_156_closure_attempt_14`;
- output run name: `track1_ert_amplitude_156_closure_attempt_14_campaign_run`;
- run instance id: `2026-04-21-10-36-23__track1_ert_amplitude_156_closure_attempt_14_campaign_run`;
...
- winning best params: `{'estimator__criterion': 'absolute_error', 'estimator__max_depth': 16, 'estimator__min_samples_split': 2, 'estimator__n_estimators': 20}`;
- winning mean component MAPE: `14.040%`;
- winning mean component MAE: `0.000040`;
- winning mean component RMSE: `0.000127`;
...
| --- | --- | ---: | ---: | --- |
| `ERT` | `paper_reference_grid_search` | 5 | 0.989078 | `{'estimator__criterion': 'absolute_error', 'estimator__max_depth': 16, 'estimator__min_samples_split': 2, 'estimator__n_estimators': 20}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ERT` | `ExtraTreesRegressor` | `paper_reference_grid_search` | 14.040 | 0.000040 | 0.000127 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_156` | `ERT` | `ExtraTreesRegressor` | 14.040 | 0.000040 | 0.000127 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_156` | `ERT / RF` | `ERT` | 14.040 | `matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/ert/2026-04-21-10-36-23__track1_ert_amplitude_156_closure_attempt_14_campaign_run/onnx_export`;
