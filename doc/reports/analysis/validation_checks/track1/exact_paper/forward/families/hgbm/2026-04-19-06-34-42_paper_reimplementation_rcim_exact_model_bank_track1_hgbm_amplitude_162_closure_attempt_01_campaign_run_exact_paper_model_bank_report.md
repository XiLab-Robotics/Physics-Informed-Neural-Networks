...
- run name: `track1_hgbm_amplitude_162_closure_attempt_01`;
- output run name: `track1_hgbm_amplitude_162_closure_attempt_01_campaign_run`;
- run instance id: `2026-04-19-06-34-30__track1_hgbm_amplitude_162_closure_attempt_01_campaign_run`;
...
- winning best params: `{'estimator__learning_rate': 0.2, 'estimator__max_depth': 13, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 25}`;
- winning mean component MAPE: `22.334%`;
- winning mean component MAE: `0.000142`;
- winning mean component RMSE: `0.000328`;
...
| --- | --- | ---: | ---: | --- |
| `HGBM` | `paper_reference_grid_search` | 5 | 0.954760 | `{'estimator__learning_rate': 0.2, 'estimator__max_depth': 13, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 25}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `HGBM` | `HistGradientBoostingRegressor` | `paper_reference_grid_search` | 22.334 | 0.000142 | 0.000328 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_162` | `HGBM` | `HistGradientBoostingRegressor` | 22.334 | 0.000142 | 0.000328 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_162` | `ERT` | `HGBM` | 22.334 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/hgbm/2026-04-19-06-34-30__track1_hgbm_amplitude_162_closure_attempt_01_campaign_run/onnx_export`;
