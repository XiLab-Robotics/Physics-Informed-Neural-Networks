...
- run name: `track1_ert_phase_81_closure_attempt_02`;
- output run name: `track1_ert_phase_81_closure_attempt_02_campaign_run`;
- run instance id: `2026-04-19-05-10-08__track1_ert_phase_81_closure_attempt_02_campaign_run`;
...
- winning mean component MAPE: `5.592%`;
- winning mean component MAE: `0.055505`;
- winning mean component RMSE: `0.078735`;
...
| --- | --- | ---: | ---: | --- |
| `ERT` | `paper_reference_grid_search` | 5 | 0.959527 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 3, 'estimator__n_estimators': 20}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ERT` | `ExtraTreesRegressor` | `paper_reference_grid_search` | 5.592 | 0.055505 | 0.078735 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_81` | `ERT` | `ExtraTreesRegressor` | 5.592 | 0.055505 | 0.078735 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_81` | `RF` | `ERT` | 5.592 | `not_matched_expected_family_direction` |
...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `81` | `-` | `-` | `-` | `RF` | `ERT` | `ERT` | `above_paper_target` | `met_paper_target` | `partially_matched_tables_3_6` |

## ONNX Export Surface

- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/ert/2026-04-19-05-10-08__track1_ert_phase_81_closure_attempt_02_campaign_run/onnx_export`;
