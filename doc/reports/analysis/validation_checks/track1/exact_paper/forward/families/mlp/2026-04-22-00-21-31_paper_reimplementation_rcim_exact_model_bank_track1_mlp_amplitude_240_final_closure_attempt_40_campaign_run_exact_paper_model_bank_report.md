...
- run name: `track1_mlp_amplitude_240_final_closure_attempt_40`;
- output run name: `track1_mlp_amplitude_240_final_closure_attempt_40_campaign_run`;
- run instance id: `2026-04-22-00-21-22__track1_mlp_amplitude_240_final_closure_attempt_40_campaign_run`;
...
- winning mean component MAPE: `6085.259%`;
- winning mean component MAE: `0.015308`;
- winning mean component RMSE: `0.026141`;
...
| --- | --- | ---: | ---: | --- |
| `MLP` | `paper_reference_grid_search` | 5 | -2111.922984 | `{'estimator__activation': 'tanh', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (200, 50), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `MLP` | `MLPRegressor` | `paper_reference_grid_search` | 6085.259 | 0.015308 | 0.026141 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_240` | `MLP` | `MLPRegressor` | 6085.259 | 0.015308 | 0.026141 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_240` | `ERT` | `MLP` | 6085.259 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/mlp/2026-04-22-00-21-22__track1_mlp_amplitude_240_final_closure_attempt_40_campaign_run/onnx_export`;
