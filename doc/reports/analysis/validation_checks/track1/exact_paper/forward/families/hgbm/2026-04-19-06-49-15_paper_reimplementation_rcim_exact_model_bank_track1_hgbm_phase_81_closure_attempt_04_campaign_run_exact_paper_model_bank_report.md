...
- run name: `track1_hgbm_phase_81_closure_attempt_04`;
- output run name: `track1_hgbm_phase_81_closure_attempt_04_campaign_run`;
- run instance id: `2026-04-19-06-49-03__track1_hgbm_phase_81_closure_attempt_04_campaign_run`;
...
- winning mean component MAPE: `4.726%`;
- winning mean component MAE: `0.054081`;
- winning mean component RMSE: `0.073461`;
...
| --- | --- | ---: | ---: | --- |
| `HGBM` | `paper_reference_grid_search` | 5 | 0.966958 | `{'estimator__learning_rate': 0.22, 'estimator__max_depth': 12, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 26}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `HGBM` | `HistGradientBoostingRegressor` | `paper_reference_grid_search` | 4.726 | 0.054081 | 0.073461 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_81` | `HGBM` | `HistGradientBoostingRegressor` | 4.726 | 0.054081 | 0.073461 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_81` | `RF` | `HGBM` | 4.726 | `not_matched_expected_family_direction` |
...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `81` | `-` | `-` | `-` | `RF` | `HGBM` | `HGBM` | `above_paper_target` | `met_paper_target` | `partially_matched_tables_3_6` |

## ONNX Export Surface

- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/hgbm/2026-04-19-06-49-03__track1_hgbm_phase_81_closure_attempt_04_campaign_run/onnx_export`;
