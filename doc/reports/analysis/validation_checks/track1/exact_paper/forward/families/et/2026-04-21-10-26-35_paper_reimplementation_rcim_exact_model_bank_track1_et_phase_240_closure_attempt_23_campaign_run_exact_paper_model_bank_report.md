...
- run name: `track1_et_phase_240_closure_attempt_23`;
- output run name: `track1_et_phase_240_closure_attempt_23_campaign_run`;
- run instance id: `2026-04-21-10-26-27__track1_et_phase_240_closure_attempt_23_campaign_run`;
...
- winning mean component MAPE: `16.998%`;
- winning mean component MAE: `0.320023`;
- winning mean component RMSE: `0.976110`;
...
| --- | --- | ---: | ---: | --- |
| `ET` | `paper_reference_grid_search` | 5 | 0.368962 | `{'estimator__criterion': 'absolute_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 4}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ET` | `ExtraTreeRegressor` | `paper_reference_grid_search` | 16.998 | 0.320023 | 0.976110 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_240` | `ET` | `ExtraTreeRegressor` | 16.998 | 0.320023 | 0.976110 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_240` | `ERT` | `ET` | 16.998 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/et/2026-04-21-10-26-27__track1_et_phase_240_closure_attempt_23_campaign_run/onnx_export`;
