...
- run name: `track1_et_amplitude_0_closure_attempt_04`;
- output run name: `track1_et_amplitude_0_closure_attempt_04_campaign_run`;
- run instance id: `2026-04-19-03-55-33__track1_et_amplitude_0_closure_attempt_04_campaign_run`;
...
- winning mean component MAPE: `6.713%`;
- winning mean component MAE: `0.003198`;
- winning mean component RMSE: `0.004018`;
...
| --- | --- | ---: | ---: | --- |
| `ET` | `paper_reference_grid_search` | 5 | 0.956759 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 5}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ET` | `ExtraTreeRegressor` | `paper_reference_grid_search` | 6.713 | 0.003198 | 0.004018 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_0` | `ET` | `ExtraTreeRegressor` | 6.713 | 0.003198 | 0.004018 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_0` | `SVR` | `ET` | 6.713 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/et/2026-04-19-03-55-33__track1_et_amplitude_0_closure_attempt_04_campaign_run/onnx_export`;
