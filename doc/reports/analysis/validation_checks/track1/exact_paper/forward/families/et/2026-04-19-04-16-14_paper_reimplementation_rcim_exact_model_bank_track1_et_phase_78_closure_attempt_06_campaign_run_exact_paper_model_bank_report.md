...
- run name: `track1_et_phase_78_closure_attempt_06`;
- output run name: `track1_et_phase_78_closure_attempt_06_campaign_run`;
- run instance id: `2026-04-19-04-16-06__track1_et_phase_78_closure_attempt_06_campaign_run`;
...
- winning mean component MAPE: `191.257%`;
- winning mean component MAE: `0.119811`;
- winning mean component RMSE: `0.272820`;
...
| --- | --- | ---: | ---: | --- |
| `ET` | `paper_reference_grid_search` | 5 | 0.696998 | `{'estimator__criterion': 'absolute_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 5}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ET` | `ExtraTreeRegressor` | `paper_reference_grid_search` | 191.257 | 0.119811 | 0.272820 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_78` | `ET` | `ExtraTreeRegressor` | 191.257 | 0.119811 | 0.272820 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_78` | `HGBM / RF` | `ET` | 191.257 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/et/2026-04-19-04-16-06__track1_et_phase_78_closure_attempt_06_campaign_run/onnx_export`;
