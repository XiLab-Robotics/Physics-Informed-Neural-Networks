...
- run name: `track1_hgbm_phase_156_closure_attempt_02`;
- output run name: `track1_hgbm_phase_156_closure_attempt_02_campaign_run`;
- run instance id: `2026-04-19-06-50-20__track1_hgbm_phase_156_closure_attempt_02_campaign_run`;
...
- winning best params: `{'estimator__learning_rate': 0.22, 'estimator__max_depth': 10, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 25}`;
- winning mean component MAPE: `44.971%`;
- winning mean component MAE: `0.757453`;
- winning mean component RMSE: `1.264106`;
...
| --- | --- | ---: | ---: | --- |
| `HGBM` | `paper_reference_grid_search` | 5 | 0.730946 | `{'estimator__learning_rate': 0.22, 'estimator__max_depth': 10, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 25}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `HGBM` | `HistGradientBoostingRegressor` | `paper_reference_grid_search` | 44.971 | 0.757453 | 1.264106 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_156` | `HGBM` | `HistGradientBoostingRegressor` | 44.971 | 0.757453 | 1.264106 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_156` | `ERT / RF` | `HGBM` | 44.971 | `not_matched_expected_family_direction` |
...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `156` | `-` | `-` | `-` | `RF` | `HGBM` | `HGBM` | `above_paper_target` | `above_paper_target` | `not_yet_matched_tables_3_6` |

## ONNX Export Surface

- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/hgbm/2026-04-19-06-50-20__track1_hgbm_phase_156_closure_attempt_02_campaign_run/onnx_export`;
