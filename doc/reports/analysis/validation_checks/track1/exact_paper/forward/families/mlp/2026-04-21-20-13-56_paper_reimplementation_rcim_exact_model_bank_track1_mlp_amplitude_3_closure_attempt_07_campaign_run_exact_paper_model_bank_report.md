...
- run name: `track1_mlp_amplitude_3_closure_attempt_07`;
- output run name: `track1_mlp_amplitude_3_closure_attempt_07_campaign_run`;
- run instance id: `2026-04-21-20-13-45__track1_mlp_amplitude_3_closure_attempt_07_campaign_run`;
...
- winning mean component MAPE: `739.711%`;
- winning mean component MAE: `0.005523`;
- winning mean component RMSE: `0.008927`;
...
| --- | --- | ---: | ---: | --- |
| `MLP` | `paper_reference_grid_search` | 5 | -26836.865108 | `{'estimator__activation': 'tanh', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (200, 50), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `MLP` | `MLPRegressor` | `paper_reference_grid_search` | 739.711 | 0.005523 | 0.008927 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_3` | `MLP` | `MLPRegressor` | 739.711 | 0.005523 | 0.008927 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_3` | `HGBM` | `MLP` | 739.711 | `not_matched_expected_family_direction` |
...
| `Repo Best RMSE` | - | - | 0.008927 | - | - | - | - | - | - | - |
| `Paper Best Family` | - | - | `HGBM` | - | - | - | - | - | - | - |
| `Paper Target RMSE` | - | - | 2.50e-05 | - | - | - | - | - | - | - |
| `Gap Vs Paper` | - | - | 0.008902 | - | - | - | - | - | - | - |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/mlp/2026-04-21-20-13-45__track1_mlp_amplitude_3_closure_attempt_07_campaign_run/onnx_export`;
