...
- run name: `track1_dt_phase_1_closure_attempt_12`;
- output run name: `track1_dt_phase_1_closure_attempt_12_campaign_run`;
- run instance id: `2026-04-21-10-04-46__track1_dt_phase_1_closure_attempt_12_campaign_run`;
...
- winning mean component MAPE: `24.788%`;
- winning mean component MAE: `0.002159`;
- winning mean component RMSE: `0.002943`;
...
| --- | --- | ---: | ---: | --- |
| `DT` | `paper_reference_grid_search` | 5 | 0.616177 | `{'estimator__criterion': 'absolute_error', 'estimator__max_depth': 15, 'estimator__min_samples_split': 4}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `DT` | `DecisionTreeRegressor` | `paper_reference_grid_search` | 24.788 | 0.002159 | 0.002943 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_1` | `DT` | `DecisionTreeRegressor` | 24.788 | 0.002159 | 0.002943 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_1` | `RF / LGBM` | `DT` | 24.788 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/dt/2026-04-21-10-04-46__track1_dt_phase_1_closure_attempt_12_campaign_run/onnx_export`;
