...
- run name: `track1_lgbm_phase_81_closure_attempt_05`;
- output run name: `track1_lgbm_phase_81_closure_attempt_05_campaign_run`;
- run instance id: `2026-04-19-10-08-45__track1_lgbm_phase_81_closure_attempt_05_campaign_run`;
...
- winning mean component MAPE: `4.245%`;
- winning mean component MAE: `0.048908`;
- winning mean component RMSE: `0.063503`;
...
| --- | --- | ---: | ---: | --- |
| `LGBM` | `paper_reference_grid_search` | 5 | 0.963955 | `{'estimator__learning_rate': 0.58, 'estimator__max_depth': 11, 'estimator__num_leaves': 31, 'estimator__subsample': 0.001}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `LGBM` | `LGBMRegressor` | `paper_reference_grid_search` | 4.245 | 0.048908 | 0.063503 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_81` | `LGBM` | `LGBMRegressor` | 4.245 | 0.048908 | 0.063503 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_81` | `RF` | `LGBM` | 4.245 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/lgbm/2026-04-19-10-08-45__track1_lgbm_phase_81_closure_attempt_05_campaign_run/onnx_export`;
