...
- run name: `track1_ert_phase_3_closure_attempt_06`;
- output run name: `track1_ert_phase_3_closure_attempt_06_campaign_run`;
- run instance id: `2026-04-19-05-02-08__track1_ert_phase_3_closure_attempt_06_campaign_run`;
...
- winning mean component MAPE: `1.530%`;
- winning mean component MAE: `0.027300`;
- winning mean component RMSE: `0.039493`;
...
| --- | --- | ---: | ---: | --- |
| `ERT` | `paper_reference_grid_search` | 5 | 0.929049 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 18, 'estimator__min_samples_split': 3, 'estimator__n_estimators': 20}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ERT` | `ExtraTreesRegressor` | `paper_reference_grid_search` | 1.530 | 0.027300 | 0.039493 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_3` | `ERT` | `ExtraTreesRegressor` | 1.530 | 0.027300 | 0.039493 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_3` | `HGBM` | `ERT` | 1.530 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/ert/2026-04-19-05-02-08__track1_ert_phase_3_closure_attempt_06_campaign_run/onnx_export`;
