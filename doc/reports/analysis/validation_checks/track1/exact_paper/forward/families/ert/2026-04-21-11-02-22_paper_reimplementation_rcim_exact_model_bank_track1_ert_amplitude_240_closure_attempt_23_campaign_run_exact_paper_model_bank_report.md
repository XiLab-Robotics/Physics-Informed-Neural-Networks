...
- run name: `track1_ert_amplitude_240_closure_attempt_23`;
- output run name: `track1_ert_amplitude_240_closure_attempt_23_campaign_run`;
- run instance id: `2026-04-21-11-02-04__track1_ert_amplitude_240_closure_attempt_23_campaign_run`;
...
- winning mean component MAPE: `32.968%`;
- winning mean component MAE: `0.000055`;
- winning mean component RMSE: `0.000164`;
...
| --- | --- | ---: | ---: | --- |
| `ERT` | `paper_reference_grid_search` | 5 | 0.983011 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 2, 'estimator__n_estimators': 40}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ERT` | `ExtraTreesRegressor` | `paper_reference_grid_search` | 32.968 | 0.000055 | 0.000164 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_240` | `ERT` | `ExtraTreesRegressor` | 32.968 | 0.000055 | 0.000164 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_240` | `ERT` | `ERT` | 32.968 | `matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/ert/2026-04-21-11-02-04__track1_ert_amplitude_240_closure_attempt_23_campaign_run/onnx_export`;
