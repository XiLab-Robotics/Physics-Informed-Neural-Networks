...
- run name: `track1_rf_phase_156_closure_attempt_04`;
- output run name: `track1_rf_phase_156_closure_attempt_04_campaign_run`;
- run instance id: `2026-04-19-02-58-20__track1_rf_phase_156_closure_attempt_04_campaign_run`;
...
- winning mean component MAPE: `36.790%`;
- winning mean component MAE: `0.508871`;
- winning mean component RMSE: `1.019170`;
...
| --- | --- | ---: | ---: | --- |
| `RF` | `paper_reference_grid_search` | 5 | 0.773026 | `{'estimator__criterion': 'absolute_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 2, 'estimator__n_estimators': 60}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `RF` | `RandomForestRegressor` | `paper_reference_grid_search` | 36.790 | 0.508871 | 1.019170 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_156` | `RF` | `RandomForestRegressor` | 36.790 | 0.508871 | 1.019170 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_156` | `ERT / RF` | `RF` | 36.790 | `matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/rf/2026-04-19-02-58-20__track1_rf_phase_156_closure_attempt_04_campaign_run/onnx_export`;
