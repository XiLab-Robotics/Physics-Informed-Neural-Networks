...
- run name: `track1_mlp_amplitude_81_closure_attempt_27`;
- output run name: `track1_mlp_amplitude_81_closure_attempt_27_campaign_run`;
- run instance id: `2026-04-21-00-41-32__track1_mlp_amplitude_81_closure_attempt_27_campaign_run`;
...
- winning mean component MAPE: `4268.610%`;
- winning mean component MAE: `0.011855`;
- winning mean component RMSE: `0.019243`;
...
| --- | --- | ---: | ---: | --- |
| `MLP` | `paper_reference_grid_search` | 5 | -167138.045760 | `{'estimator__activation': 'tanh', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (200, 50), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `MLP` | `MLPRegressor` | `paper_reference_grid_search` | 4268.610 | 0.011855 | 0.019243 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_81` | `MLP` | `MLPRegressor` | 4268.610 | 0.011855 | 0.019243 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_81` | `RF` | `MLP` | 4268.610 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/mlp/2026-04-21-00-41-32__track1_mlp_amplitude_81_closure_attempt_27_campaign_run/onnx_export`;
