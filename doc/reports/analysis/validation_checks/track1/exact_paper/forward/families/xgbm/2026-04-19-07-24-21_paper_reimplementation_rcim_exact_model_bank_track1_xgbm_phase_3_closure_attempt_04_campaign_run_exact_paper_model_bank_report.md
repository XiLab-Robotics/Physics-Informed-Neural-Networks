...
- run name: `track1_xgbm_phase_3_closure_attempt_04`;
- output run name: `track1_xgbm_phase_3_closure_attempt_04_campaign_run`;
- run instance id: `2026-04-19-07-24-13__track1_xgbm_phase_3_closure_attempt_04_campaign_run`;
...
- winning mean component MAPE: `1.338%`;
- winning mean component MAE: `0.023796`;
- winning mean component RMSE: `0.031045`;
...
| --- | --- | ---: | ---: | --- |
| `XGBM` | `paper_reference_grid_search` | 5 | 0.927126 | `{'estimator__colsample_bytree': 0.8, 'estimator__learning_rate': 0.2, 'estimator__max_depth': 14}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `XGBM` | `XGBRegressor` | `paper_reference_grid_search` | 1.338 | 0.023796 | 0.031045 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_3` | `XGBM` | `XGBRegressor` | 1.338 | 0.023796 | 0.031045 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_3` | `HGBM` | `XGBM` | 1.338 | `not_matched_expected_family_direction` |
...
| `Repo Best Family` | - | `XGBM` | - | - | - | - | - | - | - |
| `Repo Best RMSE` | - | 0.0310 | - | - | - | - | - | - | - |
| `Paper Best Family` | - | `HGBM` | - | - | - | - | - | - | - |
| `Paper Target RMSE` | - | 0.0290 | - | - | - | - | - | - | - |
| `Gap Vs Paper` | - | 0.002045 | - | - | - | - | - | - | - |
| `Status` | - | `above_paper_target` | - | - | - | - | - | - | - |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/xgbm/2026-04-19-07-24-13__track1_xgbm_phase_3_closure_attempt_04_campaign_run/onnx_export`;
