...
- run name: `track1_dt_amplitude_40_closure_attempt_06`;
- output run name: `track1_dt_amplitude_40_closure_attempt_06_campaign_run`;
- run instance id: `2026-04-19-03-23-11__track1_dt_amplitude_40_closure_attempt_06_campaign_run`;
...
- winning mean component MAPE: `3.596%`;
...
| --- | --- | ---: | ---: | --- |
| `DT` | `paper_reference_grid_search` | 5 | 0.702911 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 7}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `DT` | `DecisionTreeRegressor` | `paper_reference_grid_search` | 3.596 | 0.000029 | 0.000044 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_40` | `DT` | `DecisionTreeRegressor` | 3.596 | 0.000029 | 0.000044 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_40` | `ERT / GBM` | `DT` | 3.596 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/dt/2026-04-19-03-23-11__track1_dt_amplitude_40_closure_attempt_06_campaign_run/onnx_export`;
