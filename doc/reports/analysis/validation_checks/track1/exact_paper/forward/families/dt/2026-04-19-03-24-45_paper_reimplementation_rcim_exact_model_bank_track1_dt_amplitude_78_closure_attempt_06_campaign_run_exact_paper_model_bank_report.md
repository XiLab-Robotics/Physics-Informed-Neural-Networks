...
- run name: `track1_dt_amplitude_78_closure_attempt_06`;
- output run name: `track1_dt_amplitude_78_closure_attempt_06_campaign_run`;
- run instance id: `2026-04-19-03-24-37__track1_dt_amplitude_78_closure_attempt_06_campaign_run`;
...
- winning mean component MAPE: `12.621%`;
...
| --- | --- | ---: | ---: | --- |
| `DT` | `paper_reference_grid_search` | 5 | 0.984726 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 4}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `DT` | `DecisionTreeRegressor` | `paper_reference_grid_search` | 12.621 | 0.000050 | 0.000073 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_78` | `DT` | `DecisionTreeRegressor` | 12.621 | 0.000050 | 0.000073 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_78` | `HGBM / RF` | `DT` | 12.621 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/dt/2026-04-19-03-24-37__track1_dt_amplitude_78_closure_attempt_06_campaign_run/onnx_export`;
