...
- run name: `track1_ert_amplitude_0_closure_attempt_03`;
- output run name: `track1_ert_amplitude_0_closure_attempt_03_campaign_run`;
- run instance id: `2026-04-19-04-34-21__track1_ert_amplitude_0_closure_attempt_03_campaign_run`;
...
- winning best params: `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 16, 'estimator__min_samples_split': 6, 'estimator__n_estimators': 20}`;
- winning mean component MAPE: `6.541%`;
- winning mean component MAE: `0.002909`;
- winning mean component RMSE: `0.003748`;
...
| --- | --- | ---: | ---: | --- |
| `ERT` | `paper_reference_grid_search` | 5 | 0.964497 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 16, 'estimator__min_samples_split': 6, 'estimator__n_estimators': 20}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ERT` | `ExtraTreesRegressor` | `paper_reference_grid_search` | 6.541 | 0.002909 | 0.003748 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_0` | `ERT` | `ExtraTreesRegressor` | 6.541 | 0.002909 | 0.003748 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_0` | `SVR` | `ERT` | 6.541 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/ert/2026-04-19-04-34-21__track1_ert_amplitude_0_closure_attempt_03_campaign_run/onnx_export`;
