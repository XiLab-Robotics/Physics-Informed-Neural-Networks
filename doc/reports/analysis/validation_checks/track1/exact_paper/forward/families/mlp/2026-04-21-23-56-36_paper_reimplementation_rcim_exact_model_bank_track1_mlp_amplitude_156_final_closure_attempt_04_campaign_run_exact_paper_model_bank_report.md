...
- run name: `track1_mlp_amplitude_156_final_closure_attempt_04`;
- output run name: `track1_mlp_amplitude_156_final_closure_attempt_04_campaign_run`;
- run instance id: `2026-04-21-23-56-26__track1_mlp_amplitude_156_final_closure_attempt_04_campaign_run`;
...
- winning mean component MAPE: `8996.471%`;
- winning mean component MAE: `0.009231`;
- winning mean component RMSE: `0.015244`;
...
| --- | --- | ---: | ---: | --- |
| `MLP` | `paper_reference_grid_search` | 5 | -220.035483 | `{'estimator__activation': 'tanh', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (200, 50), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `MLP` | `MLPRegressor` | `paper_reference_grid_search` | 8996.471 | 0.009231 | 0.015244 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_156` | `MLP` | `MLPRegressor` | 8996.471 | 0.009231 | 0.015244 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_156` | `ERT / RF` | `MLP` | 8996.471 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/mlp/2026-04-21-23-56-26__track1_mlp_amplitude_156_final_closure_attempt_04_campaign_run/onnx_export`;
