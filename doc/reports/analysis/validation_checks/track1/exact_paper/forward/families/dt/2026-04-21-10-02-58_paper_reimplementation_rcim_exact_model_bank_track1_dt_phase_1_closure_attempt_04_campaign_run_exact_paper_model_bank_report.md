...
- run name: `track1_dt_phase_1_closure_attempt_04`;
- output run name: `track1_dt_phase_1_closure_attempt_04_campaign_run`;
- run instance id: `2026-04-21-10-02-51__track1_dt_phase_1_closure_attempt_04_campaign_run`;
...
- winning mean component MAPE: `53.525%`;
- winning mean component MAE: `0.002646`;
- winning mean component RMSE: `0.004389`;
...
| --- | --- | ---: | ---: | --- |
| `DT` | `paper_reference_grid_search` | 5 | 0.648694 | `{'estimator__criterion': 'absolute_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 8}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `DT` | `DecisionTreeRegressor` | `paper_reference_grid_search` | 53.525 | 0.002646 | 0.004389 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_1` | `DT` | `DecisionTreeRegressor` | 53.525 | 0.002646 | 0.004389 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_1` | `RF / LGBM` | `DT` | 53.525 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/dt/2026-04-21-10-02-51__track1_dt_phase_1_closure_attempt_04_campaign_run/onnx_export`;
