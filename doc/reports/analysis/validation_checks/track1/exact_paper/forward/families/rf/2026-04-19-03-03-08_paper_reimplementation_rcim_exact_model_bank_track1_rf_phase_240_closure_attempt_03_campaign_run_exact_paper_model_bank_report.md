...
- run name: `track1_rf_phase_240_closure_attempt_03`;
- output run name: `track1_rf_phase_240_closure_attempt_03_campaign_run`;
- run instance id: `2026-04-19-03-02-50__track1_rf_phase_240_closure_attempt_03_campaign_run`;
...
- winning best params: `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 16, 'estimator__min_samples_split': 3, 'estimator__n_estimators': 90}`;
- winning mean component MAPE: `10.077%`;
- winning mean component MAE: `0.191745`;
- winning mean component RMSE: `0.527103`;
...
| --- | --- | ---: | ---: | --- |
| `RF` | `paper_reference_grid_search` | 5 | 0.692309 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 16, 'estimator__min_samples_split': 3, 'estimator__n_estimators': 90}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `RF` | `RandomForestRegressor` | `paper_reference_grid_search` | 10.077 | 0.191745 | 0.527103 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_240` | `RF` | `RandomForestRegressor` | 10.077 | 0.191745 | 0.527103 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_240` | `ERT` | `RF` | 10.077 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/rf/2026-04-19-03-02-50__track1_rf_phase_240_closure_attempt_03_campaign_run/onnx_export`;
