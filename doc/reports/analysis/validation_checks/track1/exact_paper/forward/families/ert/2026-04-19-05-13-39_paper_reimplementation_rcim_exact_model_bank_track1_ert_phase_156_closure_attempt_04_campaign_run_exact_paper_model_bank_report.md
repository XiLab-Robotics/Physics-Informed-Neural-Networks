...
- run name: `track1_ert_phase_156_closure_attempt_04`;
- output run name: `track1_ert_phase_156_closure_attempt_04_campaign_run`;
- run instance id: `2026-04-19-05-13-21__track1_ert_phase_156_closure_attempt_04_campaign_run`;
...
- winning best params: `{'estimator__criterion': 'absolute_error', 'estimator__max_depth': 15, 'estimator__min_samples_split': 3, 'estimator__n_estimators': 80}`;
- winning mean component MAPE: `45.004%`;
- winning mean component MAE: `0.577237`;
- winning mean component RMSE: `1.116453`;
...
| --- | --- | ---: | ---: | --- |
| `ERT` | `paper_reference_grid_search` | 5 | 0.763183 | `{'estimator__criterion': 'absolute_error', 'estimator__max_depth': 15, 'estimator__min_samples_split': 3, 'estimator__n_estimators': 80}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ERT` | `ExtraTreesRegressor` | `paper_reference_grid_search` | 45.004 | 0.577237 | 1.116453 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_156` | `ERT` | `ExtraTreesRegressor` | 45.004 | 0.577237 | 1.116453 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_156` | `ERT / RF` | `ERT` | 45.004 | `matched_expected_family_direction` |
...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `156` | `-` | `-` | `-` | `RF` | `ERT` | `ERT` | `above_paper_target` | `met_paper_target` | `partially_matched_tables_3_6` |

## ONNX Export Surface

- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/ert/2026-04-19-05-13-21__track1_ert_phase_156_closure_attempt_04_campaign_run/onnx_export`;
