...
- run name: `track1_rf_amplitude_162_closure_attempt_04`;
- output run name: `track1_rf_amplitude_162_closure_attempt_04_campaign_run`;
- run instance id: `2026-04-19-02-38-41__track1_rf_amplitude_162_closure_attempt_04_campaign_run`;
...
- winning mean component MAPE: `8.890%`;
- winning mean component MAE: `0.000054`;
- winning mean component RMSE: `0.000234`;
...
| --- | --- | ---: | ---: | --- |
| `RF` | `paper_reference_grid_search` | 5 | 0.983249 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 15, 'estimator__min_samples_split': 2, 'estimator__n_estimators': 90}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `RF` | `RandomForestRegressor` | `paper_reference_grid_search` | 8.890 | 0.000054 | 0.000234 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_162` | `RF` | `RandomForestRegressor` | 8.890 | 0.000054 | 0.000234 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_162` | `ERT` | `RF` | 8.890 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/rf/2026-04-19-02-38-41__track1_rf_amplitude_162_closure_attempt_04_campaign_run/onnx_export`;
