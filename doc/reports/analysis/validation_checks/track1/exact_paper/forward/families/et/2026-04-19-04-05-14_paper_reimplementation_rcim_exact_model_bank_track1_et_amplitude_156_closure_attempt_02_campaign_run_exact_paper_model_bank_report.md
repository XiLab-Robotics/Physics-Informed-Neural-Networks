...
- run name: `track1_et_amplitude_156_closure_attempt_02`;
- output run name: `track1_et_amplitude_156_closure_attempt_02_campaign_run`;
- run instance id: `2026-04-19-04-05-06__track1_et_amplitude_156_closure_attempt_02_campaign_run`;
...
- winning mean component MAPE: `23.654%`;
- winning mean component MAE: `0.000058`;
- winning mean component RMSE: `0.000193`;
...
| --- | --- | ---: | ---: | --- |
| `ET` | `paper_reference_grid_search` | 5 | 0.979988 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 2}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ET` | `ExtraTreeRegressor` | `paper_reference_grid_search` | 23.654 | 0.000058 | 0.000193 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_156` | `ET` | `ExtraTreeRegressor` | 23.654 | 0.000058 | 0.000193 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_156` | `ERT / RF` | `ET` | 23.654 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/et/2026-04-19-04-05-06__track1_et_amplitude_156_closure_attempt_02_campaign_run/onnx_export`;
