...
- run name: `track1_mlp_phase_3_closure_attempt_25`;
- output run name: `track1_mlp_phase_3_closure_attempt_25_campaign_run`;
- run instance id: `2026-04-21-01-10-44__track1_mlp_phase_3_closure_attempt_25_campaign_run`;
...
- winning mean component MAPE: `4.464%`;
- winning mean component MAE: `0.080491`;
- winning mean component RMSE: `0.102597`;
...
| --- | --- | ---: | ---: | --- |
| `MLP` | `paper_reference_grid_search` | 5 | 0.596913 | `{'estimator__activation': 'tanh', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (100, 50), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `MLP` | `MLPRegressor` | `paper_reference_grid_search` | 4.464 | 0.080491 | 0.102597 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_3` | `MLP` | `MLPRegressor` | 4.464 | 0.080491 | 0.102597 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_3` | `HGBM` | `MLP` | 4.464 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/mlp/2026-04-21-01-10-44__track1_mlp_phase_3_closure_attempt_25_campaign_run/onnx_export`;
