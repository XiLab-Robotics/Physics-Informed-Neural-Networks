...
- run name: `track1_lgbm_phase_1_closure_attempt_01`;
- output run name: `track1_lgbm_phase_1_closure_attempt_01_campaign_run`;
- run instance id: `2026-04-19-09-17-40__track1_lgbm_phase_1_closure_attempt_01_campaign_run`;
...
- winning mean component MAPE: `22.102%`;
- winning mean component MAE: `0.001842`;
- winning mean component RMSE: `0.002510`;
...
| --- | --- | ---: | ---: | --- |
| `LGBM` | `paper_reference_grid_search` | 5 | 0.754251 | `{'estimator__learning_rate': 0.39, 'estimator__max_depth': 10, 'estimator__num_leaves': 10, 'estimator__subsample': 0.001}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `LGBM` | `LGBMRegressor` | `paper_reference_grid_search` | 22.102 | 0.001842 | 0.002510 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_1` | `LGBM` | `LGBMRegressor` | 22.102 | 0.001842 | 0.002510 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_1` | `RF / LGBM` | `LGBM` | 22.102 | `matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/lgbm/2026-04-19-09-17-40__track1_lgbm_phase_1_closure_attempt_01_campaign_run/onnx_export`;
