...
- run name: `track1_mlp_phase_240_closure_attempt_02`;
- output run name: `track1_mlp_phase_240_closure_attempt_02_campaign_run`;
- run instance id: `2026-04-19-02-04-59__track1_mlp_phase_240_closure_attempt_02_campaign_run`;
...
- winning mean component MAPE: `145.328%`;
- winning mean component MAE: `0.728191`;
- winning mean component RMSE: `1.150610`;
...
| --- | --- | ---: | ---: | --- |
| `MLP` | `paper_reference_grid_search` | 5 | 0.022325 | `{'estimator__activation': 'tanh', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (200,), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `MLP` | `MLPRegressor` | `paper_reference_grid_search` | 145.328 | 0.728191 | 1.150610 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_240` | `MLP` | `MLPRegressor` | 145.328 | 0.728191 | 1.150610 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_240` | `ERT` | `MLP` | 145.328 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/mlp/2026-04-19-02-04-59__track1_mlp_phase_240_closure_attempt_02_campaign_run/onnx_export`;
