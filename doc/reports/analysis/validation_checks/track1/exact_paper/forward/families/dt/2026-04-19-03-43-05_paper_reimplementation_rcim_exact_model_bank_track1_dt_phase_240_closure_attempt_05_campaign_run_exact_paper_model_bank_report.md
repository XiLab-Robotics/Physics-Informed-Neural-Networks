...
- run name: `track1_dt_phase_240_closure_attempt_05`;
- output run name: `track1_dt_phase_240_closure_attempt_05_campaign_run`;
- run instance id: `2026-04-19-03-42-58__track1_dt_phase_240_closure_attempt_05_campaign_run`;
...
- winning mean component MAPE: `13.449%`;
- winning mean component MAE: `0.235136`;
- winning mean component RMSE: `0.795922`;
...
| --- | --- | ---: | ---: | --- |
| `DT` | `paper_reference_grid_search` | 5 | 0.419879 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 15, 'estimator__min_samples_split': 4}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `DT` | `DecisionTreeRegressor` | `paper_reference_grid_search` | 13.449 | 0.235136 | 0.795922 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_240` | `DT` | `DecisionTreeRegressor` | 13.449 | 0.235136 | 0.795922 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_240` | `ERT` | `DT` | 13.449 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/dt/2026-04-19-03-42-58__track1_dt_phase_240_closure_attempt_05_campaign_run/onnx_export`;
