...
- run name: `track1_ert_amplitude_39_closure_attempt_03`;
- output run name: `track1_ert_amplitude_39_closure_attempt_03_campaign_run`;
- run instance id: `2026-04-19-04-41-33__track1_ert_amplitude_39_closure_attempt_03_campaign_run`;
...
- winning best params: `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 3, 'estimator__n_estimators': 60}`;
- winning mean component MAPE: `2.483%`;
- winning mean component MAE: `0.000027`;
- winning mean component RMSE: `0.000039`;
...
| --- | --- | ---: | ---: | --- |
| `ERT` | `paper_reference_grid_search` | 5 | 0.981661 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 3, 'estimator__n_estimators': 60}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ERT` | `ExtraTreesRegressor` | `paper_reference_grid_search` | 2.483 | 0.000027 | 0.000039 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_39` | `ERT` | `ExtraTreesRegressor` | 2.483 | 0.000027 | 0.000039 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_39` | `HGBM` | `ERT` | 2.483 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/ert/2026-04-19-04-41-33__track1_ert_amplitude_39_closure_attempt_03_campaign_run/onnx_export`;
