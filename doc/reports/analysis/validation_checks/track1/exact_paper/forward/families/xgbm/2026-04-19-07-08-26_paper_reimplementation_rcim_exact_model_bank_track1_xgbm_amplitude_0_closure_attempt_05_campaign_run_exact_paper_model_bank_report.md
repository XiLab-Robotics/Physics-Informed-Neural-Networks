...
- run name: `track1_xgbm_amplitude_0_closure_attempt_05`;
- output run name: `track1_xgbm_amplitude_0_closure_attempt_05_campaign_run`;
- run instance id: `2026-04-19-07-08-18__track1_xgbm_amplitude_0_closure_attempt_05_campaign_run`;
...
- winning mean component MAPE: `5.108%`;
- winning mean component MAE: `0.002363`;
- winning mean component RMSE: `0.002984`;
...
| --- | --- | ---: | ---: | --- |
| `XGBM` | `paper_reference_grid_search` | 5 | 0.972187 | `{'estimator__colsample_bytree': 0.8, 'estimator__learning_rate': 0.2, 'estimator__max_depth': 14}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `XGBM` | `XGBRegressor` | `paper_reference_grid_search` | 5.108 | 0.002363 | 0.002984 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_0` | `XGBM` | `XGBRegressor` | 5.108 | 0.002363 | 0.002984 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_0` | `SVR` | `XGBM` | 5.108 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/xgbm/2026-04-19-07-08-18__track1_xgbm_amplitude_0_closure_attempt_05_campaign_run/onnx_export`;
