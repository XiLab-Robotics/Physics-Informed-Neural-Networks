...
- run name: `track1_dt_amplitude_156_closure_attempt_02`;
- output run name: `track1_dt_amplitude_156_closure_attempt_02_campaign_run`;
- run instance id: `2026-04-19-03-26-31__track1_dt_amplitude_156_closure_attempt_02_campaign_run`;
...
- winning mean component MAPE: `19.163%`;
...
| --- | --- | ---: | ---: | --- |
| `DT` | `paper_reference_grid_search` | 5 | 0.973825 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 15, 'estimator__min_samples_split': 4}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `DT` | `DecisionTreeRegressor` | `paper_reference_grid_search` | 19.163 | 0.000047 | 0.000136 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_156` | `DT` | `DecisionTreeRegressor` | 19.163 | 0.000047 | 0.000136 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_156` | `ERT / RF` | `DT` | 19.163 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/dt/2026-04-19-03-26-31__track1_dt_amplitude_156_closure_attempt_02_campaign_run/onnx_export`;
