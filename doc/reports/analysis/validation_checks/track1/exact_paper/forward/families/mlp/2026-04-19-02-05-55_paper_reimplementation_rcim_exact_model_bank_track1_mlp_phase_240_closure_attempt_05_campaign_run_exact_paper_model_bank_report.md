...
- run name: `track1_mlp_phase_240_closure_attempt_05`;
- output run name: `track1_mlp_phase_240_closure_attempt_05_campaign_run`;
- run instance id: `2026-04-19-02-05-46__track1_mlp_phase_240_closure_attempt_05_campaign_run`;
...
- winning best params: `{'estimator__activation': 'tanh', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (200, 50), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'sgd'}`;
- winning mean component MAPE: `55.299%`;
- winning mean component MAE: `0.856100`;
- winning mean component RMSE: `1.417483`;
...
| --- | --- | ---: | ---: | --- |
| `MLP` | `paper_reference_grid_search` | 5 | 0.012181 | `{'estimator__activation': 'tanh', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (200, 50), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'sgd'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `MLP` | `MLPRegressor` | `paper_reference_grid_search` | 55.299 | 0.856100 | 1.417483 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_240` | `MLP` | `MLPRegressor` | 55.299 | 0.856100 | 1.417483 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_240` | `ERT` | `MLP` | 55.299 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/mlp/2026-04-19-02-05-46__track1_mlp_phase_240_closure_attempt_05_campaign_run/onnx_export`;
