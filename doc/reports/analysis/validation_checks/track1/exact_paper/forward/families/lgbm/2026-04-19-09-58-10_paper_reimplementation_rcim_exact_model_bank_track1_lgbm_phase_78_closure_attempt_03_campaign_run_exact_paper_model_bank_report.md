...
- run name: `track1_lgbm_phase_78_closure_attempt_03`;
- output run name: `track1_lgbm_phase_78_closure_attempt_03_campaign_run`;
- run instance id: `2026-04-19-09-56-46__track1_lgbm_phase_78_closure_attempt_03_campaign_run`;
...
- winning mean component MAPE: `61.816%`;
- winning mean component MAE: `0.103321`;
- winning mean component RMSE: `0.278072`;
...
| --- | --- | ---: | ---: | --- |
| `LGBM` | `paper_reference_grid_search` | 5 | 0.845276 | `{'estimator__learning_rate': 0.2, 'estimator__max_depth': 13, 'estimator__num_leaves': 31, 'estimator__subsample': 0.001}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `LGBM` | `LGBMRegressor` | `paper_reference_grid_search` | 61.816 | 0.103321 | 0.278072 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_78` | `LGBM` | `LGBMRegressor` | 61.816 | 0.103321 | 0.278072 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_78` | `HGBM / RF` | `LGBM` | 61.816 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/lgbm/2026-04-19-09-56-46__track1_lgbm_phase_78_closure_attempt_03_campaign_run/onnx_export`;
