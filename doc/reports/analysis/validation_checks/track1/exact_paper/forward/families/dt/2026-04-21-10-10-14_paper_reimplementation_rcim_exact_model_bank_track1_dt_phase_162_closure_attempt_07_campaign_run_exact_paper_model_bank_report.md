...
- run name: `track1_dt_phase_162_closure_attempt_07`;
- output run name: `track1_dt_phase_162_closure_attempt_07_campaign_run`;
- run instance id: `2026-04-21-10-10-06__track1_dt_phase_162_closure_attempt_07_campaign_run`;
...
- winning best params: `{'estimator__criterion': 'absolute_error', 'estimator__max_depth': 15, 'estimator__min_samples_split': 5}`;
- winning mean component MAPE: `9.450%`;
- winning mean component MAE: `0.220980`;
- winning mean component RMSE: `0.949841`;
...
| --- | --- | ---: | ---: | --- |
| `DT` | `paper_reference_grid_search` | 5 | 0.738562 | `{'estimator__criterion': 'absolute_error', 'estimator__max_depth': 15, 'estimator__min_samples_split': 5}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `DT` | `DecisionTreeRegressor` | `paper_reference_grid_search` | 9.450 | 0.220980 | 0.949841 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_162` | `DT` | `DecisionTreeRegressor` | 9.450 | 0.220980 | 0.949841 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_162` | `ERT` | `DT` | 9.450 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/dt/2026-04-21-10-10-06__track1_dt_phase_162_closure_attempt_07_campaign_run/onnx_export`;
