...
- run name: `track1_hgbm_phase_162_closure_attempt_23`;
- output run name: `track1_hgbm_phase_162_closure_attempt_23_campaign_run`;
- run instance id: `2026-04-21-12-03-24__track1_hgbm_phase_162_closure_attempt_23_campaign_run`;
...
- winning mean component MAPE: `22.737%`;
- winning mean component MAE: `0.509397`;
- winning mean component RMSE: `1.086351`;
...
| --- | --- | ---: | ---: | --- |
| `HGBM` | `paper_reference_grid_search` | 5 | 0.673144 | `{'estimator__learning_rate': 0.21, 'estimator__max_depth': 13, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 24}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `HGBM` | `HistGradientBoostingRegressor` | `paper_reference_grid_search` | 22.737 | 0.509397 | 1.086351 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_162` | `HGBM` | `HistGradientBoostingRegressor` | 22.737 | 0.509397 | 1.086351 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_162` | `ERT` | `HGBM` | 22.737 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/hgbm/2026-04-21-12-03-24__track1_hgbm_phase_162_closure_attempt_23_campaign_run/onnx_export`;
