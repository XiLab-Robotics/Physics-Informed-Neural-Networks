...
- run name: `track1_et_phase_40_closure_attempt_03`;
- output run name: `track1_et_phase_40_closure_attempt_03_campaign_run`;
- run instance id: `2026-04-19-04-13-57__track1_et_phase_40_closure_attempt_03_campaign_run`;
...
- winning mean component MAPE: `93.507%`;
- winning mean component MAE: `0.046878`;
- winning mean component RMSE: `0.064931`;
...
| --- | --- | ---: | ---: | --- |
| `ET` | `paper_reference_grid_search` | 5 | 0.633242 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 16, 'estimator__min_samples_split': 5}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ET` | `ExtraTreeRegressor` | `paper_reference_grid_search` | 93.507 | 0.046878 | 0.064931 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_40` | `ET` | `ExtraTreeRegressor` | 93.507 | 0.046878 | 0.064931 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_40` | `ERT / GBM` | `ET` | 93.507 | `not_matched_expected_family_direction` |
...
| `Repo Best Family` | - | - | - | `ET` | - | - | - | - | - |
| `Repo Best RMSE` | - | - | - | 0.0649 | - | - | - | - | - |
| `Paper Best Family` | - | - | - | `GBM` | - | - | - | - | - |
| `Paper Target RMSE` | - | - | - | 0.0550 | - | - | - | - | - |
| `Gap Vs Paper` | - | - | - | 0.009931 | - | - | - | - | - |
| `Status` | - | - | - | `above_paper_target` | - | - | - | - | - |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/et/2026-04-19-04-13-57__track1_et_phase_40_closure_attempt_03_campaign_run/onnx_export`;
