...
- run name: `track1_mlp_amplitude_240_final_closure_attempt_17`;
- output run name: `track1_mlp_amplitude_240_final_closure_attempt_17_campaign_run`;
- run instance id: `2026-04-22-00-14-57__track1_mlp_amplitude_240_final_closure_attempt_17_campaign_run`;
...
- winning mean component MAPE: `2470.632%`;
- winning mean component MAE: `0.007037`;
- winning mean component RMSE: `0.012650`;
...
| --- | --- | ---: | ---: | --- |
| `MLP` | `paper_reference_grid_search` | 5 | -1126.743171 | `{'estimator__activation': 'tanh', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (200, 50), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `MLP` | `MLPRegressor` | `paper_reference_grid_search` | 2470.632 | 0.007037 | 0.012650 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_240` | `MLP` | `MLPRegressor` | 2470.632 | 0.007037 | 0.012650 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_240` | `ERT` | `MLP` | 2470.632 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/mlp/2026-04-22-00-14-57__track1_mlp_amplitude_240_final_closure_attempt_17_campaign_run/onnx_export`;
