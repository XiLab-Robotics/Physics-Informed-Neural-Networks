...
- run name: `track1_lgbm_amplitude_1_closure_attempt_06`;
- output run name: `track1_lgbm_amplitude_1_closure_attempt_06_campaign_run`;
- run instance id: `2026-04-19-08-04-09__track1_lgbm_amplitude_1_closure_attempt_06_campaign_run`;
...
- winning mean component MAPE: `0.142%`;
...
| --- | --- | ---: | ---: | --- |
| `LGBM` | `paper_reference_grid_search` | 5 | 0.717283 | `{'estimator__learning_rate': 0.2, 'estimator__max_depth': 10, 'estimator__num_leaves': 10, 'estimator__subsample': 0.001}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `LGBM` | `LGBMRegressor` | `paper_reference_grid_search` | 0.142 | 0.000024 | 0.000033 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_1` | `LGBM` | `LGBMRegressor` | 0.142 | 0.000024 | 0.000033 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_1` | `RF / LGBM` | `LGBM` | 0.142 | `matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/lgbm/2026-04-19-08-04-09__track1_lgbm_amplitude_1_closure_attempt_06_campaign_run/onnx_export`;
