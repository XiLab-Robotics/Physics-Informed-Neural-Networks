...
- run name: `track1_mlp_amplitude_40_closure_attempt_11`;
- output run name: `track1_mlp_amplitude_40_closure_attempt_11_campaign_run`;
- run instance id: `2026-04-21-20-29-52__track1_mlp_amplitude_40_closure_attempt_11_campaign_run`;
...
- winning mean component MAPE: `2091.277%`;
- winning mean component MAE: `0.016375`;
- winning mean component RMSE: `0.031883`;
...
| --- | --- | ---: | ---: | --- |
| `MLP` | `paper_reference_grid_search` | 5 | -84764.617119 | `{'estimator__activation': 'tanh', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (100, 50), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `MLP` | `MLPRegressor` | `paper_reference_grid_search` | 2091.277 | 0.016375 | 0.031883 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_40` | `MLP` | `MLPRegressor` | 2091.277 | 0.016375 | 0.031883 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_40` | `ERT / GBM` | `MLP` | 2091.277 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/mlp/2026-04-21-20-29-52__track1_mlp_amplitude_40_closure_attempt_11_campaign_run/onnx_export`;
