...
- run name: `track1_dt_phase_78_closure_attempt_01`;
- output run name: `track1_dt_phase_78_closure_attempt_01_campaign_run`;
- run instance id: `2026-04-19-03-36-18__track1_dt_phase_78_closure_attempt_01_campaign_run`;
...
- winning mean component MAPE: `260.315%`;
- winning mean component MAE: `0.073876`;
- winning mean component RMSE: `0.147209`;
...
| --- | --- | ---: | ---: | --- |
| `DT` | `paper_reference_grid_search` | 5 | 0.762850 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 7}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `DT` | `DecisionTreeRegressor` | `paper_reference_grid_search` | 260.315 | 0.073876 | 0.147209 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_78` | `DT` | `DecisionTreeRegressor` | 260.315 | 0.073876 | 0.147209 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_78` | `HGBM / RF` | `DT` | 260.315 | `not_matched_expected_family_direction` |
...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `78` | `-` | `-` | `-` | `RF` | `DT` | `DT` | `met_paper_target` | `met_paper_target` | `partially_matched_tables_3_6` |

## ONNX Export Surface

- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/dt/2026-04-19-03-36-18__track1_dt_phase_78_closure_attempt_01_campaign_run/onnx_export`;
