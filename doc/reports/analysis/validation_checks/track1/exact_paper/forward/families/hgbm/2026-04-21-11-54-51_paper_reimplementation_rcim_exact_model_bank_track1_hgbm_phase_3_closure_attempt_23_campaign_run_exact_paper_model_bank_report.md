...
- run name: `track1_hgbm_phase_3_closure_attempt_23`;
- output run name: `track1_hgbm_phase_3_closure_attempt_23_campaign_run`;
- run instance id: `2026-04-21-11-54-39__track1_hgbm_phase_3_closure_attempt_23_campaign_run`;
...
- winning mean component MAPE: `1.083%`;
- winning mean component MAE: `0.019902`;
- winning mean component RMSE: `0.041185`;
...
| --- | --- | ---: | ---: | --- |
| `HGBM` | `paper_reference_grid_search` | 5 | 0.956339 | `{'estimator__learning_rate': 0.22, 'estimator__max_depth': 9, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 24}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `HGBM` | `HistGradientBoostingRegressor` | `paper_reference_grid_search` | 1.083 | 0.019902 | 0.041185 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_3` | `HGBM` | `HistGradientBoostingRegressor` | 1.083 | 0.019902 | 0.041185 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_3` | `HGBM` | `HGBM` | 1.083 | `matched_expected_family_direction` |
...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `3` | `-` | `-` | `-` | `HGBM` | `HGBM` | `HGBM` | `met_paper_target` | `above_paper_target` | `partially_matched_tables_3_6` |

## ONNX Export Surface

- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/hgbm/2026-04-21-11-54-39__track1_hgbm_phase_3_closure_attempt_23_campaign_run/onnx_export`;
