...
- run name: `track1_hgbm_phase_162_closure_attempt_13`;
- output run name: `track1_hgbm_phase_162_closure_attempt_13_campaign_run`;
- run instance id: `2026-04-21-12-00-09__track1_hgbm_phase_162_closure_attempt_13_campaign_run`;
...
- winning mean component MAPE: `18.509%`;
- winning mean component MAE: `0.420496`;
- winning mean component RMSE: `0.923019`;
...
| --- | --- | ---: | ---: | --- |
| `HGBM` | `paper_reference_grid_search` | 5 | 0.762628 | `{'estimator__learning_rate': 0.22, 'estimator__max_depth': 11, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 26}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `HGBM` | `HistGradientBoostingRegressor` | `paper_reference_grid_search` | 18.509 | 0.420496 | 0.923019 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_162` | `HGBM` | `HistGradientBoostingRegressor` | 18.509 | 0.420496 | 0.923019 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_162` | `ERT` | `HGBM` | 18.509 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/hgbm/2026-04-21-12-00-09__track1_hgbm_phase_162_closure_attempt_13_campaign_run/onnx_export`;
