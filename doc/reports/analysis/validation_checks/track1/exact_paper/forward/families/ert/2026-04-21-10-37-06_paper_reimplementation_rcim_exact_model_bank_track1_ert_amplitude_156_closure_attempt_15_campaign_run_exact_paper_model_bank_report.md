...
- run name: `track1_ert_amplitude_156_closure_attempt_15`;
- output run name: `track1_ert_amplitude_156_closure_attempt_15_campaign_run`;
- run instance id: `2026-04-21-10-36-48__track1_ert_amplitude_156_closure_attempt_15_campaign_run`;
...
- winning mean component MAPE: `11.863%`;
- winning mean component MAE: `0.000051`;
- winning mean component RMSE: `0.000174`;
...
| --- | --- | ---: | ---: | --- |
| `ERT` | `paper_reference_grid_search` | 5 | 0.984659 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 17, 'estimator__min_samples_split': 2, 'estimator__n_estimators': 20}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ERT` | `ExtraTreesRegressor` | `paper_reference_grid_search` | 11.863 | 0.000051 | 0.000174 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_156` | `ERT` | `ExtraTreesRegressor` | 11.863 | 0.000051 | 0.000174 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_156` | `ERT / RF` | `ERT` | 11.863 | `matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/ert/2026-04-21-10-36-48__track1_ert_amplitude_156_closure_attempt_15_campaign_run/onnx_export`;
