...
- run name: `track1_et_phase_162_closure_attempt_05`;
- output run name: `track1_et_phase_162_closure_attempt_05_campaign_run`;
- run instance id: `2026-04-19-04-20-10__track1_et_phase_162_closure_attempt_05_campaign_run`;
...
- winning mean component MAPE: `8.096%`;
- winning mean component MAE: `0.192877`;
- winning mean component RMSE: `0.807150`;
...
| --- | --- | ---: | ---: | --- |
| `ET` | `paper_reference_grid_search` | 5 | 0.668710 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 16, 'estimator__min_samples_split': 2}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ET` | `ExtraTreeRegressor` | `paper_reference_grid_search` | 8.096 | 0.192877 | 0.807150 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_162` | `ET` | `ExtraTreeRegressor` | 8.096 | 0.192877 | 0.807150 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_162` | `ERT` | `ET` | 8.096 | `not_matched_expected_family_direction` |
...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `162` | `-` | `-` | `-` | `ERT` | `ET` | `ET` | `met_paper_target` | `above_paper_target` | `partially_matched_tables_3_6` |

## ONNX Export Surface

- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/et/2026-04-19-04-20-10__track1_et_phase_162_closure_attempt_05_campaign_run/onnx_export`;
