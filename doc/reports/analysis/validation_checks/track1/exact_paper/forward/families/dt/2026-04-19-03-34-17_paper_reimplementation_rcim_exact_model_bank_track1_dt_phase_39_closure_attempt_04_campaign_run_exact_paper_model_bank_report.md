...
- run name: `track1_dt_phase_39_closure_attempt_04`;
- output run name: `track1_dt_phase_39_closure_attempt_04_campaign_run`;
- run instance id: `2026-04-19-03-34-09__track1_dt_phase_39_closure_attempt_04_campaign_run`;
...
- winning mean component MAPE: `2.256%`;
- winning mean component MAE: `0.028697`;
- winning mean component RMSE: `0.045211`;
...
| --- | --- | ---: | ---: | --- |
| `DT` | `paper_reference_grid_search` | 5 | 0.962474 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 6}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `DT` | `DecisionTreeRegressor` | `paper_reference_grid_search` | 2.256 | 0.028697 | 0.045211 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_39` | `DT` | `DecisionTreeRegressor` | 2.256 | 0.028697 | 0.045211 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_39` | `HGBM` | `DT` | 2.256 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/dt/2026-04-19-03-34-09__track1_dt_phase_39_closure_attempt_04_campaign_run/onnx_export`;
