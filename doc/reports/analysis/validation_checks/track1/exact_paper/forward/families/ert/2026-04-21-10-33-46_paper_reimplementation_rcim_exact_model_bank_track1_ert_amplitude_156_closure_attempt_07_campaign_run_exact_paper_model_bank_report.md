...
- run name: `track1_ert_amplitude_156_closure_attempt_07`;
- output run name: `track1_ert_amplitude_156_closure_attempt_07_campaign_run`;
- run instance id: `2026-04-21-10-33-29__track1_ert_amplitude_156_closure_attempt_07_campaign_run`;
...
- winning mean component MAPE: `24.091%`;
- winning mean component MAE: `0.000059`;
- winning mean component RMSE: `0.000224`;
...
| --- | --- | ---: | ---: | --- |
| `ERT` | `paper_reference_grid_search` | 5 | 0.986456 | `{'estimator__criterion': 'absolute_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 2, 'estimator__n_estimators': 40}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ERT` | `ExtraTreesRegressor` | `paper_reference_grid_search` | 24.091 | 0.000059 | 0.000224 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_156` | `ERT` | `ExtraTreesRegressor` | 24.091 | 0.000059 | 0.000224 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_156` | `ERT / RF` | `ERT` | 24.091 | `matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/ert/2026-04-21-10-33-29__track1_ert_amplitude_156_closure_attempt_07_campaign_run/onnx_export`;
