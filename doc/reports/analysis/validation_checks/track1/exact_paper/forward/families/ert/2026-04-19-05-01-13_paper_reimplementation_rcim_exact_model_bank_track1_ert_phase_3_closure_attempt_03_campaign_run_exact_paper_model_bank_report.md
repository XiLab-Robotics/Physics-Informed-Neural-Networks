...
- run name: `track1_ert_phase_3_closure_attempt_03`;
- output run name: `track1_ert_phase_3_closure_attempt_03_campaign_run`;
- run instance id: `2026-04-19-05-00-56__track1_ert_phase_3_closure_attempt_03_campaign_run`;
...
- winning best params: `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 5, 'estimator__n_estimators': 40}`;
- winning mean component MAPE: `1.310%`;
- winning mean component MAE: `0.023352`;
- winning mean component RMSE: `0.031346`;
...
| --- | --- | ---: | ---: | --- |
| `ERT` | `paper_reference_grid_search` | 5 | 0.916363 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 5, 'estimator__n_estimators': 40}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ERT` | `ExtraTreesRegressor` | `paper_reference_grid_search` | 1.310 | 0.023352 | 0.031346 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_3` | `ERT` | `ExtraTreesRegressor` | 1.310 | 0.023352 | 0.031346 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_3` | `HGBM` | `ERT` | 1.310 | `not_matched_expected_family_direction` |
...
| `Repo Best Family` | - | `ERT` | - | - | - | - | - | - | - |
| `Repo Best RMSE` | - | 0.0313 | - | - | - | - | - | - | - |
| `Paper Best Family` | - | `HGBM` | - | - | - | - | - | - | - |
| `Paper Target RMSE` | - | 0.0290 | - | - | - | - | - | - | - |
| `Gap Vs Paper` | - | 0.002346 | - | - | - | - | - | - | - |
| `Status` | - | `above_paper_target` | - | - | - | - | - | - | - |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/ert/2026-04-19-05-00-56__track1_ert_phase_3_closure_attempt_03_campaign_run/onnx_export`;
