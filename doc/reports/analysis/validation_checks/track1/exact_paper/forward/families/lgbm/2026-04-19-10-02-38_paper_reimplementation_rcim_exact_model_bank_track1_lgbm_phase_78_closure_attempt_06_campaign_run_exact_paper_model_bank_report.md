...
- run name: `track1_lgbm_phase_78_closure_attempt_06`;
- output run name: `track1_lgbm_phase_78_closure_attempt_06_campaign_run`;
- run instance id: `2026-04-19-10-01-17__track1_lgbm_phase_78_closure_attempt_06_campaign_run`;
...
- winning mean component MAPE: `173.197%`;
- winning mean component MAE: `0.087929`;
- winning mean component RMSE: `0.183944`;
...
| --- | --- | ---: | ---: | --- |
| `LGBM` | `paper_reference_grid_search` | 5 | 0.726497 | `{'estimator__learning_rate': 0.77, 'estimator__max_depth': 10, 'estimator__num_leaves': 31, 'estimator__subsample': 0.001}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `LGBM` | `LGBMRegressor` | `paper_reference_grid_search` | 173.197 | 0.087929 | 0.183944 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_78` | `LGBM` | `LGBMRegressor` | 173.197 | 0.087929 | 0.183944 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_78` | `HGBM / RF` | `LGBM` | 173.197 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/lgbm/2026-04-19-10-01-17__track1_lgbm_phase_78_closure_attempt_06_campaign_run/onnx_export`;
