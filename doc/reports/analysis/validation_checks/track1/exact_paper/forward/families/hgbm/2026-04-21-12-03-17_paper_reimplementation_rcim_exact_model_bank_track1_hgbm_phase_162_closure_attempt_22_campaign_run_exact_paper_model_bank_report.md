...
- run name: `track1_hgbm_phase_162_closure_attempt_22`;
- output run name: `track1_hgbm_phase_162_closure_attempt_22_campaign_run`;
- run instance id: `2026-04-21-12-03-04__track1_hgbm_phase_162_closure_attempt_22_campaign_run`;
...
- winning mean component MAPE: `16.957%`;
- winning mean component MAE: `0.373547`;
- winning mean component RMSE: `0.797755`;
...
| --- | --- | ---: | ---: | --- |
| `HGBM` | `paper_reference_grid_search` | 5 | 0.736987 | `{'estimator__learning_rate': 0.22, 'estimator__max_depth': 12, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 25}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `HGBM` | `HistGradientBoostingRegressor` | `paper_reference_grid_search` | 16.957 | 0.373547 | 0.797755 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_162` | `HGBM` | `HistGradientBoostingRegressor` | 16.957 | 0.373547 | 0.797755 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_162` | `ERT` | `HGBM` | 16.957 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/hgbm/2026-04-21-12-03-04__track1_hgbm_phase_162_closure_attempt_22_campaign_run/onnx_export`;
