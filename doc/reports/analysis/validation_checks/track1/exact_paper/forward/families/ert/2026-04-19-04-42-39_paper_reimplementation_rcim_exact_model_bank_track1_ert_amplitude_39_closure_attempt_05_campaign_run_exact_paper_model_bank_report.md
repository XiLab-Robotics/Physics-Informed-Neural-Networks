...
- run name: `track1_ert_amplitude_39_closure_attempt_05`;
- output run name: `track1_ert_amplitude_39_closure_attempt_05_campaign_run`;
- run instance id: `2026-04-19-04-42-21__track1_ert_amplitude_39_closure_attempt_05_campaign_run`;
...
| --- | --- | ---: | ---: | --- |
| `ERT` | `paper_reference_grid_search` | 5 | 0.983252 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 4, 'estimator__n_estimators': 40}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ERT` | `ExtraTreesRegressor` | `paper_reference_grid_search` | 2.222 | 0.000024 | 0.000035 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_39` | `ERT` | `ExtraTreesRegressor` | 2.222 | 0.000024 | 0.000035 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_39` | `HGBM` | `ERT` | 2.222 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/ert/2026-04-19-04-42-21__track1_ert_amplitude_39_closure_attempt_05_campaign_run/onnx_export`;
