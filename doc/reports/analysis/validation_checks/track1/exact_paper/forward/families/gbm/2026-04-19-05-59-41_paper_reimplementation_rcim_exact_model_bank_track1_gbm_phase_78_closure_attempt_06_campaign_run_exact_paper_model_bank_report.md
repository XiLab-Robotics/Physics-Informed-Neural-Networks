...
- run name: `track1_gbm_phase_78_closure_attempt_06`;
- output run name: `track1_gbm_phase_78_closure_attempt_06_campaign_run`;
- run instance id: `2026-04-19-05-59-29__track1_gbm_phase_78_closure_attempt_06_campaign_run`;
...
- winning mean component MAPE: `92.760%`;
- winning mean component MAE: `0.089988`;
...
| --- | --- | ---: | ---: | --- |
| `GBM` | `paper_reference_grid_search` | 5 | 0.750732 | `{'estimator__criterion': 'squared_error', 'estimator__learning_rate': 0.1, 'estimator__max_depth': 15, 'estimator__min_samples_split': 16, 'estimator__n_estimators': 20}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `GBM` | `GradientBoostingRegressor` | `paper_reference_grid_search` | 92.760 | 0.089988 | 0.172855 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_78` | `GBM` | `GradientBoostingRegressor` | 92.760 | 0.089988 | 0.172855 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_78` | `HGBM / RF` | `GBM` | 92.760 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/gbm/2026-04-19-05-59-29__track1_gbm_phase_78_closure_attempt_06_campaign_run/onnx_export`;
