...
- run name: `track1_dt_phase_240_closure_attempt_02`;
- output run name: `track1_dt_phase_240_closure_attempt_02_campaign_run`;
- run instance id: `2026-04-19-03-42-15__track1_dt_phase_240_closure_attempt_02_campaign_run`;
...
- winning best params: `{'estimator__criterion': 'absolute_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 4}`;
- winning mean component MAPE: `91.127%`;
- winning mean component MAE: `0.149592`;
- winning mean component RMSE: `0.581393`;
...
| --- | --- | ---: | ---: | --- |
| `DT` | `paper_reference_grid_search` | 5 | 0.504289 | `{'estimator__criterion': 'absolute_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 4}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `DT` | `DecisionTreeRegressor` | `paper_reference_grid_search` | 91.127 | 0.149592 | 0.581393 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_240` | `DT` | `DecisionTreeRegressor` | 91.127 | 0.149592 | 0.581393 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_240` | `ERT` | `DT` | 91.127 | `not_matched_expected_family_direction` |
...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `240` | `-` | `-` | `-` | `ERT` | `DT` | `DT` | `met_paper_target` | `above_paper_target` | `partially_matched_tables_3_6` |

## ONNX Export Surface

- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/dt/2026-04-19-03-42-15__track1_dt_phase_240_closure_attempt_02_campaign_run/onnx_export`;
