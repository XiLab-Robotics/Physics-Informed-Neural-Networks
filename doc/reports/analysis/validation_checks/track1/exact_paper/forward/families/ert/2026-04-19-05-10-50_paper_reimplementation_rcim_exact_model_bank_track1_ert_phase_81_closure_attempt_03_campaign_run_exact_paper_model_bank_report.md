...
- run name: `track1_ert_phase_81_closure_attempt_03`;
- output run name: `track1_ert_phase_81_closure_attempt_03_campaign_run`;
- run instance id: `2026-04-19-05-10-32__track1_ert_phase_81_closure_attempt_03_campaign_run`;
...
- winning best params: `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 3, 'estimator__n_estimators': 100}`;
- winning mean component MAPE: `4.643%`;
- winning mean component MAE: `0.047861`;
- winning mean component RMSE: `0.074909`;
...
| --- | --- | ---: | ---: | --- |
| `ERT` | `paper_reference_grid_search` | 5 | 0.964670 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 3, 'estimator__n_estimators': 100}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ERT` | `ExtraTreesRegressor` | `paper_reference_grid_search` | 4.643 | 0.047861 | 0.074909 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_81` | `ERT` | `ExtraTreesRegressor` | 4.643 | 0.047861 | 0.074909 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_81` | `RF` | `ERT` | 4.643 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/ert/2026-04-19-05-10-32__track1_ert_phase_81_closure_attempt_03_campaign_run/onnx_export`;
