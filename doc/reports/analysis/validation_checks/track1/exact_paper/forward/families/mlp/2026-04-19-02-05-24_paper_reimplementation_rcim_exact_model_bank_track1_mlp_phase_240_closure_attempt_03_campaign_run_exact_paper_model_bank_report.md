...
- run name: `track1_mlp_phase_240_closure_attempt_03`;
- output run name: `track1_mlp_phase_240_closure_attempt_03_campaign_run`;
- run instance id: `2026-04-19-02-05-14__track1_mlp_phase_240_closure_attempt_03_campaign_run`;
...
- winning mean component MAPE: `52.934%`;
- winning mean component MAE: `0.644170`;
- winning mean component RMSE: `1.019209`;
...
| --- | --- | ---: | ---: | --- |
| `MLP` | `paper_reference_grid_search` | 5 | 0.037602 | `{'estimator__activation': 'tanh', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (200,), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `MLP` | `MLPRegressor` | `paper_reference_grid_search` | 52.934 | 0.644170 | 1.019209 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_240` | `MLP` | `MLPRegressor` | 52.934 | 0.644170 | 1.019209 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_240` | `ERT` | `MLP` | 52.934 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/mlp/2026-04-19-02-05-14__track1_mlp_phase_240_closure_attempt_03_campaign_run/onnx_export`;
