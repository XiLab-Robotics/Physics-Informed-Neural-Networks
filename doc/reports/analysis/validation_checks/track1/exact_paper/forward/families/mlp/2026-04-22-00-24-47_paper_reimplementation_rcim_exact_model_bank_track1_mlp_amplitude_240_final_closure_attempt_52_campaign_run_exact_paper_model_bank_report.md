...
- run name: `track1_mlp_amplitude_240_final_closure_attempt_52`;
- output run name: `track1_mlp_amplitude_240_final_closure_attempt_52_campaign_run`;
- run instance id: `2026-04-22-00-24-37__track1_mlp_amplitude_240_final_closure_attempt_52_campaign_run`;
...
- winning mean component MAPE: `4468.336%`;
- winning mean component MAE: `0.011966`;
- winning mean component RMSE: `0.020743`;
...
| --- | --- | ---: | ---: | --- |
| `MLP` | `paper_reference_grid_search` | 5 | -2900.223002 | `{'estimator__activation': 'tanh', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (200, 50), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `MLP` | `MLPRegressor` | `paper_reference_grid_search` | 4468.336 | 0.011966 | 0.020743 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_240` | `MLP` | `MLPRegressor` | 4468.336 | 0.011966 | 0.020743 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_240` | `ERT` | `MLP` | 4468.336 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/mlp/2026-04-22-00-24-37__track1_mlp_amplitude_240_final_closure_attempt_52_campaign_run/onnx_export`;
