...
- run name: `track1_rf_phase_78_closure_attempt_02`;
- output run name: `track1_rf_phase_78_closure_attempt_02_campaign_run`;
- run instance id: `2026-04-19-02-52-30__track1_rf_phase_78_closure_attempt_02_campaign_run`;
...
- winning best params: `{'estimator__criterion': 'absolute_error', 'estimator__max_depth': 12, 'estimator__min_samples_split': 6, 'estimator__n_estimators': 60}`;
- winning mean component MAPE: `55.870%`;
- winning mean component MAE: `0.070615`;
- winning mean component RMSE: `0.127871`;
...
| --- | --- | ---: | ---: | --- |
| `RF` | `paper_reference_grid_search` | 5 | 0.812077 | `{'estimator__criterion': 'absolute_error', 'estimator__max_depth': 12, 'estimator__min_samples_split': 6, 'estimator__n_estimators': 60}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `RF` | `RandomForestRegressor` | `paper_reference_grid_search` | 55.870 | 0.070615 | 0.127871 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_78` | `RF` | `RandomForestRegressor` | 55.870 | 0.070615 | 0.127871 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_78` | `HGBM / RF` | `RF` | 55.870 | `matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/rf/2026-04-19-02-52-30__track1_rf_phase_78_closure_attempt_02_campaign_run/onnx_export`;
