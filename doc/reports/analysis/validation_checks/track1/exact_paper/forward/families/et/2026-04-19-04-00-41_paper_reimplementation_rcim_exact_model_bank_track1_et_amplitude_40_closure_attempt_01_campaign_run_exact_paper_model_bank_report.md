...
- run name: `track1_et_amplitude_40_closure_attempt_01`;
- output run name: `track1_et_amplitude_40_closure_attempt_01_campaign_run`;
- run instance id: `2026-04-19-04-00-34__track1_et_amplitude_40_closure_attempt_01_campaign_run`;
...
- winning mean component MAPE: `3.901%`;
...
| --- | --- | ---: | ---: | --- |
| `ET` | `paper_reference_grid_search` | 5 | 0.696450 | `{'estimator__criterion': 'absolute_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 5}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ET` | `ExtraTreeRegressor` | `paper_reference_grid_search` | 3.901 | 0.000030 | 0.000047 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_40` | `ET` | `ExtraTreeRegressor` | 3.901 | 0.000030 | 0.000047 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_40` | `ERT / GBM` | `ET` | 3.901 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/et/2026-04-19-04-00-34__track1_et_amplitude_40_closure_attempt_01_campaign_run/onnx_export`;
