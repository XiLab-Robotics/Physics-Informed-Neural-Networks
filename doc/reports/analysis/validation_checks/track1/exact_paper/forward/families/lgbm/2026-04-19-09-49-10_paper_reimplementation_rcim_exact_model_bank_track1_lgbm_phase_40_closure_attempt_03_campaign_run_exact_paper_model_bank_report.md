...
- run name: `track1_lgbm_phase_40_closure_attempt_03`;
- output run name: `track1_lgbm_phase_40_closure_attempt_03_campaign_run`;
- run instance id: `2026-04-19-09-47-47__track1_lgbm_phase_40_closure_attempt_03_campaign_run`;
...
- winning best params: `{'estimator__learning_rate': 0.39, 'estimator__max_depth': 13, 'estimator__num_leaves': 31, 'estimator__subsample': 0.001}`;
- winning mean component MAPE: `69.903%`;
- winning mean component MAE: `0.038802`;
- winning mean component RMSE: `0.053926`;
...
| --- | --- | ---: | ---: | --- |
| `LGBM` | `paper_reference_grid_search` | 5 | 0.776595 | `{'estimator__learning_rate': 0.39, 'estimator__max_depth': 13, 'estimator__num_leaves': 31, 'estimator__subsample': 0.001}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `LGBM` | `LGBMRegressor` | `paper_reference_grid_search` | 69.903 | 0.038802 | 0.053926 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_40` | `LGBM` | `LGBMRegressor` | 69.903 | 0.038802 | 0.053926 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_40` | `ERT / GBM` | `LGBM` | 69.903 | `not_matched_expected_family_direction` |
...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `40` | `-` | `-` | `-` | `GBM` | `LGBM` | `LGBM` | `above_paper_target` | `met_paper_target` | `partially_matched_tables_3_6` |

## ONNX Export Surface

- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/lgbm/2026-04-19-09-47-47__track1_lgbm_phase_40_closure_attempt_03_campaign_run/onnx_export`;
