...
- run name: `track1_hgbm_phase_39_closure_attempt_02`;
- output run name: `track1_hgbm_phase_39_closure_attempt_02_campaign_run`;
- run instance id: `2026-04-19-06-42-32__track1_hgbm_phase_39_closure_attempt_02_campaign_run`;
...
- winning mean component MAPE: `1.882%`;
- winning mean component MAE: `0.023297`;
- winning mean component RMSE: `0.034282`;
...
| --- | --- | ---: | ---: | --- |
| `HGBM` | `paper_reference_grid_search` | 5 | 0.983732 | `{'estimator__learning_rate': 0.22, 'estimator__max_depth': 11, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 26}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `HGBM` | `HistGradientBoostingRegressor` | `paper_reference_grid_search` | 1.882 | 0.023297 | 0.034282 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_39` | `HGBM` | `HistGradientBoostingRegressor` | 1.882 | 0.023297 | 0.034282 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_39` | `HGBM` | `HGBM` | 1.882 | `matched_expected_family_direction` |
...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `39` | `-` | `-` | `-` | `HGBM` | `HGBM` | `HGBM` | `above_paper_target` | `above_paper_target` | `partially_matched_tables_3_6` |

## ONNX Export Surface

- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/hgbm/2026-04-19-06-42-32__track1_hgbm_phase_39_closure_attempt_02_campaign_run/onnx_export`;
