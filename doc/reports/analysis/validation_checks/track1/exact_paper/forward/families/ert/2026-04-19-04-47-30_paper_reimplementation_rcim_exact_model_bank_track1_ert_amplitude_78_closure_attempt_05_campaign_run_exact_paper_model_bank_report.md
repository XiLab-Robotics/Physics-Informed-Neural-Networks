...
- run name: `track1_ert_amplitude_78_closure_attempt_05`;
- output run name: `track1_ert_amplitude_78_closure_attempt_05_campaign_run`;
- run instance id: `2026-04-19-04-47-12__track1_ert_amplitude_78_closure_attempt_05_campaign_run`;
...
- winning mean component MAPE: `10.588%`;
...
| --- | --- | ---: | ---: | --- |
| `ERT` | `paper_reference_grid_search` | 5 | 0.993238 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 18, 'estimator__min_samples_split': 2, 'estimator__n_estimators': 60}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ERT` | `ExtraTreesRegressor` | `paper_reference_grid_search` | 10.588 | 0.000029 | 0.000042 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_78` | `ERT` | `ExtraTreesRegressor` | 10.588 | 0.000029 | 0.000042 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_78` | `HGBM / RF` | `ERT` | 10.588 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/ert/2026-04-19-04-47-12__track1_ert_amplitude_78_closure_attempt_05_campaign_run/onnx_export`;
