...
- run name: `track1_et_amplitude_81_closure_attempt_03`;
- output run name: `track1_et_amplitude_81_closure_attempt_03_campaign_run`;
- run instance id: `2026-04-19-04-03-54__track1_et_amplitude_81_closure_attempt_03_campaign_run`;
...
- winning mean component MAPE: `5.283%`;
...
| --- | --- | ---: | ---: | --- |
| `ET` | `paper_reference_grid_search` | 5 | 0.897548 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 5}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ET` | `ExtraTreeRegressor` | `paper_reference_grid_search` | 5.283 | 0.000016 | 0.000025 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_81` | `ET` | `ExtraTreeRegressor` | 5.283 | 0.000016 | 0.000025 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_81` | `RF` | `ET` | 5.283 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/et/2026-04-19-04-03-54__track1_et_amplitude_81_closure_attempt_03_campaign_run/onnx_export`;
