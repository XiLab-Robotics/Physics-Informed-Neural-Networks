...
- run name: `track1_mlp_amplitude_39_closure_attempt_26`;
- output run name: `track1_mlp_amplitude_39_closure_attempt_26_campaign_run`;
- run instance id: `2026-04-21-00-33-47__track1_mlp_amplitude_39_closure_attempt_26_campaign_run`;
...
- winning mean component MAPE: `1051.746%`;
- winning mean component MAE: `0.010089`;
- winning mean component RMSE: `0.016633`;
...
| --- | --- | ---: | ---: | --- |
| `MLP` | `paper_reference_grid_search` | 5 | -7520.193886 | `{'estimator__activation': 'tanh', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (200, 50), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `MLP` | `MLPRegressor` | `paper_reference_grid_search` | 1051.746 | 0.010089 | 0.016633 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_39` | `MLP` | `MLPRegressor` | 1051.746 | 0.010089 | 0.016633 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_39` | `HGBM` | `MLP` | 1051.746 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/mlp/2026-04-21-00-33-47__track1_mlp_amplitude_39_closure_attempt_26_campaign_run/onnx_export`;
