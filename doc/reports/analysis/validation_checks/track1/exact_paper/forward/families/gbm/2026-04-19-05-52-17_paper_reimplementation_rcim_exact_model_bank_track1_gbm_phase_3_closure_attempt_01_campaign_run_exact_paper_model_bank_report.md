...
- run name: `track1_gbm_phase_3_closure_attempt_01`;
- output run name: `track1_gbm_phase_3_closure_attempt_01_campaign_run`;
- run instance id: `2026-04-19-05-52-04__track1_gbm_phase_3_closure_attempt_01_campaign_run`;
...
- winning best params: `{'estimator__criterion': 'squared_error', 'estimator__learning_rate': 0.1, 'estimator__max_depth': 17, 'estimator__min_samples_split': 12, 'estimator__n_estimators': 52}`;
- winning mean component MAPE: `1.340%`;
- winning mean component MAE: `0.024139`;
- winning mean component RMSE: `0.034918`;
...
| --- | --- | ---: | ---: | --- |
| `GBM` | `paper_reference_grid_search` | 5 | 0.930403 | `{'estimator__criterion': 'squared_error', 'estimator__learning_rate': 0.1, 'estimator__max_depth': 17, 'estimator__min_samples_split': 12, 'estimator__n_estimators': 52}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `GBM` | `GradientBoostingRegressor` | `paper_reference_grid_search` | 1.340 | 0.024139 | 0.034918 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_3` | `GBM` | `GradientBoostingRegressor` | 1.340 | 0.024139 | 0.034918 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_3` | `HGBM` | `GBM` | 1.340 | `not_matched_expected_family_direction` |
...
| `Repo Best Family` | - | `GBM` | - | - | - | - | - | - | - |
| `Repo Best RMSE` | - | 0.0349 | - | - | - | - | - | - | - |
| `Paper Best Family` | - | `HGBM` | - | - | - | - | - | - | - |
| `Paper Target RMSE` | - | 0.0290 | - | - | - | - | - | - | - |
| `Gap Vs Paper` | - | 0.005918 | - | - | - | - | - | - | - |
| `Status` | - | `above_paper_target` | - | - | - | - | - | - | - |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/gbm/2026-04-19-05-52-04__track1_gbm_phase_3_closure_attempt_01_campaign_run/onnx_export`;
