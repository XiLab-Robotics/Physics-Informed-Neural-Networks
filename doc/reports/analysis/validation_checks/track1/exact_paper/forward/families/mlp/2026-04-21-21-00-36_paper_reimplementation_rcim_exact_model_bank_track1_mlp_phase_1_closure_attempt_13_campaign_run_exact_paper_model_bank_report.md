...
- run name: `track1_mlp_phase_1_closure_attempt_13`;
- output run name: `track1_mlp_phase_1_closure_attempt_13_campaign_run`;
- run instance id: `2026-04-21-21-00-26__track1_mlp_phase_1_closure_attempt_13_campaign_run`;
...
- winning mean component MAPE: `267.676%`;
- winning mean component MAE: `0.015349`;
- winning mean component RMSE: `0.025387`;
...
| --- | --- | ---: | ---: | --- |
| `MLP` | `paper_reference_grid_search` | 5 | -14.420267 | `{'estimator__activation': 'tanh', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (200, 50), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `MLP` | `MLPRegressor` | `paper_reference_grid_search` | 267.676 | 0.015349 | 0.025387 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_1` | `MLP` | `MLPRegressor` | 267.676 | 0.015349 | 0.025387 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_1` | `RF / LGBM` | `MLP` | 267.676 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/mlp/2026-04-21-21-00-26__track1_mlp_phase_1_closure_attempt_13_campaign_run/onnx_export`;
