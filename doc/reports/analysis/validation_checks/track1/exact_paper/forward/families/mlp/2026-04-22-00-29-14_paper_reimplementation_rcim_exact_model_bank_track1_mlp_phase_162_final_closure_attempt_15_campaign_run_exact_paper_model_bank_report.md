...
- run name: `track1_mlp_phase_162_final_closure_attempt_15`;
- output run name: `track1_mlp_phase_162_final_closure_attempt_15_campaign_run`;
- run instance id: `2026-04-22-00-29-05__track1_mlp_phase_162_final_closure_attempt_15_campaign_run`;
...
- winning mean component MAPE: `57.898%`;
- winning mean component MAE: `1.121075`;
- winning mean component RMSE: `1.688914`;
...
| --- | --- | ---: | ---: | --- |
| `MLP` | `paper_reference_grid_search` | 5 | 0.356204 | `{'estimator__activation': 'tanh', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (200, 50), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `MLP` | `MLPRegressor` | `paper_reference_grid_search` | 57.898 | 1.121075 | 1.688914 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_162` | `MLP` | `MLPRegressor` | 57.898 | 1.121075 | 1.688914 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_162` | `ERT` | `MLP` | 57.898 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/mlp/2026-04-22-00-29-05__track1_mlp_phase_162_final_closure_attempt_15_campaign_run/onnx_export`;
