...
- run name: `track1_gbm_phase_full_matrix`;
- output run name: `track1_gbm_phase_full_matrix_campaign_run`;
- run instance id: `2026-04-18-01-33-23__track1_gbm_phase_full_matrix_campaign_run`;
...
- winning best params: `{'estimator__criterion': 'squared_error', 'estimator__learning_rate': 0.1, 'estimator__max_depth': 18, 'estimator__min_samples_split': 14, 'estimator__n_estimators': 36}`;
- winning mean component MAPE: `45.043%`;
- winning mean component MAE: `0.138956`;
- winning mean component RMSE: `0.339324`;
...
| --- | --- | ---: | ---: | --- |
| `GBM` | `paper_reference_grid_search` | 5 | 0.784468 | `{'estimator__criterion': 'squared_error', 'estimator__learning_rate': 0.1, 'estimator__max_depth': 18, 'estimator__min_samples_split': 14, 'estimator__n_estimators': 36}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `GBM` | `GradientBoostingRegressor` | `paper_reference_grid_search` | 45.043 | 0.138956 | 0.339324 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_1` | `GBM` | `GradientBoostingRegressor` | 23.271 | 0.001891 | 0.002492 |
| `fft_y_Fw_filtered_phase_3` | `GBM` | `GradientBoostingRegressor` | 1.323 | 0.023747 | 0.034311 |
| `fft_y_Fw_filtered_phase_39` | `GBM` | `GradientBoostingRegressor` | 1.835 | 0.023351 | 0.040113 |
| `fft_y_Fw_filtered_phase_40` | `GBM` | `GradientBoostingRegressor` | 68.969 | 0.038129 | 0.057144 |
| `fft_y_Fw_filtered_phase_78` | `GBM` | `GradientBoostingRegressor` | 120.012 | 0.060491 | 0.139595 |
| `fft_y_Fw_filtered_phase_81` | `GBM` | `GradientBoostingRegressor` | 4.937 | 0.050932 | 0.075851 |
| `fft_y_Fw_filtered_phase_156` | `GBM` | `GradientBoostingRegressor` | 147.887 | 0.470366 | 1.021755 |
| `fft_y_Fw_filtered_phase_162` | `GBM` | `GradientBoostingRegressor` | 12.664 | 0.279863 | 0.824810 |
| `fft_y_Fw_filtered_phase_240` | `GBM` | `GradientBoostingRegressor` | 24.489 | 0.301835 | 0.857841 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_1` | `RF / LGBM` | `GBM` | 23.271 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_3` | `HGBM` | `GBM` | 1.323 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_39` | `HGBM` | `GBM` | 1.835 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_40` | `ERT / GBM` | `GBM` | 68.969 | `matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_78` | `HGBM / RF` | `GBM` | 120.012 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_81` | `RF` | `GBM` | 4.937 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_156` | `ERT / RF` | `GBM` | 147.887 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_162` | `ERT` | `GBM` | 12.664 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_240` | `ERT` | `GBM` | 24.489 | `not_matched_expected_family_direction` |
...
| `Repo Best Family` | `GBM` | `GBM` | `GBM` | `GBM` | `GBM` | `GBM` | `GBM` | `GBM` | `GBM` |
| `Repo Best MAE` | 0.001891 | 0.0237 | 0.0234 | 0.0381 | 0.0605 | 0.0509 | 0.4704 | 0.2799 | 0.3018 |
...
| `Gap Vs Paper` | 9.10e-05 | 0.003747 | 0.002351 | 0.002129 | -0.0135 | -0.002068 | -0.0396 | 0.0799 | 0.0718 |
...
| `Repo Best Family` | `GBM` | `GBM` | `GBM` | `GBM` | `GBM` | `GBM` | `GBM` | `GBM` | `GBM` |
| `Repo Best RMSE` | 0.002492 | 0.0343 | 0.0401 | 0.0571 | 0.1396 | 0.0759 | 1.022 | 0.8248 | 0.8578 |
...
| `Gap Vs Paper` | -7.90e-06 | 0.005311 | 0.0131 | 0.002144 | -0.0204 | -0.006149 | -0.1782 | 0.1848 | 0.2778 |
| `Status` | `met_paper_target` | `above_paper_target` | `above_paper_target` | `above_paper_target` | `met_paper_target` | `met_paper_target` | `met_paper_target` | `above_paper_target` | `above_paper_target` |
...
| `3` | `-` | `-` | `-` | `HGBM` | `GBM` | `GBM` | `above_paper_target` | `above_paper_target` | `not_yet_matched_tables_3_6` |
| `39` | `-` | `-` | `-` | `HGBM` | `GBM` | `GBM` | `above_paper_target` | `above_paper_target` | `not_yet_matched_tables_3_6` |
| `40` | `-` | `-` | `-` | `GBM` | `GBM` | `GBM` | `above_paper_target` | `above_paper_target` | `partially_matched_tables_3_6` |
| `78` | `-` | `-` | `-` | `RF` | `GBM` | `GBM` | `met_paper_target` | `met_paper_target` | `partially_matched_tables_3_6` |
| `81` | `-` | `-` | `-` | `RF` | `GBM` | `GBM` | `met_paper_target` | `met_paper_target` | `partially_matched_tables_3_6` |
| `156` | `-` | `-` | `-` | `RF` | `GBM` | `GBM` | `met_paper_target` | `met_paper_target` | `partially_matched_tables_3_6` |
| `162` | `-` | `-` | `-` | `ERT` | `GBM` | `GBM` | `above_paper_target` | `above_paper_target` | `not_yet_matched_tables_3_6` |
| `240` | `-` | `-` | `-` | `ERT` | `GBM` | `GBM` | `above_paper_target` | `above_paper_target` | `not_yet_matched_tables_3_6` |

## ONNX Export Surface

- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/full_matrix/gbm/2026-04-18-01-33-23__track1_gbm_phase_full_matrix_campaign_run/onnx_export`;
