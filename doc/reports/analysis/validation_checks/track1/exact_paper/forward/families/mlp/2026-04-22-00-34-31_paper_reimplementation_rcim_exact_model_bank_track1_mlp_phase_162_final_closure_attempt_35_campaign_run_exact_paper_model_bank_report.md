...
- run name: `track1_mlp_phase_162_final_closure_attempt_35`;
- output run name: `track1_mlp_phase_162_final_closure_attempt_35_campaign_run`;
- run instance id: `2026-04-22-00-34-22__track1_mlp_phase_162_final_closure_attempt_35_campaign_run`;
...
- winning mean component MAPE: `44.812%`;
- winning mean component MAE: `0.858870`;
- winning mean component RMSE: `1.322571`;
...
| --- | --- | ---: | ---: | --- |
| `MLP` | `paper_reference_grid_search` | 5 | 0.221371 | `{'estimator__activation': 'relu', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (100,), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `MLP` | `MLPRegressor` | `paper_reference_grid_search` | 44.812 | 0.858870 | 1.322571 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_162` | `MLP` | `MLPRegressor` | 44.812 | 0.858870 | 1.322571 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_162` | `ERT` | `MLP` | 44.812 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/mlp/2026-04-22-00-34-22__track1_mlp_phase_162_final_closure_attempt_35_campaign_run/onnx_export`;
