...
- run name: `track1_lgbm_phase_39_closure_attempt_02`;
- output run name: `track1_lgbm_phase_39_closure_attempt_02_campaign_run`;
- run instance id: `2026-04-19-09-37-13__track1_lgbm_phase_39_closure_attempt_02_campaign_run`;
...
- winning mean component MAPE: `1.821%`;
- winning mean component MAE: `0.022446`;
- winning mean component RMSE: `0.032605`;
...
| --- | --- | ---: | ---: | --- |
| `LGBM` | `paper_reference_grid_search` | 5 | 0.983685 | `{'estimator__learning_rate': 0.39, 'estimator__max_depth': 13, 'estimator__num_leaves': 31, 'estimator__subsample': 0.001}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `LGBM` | `LGBMRegressor` | `paper_reference_grid_search` | 1.821 | 0.022446 | 0.032605 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_39` | `LGBM` | `LGBMRegressor` | 1.821 | 0.022446 | 0.032605 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_39` | `HGBM` | `LGBM` | 1.821 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/lgbm/2026-04-19-09-37-13__track1_lgbm_phase_39_closure_attempt_02_campaign_run/onnx_export`;
