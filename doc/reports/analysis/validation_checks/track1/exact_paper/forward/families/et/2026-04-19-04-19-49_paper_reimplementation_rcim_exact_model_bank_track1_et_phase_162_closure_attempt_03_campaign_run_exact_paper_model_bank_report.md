...
- run name: `track1_et_phase_162_closure_attempt_03`;
- output run name: `track1_et_phase_162_closure_attempt_03_campaign_run`;
- run instance id: `2026-04-19-04-19-41__track1_et_phase_162_closure_attempt_03_campaign_run`;
...
- winning mean component MAPE: `18.779%`;
- winning mean component MAE: `0.449077`;
- winning mean component RMSE: `1.379067`;
...
| --- | --- | ---: | ---: | --- |
| `ET` | `paper_reference_grid_search` | 5 | 0.732772 | `{'estimator__criterion': 'absolute_error', 'estimator__max_depth': 15, 'estimator__min_samples_split': 4}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ET` | `ExtraTreeRegressor` | `paper_reference_grid_search` | 18.779 | 0.449077 | 1.379067 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_162` | `ET` | `ExtraTreeRegressor` | 18.779 | 0.449077 | 1.379067 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_162` | `ERT` | `ET` | 18.779 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/et/2026-04-19-04-19-41__track1_et_phase_162_closure_attempt_03_campaign_run/onnx_export`;
