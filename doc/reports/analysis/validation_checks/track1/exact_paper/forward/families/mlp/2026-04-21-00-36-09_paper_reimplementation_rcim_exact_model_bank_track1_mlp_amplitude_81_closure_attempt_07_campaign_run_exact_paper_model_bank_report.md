...
- run name: `track1_mlp_amplitude_81_closure_attempt_07`;
- output run name: `track1_mlp_amplitude_81_closure_attempt_07_campaign_run`;
- run instance id: `2026-04-21-00-35-59__track1_mlp_amplitude_81_closure_attempt_07_campaign_run`;
...
- winning mean component MAPE: `1890.041%`;
- winning mean component MAE: `0.005365`;
- winning mean component RMSE: `0.009396`;
...
| --- | --- | ---: | ---: | --- |
| `MLP` | `paper_reference_grid_search` | 5 | -141612.145409 | `{'estimator__activation': 'tanh', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (200, 50), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `MLP` | `MLPRegressor` | `paper_reference_grid_search` | 1890.041 | 0.005365 | 0.009396 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_81` | `MLP` | `MLPRegressor` | 1890.041 | 0.005365 | 0.009396 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_81` | `RF` | `MLP` | 1890.041 | `not_matched_expected_family_direction` |
...
| `Repo Best RMSE` | - | - | - | - | - | - | 0.009396 | - | - | - |
| `Paper Best Family` | - | - | - | - | - | - | `RF` | - | - | - |
| `Paper Target RMSE` | - | - | - | - | - | - | 1.50e-05 | - | - | - |
| `Gap Vs Paper` | - | - | - | - | - | - | 0.009381 | - | - | - |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/mlp/2026-04-21-00-35-59__track1_mlp_amplitude_81_closure_attempt_07_campaign_run/onnx_export`;
