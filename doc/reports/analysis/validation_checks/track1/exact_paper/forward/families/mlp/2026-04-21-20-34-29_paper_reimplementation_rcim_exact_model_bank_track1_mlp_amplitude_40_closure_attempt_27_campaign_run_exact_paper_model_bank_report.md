...
- run name: `track1_mlp_amplitude_40_closure_attempt_27`;
- output run name: `track1_mlp_amplitude_40_closure_attempt_27_campaign_run`;
- run instance id: `2026-04-21-20-34-19__track1_mlp_amplitude_40_closure_attempt_27_campaign_run`;
...
- winning mean component MAPE: `1183.067%`;
- winning mean component MAE: `0.009608`;
- winning mean component RMSE: `0.015006`;
...
| --- | --- | ---: | ---: | --- |
| `MLP` | `paper_reference_grid_search` | 5 | -67776.149007 | `{'estimator__activation': 'tanh', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (200, 50), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `MLP` | `MLPRegressor` | `paper_reference_grid_search` | 1183.067 | 0.009608 | 0.015006 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_40` | `MLP` | `MLPRegressor` | 1183.067 | 0.009608 | 0.015006 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_40` | `ERT / GBM` | `MLP` | 1183.067 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/mlp/2026-04-21-20-34-19__track1_mlp_amplitude_40_closure_attempt_27_campaign_run/onnx_export`;
