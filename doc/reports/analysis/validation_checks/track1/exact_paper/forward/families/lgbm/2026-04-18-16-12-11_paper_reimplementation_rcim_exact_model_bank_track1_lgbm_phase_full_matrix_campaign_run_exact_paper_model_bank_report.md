...
- run name: `track1_lgbm_phase_full_matrix`;
- output run name: `track1_lgbm_phase_full_matrix_campaign_run`;
- run instance id: `2026-04-18-16-01-38__track1_lgbm_phase_full_matrix_campaign_run`;
...
- winning best params: `{'estimator__learning_rate': 0.39, 'estimator__max_depth': 11, 'estimator__num_leaves': 31, 'estimator__subsample': 0.001}`;
- winning mean component MAPE: `73.013%`;
- winning mean component MAE: `0.172320`;
- winning mean component RMSE: `0.342092`;
...
| --- | --- | ---: | ---: | --- |
| `LGBM` | `paper_reference_grid_search` | 5 | 0.786236 | `{'estimator__learning_rate': 0.39, 'estimator__max_depth': 11, 'estimator__num_leaves': 31, 'estimator__subsample': 0.001}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `LGBM` | `LGBMRegressor` | `paper_reference_grid_search` | 73.013 | 0.172320 | 0.342092 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_1` | `LGBM` | `LGBMRegressor` | 22.764 | 0.001923 | 0.002649 |
| `fft_y_Fw_filtered_phase_3` | `LGBM` | `LGBMRegressor` | 1.441 | 0.025613 | 0.036510 |
| `fft_y_Fw_filtered_phase_39` | `LGBM` | `LGBMRegressor` | 1.656 | 0.020463 | 0.032272 |
| `fft_y_Fw_filtered_phase_40` | `LGBM` | `LGBMRegressor` | 55.406 | 0.037662 | 0.058012 |
| `fft_y_Fw_filtered_phase_78` | `LGBM` | `LGBMRegressor` | 469.122 | 0.072443 | 0.142386 |
| `fft_y_Fw_filtered_phase_81` | `LGBM` | `LGBMRegressor` | 4.619 | 0.047014 | 0.066971 |
| `fft_y_Fw_filtered_phase_156` | `LGBM` | `LGBMRegressor` | 56.972 | 0.619105 | 1.054640 |
| `fft_y_Fw_filtered_phase_162` | `LGBM` | `LGBMRegressor` | 16.035 | 0.346057 | 0.798147 |
| `fft_y_Fw_filtered_phase_240` | `LGBM` | `LGBMRegressor` | 29.097 | 0.380599 | 0.887241 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_1` | `RF / LGBM` | `LGBM` | 22.764 | `matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_3` | `HGBM` | `LGBM` | 1.441 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_39` | `HGBM` | `LGBM` | 1.656 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_40` | `ERT / GBM` | `LGBM` | 55.406 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_78` | `HGBM / RF` | `LGBM` | 469.122 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_81` | `RF` | `LGBM` | 4.619 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_156` | `ERT / RF` | `LGBM` | 56.972 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_162` | `ERT` | `LGBM` | 16.035 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_240` | `ERT` | `LGBM` | 29.097 | `not_matched_expected_family_direction` |
...
| ---: | --- | --- | --- | ---: | --- |
| `1` | `RF / LGBM` | `-` | `LGBM` | 1/1 | `full_family_direction_match` |
| `3` | `HGBM` | `-` | `LGBM` | 0/1 | `no_family_direction_match` |
| `39` | `HGBM` | `-` | `LGBM` | 0/1 | `no_family_direction_match` |
| `40` | `ERT / GBM` | `-` | `LGBM` | 0/1 | `no_family_direction_match` |
| `78` | `HGBM / RF` | `-` | `LGBM` | 0/1 | `no_family_direction_match` |
| `81` | `RF` | `-` | `LGBM` | 0/1 | `no_family_direction_match` |
| `156` | `ERT / RF` | `-` | `LGBM` | 0/1 | `no_family_direction_match` |
| `162` | `ERT` | `-` | `LGBM` | 0/1 | `no_family_direction_match` |
| `240` | `ERT` | `-` | `LGBM` | 0/1 | `no_family_direction_match` |
...
| `Repo Best Family` | `LGBM` | `LGBM` | `LGBM` | `LGBM` | `LGBM` | `LGBM` | `LGBM` | `LGBM` | `LGBM` |
| `Repo Best MAE` | 0.001923 | 0.0256 | 0.0205 | 0.0377 | 0.0724 | 0.0470 | 0.6191 | 0.3461 | 0.3806 |
...
| `Gap Vs Paper` | 1.23e-04 | 0.005613 | -5.37e-04 | 0.001662 | -0.001557 | -0.005986 | 0.1091 | 0.1461 | 0.1506 |
...
| `Repo Best Family` | `LGBM` | `LGBM` | `LGBM` | `LGBM` | `LGBM` | `LGBM` | `LGBM` | `LGBM` | `LGBM` |
| `Repo Best RMSE` | 0.002649 | 0.0365 | 0.0323 | 0.0580 | 0.1424 | 0.0670 | 1.055 | 0.7981 | 0.8872 |
...
| `Gap Vs Paper` | 1.49e-04 | 0.007510 | 0.005272 | 0.003012 | -0.0176 | -0.0150 | -0.1454 | 0.1581 | 0.3072 |
...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `1` | `-` | `-` | `-` | `LGBM` | `LGBM` | `LGBM` | `above_paper_target` | `above_paper_target` | `partially_matched_tables_3_6` |
| `3` | `-` | `-` | `-` | `HGBM` | `LGBM` | `LGBM` | `above_paper_target` | `above_paper_target` | `not_yet_matched_tables_3_6` |
| `39` | `-` | `-` | `-` | `HGBM` | `LGBM` | `LGBM` | `met_paper_target` | `above_paper_target` | `partially_matched_tables_3_6` |
| `40` | `-` | `-` | `-` | `GBM` | `LGBM` | `LGBM` | `above_paper_target` | `above_paper_target` | `not_yet_matched_tables_3_6` |
| `78` | `-` | `-` | `-` | `RF` | `LGBM` | `LGBM` | `met_paper_target` | `met_paper_target` | `partially_matched_tables_3_6` |
| `81` | `-` | `-` | `-` | `RF` | `LGBM` | `LGBM` | `met_paper_target` | `met_paper_target` | `partially_matched_tables_3_6` |
| `156` | `-` | `-` | `-` | `RF` | `LGBM` | `LGBM` | `above_paper_target` | `met_paper_target` | `partially_matched_tables_3_6` |
| `162` | `-` | `-` | `-` | `ERT` | `LGBM` | `LGBM` | `above_paper_target` | `above_paper_target` | `not_yet_matched_tables_3_6` |
| `240` | `-` | `-` | `-` | `ERT` | `LGBM` | `LGBM` | `above_paper_target` | `above_paper_target` | `not_yet_matched_tables_3_6` |

## ONNX Export Surface

- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/full_matrix/lgbm/2026-04-18-16-01-38__track1_lgbm_phase_full_matrix_campaign_run/onnx_export`;
