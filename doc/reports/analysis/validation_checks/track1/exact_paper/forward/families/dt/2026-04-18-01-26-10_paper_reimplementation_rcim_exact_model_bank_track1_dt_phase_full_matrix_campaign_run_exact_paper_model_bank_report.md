...
- run name: `track1_dt_phase_full_matrix`;
- output run name: `track1_dt_phase_full_matrix_campaign_run`;
- run instance id: `2026-04-18-01-26-00__track1_dt_phase_full_matrix_campaign_run`;
...
- winning best params: `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 6}`;
- winning mean component MAPE: `51.518%`;
- winning mean component MAE: `0.140939`;
- winning mean component RMSE: `0.378820`;
...
| --- | --- | ---: | ---: | --- |
| `DT` | `paper_reference_grid_search` | 5 | 0.735922 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 6}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `DT` | `DecisionTreeRegressor` | `paper_reference_grid_search` | 51.518 | 0.140939 | 0.378820 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_1` | `DT` | `DecisionTreeRegressor` | 32.792 | 0.002239 | 0.003115 |
| `fft_y_Fw_filtered_phase_3` | `DT` | `DecisionTreeRegressor` | 1.517 | 0.027340 | 0.039113 |
| `fft_y_Fw_filtered_phase_39` | `DT` | `DecisionTreeRegressor` | 2.469 | 0.032261 | 0.060054 |
| `fft_y_Fw_filtered_phase_40` | `DT` | `DecisionTreeRegressor` | 77.293 | 0.045456 | 0.070673 |
| `fft_y_Fw_filtered_phase_78` | `DT` | `DecisionTreeRegressor` | 260.140 | 0.074490 | 0.151314 |
| `fft_y_Fw_filtered_phase_81` | `DT` | `DecisionTreeRegressor` | 5.894 | 0.063620 | 0.095694 |
| `fft_y_Fw_filtered_phase_156` | `DT` | `DecisionTreeRegressor` | 46.791 | 0.490408 | 1.225799 |
| `fft_y_Fw_filtered_phase_162` | `DT` | `DecisionTreeRegressor` | 11.606 | 0.245312 | 0.891606 |
| `fft_y_Fw_filtered_phase_240` | `DT` | `DecisionTreeRegressor` | 25.164 | 0.287325 | 0.872011 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_1` | `RF / LGBM` | `DT` | 32.792 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_3` | `HGBM` | `DT` | 1.517 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_39` | `HGBM` | `DT` | 2.469 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_40` | `ERT / GBM` | `DT` | 77.293 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_78` | `HGBM / RF` | `DT` | 260.140 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_81` | `RF` | `DT` | 5.894 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_156` | `ERT / RF` | `DT` | 46.791 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_162` | `ERT` | `DT` | 11.606 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_phase_240` | `ERT` | `DT` | 25.164 | `not_matched_expected_family_direction` |
...
| `Repo Best Family` | `DT` | `DT` | `DT` | `DT` | `DT` | `DT` | `DT` | `DT` | `DT` |
| `Repo Best MAE` | 0.002239 | 0.0273 | 0.0323 | 0.0455 | 0.0745 | 0.0636 | 0.4904 | 0.2453 | 0.2873 |
...
| `Gap Vs Paper` | 4.39e-04 | 0.007340 | 0.0113 | 0.009456 | 4.90e-04 | 0.0106 | -0.0196 | 0.0453 | 0.0573 |
...
| `Repo Best Family` | `DT` | `DT` | `DT` | `DT` | `DT` | `DT` | `DT` | `DT` | `DT` |
| `Repo Best RMSE` | 0.003115 | 0.0391 | 0.0601 | 0.0707 | 0.1513 | 0.0957 | 1.226 | 0.8916 | 0.8720 |
...
| `Gap Vs Paper` | 6.15e-04 | 0.0101 | 0.0331 | 0.0157 | -0.008686 | 0.0137 | 0.0258 | 0.2516 | 0.2920 |
| `Status` | `above_paper_target` | `above_paper_target` | `above_paper_target` | `above_paper_target` | `met_paper_target` | `above_paper_target` | `above_paper_target` | `above_paper_target` | `above_paper_target` |
...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `1` | `-` | `-` | `-` | `LGBM` | `DT` | `DT` | `above_paper_target` | `above_paper_target` | `not_yet_matched_tables_3_6` |
| `3` | `-` | `-` | `-` | `HGBM` | `DT` | `DT` | `above_paper_target` | `above_paper_target` | `not_yet_matched_tables_3_6` |
| `39` | `-` | `-` | `-` | `HGBM` | `DT` | `DT` | `above_paper_target` | `above_paper_target` | `not_yet_matched_tables_3_6` |
| `40` | `-` | `-` | `-` | `GBM` | `DT` | `DT` | `above_paper_target` | `above_paper_target` | `not_yet_matched_tables_3_6` |
| `78` | `-` | `-` | `-` | `RF` | `DT` | `DT` | `above_paper_target` | `met_paper_target` | `partially_matched_tables_3_6` |
| `81` | `-` | `-` | `-` | `RF` | `DT` | `DT` | `above_paper_target` | `above_paper_target` | `not_yet_matched_tables_3_6` |
| `156` | `-` | `-` | `-` | `RF` | `DT` | `DT` | `met_paper_target` | `above_paper_target` | `partially_matched_tables_3_6` |
| `162` | `-` | `-` | `-` | `ERT` | `DT` | `DT` | `above_paper_target` | `above_paper_target` | `not_yet_matched_tables_3_6` |
| `240` | `-` | `-` | `-` | `ERT` | `DT` | `DT` | `above_paper_target` | `above_paper_target` | `not_yet_matched_tables_3_6` |

## ONNX Export Surface

- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/full_matrix/dt/2026-04-18-01-26-00__track1_dt_phase_full_matrix_campaign_run/onnx_export`;
