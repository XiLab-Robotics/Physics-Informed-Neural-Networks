...
- run name: `track1_dt_amplitude_3_closure_attempt_03`;
- output run name: `track1_dt_amplitude_3_closure_attempt_03_campaign_run`;
- run instance id: `2026-04-19-03-19-36__track1_dt_amplitude_3_closure_attempt_03_campaign_run`;
...
- winning mean component MAPE: `2.739%`;
...
| --- | --- | ---: | ---: | --- |
| `DT` | `paper_reference_grid_search` | 5 | 0.959319 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 8}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `DT` | `DecisionTreeRegressor` | `paper_reference_grid_search` | 2.739 | 0.000022 | 0.000041 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_3` | `DT` | `DecisionTreeRegressor` | 2.739 | 0.000022 | 0.000041 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_3` | `HGBM` | `DT` | 2.739 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/dt/2026-04-19-03-19-36__track1_dt_amplitude_3_closure_attempt_03_campaign_run/onnx_export`;
