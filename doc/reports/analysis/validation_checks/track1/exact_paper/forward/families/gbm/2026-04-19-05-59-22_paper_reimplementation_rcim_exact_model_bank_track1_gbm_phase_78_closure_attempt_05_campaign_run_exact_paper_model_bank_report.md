...
- run name: `track1_gbm_phase_78_closure_attempt_05`;
- output run name: `track1_gbm_phase_78_closure_attempt_05_campaign_run`;
- run instance id: `2026-04-19-05-59-09__track1_gbm_phase_78_closure_attempt_05_campaign_run`;
...
- winning best params: `{'estimator__criterion': 'squared_error', 'estimator__learning_rate': 0.1, 'estimator__max_depth': 15, 'estimator__min_samples_split': 14, 'estimator__n_estimators': 20}`;
- winning mean component MAPE: `115.755%`;
- winning mean component MAE: `0.079132`;
- winning mean component RMSE: `0.151220`;
...
| --- | --- | ---: | ---: | --- |
| `GBM` | `paper_reference_grid_search` | 5 | 0.807308 | `{'estimator__criterion': 'squared_error', 'estimator__learning_rate': 0.1, 'estimator__max_depth': 15, 'estimator__min_samples_split': 14, 'estimator__n_estimators': 20}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `GBM` | `GradientBoostingRegressor` | `paper_reference_grid_search` | 115.755 | 0.079132 | 0.151220 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_78` | `GBM` | `GradientBoostingRegressor` | 115.755 | 0.079132 | 0.151220 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_78` | `HGBM / RF` | `GBM` | 115.755 | `not_matched_expected_family_direction` |
...
| `Repo Best MAE` | - | - | - | - | 0.0791 | - | - | - | - |
| `Paper Best Family` | - | - | - | - | `GBM` | - | - | - | - |
| `Paper Target MAE` | - | - | - | - | 0.0740 | - | - | - | - |
| `Gap Vs Paper` | - | - | - | - | 0.005132 | - | - | - | - |
...
| `Repo Best Family` | - | - | - | - | `GBM` | - | - | - | - |
| `Repo Best RMSE` | - | - | - | - | 0.1512 | - | - | - | - |
| `Paper Best Family` | - | - | - | - | `RF` | - | - | - | - |
| `Paper Target RMSE` | - | - | - | - | 0.1600 | - | - | - | - |
| `Gap Vs Paper` | - | - | - | - | -0.008780 | - | - | - | - |
...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `78` | `-` | `-` | `-` | `RF` | `GBM` | `GBM` | `above_paper_target` | `met_paper_target` | `partially_matched_tables_3_6` |

## ONNX Export Surface

- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/gbm/2026-04-19-05-59-09__track1_gbm_phase_78_closure_attempt_05_campaign_run/onnx_export`;
