...
- run name: `track1_rf_phase_156_closure_attempt_06`;
- output run name: `track1_rf_phase_156_closure_attempt_06_campaign_run`;
- run instance id: `2026-04-19-02-59-09__track1_rf_phase_156_closure_attempt_06_campaign_run`;
...
- winning mean component MAPE: `72.349%`;
- winning mean component MAE: `0.462401`;
- winning mean component RMSE: `1.069717`;
...
| --- | --- | ---: | ---: | --- |
| `RF` | `paper_reference_grid_search` | 5 | 0.754490 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 15, 'estimator__min_samples_split': 2, 'estimator__n_estimators': 90}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `RF` | `RandomForestRegressor` | `paper_reference_grid_search` | 72.349 | 0.462401 | 1.069717 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_156` | `RF` | `RandomForestRegressor` | 72.349 | 0.462401 | 1.069717 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_156` | `ERT / RF` | `RF` | 72.349 | `matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/rf/2026-04-19-02-59-09__track1_rf_phase_156_closure_attempt_06_campaign_run/onnx_export`;
