...
- run name: `track1_hgbm_amplitude_0_closure_attempt_02`;
- output run name: `track1_hgbm_amplitude_0_closure_attempt_02_campaign_run`;
- run instance id: `2026-04-19-06-19-24__track1_hgbm_amplitude_0_closure_attempt_02_campaign_run`;
...
- winning best params: `{'estimator__learning_rate': 0.21, 'estimator__max_depth': 10, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 26}`;
- winning mean component MAPE: `5.456%`;
- winning mean component MAE: `0.002501`;
- winning mean component RMSE: `0.003126`;
...
| --- | --- | ---: | ---: | --- |
| `HGBM` | `paper_reference_grid_search` | 5 | 0.971575 | `{'estimator__learning_rate': 0.21, 'estimator__max_depth': 10, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 26}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `HGBM` | `HistGradientBoostingRegressor` | `paper_reference_grid_search` | 5.456 | 0.002501 | 0.003126 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_0` | `HGBM` | `HistGradientBoostingRegressor` | 5.456 | 0.002501 | 0.003126 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_0` | `SVR` | `HGBM` | 5.456 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/hgbm/2026-04-19-06-19-24__track1_hgbm_amplitude_0_closure_attempt_02_campaign_run/onnx_export`;
