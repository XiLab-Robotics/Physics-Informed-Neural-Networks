...
- run name: `track1_ert_amplitude_full_matrix`;
- output run name: `track1_ert_amplitude_full_matrix_campaign_run`;
- run instance id: `2026-04-18-01-28-33__track1_ert_amplitude_full_matrix_campaign_run`;
...
- winning best params: `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 5, 'estimator__n_estimators': 80}`;
- winning mean component MAPE: `7.092%`;
- winning mean component MAE: `0.000349`;
- winning mean component RMSE: `0.000478`;
...
| --- | --- | ---: | ---: | --- |
| `ERT` | `paper_reference_grid_search` | 5 | 0.927412 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 5, 'estimator__n_estimators': 80}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ERT` | `ExtraTreesRegressor` | `paper_reference_grid_search` | 7.092 | 0.000349 | 0.000478 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_0` | `ERT` | `ExtraTreesRegressor` | 11.957 | 0.003206 | 0.004149 |
| `fft_y_Fw_filtered_ampl_1` | `ERT` | `ExtraTreesRegressor` | 0.141 | 0.000024 | 0.000034 |
| `fft_y_Fw_filtered_ampl_3` | `ERT` | `ExtraTreesRegressor` | 2.711 | 0.000021 | 0.000032 |
| `fft_y_Fw_filtered_ampl_39` | `ERT` | `ExtraTreesRegressor` | 2.441 | 0.000027 | 0.000038 |
| `fft_y_Fw_filtered_ampl_40` | `ERT` | `ExtraTreesRegressor` | 2.823 | 0.000022 | 0.000033 |
| `fft_y_Fw_filtered_ampl_78` | `ERT` | `ExtraTreesRegressor` | 11.418 | 0.000039 | 0.000056 |
| `fft_y_Fw_filtered_ampl_81` | `ERT` | `ExtraTreesRegressor` | 3.558 | 0.000011 | 0.000019 |
| `fft_y_Fw_filtered_ampl_156` | `ERT` | `ExtraTreesRegressor` | 15.536 | 0.000050 | 0.000185 |
| `fft_y_Fw_filtered_ampl_162` | `ERT` | `ExtraTreesRegressor` | 8.115 | 0.000054 | 0.000174 |
| `fft_y_Fw_filtered_ampl_240` | `ERT` | `ExtraTreesRegressor` | 12.221 | 0.000037 | 0.000064 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_0` | `SVR` | `ERT` | 11.957 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_1` | `RF / LGBM` | `ERT` | 0.141 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_3` | `HGBM` | `ERT` | 2.711 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_39` | `HGBM` | `ERT` | 2.441 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_40` | `ERT / GBM` | `ERT` | 2.823 | `matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_78` | `HGBM / RF` | `ERT` | 11.418 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_81` | `RF` | `ERT` | 3.558 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_156` | `ERT / RF` | `ERT` | 15.536 | `matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_162` | `ERT` | `ERT` | 8.115 | `matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_240` | `ERT` | `ERT` | 12.221 | `matched_expected_family_direction` |
...
| ---: | --- | --- | --- | ---: | --- |
| `0` | `SVR` | `ERT` | `-` | 0/1 | `no_family_direction_match` |
| `1` | `RF / LGBM` | `ERT` | `-` | 0/1 | `no_family_direction_match` |
| `3` | `HGBM` | `ERT` | `-` | 0/1 | `no_family_direction_match` |
| `39` | `HGBM` | `ERT` | `-` | 0/1 | `no_family_direction_match` |
| `40` | `ERT / GBM` | `ERT` | `-` | 1/1 | `full_family_direction_match` |
| `78` | `HGBM / RF` | `ERT` | `-` | 0/1 | `no_family_direction_match` |
| `81` | `RF` | `ERT` | `-` | 0/1 | `no_family_direction_match` |
| `156` | `ERT / RF` | `ERT` | `-` | 1/1 | `full_family_direction_match` |
| `162` | `ERT` | `ERT` | `-` | 1/1 | `full_family_direction_match` |
| `240` | `ERT` | `ERT` | `-` | 1/1 | `full_family_direction_match` |
...
| `Repo Best Family` | `ERT` | `ERT` | `ERT` | `ERT` | `ERT` | `ERT` | `ERT` | `ERT` | `ERT` | `ERT` |
| `Repo Best RMSE` | 0.004149 | 3.44e-05 | 3.17e-05 | 3.83e-05 | 3.27e-05 | 5.57e-05 | 1.90e-05 | 1.85e-04 | 1.74e-04 | 6.39e-05 |
...
| `Gap Vs Paper` | 8.49e-04 | -5.54e-07 | 6.73e-06 | 6.29e-06 | -3.34e-06 | 1.07e-05 | 3.96e-06 | 5.50e-05 | 1.44e-05 | 2.19e-05 |
| `Status` | `above_paper_target` | `met_paper_target` | `above_paper_target` | `above_paper_target` | `met_paper_target` | `above_paper_target` | `above_paper_target` | `above_paper_target` | `above_paper_target` | `above_paper_target` |
...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `0` | `SVM` | `ERT` | `above_paper_target` | `-` | `-` | `-` | `-` | `-` | `not_yet_matched_tables_3_6` |
| `1` | `RF` | `ERT` | `met_paper_target` | `-` | `-` | `-` | `-` | `-` | `partially_matched_tables_3_6` |
| `3` | `HGBM` | `ERT` | `above_paper_target` | `-` | `-` | `-` | `-` | `-` | `not_yet_matched_tables_3_6` |
| `39` | `HGBM` | `ERT` | `above_paper_target` | `-` | `-` | `-` | `-` | `-` | `not_yet_matched_tables_3_6` |
| `40` | `ERT` | `ERT` | `met_paper_target` | `-` | `-` | `-` | `-` | `-` | `fully_matched_tables_3_6` |
| `78` | `HGBM` | `ERT` | `above_paper_target` | `-` | `-` | `-` | `-` | `-` | `not_yet_matched_tables_3_6` |
| `81` | `RF` | `ERT` | `above_paper_target` | `-` | `-` | `-` | `-` | `-` | `not_yet_matched_tables_3_6` |
| `156` | `ERT` | `ERT` | `above_paper_target` | `-` | `-` | `-` | `-` | `-` | `partially_matched_tables_3_6` |
| `162` | `ERT` | `ERT` | `above_paper_target` | `-` | `-` | `-` | `-` | `-` | `partially_matched_tables_3_6` |
| `240` | `ERT` | `ERT` | `above_paper_target` | `-` | `-` | `-` | `-` | `-` | `partially_matched_tables_3_6` |

## ONNX Export Surface

- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/full_matrix/ert/2026-04-18-01-28-33__track1_ert_amplitude_full_matrix_campaign_run/onnx_export`;
