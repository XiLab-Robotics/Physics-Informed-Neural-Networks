...
- run name: `track1_ert_phase_162_closure_attempt_03`;
- output run name: `track1_ert_phase_162_closure_attempt_03_campaign_run`;
- run instance id: `2026-04-21-11-04-52__track1_ert_phase_162_closure_attempt_03_campaign_run`;
...
- winning mean component MAPE: `10.505%`;
- winning mean component MAE: `0.253454`;
- winning mean component RMSE: `0.825983`;
...
| --- | --- | ---: | ---: | --- |
| `ERT` | `paper_reference_grid_search` | 5 | 0.775443 | `{'estimator__criterion': 'absolute_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 2, 'estimator__n_estimators': 80}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ERT` | `ExtraTreesRegressor` | `paper_reference_grid_search` | 10.505 | 0.253454 | 0.825983 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_162` | `ERT` | `ExtraTreesRegressor` | 10.505 | 0.253454 | 0.825983 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_162` | `ERT` | `ERT` | 10.505 | `matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/ert/2026-04-21-11-04-52__track1_ert_phase_162_closure_attempt_03_campaign_run/onnx_export`;
