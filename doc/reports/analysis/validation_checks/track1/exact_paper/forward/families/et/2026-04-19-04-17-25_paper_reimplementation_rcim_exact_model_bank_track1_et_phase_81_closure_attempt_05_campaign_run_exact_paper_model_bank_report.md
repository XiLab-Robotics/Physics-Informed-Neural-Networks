...
- run name: `track1_et_phase_81_closure_attempt_05`;
- output run name: `track1_et_phase_81_closure_attempt_05_campaign_run`;
- run instance id: `2026-04-19-04-17-18__track1_et_phase_81_closure_attempt_05_campaign_run`;
...
- winning mean component MAPE: `5.394%`;
- winning mean component MAE: `0.061893`;
- winning mean component RMSE: `0.079252`;
...
| --- | --- | ---: | ---: | --- |
| `ET` | `paper_reference_grid_search` | 5 | 0.936805 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 4}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ET` | `ExtraTreeRegressor` | `paper_reference_grid_search` | 5.394 | 0.061893 | 0.079252 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_81` | `ET` | `ExtraTreeRegressor` | 5.394 | 0.061893 | 0.079252 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_81` | `RF` | `ET` | 5.394 | `not_matched_expected_family_direction` |
...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `81` | `-` | `-` | `-` | `RF` | `ET` | `ET` | `above_paper_target` | `met_paper_target` | `partially_matched_tables_3_6` |

## ONNX Export Surface

- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/et/2026-04-19-04-17-18__track1_et_phase_81_closure_attempt_05_campaign_run/onnx_export`;
