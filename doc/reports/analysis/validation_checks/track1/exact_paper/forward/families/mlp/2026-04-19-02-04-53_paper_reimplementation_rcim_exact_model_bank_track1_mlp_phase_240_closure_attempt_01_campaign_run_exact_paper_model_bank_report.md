...
- run name: `track1_mlp_phase_240_closure_attempt_01`;
- output run name: `track1_mlp_phase_240_closure_attempt_01_campaign_run`;
- run instance id: `2026-04-19-02-04-43__track1_mlp_phase_240_closure_attempt_01_campaign_run`;
...
- winning mean component MAPE: `65.190%`;
- winning mean component MAE: `0.755923`;
- winning mean component RMSE: `1.251619`;
...
| --- | --- | ---: | ---: | --- |
| `MLP` | `paper_reference_grid_search` | 5 | 0.071880 | `{'estimator__activation': 'tanh', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (200, 50), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `MLP` | `MLPRegressor` | `paper_reference_grid_search` | 65.190 | 0.755923 | 1.251619 |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/mlp/2026-04-19-02-04-43__track1_mlp_phase_240_closure_attempt_01_campaign_run/onnx_export`;
