...
- run name: `track1_dt_amplitude_full_matrix`;
- output run name: `track1_dt_amplitude_full_matrix_campaign_run`;
- run instance id: `2026-04-18-01-25-44__track1_dt_amplitude_full_matrix_campaign_run`;
...
- winning best params: `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 7}`;
- winning mean component MAPE: `8.610%`;
- winning mean component MAE: `0.000392`;
- winning mean component RMSE: `0.000572`;
...
| --- | --- | ---: | ---: | --- |
| `DT` | `paper_reference_grid_search` | 5 | 0.890342 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 14, 'estimator__min_samples_split': 7}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `DT` | `DecisionTreeRegressor` | `paper_reference_grid_search` | 8.610 | 0.000392 | 0.000572 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_0` | `DT` | `DecisionTreeRegressor` | 14.794 | 0.003520 | 0.004880 |
| `fft_y_Fw_filtered_ampl_1` | `DT` | `DecisionTreeRegressor` | 0.175 | 0.000030 | 0.000042 |
| `fft_y_Fw_filtered_ampl_3` | `DT` | `DecisionTreeRegressor` | 2.825 | 0.000023 | 0.000033 |
| `fft_y_Fw_filtered_ampl_39` | `DT` | `DecisionTreeRegressor` | 3.437 | 0.000038 | 0.000052 |
| `fft_y_Fw_filtered_ampl_40` | `DT` | `DecisionTreeRegressor` | 3.621 | 0.000029 | 0.000041 |
| `fft_y_Fw_filtered_ampl_78` | `DT` | `DecisionTreeRegressor` | 14.227 | 0.000057 | 0.000082 |
| `fft_y_Fw_filtered_ampl_81` | `DT` | `DecisionTreeRegressor` | 4.799 | 0.000015 | 0.000023 |
| `fft_y_Fw_filtered_ampl_156` | `DT` | `DecisionTreeRegressor` | 19.145 | 0.000084 | 0.000284 |
| `fft_y_Fw_filtered_ampl_162` | `DT` | `DecisionTreeRegressor` | 10.233 | 0.000073 | 0.000211 |
| `fft_y_Fw_filtered_ampl_240` | `DT` | `DecisionTreeRegressor` | 12.843 | 0.000045 | 0.000069 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_0` | `SVR` | `DT` | 14.794 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_1` | `RF / LGBM` | `DT` | 0.175 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_3` | `HGBM` | `DT` | 2.825 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_39` | `HGBM` | `DT` | 3.437 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_40` | `ERT / GBM` | `DT` | 3.621 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_78` | `HGBM / RF` | `DT` | 14.227 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_81` | `RF` | `DT` | 4.799 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_156` | `ERT / RF` | `DT` | 19.145 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_162` | `ERT` | `DT` | 10.233 | `not_matched_expected_family_direction` |
| `fft_y_Fw_filtered_ampl_240` | `ERT` | `DT` | 12.843 | `not_matched_expected_family_direction` |
...
| ---: | --- | --- | --- | ---: | --- |
| `0` | `SVR` | `DT` | `-` | 0/1 | `no_family_direction_match` |
| `1` | `RF / LGBM` | `DT` | `-` | 0/1 | `no_family_direction_match` |
| `3` | `HGBM` | `DT` | `-` | 0/1 | `no_family_direction_match` |
| `39` | `HGBM` | `DT` | `-` | 0/1 | `no_family_direction_match` |
| `40` | `ERT / GBM` | `DT` | `-` | 0/1 | `no_family_direction_match` |
| `78` | `HGBM / RF` | `DT` | `-` | 0/1 | `no_family_direction_match` |
| `81` | `RF` | `DT` | `-` | 0/1 | `no_family_direction_match` |
| `156` | `ERT / RF` | `DT` | `-` | 0/1 | `no_family_direction_match` |
| `162` | `ERT` | `DT` | `-` | 0/1 | `no_family_direction_match` |
| `240` | `ERT` | `DT` | `-` | 0/1 | `no_family_direction_match` |
...
| `Repo Best Family` | `DT` | `DT` | `DT` | `DT` | `DT` | `DT` | `DT` | `DT` | `DT` | `DT` |
| `Repo Best RMSE` | 0.004880 | 4.19e-05 | 3.34e-05 | 5.24e-05 | 4.07e-05 | 8.23e-05 | 2.34e-05 | 2.84e-04 | 2.11e-04 | 6.86e-05 |
...
| `Gap Vs Paper` | 0.001580 | 6.86e-06 | 8.39e-06 | 2.04e-05 | 4.69e-06 | 3.73e-05 | 8.44e-06 | 1.54e-04 | 5.12e-05 | 2.66e-05 |
...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `0` | `SVM` | `DT` | `above_paper_target` | `-` | `-` | `-` | `-` | `-` | `not_yet_matched_tables_3_6` |
| `1` | `RF` | `DT` | `above_paper_target` | `-` | `-` | `-` | `-` | `-` | `not_yet_matched_tables_3_6` |
| `3` | `HGBM` | `DT` | `above_paper_target` | `-` | `-` | `-` | `-` | `-` | `not_yet_matched_tables_3_6` |
| `39` | `HGBM` | `DT` | `above_paper_target` | `-` | `-` | `-` | `-` | `-` | `not_yet_matched_tables_3_6` |
| `40` | `ERT` | `DT` | `above_paper_target` | `-` | `-` | `-` | `-` | `-` | `not_yet_matched_tables_3_6` |
| `78` | `HGBM` | `DT` | `above_paper_target` | `-` | `-` | `-` | `-` | `-` | `not_yet_matched_tables_3_6` |
| `81` | `RF` | `DT` | `above_paper_target` | `-` | `-` | `-` | `-` | `-` | `not_yet_matched_tables_3_6` |
| `156` | `ERT` | `DT` | `above_paper_target` | `-` | `-` | `-` | `-` | `-` | `not_yet_matched_tables_3_6` |
| `162` | `ERT` | `DT` | `above_paper_target` | `-` | `-` | `-` | `-` | `-` | `not_yet_matched_tables_3_6` |
| `240` | `ERT` | `DT` | `above_paper_target` | `-` | `-` | `-` | `-` | `-` | `not_yet_matched_tables_3_6` |

## ONNX Export Surface

- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/full_matrix/dt/2026-04-18-01-25-44__track1_dt_amplitude_full_matrix_campaign_run/onnx_export`;
