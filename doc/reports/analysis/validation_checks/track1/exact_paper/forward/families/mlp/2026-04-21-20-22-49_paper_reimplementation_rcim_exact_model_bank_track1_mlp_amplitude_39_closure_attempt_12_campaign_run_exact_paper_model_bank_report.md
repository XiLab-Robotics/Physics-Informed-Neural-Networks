...
- run name: `track1_mlp_amplitude_39_closure_attempt_12`;
- output run name: `track1_mlp_amplitude_39_closure_attempt_12_campaign_run`;
- run instance id: `2026-04-21-20-22-39__track1_mlp_amplitude_39_closure_attempt_12_campaign_run`;
...
- winning mean component MAPE: `825.573%`;
- winning mean component MAE: `0.007904`;
- winning mean component RMSE: `0.013558`;
...
| --- | --- | ---: | ---: | --- |
| `MLP` | `paper_reference_grid_search` | 5 | -5759.223453 | `{'estimator__activation': 'tanh', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (200, 50), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `MLP` | `MLPRegressor` | `paper_reference_grid_search` | 825.573 | 0.007904 | 0.013558 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_39` | `MLP` | `MLPRegressor` | 825.573 | 0.007904 | 0.013558 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_39` | `HGBM` | `MLP` | 825.573 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/mlp/2026-04-21-20-22-39__track1_mlp_amplitude_39_closure_attempt_12_campaign_run/onnx_export`;
