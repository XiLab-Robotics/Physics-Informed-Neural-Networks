...
- run name: `track1_xgbm_amplitude_3_closure_attempt_06`;
- output run name: `track1_xgbm_amplitude_3_closure_attempt_06_campaign_run`;
- run instance id: `2026-04-19-07-11-29__track1_xgbm_amplitude_3_closure_attempt_06_campaign_run`;
...
- winning mean component MAPE: `9.331%`;
...
| --- | --- | ---: | ---: | --- |
| `XGBM` | `paper_reference_grid_search` | 5 | 0.565567 | `{'estimator__colsample_bytree': 0.3, 'estimator__learning_rate': 0.5, 'estimator__max_depth': 14}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `XGBM` | `XGBRegressor` | `paper_reference_grid_search` | 9.331 | 0.000070 | 0.000087 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_3` | `XGBM` | `XGBRegressor` | 9.331 | 0.000070 | 0.000087 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_3` | `HGBM` | `XGBM` | 9.331 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/xgbm/2026-04-19-07-11-29__track1_xgbm_amplitude_3_closure_attempt_06_campaign_run/onnx_export`;
