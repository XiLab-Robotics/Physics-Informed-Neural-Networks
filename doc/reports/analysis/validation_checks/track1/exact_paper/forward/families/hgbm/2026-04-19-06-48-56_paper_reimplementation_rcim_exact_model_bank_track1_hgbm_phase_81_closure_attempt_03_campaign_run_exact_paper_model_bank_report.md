...
- run name: `track1_hgbm_phase_81_closure_attempt_03`;
- output run name: `track1_hgbm_phase_81_closure_attempt_03_campaign_run`;
- run instance id: `2026-04-19-06-48-43__track1_hgbm_phase_81_closure_attempt_03_campaign_run`;
...
- winning mean component MAPE: `5.059%`;
- winning mean component MAE: `0.052026`;
- winning mean component RMSE: `0.072608`;
...
| --- | --- | ---: | ---: | --- |
| `HGBM` | `paper_reference_grid_search` | 5 | 0.964874 | `{'estimator__learning_rate': 0.21, 'estimator__max_depth': 12, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 26}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `HGBM` | `HistGradientBoostingRegressor` | `paper_reference_grid_search` | 5.059 | 0.052026 | 0.072608 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_81` | `HGBM` | `HistGradientBoostingRegressor` | 5.059 | 0.052026 | 0.072608 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_81` | `RF` | `HGBM` | 5.059 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/hgbm/2026-04-19-06-48-43__track1_hgbm_phase_81_closure_attempt_03_campaign_run/onnx_export`;
