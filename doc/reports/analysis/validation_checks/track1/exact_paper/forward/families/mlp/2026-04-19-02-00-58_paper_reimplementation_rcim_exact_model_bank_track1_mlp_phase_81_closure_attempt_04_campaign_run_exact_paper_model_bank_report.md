...
- run name: `track1_mlp_phase_81_closure_attempt_04`;
- output run name: `track1_mlp_phase_81_closure_attempt_04_campaign_run`;
- run instance id: `2026-04-19-02-00-49__track1_mlp_phase_81_closure_attempt_04_campaign_run`;
...
- winning mean component MAPE: `11.347%`;
- winning mean component MAE: `0.135344`;
- winning mean component RMSE: `0.181880`;
...
| --- | --- | ---: | ---: | --- |
| `MLP` | `paper_reference_grid_search` | 5 | 0.744040 | `{'estimator__activation': 'tanh', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (200, 50), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `MLP` | `MLPRegressor` | `paper_reference_grid_search` | 11.347 | 0.135344 | 0.181880 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_81` | `MLP` | `MLPRegressor` | 11.347 | 0.135344 | 0.181880 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_81` | `RF` | `MLP` | 11.347 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/mlp/2026-04-19-02-00-49__track1_mlp_phase_81_closure_attempt_04_campaign_run/onnx_export`;
