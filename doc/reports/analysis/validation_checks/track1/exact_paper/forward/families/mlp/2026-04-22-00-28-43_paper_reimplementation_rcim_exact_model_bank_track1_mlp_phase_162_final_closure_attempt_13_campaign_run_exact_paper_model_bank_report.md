...
- run name: `track1_mlp_phase_162_final_closure_attempt_13`;
- output run name: `track1_mlp_phase_162_final_closure_attempt_13_campaign_run`;
- run instance id: `2026-04-22-00-28-34__track1_mlp_phase_162_final_closure_attempt_13_campaign_run`;
...
- winning mean component MAPE: `59.913%`;
- winning mean component MAE: `1.289719`;
- winning mean component RMSE: `1.773608`;
...
| --- | --- | ---: | ---: | --- |
| `MLP` | `paper_reference_grid_search` | 5 | 0.167969 | `{'estimator__activation': 'relu', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (100,), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `MLP` | `MLPRegressor` | `paper_reference_grid_search` | 59.913 | 1.289719 | 1.773608 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_162` | `MLP` | `MLPRegressor` | 59.913 | 1.289719 | 1.773608 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_162` | `ERT` | `MLP` | 59.913 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/mlp/2026-04-22-00-28-34__track1_mlp_phase_162_final_closure_attempt_13_campaign_run/onnx_export`;
