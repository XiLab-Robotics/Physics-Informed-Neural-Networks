...
- run name: `track1_lgbm_amplitude_78_closure_attempt_04`;
- output run name: `track1_lgbm_amplitude_78_closure_attempt_04_campaign_run`;
- run instance id: `2026-04-19-08-37-08__track1_lgbm_amplitude_78_closure_attempt_04_campaign_run`;
...
- winning mean component MAPE: `8.917%`;
...
| --- | --- | ---: | ---: | --- |
| `LGBM` | `paper_reference_grid_search` | 5 | 0.995609 | `{'estimator__learning_rate': 0.58, 'estimator__max_depth': 10, 'estimator__num_leaves': 8, 'estimator__subsample': 0.001}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `LGBM` | `LGBMRegressor` | `paper_reference_grid_search` | 8.917 | 0.000027 | 0.000039 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_78` | `LGBM` | `LGBMRegressor` | 8.917 | 0.000027 | 0.000039 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_78` | `HGBM / RF` | `LGBM` | 8.917 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/lgbm/2026-04-19-08-37-08__track1_lgbm_amplitude_78_closure_attempt_04_campaign_run/onnx_export`;
