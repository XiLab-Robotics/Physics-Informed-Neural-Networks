...
- run name: `track1_dt_amplitude_81_closure_attempt_04`;
- output run name: `track1_dt_amplitude_81_closure_attempt_04_campaign_run`;
- run instance id: `2026-04-19-03-25-34__track1_dt_amplitude_81_closure_attempt_04_campaign_run`;
...
- winning best params: `{'estimator__criterion': 'absolute_error', 'estimator__max_depth': 16, 'estimator__min_samples_split': 6}`;
- winning mean component MAPE: `4.476%`;
...
| --- | --- | ---: | ---: | --- |
| `DT` | `paper_reference_grid_search` | 5 | 0.897390 | `{'estimator__criterion': 'absolute_error', 'estimator__max_depth': 16, 'estimator__min_samples_split': 6}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `DT` | `DecisionTreeRegressor` | `paper_reference_grid_search` | 4.476 | 0.000013 | 0.000018 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_81` | `DT` | `DecisionTreeRegressor` | 4.476 | 0.000013 | 0.000018 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_81` | `RF` | `DT` | 4.476 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/dt/2026-04-19-03-25-34__track1_dt_amplitude_81_closure_attempt_04_campaign_run/onnx_export`;
