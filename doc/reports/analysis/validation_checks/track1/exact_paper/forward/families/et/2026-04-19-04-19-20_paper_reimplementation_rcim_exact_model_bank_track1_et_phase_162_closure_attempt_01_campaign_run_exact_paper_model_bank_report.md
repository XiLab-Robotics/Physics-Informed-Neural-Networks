...
- run name: `track1_et_phase_162_closure_attempt_01`;
- output run name: `track1_et_phase_162_closure_attempt_01_campaign_run`;
- run instance id: `2026-04-19-04-19-12__track1_et_phase_162_closure_attempt_01_campaign_run`;
...
- winning mean component MAPE: `16.183%`;
- winning mean component MAE: `0.313559`;
- winning mean component RMSE: `0.930680`;
...
| --- | --- | ---: | ---: | --- |
| `ET` | `paper_reference_grid_search` | 5 | 0.605903 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 15, 'estimator__min_samples_split': 5}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ET` | `ExtraTreeRegressor` | `paper_reference_grid_search` | 16.183 | 0.313559 | 0.930680 |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/et/2026-04-19-04-19-12__track1_et_phase_162_closure_attempt_01_campaign_run/onnx_export`;
