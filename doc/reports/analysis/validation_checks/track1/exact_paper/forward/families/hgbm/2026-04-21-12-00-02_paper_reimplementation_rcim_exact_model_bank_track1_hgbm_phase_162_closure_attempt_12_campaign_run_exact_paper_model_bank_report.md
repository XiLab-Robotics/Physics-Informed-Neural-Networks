...
- run name: `track1_hgbm_phase_162_closure_attempt_12`;
- output run name: `track1_hgbm_phase_162_closure_attempt_12_campaign_run`;
- run instance id: `2026-04-21-11-59-49__track1_hgbm_phase_162_closure_attempt_12_campaign_run`;
...
- winning mean component MAPE: `13.828%`;
- winning mean component MAE: `0.294777`;
- winning mean component RMSE: `0.697774`;
...
| --- | --- | ---: | ---: | --- |
| `HGBM` | `paper_reference_grid_search` | 5 | 0.699022 | `{'estimator__learning_rate': 0.2, 'estimator__max_depth': 13, 'estimator__max_iter': 100, 'estimator__max_leaf_nodes': 26}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `HGBM` | `HistGradientBoostingRegressor` | `paper_reference_grid_search` | 13.828 | 0.294777 | 0.697774 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_162` | `HGBM` | `HistGradientBoostingRegressor` | 13.828 | 0.294777 | 0.697774 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_162` | `ERT` | `HGBM` | 13.828 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/hgbm/2026-04-21-11-59-49__track1_hgbm_phase_162_closure_attempt_12_campaign_run/onnx_export`;
