...
- run name: `track1_dt_phase_162_closure_attempt_15`;
- output run name: `track1_dt_phase_162_closure_attempt_15_campaign_run`;
- run instance id: `2026-04-21-10-12-02__track1_dt_phase_162_closure_attempt_15_campaign_run`;
...
- winning best params: `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 17, 'estimator__min_samples_split': 8}`;
- winning mean component MAPE: `12.479%`;
- winning mean component MAE: `0.271403`;
- winning mean component RMSE: `0.887341`;
...
| --- | --- | ---: | ---: | --- |
| `DT` | `paper_reference_grid_search` | 5 | 0.612238 | `{'estimator__criterion': 'squared_error', 'estimator__max_depth': 17, 'estimator__min_samples_split': 8}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `DT` | `DecisionTreeRegressor` | `paper_reference_grid_search` | 12.479 | 0.271403 | 0.887341 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_162` | `DT` | `DecisionTreeRegressor` | 12.479 | 0.271403 | 0.887341 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_162` | `ERT` | `DT` | 12.479 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/dt/2026-04-21-10-12-02__track1_dt_phase_162_closure_attempt_15_campaign_run/onnx_export`;
