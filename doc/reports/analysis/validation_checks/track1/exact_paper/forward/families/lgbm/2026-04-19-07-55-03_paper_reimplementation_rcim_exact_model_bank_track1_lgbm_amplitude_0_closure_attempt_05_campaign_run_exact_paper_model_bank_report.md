...
- run name: `track1_lgbm_amplitude_0_closure_attempt_05`;
- output run name: `track1_lgbm_amplitude_0_closure_attempt_05_campaign_run`;
- run instance id: `2026-04-19-07-53-38__track1_lgbm_amplitude_0_closure_attempt_05_campaign_run`;
...
- winning mean component MAPE: `5.435%`;
- winning mean component MAE: `0.002462`;
- winning mean component RMSE: `0.003180`;
...
| --- | --- | ---: | ---: | --- |
| `LGBM` | `paper_reference_grid_search` | 5 | 0.975270 | `{'estimator__learning_rate': 0.2, 'estimator__max_depth': 10, 'estimator__num_leaves': 10, 'estimator__subsample': 0.001}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `LGBM` | `LGBMRegressor` | `paper_reference_grid_search` | 5.435 | 0.002462 | 0.003180 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_ampl_0` | `LGBM` | `LGBMRegressor` | 5.435 | 0.002462 | 0.003180 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_ampl_0` | `SVR` | `LGBM` | 5.435 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/lgbm/2026-04-19-07-53-38__track1_lgbm_amplitude_0_closure_attempt_05_campaign_run/onnx_export`;
