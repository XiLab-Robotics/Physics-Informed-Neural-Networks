...
- run name: `track1_mlp_phase_40_closure_attempt_02`;
- output run name: `track1_mlp_phase_40_closure_attempt_02_campaign_run`;
- run instance id: `2026-04-19-01-57-04__track1_mlp_phase_40_closure_attempt_02_campaign_run`;
...
- winning mean component MAPE: `237.510%`;
- winning mean component MAE: `0.073000`;
- winning mean component RMSE: `0.099614`;
...
| --- | --- | ---: | ---: | --- |
| `MLP` | `paper_reference_grid_search` | 5 | 0.207112 | `{'estimator__activation': 'tanh', 'estimator__early_stopping': True, 'estimator__hidden_layer_sizes': (200, 50), 'estimator__learning_rate': 'adaptive', 'estimator__solver': 'adam'}` |

## Family Ranking

| Rank | Family | Estimator | Search Mode | Mean Component MAPE [%] | Mean Component MAE | Mean Component RMSE |
| ---: | --- | --- | --- | ---: | ---: | ---: |
| 1 | `MLP` | `MLPRegressor` | `paper_reference_grid_search` | 237.510 | 0.073000 | 0.099614 |

## Target-Winner Registry

| Target | Winning Family | Estimator | MAPE [%] | MAE | RMSE |
| --- | --- | --- | ---: | ---: | ---: |
| `fft_y_Fw_filtered_phase_40` | `MLP` | `MLPRegressor` | 237.510 | 0.073000 | 0.099614 |
...
| --- | --- | --- | ---: | --- |
| `fft_y_Fw_filtered_phase_40` | `ERT / GBM` | `MLP` | 237.510 | `not_matched_expected_family_direction` |
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/residual_cellwise_closure/mlp/2026-04-19-01-57-04__track1_mlp_phase_40_closure_attempt_02_campaign_run/onnx_export`;
