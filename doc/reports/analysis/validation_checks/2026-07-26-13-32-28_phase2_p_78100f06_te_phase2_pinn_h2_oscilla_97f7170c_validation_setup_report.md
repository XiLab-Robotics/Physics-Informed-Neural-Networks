...
- run instance id: `2026-07-26-13-32-25__te_phase2_pinn_h2_oscillator_periodic_closure_bw__polished_setpoints_validation_check`;
...
| Output Directory | `output/validation_checks/phase2_pinn_h2_oscillator_periodic_closure_bw/2026-07-26-13-32-25__te_phase2_pinn_h2_oscillator_periodic_closure_bw__polished_setpoints_validation_check` |
| Model Family | `phase2_pinn_h2_oscillator_periodic_closure_bw` |
| Model Type | `harmonic_kinematic_pinn` |
