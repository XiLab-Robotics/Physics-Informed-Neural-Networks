...
- run instance id: `2026-07-26-13-16-12__te_phase2_pinn_h1_oscillator_residual_bw__polished_setpoints_validation_check`;
...
| Output Directory | `output/validation_checks/phase2_pinn_h1_oscillator_residual_bw/2026-07-26-13-16-12__te_phase2_pinn_h1_oscillator_residual_bw__polished_setpoints_validation_check` |
| Model Family | `phase2_pinn_h1_oscillator_residual_bw` |
| Model Type | `harmonic_kinematic_pinn` |
