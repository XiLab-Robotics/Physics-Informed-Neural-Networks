...
- output run name: `te_track2f_bis_harmonic_residual_offset_global_track2f_bis_failed_queue_harmonic_global_validation`;
- run instance id: `2026-06-05-16-06-33__te_track2f_bis_harmonic_residual_offset_global_track2f_bis_failed_queue_harmonic_global_validation`;
...
| Field | Value |
| --- | --- |
| Config Path | `config/training/queue/failed/2026-06-04-23-31-57_004_04_harmonic_residual_offset_probe_global.yaml` |
| Output Directory | `output/validation_checks/track2f_bis_harmonic_residual_offset_global/2026-06-05-16-06-33__te_track2f_bis_harmonic_residual_offset_global_track2f_bis_failed_queue_harmonic_global_validation` |
| Model Family | `track2f_bis_harmonic_residual_offset_global` |
| Model Type | `harmonic_residual_offset_probe` |
