...
- logical run name: `te_track2h_log_cosh_robust_global`;
- output run name: `te_track2h_log_cosh_robust_global_track2h_log_cosh_global_one_batch_validation`;
- run instance id: `2026-06-11-11-24-22__te_track2h_log_cosh_robust_global_track2h_log_cosh_global_one_batch_validation`;
...
| Field | Value |
| --- | --- |
| Config Path | `config/training/track2h_dispersion_aware_modeling/campaigns/2026-06-10_track2h_dispersion_aware_modeling_campaign/queue/07_log_cosh_robust_global.yaml` |
| Output Directory | `output/validation_checks/track2h_dispersion_aware_log_cosh_robust_global/2026-06-11-11-24-22__te_track2h_log_cosh_robust_global_track2h_log_cosh_global_one_batch_validation` |
| Model Family | `track2h_dispersion_aware_log_cosh_robust_global` |
| Model Type | `curve_aware_harmonic_residual_offset_probe` |
