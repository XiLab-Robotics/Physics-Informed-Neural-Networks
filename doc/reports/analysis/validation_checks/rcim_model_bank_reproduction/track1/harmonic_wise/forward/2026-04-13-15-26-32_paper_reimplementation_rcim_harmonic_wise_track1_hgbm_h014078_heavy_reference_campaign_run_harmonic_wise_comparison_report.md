...
- model type: `harmonic_wise_hist_gradient_boosting_track1_h014078_heavy_reference`;
- run name: `track1_hgbm_h014078_heavy_reference`;
- output run name: `track1_hgbm_h014078_heavy_reference_campaign_run`;
- run instance id: `2026-04-13-15-25-33__track1_hgbm_h014078_heavy_reference_campaign_run`;
...
| --- | ---: | ---: | ---: | ---: | ---: |
| Validation | 0.002668 | 0.002908 | 9.646 | 3.588 | 0.000167 |
| Test | 0.002736 | 0.002930 | 9.135 | 2.749 | 0.000161 |

## Paper Alignment

- Paper offline threshold for `Target A`: `4.7%` mean percentage error.
- Current repository test result: `9.135%` mean percentage error.
...
| --- | ---: | ---: | ---: | ---: |
| `h0` | 0.002518 | 0.003291 | 0.002485 | 0.000000 |
| `h1` | 0.000027 | 0.000033 | 0.000025 | 0.001648 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| `robot` | 180 | 0.041588 | 0.071082 | 288.1 | 598.2 | 31.6 |
| `cycloidal` | 180 | 0.033005 | 0.054122 | 500.0 | 351.5 | 26.7 |

## Test Preview Samples

- `data/simplified_dataset/Test_25degree/1000rpm/1000.0rpm1200.0Nm25.0deg.csv` | forward | mean percentage error `8.562%` | curve MAE `0.005287`
- `data/simplified_dataset/Test_25degree/1000rpm/1000.0rpm1200.0Nm25.0deg.csv` | backward | mean percentage error `9.335%` | curve MAE `0.003053`
- `data/simplified_dataset/Test_25degree/1000rpm/1000.0rpm1300.0Nm25.0deg.csv` | forward | mean percentage error `4.337%` | curve MAE `0.002906`
