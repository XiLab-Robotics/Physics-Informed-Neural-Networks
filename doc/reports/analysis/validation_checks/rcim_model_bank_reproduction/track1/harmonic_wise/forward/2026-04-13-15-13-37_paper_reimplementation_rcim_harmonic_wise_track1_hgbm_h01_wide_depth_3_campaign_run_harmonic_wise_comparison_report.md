...
- model type: `harmonic_wise_hist_gradient_boosting_track1_h01_wide_depth_3`;
- run name: `track1_hgbm_h01_wide_depth_3`;
- output run name: `track1_hgbm_h01_wide_depth_3_campaign_run`;
- run instance id: `2026-04-13-15-12-43__track1_hgbm_h01_wide_depth_3_campaign_run`;
...
| --- | ---: | ---: | ---: | ---: | ---: |
| Validation | 0.002745 | 0.002984 | 9.944 | 3.588 | 0.000171 |
| Test | 0.002686 | 0.002882 | 9.032 | 2.749 | 0.000157 |

## Paper Alignment

- Paper offline threshold for `Target A`: `4.7%` mean percentage error.
- Current repository test result: `9.032%` mean percentage error.
...
| --- | ---: | ---: | ---: | ---: |
| `h0` | 0.002459 | 0.003237 | 0.002423 | 0.000000 |
| `h1` | 0.000027 | 0.000032 | 0.000026 | 0.001598 |
| `h3` | 0.000018 | 0.000023 | 0.000018 | 0.020714 |
| `h39` | 0.000020 | 0.000027 | 0.000021 | 0.026721 |
| `h40` | 0.000031 | 0.000048 | 0.000031 | 0.070287 |
| `h78` | 0.000027 | 0.000034 | 0.000023 | 0.050355 |
| `h81` | 0.000014 | 0.000018 | 0.000013 | 0.080450 |
| `h156` | 0.000056 | 0.000158 | 0.000055 | 0.079590 |
| `h162` | 0.000038 | 0.000119 | 0.000043 | 0.074189 |
| `h240` | 0.000033 | 0.000066 | 0.000035 | 0.068354 |

Top coefficient-error contributors on the test split:

- `h0` | coefficient MAE `0.002459` | amplitude MAE `0.002423`
- `h156` | coefficient MAE `0.000056` | amplitude MAE `0.000055`
- `h162` | coefficient MAE `0.000038` | amplitude MAE `0.000043`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| `robot` | 180 | 0.041394 | 0.070687 | 288.1 | 598.2 | 31.6 |
| `cycloidal` | 180 | 0.032875 | 0.053254 | 500.0 | 351.5 | 26.7 |

## Test Preview Samples

- `data/simplified_dataset/Test_25degree/1000rpm/1000.0rpm1200.0Nm25.0deg.csv` | forward | mean percentage error `8.322%` | curve MAE `0.005139`
- `data/simplified_dataset/Test_25degree/1000rpm/1000.0rpm1200.0Nm25.0deg.csv` | backward | mean percentage error `8.129%` | curve MAE `0.002658`
- `data/simplified_dataset/Test_25degree/1000rpm/1000.0rpm1300.0Nm25.0deg.csv` | forward | mean percentage error `4.167%` | curve MAE `0.002792`
