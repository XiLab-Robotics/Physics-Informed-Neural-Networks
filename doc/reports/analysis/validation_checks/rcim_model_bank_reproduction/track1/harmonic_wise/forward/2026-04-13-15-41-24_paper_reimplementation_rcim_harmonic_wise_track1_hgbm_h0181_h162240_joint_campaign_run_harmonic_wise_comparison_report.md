...
- model type: `harmonic_wise_hist_gradient_boosting_track1_h0181_h162240_joint`;
- run name: `track1_hgbm_h0181_h162240_joint`;
- output run name: `track1_hgbm_h0181_h162240_joint_campaign_run`;
- run instance id: `2026-04-13-15-40-31__track1_hgbm_h0181_h162240_joint_campaign_run`;
...
| Test | 0.002647 | 0.002843 | 8.770 | 2.749 | 0.000155 |

## Paper Alignment

- Paper offline threshold for `Target A`: `4.7%` mean percentage error.
- Current repository test result: `8.770%` mean percentage error.
...
| --- | ---: | ---: | ---: | ---: |
| `h0` | 0.002426 | 0.003232 | 0.002401 | 0.000000 |
| `h1` | 0.000026 | 0.000032 | 0.000025 | 0.001594 |
| `h3` | 0.000019 | 0.000024 | 0.000020 | 0.020521 |
| `h39` | 0.000020 | 0.000026 | 0.000021 | 0.026925 |
| `h40` | 0.000031 | 0.000047 | 0.000030 | 0.069725 |
| `h78` | 0.000026 | 0.000032 | 0.000022 | 0.047771 |
| `h81` | 0.000013 | 0.000018 | 0.000012 | 0.076785 |
| `h156` | 0.000056 | 0.000159 | 0.000054 | 0.084024 |
| `h162` | 0.000037 | 0.000116 | 0.000043 | 0.074438 |
| `h240` | 0.000035 | 0.000068 | 0.000036 | 0.072515 |

Top coefficient-error contributors on the test split:

- `h0` | coefficient MAE `0.002426` | amplitude MAE `0.002401`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| `robot` | 180 | 0.041337 | 0.070625 | 288.1 | 598.2 | 31.6 |
| `cycloidal` | 180 | 0.032910 | 0.053257 | 500.0 | 351.5 | 26.7 |

## Test Preview Samples

- `data/simplified_dataset/Test_25degree/1000rpm/1000.0rpm1200.0Nm25.0deg.csv` | forward | mean percentage error `7.253%` | curve MAE `0.004479`
- `data/simplified_dataset/Test_25degree/1000rpm/1000.0rpm1200.0Nm25.0deg.csv` | backward | mean percentage error `8.736%` | curve MAE `0.002857`
- `data/simplified_dataset/Test_25degree/1000rpm/1000.0rpm1300.0Nm25.0deg.csv` | forward | mean percentage error `3.100%` | curve MAE `0.002077`
