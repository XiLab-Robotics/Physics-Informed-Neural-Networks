...
- model type: `harmonic_wise_random_forest_track1_h156_h162_h240_focus`;
- run name: `track1_rf_h156_h162_h240_focus`;
- output run name: `track1_rf_h156_h162_h240_focus_campaign_run`;
- run instance id: `2026-04-13-01-56-19__track1_rf_h156_h162_h240_focus_campaign_run`;
...
| --- | ---: | ---: | ---: | ---: | ---: |
| Validation | 0.003121 | 0.003352 | 11.328 | 3.588 | 0.000195 |
| Test | 0.003318 | 0.003502 | 11.176 | 2.749 | 0.000198 |

## Paper Alignment

- Paper offline threshold for `Target A`: `4.7%` mean percentage error.
- Current repository test result: `11.176%` mean percentage error.
...
| `h3` | 0.000022 | 0.000027 | 0.000021 | 0.025697 |
| `h39` | 0.000024 | 0.000030 | 0.000026 | 0.031358 |
| `h40` | 0.000029 | 0.000042 | 0.000028 | 0.069740 |
| `h78` | 0.000038 | 0.000050 | 0.000035 | 0.060707 |
| `h81` | 0.000013 | 0.000016 | 0.000013 | 0.076925 |
| `h156` | 0.000066 | 0.000246 | 0.000077 | 0.096725 |
| `h162` | 0.000048 | 0.000135 | 0.000049 | 0.085236 |
| `h240` | 0.000043 | 0.000104 | 0.000047 | 0.086652 |

Top coefficient-error contributors on the test split:

- `h0` | coefficient MAE `0.003148` | amplitude MAE `0.003094`
- `h156` | coefficient MAE `0.000066` | amplitude MAE `0.000077`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| `robot` | 180 | 0.040829 | 0.069048 | 288.1 | 598.2 | 31.6 |
| `cycloidal` | 180 | 0.033044 | 0.054812 | 500.0 | 351.5 | 26.7 |

## Test Preview Samples

- `data/simplified_dataset/Test_25degree/1000rpm/1000.0rpm1200.0Nm25.0deg.csv` | forward | mean percentage error `14.322%` | curve MAE `0.008844`
- `data/simplified_dataset/Test_25degree/1000rpm/1000.0rpm1200.0Nm25.0deg.csv` | backward | mean percentage error `18.932%` | curve MAE `0.006191`
- `data/simplified_dataset/Test_25degree/1000rpm/1000.0rpm1300.0Nm25.0deg.csv` | forward | mean percentage error `8.015%` | curve MAE `0.005370`
