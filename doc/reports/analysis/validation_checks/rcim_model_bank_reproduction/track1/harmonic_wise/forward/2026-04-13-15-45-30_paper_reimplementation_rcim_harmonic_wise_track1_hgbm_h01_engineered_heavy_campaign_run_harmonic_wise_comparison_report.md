...
- model type: `harmonic_wise_hist_gradient_boosting_track1_h01_engineered_heavy`;
- run name: `track1_hgbm_h01_engineered_heavy`;
- output run name: `track1_hgbm_h01_engineered_heavy_campaign_run`;
- run instance id: `2026-04-13-15-44-34__track1_hgbm_h01_engineered_heavy_campaign_run`;
...
| --- | ---: | ---: | ---: | ---: | ---: |
| Validation | 0.002692 | 0.002938 | 9.516 | 3.588 | 0.000177 |
| Test | 0.002677 | 0.002879 | 9.360 | 2.749 | 0.000162 |

## Paper Alignment

- Paper offline threshold for `Target A`: `4.7%` mean percentage error.
- Current repository test result: `9.360%` mean percentage error.
...
| `h1` | 0.000027 | 0.000031 | 0.000025 | 0.001657 |
| `h3` | 0.000021 | 0.000030 | 0.000018 | 0.027648 |
| `h39` | 0.000021 | 0.000028 | 0.000021 | 0.030123 |
| `h40` | 0.000032 | 0.000047 | 0.000033 | 0.071778 |
| `h78` | 0.000032 | 0.000041 | 0.000028 | 0.062574 |
| `h81` | 0.000014 | 0.000019 | 0.000014 | 0.087442 |
| `h156` | 0.000086 | 0.000306 | 0.000100 | 0.109095 |
| `h162` | 0.000042 | 0.000121 | 0.000043 | 0.096067 |
| `h240` | 0.000043 | 0.000088 | 0.000044 | 0.085660 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| `robot` | 180 | 0.040356 | 0.071122 | 288.1 | 598.2 | 31.6 |
| `cycloidal` | 180 | 0.033340 | 0.058836 | 500.0 | 351.5 | 26.7 |

## Test Preview Samples

- `data/simplified_dataset/Test_25degree/1000rpm/1000.0rpm1200.0Nm25.0deg.csv` | forward | mean percentage error `5.887%` | curve MAE `0.003635`
- `data/simplified_dataset/Test_25degree/1000rpm/1000.0rpm1200.0Nm25.0deg.csv` | backward | mean percentage error `10.466%` | curve MAE `0.003423`
- `data/simplified_dataset/Test_25degree/1000rpm/1000.0rpm1300.0Nm25.0deg.csv` | forward | mean percentage error `1.126%` | curve MAE `0.000754`
