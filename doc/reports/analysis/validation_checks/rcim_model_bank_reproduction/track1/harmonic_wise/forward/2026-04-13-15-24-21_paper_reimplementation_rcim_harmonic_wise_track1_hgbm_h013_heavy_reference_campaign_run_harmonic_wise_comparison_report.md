...
- model type: `harmonic_wise_hist_gradient_boosting_track1_h013_heavy_reference`;
- run name: `track1_hgbm_h013_heavy_reference`;
- output run name: `track1_hgbm_h013_heavy_reference_campaign_run`;
- run instance id: `2026-04-13-15-23-23__track1_hgbm_h013_heavy_reference_campaign_run`;
...
| --- | ---: | ---: | ---: | ---: | ---: |
| Validation | 0.002727 | 0.002966 | 9.788 | 3.588 | 0.000171 |
| Test | 0.002728 | 0.002924 | 9.199 | 2.749 | 0.000161 |
...
| --- | ---: | ---: | ---: | ---: |
| `h0` | 0.002520 | 0.003315 | 0.002485 | 0.000000 |
| `h1` | 0.000026 | 0.000032 | 0.000025 | 0.001597 |
| `h3` | 0.000019 | 0.000023 | 0.000019 | 0.020942 |
| `h39` | 0.000020 | 0.000027 | 0.000021 | 0.027520 |
| `h40` | 0.000031 | 0.000047 | 0.000030 | 0.069368 |
| `h78` | 0.000027 | 0.000034 | 0.000022 | 0.053645 |
| `h81` | 0.000013 | 0.000018 | 0.000013 | 0.079867 |
| `h156` | 0.000057 | 0.000162 | 0.000058 | 0.083519 |
| `h162` | 0.000039 | 0.000122 | 0.000045 | 0.077183 |
| `h240` | 0.000033 | 0.000065 | 0.000034 | 0.069953 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| `robot` | 180 | 0.041444 | 0.070550 | 288.1 | 598.2 | 31.6 |
| `cycloidal` | 180 | 0.033021 | 0.054286 | 500.0 | 351.5 | 26.7 |

## Test Preview Samples

- `data/simplified_dataset/Test_25degree/1000rpm/1000.0rpm1200.0Nm25.0deg.csv` | forward | mean percentage error `7.061%` | curve MAE `0.004360`
- `data/simplified_dataset/Test_25degree/1000rpm/1000.0rpm1200.0Nm25.0deg.csv` | backward | mean percentage error `7.384%` | curve MAE `0.002415`
- `data/simplified_dataset/Test_25degree/1000rpm/1000.0rpm1300.0Nm25.0deg.csv` | forward | mean percentage error `2.824%` | curve MAE `0.001892`
