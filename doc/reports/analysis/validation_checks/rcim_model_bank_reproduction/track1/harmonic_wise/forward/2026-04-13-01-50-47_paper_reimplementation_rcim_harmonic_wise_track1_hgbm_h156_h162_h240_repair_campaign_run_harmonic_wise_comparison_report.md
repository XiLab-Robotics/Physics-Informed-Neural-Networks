...
- model type: `harmonic_wise_hist_gradient_boosting_track1_h156_h162_h240_repair`;
- run name: `track1_hgbm_h156_h162_h240_repair`;
- output run name: `track1_hgbm_h156_h162_h240_repair_campaign_run`;
- run instance id: `2026-04-13-01-50-02__track1_hgbm_h156_h162_h240_repair_campaign_run`;
...
| --- | ---: | ---: | ---: | ---: | ---: |
| Validation | 0.002587 | 0.002829 | 9.381 | 3.588 | 0.000163 |
| Test | 0.002665 | 0.002866 | 9.162 | 2.749 | 0.000158 |

## Paper Alignment

- Paper offline threshold for `Target A`: `4.7%` mean percentage error.
- Current repository test result: `9.162%` mean percentage error.
...
- `h156` | coefficient MAE `0.000056` | amplitude MAE `0.000064`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| `robot` | 180 | 0.041327 | 0.070324 | 288.1 | 598.2 | 31.6 |
| `cycloidal` | 180 | 0.033096 | 0.054104 | 500.0 | 351.5 | 26.7 |

## Test Preview Samples

- `data/simplified_dataset/Test_25degree/1000rpm/1000.0rpm1200.0Nm25.0deg.csv` | forward | mean percentage error `8.330%` | curve MAE `0.005144`
- `data/simplified_dataset/Test_25degree/1000rpm/1000.0rpm1200.0Nm25.0deg.csv` | backward | mean percentage error `9.643%` | curve MAE `0.003153`
- `data/simplified_dataset/Test_25degree/1000rpm/1000.0rpm1300.0Nm25.0deg.csv` | forward | mean percentage error `3.066%` | curve MAE `0.002054`
