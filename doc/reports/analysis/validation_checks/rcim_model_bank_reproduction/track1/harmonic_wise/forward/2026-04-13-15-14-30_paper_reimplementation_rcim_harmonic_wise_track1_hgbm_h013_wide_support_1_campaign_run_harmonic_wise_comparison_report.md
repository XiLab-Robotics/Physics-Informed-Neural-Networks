...
- model type: `harmonic_wise_hist_gradient_boosting_track1_h013_wide_support_1`;
- run name: `track1_hgbm_h013_wide_support_1`;
- output run name: `track1_hgbm_h013_wide_support_1_campaign_run`;
- run instance id: `2026-04-13-15-13-45__track1_hgbm_h013_wide_support_1_campaign_run`;
...
| --- | ---: | ---: | ---: | ---: | ---: |
| Validation | 0.002736 | 0.002974 | 9.904 | 3.588 | 0.000171 |
| Test | 0.002727 | 0.002923 | 9.177 | 2.749 | 0.000160 |

## Paper Alignment

- Paper offline threshold for `Target A`: `4.7%` mean percentage error.
- Current repository test result: `9.177%` mean percentage error.
...
| --- | ---: | ---: | ---: | ---: |
| `h0` | 0.002509 | 0.003340 | 0.002471 | 0.000000 |
| `h1` | 0.000027 | 0.000033 | 0.000026 | 0.001644 |
| `h3` | 0.000018 | 0.000023 | 0.000019 | 0.020952 |
| `h39` | 0.000020 | 0.000027 | 0.000021 | 0.028783 |
| `h40` | 0.000031 | 0.000047 | 0.000031 | 0.069118 |
| `h78` | 0.000028 | 0.000036 | 0.000024 | 0.047670 |
| `h81` | 0.000014 | 0.000018 | 0.000013 | 0.080671 |
| `h156` | 0.000058 | 0.000165 | 0.000058 | 0.084930 |
| `h162` | 0.000039 | 0.000122 | 0.000046 | 0.081982 |
| `h240` | 0.000034 | 0.000066 | 0.000036 | 0.069163 |

Top coefficient-error contributors on the test split:

- `h0` | coefficient MAE `0.002509` | amplitude MAE `0.002471`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| `robot` | 180 | 0.041338 | 0.070520 | 288.1 | 598.2 | 31.6 |
| `cycloidal` | 180 | 0.032825 | 0.054140 | 500.0 | 351.5 | 26.7 |

## Test Preview Samples

- `data/simplified_dataset/Test_25degree/1000rpm/1000.0rpm1200.0Nm25.0deg.csv` | forward | mean percentage error `7.440%` | curve MAE `0.004594`
- `data/simplified_dataset/Test_25degree/1000rpm/1000.0rpm1200.0Nm25.0deg.csv` | backward | mean percentage error `8.819%` | curve MAE `0.002884`
- `data/simplified_dataset/Test_25degree/1000rpm/1000.0rpm1300.0Nm25.0deg.csv` | forward | mean percentage error `3.645%` | curve MAE `0.002442`
