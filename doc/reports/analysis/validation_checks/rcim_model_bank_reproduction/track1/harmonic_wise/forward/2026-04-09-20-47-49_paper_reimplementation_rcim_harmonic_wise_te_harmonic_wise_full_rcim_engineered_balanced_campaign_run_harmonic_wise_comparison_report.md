...
- run name: `te_harmonic_wise_full_rcim_engineered_balanced`;
- output run name: `te_harmonic_wise_full_rcim_engineered_balanced_campaign_run`;
- run instance id: `2026-04-09-20-46-52__te_harmonic_wise_full_rcim_engineered_balanced_campaign_run`;
...
| --- | ---: | ---: | ---: | ---: | ---: |
| Validation | 0.002729 | 0.002974 | 9.563 | 3.588 | 0.000180 |
| Test | 0.002720 | 0.002919 | 9.672 | 2.749 | 0.000163 |

## Paper Alignment

- Paper offline threshold for `Target A`: `4.7%` mean percentage error.
- Current repository test result: `9.672%` mean percentage error.
...
| --- | ---: | ---: | ---: | ---: |
| `h0` | 0.002453 | 0.003250 | 0.002412 | 0.000000 |
| `h1` | 0.000027 | 0.000031 | 0.000025 | 0.001638 |
| `h3` | 0.000021 | 0.000029 | 0.000019 | 0.027452 |
| `h39` | 0.000021 | 0.000027 | 0.000021 | 0.030021 |
| `h40` | 0.000032 | 0.000046 | 0.000034 | 0.068124 |
| `h78` | 0.000031 | 0.000040 | 0.000029 | 0.060531 |
| `h81` | 0.000014 | 0.000018 | 0.000014 | 0.081502 |
| `h156` | 0.000087 | 0.000314 | 0.000098 | 0.107005 |
| `h162` | 0.000044 | 0.000120 | 0.000045 | 0.095080 |
| `h240` | 0.000047 | 0.000098 | 0.000050 | 0.090783 |

Top coefficient-error contributors on the test split:

- `h0` | coefficient MAE `0.002453` | amplitude MAE `0.002412`
- `h156` | coefficient MAE `0.000087` | amplitude MAE `0.000098`
- `h240` | coefficient MAE `0.000047` | amplitude MAE `0.000050`
- `h162` | coefficient MAE `0.000044` | amplitude MAE `0.000045`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| `robot` | 180 | 0.040261 | 0.070800 | 288.1 | 598.2 | 31.6 |
| `cycloidal` | 180 | 0.033298 | 0.057344 | 500.0 | 351.5 | 26.7 |

## Test Preview Samples

- `data/simplified_dataset/Test_25degree/1000rpm/1000.0rpm1200.0Nm25.0deg.csv` | forward | mean percentage error `3.911%` | curve MAE `0.002415`
- `data/simplified_dataset/Test_25degree/1000rpm/1000.0rpm1200.0Nm25.0deg.csv` | backward | mean percentage error `8.294%` | curve MAE `0.002712`
- `data/simplified_dataset/Test_25degree/1000rpm/1000.0rpm1300.0Nm25.0deg.csv` | forward | mean percentage error `0.993%` | curve MAE `0.000665`
