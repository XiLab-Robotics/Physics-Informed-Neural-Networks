...
- output run name: `rcim_exact_paper_model_bank_exact_paper_validation_per_harmonic_replication`;
- run instance id: `2026-04-12-15-38-43__rcim_exact_paper_model_bank_exact_paper_validation_per_harmonic_replication`;
...
- export enabled: `True`;
- export root: `output/validation_checks/paper_reimplementation_rcim_exact_model_bank/forward/baseline_reproduction/shared/2026-04-12-15-38-43__rcim_exact_paper_model_bank_exact_paper_validation_per_harmonic_replication/onnx_export`;
...
the exact numeric paper table thresholds. `RCIM Model-Bank Reproduction` therefore remains a
