...
- logical run name: `te_causal_offset_mean_periodic_mlp_harmonic_fw__polished_setpoints`;
- output run name: `te_causal_offset_mean_periodic_mlp_harmonic_fw__polished_setpoints_validation_check`;
- run instance id: `2026-07-22-17-50-24__te_causal_offset_mean_periodic_mlp_harmonic_fw__polished_setpoints_validation_check`;
...
| Field | Value |
| --- | --- |
| Config Path | `config/training/causal_offset_mean_calibration/campaigns/2026-07-22_causal_offset_mean_calibration_pilot/queue/002_causal_offset_mean_periodic_mlp_harmonic_fw.yaml` |
| Output Directory | `output/validation_checks/causal_offset_mean_periodic_mlp_harmonic_fw/2026-07-22-17-50-24__te_causal_offset_mean_periodic_mlp_harmonic_fw__polished_setpoints_validation_check` |
| Model Family | `causal_offset_mean_periodic_mlp_harmonic_fw` |
| Model Type | `periodic_mlp` |
