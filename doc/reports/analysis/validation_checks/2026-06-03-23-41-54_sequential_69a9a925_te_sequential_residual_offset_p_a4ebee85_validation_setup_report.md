...
- logical run name: `te_sequential_residual_offset_probe_remote_fw`;
- output run name: `te_sequential_residual_offset_probe_remote_fw_validation_check`;
- run instance id: `2026-06-03-23-41-33__te_sequential_residual_offset_probe_remote_fw_validation_check`;
...
| Field | Value |
| --- | --- |
| Config Path | `config/training/track2f_offset_aware_probe/campaigns/2026-06-03_track2f_offset_aware_probe_campaign/queue/02_sequential_residual_offset_probe_fw.yaml` |
| Output Directory | `output/validation_checks/sequential_residual_offset_probe_fw/2026-06-03-23-41-33__te_sequential_residual_offset_probe_remote_fw_validation_check` |
| Model Family | `sequential_residual_offset_probe_fw` |
| Model Type | `sequential_residual_offset_probe` |
