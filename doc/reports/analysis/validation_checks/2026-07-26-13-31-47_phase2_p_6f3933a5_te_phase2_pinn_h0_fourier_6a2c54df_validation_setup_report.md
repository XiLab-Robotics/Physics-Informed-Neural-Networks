...
- logical run name: `te_phase2_pinn_h0_fourier_control_bw__polished_setpoints`;
- output run name: `te_phase2_pinn_h0_fourier_control_bw__polished_setpoints_validation_check`;
- run instance id: `2026-07-26-13-31-44__te_phase2_pinn_h0_fourier_control_bw__polished_setpoints_validation_check`;
...
| Field | Value |
| --- | --- |
| Config Path | `config/training/harmonic_kinematic_pinn/campaigns/2026-07-26_phase2_harmonic_kinematic_pinn/queue/002_h0_fourier_control_bw.yaml` |
| Output Directory | `output/validation_checks/phase2_pinn_h0_fourier_control_bw/2026-07-26-13-31-44__te_phase2_pinn_h0_fourier_control_bw__polished_setpoints_validation_check` |
| Model Family | `phase2_pinn_h0_fourier_control_bw` |
| Model Type | `harmonic_kinematic_pinn` |
