...
| `polished_rcim_model_bank_reproduction_SVM19_Fw` | `SVM` | `polished_rcim_model_bank_reproduction` | `track1_reference_bank` | `Fw` | `forward` | `output\validation_checks\rcim_model_bank_reproduction\reference_inventories\forward\svm_reference_models\reference_inventory.yaml` |
| `polished_rcim_model_bank_reproduction_MLP19_Fw` | `MLP` | `polished_rcim_model_bank_reproduction` | `track1_reference_bank` | `Fw` | `forward` | `output\validation_checks\rcim_model_bank_reproduction\reference_inventories\forward\mlp_reference_models\reference_inventory.yaml` |
| `polished_rcim_model_bank_reproduction_RF19_Fw` | `RF` | `polished_rcim_model_bank_reproduction` | `track1_reference_bank` | `Fw` | `forward` | `output\validation_checks\rcim_model_bank_reproduction\reference_inventories\forward\rf_reference_models\reference_inventory.yaml` |
| `polished_rcim_model_bank_reproduction_DT19_Fw` | `DT` | `polished_rcim_model_bank_reproduction` | `track1_reference_bank` | `Fw` | `forward` | `output\validation_checks\rcim_model_bank_reproduction\reference_inventories\forward\dt_reference_models\reference_inventory.yaml` |
...
| `polished_rcim_model_bank_reproduction_ERT19_Fw` | `ERT` | `polished_rcim_model_bank_reproduction` | `track1_reference_bank` | `Fw` | `forward` | `output\validation_checks\rcim_model_bank_reproduction\reference_inventories\forward\ert_reference_models\reference_inventory.yaml` |
...
| `polished_rcim_model_bank_reproduction_HGBM19_Fw` | `HGBM` | `polished_rcim_model_bank_reproduction` | `track1_reference_bank` | `Fw` | `forward` | `output\validation_checks\rcim_model_bank_reproduction\reference_inventories\forward\hgbm_reference_models\reference_inventory.yaml` |
| `polished_rcim_model_bank_reproduction_XGBM19_Fw` | `XGBM` | `polished_rcim_model_bank_reproduction` | `track1_reference_bank` | `Fw` | `forward` | `output\validation_checks\rcim_model_bank_reproduction\reference_inventories\forward\xgbm_reference_models\reference_inventory.yaml` |
| `polished_rcim_model_bank_reproduction_LGBM19_Fw` | `LGBM` | `polished_rcim_model_bank_reproduction` | `track1_reference_bank` | `Fw` | `forward` | `output\validation_checks\rcim_model_bank_reproduction\reference_inventories\forward\lgbm_reference_models\reference_inventory.yaml` |
...
| `polished_periodic_mlp_Fw` | `periodic_mlp` | `polished_model_development_registry` | `wave1_registry_model` | `Fw` | `forward` | `output\registries\families\periodic_mlp_fw\latest_family_best.yaml` |
...
| `polished_residual_harmonic_mlp_Fw` | `residual_harmonic_mlp` | `polished_model_development_registry` | `wave1_registry_model` | `Fw` | `forward` | `output\registries\families\residual_harmonic_mlp_fw\latest_family_best.yaml` |
...
| `polished_temporal_convolution_Fw` | `temporal_convolution` | `polished_model_development_registry` | `wave1_registry_model` | `Fw` | `forward` | `output\registries\families\temporal_convolution_fw\latest_family_best.yaml` |
...
| `polished_gru_sequence_Fw` | `gru_sequence` | `polished_model_development_registry` | `wave1_registry_model` | `Fw` | `forward` | `output\registries\families\gru_sequence_fw\latest_family_best.yaml` |
...
| `polished_lstm_sequence_Fw` | `lstm_sequence` | `polished_model_development_registry` | `wave1_registry_model` | `Fw` | `forward` | `output\registries\families\lstm_sequence_fw\latest_family_best.yaml` |
...
| `polished_periodic_temporal_convolution_Fw` | `periodic_temporal_convolution` | `polished_model_development_registry` | `wave1_registry_model` | `Fw` | `forward` | `output\registries\families\periodic_temporal_convolution_fw\latest_family_best.yaml` |
...
| `polished_periodic_lstm_sequence_Fw` | `periodic_lstm_sequence` | `polished_model_development_registry` | `wave1_registry_model` | `Fw` | `forward` | `output\registries\families\periodic_lstm_sequence_fw\latest_family_best.yaml` |
...
| `polished_residual_harmonic_gru_sequence_sparse_rcim_Fw` | `residual_harmonic_gru_sequence_sparse_rcim` | `polished_model_development_registry` | `wave1_registry_model` | `Fw` | `forward` | `output\registries\families\residual_harmonic_gru_sequence_sparse_rcim_fw\latest_family_best.yaml` |
...
| `polished_residual_harmonic_gru_sequence_dense240_Fw` | `residual_harmonic_gru_sequence_dense240` | `polished_model_development_registry` | `wave1_registry_model` | `Fw` | `forward` | `output\registries\families\residual_harmonic_gru_sequence_dense240_fw\latest_family_best.yaml` |
...
| `polished_residual_harmonic_gru_sequence_dense360_Fw` | `residual_harmonic_gru_sequence_dense360` | `polished_model_development_registry` | `wave1_registry_model` | `Fw` | `forward` | `output\registries\families\residual_harmonic_gru_sequence_dense360_fw\latest_family_best.yaml` |
...
| `polished_residual_harmonic_lstm_sequence_sparse_rcim_Fw` | `residual_harmonic_lstm_sequence_sparse_rcim` | `polished_model_development_registry` | `wave1_registry_model` | `Fw` | `forward` | `output\registries\families\residual_harmonic_lstm_sequence_sparse_rcim_fw\latest_family_best.yaml` |
...
| `polished_residual_harmonic_lstm_sequence_dense240_Fw` | `residual_harmonic_lstm_sequence_dense240` | `polished_model_development_registry` | `wave1_registry_model` | `Fw` | `forward` | `output\registries\families\residual_harmonic_lstm_sequence_dense240_fw\latest_family_best.yaml` |
...
| `polished_residual_harmonic_lstm_sequence_dense360_Fw` | `residual_harmonic_lstm_sequence_dense360` | `polished_model_development_registry` | `wave1_registry_model` | `Fw` | `forward` | `output\registries\families\residual_harmonic_lstm_sequence_dense360_fw\latest_family_best.yaml` |
...
| `polished_wave3_1_sequential_residual_offset_probe_Fw` | `wave3_1_sequential_residual_offset_probe` | `polished_model_development_registry` | `wave1_registry_model` | `Fw` | `forward` | `output\registries\families\wave3_1_sequential_residual_offset_probe_fw\latest_family_best.yaml` |
...
| `polished_wave3_2_clean_sequential_residual_offset_Fw` | `wave3_2_clean_sequential_residual_offset` | `polished_model_development_registry` | `wave1_registry_model` | `Fw` | `forward` | `output\registries\families\wave3_2_clean_sequential_residual_offset_fw\latest_family_best.yaml` |
...
| `polished_wave3_2_harmonic_residual_offset_Fw` | `wave3_2_harmonic_residual_offset` | `polished_model_development_registry` | `wave1_registry_model` | `Fw` | `forward` | `output\registries\families\wave3_2_harmonic_residual_offset_fw\latest_family_best.yaml` |
...
| `polished_wave3_3_curve_aware_pointwise_control_Fw` | `wave3_3_curve_aware_pointwise_control` | `polished_model_development_registry` | `wave1_registry_model` | `Fw` | `forward` | `output\registries\families\wave3_3_curve_aware_pointwise_control_fw\latest_family_best.yaml` |
...
| `polished_wave3_3_raw_centered_shape_curve_aware_Fw` | `wave3_3_raw_centered_shape_curve_aware` | `polished_model_development_registry` | `wave1_registry_model` | `Fw` | `forward` | `output\registries\families\wave3_3_raw_centered_shape_curve_aware_fw\latest_family_best.yaml` |
...
| `polished_wave3_3_raw_offset_curve_aware_Fw` | `wave3_3_raw_offset_curve_aware` | `polished_model_development_registry` | `wave1_registry_model` | `Fw` | `forward` | `output\registries\families\wave3_3_raw_offset_curve_aware_fw\latest_family_best.yaml` |
...
| `polished_wave3_3_full_curve_composite_Fw` | `wave3_3_full_curve_composite` | `polished_model_development_registry` | `wave1_registry_model` | `Fw` | `forward` | `output\registries\families\wave3_3_full_curve_composite_fw\latest_family_best.yaml` |
...
| `polished_wave4_1_mae_robust_loss_Fw` | `wave4_1_mae_robust_loss` | `polished_model_development_registry` | `wave1_registry_model` | `Fw` | `forward` | `output\registries\families\wave4_1_mae_robust_loss_fw\latest_family_best.yaml` |
...
| `polished_wave4_1_smooth_l1_robust_loss_Fw` | `wave4_1_smooth_l1_robust_loss` | `polished_model_development_registry` | `wave1_registry_model` | `Fw` | `forward` | `output\registries\families\wave4_1_smooth_l1_robust_loss_fw\latest_family_best.yaml` |
...
| `polished_wave4_1_log_cosh_robust_loss_Fw` | `wave4_1_log_cosh_robust_loss` | `polished_model_development_registry` | `wave1_registry_model` | `Fw` | `forward` | `output\registries\families\wave4_1_log_cosh_robust_loss_fw\latest_family_best.yaml` |
...
| `polished_wave4_2_quantile_p10_p50_p90_Fw` | `wave4_2_quantile_p10_p50_p90` | `polished_model_development_registry` | `wave1_registry_model` | `Fw` | `forward` | `output\registries\families\wave4_2_quantile_p10_p50_p90_fw\latest_family_best.yaml` |
...
| `polished_wave4_2_gaussian_nll_Fw` | `wave4_2_gaussian_nll` | `polished_model_development_registry` | `wave1_registry_model` | `Fw` | `forward` | `output\registries\families\wave4_2_gaussian_nll_fw\latest_family_best.yaml` |
...
| `polished_wave4_3_mixture_density_k2_Fw` | `wave4_3_mixture_density_k2` | `polished_model_development_registry` | `wave1_registry_model` | `Fw` | `forward` | `output\registries\families\wave4_3_mixture_density_k2_fw\latest_family_best.yaml` |
...
| `polished_wave4_4_gru_latent_offset_residual_Fw` | `wave4_4_gru_latent_offset_residual` | `polished_model_development_registry` | `wave1_registry_model` | `Fw` | `forward` | `output\registries\families\wave4_4_gru_latent_offset_residual_fw\latest_family_best.yaml` |
...
| `polished_wave4_4_causal_tcn_latent_offset_residual_Fw` | `wave4_4_causal_tcn_latent_offset_residual` | `polished_model_development_registry` | `wave1_registry_model` | `Fw` | `forward` | `output\registries\families\wave4_4_causal_tcn_latent_offset_residual_fw\latest_family_best.yaml` |
...
| `polished_wave5_1_harmonic_prior_pointwise_control_Fw` | `wave5_1_harmonic_prior_pointwise_control` | `polished_model_development_registry` | `wave1_registry_model` | `Fw` | `forward` | `output\registries\families\wave5_1_harmonic_prior_pointwise_control_fw\latest_family_best.yaml` |
...
| `polished_wave5_1_harmonic_prior_smooth_l1_structured_Fw` | `wave5_1_harmonic_prior_smooth_l1_structured` | `polished_model_development_registry` | `wave1_registry_model` | `Fw` | `forward` | `output\registries\families\wave5_1_harmonic_prior_smooth_l1_structured_fw\latest_family_best.yaml` |
...
| Candidate | Curve MAE [deg] | Curve RMSE [deg] | Mean Percentage Error [%] | P95 Mean Percentage Error [%] |
| --- | ---: | ---: | ---: | ---: |
| `track2f_bis_harmonic_residual_offset_Fw` | 0.002850 | 0.003108 | 6.286 | 12.796 |
...
| Candidate | Curve MAE [deg] | Curve RMSE [deg] | Mean Percentage Error [%] | P95 Mean Percentage Error [%] |
| --- | ---: | ---: | ---: | ---: |
| `track2g_curve_aware_raw_centered_shape_Fw` | 0.003174 | 0.003429 | 7.047 | 12.981 |
| `track2g_curve_aware_full_curve_composite_Fw` | 0.003251 | 0.003515 | 7.209 | 11.876 |
| `track2g_curve_aware_raw_centered_shape_global` | 0.003248 | 0.003556 | 7.218 | 12.268 |
| `track2g_curve_aware_raw_offset_Fw` | 0.003269 | 0.003588 | 7.268 | 11.943 |
...
| `track2h_gaussian_nll_Fw` | 0.003156 | 0.003415 | 7.008 | 10.991 |
...
| `wave3_harmonic_prior_residual_pointwise_control_Fw` | 0.003374 | 0.003655 | 7.501 | 12.728 |
| `wave3_harmonic_prior_residual_smooth_l1_structured_Fw` | 0.003514 | 0.003768 | 7.812 | 13.703 |
...
| `polished_wave5_1_harmonic_prior_pointwise_control_Fw` | 0.082881 | 0.082943 | 181.809 | 315.245 |
| `polished_wave4_2_quantile_p10_p50_p90_Fw` | 0.083077 | 0.083129 | 182.617 | 319.159 |
...
| `polished_wave3_3_raw_offset_curve_aware_Fw` | 0.083671 | 0.083727 | 184.231 | 317.654 |
| `polished_wave4_2_gaussian_nll_Fw` | 0.083971 | 0.084023 | 184.509 | 323.590 |
| `polished_wave3_3_raw_offset_curve_aware_global` | 0.084156 | 0.084216 | 185.372 | 318.550 |
| `polished_wave4_1_mae_robust_loss_Fw` | 0.084308 | 0.084363 | 185.612 | 315.815 |
| `polished_wave4_1_mae_robust_loss_global` | 0.084350 | 0.084403 | 185.643 | 318.504 |
| `polished_wave4_1_log_cosh_robust_loss_Fw` | 0.084634 | 0.084695 | 186.340 | 320.677 |
| `polished_wave5_1_harmonic_prior_smooth_l1_structured_global` | 0.084916 | 0.084974 | 186.350 | 319.895 |
| `polished_wave3_3_raw_centered_shape_curve_aware_Fw` | 0.084910 | 0.084970 | 186.769 | 318.766 |
| `polished_wave3_3_curve_aware_pointwise_control_global` | 0.085063 | 0.085120 | 187.090 | 319.094 |
| `polished_wave4_1_smooth_l1_robust_loss_Fw` | 0.085061 | 0.085122 | 187.116 | 319.869 |
| `polished_periodic_temporal_convolution_Fw` | 0.085364 | 0.085443 | 187.236 | 316.322 |
| `polished_wave3_3_full_curve_composite_Fw` | 0.085191 | 0.085256 | 187.347 | 318.566 |
| `polished_wave4_3_mixture_density_k2_Fw` | 0.085189 | 0.085240 | 187.358 | 319.356 |
...
| `polished_residual_harmonic_mlp_Fw` | 0.085646 | 0.085696 | 187.950 | 315.761 |
| `polished_periodic_mlp_harmonic_Fw` | 0.085830 | 0.085880 | 188.420 | 317.347 |
| `polished_wave5_1_harmonic_prior_smooth_l1_structured_Fw` | 0.086190 | 0.086245 | 188.491 | 322.579 |
...
| `polished_gru_sequence_Fw` | 0.087172 | 0.087229 | 191.682 | 322.605 |
| `polished_residual_harmonic_lstm_sequence_dense240_Fw` | 0.087313 | 0.087440 | 192.137 | 319.266 |
| `polished_wave3_2_harmonic_residual_offset_Fw` | 0.087584 | 0.087638 | 192.572 | 321.302 |
| `polished_wave4_4_causal_tcn_latent_offset_residual_Fw` | 0.087696 | 0.087760 | 192.689 | 316.348 |
| `polished_wave3_3_curve_aware_pointwise_control_Fw` | 0.087578 | 0.087631 | 192.719 | 320.801 |
| `polished_periodic_lstm_sequence_Fw` | 0.087733 | 0.087808 | 192.894 | 319.177 |
| `polished_residual_harmonic_gru_sequence_dense240_Fw` | 0.087700 | 0.087819 | 192.937 | 323.637 |
| `polished_residual_harmonic_lstm_sequence_dense360_global` | 0.087693 | 0.088041 | 192.988 | 320.637 |
| `polished_wave3_2_clean_sequential_residual_offset_Fw` | 0.087791 | 0.087843 | 193.000 | 316.766 |
...
| `polished_residual_harmonic_lstm_sequence_sparse_rcim_Fw` | 0.087932 | 0.087972 | 193.422 | 319.672 |
| `polished_lstm_sequence_Fw` | 0.088000 | 0.088052 | 193.497 | 320.948 |
| `polished_wave4_4_gru_latent_offset_residual_global` | 0.088207 | 0.088272 | 193.741 | 319.288 |
| `polished_residual_harmonic_gru_sequence_sparse_rcim_Fw` | 0.088164 | 0.088204 | 193.895 | 321.474 |
| `polished_wave4_4_causal_tcn_latent_offset_residual_global` | 0.088407 | 0.088466 | 194.038 | 321.840 |
| `polished_residual_harmonic_lstm_sequence_dense360_Fw` | 0.088280 | 0.088701 | 194.256 | 322.941 |
...
| `polished_temporal_convolution_Fw` | 0.088705 | 0.088763 | 195.075 | 316.539 |
| `polished_residual_harmonic_lstm_sequence_dense240_global` | 0.088681 | 0.088799 | 195.120 | 322.794 |
| `polished_residual_harmonic_gru_sequence_dense360_Fw` | 0.088752 | 0.089230 | 195.144 | 323.795 |
| `polished_wave4_4_gru_latent_offset_residual_Fw` | 0.088796 | 0.088857 | 195.229 | 321.564 |
| `polished_wave3_1_sequential_residual_offset_probe_Fw` | 0.088949 | 0.088999 | 195.544 | 320.624 |
...
| `polished_periodic_mlp_Fw` | 0.089150 | 0.089207 | 195.822 | 322.482 |
...
| Candidate | Curve MAE [deg] | Curve RMSE [deg] | Mean Percentage Error [%] | P95 Mean Percentage Error [%] |
| --- | ---: | ---: | ---: | ---: |
| `polished_rcim_model_bank_reproduction_XGBM19_Fw` | 0.032567 | 0.032674 | 71.319 | 126.434 |
| `polished_rcim_model_bank_reproduction_RF19_Fw` | 0.033927 | 0.034030 | 74.277 | 132.489 |
| `polished_rcim_model_bank_reproduction_GBM19_Fw` | 0.035161 | 0.035261 | 77.115 | 138.019 |
| `polished_rcim_model_bank_reproduction_HGBM19_Fw` | 0.035273 | 0.035387 | 77.409 | 139.268 |
| `polished_rcim_model_bank_reproduction_ET19_Fw` | 0.038726 | 0.038810 | 85.150 | 149.396 |
| `polished_rcim_model_bank_reproduction_DT19_Fw` | 0.039046 | 0.039124 | 85.908 | 150.919 |
| `polished_rcim_model_bank_reproduction_ERT19_Fw` | 0.039120 | 0.039206 | 86.046 | 149.564 |
| `polished_rcim_model_bank_reproduction_LGBM19_Fw` | 0.039198 | 0.039275 | 86.209 | 149.793 |
| `polished_rcim_model_bank_reproduction_SVM19_Fw` | 0.056787 | 0.056964 | 127.070 | 196.523 |
| `polished_rcim_model_bank_reproduction_MLP19_Fw` | 0.423630 | 0.521370 | 959.820 | 1956.574 |
...
| `polished_feedforward_global` | `combined` | 0.087265 | 0.087342 | 191.515 | 323.389 |
| `polished_gru_sequence_global` | `forward` | 0.086025 | 0.086083 | 189.005 | 317.427 |
| `polished_gru_sequence_global` | `combined` | 0.086025 | 0.086083 | 189.005 | 317.427 |
| `polished_harmonic_regression_global` | `forward` | 0.081589 | 0.081641 | 179.273 | 315.612 |
| `polished_harmonic_regression_global` | `combined` | 0.081589 | 0.081641 | 179.273 | 315.612 |
| `polished_lstm_sequence_global` | `forward` | 0.087177 | 0.087231 | 191.649 | 320.837 |
| `polished_lstm_sequence_global` | `combined` | 0.087177 | 0.087231 | 191.649 | 320.837 |
| `polished_periodic_gru_sequence_global` | `forward` | 0.086508 | 0.086565 | 190.171 | 321.113 |
| `polished_periodic_gru_sequence_global` | `combined` | 0.086508 | 0.086565 | 190.171 | 321.113 |
| `polished_periodic_lstm_sequence_global` | `forward` | 0.088836 | 0.088902 | 194.827 | 324.051 |
| `polished_periodic_lstm_sequence_global` | `combined` | 0.088836 | 0.088902 | 194.827 | 324.051 |
| `polished_periodic_mlp_global` | `forward` | 0.089219 | 0.089281 | 195.795 | 320.557 |
| `polished_periodic_mlp_global` | `combined` | 0.089219 | 0.089281 | 195.795 | 320.557 |
| `polished_periodic_mlp_harmonic_global` | `forward` | 0.089445 | 0.089501 | 196.443 | 321.277 |
| `polished_periodic_mlp_harmonic_global` | `combined` | 0.089445 | 0.089501 | 196.443 | 321.277 |
| `polished_periodic_temporal_convolution_global` | `forward` | 0.086168 | 0.086235 | 189.292 | 316.954 |
| `polished_periodic_temporal_convolution_global` | `combined` | 0.086168 | 0.086235 | 189.292 | 316.954 |
| `polished_residual_harmonic_gru_sequence_dense240_global` | `forward` | 0.089108 | 0.089219 | 195.824 | 324.871 |
| `polished_residual_harmonic_gru_sequence_dense240_global` | `combined` | 0.089108 | 0.089219 | 195.824 | 324.871 |
| `polished_residual_harmonic_gru_sequence_dense360_global` | `forward` | 0.087694 | 0.088076 | 193.036 | 320.668 |
| `polished_residual_harmonic_gru_sequence_dense360_global` | `combined` | 0.087694 | 0.088076 | 193.036 | 320.668 |
| `polished_residual_harmonic_gru_sequence_sparse_rcim_global` | `forward` | 0.086770 | 0.086811 | 190.773 | 318.810 |
| `polished_residual_harmonic_gru_sequence_sparse_rcim_global` | `combined` | 0.086770 | 0.086811 | 190.773 | 318.810 |
| `polished_residual_harmonic_lstm_sequence_dense240_global` | `forward` | 0.088681 | 0.088799 | 195.120 | 322.794 |
| `polished_residual_harmonic_lstm_sequence_dense240_global` | `combined` | 0.088681 | 0.088799 | 195.120 | 322.794 |
| `polished_residual_harmonic_lstm_sequence_dense360_global` | `forward` | 0.087693 | 0.088041 | 192.988 | 320.637 |
| `polished_residual_harmonic_lstm_sequence_dense360_global` | `combined` | 0.087693 | 0.088041 | 192.988 | 320.637 |
| `polished_residual_harmonic_lstm_sequence_sparse_rcim_global` | `forward` | 0.087927 | 0.087967 | 193.386 | 321.315 |
| `polished_residual_harmonic_lstm_sequence_sparse_rcim_global` | `combined` | 0.087927 | 0.087967 | 193.386 | 321.315 |
| `polished_residual_harmonic_mlp_global` | `forward` | 0.088016 | 0.088064 | 193.130 | 317.519 |
| `polished_residual_harmonic_mlp_global` | `combined` | 0.088016 | 0.088064 | 193.130 | 317.519 |
| `polished_temporal_convolution_global` | `forward` | 0.086158 | 0.086217 | 189.546 | 315.846 |
| `polished_temporal_convolution_global` | `combined` | 0.086158 | 0.086217 | 189.546 | 315.846 |
| `polished_tree_global` | `forward` | 0.066315 | 0.066379 | 145.420 | 257.447 |
| `polished_tree_global` | `combined` | 0.066315 | 0.066379 | 145.420 | 257.447 |
| `polished_wave3_1_sequential_residual_offset_probe_global` | `forward` | 0.088966 | 0.089029 | 195.572 | 320.192 |
| `polished_wave3_1_sequential_residual_offset_probe_global` | `combined` | 0.088966 | 0.089029 | 195.572 | 320.192 |
| `polished_wave3_2_clean_sequential_residual_offset_global` | `forward` | 0.088402 | 0.088457 | 194.459 | 318.670 |
| `polished_wave3_2_clean_sequential_residual_offset_global` | `combined` | 0.088402 | 0.088457 | 194.459 | 318.670 |
| `polished_wave3_2_harmonic_residual_offset_global` | `forward` | 0.085263 | 0.085320 | 187.765 | 318.467 |
| `polished_wave3_2_harmonic_residual_offset_global` | `combined` | 0.085263 | 0.085320 | 187.765 | 318.467 |
| `polished_wave3_3_curve_aware_pointwise_control_global` | `forward` | 0.085063 | 0.085120 | 187.090 | 319.094 |
| `polished_wave3_3_curve_aware_pointwise_control_global` | `combined` | 0.085063 | 0.085120 | 187.090 | 319.094 |
| `polished_wave3_3_full_curve_composite_global` | `forward` | 0.085284 | 0.085341 | 187.596 | 317.599 |
| `polished_wave3_3_full_curve_composite_global` | `combined` | 0.085284 | 0.085341 | 187.596 | 317.599 |
| `polished_wave3_3_raw_centered_shape_curve_aware_global` | `forward` | 0.085695 | 0.085750 | 188.662 | 318.403 |
| `polished_wave3_3_raw_centered_shape_curve_aware_global` | `combined` | 0.085695 | 0.085750 | 188.662 | 318.403 |
| `polished_wave3_3_raw_offset_curve_aware_global` | `forward` | 0.084156 | 0.084216 | 185.372 | 318.550 |
| `polished_wave3_3_raw_offset_curve_aware_global` | `combined` | 0.084156 | 0.084216 | 185.372 | 318.550 |
| `polished_wave4_1_log_cosh_robust_loss_global` | `forward` | 0.086857 | 0.086909 | 190.908 | 322.502 |
| `polished_wave4_1_log_cosh_robust_loss_global` | `combined` | 0.086857 | 0.086909 | 190.908 | 322.502 |
| `polished_wave4_1_mae_robust_loss_global` | `forward` | 0.084350 | 0.084403 | 185.643 | 318.504 |
| `polished_wave4_1_mae_robust_loss_global` | `combined` | 0.084350 | 0.084403 | 185.643 | 318.504 |
| `polished_wave4_1_smooth_l1_robust_loss_global` | `forward` | 0.086037 | 0.086090 | 189.280 | 317.088 |
| `polished_wave4_1_smooth_l1_robust_loss_global` | `combined` | 0.086037 | 0.086090 | 189.280 | 317.088 |
| `polished_wave4_2_gaussian_nll_global` | `forward` | 0.082468 | 0.082526 | 181.304 | 319.127 |
| `polished_wave4_2_gaussian_nll_global` | `combined` | 0.082468 | 0.082526 | 181.304 | 319.127 |
| `polished_wave4_2_quantile_p10_p50_p90_global` | `forward` | 0.083629 | 0.083685 | 183.639 | 320.063 |
| `polished_wave4_2_quantile_p10_p50_p90_global` | `combined` | 0.083629 | 0.083685 | 183.639 | 320.063 |
| `polished_wave4_3_mixture_density_k2_global` | `forward` | 0.082547 | 0.082604 | 181.584 | 320.574 |
| `polished_wave4_3_mixture_density_k2_global` | `combined` | 0.082547 | 0.082604 | 181.584 | 320.574 |
| `polished_wave4_3_mixture_density_k3_global` | `forward` | 0.087895 | 0.087945 | 193.020 | 325.272 |
| `polished_wave4_3_mixture_density_k3_global` | `combined` | 0.087895 | 0.087945 | 193.020 | 325.272 |
| `polished_wave4_4_causal_tcn_latent_offset_residual_global` | `forward` | 0.088407 | 0.088466 | 194.038 | 321.840 |
| `polished_wave4_4_causal_tcn_latent_offset_residual_global` | `combined` | 0.088407 | 0.088466 | 194.038 | 321.840 |
| `polished_wave4_4_gru_latent_offset_residual_global` | `forward` | 0.088207 | 0.088272 | 193.741 | 319.288 |
| `polished_wave4_4_gru_latent_offset_residual_global` | `combined` | 0.088207 | 0.088272 | 193.741 | 319.288 |
| `polished_wave5_1_harmonic_prior_pointwise_control_global` | `forward` | 0.085374 | 0.085428 | 187.413 | 317.760 |
| `polished_wave5_1_harmonic_prior_pointwise_control_global` | `combined` | 0.085374 | 0.085428 | 187.413 | 317.760 |
| `polished_wave5_1_harmonic_prior_smooth_l1_structured_global` | `forward` | 0.084916 | 0.084974 | 186.350 | 319.895 |
| `polished_wave5_1_harmonic_prior_smooth_l1_structured_global` | `combined` | 0.084916 | 0.084974 | 186.350 | 319.895 |
...
| `sequential_residual_offset_probe_global` | `combined` | 0.003425 | 0.003839 | 7.599 | 12.346 |
...
| `track2f_bis_clean_sequential_residual_offset_global` | `combined` | 0.003420 | 0.003841 | 7.590 | 13.476 |
| `track2f_bis_harmonic_residual_offset_global` | `forward` | 0.003255 | 0.003547 | 7.224 | 12.114 |
| `track2f_bis_harmonic_residual_offset_global` | `combined` | 0.003255 | 0.003547 | 7.224 | 12.114 |
| `track2g_curve_aware_full_curve_composite_global` | `forward` | 0.085677 | 0.085733 | 188.514 | 319.710 |
| `track2g_curve_aware_full_curve_composite_global` | `combined` | 0.085677 | 0.085733 | 188.514 | 319.710 |
| `track2g_curve_aware_pointwise_control_global` | `forward` | 0.003499 | 0.003784 | 7.771 | 13.513 |
| `track2g_curve_aware_pointwise_control_global` | `combined` | 0.003499 | 0.003784 | 7.771 | 13.513 |
| `track2g_curve_aware_raw_centered_shape_global` | `forward` | 0.003248 | 0.003556 | 7.218 | 12.268 |
| `track2g_curve_aware_raw_centered_shape_global` | `combined` | 0.003248 | 0.003556 | 7.218 | 12.268 |
| `track2g_curve_aware_raw_offset_global` | `forward` | 0.003359 | 0.003630 | 7.429 | 12.737 |
| `track2g_curve_aware_raw_offset_global` | `combined` | 0.003359 | 0.003630 | 7.429 | 12.737 |
| `track2h_gaussian_nll_global` | `forward` | 0.002951 | 0.003246 | 6.524 | 15.237 |
| `track2h_gaussian_nll_global` | `combined` | 0.002951 | 0.003246 | 6.524 | 15.237 |
| `track2h_l_causal_tcn_offset_residual_global` | `forward` | 0.003267 | 0.003715 | 7.241 | 12.649 |
| `track2h_l_causal_tcn_offset_residual_global` | `combined` | 0.003267 | 0.003715 | 7.241 | 12.649 |
| `track2h_l_gru_offset_residual_global` | `forward` | 0.087641 | 0.087704 | 192.524 | 320.620 |
| `track2h_l_gru_offset_residual_global` | `combined` | 0.087641 | 0.087704 | 192.524 | 320.620 |
| `track2h_log_cosh_robust_global` | `forward` | 0.003515 | 0.003825 | 7.792 | 14.729 |
| `track2h_log_cosh_robust_global` | `combined` | 0.003515 | 0.003825 | 7.792 | 14.729 |
| `track2h_mae_robust_global` | `forward` | 0.003235 | 0.003544 | 7.189 | 12.856 |
| `track2h_mae_robust_global` | `combined` | 0.003235 | 0.003544 | 7.189 | 12.856 |
| `track2h_mdn_k2_global` | `forward` | 0.003263 | 0.003582 | 7.261 | 14.354 |
| `track2h_mdn_k2_global` | `combined` | 0.003263 | 0.003582 | 7.261 | 14.354 |
| `track2h_mdn_k3_global` | `forward` | 0.003415 | 0.003713 | 7.594 | 15.012 |
| `track2h_mdn_k3_global` | `combined` | 0.003415 | 0.003713 | 7.594 | 15.012 |
| `track2h_quantile_p10_p50_p90_global` | `forward` | 0.003188 | 0.003469 | 7.059 | 12.765 |
| `track2h_quantile_p10_p50_p90_global` | `combined` | 0.003188 | 0.003469 | 7.059 | 12.765 |
| `track2h_smooth_l1_robust_global` | `forward` | 0.003222 | 0.003507 | 7.161 | 12.021 |
| `track2h_smooth_l1_robust_global` | `combined` | 0.003222 | 0.003507 | 7.161 | 12.021 |
...
| `wave3_harmonic_prior_residual_pointwise_control_global` | `combined` | 0.003279 | 0.003550 | 7.289 | 14.109 |
| `wave3_harmonic_prior_residual_smooth_l1_structured_global` | `forward` | 0.087837 | 0.087893 | 192.823 | 321.880 |
| `wave3_harmonic_prior_residual_smooth_l1_structured_global` | `combined` | 0.087837 | 0.087893 | 192.823 | 321.880 |
| `wave52b_offset_centered_shape_harmonic_global` | `forward` | 0.080306 | 0.080373 | 176.296 | 312.921 |
| `wave52b_offset_centered_shape_harmonic_global` | `combined` | 0.080306 | 0.080373 | 176.296 | 312.921 |

## Artifacts

- summary YAML: `output\validation_checks\track2_reference_comparison\2026-07-05-08-06-21__track2_full_directional_family_matrix_track2_dataset_surface_simplified_dataset_forward_2026_07_04/validation_summary.yaml`;
- per-condition CSV: `output\validation_checks\track2_reference_comparison\2026-07-05-08-06-21__track2_full_directional_family_matrix_track2_dataset_surface_simplified_dataset_forward_2026_07_04\per_condition_metrics.csv`;
