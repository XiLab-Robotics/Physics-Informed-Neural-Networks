...
| `shape_first_distilled_periodic_gru_sequence_Fw` | `shape_first_training_rule_distillation` | `shape_first_distilled_periodic_gru_sequence_fw` | `Fw` | `forward` |
| `shape_first_distilled_periodic_mlp_harmonic_Fw` | `shape_first_training_rule_distillation` | `shape_first_distilled_periodic_mlp_harmonic_fw` | `Fw` | `forward` |
...
| `shape_first_distilled_periodic_gru_sequence_Fw` | `shape_first_distilled_periodic_gru_sequence_fw` | `Fw` | `` | `None` |
| `shape_first_distilled_periodic_mlp_harmonic_Fw` | `shape_first_distilled_periodic_mlp_harmonic_fw` | `Fw` | `` | `None` |
...
| 3 | `shape_first_distilled_periodic_gru_sequence_Fw` | 0.002032 | 0.002389 | 4.225 | 11.873 |
| 4 | `shape_first_distilled_periodic_mlp_harmonic_Fw` | 0.002079 | 0.002469 | 4.333 | 10.396 |
...
| `forward` | `shape_first_distilled_periodic_gru_sequence_Fw` | 0.002032 | 0.002389 | 4.225 | 11.873 |
| `forward` | `shape_first_distilled_periodic_mlp_harmonic_Fw` | 0.002079 | 0.002469 | 4.333 | 10.396 |

## Artifacts

- summary YAML: `output\validation_checks\track2_reference_comparison\2026-07-22-15-58-24__shape_first_distillation_bounded_track2_screen_polished_setpoints_fw_matrix_shape_first_distillation_bounded_track2_screen_polished_setpoints_fw/validation_summary.yaml`;
- per-condition CSV: `output\validation_checks\track2_reference_comparison\2026-07-22-15-58-24__shape_first_distillation_bounded_track2_screen_polished_setpoints_fw_matrix_shape_first_distillation_bounded_track2_screen_polished_setpoints_fw\per_condition_metrics.csv`;
- grouped report plot root: `doc\reports\campaign_results\track_2\verification_plots\shape_first_distillation_bounded_track2_screen_polished_setpoints_fw`;
