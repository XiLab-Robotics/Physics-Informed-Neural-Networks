...
| `causal_offset_mean_periodic_mlp_harmonic_Fw` | `causal_offset_mean_calibration_pilot` | `causal_offset_mean_periodic_mlp_harmonic_fw` | `Fw` | `forward` |
| `causal_offset_mean_gru_sequence_Fw` | `causal_offset_mean_calibration_pilot` | `causal_offset_mean_gru_sequence_fw` | `Fw` | `forward` |
...
| `causal_offset_mean_periodic_mlp_harmonic_Fw` | `causal_offset_mean_periodic_mlp_harmonic_fw` | `Fw` | `` | `None` |
| `causal_offset_mean_gru_sequence_Fw` | `causal_offset_mean_gru_sequence_fw` | `Fw` | `` | `None` |
...
| 4 | `causal_offset_mean_periodic_mlp_harmonic_Fw` | 0.002075 | 0.002478 | 4.314 | 9.717 |
| 5 | `causal_offset_mean_gru_sequence_Fw` | 0.002392 | 0.002868 | 5.010 | 10.269 |
...
| `forward` | `causal_offset_mean_periodic_mlp_harmonic_Fw` | 0.002075 | 0.002478 | 4.314 | 9.717 |
| `forward` | `causal_offset_mean_gru_sequence_Fw` | 0.002392 | 0.002868 | 5.010 | 10.269 |

## Artifacts

- summary YAML: `output\validation_checks\track2_reference_comparison\2026-07-23-15-58-54__causal_offset_bounded_track2_screen_polished_setpoints_fw_matrix_causal_offset_bounded_track2_screen_polished_setpoints_fw/validation_summary.yaml`;
- per-condition CSV: `output\validation_checks\track2_reference_comparison\2026-07-23-15-58-54__causal_offset_bounded_track2_screen_polished_setpoints_fw_matrix_causal_offset_bounded_track2_screen_polished_setpoints_fw\per_condition_metrics.csv`;
- grouped report plot root: `doc\reports\campaign_results\track_2\verification_plots\causal_offset_bounded_track2_screen_polished_setpoints_fw`;
