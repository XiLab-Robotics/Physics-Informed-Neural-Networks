...
| `wave52r_integrated_a02_seed_161803` | `combined` | 0.001402 | 0.001660 | 2.858 | 7.468 |
| `wave52r_integrated_a02_seed_271828` | `forward` | 0.001401 | 0.001660 | 2.858 | 7.466 |
| `wave52r_integrated_a02_seed_271828` | `combined` | 0.001401 | 0.001660 | 2.858 | 7.466 |
| `wave52r_integrated_a02_seed_314159` | `forward` | 0.001400 | 0.001658 | 2.856 | 7.463 |
| `wave52r_integrated_a02_seed_314159` | `combined` | 0.001400 | 0.001658 | 2.856 | 7.463 |
| `wave52r_integrated_a03_seed_161803` | `forward` | 0.001403 | 0.001662 | 2.862 | 7.462 |
| `wave52r_integrated_a03_seed_161803` | `combined` | 0.001403 | 0.001662 | 2.862 | 7.462 |
| `wave52r_integrated_a03_seed_271828` | `forward` | 0.001402 | 0.001661 | 2.859 | 7.477 |
| `wave52r_integrated_a03_seed_271828` | `combined` | 0.001402 | 0.001661 | 2.859 | 7.477 |
| `wave52r_integrated_a03_seed_314159` | `forward` | 0.001403 | 0.001662 | 2.861 | 7.485 |
| `wave52r_integrated_a03_seed_314159` | `combined` | 0.001403 | 0.001662 | 2.861 | 7.485 |
| `wave52r_integrated_a04_seed_161803` | `forward` | 0.001398 | 0.001655 | 2.848 | 7.309 |
| `wave52r_integrated_a04_seed_161803` | `combined` | 0.001398 | 0.001655 | 2.848 | 7.309 |
| `wave52r_integrated_a04_seed_271828` | `forward` | 0.001401 | 0.001658 | 2.853 | 7.389 |
| `wave52r_integrated_a04_seed_271828` | `combined` | 0.001401 | 0.001658 | 2.853 | 7.389 |
| `wave52r_integrated_a04_seed_314159` | `forward` | 0.001402 | 0.001661 | 2.858 | 7.424 |
| `wave52r_integrated_a04_seed_314159` | `combined` | 0.001402 | 0.001661 | 2.858 | 7.424 |
| `wave52r_integrated_a05_seed_161803` | `forward` | 0.001400 | 0.001658 | 2.852 | 7.278 |
| `wave52r_integrated_a05_seed_161803` | `combined` | 0.001400 | 0.001658 | 2.852 | 7.278 |
| `wave52r_integrated_a05_seed_271828` | `forward` | 0.001404 | 0.001663 | 2.860 | 7.346 |
| `wave52r_integrated_a05_seed_271828` | `combined` | 0.001404 | 0.001663 | 2.860 | 7.346 |
| `wave52r_integrated_a05_seed_314159` | `forward` | 0.001403 | 0.001662 | 2.859 | 7.349 |
| `wave52r_integrated_a05_seed_314159` | `combined` | 0.001403 | 0.001662 | 2.859 | 7.349 |
| `wave52r_integrated_a06_seed_161803` | `forward` | 0.001416 | 0.001678 | 2.884 | 7.548 |
| `wave52r_integrated_a06_seed_161803` | `combined` | 0.001416 | 0.001678 | 2.884 | 7.548 |
| `wave52r_integrated_a06_seed_271828` | `forward` | 0.001404 | 0.001662 | 2.858 | 7.230 |
| `wave52r_integrated_a06_seed_271828` | `combined` | 0.001404 | 0.001662 | 2.858 | 7.230 |
| `wave52r_integrated_a06_seed_314159` | `forward` | 0.001403 | 0.001661 | 2.857 | 7.301 |
| `wave52r_integrated_a06_seed_314159` | `combined` | 0.001403 | 0.001661 | 2.857 | 7.301 |
| `wave52r_integrated_a07_seed_161803` | `forward` | 0.001405 | 0.001664 | 2.862 | 7.491 |
| `wave52r_integrated_a07_seed_161803` | `combined` | 0.001405 | 0.001664 | 2.862 | 7.491 |
| `wave52r_integrated_a07_seed_271828` | `forward` | 0.001404 | 0.001662 | 2.860 | 7.369 |
| `wave52r_integrated_a07_seed_271828` | `combined` | 0.001404 | 0.001662 | 2.860 | 7.369 |
| `wave52r_integrated_a07_seed_314159` | `forward` | 0.001403 | 0.001661 | 2.858 | 7.197 |
| `wave52r_integrated_a07_seed_314159` | `combined` | 0.001403 | 0.001661 | 2.858 | 7.197 |
| `wave52r_integrated_a08_seed_161803` | `forward` | 0.001402 | 0.001660 | 2.858 | 7.468 |
| `wave52r_integrated_a08_seed_161803` | `combined` | 0.001402 | 0.001660 | 2.858 | 7.468 |
| `wave52r_integrated_a08_seed_271828` | `forward` | 0.001401 | 0.001660 | 2.858 | 7.466 |
| `wave52r_integrated_a08_seed_271828` | `combined` | 0.001401 | 0.001660 | 2.858 | 7.466 |
| `wave52r_integrated_a08_seed_314159` | `forward` | 0.001400 | 0.001658 | 2.856 | 7.463 |
| `wave52r_integrated_a08_seed_314159` | `combined` | 0.001400 | 0.001658 | 2.856 | 7.463 |
...
- summary YAML: `output\validation_checks\track2_reference_comparison\2026-08-03-21-58-09__wave52r_integrated_specialist_track2_wave52r_integrated_specialist_track2_forward/validation_summary.yaml`;
- per-condition CSV: `output\validation_checks\track2_reference_comparison\2026-08-03-21-58-09__wave52r_integrated_specialist_track2_wave52r_integrated_specialist_track2_forward\per_condition_metrics.csv`;
