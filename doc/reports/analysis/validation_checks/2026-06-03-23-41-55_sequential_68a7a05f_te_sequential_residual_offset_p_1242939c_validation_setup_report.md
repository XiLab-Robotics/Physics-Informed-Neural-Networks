...
- logical run name: `te_sequential_residual_offset_probe_remote_bw`;
- output run name: `te_sequential_residual_offset_probe_remote_bw_validation_check`;
- run instance id: `2026-06-03-23-41-33__te_sequential_residual_offset_probe_remote_bw_validation_check`;
...
| Field | Value |
| --- | --- |
| Config Path | `config/training/track2f_offset_aware_probe/campaigns/2026-06-03_track2f_offset_aware_probe_campaign/queue/03_sequential_residual_offset_probe_bw.yaml` |
| Output Directory | `output/validation_checks/sequential_residual_offset_probe_bw/2026-06-03-23-41-33__te_sequential_residual_offset_probe_remote_bw_validation_check` |
| Model Family | `sequential_residual_offset_probe_bw` |
| Model Type | `sequential_residual_offset_probe` |
