...
- logical run name: `te_phase2_pinn_h2_oscillator_periodic_closure_bw__polished_setpoints`;
- output run name: `te_phase2_pinn_h2_oscillator_periodic_closure_bw__polished_setpoints_validation_check`;
- run instance id: `2026-07-26-14-02-50__te_phase2_pinn_h2_oscillator_periodic_closure_bw__polished_setpoints_validation_check`;
...
| Field | Value |
| --- | --- |
| Config Path | `config/training/harmonic_kinematic_pinn/campaigns/2026-07-26_phase2_harmonic_kinematic_pinn/queue/006_h2_oscillator_periodic_closure_bw.yaml` |
| Output Directory | `output/validation_checks/phase2_pinn_h2_oscillator_periodic_closure_bw/2026-07-26-14-02-50__te_phase2_pinn_h2_oscillator_periodic_closure_bw__polished_setpoints_validation_check` |
| Model Family | `phase2_pinn_h2_oscillator_periodic_closure_bw` |
| Model Type | `harmonic_kinematic_pinn` |
