...
- logical run name: `te_stage4_h02_r2_deep__polished_setpoints_fw`;
- output run name: `te_stage4_h02_r2_deep__polished_setpoints_fw_validation_check`;
- run instance id: `2026-07-28-09-58-03__te_stage4_h02_r2_deep__polished_setpoints_fw_validation_check`;
...
| Field | Value |
| --- | --- |
| Config Path | `config/training/data_only_residual_capacity/campaigns/2026-07-28_wave52r_stage4_data_only_residual_capacity/queue/008_h02_r2_deep.yaml` |
| Output Directory | `output/validation_checks/stage4_h02_r2_deep/2026-07-28-09-58-03__te_stage4_h02_r2_deep__polished_setpoints_fw_validation_check` |
| Model Family | `stage4_h02_r2_deep` |
| Model Type | `data_only_residual_capacity` |
