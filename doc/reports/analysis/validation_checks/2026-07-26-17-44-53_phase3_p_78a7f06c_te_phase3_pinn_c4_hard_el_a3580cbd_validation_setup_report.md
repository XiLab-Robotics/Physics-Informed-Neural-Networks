...
- logical run name: `te_phase3_pinn_c4_hard_elastic_offset_fw__polished_setpoints`;
- output run name: `te_phase3_pinn_c4_hard_elastic_offset_fw__polished_setpoints_validation_check`;
- run instance id: `2026-07-26-17-44-49__te_phase3_pinn_c4_hard_elastic_offset_fw__polished_setpoints_validation_check`;
...
| Field | Value |
| --- | --- |
| Config Path | `config/training/quasi_static_compliance_pinn/campaigns/2026-07-26_phase3_quasi_static_compliance_pinn/queue/010_c4_hard_elastic_offset_fw.yaml` |
| Output Directory | `output/validation_checks/phase3_pinn_c4_hard_elastic_offset_fw/2026-07-26-17-44-49__te_phase3_pinn_c4_hard_elastic_offset_fw__polished_setpoints_validation_check` |
| Model Family | `phase3_pinn_c4_hard_elastic_offset_fw` |
| Model Type | `quasi_static_compliance_pinn` |
