...
- output run name: `te_periodic_lstm_sequence_remote_Fw_wave2b_probe`;
- run instance id: `2026-05-25-03-29-31__te_periodic_lstm_sequence_remote_fw_wave2b_probe`;
...
| Field | Value |
| --- | --- |
| Config Path | `config/training/hydra/wave2/materialized/training_configs/periodic_lstm_sequence_fw.yaml` |
| Output Directory | `output/validation_checks/periodic_lstm_sequence/2026-05-25-03-29-31__te_periodic_lstm_sequence_remote_fw_wave2b_probe` |
| Model Family | `periodic_lstm_sequence` |
| Model Type | `periodic_lstm_sequence` |
