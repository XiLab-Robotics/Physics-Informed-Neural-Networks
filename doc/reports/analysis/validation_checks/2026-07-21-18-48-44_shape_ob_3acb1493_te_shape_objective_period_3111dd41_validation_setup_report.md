...
- logical run name: `te_shape_objective_periodic_mlp_harmonic_fw__polished_setpoints`;
- output run name: `te_shape_objective_periodic_mlp_harmonic_fw__polished_setpoints_validation_check`;
- run instance id: `2026-07-21-18-48-43__te_shape_objective_periodic_mlp_harmonic_fw__polished_setpoints_validation_check`;
...
| Field | Value |
| --- | --- |
| Config Path | `config/training/shape_objective_followup/campaigns/2026-07-21_parallel_shape_objective_followup/queue/002_shape_objective_periodic_mlp_harmonic_fw.yaml` |
| Output Directory | `output/validation_checks/shape_objective_periodic_mlp_harmonic_fw/2026-07-21-18-48-43__te_shape_objective_periodic_mlp_harmonic_fw__polished_setpoints_validation_check` |
| Model Family | `shape_objective_periodic_mlp_harmonic_fw` |
| Model Type | `periodic_mlp` |
