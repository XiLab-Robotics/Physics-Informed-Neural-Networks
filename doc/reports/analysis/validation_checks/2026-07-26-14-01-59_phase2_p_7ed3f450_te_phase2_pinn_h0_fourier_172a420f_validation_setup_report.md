...
- logical run name: `te_phase2_pinn_h0_fourier_control_fw__polished_setpoints`;
- output run name: `te_phase2_pinn_h0_fourier_control_fw__polished_setpoints_validation_check`;
- run instance id: `2026-07-26-14-01-56__te_phase2_pinn_h0_fourier_control_fw__polished_setpoints_validation_check`;
...
| Field | Value |
| --- | --- |
| Config Path | `config/training/harmonic_kinematic_pinn/campaigns/2026-07-26_phase2_harmonic_kinematic_pinn/queue/001_h0_fourier_control_fw.yaml` |
| Output Directory | `output/validation_checks/phase2_pinn_h0_fourier_control_fw/2026-07-26-14-01-56__te_phase2_pinn_h0_fourier_control_fw__polished_setpoints_validation_check` |
| Model Family | `phase2_pinn_h0_fourier_control_fw` |
| Model Type | `harmonic_kinematic_pinn` |
