...
- logical run name: `te_phase3_pinn_c1_linear_compliance_soft_fw_seed_271828__polished_setpoints`;
- output run name: `te_phase3_pinn_c1_linear_compliance_soft_fw_seed_271828__polished_setpoints_validation_check`;
- run instance id: `2026-07-26-19-52-08__te_phase3_pinn_c1_linear_compliance_soft_fw_seed_271828__polished_setpoints_validation_check`;
...
| Field | Value |
| --- | --- |
| Config Path | `config/training/quasi_static_compliance_pinn/campaigns/2026-07-26_phase3_c1_fw_stability_repeat/queue/002_c1_linear_compliance_soft_fw_seed_271828.yaml` |
| Output Directory | `output/validation_checks/phase3_pinn_c1_linear_compliance_soft_fw_seed_271828/2026-07-26-19-52-08__te_phase3_pinn_c1_linear_compliance_soft_fw_seed_271828__polished_setpoints_validation_check` |
| Model Family | `phase3_pinn_c1_linear_compliance_soft_fw_seed_271828` |
| Model Type | `quasi_static_compliance_pinn` |
