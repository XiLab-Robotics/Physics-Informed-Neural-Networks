...
- `doc/reports/analysis/model_development_waves/wave_4/Wave 4A MMT Equation Diagnostic Design.md`;
- `doc/reports/analysis/model_development_waves/wave_4/Wave 4B MMT Feature Generator Design.md`;
- `doc/reports/analysis/model_development_waves/wave_4/Wave 4C MMT Soft Constraint PINN Design.md`;
- `doc/reports/analysis/model_development_waves/wave_4/Wave 4D Mesh Stiffness Loaded TE PINN Design.md`;
- `doc/reports/analysis/model_development_waves/wave_4/Wave 4E Backlash Preload State PINN Design.md`;
- `doc/reports/analysis/model_development_waves/wave_4/Wave 4F Cycloid Contact Force PINN Design.md`;
- `doc/reports/analysis/model_development_waves/wave_4/Wave 4G Planetary Mesh Force LSTE PINN Design.md`.
...
| Markdown report | `doc/reports/analysis/model_development_waves/wave_4/mmt_equation_diagnostic/[2026-06-11]/wave4a_mmt_equation_diagnostic.md`. |
...
| Markdown report | `doc/reports/analysis/model_development_waves/wave_4/mmt_parameter_inventory/[2026-06-11]/wave4a_mmt_parameter_inventory.md`. |
