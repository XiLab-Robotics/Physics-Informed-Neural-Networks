...
### Forward Wave 3 Harmonic Prior Residual Registry Models
...
### Backward Wave 3 Harmonic Prior Residual Registry Models
...
### Global Wave 3 Harmonic Prior Residual Registry Models
...
![track2h_mdn_k2_Fw Track 2 collage](assets/a_fw_trac_mixt_dens_head_reg_f6ec842d96/track2h_mdn_k2_fw.png)

track2h_mdn_k3_Fw:

![track2h_mdn_k3_Fw Track 2 collage](assets/a_fw_trac_mixt_dens_head_reg_f6ec842d96/track2h_mdn_k3_fw.png)

## Collage Gallery - Backward Track2h Mixture Density Heads Registry Models

track2h_mdn_k2_Bw:

![track2h_mdn_k2_Bw Track 2 collage](assets/a_bw_trac_mixt_dens_head_reg_18b372da4f/track2h_mdn_k2_bw.png)

track2h_mdn_k3_Bw:

![track2h_mdn_k3_Bw Track 2 collage](assets/a_bw_trac_mixt_dens_head_reg_18b372da4f/track2h_mdn_k3_bw.png)

## Collage Gallery - Global Track2h Mixture Density Heads Registry Models

track2h_mdn_k2_global:

![track2h_mdn_k2_global Track 2 collage](assets/a_mix_trac_mixt_dens_head_reg_434037e96c/track2h_mdn_k2_global.png)

track2h_mdn_k3_global:

![track2h_mdn_k3_global Track 2 collage](assets/a_mix_trac_mixt_dens_head_reg_434037e96c/track2h_mdn_k3_global.png)

## Collage Gallery - Forward Track2h Latent State Hysteresis Registry Models

track2h_l_gru_offset_residual_Fw:

![track2h_l_gru_offset_residual_Fw Track 2 collage](assets/a_fw_trac_late_stat_hyst_reg_b9a1d6d37a/track2h_l_gru_offset_residual_fw.png)

track2h_l_causal_tcn_offset_residual_Fw:

![track2h_l_causal_tcn_offset_residual_Fw Track 2 collage](assets/a_fw_trac_late_stat_hyst_reg_b9a1d6d37a/track2h_l_causal_tcn_offset_residual_fw.png)

## Collage Gallery - Backward Track2h Latent State Hysteresis Registry Models

track2h_l_gru_offset_residual_Bw:

![track2h_l_gru_offset_residual_Bw Track 2 collage](assets/a_bw_trac_late_stat_hyst_reg_7a4d528fe8/track2h_l_gru_offset_residual_bw.png)

track2h_l_causal_tcn_offset_residual_Bw:

![track2h_l_causal_tcn_offset_residual_Bw Track 2 collage](assets/a_bw_trac_late_stat_hyst_reg_7a4d528fe8/track2h_l_causal_tcn_offset_residual_bw.png)

## Collage Gallery - Global Track2h Latent State Hysteresis Registry Models

track2h_l_gru_offset_residual_global:

![track2h_l_gru_offset_residual_global Track 2 collage](assets/a_mix_trac_late_stat_hyst_reg_4bc86c3c52/track2h_l_gru_offset_residual_global.png)

track2h_l_causal_tcn_offset_residual_global:

![track2h_l_causal_tcn_offset_residual_global Track 2 collage](assets/a_mix_trac_late_stat_hyst_reg_4bc86c3c52/track2h_l_causal_tcn_offset_residual_global.png)

## Collage Gallery - Forward Wave 3 Harmonic Prior Residual Registry Models

wave3_harmonic_prior_residual_pointwise_control_Fw:

![wave3_harmonic_prior_residual_pointwise_control_Fw Track 2 collage](assets/a_fw_w3_harm_pri_res_reg_ae5ebf52ea/wave3_harmonic_prior_residual_pointwise_control_fw.png)

wave3_harmonic_prior_residual_smooth_l1_structured_Fw:

![wave3_harmonic_prior_residual_smooth_l1_structured_Fw Track 2 collage](assets/a_fw_w3_harm_pri_res_reg_ae5ebf52ea/wave3_harmonic_prior_residual_smooth_l1_structured_fw.png)

## Collage Gallery - Backward Wave 3 Harmonic Prior Residual Registry Models

wave3_harmonic_prior_residual_pointwise_control_Bw:

![wave3_harmonic_prior_residual_pointwise_control_Bw Track 2 collage](assets/a_bw_w3_harm_pri_res_reg_06ebe1c05e/wave3_harmonic_prior_residual_pointwise_control_bw.png)

wave3_harmonic_prior_residual_smooth_l1_structured_Bw:

![wave3_harmonic_prior_residual_smooth_l1_structured_Bw Track 2 collage](assets/a_bw_w3_harm_pri_res_reg_06ebe1c05e/wave3_harmonic_prior_residual_smooth_l1_structured_bw.png)

## Collage Gallery - Global Wave 3 Harmonic Prior Residual Registry Models

wave3_harmonic_prior_residual_pointwise_control_global:

![wave3_harmonic_prior_residual_pointwise_control_global Track 2 collage](assets/a_mix_w3_harm_pri_res_reg_66ff2b30f7/wave3_harmonic_prior_residual_pointwise_control_global.png)

wave3_harmonic_prior_residual_smooth_l1_structured_global:

![wave3_harmonic_prior_residual_smooth_l1_structured_global Track 2 collage](assets/a_mix_w3_harm_pri_res_reg_66ff2b30f7/wave3_harmonic_prior_residual_smooth_l1_structured_global.png)

## Output Artifacts

- output directory: `output\validation_checks\track2_best_model_collage_report\2026-06-18-15-45-41__track2_best_model_collage_report`;
- summary YAML: `output\validation_checks\track2_best_model_collage_report\2026-06-18-15-45-41__track2_best_model_collage_report\track2_best_model_collage_summary.yaml`;
- metrics CSV: `output\validation_checks\track2_best_model_collage_report\2026-06-18-15-45-41__track2_best_model_collage_report\track2_best_model_collage_metrics.csv`;
- report Markdown: `doc\reports\analysis\track2\best_model_collage_report\[2026-06-18]\track2_best_model_collage_report.md`.
