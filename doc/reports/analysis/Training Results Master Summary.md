...
| Track 2 offline model comparison | Direction-valid direct TE-curve comparison between paper-reference banks and repository models | Full matrix generated across `22` Track 1 family banks, `11` recovered original forward banks, `22` retuned banks, `15` Wave 1 exported surfaces, and `5` composed best-reference candidates, with a zero-violation direction audit and grouped PNG previews | populated_directional_offline |
