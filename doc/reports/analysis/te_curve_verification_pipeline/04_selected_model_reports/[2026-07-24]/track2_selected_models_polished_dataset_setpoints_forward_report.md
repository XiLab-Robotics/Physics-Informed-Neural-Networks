...
| 5 | `polished_setpoints_tree_Fw` | 0.002098 | 0.002536 | 4.314 | 8.754 |
| 6 | `polished_setpoints_feedforward_Fw` | 0.002407 | 0.002885 | 5.036 | 10.659 |
| 7 | `polished_setpoints_harmonic_regression_Fw` | 0.017220 | 0.017494 | 38.404 | 78.948 |
...
| --- | --- | ---: | ---: | ---: | ---: |
| `polished_setpoints_feedforward_Fw` | Selected candidate | 0.002407 | 0.002885 | 5.036 | 10.659 |
| `polished_setpoints_tree_Fw` | Selected candidate | 0.002098 | 0.002536 | 4.314 | 8.754 |
| `polished_setpoints_harmonic_regression_Fw` | Selected candidate | 0.017220 | 0.017494 | 38.404 | 78.948 |
| `polished_setpoints_periodic_mlp_harmonic_Fw` | Selected candidate | 0.001938 | 0.002276 | 3.988 | 10.017 |
| `polished_setpoints_periodic_gru_sequence_Fw` | Selected candidate | 0.001837 | 0.002179 | 3.751 | 8.248 |
| `polished_setpoints_wave4_1_mae_robust_loss_Fw` | Surface leader | 0.001767 | 0.002107 | 3.571 | 8.554 |
| `polished_setpoints_wave4_2_quantile_p10_p50_p90_Fw` | Selected candidate | 0.001835 | 0.002193 | 3.733 | 8.562 |

### polished_setpoints_feedforward_Fw

![polished_setpoints_feedforward_Fw measured-versus-predicted TE collage](assets/track2_selected_models_polished_dataset_setpoints_forward_report/polished_setpoints_feedforward_fw.png)

### polished_setpoints_tree_Fw

![polished_setpoints_tree_Fw measured-versus-predicted TE collage](assets/track2_selected_models_polished_dataset_setpoints_forward_report/polished_setpoints_tree_fw.png)

### polished_setpoints_harmonic_regression_Fw

![polished_setpoints_harmonic_regression_Fw measured-versus-predicted TE collage](assets/track2_selected_models_polished_dataset_setpoints_forward_report/polished_setpoints_harmonic_regression_fw.png)

### polished_setpoints_periodic_mlp_harmonic_Fw

![polished_setpoints_periodic_mlp_harmonic_Fw measured-versus-predicted TE collage](assets/track2_selected_models_polished_dataset_setpoints_forward_report/polished_setpoints_periodic_mlp_harmonic_fw.png)

### polished_setpoints_periodic_gru_sequence_Fw

![polished_setpoints_periodic_gru_sequence_Fw measured-versus-predicted TE collage](assets/track2_selected_models_polished_dataset_setpoints_forward_report/polished_setpoints_periodic_gru_sequence_fw.png)

### polished_setpoints_wave4_1_mae_robust_loss_Fw

![polished_setpoints_wave4_1_mae_robust_loss_Fw measured-versus-predicted TE collage](assets/track2_selected_models_polished_dataset_setpoints_forward_report/polished_setpoints_wave4_1_mae_robust_loss_fw.png)

### polished_setpoints_wave4_2_quantile_p10_p50_p90_Fw

![polished_setpoints_wave4_2_quantile_p10_p50_p90_Fw measured-versus-predicted TE collage](assets/track2_selected_models_polished_dataset_setpoints_forward_report/polished_setpoints_wave4_2_quantile_p10_p50_p90_fw.png)

## Artifacts

- summary YAML: `output\validation_checks\track2_reference_comparison\2026-07-24-13-31-04__track2_selected_active_polished_setpoints_matrix_track2_selected_polished_dataset_setpoints_forward_2026_07_24_13_30_33/validation_summary.yaml`;
- per-condition CSV: `output\validation_checks\track2_reference_comparison\2026-07-24-13-31-04__track2_selected_active_polished_setpoints_matrix_track2_selected_polished_dataset_setpoints_forward_2026_07_24_13_30_33\per_condition_metrics.csv`;
