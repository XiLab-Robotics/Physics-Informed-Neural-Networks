...
| `polished_actual_values_residual_harmonic_gru_sequence_sparse_rcim_Bw` | `polished_actual_values_sparse_rcim_temporal_reference` | `residual_harmonic_gru_sequence_sparse_rcim` | `Bw` | `backward` |
| `polished_actual_values_residual_harmonic_lstm_sequence_sparse_rcim_Bw` | `polished_actual_values_sparse_rcim_temporal_reference` | `residual_harmonic_lstm_sequence_sparse_rcim` | `Bw` | `backward` |
...
| `polished_actual_values_residual_harmonic_gru_sequence_sparse_rcim_Bw` | `residual_harmonic_gru_sequence_sparse_rcim` | `Bw` | `models/polished_dataset/actual_values/residual_harmonic_gru_sequence_sparse_rcim/backward/onnx/model.onnx` | `models/polished_dataset/actual_values/residual_harmonic_gru_sequence_sparse_rcim/backward/python/residual_harmonic_gru_sequence-epoch=200-val_mae=0.00195317.ckpt` |
| `polished_actual_values_residual_harmonic_lstm_sequence_sparse_rcim_Bw` | `residual_harmonic_lstm_sequence_sparse_rcim` | `Bw` | `models/polished_dataset/actual_values/residual_harmonic_lstm_sequence_sparse_rcim/backward/onnx/model.onnx` | `models/polished_dataset/actual_values/residual_harmonic_lstm_sequence_sparse_rcim/backward/python/residual_harmonic_lstm_sequence-epoch=010-val_mae=0.00215380.ckpt` |
...
| 4 | `polished_actual_values_residual_harmonic_gru_sequence_sparse_rcim_Bw` | 0.002306 | 0.002811 | 4.183 | 9.915 |
| 5 | `polished_actual_values_periodic_mlp_harmonic_Bw` | 0.002483 | 0.002914 | 4.321 | 10.519 |
| 6 | `polished_actual_values_residual_harmonic_lstm_sequence_sparse_rcim_Bw` | 0.002669 | 0.003164 | 4.692 | 10.333 |
| 7 | `polished_actual_values_feedforward_Bw` | 0.002769 | 0.003293 | 4.919 | 10.603 |
| 8 | `polished_actual_values_tree_Bw` | 0.002759 | 0.003293 | 4.935 | 10.731 |
| 9 | `polished_actual_values_harmonic_regression_Bw` | 0.002966 | 0.003511 | 5.369 | 10.974 |
...
| `backward` | `polished_actual_values_residual_harmonic_gru_sequence_sparse_rcim_Bw` | 0.002306 | 0.002811 | 4.183 | 9.915 |
| `backward` | `polished_actual_values_periodic_mlp_harmonic_Bw` | 0.002483 | 0.002914 | 4.321 | 10.519 |
| `backward` | `polished_actual_values_residual_harmonic_lstm_sequence_sparse_rcim_Bw` | 0.002669 | 0.003164 | 4.692 | 10.333 |
...
| `polished_actual_values_residual_harmonic_gru_sequence_sparse_rcim_Bw` | Selected candidate | 0.002306 | 0.002811 | 4.183 | 9.915 |
| `polished_actual_values_residual_harmonic_lstm_sequence_sparse_rcim_Bw` | Selected candidate | 0.002669 | 0.003164 | 4.692 | 10.333 |
...
![polished_actual_values_feedforward_Bw measured-versus-predicted TE collage](assets/track2_selected_models_polished_dataset_actual_values_backward_report/polished_actual_values_feedforward_bw.png)

### polished_actual_values_tree_Bw

![polished_actual_values_tree_Bw measured-versus-predicted TE collage](assets/track2_selected_models_polished_dataset_actual_values_backward_report/polished_actual_values_tree_bw.png)

### polished_actual_values_harmonic_regression_Bw

![polished_actual_values_harmonic_regression_Bw measured-versus-predicted TE collage](assets/track2_selected_models_polished_dataset_actual_values_backward_report/polished_actual_values_harmonic_regression_bw.png)

### polished_actual_values_periodic_mlp_harmonic_Bw

![polished_actual_values_periodic_mlp_harmonic_Bw measured-versus-predicted TE collage](assets/track2_selected_models_polished_dataset_actual_values_backward_report/polished_actual_values_periodic_mlp_harmonic_bw.png)

### polished_actual_values_periodic_gru_sequence_Bw

![polished_actual_values_periodic_gru_sequence_Bw measured-versus-predicted TE collage](assets/track2_selected_models_polished_dataset_actual_values_backward_report/polished_actual_values_periodic_gru_sequence_bw.png)

### polished_actual_values_residual_harmonic_gru_sequence_sparse_rcim_Bw

![polished_actual_values_residual_harmonic_gru_sequence_sparse_rcim_Bw measured-versus-predicted TE collage](assets/track2_selected_models_polished_dataset_actual_values_backward_report/polished_actual_values_residual_harmonic_gru_sequence_sparse_rcim_bw.png)

### polished_actual_values_residual_harmonic_lstm_sequence_sparse_rcim_Bw

![polished_actual_values_residual_harmonic_lstm_sequence_sparse_rcim_Bw measured-versus-predicted TE collage](assets/track2_selected_models_polished_dataset_actual_values_backward_report/polished_actual_values_residual_harmonic_lstm_sequence_sparse_rcim_bw.png)

### polished_actual_values_wave4_1_mae_robust_loss_Bw

![polished_actual_values_wave4_1_mae_robust_loss_Bw measured-versus-predicted TE collage](assets/track2_selected_models_polished_dataset_actual_values_backward_report/polished_actual_values_wave4_1_mae_robust_loss_bw.png)

### polished_actual_values_wave4_2_quantile_p10_p50_p90_Bw

![polished_actual_values_wave4_2_quantile_p10_p50_p90_Bw measured-versus-predicted TE collage](assets/track2_selected_models_polished_dataset_actual_values_backward_report/polished_actual_values_wave4_2_quantile_p10_p50_p90_bw.png)

## Artifacts

- summary YAML: `output\validation_checks\track2_reference_comparison\2026-07-24-13-40-28__track2_selected_active_polished_actual_values_matrix_track2_selected_polished_dataset_actual_values_backward_2026_07_24_13_30_33/validation_summary.yaml`;
- per-condition CSV: `output\validation_checks\track2_reference_comparison\2026-07-24-13-40-28__track2_selected_active_polished_actual_values_matrix_track2_selected_polished_dataset_actual_values_backward_2026_07_24_13_30_33\per_condition_metrics.csv`;
