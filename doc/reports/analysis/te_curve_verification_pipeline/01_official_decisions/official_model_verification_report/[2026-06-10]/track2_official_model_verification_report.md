...
- validation report:
  `doc/reports/analysis/validation_checks/te_curve_verification_pipeline/2026-06-09-13-33-45_track2_full_directional_family_matrix_track2g_curve_aware_track2_refresh_2026_06_09_report.md`;
- best-model collage report:
  `doc/reports/analysis/te_curve_verification_pipeline/02_visual_reports/best_model_collage_report/[2026-06-09]/track2_best_model_collage_report.md`;
- multi-model curve comparison report:
  `doc/reports/analysis/te_curve_verification_pipeline/02_visual_reports/multi_model_curve_comparison_report/[2026-06-09]/track2_multi_model_curve_comparison_report.md`.
