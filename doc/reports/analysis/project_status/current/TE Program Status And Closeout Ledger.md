...
| Latest official TE Curve Verification refresh | Wave 5.2R integrated-specialist review, dated `2026-08-04`; separate matrices covered `27` Fw, `26` Bw, and `24` global candidates over `97`, `97`, and `194` curves, followed by CVP 1.2 diagnostics and visual review |
| Latest curve-verification decision | A02 seed `314159` is the veto-free `Fw` and routed `global` recommendation. K01 seed `271828` remains recommended on `Bw`. A03-A07 retain failed-gate vetoes, and accepted registries remain unchanged. |
...
| Latest deployment-preparation gate | A02 seed `314159` passed exact campaign reconstruction, ONNX Runtime, and independent float32 PLC-reference parity on all 194 test curves. Beckhoff TF3820 preparation and static standalone-catalog validation pass. XAE build, activated-target inference, timing, and commissioned runtime remain pending. |
| Latest curated model-archive refresh | The verified offline A02 fixed-grid composer was added on `2026-08-04`, bringing the polished-setpoint aggregate to `114` leaves: `38` global, `39` forward, and `37` backward. Its K01/H08 dependencies and parity evidence are explicit. Archive preservation does not change accepted registries or deployment leaders. |
...
| Wave 5.2R A02 export and static TF3820 qualification | export-prepared; runtime pending | Exact campaign reconstruction, ONNX Runtime, and independent float32 PLC-reference parity pass on all 194 official curves. The backward residual and prediction-versus-K01 error are zero. Beckhoff TF3820 preparation and the 40-package standalone catalog pass static checks. | Preserve the A02 curated archive without changing accepted registries. Proceed to XAE build and activated-target replay with exact upstream K01/H08 curves; do not claim runtime or commissioned compensation yet. |
