...
| Latest non-training PINN gate | Phase 12 hybrid audit verified four evidence files and eight quantities; five architectures are empirically trainable, but none is full-PINN eligible because no isolated physical residual was promoted |
...
| Next modeling decision | Phases 0 through 12 are complete; begin Phase 13 cross-formulation tournament entry and no-contest gating |
...
| Wave 5.2 general full-PINN program | Phases 0 through 12 complete; Phase 13 active next | Phases 4 through 12 preserve every tested mechanism and separate empirical hybrid feasibility from full-PINN eligibility. | Start Phase 13 with tournament-entry gating; do not train a zero-candidate tournament. |
| Wave 5.2 complete theory-validation program | Phases 0 through 12 of 16 complete | Sixteen phases preserve every ingested mechanism through common foundations, isolated formulations, synthetic and offline oracles, causal reconstruction, instrumentation gates, cross-formulation comparison, multi-physics integration, and Wave 6 entry criteria. | Continue Phase 13 as a roster and comparison gate. |
...
1. Treat Phases 0 through 12 as complete and keep the general Wave 5.2
   full-PINN program active at the Phase 13 tournament-entry gate.
2. Build the complete formulation roster and require an eligible isolated
   full-PINN candidate before authorizing any tournament training.
