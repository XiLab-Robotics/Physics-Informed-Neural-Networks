...
- Generated At: `2026-07-10T02:03:45`
...
| `residual_harmonic_lstm_sequence_dense240_global` | Implemented Benchmark | `te_residual_harmonic_lstm_sequence_dense240_global` | `residual_harmonic_lstm_sequence` | 0.002161 | 201,314 | `2026-07-10 00:54:03` |
...
| `residual_harmonic_lstm_sequence_dense240_fw` | Implemented Benchmark | `te_residual_harmonic_lstm_sequence_dense240_fw` | `residual_harmonic_lstm_sequence` | 0.002147 | 201,314 | `2026-07-10 01:19:43` |
...
| `residual_harmonic_lstm_sequence_dense240_bw` | Implemented Benchmark | `te_residual_harmonic_lstm_sequence_dense240_bw` | `residual_harmonic_lstm_sequence` | 0.002164 | 201,314 | `2026-07-10 01:46:42` |
...
| --- | --- | ---: | ---: | --- | --- |
| `dataset_input_mode_retraining__residual_harmonic_lstm_sequence_dense240__polished_setpoints` | `2026-07-10 01:46:42` | 3 | 0 | `te_residual_harmonic_lstm_sequence_dense240_fw__polished_setpoints` | No family-best change |
| `dataset_input_mode_retraining__residual_harmonic_lstm_sequence_dense240__simplified_setpoints` | `2026-07-10 00:20:55` | 3 | 0 | `te_residual_harmonic_lstm_sequence_dense240_fw__simplified_setpoints` | No family-best change |
| `dataset_input_mode_retraining__residual_harmonic_lstm_sequence_sparse_rcim__polished_actual_values` | `2026-07-09 22:49:53` | 3 | 0 | `te_residual_harmonic_lstm_sequence_sparse_rcim_fw__polished_actual_values` | Updated residual_harmonic_lstm_sequence_sparse_rcim_fw family best |
...
| 4 | `te_residual_harmonic_lstm_sequence_dense240_fw__polished_setpoints` | `residual_harmonic_lstm_sequence` | 0.002275 | 0.003636 | 0.001995 | 201,826 | 25m 40s | 2.33 MB | Very High | Medium | `dataset_input_mode_retraining__residual_harmonic_lstm_sequence_dense240__polished_setpoints` |
| 5 | `te_residual_harmonic_lstm_sequence_dense240_global__polished_setpoints` | `residual_harmonic_lstm_sequence` | 0.002297 | 0.003647 | 0.002004 | 201,826 | 20m 56s | 2.33 MB | Very High | Medium | `dataset_input_mode_retraining__residual_harmonic_lstm_sequence_dense240__polished_setpoints` |
| 6 | `te_residual_harmonic_lstm_sequence_dense240_bw__polished_setpoints` | `residual_harmonic_lstm_sequence` | 0.002316 | 0.003665 | 0.002005 | 201,826 | 26m 59s | 2.33 MB | Very High | Medium | `dataset_input_mode_retraining__residual_harmonic_lstm_sequence_dense240__polished_setpoints` |
| 7 | `te_residual_harmonic_lstm_sequence_dense240_fw__simplified_setpoints` | `residual_harmonic_lstm_sequence` | 0.003354 | 0.004116 | 0.003561 | 201,826 | 21m 52s | 2.33 MB | Very High | Medium | `dataset_input_mode_retraining__residual_harmonic_lstm_sequence_dense240__simplified_setpoints` |
| 8 | `te_residual_harmonic_lstm_sequence_dense240_bw__simplified_setpoints` | `residual_harmonic_lstm_sequence` | 0.003367 | 0.004145 | 0.003586 | 201,826 | 27m 02s | 2.33 MB | Very High | Medium | `dataset_input_mode_retraining__residual_harmonic_lstm_sequence_dense240__simplified_setpoints` |
| 9 | `te_residual_harmonic_lstm_sequence_dense240_global__simplified_setpoints` | `residual_harmonic_lstm_sequence` | 0.003381 | 0.004182 | 0.003604 | 201,826 | 17m 53s | 2.33 MB | Very High | Medium | `dataset_input_mode_retraining__residual_harmonic_lstm_sequence_dense240__simplified_setpoints` |
| 10 | `te_residual_harmonic_lstm_sequence_remote_global_dense240` | `residual_harmonic_lstm_sequence` | 0.003473 | 0.003925 | 0.003624 | 201,826 | 13m 54s | 2.33 MB | Very High | Low | `wave2c_residual_harmonic_temporal_hybrid_campaign_2026_05_27` |
