...
```powershell
.\scripts\\campaigns\\track1\\svm\\run_track1_svm_final_closure_campaign.ps1
```
...
- `doc/reports/campaign_plans/track_1/svm/2026-04-14-20-50-01_track1_svm_final_closure_campaign_plan_report.md`
