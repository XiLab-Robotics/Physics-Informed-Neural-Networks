# Track 1 Forward Last Three Open Cells Campaign Launcher

## Overview

This launcher executes the prepared final targeted forward-only `Track 1`
original-dataset residual repair campaign.

The script is stored in:

- `scripts/campaigns/track1/exact_paper/run_track1_forward_last_three_open_cells_campaign.ps1`
...
```powershell
conda run -n standard_ml_codex_env python scripts/campaigns/track1/exact_paper/prepare_track1_forward_last_three_open_cells_campaign.py
```
