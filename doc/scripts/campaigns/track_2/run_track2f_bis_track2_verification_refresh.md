...
```powershell
.\scripts\campaigns\track_2\run_track2f_bis_track2_verification_refresh.ps1
```
...
- `doc/reports/analysis/te_curve_verification_pipeline/02_visual_reports/best_model_collage_report/[2026-06-08]/`
- `doc/reports/analysis/te_curve_verification_pipeline/02_visual_reports/multi_model_curve_comparison_report/[2026-06-08]/`
...
- `doc/reports/campaign_results/track_2/verification_plots/track2f_bis_harmonic_offset_probe_registry/`
  when present.
