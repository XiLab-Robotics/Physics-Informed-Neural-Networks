# Wave 4.4 TE Curve Verification Pipeline Verification Refresh Launcher

## Overview

This launcher runs the operator-approved official `TE Curve Verification Pipeline` offline
verification refresh for the completed `Wave 4.4` latent-state /
...
`Wave 4.4` family registries, `Wave 4.4` training-run artifacts, and the
