# RCIM Model-Bank Reproduction HGBM Remaining Yellow-Cell Campaign Launcher
...
```powershell
.\scripts\campaigns\track_1\exact_paper\run_track1_hgbm_remaining_yellow_cell_campaign.ps1 -Remote
```
