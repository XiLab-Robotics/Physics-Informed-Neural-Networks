...
```powershell
.\scripts\campaigns\track2\run_wave3_harmonic_prior_residual_track2_verification_refresh.ps1
```
...
```powershell
.\scripts\campaigns\track2\run_wave3_harmonic_prior_residual_track2_verification_refresh.ps1 -Remote
```
...
- `doc/reports/campaign_results/track 2/wave3_harmonic_prior_residual_registry/`
  when present.
