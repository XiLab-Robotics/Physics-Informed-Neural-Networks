...
```powershell
.\scripts\campaigns\track2\run_track2h_quantile_probabilistic_track2_verification_refresh.ps1
```
...
```powershell
.\scripts\campaigns\track2\run_track2h_quantile_probabilistic_track2_verification_refresh.ps1 -Remote
```
...
- `doc/reports/campaign_results/track 2/track2h_quantile_probabilistic_registry/`
  when present.
