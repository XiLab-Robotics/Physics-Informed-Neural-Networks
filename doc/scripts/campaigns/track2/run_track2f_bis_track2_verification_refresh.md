...
```powershell
.\scripts\campaigns\track2\run_track2f_bis_track2_verification_refresh.ps1
```
...
```powershell
.\scripts\campaigns\track2\run_track2f_bis_track2_verification_refresh.ps1 -Remote
```
...
- `doc/reports/analysis/track2/best_model_collage_report/[2026-06-08]/`
- `doc/reports/analysis/track2/multi_model_curve_comparison_report/[2026-06-08]/`
...
- `doc/reports/campaign_results/track 2/track2f_bis_harmonic_offset_probe_registry/`
  when present.
