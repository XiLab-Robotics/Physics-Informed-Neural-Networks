# Track 1 Forward Last Four Open Cells Campaign Launcher
...
- `scripts/campaigns/track1/exact_paper/run_track1_forward_last_four_open_cells_campaign.ps1`
...
```powershell
conda run -n standard_ml_codex_env python scripts/campaigns/track1/exact_paper/prepare_track1_forward_last_four_open_cells_campaign.py
```
