# RCIM Model-Bank Reproduction DT Residual Cellwise Closure Campaign Launcher

This launcher runs the aggressive overnight residual-cell closure wave for the exact-paper `DT` family.
