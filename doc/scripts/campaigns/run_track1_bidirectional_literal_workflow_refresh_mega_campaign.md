...
- `scripts/campaigns/track1/exact_paper/run_track1_bidirectional_literal_workflow_refresh_mega_campaign.ps1`
...
- `output/training_campaigns/track1/exact_paper/bidirectional_literal_workflow_refresh/<campaign_name>/`
...
```powershell
conda run -n standard_ml_codex_env python scripts/campaigns/track1/exact_paper/prepare_track1_bidirectional_literal_workflow_refresh_mega_campaign.py
```
