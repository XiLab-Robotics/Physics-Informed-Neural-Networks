...
- `scripts/campaigns/track_1/exact_paper/run_track1_bidirectional_literal_workflow_refresh_mega_campaign.ps1`
...
```powershell
conda run -n pinns_env python scripts/campaigns/track_1/exact_paper/prepare_track1_bidirectional_literal_workflow_refresh_mega_campaign.py
```
