...
```powershell
.\scripts\campaigns\wave3\run_wave3_harmonic_prior_residual_campaign.ps1 -PreflightOnly -RunOneBatchValidation
```

## Local Enqueue Only

```powershell
.\scripts\campaigns\wave3\run_wave3_harmonic_prior_residual_campaign.ps1 -EnqueueOnly
```
