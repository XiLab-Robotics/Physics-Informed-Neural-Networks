...
- `original_dataset_exact_model_bank/`
  ...
  canonical dataset, including forward/backward RCIM Model-Bank Reproduction campaign execution,
...
RCIM Model-Bank Reproduction is closed for the current full-dataset paper-faithful surface. The
