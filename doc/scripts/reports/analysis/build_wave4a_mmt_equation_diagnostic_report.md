# Build Wave 4A MMT Equation Diagnostic Report
...
generates a diagnostic-only report for `Wave 4A`.
...
MMT equation chain is useful enough to justify the later `Wave 4B` or `Wave
