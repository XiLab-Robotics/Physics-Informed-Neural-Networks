...
This archive stores the canonical `DT` Track 1 reference model artifacts that
...
accepted repository-owned `DT` benchmark row.
...
access paths for the accepted `DT` reference row:
