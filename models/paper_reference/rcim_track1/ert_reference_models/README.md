# ERT Reference Models

This archive stores the canonical `ERT` Track 1 reference model artifacts that
...
accepted repository-owned `ERT` benchmark row.
...
access paths for the accepted `ERT` reference row:
