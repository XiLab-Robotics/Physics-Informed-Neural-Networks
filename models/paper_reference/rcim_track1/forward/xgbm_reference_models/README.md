# XGBM Reference Models

This archive stores the canonical `XGBM` Track 1 reference model artifacts that
...
- `2026-04-10-17-19-53__rcim_exact_paper_model_bank_exact_paper_validation_after_fix`
...
accepted repository-owned `XGBM` benchmark row.
...
access paths for the accepted `XGBM` reference row:
