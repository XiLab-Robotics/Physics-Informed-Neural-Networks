...
This archive stores the canonical `ET` Track 1 reference model artifacts that
...
accepted repository-owned `ET` benchmark row.
...
access paths for the accepted `ET` reference row:
