...
This archive stores the canonical `RF` Track 1 reference model artifacts that
...
accepted repository-owned `RF` benchmark row.
...
access paths for the accepted `RF` reference row:
