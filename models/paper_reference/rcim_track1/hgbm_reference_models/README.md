# HGBM Reference Models

This archive stores the canonical `HGBM` Track 1 reference model artifacts that
...
accepted repository-owned `HGBM` benchmark row.
...
access paths for the accepted `HGBM` reference row:
