...
- Run Name: `te_harmonic_order12_linear_conditioned_recovery_Fw_grid_order8_lr0002_stride1`
...
The held-out val error stayed finite with MAE=0.002799 deg and RMSE=0.003344 deg, which indicates a numerically stable baseline run.
The held-out test error stayed finite with MAE=0.003121 deg and RMSE=0.003553 deg, which indicates a numerically stable baseline run.
