...
- Run Name: `te_harmonic_order12_linear_conditioned_recovery_global_grid_order12_lr0002_stride1`
...
The held-out val error stayed finite with MAE=0.017009 deg and RMSE=0.018585 deg, which indicates a numerically stable baseline run.
The held-out test error stayed finite with MAE=0.020781 deg and RMSE=0.022433 deg, which indicates a numerically stable baseline run.
