...
- Run Name: `te_harmonic_order12_linear_conditioned_recovery_Bw_grid_order8_lr0001_stride5`
...
The held-out val error stayed finite with MAE=0.003697 deg and RMSE=0.004256 deg, which indicates a numerically stable baseline run.
The held-out test error stayed finite with MAE=0.003516 deg and RMSE=0.004076 deg, which indicates a numerically stable baseline run.
