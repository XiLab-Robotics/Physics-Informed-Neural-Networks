...
- Run Name: `te_harmonic_order12_linear_conditioned_recovery_Bw_grid_order8_lr00005_stride1`
...
The held-out val error stayed finite with MAE=0.003743 deg and RMSE=0.004283 deg, which indicates a numerically stable baseline run.
The held-out test error stayed finite with MAE=0.003497 deg and RMSE=0.004053 deg, which indicates a numerically stable baseline run.
