...
- Run Name: `te_harmonic_order12_linear_conditioned_recovery_Bw_grid_order12_lr00005_stride5`
...
The held-out val error stayed finite with MAE=0.003729 deg and RMSE=0.004274 deg, which indicates a numerically stable baseline run.
The held-out test error stayed finite with MAE=0.003506 deg and RMSE=0.004063 deg, which indicates a numerically stable baseline run.
