...
`track1_rf_full_matrix_campaign_2026_04_18_00_48_05`.
...
- Near paper cells: `8`
- Open paper cells: `3`
- Mean normalized gap ratio: `0.144239`
- Max normalized gap ratio: `0.797487`
- Failed exports: `0`

## Interpretation

This winner is the bookkeeping representative for the completed RF full-matrix exact-paper rerun package. It serializes the stronger of the amplitude and phase reruns under the explicit row-closure policy and does not imply that the family closes RCIM Model-Bank Reproduction by itself.
