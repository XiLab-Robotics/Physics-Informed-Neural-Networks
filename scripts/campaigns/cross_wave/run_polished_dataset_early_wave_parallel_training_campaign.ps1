...
$CampaignName = "polished_dataset_early_wave_parallel_training_2026_06_25"
$CampaignManifestPath = "config/training/polished_dataset_retraining/campaigns/2026-06-25_polished_early_wave_parallel_training/campaign.yaml"
$PlanningReportPath = "doc/reports/campaign_plans/cross_wave/polished_dataset/2026-06-25-15-28-26_polished_early_wave_parallel_training_campaign_plan_report.md"
$ValidatorPath = "scripts/campaigns/cross_wave/validate_polished_dataset_retraining_campaign_package.py"
$QueueRoot = "config\training\queue\polished_dataset_early_wave_parallel_training"
...
Write-Host "[INFO] Scope: early-wave subset | runs=36 | surfaces=global,fw,bw"
...
Write-Host "[STEP] Launching local polished early-wave parallel training campaign."
