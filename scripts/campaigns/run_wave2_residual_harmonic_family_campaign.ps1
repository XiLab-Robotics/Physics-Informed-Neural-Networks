...
$campaignConfigRoot = "config\training\residual_harmonic_mlp\campaigns\2026-03-26_wave2_residual_harmonic_family_campaign"
$planningReportPath = "doc\reports\campaign_plans\2026-03-26-13-52-00_wave2_residual_harmonic_family_campaign_plan_report.md"
...
$argumentList = @(
    ...
    "--campaign-name",
    "wave2_residual_harmonic_family_campaign_2026_03_26_13_52_00",
