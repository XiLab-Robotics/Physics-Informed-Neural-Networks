...
while [[ $# -gt 0 ]]; do
    case "$1" in
        ...
        --dry-run)
            ...
            ;;
        --help|-h)
            echo "Usage: bash scripts/campaigns/wave1/run_wave1_directional_retraining_campaign.sh [--python-executable COMMAND] [--dry-run]"
            exit 0
            ;;
        *)
...
PLANNING_REPORT_PATH="doc/reports/campaign_plans/wave1/2026-05-06-16-07-16_wave1_directional_retraining_campaign_plan_report.md"
