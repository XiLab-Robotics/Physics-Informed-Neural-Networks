...
while [[ $# -gt 0 ]]; do
    case "$1" in
        ...
        --dry-run)
            ...
            ;;
        --help|-h)
            echo "Usage: bash scripts/campaigns/wave1/run_wave1_directional_best_hyperparameter_search_campaign.sh [--conda-environment-name NAME] [--python-executable COMMAND] [--gpu-id-list 0,1] [--skip-grid-phase] [--dry-run]"
            exit 0
            ;;
        *)
...
PLANNING_REPORT_PATH="doc/reports/campaign_plans/wave1/2026-05-11-19-41-11_wave1_directional_best_hyperparameter_search_campaign_plan_report.md"
