...
PLANNING_REPORT_PATH = Path("doc/reports/campaign_plans/wave1/2026-05-20-22-42-49_wave1_periodic_mlp_explicit_harmonic_tracking_campaign_plan_report.md")
...
LAUNCHER_PATH = Path("scripts/campaigns/wave1/run_wave1_periodic_mlp_explicit_harmonic_tracking_campaign.ps1")
