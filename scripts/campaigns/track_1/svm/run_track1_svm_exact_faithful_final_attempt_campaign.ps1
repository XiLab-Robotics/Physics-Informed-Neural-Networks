...
for ($configIndex = 0; $configIndex -lt $campaignConfigPathList.Count; $configIndex++) {
    ...
    if ($nativeExitCode -ne 0) {
        Write-Host "[ERROR] Exact-paper SVM faithful-final campaign run failed | $configPath" -ForegroundColor Red
...
Write-Host ""
Write-Host "[DONE] Exact-paper SVM faithful-final campaign completed successfully" -ForegroundColor Green
