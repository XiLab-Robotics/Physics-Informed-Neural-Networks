...
$planningReportPath = "doc\reports\campaign_plans\track_1\svm\2026-04-14-22-53-48_track1_svr_reference_grid_search_repair_campaign_plan_report.md"
...
$requiredRemoteSourcePathList = @($resolvedCampaignConfigPathList + @($resolvedPlanningReportPath, "scripts\campaigns\track_1\svm\run_track1_svr_reference_grid_search_repair_campaign.ps1", "scripts\campaigns\infrastructure\shared_streaming_campaign_launcher.ps1"))
...
`$launcherPath = Join-Path '$remoteExecutionRoot' 'scripts\campaigns\track_1\svm\run_track1_svr_reference_grid_search_repair_campaign.ps1'
