...
VALIDATION_REPORT_ROOT="doc/reports/analysis/validation_checks/rcim_model_bank_reproduction/track1/exact_paper/forward"
...
print_usage() {
    cat <<'USAGE'
Usage:
  bash scripts/campaigns/track_1/exact_paper/run_exact_paper_campaign_remote.sh [options] -- [launcher arguments]
