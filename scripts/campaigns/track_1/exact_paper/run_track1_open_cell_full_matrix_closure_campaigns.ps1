...
Write-Host "[INFO] Aggregate Track 1 Open-Cell Full-Matrix Closure Launcher Count | $($launcherRelativePathList.Count)" -ForegroundColor Cyan
...
Write-Host ""
Write-Host "[DONE] Track 1 open-cell full-matrix closure campaign sequence completed successfully" -ForegroundColor Green
exit 0
