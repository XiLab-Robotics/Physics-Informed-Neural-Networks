...
$campaignConfigRoot = "config\paper_reimplementation\rcim_ml_compensation\exact_model_bank\campaigns\track1\exact_paper\forward\remaining_yellow_cells\et\2026-04-22_track1_et_remaining_yellow_cell_campaign"
...
$campaignName = "track1_et_remaining_yellow_cell_campaign_2026_04_22_01_40_43"
...
if ($Remote) {
    & ".\scripts\campaigns\track_1\exact_paper\run_exact_paper_campaign_remote.ps1" `
        ...
        -LauncherRelativePath "scripts\campaigns\track_1\exact_paper\run_track1_et_remaining_yellow_cell_campaign.ps1" `
