...
$campaignConfigRoot = "config\paper_reimplementation\rcim_ml_compensation\exact_model_bank\campaigns\track1\exact_paper\forward\remaining_yellow_cells\hgbm\2026-04-22_track1_hgbm_remaining_yellow_cell_campaign"
$planningReportPath = "doc\reports\campaign_plans\track_1\exact_paper\2026-04-22-01-40-43_track1_remaining_yellow_cell_multi_family_campaign_bundle_plan_report.md"
$campaignName = "track1_hgbm_remaining_yellow_cell_campaign_2026_04_22_01_40_43"
...
if ($Remote) {
    & ".\scripts\campaigns\track_1\exact_paper\run_exact_paper_campaign_remote.ps1" `
        ...
        -LauncherRelativePath "scripts\campaigns\track_1\exact_paper\run_track1_hgbm_remaining_yellow_cell_campaign.ps1" `
