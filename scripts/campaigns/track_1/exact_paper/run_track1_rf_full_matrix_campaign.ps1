...
$campaignConfigFileNameList = @(
    "01_track1_rf_amplitude_full_matrix.yaml"
    "02_track1_rf_phase_full_matrix.yaml"
)
$campaignConfigPathList = @(
    (Join-Path $campaignConfigRoot "01_track1_rf_amplitude_full_matrix.yaml")
    (Join-Path $campaignConfigRoot "02_track1_rf_phase_full_matrix.yaml")
)
$runNameList = @(
    "track1_rf_amplitude_full_matrix"
...
if ($Remote) {
    & ".\scripts\campaigns\track_1\exact_paper\run_exact_paper_campaign_remote.ps1" `
        ...
        -LauncherRelativePath "scripts\campaigns\track_1\exact_paper\run_track1_rf_full_matrix_campaign.ps1" `
