...
$launcherRelativePathList = @(
    "scripts\campaigns\track_1\exact_paper\run_track1_mlp_cellwise_reference_campaign.ps1"
    "scripts\campaigns\track_1\exact_paper\run_track1_rf_cellwise_reference_campaign.ps1"
    "scripts\campaigns\track_1\exact_paper\run_track1_dt_cellwise_reference_campaign.ps1"
    "scripts\campaigns\track_1\exact_paper\run_track1_et_cellwise_reference_campaign.ps1"
    "scripts\campaigns\track_1\exact_paper\run_track1_ert_cellwise_reference_campaign.ps1"
    "scripts\campaigns\track_1\exact_paper\run_track1_gbm_cellwise_reference_campaign.ps1"
    "scripts\campaigns\track_1\exact_paper\run_track1_hgbm_cellwise_reference_campaign.ps1"
    "scripts\campaigns\track_1\exact_paper\run_track1_xgbm_cellwise_reference_campaign.ps1"
    "scripts\campaigns\track_1\exact_paper\run_track1_lgbm_cellwise_reference_campaign.ps1")

Write-Host "[INFO] Aggregate RCIM Model-Bank Reproduction Remaining Family Cellwise Launcher Count | $($launcherRelativePathList.Count)" -ForegroundColor Cyan
...
Write-Host ""
Write-Host "[DONE] RCIM Model-Bank Reproduction remaining family cellwise reference campaign sequence completed successfully" -ForegroundColor Green
exit 0
