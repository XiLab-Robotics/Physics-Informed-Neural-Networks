...
echo ""
printf "=%.0s" {1..96}; echo
echo "[INFO] Running aggregate child | scripts/campaigns/track_1/exact_paper/run_track1_mlp_open_cell_full_matrix_closure_campaign.sh"
printf "=%.0s" {1..96}; echo
bash "${PROJECT_ROOT}/scripts/campaigns/track_1/exact_paper/run_track1_mlp_open_cell_full_matrix_closure_campaign.sh" "${REMOTE_ARGUMENT_LIST[@]}" "${PASSTHROUGH_ARGUMENT_LIST[@]}"
