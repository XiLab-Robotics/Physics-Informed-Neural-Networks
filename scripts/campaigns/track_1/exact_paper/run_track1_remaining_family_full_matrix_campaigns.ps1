...
$launcherRelativePathList = @(
    "scripts\campaigns\track_1\exact_paper\run_track1_mlp_full_matrix_campaign.ps1"
    "scripts\campaigns\track_1\exact_paper\run_track1_rf_full_matrix_campaign.ps1"
    "scripts\campaigns\track_1\exact_paper\run_track1_dt_full_matrix_campaign.ps1"
    "scripts\campaigns\track_1\exact_paper\run_track1_et_full_matrix_campaign.ps1"
    "scripts\campaigns\track_1\exact_paper\run_track1_ert_full_matrix_campaign.ps1"
    "scripts\campaigns\track_1\exact_paper\run_track1_gbm_full_matrix_campaign.ps1"
    "scripts\campaigns\track_1\exact_paper\run_track1_hgbm_full_matrix_campaign.ps1"
    "scripts\campaigns\track_1\exact_paper\run_track1_xgbm_full_matrix_campaign.ps1"
    "scripts\campaigns\track_1\exact_paper\run_track1_lgbm_full_matrix_campaign.ps1"
)

Write-Host "[INFO] Aggregate RCIM Model-Bank Reproduction Remaining Family Launcher Count | $($launcherRelativePathList.Count)" -ForegroundColor Cyan
...
Write-Host ""
Write-Host "[DONE] RCIM Model-Bank Reproduction remaining family full-matrix campaign sequence completed successfully" -ForegroundColor Green
exit 0
