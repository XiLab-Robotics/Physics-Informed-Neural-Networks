...
print_usage() {
    cat <<'USAGE'
Usage:
  bash scripts/campaigns/track_1/exact_paper/run_track1_bidirectional_paper_faithful_grid_search_campaign.sh [options]
...
if [[ "${REMOTE}" == "1" ]]; then
    REMOTE_WRAPPER_ARGUMENT_LIST=(
        ...
        --launcher-relative-path "scripts/campaigns/track_1/exact_paper/run_track1_bidirectional_paper_faithful_grid_search_campaign.sh"
