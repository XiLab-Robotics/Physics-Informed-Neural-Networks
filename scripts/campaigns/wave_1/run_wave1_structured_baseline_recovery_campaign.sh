...
while [[ $# -gt 0 ]]; do
    case "$1" in
        ...
        --dry-run)
            ...
            ;;
        --help|-h)
            echo "Usage: bash scripts/campaigns/wave_1/run_wave1_structured_baseline_recovery_campaign.sh [--python-executable COMMAND] [--dry-run]"
            exit 0
            ;;
        *)
...
PLANNING_REPORT_PATH="doc/reports/campaign_plans/wave_1/2026-03-20-15-40-42_wave1_structured_baseline_recovery_campaign_plan_report.md"
