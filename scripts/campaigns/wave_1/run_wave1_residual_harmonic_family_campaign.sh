...
while [[ $# -gt 0 ]]; do
    case "$1" in
        ...
        --dry-run)
            ...
            ;;
        --help|-h)
            echo "Usage: bash scripts/campaigns/wave_1/run_wave1_residual_harmonic_family_campaign.sh [--python-executable COMMAND] [--dry-run]"
            exit 0
            ;;
        *)
...
PLANNING_REPORT_PATH="doc/reports/campaign_plans/wave_1/2026-03-26-13-52-00_wave1_residual_harmonic_family_campaign_plan_report.md"
