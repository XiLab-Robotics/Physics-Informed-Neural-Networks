...
$requiredRemoteSourcePathList = @($resolvedCampaignConfigPathList + @($resolvedPlanningReportPath, "scripts\campaigns\track1\svm\run_track1_svm_exact_faithful_final_attempt_campaign.ps1", "scripts\campaigns\infrastructure\shared_streaming_campaign_launcher.ps1"))
...
`$launcherPath = Join-Path '$remoteExecutionRoot' 'scripts\campaigns\track1\svm\run_track1_svm_exact_faithful_final_attempt_campaign.ps1'
