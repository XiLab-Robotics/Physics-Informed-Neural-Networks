...
$launcherRelativePathList = @(
    ...
    "scripts\campaigns\track1\exact_paper\run_track1_mlp_remaining_yellow_cell_campaign.ps1"
    "scripts\campaigns\track1\exact_paper\run_track1_et_remaining_yellow_cell_campaign.ps1"
    "scripts\campaigns\track1\exact_paper\run_track1_ert_remaining_yellow_cell_campaign.ps1"
    "scripts\campaigns\track1\exact_paper\run_track1_hgbm_remaining_yellow_cell_campaign.ps1"
    "scripts\campaigns\track1\exact_paper\run_track1_xgbm_remaining_yellow_cell_campaign.ps1"
)
