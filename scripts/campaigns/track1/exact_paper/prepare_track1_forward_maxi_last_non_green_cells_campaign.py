...
CAMPAIGN_CONFIG_ROOT = (
    ...
    / "track1"
    / "exact_paper"
    / "forward_maxi_last_non_green_cells"
)
...
PLANNING_REPORT_RELATIVE_PATH = (
    ...
    "2026-04-29-01-37-16_track1_forward_maxi_last_non_green_cells_campaign_plan_report.md"
)
LAUNCHER_RELATIVE_PATH = (
    "scripts/campaigns/track1/exact_paper/"
    "run_track1_forward_maxi_last_non_green_cells_campaign.ps1"
)
...
LAUNCHER_NOTE_RELATIVE_PATH = (
    "doc/scripts/campaigns/run_track1_forward_maxi_last_non_green_cells_campaign.md"
)
CAMPAIGN_OUTPUT_DIRECTORY_TEMPLATE = (
    "output/training_campaigns/track1/exact_paper/forward_maxi_last_non_green_cells/{campaign_name}"
)
...
MULTI_SURFACE_EXTENSION_ATTEMPT_SPECIFICATION_LIST = [
    AttemptSpecification(0.14, 0.16, 109, "multi_surface_extension"),
    AttemptSpecification(0.14, 0.16, 113, "multi_surface_extension"),
    AttemptSpecification(0.26, 0.08, 127, "multi_surface_extension"),
    AttemptSpecification(0.26, 0.08, 131, "multi_surface_extension"),
    AttemptSpecification(0.08, 0.22, 137, "multi_surface_extension"),
    AttemptSpecification(0.08, 0.22, 139, "multi_surface_extension"),
    AttemptSpecification(0.18, 0.18, 149, "multi_surface_extension"),
    AttemptSpecification(0.18, 0.18, 151, "multi_surface_extension"),
    AttemptSpecification(0.28, 0.06, 157, "multi_surface_extension"),
    AttemptSpecification(0.28, 0.06, 163, "multi_surface_extension"),
    AttemptSpecification(0.06, 0.24, 167, "multi_surface_extension"),
    AttemptSpecification(0.06, 0.24, 173, "multi_surface_extension"),
    AttemptSpecification(0.21, 0.09, 179, "multi_surface_extension"),
    AttemptSpecification(0.21, 0.09, 181, "multi_surface_extension"),
    AttemptSpecification(0.09, 0.21, 191, "multi_surface_extension"),
    AttemptSpecification(0.09, 0.21, 193, "multi_surface_extension"),
    AttemptSpecification(0.19, 0.14, 197, "multi_surface_extension"),
    AttemptSpecification(0.19, 0.14, 199, "multi_surface_extension"),
    AttemptSpecification(0.13, 0.17, 211, "multi_surface_extension"),
    AttemptSpecification(0.13, 0.17, 223, "multi_surface_extension"),
    AttemptSpecification(0.17, 0.13, 227, "multi_surface_extension"),
    AttemptSpecification(0.17, 0.13, 229, "multi_surface_extension"),
    AttemptSpecification(0.11, 0.19, 233, "multi_surface_extension"),
    AttemptSpecification(0.11, 0.19, 239, "multi_surface_extension"),
]
RED_MULTI_SURFACE_EXTENSION_ATTEMPT_SPECIFICATION_LIST = [
    AttemptSpecification(0.30, 0.05, 241, "red_multi_surface_extension"),
    AttemptSpecification(0.30, 0.05, 251, "red_multi_surface_extension"),
    AttemptSpecification(0.05, 0.25, 257, "red_multi_surface_extension"),
    AttemptSpecification(0.05, 0.25, 263, "red_multi_surface_extension"),
    AttemptSpecification(0.23, 0.07, 269, "red_multi_surface_extension"),
    AttemptSpecification(0.23, 0.07, 271, "red_multi_surface_extension"),
    AttemptSpecification(0.07, 0.23, 277, "red_multi_surface_extension"),
    AttemptSpecification(0.07, 0.23, 281, "red_multi_surface_extension"),
    AttemptSpecification(0.27, 0.07, 283, "red_multi_surface_extension"),
    AttemptSpecification(0.27, 0.07, 293, "red_multi_surface_extension"),
    AttemptSpecification(0.07, 0.27, 307, "red_multi_surface_extension"),
    AttemptSpecification(0.07, 0.27, 311, "red_multi_surface_extension"),
    AttemptSpecification(0.20, 0.10, 313, "red_multi_surface_extension"),
    AttemptSpecification(0.20, 0.10, 317, "red_multi_surface_extension"),
    AttemptSpecification(0.10, 0.20, 331, "red_multi_surface_extension"),
    AttemptSpecification(0.10, 0.20, 337, "red_multi_surface_extension"),
    AttemptSpecification(0.24, 0.08, 347, "red_multi_surface_extension"),
    AttemptSpecification(0.24, 0.08, 349, "red_multi_surface_extension"),
    AttemptSpecification(0.08, 0.24, 353, "red_multi_surface_extension"),
    AttemptSpecification(0.08, 0.24, 359, "red_multi_surface_extension"),
    AttemptSpecification(0.16, 0.14, 367, "red_multi_surface_extension"),
    AttemptSpecification(0.16, 0.14, 373, "red_multi_surface_extension"),
    AttemptSpecification(0.14, 0.16, 379, "red_multi_surface_extension"),
    AttemptSpecification(0.14, 0.16, 383, "red_multi_surface_extension"),
    AttemptSpecification(0.22, 0.12, 389, "red_multi_surface_extension"),
    AttemptSpecification(0.22, 0.12, 397, "red_multi_surface_extension"),
    AttemptSpecification(0.12, 0.22, 401, "red_multi_surface_extension"),
]
FORWARD_RESIDUAL_REPAIR_ITEM_LIST = [
    ForwardResidualRepairItem("ERT", "ampl", 156, "yellow_single_surface", ("Table 2",)),
    ForwardResidualRepairItem("ERT", "ampl", 162, "yellow_multi_surface", ("Table 2", "Table 3")),
    ...
    ForwardResidualRepairItem("XGBM", "ampl", 240, "yellow_single_surface", ("Table 2",)),
    ForwardResidualRepairItem("LGBM", "ampl", 0, "yellow_single_surface", ("Table 2",)),
...
def build_attempt_specification_list(
    ...
    if repair_item.severity_label == "yellow_single_surface":
        attempt_specification_list.extend(YELLOW_SINGLE_EXTENSION_ATTEMPT_SPECIFICATION_LIST)
    if repair_item.severity_label in {"yellow_multi_surface", "red_multi_surface"}:
        attempt_specification_list.extend(MULTI_SURFACE_EXTENSION_ATTEMPT_SPECIFICATION_LIST)
    if repair_item.severity_label == "red_multi_surface":
        attempt_specification_list.extend(RED_MULTI_SURFACE_EXTENSION_ATTEMPT_SPECIFICATION_LIST)
...
def build_campaign_config(
    ...
    baseline_payload["experiment"]["run_name"] = (
        f"track1_forward_{family_slug}_{target_slug}_maxi_last_non_green_cells_{attempt_slug}"
    )
    baseline_payload["experiment"]["model_family"] = (
        "paper_reimplementation_rcim_original_dataset_exact_model_bank_forward_maxi_last_non_green_cells"
    )
    baseline_payload["experiment"]["model_type"] = (
        f"exact_model_bank_forward_maxi_last_non_green_cells_{family_slug}_{target_slug}"
    )
...
def build_campaign_directory_slug(repair_item: ForwardResidualRepairItem) -> str:
    ...
    return (
        ...
        f"h{repair_item.harmonic_order}_maxi_last_non_green_cells"
    )
...
def build_campaign_config_path(
    ...
    filename = (
        ...
        f"{repair_item.target_kind}_h{repair_item.harmonic_order}_maxi_last_non_green_cells_"
...
def main() -> None:
    ...
    """Prepare the complete forward-only maxi residual campaign package."""

    timestamp_string = datetime.now().astimezone().strftime("%Y-%m-%d_%H_%M_%S")
    campaign_name = f"track1_forward_maxi_last_non_green_cells_campaign_{timestamp_string}"
    ...
    active_campaign_payload = {
        ...
        "interruption_note": (
            "Prepared as the forward-only maxi residual repair wave after the "
            "completed last-non-green forward closeout."
        ),
    }
    save_yaml_file(active_campaign_payload, ACTIVE_CAMPAIGN_STATE_PATH)
    print(
        f"[DONE] Prepared forward maxi residual queue count | "
