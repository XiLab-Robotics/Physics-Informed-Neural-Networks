...
$launcherRelativePathList = @(
    "scripts\campaigns\track1\exact_paper\run_track1_mlp_residual_cellwise_closure_campaign.ps1"
    "scripts\campaigns\track1\exact_paper\run_track1_rf_residual_cellwise_closure_campaign.ps1"
    "scripts\campaigns\track1\exact_paper\run_track1_dt_residual_cellwise_closure_campaign.ps1"
    "scripts\campaigns\track1\exact_paper\run_track1_et_residual_cellwise_closure_campaign.ps1"
    "scripts\campaigns\track1\exact_paper\run_track1_ert_residual_cellwise_closure_campaign.ps1"
    "scripts\campaigns\track1\exact_paper\run_track1_gbm_residual_cellwise_closure_campaign.ps1"
    "scripts\campaigns\track1\exact_paper\run_track1_hgbm_residual_cellwise_closure_campaign.ps1"
    "scripts\campaigns\track1\exact_paper\run_track1_xgbm_residual_cellwise_closure_campaign.ps1"
    "scripts\campaigns\track1\exact_paper\run_track1_lgbm_residual_cellwise_closure_campaign.ps1"
)
