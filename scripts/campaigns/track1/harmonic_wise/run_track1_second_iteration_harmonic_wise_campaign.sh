...
bash "${SCRIPT_DIRECTORY}/run_track1_harmonic_wise_campaign_bundle.sh" \
    ...
    --planning-report-path "doc/reports/campaign_plans/track1/harmonic_wise/2026-04-09-18-56-03_track1_second_iteration_harmonic_wise_campaign_plan_report.md" \
