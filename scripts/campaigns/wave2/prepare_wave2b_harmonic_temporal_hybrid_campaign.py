...
LAUNCHER_PATH = Path("scripts/campaigns/wave2/run_wave2b_harmonic_temporal_hybrid_campaign.ps1")
LAUNCHER_NOTE_PATH = Path(
    "doc/scripts/campaigns/wave2/run_wave2b_harmonic_temporal_hybrid_campaign.md"
)
