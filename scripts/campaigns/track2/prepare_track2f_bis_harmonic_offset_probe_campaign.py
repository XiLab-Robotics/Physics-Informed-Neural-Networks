...
LAUNCHER_PATH = Path("scripts/campaigns/track2/run_track2f_bis_harmonic_offset_probe_campaign.ps1")
VALIDATOR_PATH = Path("scripts/campaigns/track2/validate_track2f_bis_harmonic_offset_probe_package.py")
LAUNCHER_NOTE_PATH = Path("doc/scripts/campaigns/track2/run_track2f_bis_harmonic_offset_probe_campaign.md")
