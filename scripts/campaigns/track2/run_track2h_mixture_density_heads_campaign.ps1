...
$validatorPath = "scripts\campaigns\track2\validate_track2h_mixture_density_heads_package.py"
$planningReportPath = "doc\reports\campaign_plans\track2\2026-06-13-10-40-25_track2h_mixture_density_heads_campaign_plan_report.md"
