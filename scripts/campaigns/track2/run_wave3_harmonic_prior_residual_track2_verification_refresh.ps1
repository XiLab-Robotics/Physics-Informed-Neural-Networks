...
$newCandidateCampaignResultPlotDirectory = "doc\reports\campaign_results\track 2\wave3_harmonic_prior_residual_registry"
...
if ($Remote) {
    ...
    $remoteScriptPath = "scripts\campaigns\track2\run_wave3_harmonic_prior_residual_track2_verification_refresh.ps1"
    $remoteCommand = @"
Set-Location -LiteralPath '$RemoteRepositoryPath'
