...
$newCandidateCampaignResultPlotDirectory = "doc\reports\campaign_results\track 2\track2h_mixture_density_heads_registry"
...
if ($Remote) {
    ...
    $remoteScriptPath = "scripts\campaigns\track2\run_track2h_mixture_density_heads_track2_verification_refresh.ps1"
    $remoteCommand = @"
Set-Location -LiteralPath '$RemoteRepositoryPath'
