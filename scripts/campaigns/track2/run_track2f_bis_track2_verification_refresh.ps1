...
$newCandidateCampaignResultPlotDirectory = "doc\reports\campaign_results\track 2\track2f_bis_harmonic_offset_probe_registry"
...
if ($Remote) {
    ...
    $remoteScriptPath = "scripts\campaigns\track2\run_track2f_bis_track2_verification_refresh.ps1"
    $remoteCommand = @"
Set-Location -LiteralPath '$RemoteRepositoryPath'
