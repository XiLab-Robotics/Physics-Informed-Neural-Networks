...
LAUNCHER_PATH = Path("scripts/campaigns/track2/run_track2h_quantile_probabilistic_campaign.ps1")
VALIDATOR_PATH = Path("scripts/campaigns/track2/validate_track2h_quantile_probabilistic_package.py")
LAUNCHER_NOTE_PATH = Path("doc/scripts/campaigns/track2/run_track2h_quantile_probabilistic_campaign.md")
