...
LAUNCHER_PATH = Path("scripts/campaigns/track2/run_track2g_curve_aware_training_campaign.ps1")
VALIDATOR_PATH = Path("scripts/campaigns/track2/validate_track2g_curve_aware_training_package.py")
LAUNCHER_NOTE_PATH = Path("doc/scripts/campaigns/track2/run_track2g_curve_aware_training_campaign.md")
