...
$validatorPath = "scripts\campaigns\track2\validate_track2h_dispersion_aware_modeling_package.py"
$planningReportPath = "doc\reports\campaign_plans\track2\2026-06-10-16-56-36_track2h_dispersion_aware_modeling_probe_campaign_plan_report.md"
