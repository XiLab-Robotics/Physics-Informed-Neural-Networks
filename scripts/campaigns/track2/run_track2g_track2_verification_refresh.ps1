...
$newCandidateCampaignResultPlotDirectory = "doc\reports\campaign_results\track 2\track2g_curve_aware_training_registry"
...
if ($Remote) {
    ...
    $remoteScriptPath = "scripts\campaigns\track2\run_track2g_track2_verification_refresh.ps1"
    $remoteCommand = @"
Set-Location -LiteralPath '$RemoteRepositoryPath'
