...
$validatorPath = "scripts\campaigns\track2\validate_track2h_latent_state_hysteresis_package.py"
$planningReportPath = "doc\reports\campaign_plans\track2\2026-06-16-16-00-57_track2h_latent_state_hysteresis_campaign_plan_report.md"
