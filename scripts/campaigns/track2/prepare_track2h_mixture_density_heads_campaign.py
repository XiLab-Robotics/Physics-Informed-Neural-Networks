...
LAUNCHER_PATH = Path("scripts/campaigns/track2/run_track2h_mixture_density_heads_campaign.ps1")
VALIDATOR_PATH = Path("scripts/campaigns/track2/validate_track2h_mixture_density_heads_package.py")
LAUNCHER_NOTE_PATH = Path("doc/scripts/campaigns/track2/run_track2h_mixture_density_heads_campaign.md")
