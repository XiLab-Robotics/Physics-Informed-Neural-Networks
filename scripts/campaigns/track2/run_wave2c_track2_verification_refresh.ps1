...
$newCandidateCampaignResultPlotDirectory = "doc\reports\campaign_results\track 2\wave2c_residual_harmonic_temporal_registry"
...
if ($Remote) {
    ...
    $remoteScriptPath = "scripts\campaigns\track2\run_wave2c_track2_verification_refresh.ps1"
    $remoteCommand = @"
Set-Location -LiteralPath '$RemoteRepositoryPath'
