...
$validatorPath = "scripts\campaigns\wave3\validate_wave3_harmonic_prior_residual_campaign.py"
$planningReportPath = "doc\reports\campaign_plans\wave3_wave4\2026-06-14-19-54-55_wave3_harmonic_prior_residual_campaign_plan_report.md"
