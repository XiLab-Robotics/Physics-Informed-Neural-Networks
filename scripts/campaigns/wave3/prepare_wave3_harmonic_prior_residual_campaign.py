...
LAUNCHER_PATH = Path("scripts/campaigns/wave3/run_wave3_harmonic_prior_residual_campaign.ps1")
VALIDATOR_PATH = Path("scripts/campaigns/wave3/validate_wave3_harmonic_prior_residual_campaign.py")
LAUNCHER_NOTE_PATH = Path("doc/scripts/campaigns/wave3/run_wave3_harmonic_prior_residual_campaign.md")
