...
$planningReportPath = "doc\reports\campaign_plans\2026-04-17-11-44-20_track1_svm_exact_faithful_final_attempt_campaign_plan_report.md"
...
$requiredRemoteSourcePathList = @($resolvedCampaignConfigPathList + @($resolvedPlanningReportPath, "scripts\campaigns\run_track1_svm_exact_faithful_final_attempt_campaign.ps1", "scripts\campaigns\shared_streaming_campaign_launcher.ps1"))
...
`$launcherPath = Join-Path '$remoteExecutionRoot' 'scripts\campaigns\run_track1_svm_exact_faithful_final_attempt_campaign.ps1'
