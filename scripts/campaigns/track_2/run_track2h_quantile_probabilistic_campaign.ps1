...
$validatorPath = "scripts\campaigns\track_2\validate_track2h_quantile_probabilistic_package.py"
$planningReportPath = "doc\reports\campaign_plans\track_2\2026-06-12-00-01-04_track2h_quantile_probabilistic_campaign_plan_report.md"
