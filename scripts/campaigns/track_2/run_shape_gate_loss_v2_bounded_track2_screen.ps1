param(
    ...
    [string]$OutputSuffix = "shape_gate_loss_v2_bounded_track2_screen_polished_setpoints_fw",
    [string]$ReportDate = "2026-07-21"
)
...
$ConfigPath = "config/paper_reimplementation/rcim_ml_compensation/reference_family_vs_feedforward/shape_gate_loss_v2_bounded_track2_screen_polished_setpoints_fw_matrix.yaml"
...
$ActiveFamilyList = @(
    ...
    "shape_gate_loss_v2_checkpoint_selection_periodic_gru_sequence_fw"
)
...
function Repair-BoundedScreenArtifacts {
    Repair-TextArtifactWhitespace @(
        ...
        "doc/reports/analysis/te_curve_verification_pipeline/03_cvp_diagnostics/shape_gated_reranker/[$ReportDate]",
...
function Invoke-LocalPreflight {
    ...
    Assert-RelativePathExists "output/registries/families/shape_gate_loss_v2_checkpoint_selection_periodic_gru_sequence_fw/latest_family_best.yaml"
    Assert-RelativePathExists "output/registries/families/shape_gate_loss_pilot_periodic_gru_sequence_fw/latest_family_best.yaml"
    Assert-RelativePathExists "models/polished_dataset/setpoints/feedforward/forward/reference_inventory.yaml"
    Assert-RelativePathExists "models/polished_dataset/setpoints/tree/forward/reference_inventory.yaml"
    Assert-RelativePathExists "models/polished_dataset/setpoints/harmonic_regression/forward/reference_inventory.yaml"
    ...
    Assert-RelativePathExists "models/polished_dataset/setpoints/wave4_1_mae_robust_loss/forward/reference_inventory.yaml"
    Assert-RelativePathExists "models/polished_dataset/setpoints/wave4_2_quantile_p10_p50_p90/forward/reference_inventory.yaml"

    $activeStateText = Get-Content -Raw -LiteralPath (Join-Path $RepositoryRoot $ActiveStatePath)
    if ($activeStateText -notmatch "shape_gate_loss_v2_bounded_track2_screen_2026_07_21") {
        throw "Active campaign state is not prepared for shape_gate_loss_v2_bounded_track2_screen_2026_07_21."
    }
...
function Invoke-RemoteSourceSync {
    ...
    $sourcePathList = @(
        ...
        "scripts/reports/pdf",
        "config/datasets",
        "doc/scripts/campaigns/track_2/run_shape_gate_loss_v2_bounded_track2_screen.md",
        "doc/reports/analysis/te_curve_verification_pipeline",
        "output/registries/families/shape_gate_loss_v2_checkpoint_selection_periodic_gru_sequence_fw",
        "output/registries/families/shape_gate_loss_pilot_periodic_gru_sequence_fw",
        "output/training_runs/shape_gate_loss_v2_checkpoint_selection_periodic_gru_sequence",
...
`$artifactMap = @(
  @{
    Source = 'output/validation_checks/track2_reference_comparison'
    Target = 'output/validation_checks/track2_reference_comparison'
  },
  @{
    Source = 'output/validation_checks/shape_gated_te_curve_reranker'
    Target = 'output/validation_checks/shape_gated_te_curve_reranker'
  },
  @{
    Source = 'output/validation_checks/track2_operator_launch_logs'
    Target = 'output/validation_checks/track2_operator_launch_logs'
  },
  @{
    Source = 'doc/reports/analysis/te_curve_verification_pipeline/03_cvp_diagnostics/shape_gated_reranker/[$ReportDate]'
    Target = 'doc/reports/analysis/te_curve_verification_pipeline/03_cvp_diagnostics/shape_gated_reranker/[$ReportDate]'
  },
  @{
    Source = 'doc/reports/analysis/validation_checks/te_curve_verification_pipeline'
    Target = 'doc/reports/analysis/validation_checks/te_curve_verification_pipeline'
  },
  @{
    Source = 'doc/reports/campaign_results/track_2/verification_plots/shape_gate_loss_v2_bounded_track2_screen_polished_setpoints_fw'
    Target = 'doc/reports/campaign_results/track_2/verification_plots/shape_gate_loss_v2_bounded_track2_screen_polished_setpoints_fw'
  }
)
`$bundleRoot = Join-Path `$env:TEMP ('shape_gate_loss_v2_bounded_track2_screen_bundle_$RunStamp')
...
`$archivePath = Join-Path `$env:TEMP ('shape_gate_loss_v2_bounded_track2_screen_artifacts_$RunStamp.zip')
...
function Invoke-RemoteRun {
    ...
    $remoteScriptPath = Convert-ToRemotePath (Join-Path $RemoteRepositoryPath "scripts/campaigns/track_2/run_shape_gate_loss_v2_bounded_track2_screen.ps1")
    $preflightFlag = ""
    if ($PreflightOnly) {
