...
$validatorPath = "scripts\campaigns\track_2\validate_track2f_offset_aware_probe_package.py"
$baselineOutputRoot = "output\validation_checks\track2f_offset_aware_probe\2026-06-03_track2f_offset_aware_probe_prelaunch"
$planningReportPath = "doc\reports\campaign_plans\track_2\2026-06-03-17-25-37_track2f_offset_aware_probe_campaign_plan_report.md"
