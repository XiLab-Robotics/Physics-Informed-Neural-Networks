...
LAUNCHER_PATH = Path("scripts/campaigns/track_2/run_track2h_latent_state_hysteresis_campaign.ps1")
VALIDATOR_PATH = Path("scripts/campaigns/track_2/validate_track2h_latent_state_hysteresis_package.py")
LAUNCHER_NOTE_PATH = Path("doc/scripts/campaigns/track_2/run_track2h_latent_state_hysteresis_campaign.md")
