...
$validatorPath = "scripts\campaigns\track_2\validate_track2f_bis_harmonic_offset_probe_package.py"
$planningReportPath = "doc\reports\campaign_plans\track_2\2026-06-04-22-57-04_track2f_bis_harmonic_offset_probe_campaign_plan_report.md"
