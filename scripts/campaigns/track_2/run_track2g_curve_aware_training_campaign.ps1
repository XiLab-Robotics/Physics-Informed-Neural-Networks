...
$validatorPath = "scripts\campaigns\track_2\validate_track2g_curve_aware_training_package.py"
$planningReportPath = "doc\reports\campaign_plans\track_2\2026-06-08-18-01-40_track2g_curve_aware_training_campaign_plan_report.md"
