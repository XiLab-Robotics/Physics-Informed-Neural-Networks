param(
    ...
    [string]$OutputSuffix = "track2h_mixture_density_heads_track2_refresh_2026_06_13",
    [string]$ReportDate = "2026-06-13",
...
$newCandidateCampaignResultPlotDirectory = "doc\reports\campaign_results\track_2\verification_plots\track2h_mixture_density_heads_registry"
...
$sourceSyncPathList = @(
    ...
    "output\registries\families\track2h_mixture_density_heads_mdn_k2_global",
    "output\registries\families\track2h_mixture_density_heads_mdn_k2_fw",
    "output\registries\families\track2h_mixture_density_heads_mdn_k2_bw",
    "output\registries\families\track2h_mixture_density_heads_mdn_k3_global",
    "output\registries\families\track2h_mixture_density_heads_mdn_k3_fw",
    "output\registries\families\track2h_mixture_density_heads_mdn_k3_bw",
    "output\training_runs\track2h_mixture_density_heads_mdn_k2_global",
    "output\training_runs\track2h_mixture_density_heads_mdn_k2_fw",
    "output\training_runs\track2h_mixture_density_heads_mdn_k2_bw",
    "output\training_runs\track2h_mixture_density_heads_mdn_k3_global",
    "output\training_runs\track2h_mixture_density_heads_mdn_k3_fw",
    "output\training_runs\track2h_mixture_density_heads_mdn_k3_bw",
