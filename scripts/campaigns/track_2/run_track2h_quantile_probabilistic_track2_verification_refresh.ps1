param(
    ...
    [string]$OutputSuffix = "track2h_quantile_probabilistic_track2_refresh_2026_06_12",
    [string]$ReportDate = "2026-06-12",
...
$newCandidateCampaignResultPlotDirectory = "doc\reports\campaign_results\track_2\verification_plots\track2h_quantile_probabilistic_registry"
...
$sourceSyncPathList = @(
    ...
    "output\registries\families\track2h_quantile_probabilistic_quantile_p10_p50_p90_global",
    "output\registries\families\track2h_quantile_probabilistic_quantile_p10_p50_p90_fw",
    "output\registries\families\track2h_quantile_probabilistic_quantile_p10_p50_p90_bw",
    "output\registries\families\track2h_quantile_probabilistic_gaussian_nll_global",
    "output\registries\families\track2h_quantile_probabilistic_gaussian_nll_fw",
    "output\registries\families\track2h_quantile_probabilistic_gaussian_nll_bw",
    "output\training_runs\track2h_quantile_probabilistic_quantile_p10_p50_p90_global",
    "output\training_runs\track2h_quantile_probabilistic_quantile_p10_p50_p90_fw",
    "output\training_runs\track2h_quantile_probabilistic_quantile_p10_p50_p90_bw",
    "output\training_runs\track2h_quantile_probabilistic_gaussian_nll_global",
    "output\training_runs\track2h_quantile_probabilistic_gaussian_nll_fw",
    "output\training_runs\track2h_quantile_probabilistic_gaussian_nll_bw",
...
if (`$null -eq `$manifestPath) {
        throw 'No remote Wave 4.2 quantile/probabilistic artifact sync manifest found.'
}
`$existingPathList = @()
...
if (`$existingPathList.Count -eq 0) {
        throw 'The remote Wave 4.2 quantile/probabilistic artifact sync manifest did not contain existing paths.'
}
...
if ($Remote) {
    ...
    Write-StatusLine "INFO" ("Launching Wave 4.2 quantile/probabilistic refresh remotely | host={0} | repo={1}" -f $RemoteHostAlias, $RemoteRepositoryPath)
    Invoke-RemoteSourceSync

    $remoteScriptPath = "scripts\campaigns\track_2\run_track2h_quantile_probabilistic_track2_verification_refresh.ps1"
    $remoteCommand = @"
Set-Location -LiteralPath '$RemoteRepositoryPath'
...
"@
    ...
    Write-StatusLine "DONE" "Remote Wave 4.2 quantile/probabilistic refresh completed and artifacts synchronized locally"
    exit 0
}

Write-StatusLine "INFO" "Preparing local Wave 4.2 quantile/probabilistic verification refresh"
...
if (-not $SkipVisualReports) {
    ...
    Invoke-LoggedCondaPython `
        ...
        -ArgumentList @(
            ...
            $ReportDate,
            "--refresh-label",
            "Wave 4.2 quantile/probabilistic refresh",
            ...
            "--next-step",
            "Compare this probabilistic branch with the next dispersion-aware families before selecting ingredients for multi-task or multi-head integration.",
            "--output-report-path",
            $officialReportPath,
            "--operator-log-root",
            $logRoot
...
Write-StatusLine "DONE" "Wave 4.2 quantile/probabilistic verification refresh completed"
