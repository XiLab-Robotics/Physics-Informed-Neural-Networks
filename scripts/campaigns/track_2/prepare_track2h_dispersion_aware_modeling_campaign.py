...
LAUNCHER_PATH = Path("scripts/campaigns/track_2/run_track2h_dispersion_aware_modeling_campaign.ps1")
VALIDATOR_PATH = Path("scripts/campaigns/track_2/validate_track2h_dispersion_aware_modeling_package.py")
LAUNCHER_NOTE_PATH = Path("doc/scripts/campaigns/track_2/run_track2h_dispersion_aware_modeling_campaign.md")
