param(
    ...
    [string]$OutputSuffix = "wave2c_residual_harmonic_temporal_hybrid_track2_refresh_2026_05_28",
    [string]$ReportDate = "2026-05-28",
    [string[]]$SourceSyncPathList = @(
        "scripts",
        "config",
        "doc\scripts\campaigns\track_2",
        "output\registries\families\residual_harmonic_gru_sequence_sparse_rcim",
        "output\registries\families\residual_harmonic_gru_sequence_fw_sparse_rcim",
        "output\registries\families\residual_harmonic_gru_sequence_bw_sparse_rcim",
        "output\registries\families\residual_harmonic_gru_sequence_dense240",
        "output\registries\families\residual_harmonic_gru_sequence_fw_dense240",
        "output\registries\families\residual_harmonic_gru_sequence_bw_dense240",
        "output\registries\families\residual_harmonic_gru_sequence_dense360",
        "output\registries\families\residual_harmonic_gru_sequence_fw_dense360",
        "output\registries\families\residual_harmonic_gru_sequence_bw_dense360",
        "output\registries\families\residual_harmonic_lstm_sequence_sparse_rcim",
        "output\registries\families\residual_harmonic_lstm_sequence_fw_sparse_rcim",
        "output\registries\families\residual_harmonic_lstm_sequence_bw_sparse_rcim",
        "output\registries\families\residual_harmonic_lstm_sequence_dense240",
        "output\registries\families\residual_harmonic_lstm_sequence_fw_dense240",
        "output\registries\families\residual_harmonic_lstm_sequence_bw_dense240",
        "output\registries\families\residual_harmonic_lstm_sequence_dense360",
        "output\registries\families\residual_harmonic_lstm_sequence_fw_dense360",
        "output\registries\families\residual_harmonic_lstm_sequence_bw_dense360",
        "output\training_runs\residual_harmonic_gru_sequence_sparse_rcim",
        "output\training_runs\residual_harmonic_gru_sequence_fw_sparse_rcim",
        "output\training_runs\residual_harmonic_gru_sequence_bw_sparse_rcim",
        "output\training_runs\residual_harmonic_gru_sequence_dense240",
        "output\training_runs\residual_harmonic_gru_sequence_fw_dense240",
        "output\training_runs\residual_harmonic_gru_sequence_bw_dense240",
        "output\training_runs\residual_harmonic_gru_sequence_dense360",
        "output\training_runs\residual_harmonic_gru_sequence_fw_dense360",
        "output\training_runs\residual_harmonic_gru_sequence_bw_dense360",
        "output\training_runs\residual_harmonic_lstm_sequence_sparse_rcim",
        "output\training_runs\residual_harmonic_lstm_sequence_fw_sparse_rcim",
        "output\training_runs\residual_harmonic_lstm_sequence_bw_sparse_rcim",
        "output\training_runs\residual_harmonic_lstm_sequence_dense240",
        "output\training_runs\residual_harmonic_lstm_sequence_fw_dense240",
        "output\training_runs\residual_harmonic_lstm_sequence_bw_dense240",
        "output\training_runs\residual_harmonic_lstm_sequence_dense360",
        "output\training_runs\residual_harmonic_lstm_sequence_fw_dense360",
        "output\training_runs\residual_harmonic_lstm_sequence_bw_dense360",
        "output\validation_checks\track2_reference_comparison\2026-05-27-16-03-14__track2_full_directional_family_matrix_wave2b_harmonic_temporal_hybrid_track2_refresh_2026_05_26\validation_summary.yaml",
        "output\validation_checks\track2_reference_comparison\2026-05-27-16-03-14__track2_full_directional_family_matrix_wave2b_harmonic_temporal_hybrid_track2_refresh_2026_05_26\per_condition_metrics.csv"
    ),
...
$newCandidateCampaignResultPlotDirectory = "doc\reports\campaign_results\track_2\verification_plots\wave2c_residual_harmonic_temporal_registry"
