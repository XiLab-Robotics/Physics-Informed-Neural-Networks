...
DEFAULT_LM_STUDIO_BASE_URL = os.environ.get("LM_STUDIO_BASE_URL", os.environ.get("STANDARDML_LM_STUDIO_BASE_URL", "http://127.0.0.1:1234")).strip()
    ...
    raw_chunk_payload = [
        {
            ...
            "raw_transcript_text": transcript_chunk.raw_transcript_text,
        }
...
def synthesize_report_markdown(
    ...
    transcript_context = "\n".join(
        [
            f"[{format_seconds(chunk.start_seconds)} - {format_seconds(chunk.end_seconds)}] {chunk.corrected_transcript_text}"
...
def main() -> int:
    ...
    print("")
    print("=" * 96)
    print("High-Quality TwinCAT Video Knowledge Extraction")
    print("=" * 96)
    for video_file_path in video_file_path_list:
